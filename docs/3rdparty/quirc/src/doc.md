# Documentation for `3rdparty/quirc/src/`
...
- **[version_db.c](version_db.c_docs.md)**: C file
- **[decode.c](decode.c_docs.md)**: C file
- **[quirc.c](quirc.c_docs.md)**: C file
