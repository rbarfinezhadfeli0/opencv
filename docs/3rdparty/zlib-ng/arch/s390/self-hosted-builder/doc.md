# Documentation for `3rdparty/zlib-ng/arch/s390/self-hosted-builder/`
...
**Path**: `3rdparty/zlib-ng/arch/s390/self-hosted-builder/`
**Direct Files**: 4
**Subfolders**: 0
...
- **[runner-s390x.patch](runner-s390x.patch_docs.md)**: PATCH file
- **[actions-runner.service](actions-runner.service_docs.md)**: SERVICE file
- **[actions-runner.Dockerfile](actions-runner.Dockerfile_docs.md)**: DOCKERFILE file
- **[runner-global.json](runner-global.json_docs.md)**: JSON file
...
- **Parent Folder**: [3rdparty/zlib-ng/arch/s390/](../s390/doc.md)
