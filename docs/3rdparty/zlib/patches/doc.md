# Documentation for `3rdparty/zlib/patches/`
...
- **[20190330-ununitialized-use-state-check.diff](20190330-ununitialized-use-state-check.diff_docs.md)**: DIFF file
...
- **Parent Folder**: [3rdparty/zlib/](../zlib/doc.md)
