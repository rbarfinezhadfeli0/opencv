# Documentation for `cmake/checks/runtime/`
...
- **[cpu_vsx_aligned.cpp](cpu_vsx_aligned.cpp_docs.md)**: CPP file
...
- **Parent Folder**: [cmake/checks/](../checks/doc.md)
