# Documentation for `cmake/templates/`
...
- **[dllmain.cpp.in](dllmain.cpp.in_docs.md)**: Main entry point
- **[setup_vars_macosx.sh.in](setup_vars_macosx.sh.in_docs.md)**: IN file
- **[setup_vars_linux.sh.in](setup_vars_linux.sh.in_docs.md)**: IN file
- **[setup_vars_win32.cmd.in](setup_vars_win32.cmd.in_docs.md)**: IN file
