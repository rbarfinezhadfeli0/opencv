# Documentation for `doc/js_tutorials/js_assets/webnn-electron/`
...
**Path**: `doc/js_tutorials/js_assets/webnn-electron/`
**Direct Files**: 5
**Subfolders**: 0
...
- **[main.js](main.js_docs.md)**: Main entry point
- **[node_setup.js](node_setup.js_docs.md)**: JS file
...
- **Parent Folder**: [doc/js_tutorials/js_assets/](../js_assets/doc.md)
