# Documentation for `doc/js_tutorials/js_core/js_image_arithmetics/`
...
**Path**: `doc/js_tutorials/js_core/js_image_arithmetics/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[js_image_arithmetics.markdown](js_image_arithmetics.markdown_docs.md)**: MARKDOWN file
...
- **Parent Folder**: [doc/js_tutorials/js_core/](../js_core/doc.md)
