# Documentation for `doc/js_tutorials/js_gui/js_image_display/images/`
...
**Path**: `doc/js_tutorials/js_gui/js_image_display/images/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[Imread_Imshow_Tutorial_Result.png](Imread_Imshow_Tutorial_Result.png_docs.md)**: PNG file
...
- **Parent Folder**: [doc/js_tutorials/js_gui/js_image_display/](../js_image_display/doc.md)
