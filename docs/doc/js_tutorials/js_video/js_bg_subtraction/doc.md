# Documentation for `doc/js_tutorials/js_video/js_bg_subtraction/`
...
**Path**: `doc/js_tutorials/js_video/js_bg_subtraction/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[js_bg_subtraction.markdown](js_bg_subtraction.markdown_docs.md)**: MARKDOWN file
...
- **Parent Folder**: [doc/js_tutorials/js_video/](../js_video/doc.md)
