# Index of `doc/py_tutorials/py_core/py_image_arithmetics/`

## Overview

This folder is part of the OpenCV repository structure and contains and other repository content.

**Location**: `doc/py_tutorials/py_core/py_image_arithmetics`
...
|-----------|------|------|---------------|----------|
| [py_image_arithmetics.markdown](../../../../../doc/py_tutorials/py_core/py_image_arithmetics/py_image_arithmetics.markdown) | MARKDOWN | 4.0KB | [docs](py_image_arithmetics.markdown_docs.md) | [keywords](py_image_arithmetics.markdown_kw.md) |
