# Index of `doc/py_tutorials/py_imgproc/py_contours/py_contour_features/`

## Overview

This folder is part of the OpenCV repository structure and contains and other repository content.

**Location**: `doc/py_tutorials/py_imgproc/py_contours/py_contour_features`
...
|-----------|------|------|---------------|----------|
| [py_contour_features.markdown](../../../../../../doc/py_tutorials/py_imgproc/py_contours/py_contour_features/py_contour_features.markdown) | MARKDOWN | 7.2KB | [docs](py_contour_features.markdown_docs.md) | [keywords](py_contour_features.markdown_kw.md) |
