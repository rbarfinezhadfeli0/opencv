# Index of `doc/py_tutorials/py_imgproc/py_filtering/`

## Overview

This folder is part of the OpenCV repository structure and contains and other repository content.

**Location**: `doc/py_tutorials/py_imgproc/py_filtering`
...
- **[images/](images/index.md)**: Subfolder containing 5 files
...
|-----------|------|------|---------------|----------|
| [py_filtering.markdown](../../../../../doc/py_tutorials/py_imgproc/py_filtering/py_filtering.markdown) | MARKDOWN | 6.1KB | [docs](py_filtering.markdown_docs.md) | [keywords](py_filtering.markdown_kw.md) |
