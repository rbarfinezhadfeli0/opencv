# Index of `doc/py_tutorials/py_imgproc/py_geometric_transformations/`

## Overview

This folder is part of the OpenCV repository structure and contains and other repository content.

**Location**: `doc/py_tutorials/py_imgproc/py_geometric_transformations`
...
|-----------|------|------|---------------|----------|
| [py_geometric_transformations.markdown](../../../../../doc/py_tutorials/py_imgproc/py_geometric_transformations/py_geometric_transformations.markdown) | MARKDOWN | 5.8KB | [docs](py_geometric_transformations.markdown_docs.md) | [keywords](py_geometric_transformations.markdown_kw.md) |
