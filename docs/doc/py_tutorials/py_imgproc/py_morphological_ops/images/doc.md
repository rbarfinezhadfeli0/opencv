# Documentation for `doc/py_tutorials/py_imgproc/py_morphological_ops/images/`
...
**Path**: `doc/py_tutorials/py_imgproc/py_morphological_ops/images/`
**Direct Files**: 8
**Subfolders**: 0
...
- **[opening.png](opening.png_docs.md)**: PNG file
- **[blackhat.png](blackhat.png_docs.md)**: PNG file
- **[dilation.png](dilation.png_docs.md)**: PNG file
- **[gradient.png](gradient.png_docs.md)**: PNG file
- **[j.png](j.png_docs.md)**: PNG file
- **[closing.png](closing.png_docs.md)**: PNG file
- **[erosion.png](erosion.png_docs.md)**: PNG file
- **[tophat.png](tophat.png_docs.md)**: PNG file
...
- **Parent Folder**: [doc/py_tutorials/py_imgproc/py_morphological_ops/](../py_morphological_ops/doc.md)
