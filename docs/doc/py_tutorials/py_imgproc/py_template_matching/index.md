# Index of `doc/py_tutorials/py_imgproc/py_template_matching/`

## Overview

This folder is part of the OpenCV repository structure and contains and other repository content.

**Location**: `doc/py_tutorials/py_imgproc/py_template_matching`
...
|-----------|------|------|---------------|----------|
| [py_template_matching.markdown](../../../../../doc/py_tutorials/py_imgproc/py_template_matching/py_template_matching.markdown) | MARKDOWN | 4.4KB | [docs](py_template_matching.markdown_docs.md) | [keywords](py_template_matching.markdown_kw.md) |
