# Documentation for `doc/py_tutorials/py_objdetect/`
...
**Path**: `doc/py_tutorials/py_objdetect/`
**Direct Files**: 1
**Subfolders**: 1
...
- **[py_table_of_contents_objdetect.markdown](py_table_of_contents_objdetect.markdown_docs.md)**: MARKDOWN file
...
- **py_face_detection/** - See [py_face_detection/doc.md](py_face_detection/doc.md)
...
**Subfolders**:
- [py_face_detection/](py_face_detection/doc.md)
