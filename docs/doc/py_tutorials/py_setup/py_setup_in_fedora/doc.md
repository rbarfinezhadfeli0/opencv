# Documentation for `doc/py_tutorials/py_setup/py_setup_in_fedora/`
...
**Path**: `doc/py_tutorials/py_setup/py_setup_in_fedora/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[py_setup_in_fedora.markdown](py_setup_in_fedora.markdown_docs.md)**: MARKDOWN file
