# Documentation for `doc/py_tutorials/py_setup/py_setup_in_ubuntu/`
...
**Path**: `doc/py_tutorials/py_setup/py_setup_in_ubuntu/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[py_setup_in_ubuntu.markdown](py_setup_in_ubuntu.markdown_docs.md)**: MARKDOWN file
