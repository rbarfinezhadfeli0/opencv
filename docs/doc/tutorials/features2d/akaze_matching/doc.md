# Documentation for `doc/tutorials/features2d/akaze_matching/`
...
**Path**: `doc/tutorials/features2d/akaze_matching/`
**Direct Files**: 1
**Subfolders**: 1
...
- **[akaze_matching.markdown](akaze_matching.markdown_docs.md)**: MARKDOWN file
