# Documentation for `doc/tutorials/features2d/akaze_tracking/`
...
**Path**: `doc/tutorials/features2d/akaze_tracking/`
**Direct Files**: 1
**Subfolders**: 1
...
- **[akaze_tracking.markdown](akaze_tracking.markdown_docs.md)**: MARKDOWN file
