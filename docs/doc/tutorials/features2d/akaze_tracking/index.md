# Index of `doc/tutorials/features2d/akaze_tracking/`

## Overview

This folder is part of the OpenCV repository structure and contains and other repository content.

**Location**: `doc/tutorials/features2d/akaze_tracking`
...
|-----------|------|------|---------------|----------|
| [akaze_tracking.markdown](../../../../../doc/tutorials/features2d/akaze_tracking/akaze_tracking.markdown) | MARKDOWN | 4.6KB | [docs](akaze_tracking.markdown_docs.md) | [keywords](akaze_tracking.markdown_kw.md) |
