# Documentation for `doc/tutorials/features2d/feature_detection/`
...
**Path**: `doc/tutorials/features2d/feature_detection/`
**Direct Files**: 1
**Subfolders**: 1
...
- **[feature_detection.markdown](feature_detection.markdown_docs.md)**: MARKDOWN file
