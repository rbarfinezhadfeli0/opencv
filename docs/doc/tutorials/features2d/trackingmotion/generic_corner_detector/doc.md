# Documentation for `doc/tutorials/features2d/trackingmotion/generic_corner_detector/`
...
**Path**: `doc/tutorials/features2d/trackingmotion/generic_corner_detector/`
**Direct Files**: 1
**Subfolders**: 1
...
- **[generic_corner_detector.markdown](generic_corner_detector.markdown_docs.md)**: MARKDOWN file
...
- **Parent Folder**: [doc/tutorials/features2d/trackingmotion/](../trackingmotion/doc.md)
