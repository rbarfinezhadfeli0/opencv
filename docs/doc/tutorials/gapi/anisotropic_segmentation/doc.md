# Documentation for `doc/tutorials/gapi/anisotropic_segmentation/`
...
**Path**: `doc/tutorials/gapi/anisotropic_segmentation/`
**Direct Files**: 1
**Subfolders**: 1
...
- **[porting_anisotropic_segmentation.markdown](porting_anisotropic_segmentation.markdown_docs.md)**: MARKDOWN file
...
- **Parent Folder**: [doc/tutorials/gapi/](../gapi/doc.md)
