# Documentation for `doc/tutorials/gapi/anisotropic_segmentation/pics/`
...
**Path**: `doc/tutorials/gapi/anisotropic_segmentation/pics/`
**Direct Files**: 6
**Subfolders**: 0
...
- **[result.jpg](result.jpg_docs.md)**: JPG file
- **[segm_fluid.gif](segm_fluid.gif_docs.md)**: GIF file
- **[massif_export_ocv.png](massif_export_ocv.png_docs.md)**: PNG file
- **[massif_export_gapi_fluid.png](massif_export_gapi_fluid.png_docs.md)**: PNG file
- **[massif_export_gapi.png](massif_export_gapi.png_docs.md)**: PNG file
- **[segm.gif](segm.gif_docs.md)**: GIF file
...
- **Parent Folder**: [doc/tutorials/gapi/anisotropic_segmentation/](../anisotropic_segmentation/doc.md)
