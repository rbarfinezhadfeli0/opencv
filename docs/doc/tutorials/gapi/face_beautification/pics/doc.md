# Documentation for `doc/tutorials/gapi/face_beautification/pics/`
...
**Path**: `doc/tutorials/gapi/face_beautification/pics/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[example.jpg](example.jpg_docs.md)**: JPG file
...
- **Parent Folder**: [doc/tutorials/gapi/face_beautification/](../face_beautification/doc.md)
