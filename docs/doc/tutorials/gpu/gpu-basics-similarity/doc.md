# Documentation for `doc/tutorials/gpu/gpu-basics-similarity/`
...
**Path**: `doc/tutorials/gpu/gpu-basics-similarity/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[gpu_basics_similarity.markdown](gpu_basics_similarity.markdown_docs.md)**: MARKDOWN file
