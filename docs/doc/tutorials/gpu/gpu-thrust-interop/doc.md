# Documentation for `doc/tutorials/gpu/gpu-thrust-interop/`
...
**Path**: `doc/tutorials/gpu/gpu-thrust-interop/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[gpu_thrust_interop.markdown](gpu_thrust_interop.markdown_docs.md)**: MARKDOWN file
