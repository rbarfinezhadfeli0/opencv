# Documentation for `doc/tutorials/gpu/images/`
...
- **[gpu-basics-similarity.png](gpu-basics-similarity.png_docs.md)**: PNG file
...
- **Parent Folder**: [doc/tutorials/gpu/](../gpu/doc.md)
