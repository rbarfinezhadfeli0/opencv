# Index of `doc/tutorials/imgproc/anisotropic_image_segmentation/`

## Overview

This folder is part of the OpenCV repository structure and contains and other repository content.

**Location**: `doc/tutorials/imgproc/anisotropic_image_segmentation`
...
|-----------|------|------|---------------|----------|
| [anisotropic_image_segmentation.markdown](../../../../../doc/tutorials/imgproc/anisotropic_image_segmentation/anisotropic_image_segmentation.markdown) | MARKDOWN | 6.3KB | [docs](anisotropic_image_segmentation.markdown_docs.md) | [keywords](anisotropic_image_segmentation.markdown_kw.md) |
