# Documentation for `doc/tutorials/imgproc/hitOrMiss/images/`
...
**Path**: `doc/tutorials/imgproc/hitOrMiss/images/`
**Direct Files**: 5
**Subfolders**: 0
...
- **[hitmiss_example2.png](hitmiss_example2.png_docs.md)**: PNG file
- **[hitmiss_example3.png](hitmiss_example3.png_docs.md)**: PNG file
- **[hitmiss_input.png](hitmiss_input.png_docs.md)**: PNG file
- **[hitmiss_kernels.png](hitmiss_kernels.png_docs.md)**: PNG file
- **[hitmiss_output.png](hitmiss_output.png_docs.md)**: PNG file
...
- **Parent Folder**: [doc/tutorials/imgproc/hitOrMiss/](../hitOrMiss/doc.md)
