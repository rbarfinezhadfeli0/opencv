# Index of `doc/tutorials/imgproc/imgtrans/canny_detector/`

## Overview

This folder is part of the OpenCV repository structure and contains and other repository content.

**Location**: `doc/tutorials/imgproc/imgtrans/canny_detector`
...
|-----------|------|------|---------------|----------|
| [canny_detector.markdown](../../../../../../doc/tutorials/imgproc/imgtrans/canny_detector/canny_detector.markdown) | MARKDOWN | 7.4KB | [docs](canny_detector.markdown_docs.md) | [keywords](canny_detector.markdown_kw.md) |
