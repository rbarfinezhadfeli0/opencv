# Index of `doc/tutorials/imgproc/imgtrans/copyMakeBorder/`

## Overview

This folder is part of the OpenCV repository structure and contains and other repository content.

**Location**: `doc/tutorials/imgproc/imgtrans/copyMakeBorder`
...
|-----------|------|------|---------------|----------|
| [copyMakeBorder.markdown](../../../../../../doc/tutorials/imgproc/imgtrans/copyMakeBorder/copyMakeBorder.markdown) | MARKDOWN | 7.7KB | [docs](copyMakeBorder.markdown_docs.md) | [keywords](copyMakeBorder.markdown_kw.md) |
