# Documentation for `doc/tutorials/imgproc/imgtrans/laplace_operator/`
...
**Path**: `doc/tutorials/imgproc/imgtrans/laplace_operator/`
**Direct Files**: 1
**Subfolders**: 1
...
- **[laplace_operator.markdown](laplace_operator.markdown_docs.md)**: MARKDOWN file
