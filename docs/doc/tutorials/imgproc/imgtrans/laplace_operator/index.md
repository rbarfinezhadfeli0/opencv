# Index of `doc/tutorials/imgproc/imgtrans/laplace_operator/`

## Overview

This folder is part of the OpenCV repository structure and contains and other repository content.

**Location**: `doc/tutorials/imgproc/imgtrans/laplace_operator`
...
|-----------|------|------|---------------|----------|
| [laplace_operator.markdown](../../../../../../doc/tutorials/imgproc/imgtrans/laplace_operator/laplace_operator.markdown) | MARKDOWN | 6.4KB | [docs](laplace_operator.markdown_docs.md) | [keywords](laplace_operator.markdown_kw.md) |
