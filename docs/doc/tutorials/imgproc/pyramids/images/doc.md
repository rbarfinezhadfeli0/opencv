# Documentation for `doc/tutorials/imgproc/pyramids/images/`
...
**Path**: `doc/tutorials/imgproc/pyramids/images/`
**Direct Files**: 4
**Subfolders**: 0
...
- **[Pyramids_Tutorial_Pyramid_Theory.png](Pyramids_Tutorial_Pyramid_Theory.png_docs.md)**: PNG file
- **[Pyramids_Tutorial_PyrUp_Result.jpg](Pyramids_Tutorial_PyrUp_Result.jpg_docs.md)**: JPG file
- **[Pyramids_Tutorial_PyrDown_Result.jpg](Pyramids_Tutorial_PyrDown_Result.jpg_docs.md)**: JPG file
- **[Pyramids_Tutorial_Original_Image.jpg](Pyramids_Tutorial_Original_Image.jpg_docs.md)**: JPG file
...
- **Parent Folder**: [doc/tutorials/imgproc/pyramids/](../pyramids/doc.md)
