# Documentation for `doc/tutorials/imgproc/shapedescriptors/point_polygon_test/images/`
...
**Path**: `doc/tutorials/imgproc/shapedescriptors/point_polygon_test/images/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[Point_Polygon_Test_Result.jpg](Point_Polygon_Test_Result.jpg_docs.md)**: JPG file
- **[Point_Polygon_Test_Source_Image.png](Point_Polygon_Test_Source_Image.png_docs.md)**: PNG file
...
- **Parent Folder**: [doc/tutorials/imgproc/shapedescriptors/point_polygon_test/](../point_polygon_test/doc.md)
