# Documentation for `doc/tutorials/imgproc/shapedescriptors/point_polygon_test/point_polygon_test.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/imgproc/shapedescriptors/point_polygon_test/point_polygon_test.markdown`
- **File Name**: `point_polygon_test.markdown`
- **File Size**: 1,517 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/imgproc/shapedescriptors/point_polygon_test/point_polygon_test.markdown](../../../../../doc/tutorials/imgproc/shapedescriptors/point_polygon_test/point_polygon_test.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/imgproc/shapedescriptors/point_polygon_test` directory and serves as part of the OpenCV library infrastructure.
