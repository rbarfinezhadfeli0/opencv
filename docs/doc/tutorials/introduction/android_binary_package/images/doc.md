# Documentation for `doc/tutorials/introduction/android_binary_package/images/`
...
**Path**: `doc/tutorials/introduction/android_binary_package/images/`
**Direct Files**: 28
**Subfolders**: 0
...
- **[setup_project.png](setup_project.png_docs.md)**: PNG file
...
- **Parent Folder**: [doc/tutorials/introduction/android_binary_package/](../android_binary_package/doc.md)
