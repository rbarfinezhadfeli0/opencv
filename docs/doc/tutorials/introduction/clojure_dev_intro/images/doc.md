# Documentation for `doc/tutorials/introduction/clojure_dev_intro/images/`
...
**Path**: `doc/tutorials/introduction/clojure_dev_intro/images/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[blurred.png](blurred.png_docs.md)**: PNG file
...
- **Parent Folder**: [doc/tutorials/introduction/clojure_dev_intro/](../clojure_dev_intro/doc.md)
