# Documentation for `doc/tutorials/introduction/linux_gcc_cmake/images/`
...
**Path**: `doc/tutorials/introduction/linux_gcc_cmake/images/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[GCC_CMake_Example_Tutorial.jpg](GCC_CMake_Example_Tutorial.jpg_docs.md)**: JPG file
...
- **Parent Folder**: [doc/tutorials/introduction/linux_gcc_cmake/](../linux_gcc_cmake/doc.md)
