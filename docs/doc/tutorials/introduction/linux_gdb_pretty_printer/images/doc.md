# Documentation for `doc/tutorials/introduction/linux_gdb_pretty_printer/images/`
...
**Path**: `doc/tutorials/introduction/linux_gdb_pretty_printer/images/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[example.png](example.png_docs.md)**: PNG file
...
- **Parent Folder**: [doc/tutorials/introduction/linux_gdb_pretty_printer/](../linux_gdb_pretty_printer/doc.md)
