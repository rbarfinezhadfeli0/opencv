# Documentation for `doc/tutorials/ios/hello/images/`
...
**Path**: `doc/tutorials/ios/hello/images/`
**Direct Files**: 4
**Subfolders**: 0
...
- **[header_directive.png](header_directive.png_docs.md)**: PNG file
- **[ios_hello_output.png](ios_hello_output.png_docs.md)**: PNG file
- **[linking_opencv_ios.png](linking_opencv_ios.png_docs.md)**: PNG file
- **[view_did_load.png](view_did_load.png_docs.md)**: PNG file
...
- **Parent Folder**: [doc/tutorials/ios/hello/](../hello/doc.md)
