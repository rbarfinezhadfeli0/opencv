# Index of `doc/tutorials/objdetect/aruco_board_detection/`

## Overview

This folder is part of the OpenCV repository structure and contains and other repository content.

**Location**: `doc/tutorials/objdetect/aruco_board_detection`
...
|-----------|------|------|---------------|----------|
| [aruco_board_detection.markdown](../../../../../doc/tutorials/objdetect/aruco_board_detection/aruco_board_detection.markdown) | MARKDOWN | 10.0KB | [docs](aruco_board_detection.markdown_docs.md) | [keywords](aruco_board_detection.markdown_kw.md) |
