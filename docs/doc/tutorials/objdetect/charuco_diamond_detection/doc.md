# Documentation for `doc/tutorials/objdetect/charuco_diamond_detection/`
...
**Path**: `doc/tutorials/objdetect/charuco_diamond_detection/`
**Direct Files**: 1
**Subfolders**: 1
...
- **[charuco_diamond_detection.markdown](charuco_diamond_detection.markdown_docs.md)**: MARKDOWN file
...
- **Parent Folder**: [doc/tutorials/objdetect/](../objdetect/doc.md)
