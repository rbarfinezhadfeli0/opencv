# Documentation for `docs/3rdparty/fastcv/fastcv.cmake_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/fastcv/fastcv.cmake_docs.md`
- **File Name**: `fastcv.cmake_docs.md`
- **File Size**: 2,495 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/fastcv/fastcv.cmake_docs.md](../../../docs/3rdparty/fastcv/fastcv.cmake_docs.md)

## Purpose and Role

This file is located in the `docs/3rdparty/fastcv` directory and serves as part of the OpenCV library infrastructure.

## Documentation Content

# Documentation for `3rdparty/fastcv/fastcv.cmake`

## File Metadata

- **Full Path**: `3rdparty/fastcv/fastcv.cmake`
- **File Name**: `fastcv.cmake`
- **File Size**: 1,548 bytes
- **File Type**: .cmake
- **Link to Source**: [3rdparty/fastcv/fastcv.cmake](../../3rdparty/fastcv/fastcv.cmake)

## Purpose and Role

This file is located in the `3rdparty/fastcv` directory and serves as part of the OpenCV library infrastructure.
