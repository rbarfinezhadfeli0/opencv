# Documentation for `docs/3rdparty/ffmpeg/ffmpeg-download.ps1.in_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/ffmpeg/ffmpeg-download.ps1.in_docs.md`
- **File Name**: `ffmpeg-download.ps1.in_docs.md`
- **File Size**: 3,478 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/ffmpeg/ffmpeg-download.ps1.in_docs.md](../../../docs/3rdparty/ffmpeg/ffmpeg-download.ps1.in_docs.md)
...
# Documentation for `3rdparty/ffmpeg/ffmpeg-download.ps1.in`

## File Metadata

- **Full Path**: `3rdparty/ffmpeg/ffmpeg-download.ps1.in`
- **File Name**: `ffmpeg-download.ps1.in`
- **File Size**: 2,971 bytes
- **File Type**: .in
- **Link to Source**: [3rdparty/ffmpeg/ffmpeg-download.ps1.in](../../3rdparty/ffmpeg/ffmpeg-download.ps1.in)

## Purpose and Role

This file is located in the `3rdparty/ffmpeg` directory and serves as part of the OpenCV library infrastructure.
