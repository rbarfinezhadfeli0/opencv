# Documentation for `docs/3rdparty/ffmpeg/readme.txt_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/ffmpeg/readme.txt_docs.md`
- **File Name**: `readme.txt_docs.md`
- **File Size**: 3,402 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/ffmpeg/readme.txt_docs.md](../../../docs/3rdparty/ffmpeg/readme.txt_docs.md)
...
# Documentation for `3rdparty/ffmpeg/readme.txt`

## File Metadata

- **Full Path**: `3rdparty/ffmpeg/readme.txt`
- **File Name**: `readme.txt`
- **File Size**: 2,467 bytes
- **File Type**: .txt
- **Link to Source**: [3rdparty/ffmpeg/readme.txt](../../3rdparty/ffmpeg/readme.txt)
