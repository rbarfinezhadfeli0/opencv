# Documentation for `docs/3rdparty/ittnotify/src/ittnotify/ittnotify_static.h_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/ittnotify/src/ittnotify/ittnotify_static.h_docs.md`
- **File Name**: `ittnotify_static.h_docs.md`
- **File Size**: 46,079 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/ittnotify/src/ittnotify/ittnotify_static.h_docs.md](../../../../../docs/3rdparty/ittnotify/src/ittnotify/ittnotify_static.h_docs.md)
...
# Documentation for `3rdparty/ittnotify/src/ittnotify/ittnotify_static.h`

## File Metadata

- **Full Path**: `3rdparty/ittnotify/src/ittnotify/ittnotify_static.h`
- **File Name**: `ittnotify_static.h`
- **File Size**: 42,618 bytes
- **File Type**: .h
- **Link to Source**: [3rdparty/ittnotify/src/ittnotify/ittnotify_static.h](../../../../3rdparty/ittnotify/src/ittnotify/ittnotify_static.h)
...
- **ITT_FORMAT()**: A function/method defined in this file
- **ITT_FORMAT_DEFINED()**: A function/method defined in this file
- **h()**: A function/method defined in this file
- **fn()**: A function/method defined in this file
- **__ITT_INTERNAL_BODY()**: A function/method defined in this file
- **__ITT_INTERNAL_INIT()**: A function/method defined in this file
- **ITT_NO_PARAMS()**: A function/method defined in this file
