# Documentation for `docs/3rdparty/libjasper/CMakeLists.txt_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libjasper/CMakeLists.txt_docs.md`
- **File Name**: `CMakeLists.txt_docs.md`
- **File Size**: 3,156 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libjasper/CMakeLists.txt_docs.md](../../../docs/3rdparty/libjasper/CMakeLists.txt_docs.md)
