# Documentation for `docs/3rdparty/libjasper/changelog_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libjasper/changelog_docs.md`
- **File Name**: `changelog_docs.md`
- **File Size**: 6,145 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libjasper/changelog_docs.md](../../../docs/3rdparty/libjasper/changelog_docs.md)
...
# Documentation for `3rdparty/libjasper/changelog`

## File Metadata

- **Full Path**: `3rdparty/libjasper/changelog`
- **File Name**: `changelog`
- **File Size**: 5,600 bytes
- **File Type**: no extension
- **Link to Source**: [3rdparty/libjasper/changelog](../../3rdparty/libjasper/changelog)
