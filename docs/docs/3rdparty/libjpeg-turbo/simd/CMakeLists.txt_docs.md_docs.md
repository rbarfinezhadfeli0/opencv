# Documentation for `docs/3rdparty/libjpeg-turbo/simd/CMakeLists.txt_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libjpeg-turbo/simd/CMakeLists.txt_docs.md`
- **File Name**: `CMakeLists.txt_docs.md`
- **File Size**: 20,978 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libjpeg-turbo/simd/CMakeLists.txt_docs.md](../../../../docs/3rdparty/libjpeg-turbo/simd/CMakeLists.txt_docs.md)
...
# Documentation for `3rdparty/libjpeg-turbo/simd/CMakeLists.txt`

## File Metadata

- **Full Path**: `3rdparty/libjpeg-turbo/simd/CMakeLists.txt`
- **File Name**: `CMakeLists.txt`
- **File Size**: 19,959 bytes
- **File Type**: .txt
- **Link to Source**: [3rdparty/libjpeg-turbo/simd/CMakeLists.txt](../../../3rdparty/libjpeg-turbo/simd/CMakeLists.txt)
