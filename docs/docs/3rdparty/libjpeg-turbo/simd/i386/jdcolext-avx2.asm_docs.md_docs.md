# Documentation for `docs/3rdparty/libjpeg-turbo/simd/i386/jdcolext-avx2.asm_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libjpeg-turbo/simd/i386/jdcolext-avx2.asm_docs.md`
- **File Name**: `jdcolext-avx2.asm_docs.md`
- **File Size**: 25,496 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libjpeg-turbo/simd/i386/jdcolext-avx2.asm_docs.md](../../../../../docs/3rdparty/libjpeg-turbo/simd/i386/jdcolext-avx2.asm_docs.md)
...
# Documentation for `3rdparty/libjpeg-turbo/simd/i386/jdcolext-avx2.asm`

## File Metadata

- **Full Path**: `3rdparty/libjpeg-turbo/simd/i386/jdcolext-avx2.asm`
- **File Name**: `jdcolext-avx2.asm`
- **File Size**: 24,842 bytes
- **File Type**: .asm
- **Link to Source**: [3rdparty/libjpeg-turbo/simd/i386/jdcolext-avx2.asm](../../../../3rdparty/libjpeg-turbo/simd/i386/jdcolext-avx2.asm)
