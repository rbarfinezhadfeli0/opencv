# Documentation for `docs/3rdparty/libjpeg-turbo/simd/i386/jdsample-avx2.asm_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libjpeg-turbo/simd/i386/jdsample-avx2.asm_docs.md`
- **File Name**: `jdsample-avx2.asm_docs.md`
- **File Size**: 31,667 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libjpeg-turbo/simd/i386/jdsample-avx2.asm_docs.md](../../../../../docs/3rdparty/libjpeg-turbo/simd/i386/jdsample-avx2.asm_docs.md)
...
# Documentation for `3rdparty/libjpeg-turbo/simd/i386/jdsample-avx2.asm`

## File Metadata

- **Full Path**: `3rdparty/libjpeg-turbo/simd/i386/jdsample-avx2.asm`
- **File Name**: `jdsample-avx2.asm`
- **File Size**: 31,013 bytes
- **File Type**: .asm
- **Link to Source**: [3rdparty/libjpeg-turbo/simd/i386/jdsample-avx2.asm](../../../../3rdparty/libjpeg-turbo/simd/i386/jdsample-avx2.asm)
