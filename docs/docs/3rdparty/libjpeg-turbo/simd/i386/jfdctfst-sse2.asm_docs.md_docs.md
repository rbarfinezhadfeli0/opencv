# Documentation for `docs/3rdparty/libjpeg-turbo/simd/i386/jfdctfst-sse2.asm_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libjpeg-turbo/simd/i386/jfdctfst-sse2.asm_docs.md`
- **File Name**: `jfdctfst-sse2.asm_docs.md`
- **File Size**: 18,326 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libjpeg-turbo/simd/i386/jfdctfst-sse2.asm_docs.md](../../../../../docs/3rdparty/libjpeg-turbo/simd/i386/jfdctfst-sse2.asm_docs.md)
...
# Documentation for `3rdparty/libjpeg-turbo/simd/i386/jfdctfst-sse2.asm`

## File Metadata

- **Full Path**: `3rdparty/libjpeg-turbo/simd/i386/jfdctfst-sse2.asm`
- **File Name**: `jfdctfst-sse2.asm`
- **File Size**: 17,672 bytes
- **File Type**: .asm
- **Link to Source**: [3rdparty/libjpeg-turbo/simd/i386/jfdctfst-sse2.asm](../../../../3rdparty/libjpeg-turbo/simd/i386/jfdctfst-sse2.asm)
