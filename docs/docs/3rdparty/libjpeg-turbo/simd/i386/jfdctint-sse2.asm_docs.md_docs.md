# Documentation for `docs/3rdparty/libjpeg-turbo/simd/i386/jfdctint-sse2.asm_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libjpeg-turbo/simd/i386/jfdctint-sse2.asm_docs.md`
- **File Name**: `jfdctint-sse2.asm_docs.md`
- **File Size**: 27,499 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libjpeg-turbo/simd/i386/jfdctint-sse2.asm_docs.md](../../../../../docs/3rdparty/libjpeg-turbo/simd/i386/jfdctint-sse2.asm_docs.md)
...
# Documentation for `3rdparty/libjpeg-turbo/simd/i386/jfdctint-sse2.asm`

## File Metadata

- **Full Path**: `3rdparty/libjpeg-turbo/simd/i386/jfdctint-sse2.asm`
- **File Name**: `jfdctint-sse2.asm`
- **File Size**: 26,845 bytes
- **File Type**: .asm
- **Link to Source**: [3rdparty/libjpeg-turbo/simd/i386/jfdctint-sse2.asm](../../../../3rdparty/libjpeg-turbo/simd/i386/jfdctint-sse2.asm)

## Purpose and Role

This file is located in the `3rdparty/libjpeg-turbo/simd/i386` directory and serves as part of the OpenCV library infrastructure.
