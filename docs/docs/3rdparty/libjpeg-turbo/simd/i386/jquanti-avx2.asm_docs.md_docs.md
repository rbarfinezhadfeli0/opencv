# Documentation for `docs/3rdparty/libjpeg-turbo/simd/i386/jquanti-avx2.asm_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libjpeg-turbo/simd/i386/jquanti-avx2.asm_docs.md`
- **File Name**: `jquanti-avx2.asm_docs.md`
- **File Size**: 7,345 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libjpeg-turbo/simd/i386/jquanti-avx2.asm_docs.md](../../../../../docs/3rdparty/libjpeg-turbo/simd/i386/jquanti-avx2.asm_docs.md)
...
# Documentation for `3rdparty/libjpeg-turbo/simd/i386/jquanti-avx2.asm`

## File Metadata

- **Full Path**: `3rdparty/libjpeg-turbo/simd/i386/jquanti-avx2.asm`
- **File Name**: `jquanti-avx2.asm`
- **File Size**: 6,697 bytes
- **File Type**: .asm
- **Link to Source**: [3rdparty/libjpeg-turbo/simd/i386/jquanti-avx2.asm](../../../../3rdparty/libjpeg-turbo/simd/i386/jquanti-avx2.asm)
