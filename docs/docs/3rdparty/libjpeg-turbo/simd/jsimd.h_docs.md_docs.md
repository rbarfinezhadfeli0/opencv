# Documentation for `docs/3rdparty/libjpeg-turbo/simd/jsimd.h_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libjpeg-turbo/simd/jsimd.h_docs.md`
- **File Name**: `jsimd.h_docs.md`
- **File Size**: 59,930 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libjpeg-turbo/simd/jsimd.h_docs.md](../../../../docs/3rdparty/libjpeg-turbo/simd/jsimd.h_docs.md)

## Purpose and Role

This file is located in the `docs/3rdparty/libjpeg-turbo/simd` directory and serves as part of the OpenCV library infrastructure.

## Documentation Content

# Documentation for `3rdparty/libjpeg-turbo/simd/jsimd.h`

## File Metadata

- **Full Path**: `3rdparty/libjpeg-turbo/simd/jsimd.h`
- **File Name**: `jsimd.h`
- **File Size**: 56,955 bytes
- **File Type**: .h
- **Link to Source**: [3rdparty/libjpeg-turbo/simd/jsimd.h](../../../3rdparty/libjpeg-turbo/simd/jsimd.h)

## Purpose and Role

This file is located in the `3rdparty/libjpeg-turbo/simd` directory and serves as part of the OpenCV library infrastructure.
...
- **NEON_INTRINSICS()**: A function/method defined in this file
