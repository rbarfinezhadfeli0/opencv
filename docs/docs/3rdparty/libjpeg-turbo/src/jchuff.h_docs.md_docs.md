# Documentation for `docs/3rdparty/libjpeg-turbo/src/jchuff.h_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libjpeg-turbo/src/jchuff.h_docs.md`
- **File Name**: `jchuff.h_docs.md`
- **File Size**: 4,788 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libjpeg-turbo/src/jchuff.h_docs.md](../../../../docs/3rdparty/libjpeg-turbo/src/jchuff.h_docs.md)
