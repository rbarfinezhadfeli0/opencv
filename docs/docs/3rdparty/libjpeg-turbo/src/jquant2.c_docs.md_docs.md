# Documentation for `docs/3rdparty/libjpeg-turbo/src/jquant2.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libjpeg-turbo/src/jquant2.c_docs.md`
- **File Name**: `jquant2.c_docs.md`
- **File Size**: 53,271 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libjpeg-turbo/src/jquant2.c_docs.md](../../../../docs/3rdparty/libjpeg-turbo/src/jquant2.c_docs.md)
...
# Documentation for `3rdparty/libjpeg-turbo/src/jquant2.c`

## File Metadata

- **Full Path**: `3rdparty/libjpeg-turbo/src/jquant2.c`
- **File Name**: `jquant2.c`
- **File Size**: 49,272 bytes
- **File Type**: .c
- **Link to Source**: [3rdparty/libjpeg-turbo/src/jquant2.c](../../../3rdparty/libjpeg-turbo/src/jquant2.c)
