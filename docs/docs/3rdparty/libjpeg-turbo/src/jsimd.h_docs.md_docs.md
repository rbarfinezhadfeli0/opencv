# Documentation for `docs/3rdparty/libjpeg-turbo/src/jsimd.h_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libjpeg-turbo/src/jsimd.h_docs.md`
- **File Name**: `jsimd.h_docs.md`
- **File Size**: 8,904 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libjpeg-turbo/src/jsimd.h_docs.md](../../../../docs/3rdparty/libjpeg-turbo/src/jsimd.h_docs.md)
