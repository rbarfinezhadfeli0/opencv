# Documentation for `docs/3rdparty/libjpeg-turbo/src/structure.txt_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libjpeg-turbo/src/structure.txt_docs.md`
- **File Name**: `structure.txt_docs.md`
- **File Size**: 51,025 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libjpeg-turbo/src/structure.txt_docs.md](../../../../docs/3rdparty/libjpeg-turbo/src/structure.txt_docs.md)
...
# Documentation for `3rdparty/libjpeg-turbo/src/structure.txt`

## File Metadata

- **Full Path**: `3rdparty/libjpeg-turbo/src/structure.txt`
- **File Name**: `structure.txt`
- **File Size**: 53,399 bytes
- **File Type**: .txt
- **Link to Source**: [3rdparty/libjpeg-turbo/src/structure.txt](../../../3rdparty/libjpeg-turbo/src/structure.txt)
