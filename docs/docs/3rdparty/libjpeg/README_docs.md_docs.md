# Documentation for `docs/3rdparty/libjpeg/README_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libjpeg/README_docs.md`
- **File Name**: `README_docs.md`
- **File Size**: 19,105 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libjpeg/README_docs.md](../../../docs/3rdparty/libjpeg/README_docs.md)
...
# Documentation for `3rdparty/libjpeg/README`

## File Metadata

- **Full Path**: `3rdparty/libjpeg/README`
- **File Name**: `README`
- **File Size**: 18,584 bytes
- **File Type**: no extension
- **Link to Source**: [3rdparty/libjpeg/README](../../3rdparty/libjpeg/README)
