# Documentation for `docs/3rdparty/libjpeg/change.log_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libjpeg/change.log_docs.md`
- **File Name**: `change.log_docs.md`
- **File Size**: 20,164 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libjpeg/change.log_docs.md](../../../docs/3rdparty/libjpeg/change.log_docs.md)
...
# Documentation for `3rdparty/libjpeg/change.log`

## File Metadata

- **Full Path**: `3rdparty/libjpeg/change.log`
- **File Name**: `change.log`
- **File Size**: 19,631 bytes
- **File Type**: .log
- **Link to Source**: [3rdparty/libjpeg/change.log](../../3rdparty/libjpeg/change.log)
