# Documentation for `docs/3rdparty/libjpeg/jcarith.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libjpeg/jcarith.c_docs.md`
- **File Name**: `jcarith.c_docs.md`
- **File Size**: 31,641 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libjpeg/jcarith.c_docs.md](../../../docs/3rdparty/libjpeg/jcarith.c_docs.md)
...
# Documentation for `3rdparty/libjpeg/jcarith.c`

## File Metadata

- **Full Path**: `3rdparty/libjpeg/jcarith.c`
- **File Name**: `jcarith.c`
- **File Size**: 28,260 bytes
- **File Type**: .c
- **Link to Source**: [3rdparty/libjpeg/jcarith.c](../../3rdparty/libjpeg/jcarith.c)
