# Documentation for `docs/3rdparty/libjpeg/jcdctmgr.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libjpeg/jcdctmgr.c_docs.md`
- **File Name**: `jcdctmgr.c_docs.md`
- **File Size**: 18,935 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libjpeg/jcdctmgr.c_docs.md](../../../docs/3rdparty/libjpeg/jcdctmgr.c_docs.md)
...
# Documentation for `3rdparty/libjpeg/jcdctmgr.c`

## File Metadata

- **Full Path**: `3rdparty/libjpeg/jcdctmgr.c`
- **File Name**: `jcdctmgr.c`
- **File Size**: 15,305 bytes
- **File Type**: .c
- **Link to Source**: [3rdparty/libjpeg/jcdctmgr.c](../../3rdparty/libjpeg/jcdctmgr.c)
