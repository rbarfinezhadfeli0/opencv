# Documentation for `docs/3rdparty/libjpeg/jcmaster.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libjpeg/jcmaster.c_docs.md`
- **File Name**: `jcmaster.c_docs.md`
- **File Size**: 26,506 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libjpeg/jcmaster.c_docs.md](../../../docs/3rdparty/libjpeg/jcmaster.c_docs.md)
...
# Documentation for `3rdparty/libjpeg/jcmaster.c`

## File Metadata

- **Full Path**: `3rdparty/libjpeg/jcmaster.c`
- **File Name**: `jcmaster.c`
- **File Size**: 23,010 bytes
- **File Type**: .c
- **Link to Source**: [3rdparty/libjpeg/jcmaster.c](../../3rdparty/libjpeg/jcmaster.c)
