# Documentation for `docs/3rdparty/libjpeg/jcomapi.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libjpeg/jcomapi.c_docs.md`
- **File Name**: `jcomapi.c_docs.md`
- **File Size**: 11,166 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libjpeg/jcomapi.c_docs.md](../../../docs/3rdparty/libjpeg/jcomapi.c_docs.md)
...
# Documentation for `3rdparty/libjpeg/jcomapi.c`

## File Metadata

- **Full Path**: `3rdparty/libjpeg/jcomapi.c`
- **File Name**: `jcomapi.c`
- **File Size**: 8,114 bytes
- **File Type**: .c
- **Link to Source**: [3rdparty/libjpeg/jcomapi.c](../../3rdparty/libjpeg/jcomapi.c)
