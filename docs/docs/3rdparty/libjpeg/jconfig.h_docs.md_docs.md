# Documentation for `docs/3rdparty/libjpeg/jconfig.h_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libjpeg/jconfig.h_docs.md`
- **File Name**: `jconfig.h_docs.md`
- **File Size**: 6,322 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libjpeg/jconfig.h_docs.md](../../../docs/3rdparty/libjpeg/jconfig.h_docs.md)
