# Documentation for `docs/3rdparty/libjpeg/jcparam.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libjpeg/jcparam.c_docs.md`
- **File Name**: `jcparam.c_docs.md`
- **File Size**: 23,131 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libjpeg/jcparam.c_docs.md](../../../docs/3rdparty/libjpeg/jcparam.c_docs.md)
...
# Documentation for `3rdparty/libjpeg/jcparam.c`

## File Metadata

- **Full Path**: `3rdparty/libjpeg/jcparam.c`
- **File Name**: `jcparam.c`
- **File Size**: 20,124 bytes
- **File Type**: .c
- **Link to Source**: [3rdparty/libjpeg/jcparam.c](../../3rdparty/libjpeg/jcparam.c)
