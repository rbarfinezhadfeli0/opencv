# Documentation for `docs/3rdparty/libjpeg/jctrans.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libjpeg/jctrans.c_docs.md`
- **File Name**: `jctrans.c_docs.md`
- **File Size**: 17,691 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libjpeg/jctrans.c_docs.md](../../../docs/3rdparty/libjpeg/jctrans.c_docs.md)
...
# Documentation for `3rdparty/libjpeg/jctrans.c`

## File Metadata

- **Full Path**: `3rdparty/libjpeg/jctrans.c`
- **File Name**: `jctrans.c`
- **File Size**: 14,465 bytes
- **File Type**: .c
- **Link to Source**: [3rdparty/libjpeg/jctrans.c](../../3rdparty/libjpeg/jctrans.c)
