# Documentation for `docs/3rdparty/libjpeg/jdarith.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libjpeg/jdarith.c_docs.md`
- **File Name**: `jdarith.c_docs.md`
- **File Size**: 27,533 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libjpeg/jdarith.c_docs.md](../../../docs/3rdparty/libjpeg/jdarith.c_docs.md)
...
# Documentation for `3rdparty/libjpeg/jdarith.c`

## File Metadata

- **Full Path**: `3rdparty/libjpeg/jdarith.c`
- **File Name**: `jdarith.c`
- **File Size**: 24,277 bytes
- **File Type**: .c
- **Link to Source**: [3rdparty/libjpeg/jdarith.c](../../3rdparty/libjpeg/jdarith.c)
