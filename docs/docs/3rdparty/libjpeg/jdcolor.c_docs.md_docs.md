# Documentation for `docs/3rdparty/libjpeg/jdcolor.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libjpeg/jdcolor.c_docs.md`
- **File Name**: `jdcolor.c_docs.md`
- **File Size**: 28,189 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libjpeg/jdcolor.c_docs.md](../../../docs/3rdparty/libjpeg/jdcolor.c_docs.md)
...
# Documentation for `3rdparty/libjpeg/jdcolor.c`

## File Metadata

- **Full Path**: `3rdparty/libjpeg/jdcolor.c`
- **File Name**: `jdcolor.c`
- **File Size**: 25,002 bytes
- **File Type**: .c
- **Link to Source**: [3rdparty/libjpeg/jdcolor.c](../../3rdparty/libjpeg/jdcolor.c)
