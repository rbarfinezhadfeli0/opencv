# Documentation for `docs/3rdparty/libjpeg/jdinput.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libjpeg/jdinput.c_docs.md`
- **File Name**: `jdinput.c_docs.md`
- **File Size**: 28,286 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libjpeg/jdinput.c_docs.md](../../../docs/3rdparty/libjpeg/jdinput.c_docs.md)
...
# Documentation for `3rdparty/libjpeg/jdinput.c`

## File Metadata

- **Full Path**: `3rdparty/libjpeg/jdinput.c`
- **File Name**: `jdinput.c`
- **File Size**: 24,923 bytes
- **File Type**: .c
- **Link to Source**: [3rdparty/libjpeg/jdinput.c](../../3rdparty/libjpeg/jdinput.c)
