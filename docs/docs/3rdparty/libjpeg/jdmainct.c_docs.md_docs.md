# Documentation for `docs/3rdparty/libjpeg/jdmainct.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libjpeg/jdmainct.c_docs.md`
- **File Name**: `jdmainct.c_docs.md`
- **File Size**: 24,030 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libjpeg/jdmainct.c_docs.md](../../../docs/3rdparty/libjpeg/jdmainct.c_docs.md)
...
# Documentation for `3rdparty/libjpeg/jdmainct.c`

## File Metadata

- **Full Path**: `3rdparty/libjpeg/jdmainct.c`
- **File Name**: `jdmainct.c`
- **File Size**: 20,773 bytes
- **File Type**: .c
- **Link to Source**: [3rdparty/libjpeg/jdmainct.c](../../3rdparty/libjpeg/jdmainct.c)
