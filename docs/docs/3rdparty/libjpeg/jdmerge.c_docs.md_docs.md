# Documentation for `docs/3rdparty/libjpeg/jdmerge.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libjpeg/jdmerge.c_docs.md`
- **File Name**: `jdmerge.c_docs.md`
- **File Size**: 18,825 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libjpeg/jdmerge.c_docs.md](../../../docs/3rdparty/libjpeg/jdmerge.c_docs.md)
...
# Documentation for `3rdparty/libjpeg/jdmerge.c`

## File Metadata

- **Full Path**: `3rdparty/libjpeg/jdmerge.c`
- **File Name**: `jdmerge.c`
- **File Size**: 15,584 bytes
- **File Type**: .c
- **Link to Source**: [3rdparty/libjpeg/jdmerge.c](../../3rdparty/libjpeg/jdmerge.c)
