# Documentation for `docs/3rdparty/libjpeg/jidctfst.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libjpeg/jidctfst.c_docs.md`
- **File Name**: `jidctfst.c_docs.md`
- **File Size**: 15,940 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libjpeg/jidctfst.c_docs.md](../../../docs/3rdparty/libjpeg/jidctfst.c_docs.md)
...
# Documentation for `3rdparty/libjpeg/jidctfst.c`

## File Metadata

- **Full Path**: `3rdparty/libjpeg/jidctfst.c`
- **File Name**: `jidctfst.c`
- **File Size**: 12,718 bytes
- **File Type**: .c
- **Link to Source**: [3rdparty/libjpeg/jidctfst.c](../../3rdparty/libjpeg/jidctfst.c)
