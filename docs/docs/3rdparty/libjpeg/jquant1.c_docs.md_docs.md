# Documentation for `docs/3rdparty/libjpeg/jquant1.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libjpeg/jquant1.c_docs.md`
- **File Name**: `jquant1.c_docs.md`
- **File Size**: 34,773 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libjpeg/jquant1.c_docs.md](../../../docs/3rdparty/libjpeg/jquant1.c_docs.md)
...
# Documentation for `3rdparty/libjpeg/jquant1.c`

## File Metadata

- **Full Path**: `3rdparty/libjpeg/jquant1.c`
- **File Name**: `jquant1.c`
- **File Size**: 31,282 bytes
- **File Type**: .c
- **Link to Source**: [3rdparty/libjpeg/jquant1.c](../../3rdparty/libjpeg/jquant1.c)
