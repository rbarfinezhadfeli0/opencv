# Documentation for `docs/3rdparty/libpng/CHANGES_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libpng/CHANGES_docs.md`
- **File Name**: `CHANGES_docs.md`
- **File Size**: 50,538 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libpng/CHANGES_docs.md](../../../docs/3rdparty/libpng/CHANGES_docs.md)
...
# Documentation for `3rdparty/libpng/CHANGES`

## File Metadata

- **Full Path**: `3rdparty/libpng/CHANGES`
- **File Name**: `CHANGES`
- **File Size**: 310,666 bytes
- **File Type**: no extension
- **Link to Source**: [3rdparty/libpng/CHANGES](../../3rdparty/libpng/CHANGES)
...
Version 1.0.9beta2 [November 19, 2000]
  ...
  Add error message in png_set_compression_buffer_size() when malloc 
... [truncated]
```
