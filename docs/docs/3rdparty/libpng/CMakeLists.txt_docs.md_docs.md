# Documentation for `docs/3rdparty/libpng/CMakeLists.txt_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libpng/CMakeLists.txt_docs.md`
- **File Name**: `CMakeLists.txt_docs.md`
- **File Size**: 10,250 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libpng/CMakeLists.txt_docs.md](../../../docs/3rdparty/libpng/CMakeLists.txt_docs.md)
...
# Documentation for `3rdparty/libpng/CMakeLists.txt`

## File Metadata

- **Full Path**: `3rdparty/libpng/CMakeLists.txt`
- **File Name**: `CMakeLists.txt`
- **File Size**: 9,295 bytes
- **File Type**: .txt
- **Link to Source**: [3rdparty/libpng/CMakeLists.txt](../../3rdparty/libpng/CMakeLists.txt)
