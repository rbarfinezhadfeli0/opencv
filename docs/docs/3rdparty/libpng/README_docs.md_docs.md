# Documentation for `docs/3rdparty/libpng/README_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libpng/README_docs.md`
- **File Name**: `README_docs.md`
- **File Size**: 9,858 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libpng/README_docs.md](../../../docs/3rdparty/libpng/README_docs.md)
...
# Documentation for `3rdparty/libpng/README`

## File Metadata

- **Full Path**: `3rdparty/libpng/README`
- **File Name**: `README`
- **File Size**: 9,343 bytes
- **File Type**: no extension
- **Link to Source**: [3rdparty/libpng/README](../../3rdparty/libpng/README)
