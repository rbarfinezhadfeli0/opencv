# Documentation for `docs/3rdparty/libpng/intel/`
...
**Path**: `docs/3rdparty/libpng/intel/`
**Direct Files**: 4
**Subfolders**: 0
...
- **[intel_init.c_docs.md](intel_init.c_docs.md_docs.md)**: MD file
- **[intel_init.c_kw.md](intel_init.c_kw.md_docs.md)**: MD file
