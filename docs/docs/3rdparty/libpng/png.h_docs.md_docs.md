# Documentation for `docs/3rdparty/libpng/png.h_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libpng/png.h_docs.md`
- **File Name**: `png.h_docs.md`
- **File Size**: 106,863 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libpng/png.h_docs.md](../../../docs/3rdparty/libpng/png.h_docs.md)
