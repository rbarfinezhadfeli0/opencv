# Documentation for `docs/3rdparty/libpng/pnginfo.h_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libpng/pnginfo.h_docs.md`
- **File Name**: `pnginfo.h_docs.md`
- **File Size**: 17,089 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libpng/pnginfo.h_docs.md](../../../docs/3rdparty/libpng/pnginfo.h_docs.md)
