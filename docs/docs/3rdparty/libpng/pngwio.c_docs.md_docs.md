# Documentation for `docs/3rdparty/libpng/pngwio.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libpng/pngwio.c_docs.md`
- **File Name**: `pngwio.c_docs.md`
- **File Size**: 9,293 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libpng/pngwio.c_docs.md](../../../docs/3rdparty/libpng/pngwio.c_docs.md)
