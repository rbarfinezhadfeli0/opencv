# Documentation for `docs/3rdparty/libspng/CMakeLists.txt_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libspng/CMakeLists.txt_docs.md`
- **File Name**: `CMakeLists.txt_docs.md`
- **File Size**: 2,719 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libspng/CMakeLists.txt_docs.md](../../../docs/3rdparty/libspng/CMakeLists.txt_docs.md)
...
# Documentation for `3rdparty/libspng/CMakeLists.txt`

## File Metadata

- **Full Path**: `3rdparty/libspng/CMakeLists.txt`
- **File Name**: `CMakeLists.txt`
- **File Size**: 1,759 bytes
- **File Type**: .txt
- **Link to Source**: [3rdparty/libspng/CMakeLists.txt](../../3rdparty/libspng/CMakeLists.txt)
