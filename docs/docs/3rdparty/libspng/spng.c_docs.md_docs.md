# Documentation for `docs/3rdparty/libspng/spng.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libspng/spng.c_docs.md`
- **File Name**: `spng.c_docs.md`
- **File Size**: 105,200 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libspng/spng.c_docs.md](../../../docs/3rdparty/libspng/spng.c_docs.md)
