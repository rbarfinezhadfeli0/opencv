# Documentation for `docs/3rdparty/libtiff/CMakeLists.txt_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libtiff/CMakeLists.txt_docs.md`
- **File Name**: `CMakeLists.txt_docs.md`
- **File Size**: 15,182 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libtiff/CMakeLists.txt_docs.md](../../../docs/3rdparty/libtiff/CMakeLists.txt_docs.md)
...
# Documentation for `3rdparty/libtiff/CMakeLists.txt`

## File Metadata

- **Full Path**: `3rdparty/libtiff/CMakeLists.txt`
- **File Name**: `CMakeLists.txt`
- **File Size**: 14,221 bytes
- **File Type**: .txt
- **Link to Source**: [3rdparty/libtiff/CMakeLists.txt](../../3rdparty/libtiff/CMakeLists.txt)
