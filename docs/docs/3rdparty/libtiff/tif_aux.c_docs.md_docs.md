# Documentation for `docs/3rdparty/libtiff/tif_aux.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libtiff/tif_aux.c_docs.md`
- **File Name**: `tif_aux.c_docs.md`
- **File Size**: 16,175 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libtiff/tif_aux.c_docs.md](../../../docs/3rdparty/libtiff/tif_aux.c_docs.md)
...
# Documentation for `3rdparty/libtiff/tif_aux.c`

## File Metadata

- **Full Path**: `3rdparty/libtiff/tif_aux.c`
- **File Name**: `tif_aux.c`
- **File Size**: 13,240 bytes
- **File Type**: .c
- **Link to Source**: [3rdparty/libtiff/tif_aux.c](../../3rdparty/libtiff/tif_aux.c)
