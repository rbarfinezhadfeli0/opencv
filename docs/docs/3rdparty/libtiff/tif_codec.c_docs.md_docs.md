# Documentation for `docs/3rdparty/libtiff/tif_codec.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libtiff/tif_codec.c_docs.md`
- **File Name**: `tif_codec.c_docs.md`
- **File Size**: 8,942 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libtiff/tif_codec.c_docs.md](../../../docs/3rdparty/libtiff/tif_codec.c_docs.md)
