# Documentation for `docs/3rdparty/libtiff/tif_fax3.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libtiff/tif_fax3.c_docs.md`
- **File Name**: `tif_fax3.c_docs.md`
- **File Size**: 66,030 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libtiff/tif_fax3.c_docs.md](../../../docs/3rdparty/libtiff/tif_fax3.c_docs.md)
...
# Documentation for `3rdparty/libtiff/tif_fax3.c`

## File Metadata

- **Full Path**: `3rdparty/libtiff/tif_fax3.c`
- **File Name**: `tif_fax3.c`
- **File Size**: 62,462 bytes
- **File Type**: .c
- **Link to Source**: [3rdparty/libtiff/tif_fax3.c](../../3rdparty/libtiff/tif_fax3.c)
...
- **SWAP()**: A function/method defined in this file
- **EOF_REACHED_COUNT_THRESHOLD()**: A function/method defined in this file
...
- **ZERO()**: A function/method defined in this file
