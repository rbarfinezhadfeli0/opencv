# Documentation for `docs/3rdparty/libtiff/tif_jpeg_12.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libtiff/tif_jpeg_12.c_docs.md`
- **File Name**: `tif_jpeg_12.c_docs.md`
- **File Size**: 4,419 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libtiff/tif_jpeg_12.c_docs.md](../../../docs/3rdparty/libtiff/tif_jpeg_12.c_docs.md)
