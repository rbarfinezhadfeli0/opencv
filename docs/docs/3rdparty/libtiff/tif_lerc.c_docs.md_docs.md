# Documentation for `docs/3rdparty/libtiff/tif_lerc.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libtiff/tif_lerc.c_docs.md`
- **File Name**: `tif_lerc.c_docs.md`
- **File Size**: 53,123 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libtiff/tif_lerc.c_docs.md](../../../docs/3rdparty/libtiff/tif_lerc.c_docs.md)
...
# Documentation for `3rdparty/libtiff/tif_lerc.c`

## File Metadata

- **Full Path**: `3rdparty/libtiff/tif_lerc.c`
- **File Name**: `tif_lerc.c`
- **File Size**: 49,607 bytes
- **File Type**: .c
- **Link to Source**: [3rdparty/libtiff/tif_lerc.c](../../3rdparty/libtiff/tif_lerc.c)
...
- **libdeflate_decompressor**: A class/struct defined in this file
- **libdeflate_compressor**: A class/struct defined in this file

### Functions and Methods

- **LERC_AT_LEAST_VERSION()**: A function/method defined in this file
- **ZSTD_SUPPORT()**: A function/method defined in this file
- **struct()**: A function/method defined in this file
- **LERC_SUPPORT()**: A function/method defined in this file
- **LERC_READ_ONLY()**: A function/method defined in this file
