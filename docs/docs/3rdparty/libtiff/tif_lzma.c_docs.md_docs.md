# Documentation for `docs/3rdparty/libtiff/tif_lzma.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libtiff/tif_lzma.c_docs.md`
- **File Name**: `tif_lzma.c_docs.md`
- **File Size**: 19,443 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libtiff/tif_lzma.c_docs.md](../../../docs/3rdparty/libtiff/tif_lzma.c_docs.md)
...
# Documentation for `3rdparty/libtiff/tif_lzma.c`

## File Metadata

- **Full Path**: `3rdparty/libtiff/tif_lzma.c`
- **File Name**: `tif_lzma.c`
- **File Size**: 16,272 bytes
- **File Type**: .c
- **Link to Source**: [3rdparty/libtiff/tif_lzma.c](../../3rdparty/libtiff/tif_lzma.c)
