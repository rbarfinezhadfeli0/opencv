# Documentation for `docs/3rdparty/libtiff/tif_pixarlog.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libtiff/tif_pixarlog.c_docs.md`
- **File Name**: `tif_pixarlog.c_docs.md`
- **File Size**: 58,852 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libtiff/tif_pixarlog.c_docs.md](../../../docs/3rdparty/libtiff/tif_pixarlog.c_docs.md)
...
# Documentation for `3rdparty/libtiff/tif_pixarlog.c`

## File Metadata

- **Full Path**: `3rdparty/libtiff/tif_pixarlog.c`
- **File Name**: `tif_pixarlog.c`
- **File Size**: 55,457 bytes
- **File Type**: .c
- **Link to Source**: [3rdparty/libtiff/tif_pixarlog.c](../../3rdparty/libtiff/tif_pixarlog.c)
