# Documentation for `docs/3rdparty/libtiff/tif_predict.h_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libtiff/tif_predict.h_docs.md`
- **File Name**: `tif_predict.h_docs.md`
- **File Size**: 6,073 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libtiff/tif_predict.h_docs.md](../../../docs/3rdparty/libtiff/tif_predict.h_docs.md)
