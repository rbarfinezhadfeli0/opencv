# Documentation for `docs/3rdparty/libtiff/tif_unix.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libtiff/tif_unix.c_docs.md`
- **File Name**: `tif_unix.c_docs.md`
- **File Size**: 13,351 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libtiff/tif_unix.c_docs.md](../../../docs/3rdparty/libtiff/tif_unix.c_docs.md)
