# Documentation for `docs/3rdparty/libtiff/tif_webp.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libtiff/tif_webp.c_docs.md`
- **File Name**: `tif_webp.c_docs.md`
- **File Size**: 30,335 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libtiff/tif_webp.c_docs.md](../../../docs/3rdparty/libtiff/tif_webp.c_docs.md)
...
# Documentation for `3rdparty/libtiff/tif_webp.c`

## File Metadata

- **Full Path**: `3rdparty/libtiff/tif_webp.c`
- **File Name**: `tif_webp.c`
- **File Size**: 27,181 bytes
- **File Type**: .c
- **Link to Source**: [3rdparty/libtiff/tif_webp.c](../../3rdparty/libtiff/tif_webp.c)
