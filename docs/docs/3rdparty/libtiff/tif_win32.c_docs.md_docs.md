# Documentation for `docs/3rdparty/libtiff/tif_win32.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libtiff/tif_win32.c_docs.md`
- **File Name**: `tif_win32.c_docs.md`
- **File Size**: 14,916 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libtiff/tif_win32.c_docs.md](../../../docs/3rdparty/libtiff/tif_win32.c_docs.md)
...
# Documentation for `3rdparty/libtiff/tif_win32.c`

## File Metadata

- **Full Path**: `3rdparty/libtiff/tif_win32.c`
- **File Name**: `tif_win32.c`
- **File Size**: 11,804 bytes
- **File Type**: .c
- **Link to Source**: [3rdparty/libtiff/tif_win32.c](../../3rdparty/libtiff/tif_win32.c)
