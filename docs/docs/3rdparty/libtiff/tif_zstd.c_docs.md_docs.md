# Documentation for `docs/3rdparty/libtiff/tif_zstd.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libtiff/tif_zstd.c_docs.md`
- **File Name**: `tif_zstd.c_docs.md`
- **File Size**: 14,880 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libtiff/tif_zstd.c_docs.md](../../../docs/3rdparty/libtiff/tif_zstd.c_docs.md)
...
# Documentation for `3rdparty/libtiff/tif_zstd.c`

## File Metadata

- **Full Path**: `3rdparty/libtiff/tif_zstd.c`
- **File Name**: `tif_zstd.c`
- **File Size**: 11,747 bytes
- **File Type**: .c
- **Link to Source**: [3rdparty/libtiff/tif_zstd.c](../../3rdparty/libtiff/tif_zstd.c)
