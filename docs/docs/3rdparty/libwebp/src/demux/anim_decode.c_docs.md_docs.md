# Documentation for `docs/3rdparty/libwebp/src/demux/anim_decode.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libwebp/src/demux/anim_decode.c_docs.md`
- **File Name**: `anim_decode.c_docs.md`
- **File Size**: 20,966 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libwebp/src/demux/anim_decode.c_docs.md](../../../../../docs/3rdparty/libwebp/src/demux/anim_decode.c_docs.md)
...
# Documentation for `3rdparty/libwebp/src/demux/anim_decode.c`

## File Metadata

- **Full Path**: `3rdparty/libwebp/src/demux/anim_decode.c`
- **File Name**: `anim_decode.c`
- **File Size**: 17,511 bytes
- **File Type**: .c
- **Link to Source**: [3rdparty/libwebp/src/demux/anim_decode.c](../../../../3rdparty/libwebp/src/demux/anim_decode.c)

## Purpose and Role

This file is located in the `3rdparty/libwebp/src/demux` directory and serves as part of the OpenCV library infrastructure.
