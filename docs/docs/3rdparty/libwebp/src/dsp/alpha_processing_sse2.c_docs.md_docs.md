# Documentation for `docs/3rdparty/libwebp/src/dsp/alpha_processing_sse2.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libwebp/src/dsp/alpha_processing_sse2.c_docs.md`
- **File Name**: `alpha_processing_sse2.c_docs.md`
- **File Size**: 20,129 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libwebp/src/dsp/alpha_processing_sse2.c_docs.md](../../../../../docs/3rdparty/libwebp/src/dsp/alpha_processing_sse2.c_docs.md)
...
# Documentation for `3rdparty/libwebp/src/dsp/alpha_processing_sse2.c`

## File Metadata

- **Full Path**: `3rdparty/libwebp/src/dsp/alpha_processing_sse2.c`
- **File Name**: `alpha_processing_sse2.c`
- **File Size**: 16,982 bytes
- **File Type**: .c
- **Link to Source**: [3rdparty/libwebp/src/dsp/alpha_processing_sse2.c](../../../../3rdparty/libwebp/src/dsp/alpha_processing_sse2.c)
