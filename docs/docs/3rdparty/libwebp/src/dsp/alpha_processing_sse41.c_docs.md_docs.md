# Documentation for `docs/3rdparty/libwebp/src/dsp/alpha_processing_sse41.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libwebp/src/dsp/alpha_processing_sse41.c_docs.md`
- **File Name**: `alpha_processing_sse41.c_docs.md`
- **File Size**: 6,749 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libwebp/src/dsp/alpha_processing_sse41.c_docs.md](../../../../../docs/3rdparty/libwebp/src/dsp/alpha_processing_sse41.c_docs.md)
