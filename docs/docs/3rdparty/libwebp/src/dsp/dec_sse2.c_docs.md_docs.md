# Documentation for `docs/3rdparty/libwebp/src/dsp/dec_sse2.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libwebp/src/dsp/dec_sse2.c_docs.md`
- **File Name**: `dec_sse2.c_docs.md`
- **File Size**: 50,757 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libwebp/src/dsp/dec_sse2.c_docs.md](../../../../../docs/3rdparty/libwebp/src/dsp/dec_sse2.c_docs.md)
...
# Documentation for `3rdparty/libwebp/src/dsp/dec_sse2.c`

## File Metadata

- **Full Path**: `3rdparty/libwebp/src/dsp/dec_sse2.c`
- **File Name**: `dec_sse2.c`
- **File Size**: 47,618 bytes
- **File Type**: .c
- **Link to Source**: [3rdparty/libwebp/src/dsp/dec_sse2.c](../../../../3rdparty/libwebp/src/dsp/dec_sse2.c)
