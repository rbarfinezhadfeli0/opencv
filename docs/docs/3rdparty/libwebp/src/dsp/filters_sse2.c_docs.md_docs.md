# Documentation for `docs/3rdparty/libwebp/src/dsp/filters_sse2.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libwebp/src/dsp/filters_sse2.c_docs.md`
- **File Name**: `filters_sse2.c_docs.md`
- **File Size**: 16,228 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libwebp/src/dsp/filters_sse2.c_docs.md](../../../../../docs/3rdparty/libwebp/src/dsp/filters_sse2.c_docs.md)
...
# Documentation for `3rdparty/libwebp/src/dsp/filters_sse2.c`

## File Metadata

- **Full Path**: `3rdparty/libwebp/src/dsp/filters_sse2.c`
- **File Name**: `filters_sse2.c`
- **File Size**: 13,109 bytes
- **File Type**: .c
- **Link to Source**: [3rdparty/libwebp/src/dsp/filters_sse2.c](../../../../3rdparty/libwebp/src/dsp/filters_sse2.c)
