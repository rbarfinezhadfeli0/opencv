# Documentation for `docs/3rdparty/libwebp/src/dsp/lossless_enc_mips_dsp_r2.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libwebp/src/dsp/lossless_enc_mips_dsp_r2.c_docs.md`
- **File Name**: `lossless_enc_mips_dsp_r2.c_docs.md`
- **File Size**: 17,093 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libwebp/src/dsp/lossless_enc_mips_dsp_r2.c_docs.md](../../../../../docs/3rdparty/libwebp/src/dsp/lossless_enc_mips_dsp_r2.c_docs.md)
...
# Documentation for `3rdparty/libwebp/src/dsp/lossless_enc_mips_dsp_r2.c`

## File Metadata

- **Full Path**: `3rdparty/libwebp/src/dsp/lossless_enc_mips_dsp_r2.c`
- **File Name**: `lossless_enc_mips_dsp_r2.c`
- **File Size**: 14,071 bytes
- **File Type**: .c
- **Link to Source**: [3rdparty/libwebp/src/dsp/lossless_enc_mips_dsp_r2.c](../../../../3rdparty/libwebp/src/dsp/lossless_enc_mips_dsp_r2.c)
