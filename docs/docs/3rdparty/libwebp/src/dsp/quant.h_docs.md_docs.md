# Documentation for `docs/3rdparty/libwebp/src/dsp/quant.h_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libwebp/src/dsp/quant.h_docs.md`
- **File Name**: `quant.h_docs.md`
- **File Size**: 5,681 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libwebp/src/dsp/quant.h_docs.md](../../../../../docs/3rdparty/libwebp/src/dsp/quant.h_docs.md)
