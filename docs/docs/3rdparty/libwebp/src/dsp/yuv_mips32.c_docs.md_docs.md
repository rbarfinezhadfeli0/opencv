# Documentation for `docs/3rdparty/libwebp/src/dsp/yuv_mips32.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libwebp/src/dsp/yuv_mips32.c_docs.md`
- **File Name**: `yuv_mips32.c_docs.md`
- **File Size**: 8,949 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libwebp/src/dsp/yuv_mips32.c_docs.md](../../../../../docs/3rdparty/libwebp/src/dsp/yuv_mips32.c_docs.md)
