# Documentation for `docs/3rdparty/libwebp/src/dsp/yuv_neon.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libwebp/src/dsp/yuv_neon.c_docs.md`
- **File Name**: `yuv_neon.c_docs.md`
- **File Size**: 9,967 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libwebp/src/dsp/yuv_neon.c_docs.md](../../../../../docs/3rdparty/libwebp/src/dsp/yuv_neon.c_docs.md)
