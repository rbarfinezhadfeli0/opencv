# Documentation for `docs/3rdparty/libwebp/src/dsp/yuv_sse2.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libwebp/src/dsp/yuv_sse2.c_docs.md`
- **File Name**: `yuv_sse2.c_docs.md`
- **File Size**: 31,910 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libwebp/src/dsp/yuv_sse2.c_docs.md](../../../../../docs/3rdparty/libwebp/src/dsp/yuv_sse2.c_docs.md)
...
# Documentation for `3rdparty/libwebp/src/dsp/yuv_sse2.c`

## File Metadata

- **Full Path**: `3rdparty/libwebp/src/dsp/yuv_sse2.c`
- **File Name**: `yuv_sse2.c`
- **File Size**: 28,714 bytes
- **File Type**: .c
- **Link to Source**: [3rdparty/libwebp/src/dsp/yuv_sse2.c](../../../../3rdparty/libwebp/src/dsp/yuv_sse2.c)
