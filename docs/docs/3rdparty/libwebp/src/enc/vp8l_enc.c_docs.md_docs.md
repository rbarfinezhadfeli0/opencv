# Documentation for `docs/3rdparty/libwebp/src/enc/vp8l_enc.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libwebp/src/enc/vp8l_enc.c_docs.md`
- **File Name**: `vp8l_enc.c_docs.md`
- **File Size**: 73,811 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libwebp/src/enc/vp8l_enc.c_docs.md](../../../../../docs/3rdparty/libwebp/src/enc/vp8l_enc.c_docs.md)
...
# Documentation for `3rdparty/libwebp/src/enc/vp8l_enc.c`

## File Metadata

- **Full Path**: `3rdparty/libwebp/src/enc/vp8l_enc.c`
- **File Name**: `vp8l_enc.c`
- **File Size**: 69,810 bytes
- **File Type**: .c
- **Link to Source**: [3rdparty/libwebp/src/enc/vp8l_enc.c](../../../../3rdparty/libwebp/src/enc/vp8l_enc.c)
...
- **PALETTE_INV_SIZE()**: A function/method defined in this file
- **CRUNCH_SUBCONFIGS_MAX()**: A function/method defined in this file
- **enum()**: A function/method defined in this file
- **able()**: A function/method defined in this file
- **APPLY_PALETTE_FOR()**: A function/method defined in this file
- **PALETTE_INV_SIZE_BITS()**: A function/method defined in this file
- **struct()**: A function/method defined in this file
- **CRUNCH_CONFIGS_MAX()**: A function/method defined in this file
- **of()**: A function/method defined in this file
- **APPLY_PALETTE_GREEDY_MAX()**: A function/method defined in this file
