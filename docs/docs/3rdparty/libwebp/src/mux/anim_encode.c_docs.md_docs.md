# Documentation for `docs/3rdparty/libwebp/src/mux/anim_encode.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libwebp/src/mux/anim_encode.c_docs.md`
- **File Name**: `anim_encode.c_docs.md`
- **File Size**: 63,294 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libwebp/src/mux/anim_encode.c_docs.md](../../../../../docs/3rdparty/libwebp/src/mux/anim_encode.c_docs.md)
...
# Documentation for `3rdparty/libwebp/src/mux/anim_encode.c`

## File Metadata

- **Full Path**: `3rdparty/libwebp/src/mux/anim_encode.c`
- **File Name**: `anim_encode.c`
- **File Size**: 59,438 bytes
- **File Type**: .c
- **Link to Source**: [3rdparty/libwebp/src/mux/anim_encode.c](../../../../3rdparty/libwebp/src/mux/anim_encode.c)
...
- **WebPAnimEncoder**: A class/struct defined in this file

### Functions and Methods

- **pointer()**: A function/method defined in this file
- **MIN_COLORS_LOSSY()**: A function/method defined in this file
- **struct()**: A function/method defined in this file
- **KEYFRAME_NONE()**: A function/method defined in this file
- **MAX_CACHED_FRAMES()**: A function/method defined in this file
- **TRANSPARENT_COLOR()**: A function/method defined in this file
- **DELTA_INFINITY()**: A function/method defined in this file
- **MAX_COLORS_LOSSLESS()**: A function/method defined in this file
