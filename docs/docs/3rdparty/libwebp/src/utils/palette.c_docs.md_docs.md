# Documentation for `docs/3rdparty/libwebp/src/utils/palette.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libwebp/src/utils/palette.c_docs.md`
- **File Name**: `palette.c_docs.md`
- **File Size**: 17,279 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libwebp/src/utils/palette.c_docs.md](../../../../../docs/3rdparty/libwebp/src/utils/palette.c_docs.md)
...
# Documentation for `3rdparty/libwebp/src/utils/palette.c`

## File Metadata

- **Full Path**: `3rdparty/libwebp/src/utils/palette.c`
- **File Name**: `palette.c`
- **File Size**: 13,803 bytes
- **File Type**: .c
- **Link to Source**: [3rdparty/libwebp/src/utils/palette.c](../../../../3rdparty/libwebp/src/utils/palette.c)
...
- **Sum**: A class/struct defined in this file
- **WebPPicture**: A class/struct defined in this file

### Functions and Methods

- **COLOR_HASH_SIZE()**: A function/method defined in this file
- **checks()**: A function/method defined in this file
- **COLOR_HASH_RIGHT_SHIFT()**: A function/method defined in this file
