# Documentation for `docs/3rdparty/libwebp/src/utils/palette.h_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libwebp/src/utils/palette.h_docs.md`
- **File Name**: `palette.h_docs.md`
- **File Size**: 5,703 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libwebp/src/utils/palette.h_docs.md](../../../../../docs/3rdparty/libwebp/src/utils/palette.h_docs.md)
