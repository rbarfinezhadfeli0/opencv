# Documentation for `docs/3rdparty/libwebp/src/webp/types.h_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/libwebp/src/webp/types.h_docs.md`
- **File Name**: `types.h_docs.md`
- **File Size**: 6,620 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/libwebp/src/webp/types.h_docs.md](../../../../../docs/3rdparty/libwebp/src/webp/types.h_docs.md)
