# Documentation for `docs/3rdparty/openexr/CMakeLists.txt_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/openexr/CMakeLists.txt_docs.md`
- **File Name**: `CMakeLists.txt_docs.md`
- **File Size**: 6,935 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/openexr/CMakeLists.txt_docs.md](../../../docs/3rdparty/openexr/CMakeLists.txt_docs.md)
...
# Documentation for `3rdparty/openexr/CMakeLists.txt`

## File Metadata

- **Full Path**: `3rdparty/openexr/CMakeLists.txt`
- **File Name**: `CMakeLists.txt`
- **File Size**: 5,975 bytes
- **File Type**: .txt
- **Link to Source**: [3rdparty/openexr/CMakeLists.txt](../../3rdparty/openexr/CMakeLists.txt)
