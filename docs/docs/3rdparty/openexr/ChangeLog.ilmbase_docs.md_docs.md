# Documentation for `docs/3rdparty/openexr/ChangeLog.ilmbase_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/openexr/ChangeLog.ilmbase_docs.md`
- **File Name**: `ChangeLog.ilmbase_docs.md`
- **File Size**: 5,706 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/openexr/ChangeLog.ilmbase_docs.md](../../../docs/3rdparty/openexr/ChangeLog.ilmbase_docs.md)
...
# Documentation for `3rdparty/openexr/ChangeLog.ilmbase`

## File Metadata

- **Full Path**: `3rdparty/openexr/ChangeLog.ilmbase`
- **File Name**: `ChangeLog.ilmbase`
- **File Size**: 5,135 bytes
- **File Type**: .ilmbase
- **Link to Source**: [3rdparty/openexr/ChangeLog.ilmbase](../../3rdparty/openexr/ChangeLog.ilmbase)
