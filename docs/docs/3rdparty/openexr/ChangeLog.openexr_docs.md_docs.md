# Documentation for `docs/3rdparty/openexr/ChangeLog.openexr_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/openexr/ChangeLog.openexr_docs.md`
- **File Name**: `ChangeLog.openexr_docs.md`
- **File Size**: 31,406 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/openexr/ChangeLog.openexr_docs.md](../../../docs/3rdparty/openexr/ChangeLog.openexr_docs.md)
...
# Documentation for `3rdparty/openexr/ChangeLog.openexr`

## File Metadata

- **Full Path**: `3rdparty/openexr/ChangeLog.openexr`
- **File Name**: `ChangeLog.openexr`
- **File Size**: 30,834 bytes
- **File Type**: .openexr
- **Link to Source**: [3rdparty/openexr/ChangeLog.openexr](../../3rdparty/openexr/ChangeLog.openexr)
