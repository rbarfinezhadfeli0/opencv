# Documentation for `docs/3rdparty/openjpeg/CHANGELOG.md_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/openjpeg/CHANGELOG.md_docs.md`
- **File Name**: `CHANGELOG.md_docs.md`
- **File Size**: 100,625 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/openjpeg/CHANGELOG.md_docs.md](../../../docs/3rdparty/openjpeg/CHANGELOG.md_docs.md)
...
# Documentation for `3rdparty/openjpeg/CHANGELOG.md`

## File Metadata

- **Full Path**: `3rdparty/openjpeg/CHANGELOG.md`
- **File Name**: `CHANGELOG.md`
- **File Size**: 115,119 bytes
- **File Type**: .md
- **Link to Source**: [3rdparty/openjpeg/CHANGELOG.md](../../3rdparty/openjpeg/CHANGELOG.md)
...
- Add option to call dsymutil on built binaries [\#409](https://gi
... [truncated]
