# Documentation for `docs/3rdparty/openjpeg/CMakeLists.txt_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/openjpeg/CMakeLists.txt_docs.md`
- **File Name**: `CMakeLists.txt_docs.md`
- **File Size**: 8,396 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/openjpeg/CMakeLists.txt_docs.md](../../../docs/3rdparty/openjpeg/CMakeLists.txt_docs.md)
...
# Documentation for `3rdparty/openjpeg/CMakeLists.txt`

## File Metadata

- **Full Path**: `3rdparty/openjpeg/CMakeLists.txt`
- **File Name**: `CMakeLists.txt`
- **File Size**: 7,431 bytes
- **File Type**: .txt
- **Link to Source**: [3rdparty/openjpeg/CMakeLists.txt](../../3rdparty/openjpeg/CMakeLists.txt)

## Purpose and Role

This file is located in the `3rdparty/openjpeg` directory and serves as part of the OpenCV library infrastructure.
