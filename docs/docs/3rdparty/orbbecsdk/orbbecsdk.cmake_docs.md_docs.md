# Documentation for `docs/3rdparty/orbbecsdk/orbbecsdk.cmake_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/orbbecsdk/orbbecsdk.cmake_docs.md`
- **File Name**: `orbbecsdk.cmake_docs.md`
- **File Size**: 2,513 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/orbbecsdk/orbbecsdk.cmake_docs.md](../../../docs/3rdparty/orbbecsdk/orbbecsdk.cmake_docs.md)

## Purpose and Role

This file is located in the `docs/3rdparty/orbbecsdk` directory and serves as part of the OpenCV library infrastructure.
