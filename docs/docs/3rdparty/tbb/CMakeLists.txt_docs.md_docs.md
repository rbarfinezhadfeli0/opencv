# Documentation for `docs/3rdparty/tbb/CMakeLists.txt_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/tbb/CMakeLists.txt_docs.md`
- **File Name**: `CMakeLists.txt_docs.md`
- **File Size**: 7,739 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/tbb/CMakeLists.txt_docs.md](../../../docs/3rdparty/tbb/CMakeLists.txt_docs.md)
...
# Documentation for `3rdparty/tbb/CMakeLists.txt`

## File Metadata

- **Full Path**: `3rdparty/tbb/CMakeLists.txt`
- **File Name**: `CMakeLists.txt`
- **File Size**: 6,799 bytes
- **File Type**: .txt
- **Link to Source**: [3rdparty/tbb/CMakeLists.txt](../../3rdparty/tbb/CMakeLists.txt)
