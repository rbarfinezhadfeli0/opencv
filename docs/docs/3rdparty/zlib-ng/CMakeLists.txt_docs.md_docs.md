# Documentation for `docs/3rdparty/zlib-ng/CMakeLists.txt_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/zlib-ng/CMakeLists.txt_docs.md`
- **File Name**: `CMakeLists.txt_docs.md`
- **File Size**: 50,977 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/zlib-ng/CMakeLists.txt_docs.md](../../../docs/3rdparty/zlib-ng/CMakeLists.txt_docs.md)
...
# Documentation for `3rdparty/zlib-ng/CMakeLists.txt`

## File Metadata

- **Full Path**: `3rdparty/zlib-ng/CMakeLists.txt`
- **File Name**: `CMakeLists.txt`
- **File Size**: 55,018 bytes
- **File Type**: .txt
- **Link to Source**: [3rdparty/zlib-ng/CMakeLists.txt](../../3rdparty/zlib-ng/CMakeLists.txt)
...
if(NOT SKIP_INSTALL_HEADERS AND NOT SKIP_INSTALL_ALL)
    ...
    install(FILES ${CMAKE_CURRENT_BINARY_DIR}/zconf${SU
... [truncated]
```
