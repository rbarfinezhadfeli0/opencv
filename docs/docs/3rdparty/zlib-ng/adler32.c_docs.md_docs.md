# Documentation for `docs/3rdparty/zlib-ng/adler32.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/zlib-ng/adler32.c_docs.md`
- **File Name**: `adler32.c_docs.md`
- **File Size**: 5,617 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/zlib-ng/adler32.c_docs.md](../../../docs/3rdparty/zlib-ng/adler32.c_docs.md)
