# Documentation for `docs/3rdparty/zlib-ng/arch/power/chunkset_power8.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/zlib-ng/arch/power/chunkset_power8.c_docs.md`
- **File Name**: `chunkset_power8.c_docs.md`
- **File Size**: 4,576 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/zlib-ng/arch/power/chunkset_power8.c_docs.md](../../../../../docs/3rdparty/zlib-ng/arch/power/chunkset_power8.c_docs.md)
