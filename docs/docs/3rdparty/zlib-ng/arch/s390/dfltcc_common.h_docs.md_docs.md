# Documentation for `docs/3rdparty/zlib-ng/arch/s390/dfltcc_common.h_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/zlib-ng/arch/s390/dfltcc_common.h_docs.md`
- **File Name**: `dfltcc_common.h_docs.md`
- **File Size**: 7,518 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/zlib-ng/arch/s390/dfltcc_common.h_docs.md](../../../../../docs/3rdparty/zlib-ng/arch/s390/dfltcc_common.h_docs.md)
