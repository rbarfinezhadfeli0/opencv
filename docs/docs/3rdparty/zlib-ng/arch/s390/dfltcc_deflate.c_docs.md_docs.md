# Documentation for `docs/3rdparty/zlib-ng/arch/s390/dfltcc_deflate.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/zlib-ng/arch/s390/dfltcc_deflate.c_docs.md`
- **File Name**: `dfltcc_deflate.c_docs.md`
- **File Size**: 17,392 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/zlib-ng/arch/s390/dfltcc_deflate.c_docs.md](../../../../../docs/3rdparty/zlib-ng/arch/s390/dfltcc_deflate.c_docs.md)
...
# Documentation for `3rdparty/zlib-ng/arch/s390/dfltcc_deflate.c`

## File Metadata

- **Full Path**: `3rdparty/zlib-ng/arch/s390/dfltcc_deflate.c`
- **File Name**: `dfltcc_deflate.c`
- **File Size**: 14,191 bytes
- **File Type**: .c
- **Link to Source**: [3rdparty/zlib-ng/arch/s390/dfltcc_deflate.c](../../../../3rdparty/zlib-ng/arch/s390/dfltcc_deflate.c)
