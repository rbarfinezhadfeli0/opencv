# Documentation for `docs/3rdparty/zlib-ng/arch/s390/dfltcc_inflate.h_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/zlib-ng/arch/s390/dfltcc_inflate.h_docs.md`
- **File Name**: `dfltcc_inflate.h_docs.md`
- **File Size**: 5,606 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/zlib-ng/arch/s390/dfltcc_inflate.h_docs.md](../../../../../docs/3rdparty/zlib-ng/arch/s390/dfltcc_inflate.h_docs.md)
