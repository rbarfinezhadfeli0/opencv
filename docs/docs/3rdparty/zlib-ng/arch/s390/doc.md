# Documentation for `docs/3rdparty/zlib-ng/arch/s390/`
...
**Path**: `docs/3rdparty/zlib-ng/arch/s390/`
**Direct Files**: 24
**Subfolders**: 1
...
- **self-hosted-builder/** - See [self-hosted-builder/doc.md](self-hosted-builder/doc.md)
...
- **Parent Folder**: [docs/3rdparty/zlib-ng/arch/](../arch/doc.md)
...
**Subfolders**:
- [self-hosted-builder/](self-hosted-builder/doc.md)
