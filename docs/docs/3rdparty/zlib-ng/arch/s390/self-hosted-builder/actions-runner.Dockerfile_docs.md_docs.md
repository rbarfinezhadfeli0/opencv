# Documentation for `docs/3rdparty/zlib-ng/arch/s390/self-hosted-builder/actions-runner.Dockerfile_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/zlib-ng/arch/s390/self-hosted-builder/actions-runner.Dockerfile_docs.md`
- **File Name**: `actions-runner.Dockerfile_docs.md`
- **File Size**: 2,309 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/zlib-ng/arch/s390/self-hosted-builder/actions-runner.Dockerfile_docs.md](../../../../../../docs/3rdparty/zlib-ng/arch/s390/self-hosted-builder/actions-runner.Dockerfile_docs.md)
