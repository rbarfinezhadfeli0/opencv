# Documentation for `docs/3rdparty/zlib-ng/arch/s390/self-hosted-builder/runner-s390x.patch_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/zlib-ng/arch/s390/self-hosted-builder/runner-s390x.patch_docs.md`
- **File Name**: `runner-s390x.patch_docs.md`
- **File Size**: 11,573 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/zlib-ng/arch/s390/self-hosted-builder/runner-s390x.patch_docs.md](../../../../../../docs/3rdparty/zlib-ng/arch/s390/self-hosted-builder/runner-s390x.patch_docs.md)
...
# Documentation for `3rdparty/zlib-ng/arch/s390/self-hosted-builder/runner-s390x.patch`

## File Metadata

- **Full Path**: `3rdparty/zlib-ng/arch/s390/self-hosted-builder/runner-s390x.patch`
- **File Name**: `runner-s390x.patch`
- **File Size**: 10,839 bytes
- **File Type**: .patch
- **Link to Source**: [3rdparty/zlib-ng/arch/s390/self-hosted-builder/runner-s390x.patch](../../../../../3rdparty/zlib-ng/arch/s390/self-hosted-builder/runner-s390x.patch)
