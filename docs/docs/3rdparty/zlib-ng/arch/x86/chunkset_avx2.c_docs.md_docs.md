# Documentation for `docs/3rdparty/zlib-ng/arch/x86/chunkset_avx2.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/zlib-ng/arch/x86/chunkset_avx2.c_docs.md`
- **File Name**: `chunkset_avx2.c_docs.md`
- **File Size**: 8,475 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/zlib-ng/arch/x86/chunkset_avx2.c_docs.md](../../../../../docs/3rdparty/zlib-ng/arch/x86/chunkset_avx2.c_docs.md)
