# Documentation for `docs/3rdparty/zlib-ng/arch_functions.h_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/zlib-ng/arch_functions.h_docs.md`
- **File Name**: `arch_functions.h_docs.md`
- **File Size**: 3,921 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/zlib-ng/arch_functions.h_docs.md](../../../docs/3rdparty/zlib-ng/arch_functions.h_docs.md)
