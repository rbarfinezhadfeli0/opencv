# Documentation for `docs/3rdparty/zlib-ng/chunkset_tpl.h_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/zlib-ng/chunkset_tpl.h_docs.md`
- **File Name**: `chunkset_tpl.h_docs.md`
- **File Size**: 9,832 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/zlib-ng/chunkset_tpl.h_docs.md](../../../docs/3rdparty/zlib-ng/chunkset_tpl.h_docs.md)
...
# Documentation for `3rdparty/zlib-ng/chunkset_tpl.h`

## File Metadata

- **Full Path**: `3rdparty/zlib-ng/chunkset_tpl.h`
- **File Name**: `chunkset_tpl.h`
- **File Size**: 6,462 bytes
- **File Type**: .h
- **Link to Source**: [3rdparty/zlib-ng/chunkset_tpl.h](../../3rdparty/zlib-ng/chunkset_tpl.h)
...
- **HAVE_CHUNK_MAG()**: A function/method defined in this file
- **HAVE_CHUNKMEMSET_2()**: A function/method defined in this file
- **HAVE_CHUNKUNROLL()**: A function/method defined in this file
- **HAVE_CHUNKMEMSET_8()**: A function/method defined in this file
- **HAVE_CHUNKCOPY()**: A function/method defined in this file
- **HAVE_CHUNKMEMSET_4()**: A function/method defined in this file
