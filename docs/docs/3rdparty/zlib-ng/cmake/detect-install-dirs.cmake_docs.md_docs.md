# Documentation for `docs/3rdparty/zlib-ng/cmake/detect-install-dirs.cmake_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/zlib-ng/cmake/detect-install-dirs.cmake_docs.md`
- **File Name**: `detect-install-dirs.cmake_docs.md`
- **File Size**: 3,205 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/zlib-ng/cmake/detect-install-dirs.cmake_docs.md](../../../../docs/3rdparty/zlib-ng/cmake/detect-install-dirs.cmake_docs.md)
...
# Documentation for `3rdparty/zlib-ng/cmake/detect-install-dirs.cmake`

## File Metadata

- **Full Path**: `3rdparty/zlib-ng/cmake/detect-install-dirs.cmake`
- **File Name**: `detect-install-dirs.cmake`
- **File Size**: 2,155 bytes
- **File Type**: .cmake
- **Link to Source**: [3rdparty/zlib-ng/cmake/detect-install-dirs.cmake](../../../3rdparty/zlib-ng/cmake/detect-install-dirs.cmake)
