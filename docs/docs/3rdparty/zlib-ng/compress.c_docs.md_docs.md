# Documentation for `docs/3rdparty/zlib-ng/compress.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/zlib-ng/compress.c_docs.md`
- **File Name**: `compress.c_docs.md`
- **File Size**: 6,986 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/zlib-ng/compress.c_docs.md](../../../docs/3rdparty/zlib-ng/compress.c_docs.md)
