# Documentation for `docs/3rdparty/zlib-ng/crc32.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/zlib-ng/crc32.c_docs.md`
- **File Name**: `crc32.c_docs.md`
- **File Size**: 4,377 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/zlib-ng/crc32.c_docs.md](../../../docs/3rdparty/zlib-ng/crc32.c_docs.md)
