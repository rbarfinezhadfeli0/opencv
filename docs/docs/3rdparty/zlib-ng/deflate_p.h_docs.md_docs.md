# Documentation for `docs/3rdparty/zlib-ng/deflate_p.h_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/zlib-ng/deflate_p.h_docs.md`
- **File Name**: `deflate_p.h_docs.md`
- **File Size**: 7,727 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/zlib-ng/deflate_p.h_docs.md](../../../docs/3rdparty/zlib-ng/deflate_p.h_docs.md)
