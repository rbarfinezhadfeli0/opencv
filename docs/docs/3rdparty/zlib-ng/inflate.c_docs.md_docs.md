# Documentation for `docs/3rdparty/zlib-ng/inflate.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/zlib-ng/inflate.c_docs.md`
- **File Name**: `inflate.c_docs.md`
- **File Size**: 56,507 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/zlib-ng/inflate.c_docs.md](../../../docs/3rdparty/zlib-ng/inflate.c_docs.md)
...
# Documentation for `3rdparty/zlib-ng/inflate.c`

## File Metadata

- **Full Path**: `3rdparty/zlib-ng/inflate.c`
- **File Name**: `inflate.c`
- **File Size**: 52,531 bytes
- **File Type**: .c
- **Link to Source**: [3rdparty/zlib-ng/inflate.c](../../3rdparty/zlib-ng/inflate.c)
...
- **INF_ALLOC_DEBUG()**: A function/method defined in this file
- **GUNZIP()**: A function/method defined in this file
- **inflateInit2()**: A function/method defined in this file
- **inflateInit()**: A function/method defined in this file
- **INFLATE_STRICT()**: A function/method defined in this file
- **ZLIB_COMPAT()**: A function/method defined in this file
- **PKZIP_BUG_WORKAROUND()**: A function/method defined in this file
- **INFLATE_ALLOW_INVALID_DISTANCE_TOOFAR_ARRR()**: A function/method defined in this file
