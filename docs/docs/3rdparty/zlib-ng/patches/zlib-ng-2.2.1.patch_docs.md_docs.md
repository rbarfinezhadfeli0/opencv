# Documentation for `docs/3rdparty/zlib-ng/patches/zlib-ng-2.2.1.patch_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/zlib-ng/patches/zlib-ng-2.2.1.patch_docs.md`
- **File Name**: `zlib-ng-2.2.1.patch_docs.md`
- **File Size**: 6,591 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/zlib-ng/patches/zlib-ng-2.2.1.patch_docs.md](../../../../docs/3rdparty/zlib-ng/patches/zlib-ng-2.2.1.patch_docs.md)
...
# Documentation for `3rdparty/zlib-ng/patches/zlib-ng-2.2.1.patch`

## File Metadata

- **Full Path**: `3rdparty/zlib-ng/patches/zlib-ng-2.2.1.patch`
- **File Name**: `zlib-ng-2.2.1.patch`
- **File Size**: 5,969 bytes
- **File Type**: .patch
- **Link to Source**: [3rdparty/zlib-ng/patches/zlib-ng-2.2.1.patch](../../../3rdparty/zlib-ng/patches/zlib-ng-2.2.1.patch)
