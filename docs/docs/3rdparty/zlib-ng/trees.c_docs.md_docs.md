# Documentation for `docs/3rdparty/zlib-ng/trees.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/zlib-ng/trees.c_docs.md`
- **File Name**: `trees.c_docs.md`
- **File Size**: 34,896 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/zlib-ng/trees.c_docs.md](../../../docs/3rdparty/zlib-ng/trees.c_docs.md)
...
# Documentation for `3rdparty/zlib-ng/trees.c`

## File Metadata

- **Full Path**: `3rdparty/zlib-ng/trees.c`
- **File Name**: `trees.c`
- **File Size**: 31,462 bytes
- **File Type**: .c
- **Link to Source**: [3rdparty/zlib-ng/trees.c](../../3rdparty/zlib-ng/trees.c)
