# Documentation for `docs/3rdparty/zlib-ng/zbuild.h_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/zlib-ng/zbuild.h_docs.md`
- **File Name**: `zbuild.h_docs.md`
- **File Size**: 14,574 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/zlib-ng/zbuild.h_docs.md](../../../docs/3rdparty/zlib-ng/zbuild.h_docs.md)
