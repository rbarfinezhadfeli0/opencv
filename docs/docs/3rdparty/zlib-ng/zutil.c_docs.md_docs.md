# Documentation for `docs/3rdparty/zlib-ng/zutil.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/zlib-ng/zutil.c_docs.md`
- **File Name**: `zutil.c_docs.md`
- **File Size**: 6,353 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/zlib-ng/zutil.c_docs.md](../../../docs/3rdparty/zlib-ng/zutil.c_docs.md)
