# Documentation for `docs/3rdparty/zlib-ng/zutil.h_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/zlib-ng/zutil.h_docs.md`
- **File Name**: `zutil.h_docs.md`
- **File Size**: 7,509 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/zlib-ng/zutil.h_docs.md](../../../docs/3rdparty/zlib-ng/zutil.h_docs.md)
