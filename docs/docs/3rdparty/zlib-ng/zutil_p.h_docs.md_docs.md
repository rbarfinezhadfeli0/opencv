# Documentation for `docs/3rdparty/zlib-ng/zutil_p.h_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/zlib-ng/zutil_p.h_docs.md`
- **File Name**: `zutil_p.h_docs.md`
- **File Size**: 5,118 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/zlib-ng/zutil_p.h_docs.md](../../../docs/3rdparty/zlib-ng/zutil_p.h_docs.md)
