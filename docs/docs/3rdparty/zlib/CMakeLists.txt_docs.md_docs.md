# Documentation for `docs/3rdparty/zlib/CMakeLists.txt_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/zlib/CMakeLists.txt_docs.md`
- **File Name**: `CMakeLists.txt_docs.md`
- **File Size**: 3,600 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/zlib/CMakeLists.txt_docs.md](../../../docs/3rdparty/zlib/CMakeLists.txt_docs.md)
...
# Documentation for `3rdparty/zlib/CMakeLists.txt`

## File Metadata

- **Full Path**: `3rdparty/zlib/CMakeLists.txt`
- **File Name**: `CMakeLists.txt`
- **File Size**: 2,655 bytes
- **File Type**: .txt
- **Link to Source**: [3rdparty/zlib/CMakeLists.txt](../../3rdparty/zlib/CMakeLists.txt)
