# Documentation for `docs/3rdparty/zlib/gzclose.c_docs.md`

## File Metadata

- **Full Path**: `docs/3rdparty/zlib/gzclose.c_docs.md`
- **File Name**: `gzclose.c_docs.md`
- **File Size**: 3,603 bytes
- **File Type**: .md
- **Link to Source**: [docs/3rdparty/zlib/gzclose.c_docs.md](../../../docs/3rdparty/zlib/gzclose.c_docs.md)
