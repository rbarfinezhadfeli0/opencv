# Documentation for `docs/3rdparty/zlib/patches/`
...
**Path**: `docs/3rdparty/zlib/patches/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[20190330-ununitialized-use-state-check.diff_kw.md](20190330-ununitialized-use-state-check.diff_kw.md_docs.md)**: MD file
- **[20190330-ununitialized-use-state-check.diff_docs.md](20190330-ununitialized-use-state-check.diff_docs.md_docs.md)**: MD file
...
- **Parent Folder**: [docs/3rdparty/zlib/](../zlib/doc.md)
