# Documentation for `docs/apps/CMakeLists.txt_docs.md`

## File Metadata

- **Full Path**: `docs/apps/CMakeLists.txt_docs.md`
- **File Name**: `CMakeLists.txt_docs.md`
- **File Size**: 3,386 bytes
- **File Type**: .md
- **Link to Source**: [docs/apps/CMakeLists.txt_docs.md](../../docs/apps/CMakeLists.txt_docs.md)
...
# Documentation for `apps/CMakeLists.txt`

## File Metadata

- **Full Path**: `apps/CMakeLists.txt`
- **File Name**: `CMakeLists.txt`
- **File Size**: 2,489 bytes
- **File Type**: .txt
- **Link to Source**: [apps/CMakeLists.txt](../apps/CMakeLists.txt)
