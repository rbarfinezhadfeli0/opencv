# Documentation for `docs/apps/createsamples/CMakeLists.txt_kw.md`

## File Metadata

- **Full Path**: `docs/apps/createsamples/CMakeLists.txt_kw.md`
- **File Name**: `CMakeLists.txt_kw.md`
- **File Size**: 2,622 bytes
- **File Type**: .md
- **Link to Source**: [docs/apps/createsamples/CMakeLists.txt_kw.md](../../../docs/apps/createsamples/CMakeLists.txt_kw.md)
...
# Keyword Map for `apps/createsamples/CMakeLists.txt`

## File Path and Links

- **Source File**: [apps/createsamples/CMakeLists.txt](../../apps/createsamples/CMakeLists.txt)
- **Documentation**: [apps/createsamples/CMakeLists.txt_docs.md](CMakeLists.txt_docs.md)
...
- **opencv_createsamples**: Technical term or identifier found in [CMakeLists.txt](CMakeLists.txt_docs.md)
