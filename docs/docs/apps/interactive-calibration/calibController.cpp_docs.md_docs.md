# Documentation for `docs/apps/interactive-calibration/calibController.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/apps/interactive-calibration/calibController.cpp_docs.md`
- **File Name**: `calibController.cpp_docs.md`
- **File Size**: 17,901 bytes
- **File Type**: .md
- **Link to Source**: [docs/apps/interactive-calibration/calibController.cpp_docs.md](../../../docs/apps/interactive-calibration/calibController.cpp_docs.md)
...
# Documentation for `apps/interactive-calibration/calibController.cpp`

## File Metadata

- **Full Path**: `apps/interactive-calibration/calibController.cpp`
- **File Name**: `calibController.cpp`
- **File Size**: 14,807 bytes
- **File Type**: .cpp
- **Link to Source**: [apps/interactive-calibration/calibController.cpp](../../apps/interactive-calibration/calibController.cpp)
