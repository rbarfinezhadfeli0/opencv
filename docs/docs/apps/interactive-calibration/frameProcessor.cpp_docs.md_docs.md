# Documentation for `docs/apps/interactive-calibration/frameProcessor.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/apps/interactive-calibration/frameProcessor.cpp_docs.md`
- **File Name**: `frameProcessor.cpp_docs.md`
- **File Size**: 25,443 bytes
- **File Type**: .md
- **Link to Source**: [docs/apps/interactive-calibration/frameProcessor.cpp_docs.md](../../../docs/apps/interactive-calibration/frameProcessor.cpp_docs.md)
...
# Documentation for `apps/interactive-calibration/frameProcessor.cpp`

## File Metadata

- **Full Path**: `apps/interactive-calibration/frameProcessor.cpp`
- **File Name**: `frameProcessor.cpp`
- **File Size**: 22,331 bytes
- **File Type**: .cpp
- **Link to Source**: [apps/interactive-calibration/frameProcessor.cpp](../../apps/interactive-calibration/frameProcessor.cpp)
