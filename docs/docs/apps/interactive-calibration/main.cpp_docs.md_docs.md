# Documentation for `docs/apps/interactive-calibration/main.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/apps/interactive-calibration/main.cpp_docs.md`
- **File Name**: `main.cpp_docs.md`
- **File Size**: 13,542 bytes
- **File Type**: .md
- **Link to Source**: [docs/apps/interactive-calibration/main.cpp_docs.md](../../../docs/apps/interactive-calibration/main.cpp_docs.md)
...
# Documentation for `apps/interactive-calibration/main.cpp`

## File Metadata

- **Full Path**: `apps/interactive-calibration/main.cpp`
- **File Name**: `main.cpp`
- **File Size**: 10,187 bytes
- **File Type**: .cpp
- **Link to Source**: [apps/interactive-calibration/main.cpp](../../apps/interactive-calibration/main.cpp)
