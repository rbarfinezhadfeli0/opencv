# Documentation for `docs/apps/interactive-calibration/parametersController.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/apps/interactive-calibration/parametersController.cpp_docs.md`
- **File Name**: `parametersController.cpp_docs.md`
- **File Size**: 12,914 bytes
- **File Type**: .md
- **Link to Source**: [docs/apps/interactive-calibration/parametersController.cpp_docs.md](../../../docs/apps/interactive-calibration/parametersController.cpp_docs.md)
...
# Documentation for `apps/interactive-calibration/parametersController.cpp`

## File Metadata

- **Full Path**: `apps/interactive-calibration/parametersController.cpp`
- **File Name**: `parametersController.cpp`
- **File Size**: 9,810 bytes
- **File Type**: .cpp
- **Link to Source**: [apps/interactive-calibration/parametersController.cpp](../../apps/interactive-calibration/parametersController.cpp)
