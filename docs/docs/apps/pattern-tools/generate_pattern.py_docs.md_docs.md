# Documentation for `docs/apps/pattern-tools/generate_pattern.py_docs.md`

## File Metadata

- **Full Path**: `docs/apps/pattern-tools/generate_pattern.py_docs.md`
- **File Name**: `generate_pattern.py_docs.md`
- **File Size**: 20,141 bytes
- **File Type**: .md
- **Link to Source**: [docs/apps/pattern-tools/generate_pattern.py_docs.md](../../../docs/apps/pattern-tools/generate_pattern.py_docs.md)
...
# Documentation for `apps/pattern-tools/generate_pattern.py`

## File Metadata

- **Full Path**: `apps/pattern-tools/generate_pattern.py`
- **File Name**: `generate_pattern.py`
- **File Size**: 16,387 bytes
- **File Type**: .py
- **Link to Source**: [apps/pattern-tools/generate_pattern.py](../../apps/pattern-tools/generate_pattern.py)
...
- **PatternMaker**: A class/struct defined in this file

### Functions and Methods

- **_get_type()**: A function/method defined in this file
- **_create_marker_bits()**: A function/method defined in this file
- **make_charuco_board()**: A function/method defined in this file
- **make_circles_pattern()**: A function/method defined in this file
- **make_acircles_pattern()**: A function/method defined in this file
- **make_radon_checkerboard_pattern()**: A function/method defined in this file
- **save()**: A function/method defined in this file
- **main()**: A function/method defined in this file
- **make_checkerboard_pattern()**: A function/method defined in this file
- **_make_round_rect()**: A function/method defined in this file
