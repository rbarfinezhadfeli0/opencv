# Documentation for `docs/apps/pattern-tools/test_charuco_board.py_docs.md`

## File Metadata

- **Full Path**: `docs/apps/pattern-tools/test_charuco_board.py_docs.md`
- **File Name**: `test_charuco_board.py_docs.md`
- **File Size**: 9,877 bytes
- **File Type**: .md
- **Link to Source**: [docs/apps/pattern-tools/test_charuco_board.py_docs.md](../../../docs/apps/pattern-tools/test_charuco_board.py_docs.md)
