# Documentation for `docs/apps/traincascade/HOGfeatures.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/apps/traincascade/HOGfeatures.cpp_docs.md`
- **File Name**: `HOGfeatures.cpp_docs.md`
- **File Size**: 10,816 bytes
- **File Type**: .md
- **Link to Source**: [docs/apps/traincascade/HOGfeatures.cpp_docs.md](../../../docs/apps/traincascade/HOGfeatures.cpp_docs.md)
...
# Documentation for `apps/traincascade/HOGfeatures.cpp`

## File Metadata

- **Full Path**: `apps/traincascade/HOGfeatures.cpp`
- **File Name**: `HOGfeatures.cpp`
- **File Size**: 7,843 bytes
- **File Type**: .cpp
- **Link to Source**: [apps/traincascade/HOGfeatures.cpp](../../apps/traincascade/HOGfeatures.cpp)
