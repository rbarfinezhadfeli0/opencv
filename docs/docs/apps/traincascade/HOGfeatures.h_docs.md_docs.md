# Documentation for `docs/apps/traincascade/HOGfeatures.h_docs.md`

## File Metadata

- **Full Path**: `docs/apps/traincascade/HOGfeatures.h_docs.md`
- **File Name**: `HOGfeatures.h_docs.md`
- **File Size**: 5,895 bytes
- **File Type**: .md
- **Link to Source**: [docs/apps/traincascade/HOGfeatures.h_docs.md](../../../docs/apps/traincascade/HOGfeatures.h_docs.md)
