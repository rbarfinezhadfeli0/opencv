# Documentation for `docs/apps/traincascade/boost.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/apps/traincascade/boost.cpp_docs.md`
- **File Name**: `boost.cpp_docs.md`
- **File Size**: 61,678 bytes
- **File Type**: .md
- **Link to Source**: [docs/apps/traincascade/boost.cpp_docs.md](../../../docs/apps/traincascade/boost.cpp_docs.md)
...
# Documentation for `apps/traincascade/boost.cpp`

## File Metadata

- **Full Path**: `apps/traincascade/boost.cpp`
- **File Name**: `boost.cpp`
- **File Size**: 58,264 bytes
- **File Type**: .cpp
- **Link to Source**: [apps/traincascade/boost.cpp](../../apps/traincascade/boost.cpp)
...
- **FeatureIdxOnlyPrecalc**: A class/struct defined in this file
- **labels**: A class/struct defined in this file
- **FeatureValAndIdxPrecalc**: A class/struct defined in this file
- **FeatureValOnlyPrecalc**: A class/struct defined in this file
- **LessThanIdx**: A class/struct defined in this file
