# Documentation for `docs/apps/traincascade/boost.h_docs.md`

## File Metadata

- **Full Path**: `docs/apps/traincascade/boost.h_docs.md`
- **File Name**: `boost.h_docs.md`
- **File Size**: 6,818 bytes
- **File Type**: .md
- **Link to Source**: [docs/apps/traincascade/boost.h_docs.md](../../../docs/apps/traincascade/boost.h_docs.md)
