# Documentation for `docs/apps/traincascade/cascadeclassifier.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/apps/traincascade/cascadeclassifier.cpp_docs.md`
- **File Name**: `cascadeclassifier.cpp_docs.md`
- **File Size**: 24,653 bytes
- **File Type**: .md
- **Link to Source**: [docs/apps/traincascade/cascadeclassifier.cpp_docs.md](../../../docs/apps/traincascade/cascadeclassifier.cpp_docs.md)
...
# Documentation for `apps/traincascade/cascadeclassifier.cpp`

## File Metadata

- **Full Path**: `apps/traincascade/cascadeclassifier.cpp`
- **File Name**: `cascadeclassifier.cpp`
- **File Size**: 21,652 bytes
- **File Type**: .cpp
- **Link to Source**: [apps/traincascade/cascadeclassifier.cpp](../../apps/traincascade/cascadeclassifier.cpp)
