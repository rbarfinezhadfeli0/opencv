# Documentation for `docs/apps/traincascade/haarfeatures.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/apps/traincascade/haarfeatures.cpp_docs.md`
- **File Name**: `haarfeatures.cpp_docs.md`
- **File Size**: 14,437 bytes
- **File Type**: .md
- **Link to Source**: [docs/apps/traincascade/haarfeatures.cpp_docs.md](../../../docs/apps/traincascade/haarfeatures.cpp_docs.md)
