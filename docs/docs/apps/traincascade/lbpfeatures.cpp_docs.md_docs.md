# Documentation for `docs/apps/traincascade/lbpfeatures.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/apps/traincascade/lbpfeatures.cpp_docs.md`
- **File Name**: `lbpfeatures.cpp_docs.md`
- **File Size**: 5,122 bytes
- **File Type**: .md
- **Link to Source**: [docs/apps/traincascade/lbpfeatures.cpp_docs.md](../../../docs/apps/traincascade/lbpfeatures.cpp_docs.md)
