# Documentation for `docs/cmake/OpenCVDetectCUDAUtils.cmake_docs.md`

## File Metadata

- **Full Path**: `docs/cmake/OpenCVDetectCUDAUtils.cmake_docs.md`
- **File Name**: `OpenCVDetectCUDAUtils.cmake_docs.md`
- **File Size**: 21,631 bytes
- **File Type**: .md
- **Link to Source**: [docs/cmake/OpenCVDetectCUDAUtils.cmake_docs.md](../../docs/cmake/OpenCVDetectCUDAUtils.cmake_docs.md)
...
# Documentation for `cmake/OpenCVDetectCUDAUtils.cmake`

## File Metadata

- **Full Path**: `cmake/OpenCVDetectCUDAUtils.cmake`
- **File Name**: `OpenCVDetectCUDAUtils.cmake`
- **File Size**: 20,661 bytes
- **File Type**: .cmake
- **Link to Source**: [cmake/OpenCVDetectCUDAUtils.cmake](../cmake/OpenCVDetectCUDAUtils.cmake)
