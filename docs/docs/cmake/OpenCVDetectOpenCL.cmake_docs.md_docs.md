# Documentation for `docs/cmake/OpenCVDetectOpenCL.cmake_docs.md`

## File Metadata

- **Full Path**: `docs/cmake/OpenCVDetectOpenCL.cmake_docs.md`
- **File Name**: `OpenCVDetectOpenCL.cmake_docs.md`
- **File Size**: 3,813 bytes
- **File Type**: .md
- **Link to Source**: [docs/cmake/OpenCVDetectOpenCL.cmake_docs.md](../../docs/cmake/OpenCVDetectOpenCL.cmake_docs.md)
...
# Documentation for `cmake/OpenCVDetectOpenCL.cmake`

## File Metadata

- **Full Path**: `cmake/OpenCVDetectOpenCL.cmake`
- **File Name**: `OpenCVDetectOpenCL.cmake`
- **File Size**: 2,859 bytes
- **File Type**: .cmake
- **Link to Source**: [cmake/OpenCVDetectOpenCL.cmake](../cmake/OpenCVDetectOpenCL.cmake)
