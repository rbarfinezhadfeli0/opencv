# Documentation for `docs/cmake/OpenCVDetectTBB.cmake_docs.md`

## File Metadata

- **Full Path**: `docs/cmake/OpenCVDetectTBB.cmake_docs.md`
- **File Name**: `OpenCVDetectTBB.cmake_docs.md`
- **File Size**: 5,736 bytes
- **File Type**: .md
- **Link to Source**: [docs/cmake/OpenCVDetectTBB.cmake_docs.md](../../docs/cmake/OpenCVDetectTBB.cmake_docs.md)
...
# Documentation for `cmake/OpenCVDetectTBB.cmake`

## File Metadata

- **Full Path**: `cmake/OpenCVDetectTBB.cmake`
- **File Name**: `OpenCVDetectTBB.cmake`
- **File Size**: 4,797 bytes
- **File Type**: .cmake
- **Link to Source**: [cmake/OpenCVDetectTBB.cmake](../cmake/OpenCVDetectTBB.cmake)
