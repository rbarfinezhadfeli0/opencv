# Documentation for `docs/cmake/OpenCVDetectVTK.cmake_docs.md`

## File Metadata

- **Full Path**: `docs/cmake/OpenCVDetectVTK.cmake_docs.md`
- **File Name**: `OpenCVDetectVTK.cmake_docs.md`
- **File Size**: 3,843 bytes
- **File Type**: .md
- **Link to Source**: [docs/cmake/OpenCVDetectVTK.cmake_docs.md](../../docs/cmake/OpenCVDetectVTK.cmake_docs.md)
...
# Documentation for `cmake/OpenCVDetectVTK.cmake`

## File Metadata

- **Full Path**: `cmake/OpenCVDetectVTK.cmake`
- **File Name**: `OpenCVDetectVTK.cmake`
- **File Size**: 2,904 bytes
- **File Type**: .cmake
- **Link to Source**: [cmake/OpenCVDetectVTK.cmake](../cmake/OpenCVDetectVTK.cmake)
