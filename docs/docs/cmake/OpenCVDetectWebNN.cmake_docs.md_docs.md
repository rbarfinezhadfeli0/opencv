# Documentation for `docs/cmake/OpenCVDetectWebNN.cmake_docs.md`

## File Metadata

- **Full Path**: `docs/cmake/OpenCVDetectWebNN.cmake_docs.md`
- **File Name**: `OpenCVDetectWebNN.cmake_docs.md`
- **File Size**: 2,488 bytes
- **File Type**: .md
- **Link to Source**: [docs/cmake/OpenCVDetectWebNN.cmake_docs.md](../../docs/cmake/OpenCVDetectWebNN.cmake_docs.md)
...
# Documentation for `cmake/OpenCVDetectWebNN.cmake`

## File Metadata

- **Full Path**: `cmake/OpenCVDetectWebNN.cmake`
- **File Name**: `OpenCVDetectWebNN.cmake`
- **File Size**: 1,539 bytes
- **File Type**: .cmake
- **Link to Source**: [cmake/OpenCVDetectWebNN.cmake](../cmake/OpenCVDetectWebNN.cmake)
