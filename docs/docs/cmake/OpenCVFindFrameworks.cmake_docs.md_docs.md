# Documentation for `docs/cmake/OpenCVFindFrameworks.cmake_docs.md`

## File Metadata

- **Full Path**: `docs/cmake/OpenCVFindFrameworks.cmake_docs.md`
- **File Name**: `OpenCVFindFrameworks.cmake_docs.md`
- **File Size**: 2,371 bytes
- **File Type**: .md
- **Link to Source**: [docs/cmake/OpenCVFindFrameworks.cmake_docs.md](../../docs/cmake/OpenCVFindFrameworks.cmake_docs.md)
...
# Documentation for `cmake/OpenCVFindFrameworks.cmake`

## File Metadata

- **Full Path**: `cmake/OpenCVFindFrameworks.cmake`
- **File Name**: `OpenCVFindFrameworks.cmake`
- **File Size**: 1,407 bytes
- **File Type**: .cmake
- **Link to Source**: [cmake/OpenCVFindFrameworks.cmake](../cmake/OpenCVFindFrameworks.cmake)
