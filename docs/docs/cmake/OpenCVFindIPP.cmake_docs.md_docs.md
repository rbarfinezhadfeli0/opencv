# Documentation for `docs/cmake/OpenCVFindIPP.cmake_docs.md`

## File Metadata

- **Full Path**: `docs/cmake/OpenCVFindIPP.cmake_docs.md`
- **File Name**: `OpenCVFindIPP.cmake_docs.md`
- **File Size**: 12,796 bytes
- **File Type**: .md
- **Link to Source**: [docs/cmake/OpenCVFindIPP.cmake_docs.md](../../docs/cmake/OpenCVFindIPP.cmake_docs.md)
...
# Documentation for `cmake/OpenCVFindIPP.cmake`

## File Metadata

- **Full Path**: `cmake/OpenCVFindIPP.cmake`
- **File Name**: `OpenCVFindIPP.cmake`
- **File Size**: 11,866 bytes
- **File Type**: .cmake
- **Link to Source**: [cmake/OpenCVFindIPP.cmake](../cmake/OpenCVFindIPP.cmake)
