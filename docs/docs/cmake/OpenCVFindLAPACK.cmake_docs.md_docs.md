# Documentation for `docs/cmake/OpenCVFindLAPACK.cmake_docs.md`

## File Metadata

- **Full Path**: `docs/cmake/OpenCVFindLAPACK.cmake_docs.md`
- **File Name**: `OpenCVFindLAPACK.cmake_docs.md`
- **File Size**: 12,120 bytes
- **File Type**: .md
- **Link to Source**: [docs/cmake/OpenCVFindLAPACK.cmake_docs.md](../../docs/cmake/OpenCVFindLAPACK.cmake_docs.md)
...
# Documentation for `cmake/OpenCVFindLAPACK.cmake`

## File Metadata

- **Full Path**: `cmake/OpenCVFindLAPACK.cmake`
- **File Name**: `OpenCVFindLAPACK.cmake`
- **File Size**: 11,175 bytes
- **File Type**: .cmake
- **Link to Source**: [cmake/OpenCVFindLAPACK.cmake](../cmake/OpenCVFindLAPACK.cmake)
