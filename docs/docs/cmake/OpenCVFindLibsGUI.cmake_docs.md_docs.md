# Documentation for `docs/cmake/OpenCVFindLibsGUI.cmake_docs.md`

## File Metadata

- **Full Path**: `docs/cmake/OpenCVFindLibsGUI.cmake_docs.md`
- **File Name**: `OpenCVFindLibsGUI.cmake_docs.md`
- **File Size**: 3,730 bytes
- **File Type**: .md
- **Link to Source**: [docs/cmake/OpenCVFindLibsGUI.cmake_docs.md](../../docs/cmake/OpenCVFindLibsGUI.cmake_docs.md)
...
# Documentation for `cmake/OpenCVFindLibsGUI.cmake`

## File Metadata

- **Full Path**: `cmake/OpenCVFindLibsGUI.cmake`
- **File Name**: `OpenCVFindLibsGUI.cmake`
- **File Size**: 2,781 bytes
- **File Type**: .cmake
- **Link to Source**: [cmake/OpenCVFindLibsGUI.cmake](../cmake/OpenCVFindLibsGUI.cmake)
