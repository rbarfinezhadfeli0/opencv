# Documentation for `docs/cmake/OpenCVFindLibsGrfmt.cmake_docs.md`

## File Metadata

- **Full Path**: `docs/cmake/OpenCVFindLibsGrfmt.cmake_docs.md`
- **File Name**: `OpenCVFindLibsGrfmt.cmake_docs.md`
- **File Size**: 16,031 bytes
- **File Type**: .md
- **Link to Source**: [docs/cmake/OpenCVFindLibsGrfmt.cmake_docs.md](../../docs/cmake/OpenCVFindLibsGrfmt.cmake_docs.md)
...
# Documentation for `cmake/OpenCVFindLibsGrfmt.cmake`

## File Metadata

- **Full Path**: `cmake/OpenCVFindLibsGrfmt.cmake`
- **File Name**: `OpenCVFindLibsGrfmt.cmake`
- **File Size**: 15,071 bytes
- **File Type**: .cmake
- **Link to Source**: [cmake/OpenCVFindLibsGrfmt.cmake](../cmake/OpenCVFindLibsGrfmt.cmake)
