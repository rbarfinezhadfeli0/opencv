# Documentation for `docs/cmake/OpenCVFindProtobuf.cmake_docs.md`

## File Metadata

- **Full Path**: `docs/cmake/OpenCVFindProtobuf.cmake_docs.md`
- **File Name**: `OpenCVFindProtobuf.cmake_docs.md`
- **File Size**: 4,877 bytes
- **File Type**: .md
- **Link to Source**: [docs/cmake/OpenCVFindProtobuf.cmake_docs.md](../../docs/cmake/OpenCVFindProtobuf.cmake_docs.md)
...
# Documentation for `cmake/OpenCVFindProtobuf.cmake`

## File Metadata

- **Full Path**: `cmake/OpenCVFindProtobuf.cmake`
- **File Name**: `OpenCVFindProtobuf.cmake`
- **File Size**: 3,923 bytes
- **File Type**: .cmake
- **Link to Source**: [cmake/OpenCVFindProtobuf.cmake](../cmake/OpenCVFindProtobuf.cmake)
