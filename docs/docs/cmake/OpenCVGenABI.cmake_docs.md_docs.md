# Documentation for `docs/cmake/OpenCVGenABI.cmake_docs.md`

## File Metadata

- **Full Path**: `docs/cmake/OpenCVGenABI.cmake_docs.md`
- **File Name**: `OpenCVGenABI.cmake_docs.md`
- **File Size**: 2,944 bytes
- **File Type**: .md
- **Link to Source**: [docs/cmake/OpenCVGenABI.cmake_docs.md](../../docs/cmake/OpenCVGenABI.cmake_docs.md)
...
# Documentation for `cmake/OpenCVGenABI.cmake`

## File Metadata

- **Full Path**: `cmake/OpenCVGenABI.cmake`
- **File Name**: `OpenCVGenABI.cmake`
- **File Size**: 2,020 bytes
- **File Type**: .cmake
- **Link to Source**: [cmake/OpenCVGenABI.cmake](../cmake/OpenCVGenABI.cmake)
