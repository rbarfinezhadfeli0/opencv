# Documentation for `docs/cmake/OpenCVGenConfig.cmake_docs.md`

## File Metadata

- **Full Path**: `docs/cmake/OpenCVGenConfig.cmake_docs.md`
- **File Name**: `OpenCVGenConfig.cmake_docs.md`
- **File Size**: 8,245 bytes
- **File Type**: .md
- **Link to Source**: [docs/cmake/OpenCVGenConfig.cmake_docs.md](../../docs/cmake/OpenCVGenConfig.cmake_docs.md)
...
# Documentation for `cmake/OpenCVGenConfig.cmake`

## File Metadata

- **Full Path**: `cmake/OpenCVGenConfig.cmake`
- **File Name**: `OpenCVGenConfig.cmake`
- **File Size**: 7,306 bytes
- **File Type**: .cmake
- **Link to Source**: [cmake/OpenCVGenConfig.cmake](../cmake/OpenCVGenConfig.cmake)
