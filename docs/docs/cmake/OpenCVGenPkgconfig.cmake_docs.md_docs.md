# Documentation for `docs/cmake/OpenCVGenPkgconfig.cmake_docs.md`

## File Metadata

- **Full Path**: `docs/cmake/OpenCVGenPkgconfig.cmake_docs.md`
- **File Name**: `OpenCVGenPkgconfig.cmake_docs.md`
- **File Size**: 5,826 bytes
- **File Type**: .md
- **Link to Source**: [docs/cmake/OpenCVGenPkgconfig.cmake_docs.md](../../docs/cmake/OpenCVGenPkgconfig.cmake_docs.md)
...
# Documentation for `cmake/OpenCVGenPkgconfig.cmake`

## File Metadata

- **Full Path**: `cmake/OpenCVGenPkgconfig.cmake`
- **File Name**: `OpenCVGenPkgconfig.cmake`
- **File Size**: 4,872 bytes
- **File Type**: .cmake
- **Link to Source**: [cmake/OpenCVGenPkgconfig.cmake](../cmake/OpenCVGenPkgconfig.cmake)
