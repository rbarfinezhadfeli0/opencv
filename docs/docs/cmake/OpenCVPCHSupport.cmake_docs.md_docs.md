# Documentation for `docs/cmake/OpenCVPCHSupport.cmake_docs.md`

## File Metadata

- **Full Path**: `docs/cmake/OpenCVPCHSupport.cmake_docs.md`
- **File Name**: `OpenCVPCHSupport.cmake_docs.md`
- **File Size**: 16,196 bytes
- **File Type**: .md
- **Link to Source**: [docs/cmake/OpenCVPCHSupport.cmake_docs.md](../../docs/cmake/OpenCVPCHSupport.cmake_docs.md)
...
# Documentation for `cmake/OpenCVPCHSupport.cmake`

## File Metadata

- **Full Path**: `cmake/OpenCVPCHSupport.cmake`
- **File Name**: `OpenCVPCHSupport.cmake`
- **File Size**: 15,251 bytes
- **File Type**: .cmake
- **Link to Source**: [cmake/OpenCVPCHSupport.cmake](../cmake/OpenCVPCHSupport.cmake)
