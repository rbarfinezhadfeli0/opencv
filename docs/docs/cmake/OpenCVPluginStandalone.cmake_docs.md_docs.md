# Documentation for `docs/cmake/OpenCVPluginStandalone.cmake_docs.md`

## File Metadata

- **Full Path**: `docs/cmake/OpenCVPluginStandalone.cmake_docs.md`
- **File Name**: `OpenCVPluginStandalone.cmake_docs.md`
- **File Size**: 5,658 bytes
- **File Type**: .md
- **Link to Source**: [docs/cmake/OpenCVPluginStandalone.cmake_docs.md](../../docs/cmake/OpenCVPluginStandalone.cmake_docs.md)
...
# Documentation for `cmake/OpenCVPluginStandalone.cmake`

## File Metadata

- **Full Path**: `cmake/OpenCVPluginStandalone.cmake`
- **File Name**: `OpenCVPluginStandalone.cmake`
- **File Size**: 4,684 bytes
- **File Type**: .cmake
- **Link to Source**: [cmake/OpenCVPluginStandalone.cmake](../cmake/OpenCVPluginStandalone.cmake)
