# Documentation for `docs/cmake/OpenCVUtils.cmake_docs.md`

## File Metadata

- **Full Path**: `docs/cmake/OpenCVUtils.cmake_docs.md`
- **File Name**: `OpenCVUtils.cmake_docs.md`
- **File Size**: 50,936 bytes
- **File Type**: .md
- **Link to Source**: [docs/cmake/OpenCVUtils.cmake_docs.md](../../docs/cmake/OpenCVUtils.cmake_docs.md)
...
# Documentation for `cmake/OpenCVUtils.cmake`

## File Metadata

- **Full Path**: `cmake/OpenCVUtils.cmake`
- **File Name**: `OpenCVUtils.cmake`
- **File Size**: 71,402 bytes
- **File Type**: .cmake
- **Link to Source**: [cmake/OpenCVUtils.cmake](../cmake/OpenCVUtils.cmake)
