# Documentation for `docs/cmake/android/android_gradle_projects.cmake_docs.md`

## File Metadata

- **Full Path**: `docs/cmake/android/android_gradle_projects.cmake_docs.md`
- **File Name**: `android_gradle_projects.cmake_docs.md`
- **File Size**: 11,113 bytes
- **File Type**: .md
- **Link to Source**: [docs/cmake/android/android_gradle_projects.cmake_docs.md](../../../docs/cmake/android/android_gradle_projects.cmake_docs.md)
...
# Documentation for `cmake/android/android_gradle_projects.cmake`

## File Metadata

- **Full Path**: `cmake/android/android_gradle_projects.cmake`
- **File Name**: `android_gradle_projects.cmake`
- **File Size**: 10,090 bytes
- **File Type**: .cmake
- **Link to Source**: [cmake/android/android_gradle_projects.cmake](../../cmake/android/android_gradle_projects.cmake)

## Purpose and Role

This file is located in the `cmake/android` directory and serves as part of the OpenCV library infrastructure.
