# Documentation for `docs/cmake/checks/cpu_neon.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/cmake/checks/cpu_neon.cpp_docs.md`
- **File Name**: `cpu_neon.cpp_docs.md`
- **File Size**: 3,587 bytes
- **File Type**: .md
- **Link to Source**: [docs/cmake/checks/cpu_neon.cpp_docs.md](../../../docs/cmake/checks/cpu_neon.cpp_docs.md)
...
# Documentation for `cmake/checks/cpu_neon.cpp`

## File Metadata

- **Full Path**: `cmake/checks/cpu_neon.cpp`
- **File Name**: `cpu_neon.cpp`
- **File Size**: 731 bytes
- **File Type**: .cpp
- **Link to Source**: [cmake/checks/cpu_neon.cpp](../../cmake/checks/cpu_neon.cpp)
