# Documentation for `docs/cmake/checks/cpu_vsx3.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/cmake/checks/cpu_vsx3.cpp_docs.md`
- **File Name**: `cpu_vsx3.cpp_docs.md`
- **File Size**: 3,290 bytes
- **File Type**: .md
- **Link to Source**: [docs/cmake/checks/cpu_vsx3.cpp_docs.md](../../../docs/cmake/checks/cpu_vsx3.cpp_docs.md)
...
# Documentation for `cmake/checks/cpu_vsx3.cpp`

## File Metadata

- **Full Path**: `cmake/checks/cpu_vsx3.cpp`
- **File Name**: `cpu_vsx3.cpp`
- **File Size**: 432 bytes
- **File Type**: .cpp
- **Link to Source**: [cmake/checks/cpu_vsx3.cpp](../../cmake/checks/cpu_vsx3.cpp)
