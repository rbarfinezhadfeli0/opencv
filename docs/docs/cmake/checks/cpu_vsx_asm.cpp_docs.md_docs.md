# Documentation for `docs/cmake/checks/cpu_vsx_asm.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/cmake/checks/cpu_vsx_asm.cpp_docs.md`
- **File Name**: `cpu_vsx_asm.cpp_docs.md`
- **File Size**: 3,430 bytes
- **File Type**: .md
- **Link to Source**: [docs/cmake/checks/cpu_vsx_asm.cpp_docs.md](../../../docs/cmake/checks/cpu_vsx_asm.cpp_docs.md)
...
# Documentation for `cmake/checks/cpu_vsx_asm.cpp`

## File Metadata

- **Full Path**: `cmake/checks/cpu_vsx_asm.cpp`
- **File Name**: `cpu_vsx_asm.cpp`
- **File Size**: 557 bytes
- **File Type**: .cpp
- **Link to Source**: [cmake/checks/cpu_vsx_asm.cpp](../../cmake/checks/cpu_vsx_asm.cpp)
