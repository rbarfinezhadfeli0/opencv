# Documentation for `docs/cmake/mirrors/custom.cmake_docs.md`

## File Metadata

- **Full Path**: `docs/cmake/mirrors/custom.cmake_docs.md`
- **File Name**: `custom.cmake_docs.md`
- **File Size**: 4,892 bytes
- **File Type**: .md
- **Link to Source**: [docs/cmake/mirrors/custom.cmake_docs.md](../../../docs/cmake/mirrors/custom.cmake_docs.md)
...
# Documentation for `cmake/mirrors/custom.cmake`

## File Metadata

- **Full Path**: `cmake/mirrors/custom.cmake`
- **File Name**: `custom.cmake`
- **File Size**: 3,955 bytes
- **File Type**: .cmake
- **Link to Source**: [cmake/mirrors/custom.cmake](../../cmake/mirrors/custom.cmake)
