# Documentation for `docs/cmake/templates/OpenCV.mk.in_docs.md`

## File Metadata

- **Full Path**: `docs/cmake/templates/OpenCV.mk.in_docs.md`
- **File Name**: `OpenCV.mk.in_docs.md`
- **File Size**: 4,559 bytes
- **File Type**: .md
- **Link to Source**: [docs/cmake/templates/OpenCV.mk.in_docs.md](../../../docs/cmake/templates/OpenCV.mk.in_docs.md)
...
# Documentation for `cmake/templates/OpenCV.mk.in`

## File Metadata

- **Full Path**: `cmake/templates/OpenCV.mk.in`
- **File Name**: `OpenCV.mk.in`
- **File Size**: 4,023 bytes
- **File Type**: .in
- **Link to Source**: [cmake/templates/OpenCV.mk.in](../../cmake/templates/OpenCV.mk.in)
