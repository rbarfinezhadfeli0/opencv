# Documentation for `docs/cmake/templates/cvconfig.h.in_docs.md`

## File Metadata

- **Full Path**: `docs/cmake/templates/cvconfig.h.in_docs.md`
- **File Name**: `cvconfig.h.in_docs.md`
- **File Size**: 3,921 bytes
- **File Type**: .md
- **Link to Source**: [docs/cmake/templates/cvconfig.h.in_docs.md](../../../docs/cmake/templates/cvconfig.h.in_docs.md)
...
# Documentation for `cmake/templates/cvconfig.h.in`

## File Metadata

- **Full Path**: `cmake/templates/cvconfig.h.in`
- **File Name**: `cvconfig.h.in`
- **File Size**: 3,380 bytes
- **File Type**: .in
- **Link to Source**: [cmake/templates/cvconfig.h.in](../../cmake/templates/cvconfig.h.in)
