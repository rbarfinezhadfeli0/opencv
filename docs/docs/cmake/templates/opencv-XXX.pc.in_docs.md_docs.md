# Documentation for `docs/cmake/templates/opencv-XXX.pc.in_docs.md`

## File Metadata

- **Full Path**: `docs/cmake/templates/opencv-XXX.pc.in_docs.md`
- **File Name**: `opencv-XXX.pc.in_docs.md`
- **File Size**: 855 bytes
- **File Type**: .md
- **Link to Source**: [docs/cmake/templates/opencv-XXX.pc.in_docs.md](../../../docs/cmake/templates/opencv-XXX.pc.in_docs.md)
