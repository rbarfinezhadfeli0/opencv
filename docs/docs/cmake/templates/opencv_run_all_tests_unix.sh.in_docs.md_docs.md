# Documentation for `docs/cmake/templates/opencv_run_all_tests_unix.sh.in_docs.md`

## File Metadata

- **Full Path**: `docs/cmake/templates/opencv_run_all_tests_unix.sh.in_docs.md`
- **File Name**: `opencv_run_all_tests_unix.sh.in_docs.md`
- **File Size**: 4,913 bytes
- **File Type**: .md
- **Link to Source**: [docs/cmake/templates/opencv_run_all_tests_unix.sh.in_docs.md](../../../docs/cmake/templates/opencv_run_all_tests_unix.sh.in_docs.md)
...
# Documentation for `cmake/templates/opencv_run_all_tests_unix.sh.in`

## File Metadata

- **Full Path**: `cmake/templates/opencv_run_all_tests_unix.sh.in`
- **File Name**: `opencv_run_all_tests_unix.sh.in`
- **File Size**: 4,282 bytes
- **File Type**: .in
- **Link to Source**: [cmake/templates/opencv_run_all_tests_unix.sh.in](../../cmake/templates/opencv_run_all_tests_unix.sh.in)
