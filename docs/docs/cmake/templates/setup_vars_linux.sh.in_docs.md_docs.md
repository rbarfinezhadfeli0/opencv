# Documentation for `docs/cmake/templates/setup_vars_linux.sh.in_docs.md`

## File Metadata

- **Full Path**: `docs/cmake/templates/setup_vars_linux.sh.in_docs.md`
- **File Name**: `setup_vars_linux.sh.in_docs.md`
- **File Size**: 1,314 bytes
- **File Type**: .md
- **Link to Source**: [docs/cmake/templates/setup_vars_linux.sh.in_docs.md](../../../docs/cmake/templates/setup_vars_linux.sh.in_docs.md)
...
# Documentation for `cmake/templates/setup_vars_linux.sh.in`

## File Metadata

- **Full Path**: `cmake/templates/setup_vars_linux.sh.in`
- **File Name**: `setup_vars_linux.sh.in`
- **File Size**: 730 bytes
- **File Type**: .in
- **Link to Source**: [cmake/templates/setup_vars_linux.sh.in](../../cmake/templates/setup_vars_linux.sh.in)
