# Documentation for `docs/cmake/vars/EnableModeVars.cmake_docs.md`

## File Metadata

- **Full Path**: `docs/cmake/vars/EnableModeVars.cmake_docs.md`
- **File Name**: `EnableModeVars.cmake_docs.md`
- **File Size**: 1,633 bytes
- **File Type**: .md
- **Link to Source**: [docs/cmake/vars/EnableModeVars.cmake_docs.md](../../../docs/cmake/vars/EnableModeVars.cmake_docs.md)
