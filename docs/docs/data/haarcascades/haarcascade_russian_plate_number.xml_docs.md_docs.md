# Documentation for `docs/data/haarcascades/haarcascade_russian_plate_number.xml_docs.md`

## File Metadata

- **Full Path**: `docs/data/haarcascades/haarcascade_russian_plate_number.xml_docs.md`
- **File Name**: `haarcascade_russian_plate_number.xml_docs.md`
- **File Size**: 51,092 bytes
- **File Type**: .md
- **Link to Source**: [docs/data/haarcascades/haarcascade_russian_plate_number.xml_docs.md](../../../docs/data/haarcascades/haarcascade_russian_plate_number.xml_docs.md)
...
# Documentation for `data/haarcascades/haarcascade_russian_plate_number.xml`

## File Metadata

- **Full Path**: `data/haarcascades/haarcascade_russian_plate_number.xml`
- **File Name**: `haarcascade_russian_plate_number.xml`
- **File Size**: 75,482 bytes
- **File Type**: .xml
- **Link to Source**: [data/haarcascades/haarcascade_russian_plate_number.xml](../../data/haarcascades/haarcascade_russian_plate_number.xml)
