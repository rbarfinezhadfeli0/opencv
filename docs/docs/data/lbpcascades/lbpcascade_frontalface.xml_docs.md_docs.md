# Documentation for `docs/data/lbpcascades/lbpcascade_frontalface.xml_docs.md`

## File Metadata

- **Full Path**: `docs/data/lbpcascades/lbpcascade_frontalface.xml_docs.md`
- **File Name**: `lbpcascade_frontalface.xml_docs.md`
- **File Size**: 51,037 bytes
- **File Type**: .md
- **Link to Source**: [docs/data/lbpcascades/lbpcascade_frontalface.xml_docs.md](../../../docs/data/lbpcascades/lbpcascade_frontalface.xml_docs.md)
...
# Documentation for `data/lbpcascades/lbpcascade_frontalface.xml`

## File Metadata

- **Full Path**: `data/lbpcascades/lbpcascade_frontalface.xml`
- **File Name**: `lbpcascade_frontalface.xml`
- **File Size**: 51,856 bytes
- **File Type**: .xml
- **Link to Source**: [data/lbpcascades/lbpcascade_frontalface.xml](../../data/lbpcascades/lbpcascade_frontalface.xml)
