# Documentation for `docs/data/lbpcascades/lbpcascade_profileface.xml_docs.md`

## File Metadata

- **Full Path**: `docs/data/lbpcascades/lbpcascade_profileface.xml_docs.md`
- **File Name**: `lbpcascade_profileface.xml_docs.md`
- **File Size**: 46,761 bytes
- **File Type**: .md
- **Link to Source**: [docs/data/lbpcascades/lbpcascade_profileface.xml_docs.md](../../../docs/data/lbpcascades/lbpcascade_profileface.xml_docs.md)
...
# Documentation for `data/lbpcascades/lbpcascade_profileface.xml`

## File Metadata

- **Full Path**: `data/lbpcascades/lbpcascade_profileface.xml`
- **File Name**: `lbpcascade_profileface.xml`
- **File Size**: 47,015 bytes
- **File Type**: .xml
- **Link to Source**: [data/lbpcascades/lbpcascade_profileface.xml](../../data/lbpcascades/lbpcascade_profileface.xml)
