# Documentation for `docs/data/lbpcascades/lbpcascade_silverware.xml_docs.md`

## File Metadata

- **Full Path**: `docs/data/lbpcascades/lbpcascade_silverware.xml_docs.md`
- **File Name**: `lbpcascade_silverware.xml_docs.md`
- **File Size**: 46,764 bytes
- **File Type**: .md
- **Link to Source**: [docs/data/lbpcascades/lbpcascade_silverware.xml_docs.md](../../../docs/data/lbpcascades/lbpcascade_silverware.xml_docs.md)
...
# Documentation for `data/lbpcascades/lbpcascade_silverware.xml`

## File Metadata

- **Full Path**: `data/lbpcascades/lbpcascade_silverware.xml`
- **File Name**: `lbpcascade_silverware.xml`
- **File Size**: 47,027 bytes
- **File Type**: .xml
- **Link to Source**: [data/lbpcascades/lbpcascade_silverware.xml](../../data/lbpcascades/lbpcascade_silverware.xml)
