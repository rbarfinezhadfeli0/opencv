# Documentation for `docs/doc/CMakeLists.txt_docs.md`

## File Metadata

- **Full Path**: `docs/doc/CMakeLists.txt_docs.md`
- **File Name**: `CMakeLists.txt_docs.md`
- **File Size**: 14,196 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/CMakeLists.txt_docs.md](../../docs/doc/CMakeLists.txt_docs.md)
...
# Documentation for `doc/CMakeLists.txt`

## File Metadata

- **Full Path**: `doc/CMakeLists.txt`
- **File Name**: `CMakeLists.txt`
- **File Size**: 13,303 bytes
- **File Type**: .txt
- **Link to Source**: [doc/CMakeLists.txt](../doc/CMakeLists.txt)
