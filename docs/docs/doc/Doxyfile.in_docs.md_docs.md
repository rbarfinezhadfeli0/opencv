# Documentation for `docs/doc/Doxyfile.in_docs.md`

## File Metadata

- **Full Path**: `docs/doc/Doxyfile.in_docs.md`
- **File Name**: `Doxyfile.in_docs.md`
- **File Size**: 17,137 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/Doxyfile.in_docs.md](../../docs/doc/Doxyfile.in_docs.md)
...
# Documentation for `doc/Doxyfile.in`

## File Metadata

- **Full Path**: `doc/Doxyfile.in`
- **File Name**: `Doxyfile.in`
- **File Size**: 16,668 bytes
- **File Type**: .in
- **Link to Source**: [doc/Doxyfile.in](../doc/Doxyfile.in)
