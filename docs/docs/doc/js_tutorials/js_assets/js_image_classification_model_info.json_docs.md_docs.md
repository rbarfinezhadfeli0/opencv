# Documentation for `docs/doc/js_tutorials/js_assets/js_image_classification_model_info.json_docs.md`

## File Metadata

- **Full Path**: `docs/doc/js_tutorials/js_assets/js_image_classification_model_info.json_docs.md`
- **File Name**: `js_image_classification_model_info.json_docs.md`
- **File Size**: 4,397 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/js_tutorials/js_assets/js_image_classification_model_info.json_docs.md](../../../../docs/doc/js_tutorials/js_assets/js_image_classification_model_info.json_docs.md)
