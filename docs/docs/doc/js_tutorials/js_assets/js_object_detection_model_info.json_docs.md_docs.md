# Documentation for `docs/doc/js_tutorials/js_assets/js_object_detection_model_info.json_docs.md`

## File Metadata

- **Full Path**: `docs/doc/js_tutorials/js_assets/js_object_detection_model_info.json_docs.md`
- **File Name**: `js_object_detection_model_info.json_docs.md`
- **File Size**: 2,857 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/js_tutorials/js_assets/js_object_detection_model_info.json_docs.md](../../../../docs/doc/js_tutorials/js_assets/js_object_detection_model_info.json_docs.md)
