# Documentation for `docs/doc/js_tutorials/js_assets/webnn-electron/`
...
**Path**: `docs/doc/js_tutorials/js_assets/webnn-electron/`
**Direct Files**: 10
**Subfolders**: 0
...
- **[main.js_docs.md](main.js_docs.md_docs.md)**: Main entry point
- **[main.js_kw.md](main.js_kw.md_docs.md)**: Main entry point
- **[node_setup.js_docs.md](node_setup.js_docs.md_docs.md)**: MD file
- **[node_setup.js_kw.md](node_setup.js_kw.md_docs.md)**: MD file
...
- **Parent Folder**: [docs/doc/js_tutorials/js_assets/](../js_assets/doc.md)
