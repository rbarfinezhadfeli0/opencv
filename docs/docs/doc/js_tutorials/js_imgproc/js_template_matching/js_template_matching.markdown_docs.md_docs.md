# Documentation for `docs/doc/js_tutorials/js_imgproc/js_template_matching/js_template_matching.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/js_tutorials/js_imgproc/js_template_matching/js_template_matching.markdown_docs.md`
- **File Name**: `js_template_matching.markdown_docs.md`
- **File Size**: 2,915 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/js_tutorials/js_imgproc/js_template_matching/js_template_matching.markdown_docs.md](../../../../../docs/doc/js_tutorials/js_imgproc/js_template_matching/js_template_matching.markdown_docs.md)
...
# Documentation for `doc/js_tutorials/js_imgproc/js_template_matching/js_template_matching.markdown`

## File Metadata

- **Full Path**: `doc/js_tutorials/js_imgproc/js_template_matching/js_template_matching.markdown`
- **File Name**: `js_template_matching.markdown`
- **File Size**: 2,117 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/js_tutorials/js_imgproc/js_template_matching/js_template_matching.markdown](../../../../doc/js_tutorials/js_imgproc/js_template_matching/js_template_matching.markdown)

## Purpose and Role

This file is located in the `doc/js_tutorials/js_imgproc/js_template_matching` directory and serves as part of the OpenCV library infrastructure.
