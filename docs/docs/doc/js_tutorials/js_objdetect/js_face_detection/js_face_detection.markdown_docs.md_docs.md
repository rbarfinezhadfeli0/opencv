# Documentation for `docs/doc/js_tutorials/js_objdetect/js_face_detection/js_face_detection.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/js_tutorials/js_objdetect/js_face_detection/js_face_detection.markdown_docs.md`
- **File Name**: `js_face_detection.markdown_docs.md`
- **File Size**: 7,342 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/js_tutorials/js_objdetect/js_face_detection/js_face_detection.markdown_docs.md](../../../../../docs/doc/js_tutorials/js_objdetect/js_face_detection/js_face_detection.markdown_docs.md)
...
# Documentation for `doc/js_tutorials/js_objdetect/js_face_detection/js_face_detection.markdown`

## File Metadata

- **Full Path**: `doc/js_tutorials/js_objdetect/js_face_detection/js_face_detection.markdown`
- **File Name**: `js_face_detection.markdown`
- **File Size**: 6,564 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/js_tutorials/js_objdetect/js_face_detection/js_face_detection.markdown](../../../../doc/js_tutorials/js_objdetect/js_face_detection/js_face_detection.markdown)

## Purpose and Role

This file is located in the `doc/js_tutorials/js_objdetect/js_face_detection` directory and serves as part of the OpenCV library infrastructure.
