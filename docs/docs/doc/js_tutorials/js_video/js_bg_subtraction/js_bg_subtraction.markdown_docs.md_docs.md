# Documentation for `docs/doc/js_tutorials/js_video/js_bg_subtraction/js_bg_subtraction.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/js_tutorials/js_video/js_bg_subtraction/js_bg_subtraction.markdown_docs.md`
- **File Name**: `js_bg_subtraction.markdown_docs.md`
- **File Size**: 4,054 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/js_tutorials/js_video/js_bg_subtraction/js_bg_subtraction.markdown_docs.md](../../../../../docs/doc/js_tutorials/js_video/js_bg_subtraction/js_bg_subtraction.markdown_docs.md)

## Purpose and Role

This file is located in the `docs/doc/js_tutorials/js_video/js_bg_subtraction` directory and serves as part of the OpenCV library infrastructure.

## Documentation Content

# Documentation for `doc/js_tutorials/js_video/js_bg_subtraction/js_bg_subtraction.markdown`

## File Metadata

- **Full Path**: `doc/js_tutorials/js_video/js_bg_subtraction/js_bg_subtraction.markdown`
- **File Name**: `js_bg_subtraction.markdown`
- **File Size**: 3,296 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/js_tutorials/js_video/js_bg_subtraction/js_bg_subtraction.markdown](../../../../doc/js_tutorials/js_video/js_bg_subtraction/js_bg_subtraction.markdown)

## Purpose and Role

This file is located in the `doc/js_tutorials/js_video/js_bg_subtraction` directory and serves as part of the OpenCV library infrastructure.
