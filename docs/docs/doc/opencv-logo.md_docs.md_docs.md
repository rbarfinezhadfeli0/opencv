# Documentation for `docs/doc/opencv-logo.md_docs.md`

## File Metadata

- **Full Path**: `docs/doc/opencv-logo.md_docs.md`
- **File Name**: `opencv-logo.md_docs.md`
- **File Size**: 1,506 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/opencv-logo.md_docs.md](../../docs/doc/opencv-logo.md_docs.md)
...
# Documentation for `doc/opencv-logo.md`

## File Metadata

- **Full Path**: `doc/opencv-logo.md`
- **File Name**: `opencv-logo.md`
- **File Size**: 981 bytes
- **File Type**: .md
- **Link to Source**: [doc/opencv-logo.md](../doc/opencv-logo.md)
