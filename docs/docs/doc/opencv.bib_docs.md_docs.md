# Documentation for `docs/doc/opencv.bib_docs.md`

## File Metadata

- **Full Path**: `docs/doc/opencv.bib_docs.md`
- **File Name**: `opencv.bib_docs.md`
- **File Size**: 50,603 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/opencv.bib_docs.md](../../docs/doc/opencv.bib_docs.md)
...
# Documentation for `doc/opencv.bib`

## File Metadata

- **Full Path**: `doc/opencv.bib`
- **File Name**: `opencv.bib`
- **File Size**: 62,016 bytes
- **File Type**: .bib
- **Link to Source**: [doc/opencv.bib](../doc/opencv.bib)
...
@article{HTF01,
  ...
  volume = {1},
  number = {8},
  url = {https://web.archive.org/web/20200918132934/http://www.stat.auckland.ac.nz/~yee/784/files/ch09AdditiveModelsTrees.pdf}
}
@article{Hartley99,
...
@inproceedings{LCS11,
  ...
  pages = {2548--2555},
  publisher = {IEEE},
  url = {https://www.research-collection.ethz.ch/bitstream/handle/20.500.11850/43288/eth-7684-01.pdf}
}
...
@incollection{Liao2007,
  ...
  year = {2007},
  publisher = {Springer},
  url = {https://www.researchgate.net/publication/225231394_Learning_Multi-scale_Block_Local_Binary_Patterns_for_Face_Recognition}
}
...
@inproceedings{Lienhart02,
  ...
  volume = {1},
  publisher = {IEEE},
  url = {https://opus.bibliothek.uni-augsburg.de/opus4/frontdoor/deliver/index/docId/67686/file/67686.pdf}
}
@article{Louhichi07,
...
@inproceedings{RPROP93,
  ...
  pages = {586--591},
  publisher = {IEEE},
  url = {https://www.cs.cmu.edu/~bhiksha/courses/deeplearning/Fall.2016/pdfs/Rprop.pdf}
}
