# Documentation for `docs/doc/py_tutorials/py_bindings/py_bindings_basics/py_bindings_basics.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/py_tutorials/py_bindings/py_bindings_basics/py_bindings_basics.markdown_docs.md`
- **File Name**: `py_bindings_basics.markdown_docs.md`
- **File Size**: 11,514 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/py_tutorials/py_bindings/py_bindings_basics/py_bindings_basics.markdown_docs.md](../../../../../docs/doc/py_tutorials/py_bindings/py_bindings_basics/py_bindings_basics.markdown_docs.md)

## Purpose and Role

This file is located in the `docs/doc/py_tutorials/py_bindings/py_bindings_basics` directory and serves as part of the OpenCV library infrastructure.

## Documentation Content

# Documentation for `doc/py_tutorials/py_bindings/py_bindings_basics/py_bindings_basics.markdown`

## File Metadata

- **Full Path**: `doc/py_tutorials/py_bindings/py_bindings_basics/py_bindings_basics.markdown`
- **File Name**: `py_bindings_basics.markdown`
- **File Size**: 10,730 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/py_tutorials/py_bindings/py_bindings_basics/py_bindings_basics.markdown](../../../../doc/py_tutorials/py_bindings/py_bindings_basics/py_bindings_basics.markdown)

## Purpose and Role

This file is located in the `doc/py_tutorials/py_bindings/py_bindings_basics` directory and serves as part of the OpenCV library infrastructure.
