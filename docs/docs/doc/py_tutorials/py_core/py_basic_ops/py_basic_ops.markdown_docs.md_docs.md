# Documentation for `docs/doc/py_tutorials/py_core/py_basic_ops/py_basic_ops.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/py_tutorials/py_core/py_basic_ops/py_basic_ops.markdown_docs.md`
- **File Name**: `py_basic_ops.markdown_docs.md`
- **File Size**: 6,850 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/py_tutorials/py_core/py_basic_ops/py_basic_ops.markdown_docs.md](../../../../../docs/doc/py_tutorials/py_core/py_basic_ops/py_basic_ops.markdown_docs.md)

## Purpose and Role

This file is located in the `docs/doc/py_tutorials/py_core/py_basic_ops` directory and serves as part of the OpenCV library infrastructure.

## Documentation Content

# Documentation for `doc/py_tutorials/py_core/py_basic_ops/py_basic_ops.markdown`

## File Metadata

- **Full Path**: `doc/py_tutorials/py_core/py_basic_ops/py_basic_ops.markdown`
- **File Name**: `py_basic_ops.markdown`
- **File Size**: 6,147 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/py_tutorials/py_core/py_basic_ops/py_basic_ops.markdown](../../../../doc/py_tutorials/py_core/py_basic_ops/py_basic_ops.markdown)

## Purpose and Role

This file is located in the `doc/py_tutorials/py_core/py_basic_ops` directory and serves as part of the OpenCV library infrastructure.
