# Documentation for `docs/doc/py_tutorials/py_gui/py_drawing_functions/py_drawing_functions.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/py_tutorials/py_gui/py_drawing_functions/py_drawing_functions.markdown_docs.md`
- **File Name**: `py_drawing_functions.markdown_docs.md`
- **File Size**: 5,099 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/py_tutorials/py_gui/py_drawing_functions/py_drawing_functions.markdown_docs.md](../../../../../docs/doc/py_tutorials/py_gui/py_drawing_functions/py_drawing_functions.markdown_docs.md)
...
# Documentation for `doc/py_tutorials/py_gui/py_drawing_functions/py_drawing_functions.markdown`

## File Metadata

- **Full Path**: `doc/py_tutorials/py_gui/py_drawing_functions/py_drawing_functions.markdown`
- **File Name**: `py_drawing_functions.markdown`
- **File Size**: 4,321 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/py_tutorials/py_gui/py_drawing_functions/py_drawing_functions.markdown](../../../../doc/py_tutorials/py_gui/py_drawing_functions/py_drawing_functions.markdown)

## Purpose and Role

This file is located in the `doc/py_tutorials/py_gui/py_drawing_functions` directory and serves as part of the OpenCV library infrastructure.
