# Documentation for `docs/doc/py_tutorials/py_gui/py_video_display/py_video_display.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/py_tutorials/py_gui/py_video_display/py_video_display.markdown_docs.md`
- **File Name**: `py_video_display.markdown_docs.md`
- **File Size**: 6,649 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/py_tutorials/py_gui/py_video_display/py_video_display.markdown_docs.md](../../../../../docs/doc/py_tutorials/py_gui/py_video_display/py_video_display.markdown_docs.md)
...
# Documentation for `doc/py_tutorials/py_gui/py_video_display/py_video_display.markdown`

## File Metadata

- **Full Path**: `doc/py_tutorials/py_gui/py_video_display/py_video_display.markdown`
- **File Name**: `py_video_display.markdown`
- **File Size**: 5,911 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/py_tutorials/py_gui/py_video_display/py_video_display.markdown](../../../../doc/py_tutorials/py_gui/py_video_display/py_video_display.markdown)

## Purpose and Role

This file is located in the `doc/py_tutorials/py_gui/py_video_display` directory and serves as part of the OpenCV library infrastructure.
