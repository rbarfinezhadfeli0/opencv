# Documentation for `docs/doc/py_tutorials/py_imgproc/py_canny/py_canny.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/py_tutorials/py_imgproc/py_canny/py_canny.markdown_docs.md`
- **File Name**: `py_canny.markdown_docs.md`
- **File Size**: 5,523 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/py_tutorials/py_imgproc/py_canny/py_canny.markdown_docs.md](../../../../../docs/doc/py_tutorials/py_imgproc/py_canny/py_canny.markdown_docs.md)
...
# Documentation for `doc/py_tutorials/py_imgproc/py_canny/py_canny.markdown`

## File Metadata

- **Full Path**: `doc/py_tutorials/py_imgproc/py_canny/py_canny.markdown`
- **File Name**: `py_canny.markdown`
- **File Size**: 4,845 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/py_tutorials/py_imgproc/py_canny/py_canny.markdown](../../../../doc/py_tutorials/py_imgproc/py_canny/py_canny.markdown)

## Purpose and Role

This file is located in the `doc/py_tutorials/py_imgproc/py_canny` directory and serves as part of the OpenCV library infrastructure.
