# Documentation for `docs/doc/py_tutorials/py_imgproc/py_table_of_contents_imgproc.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/py_tutorials/py_imgproc/py_table_of_contents_imgproc.markdown_docs.md`
- **File Name**: `py_table_of_contents_imgproc.markdown_docs.md`
- **File Size**: 2,619 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/py_tutorials/py_imgproc/py_table_of_contents_imgproc.markdown_docs.md](../../../../docs/doc/py_tutorials/py_imgproc/py_table_of_contents_imgproc.markdown_docs.md)
...
# Documentation for `doc/py_tutorials/py_imgproc/py_table_of_contents_imgproc.markdown`

## File Metadata

- **Full Path**: `doc/py_tutorials/py_imgproc/py_table_of_contents_imgproc.markdown`
- **File Name**: `py_table_of_contents_imgproc.markdown`
- **File Size**: 1,889 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/py_tutorials/py_imgproc/py_table_of_contents_imgproc.markdown](../../../doc/py_tutorials/py_imgproc/py_table_of_contents_imgproc.markdown)

## Purpose and Role

This file is located in the `doc/py_tutorials/py_imgproc` directory and serves as part of the OpenCV library infrastructure.
