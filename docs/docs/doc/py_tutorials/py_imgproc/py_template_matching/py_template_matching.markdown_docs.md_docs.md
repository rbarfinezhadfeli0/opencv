# Documentation for `docs/doc/py_tutorials/py_imgproc/py_template_matching/py_template_matching.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/py_tutorials/py_imgproc/py_template_matching/py_template_matching.markdown_docs.md`
- **File Name**: `py_template_matching.markdown_docs.md`
- **File Size**: 5,351 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/py_tutorials/py_imgproc/py_template_matching/py_template_matching.markdown_docs.md](../../../../../docs/doc/py_tutorials/py_imgproc/py_template_matching/py_template_matching.markdown_docs.md)

## Purpose and Role

This file is located in the `docs/doc/py_tutorials/py_imgproc/py_template_matching` directory and serves as part of the OpenCV library infrastructure.

## Documentation Content

# Documentation for `doc/py_tutorials/py_imgproc/py_template_matching/py_template_matching.markdown`

## File Metadata

- **Full Path**: `doc/py_tutorials/py_imgproc/py_template_matching/py_template_matching.markdown`
- **File Name**: `py_template_matching.markdown`
- **File Size**: 4,553 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/py_tutorials/py_imgproc/py_template_matching/py_template_matching.markdown](../../../../doc/py_tutorials/py_imgproc/py_template_matching/py_template_matching.markdown)

## Purpose and Role

This file is located in the `doc/py_tutorials/py_imgproc/py_template_matching` directory and serves as part of the OpenCV library infrastructure.
