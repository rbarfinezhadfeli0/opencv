# Documentation for `docs/doc/py_tutorials/py_ml/py_knn/`
...
**Path**: `docs/doc/py_tutorials/py_ml/py_knn/`
**Direct Files**: 2
**Subfolders**: 3
...
- **[py_knn_index.markdown_docs.md](py_knn_index.markdown_docs.md_docs.md)**: MD file
- **[py_knn_index.markdown_kw.md](py_knn_index.markdown_kw.md_docs.md)**: MD file
...
- **py_knn_opencv/** - See [py_knn_opencv/doc.md](py_knn_opencv/doc.md)
- **py_knn_understanding/** - See [py_knn_understanding/doc.md](py_knn_understanding/doc.md)
...
- [py_kmeans/](../py_kmeans/doc.md)
- [py_svm/](../py_svm/doc.md)

**Subfolders**:
- [images/](images/doc.md)
- [py_knn_opencv/](py_knn_opencv/doc.md)
- [py_knn_understanding/](py_knn_understanding/doc.md)
