# Documentation for `docs/doc/py_tutorials/py_photo/py_non_local_means/py_non_local_means.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/py_tutorials/py_photo/py_non_local_means/py_non_local_means.markdown_docs.md`
- **File Name**: `py_non_local_means.markdown_docs.md`
- **File Size**: 7,024 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/py_tutorials/py_photo/py_non_local_means/py_non_local_means.markdown_docs.md](../../../../../docs/doc/py_tutorials/py_photo/py_non_local_means/py_non_local_means.markdown_docs.md)
...
# Documentation for `doc/py_tutorials/py_photo/py_non_local_means/py_non_local_means.markdown`

## File Metadata

- **Full Path**: `doc/py_tutorials/py_photo/py_non_local_means/py_non_local_means.markdown`
- **File Name**: `py_non_local_means.markdown`
- **File Size**: 6,256 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/py_tutorials/py_photo/py_non_local_means/py_non_local_means.markdown](../../../../doc/py_tutorials/py_photo/py_non_local_means/py_non_local_means.markdown)

## Purpose and Role

This file is located in the `doc/py_tutorials/py_photo/py_non_local_means` directory and serves as part of the OpenCV library infrastructure.
