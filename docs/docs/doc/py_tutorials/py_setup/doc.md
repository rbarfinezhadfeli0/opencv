# Documentation for `docs/doc/py_tutorials/py_setup/`
...
**Path**: `docs/doc/py_tutorials/py_setup/`
**Direct Files**: 2
**Subfolders**: 6
...
- **[py_table_of_contents_setup.markdown_kw.md](py_table_of_contents_setup.markdown_kw.md_docs.md)**: MD file
- **[py_table_of_contents_setup.markdown_docs.md](py_table_of_contents_setup.markdown_docs.md_docs.md)**: MD file
...
- **py_intro/** - See [py_intro/doc.md](py_intro/doc.md)
- **py_pip_install/** - See [py_pip_install/doc.md](py_pip_install/doc.md)
- **py_setup_in_fedora/** - See [py_setup_in_fedora/doc.md](py_setup_in_fedora/doc.md)
- **py_setup_in_ubuntu/** - See [py_setup_in_ubuntu/doc.md](py_setup_in_ubuntu/doc.md)
- **py_setup_in_windows/** - See [py_setup_in_windows/doc.md](py_setup_in_windows/doc.md)
...
- **Parent Folder**: [docs/doc/py_tutorials/](../py_tutorials/doc.md)
...
**Subfolders**:
- [images/](images/doc.md)
- [py_intro/](py_intro/doc.md)
- [py_pip_install/](py_pip_install/doc.md)
- [py_setup_in_fedora/](py_setup_in_fedora/doc.md)
- [py_setup_in_ubuntu/](py_setup_in_ubuntu/doc.md)
- [py_setup_in_windows/](py_setup_in_windows/doc.md)
