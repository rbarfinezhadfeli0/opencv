# Documentation for `docs/doc/py_tutorials/py_video/`
...
**Path**: `docs/doc/py_tutorials/py_video/`
**Direct Files**: 2
**Subfolders**: 3
...
- **[py_table_of_contents_video.markdown_kw.md](py_table_of_contents_video.markdown_kw.md_docs.md)**: MD file
- **[py_table_of_contents_video.markdown_docs.md](py_table_of_contents_video.markdown_docs.md_docs.md)**: MD file
...
- **py_bg_subtraction/** - See [py_bg_subtraction/doc.md](py_bg_subtraction/doc.md)
- **py_lucas_kanade/** - See [py_lucas_kanade/doc.md](py_lucas_kanade/doc.md)
- **py_meanshift/** - See [py_meanshift/doc.md](py_meanshift/doc.md)
...
**Subfolders**:
- [py_bg_subtraction/](py_bg_subtraction/doc.md)
- [py_lucas_kanade/](py_lucas_kanade/doc.md)
- [py_meanshift/](py_meanshift/doc.md)
