# Documentation for `docs/doc/tutorials/app/highgui_wayland_ubuntu.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/app/highgui_wayland_ubuntu.markdown_docs.md`
- **File Name**: `highgui_wayland_ubuntu.markdown_docs.md`
- **File Size**: 3,592 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/app/highgui_wayland_ubuntu.markdown_docs.md](../../../../docs/doc/tutorials/app/highgui_wayland_ubuntu.markdown_docs.md)
...
# Documentation for `doc/tutorials/app/highgui_wayland_ubuntu.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/app/highgui_wayland_ubuntu.markdown`
- **File Name**: `highgui_wayland_ubuntu.markdown`
- **File Size**: 2,942 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/app/highgui_wayland_ubuntu.markdown](../../../doc/tutorials/app/highgui_wayland_ubuntu.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/app` directory and serves as part of the OpenCV library infrastructure.
