# Documentation for `docs/doc/tutorials/app/kinect_openni.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/app/kinect_openni.markdown_docs.md`
- **File Name**: `kinect_openni.markdown_docs.md`
- **File Size**: 7,204 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/app/kinect_openni.markdown_docs.md](../../../../docs/doc/tutorials/app/kinect_openni.markdown_docs.md)
...
# Documentation for `doc/tutorials/app/kinect_openni.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/app/kinect_openni.markdown`
- **File Name**: `kinect_openni.markdown`
- **File Size**: 6,599 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/app/kinect_openni.markdown](../../../doc/tutorials/app/kinect_openni.markdown)
