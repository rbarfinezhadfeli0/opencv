# Documentation for `docs/doc/tutorials/app/orbbec_astra_openni.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/app/orbbec_astra_openni.markdown_docs.md`
- **File Name**: `orbbec_astra_openni.markdown_docs.md`
- **File Size**: 10,978 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/app/orbbec_astra_openni.markdown_docs.md](../../../../docs/doc/tutorials/app/orbbec_astra_openni.markdown_docs.md)
...
# Documentation for `doc/tutorials/app/orbbec_astra_openni.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/app/orbbec_astra_openni.markdown`
- **File Name**: `orbbec_astra_openni.markdown`
- **File Size**: 10,342 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/app/orbbec_astra_openni.markdown](../../../doc/tutorials/app/orbbec_astra_openni.markdown)
