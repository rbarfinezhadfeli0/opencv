# Documentation for `docs/doc/tutorials/app/orbbec_uvc.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/app/orbbec_uvc.markdown_docs.md`
- **File Name**: `orbbec_uvc.markdown_docs.md`
- **File Size**: 6,472 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/app/orbbec_uvc.markdown_docs.md](../../../../docs/doc/tutorials/app/orbbec_uvc.markdown_docs.md)
...
# Documentation for `doc/tutorials/app/orbbec_uvc.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/app/orbbec_uvc.markdown`
- **File Name**: `orbbec_uvc.markdown`
- **File Size**: 5,882 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/app/orbbec_uvc.markdown](../../../doc/tutorials/app/orbbec_uvc.markdown)
