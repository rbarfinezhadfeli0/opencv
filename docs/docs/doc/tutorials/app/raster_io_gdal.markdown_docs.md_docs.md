# Documentation for `docs/doc/tutorials/app/raster_io_gdal.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/app/raster_io_gdal.markdown_docs.md`
- **File Name**: `raster_io_gdal.markdown_docs.md`
- **File Size**: 5,252 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/app/raster_io_gdal.markdown_docs.md](../../../../docs/doc/tutorials/app/raster_io_gdal.markdown_docs.md)
...
# Documentation for `doc/tutorials/app/raster_io_gdal.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/app/raster_io_gdal.markdown`
- **File Name**: `raster_io_gdal.markdown`
- **File Size**: 4,642 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/app/raster_io_gdal.markdown](../../../doc/tutorials/app/raster_io_gdal.markdown)
