# Documentation for `docs/doc/tutorials/app/trackbar.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/app/trackbar.markdown_docs.md`
- **File Name**: `trackbar.markdown_docs.md`
- **File Size**: 5,516 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/app/trackbar.markdown_docs.md](../../../../docs/doc/tutorials/app/trackbar.markdown_docs.md)
...
# Documentation for `doc/tutorials/app/trackbar.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/app/trackbar.markdown`
- **File Name**: `trackbar.markdown`
- **File Size**: 4,936 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/app/trackbar.markdown](../../../doc/tutorials/app/trackbar.markdown)
