# Documentation for `docs/doc/tutorials/app/video_input_psnr_ssim.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/app/video_input_psnr_ssim.markdown_docs.md`
- **File Name**: `video_input_psnr_ssim.markdown_docs.md`
- **File Size**: 10,960 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/app/video_input_psnr_ssim.markdown_docs.md](../../../../docs/doc/tutorials/app/video_input_psnr_ssim.markdown_docs.md)
...
# Documentation for `doc/tutorials/app/video_input_psnr_ssim.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/app/video_input_psnr_ssim.markdown`
- **File Name**: `video_input_psnr_ssim.markdown`
- **File Size**: 10,314 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/app/video_input_psnr_ssim.markdown](../../../doc/tutorials/app/video_input_psnr_ssim.markdown)
