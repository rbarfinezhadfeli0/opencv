# Documentation for `docs/doc/tutorials/calib3d/camera_calibration_square_chess/camera_calibration_square_chess.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/calib3d/camera_calibration_square_chess/camera_calibration_square_chess.markdown_docs.md`
- **File Name**: `camera_calibration_square_chess.markdown_docs.md`
- **File Size**: 3,964 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/calib3d/camera_calibration_square_chess/camera_calibration_square_chess.markdown_docs.md](../../../../../docs/doc/tutorials/calib3d/camera_calibration_square_chess/camera_calibration_square_chess.markdown_docs.md)
...
# Documentation for `doc/tutorials/calib3d/camera_calibration_square_chess/camera_calibration_square_chess.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/calib3d/camera_calibration_square_chess/camera_calibration_square_chess.markdown`
- **File Name**: `camera_calibration_square_chess.markdown`
- **File Size**: 3,086 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/calib3d/camera_calibration_square_chess/camera_calibration_square_chess.markdown](../../../../doc/tutorials/calib3d/camera_calibration_square_chess/camera_calibration_square_chess.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/calib3d/camera_calibration_square_chess` directory and serves as part of the OpenCV library infrastructure.
