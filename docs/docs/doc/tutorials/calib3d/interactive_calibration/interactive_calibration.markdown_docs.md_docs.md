# Documentation for `docs/doc/tutorials/calib3d/interactive_calibration/interactive_calibration.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/calib3d/interactive_calibration/interactive_calibration.markdown_docs.md`
- **File Name**: `interactive_calibration.markdown_docs.md`
- **File Size**: 9,427 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/calib3d/interactive_calibration/interactive_calibration.markdown_docs.md](../../../../../docs/doc/tutorials/calib3d/interactive_calibration/interactive_calibration.markdown_docs.md)

## Purpose and Role

This file is located in the `docs/doc/tutorials/calib3d/interactive_calibration` directory and serves as part of the OpenCV library infrastructure.

## Documentation Content

# Documentation for `doc/tutorials/calib3d/interactive_calibration/interactive_calibration.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/calib3d/interactive_calibration/interactive_calibration.markdown`
- **File Name**: `interactive_calibration.markdown`
- **File Size**: 8,629 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/calib3d/interactive_calibration/interactive_calibration.markdown](../../../../doc/tutorials/calib3d/interactive_calibration/interactive_calibration.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/calib3d/interactive_calibration` directory and serves as part of the OpenCV library infrastructure.
