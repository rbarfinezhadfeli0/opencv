# Documentation for `docs/doc/tutorials/core/basic_linear_transform/basic_linear_transform.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/core/basic_linear_transform/basic_linear_transform.markdown_docs.md`
- **File Name**: `basic_linear_transform.markdown_docs.md`
- **File Size**: 15,121 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/core/basic_linear_transform/basic_linear_transform.markdown_docs.md](../../../../../docs/doc/tutorials/core/basic_linear_transform/basic_linear_transform.markdown_docs.md)

## Purpose and Role

This file is located in the `docs/doc/tutorials/core/basic_linear_transform` directory and serves as part of the OpenCV library infrastructure.

## Documentation Content

# Documentation for `doc/tutorials/core/basic_linear_transform/basic_linear_transform.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/core/basic_linear_transform/basic_linear_transform.markdown`
- **File Name**: `basic_linear_transform.markdown`
- **File Size**: 14,347 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/core/basic_linear_transform/basic_linear_transform.markdown](../../../../doc/tutorials/core/basic_linear_transform/basic_linear_transform.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/core/basic_linear_transform` directory and serves as part of the OpenCV library infrastructure.
