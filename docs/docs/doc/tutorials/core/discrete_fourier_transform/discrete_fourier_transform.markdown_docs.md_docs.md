# Documentation for `docs/doc/tutorials/core/discrete_fourier_transform/discrete_fourier_transform.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/core/discrete_fourier_transform/discrete_fourier_transform.markdown_docs.md`
- **File Name**: `discrete_fourier_transform.markdown_docs.md`
- **File Size**: 10,772 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/core/discrete_fourier_transform/discrete_fourier_transform.markdown_docs.md](../../../../../docs/doc/tutorials/core/discrete_fourier_transform/discrete_fourier_transform.markdown_docs.md)
...
# Documentation for `doc/tutorials/core/discrete_fourier_transform/discrete_fourier_transform.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/core/discrete_fourier_transform/discrete_fourier_transform.markdown`
- **File Name**: `discrete_fourier_transform.markdown`
- **File Size**: 9,959 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/core/discrete_fourier_transform/discrete_fourier_transform.markdown](../../../../doc/tutorials/core/discrete_fourier_transform/discrete_fourier_transform.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/core/discrete_fourier_transform` directory and serves as part of the OpenCV library infrastructure.
