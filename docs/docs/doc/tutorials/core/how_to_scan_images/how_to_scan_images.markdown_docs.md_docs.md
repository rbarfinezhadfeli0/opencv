# Documentation for `docs/doc/tutorials/core/how_to_scan_images/how_to_scan_images.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/core/how_to_scan_images/how_to_scan_images.markdown_docs.md`
- **File Name**: `how_to_scan_images.markdown_docs.md`
- **File Size**: 13,118 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/core/how_to_scan_images/how_to_scan_images.markdown_docs.md](../../../../../docs/doc/tutorials/core/how_to_scan_images/how_to_scan_images.markdown_docs.md)
...
# Documentation for `doc/tutorials/core/how_to_scan_images/how_to_scan_images.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/core/how_to_scan_images/how_to_scan_images.markdown`
- **File Name**: `how_to_scan_images.markdown`
- **File Size**: 12,384 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/core/how_to_scan_images/how_to_scan_images.markdown](../../../../doc/tutorials/core/how_to_scan_images/how_to_scan_images.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/core/how_to_scan_images` directory and serves as part of the OpenCV library infrastructure.
