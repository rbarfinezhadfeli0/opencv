# Documentation for `docs/doc/tutorials/core/how_to_use_OpenCV_parallel_for_new/images/`
...
**Path**: `docs/doc/tutorials/core/how_to_use_OpenCV_parallel_for_new/images/`
**Direct Files**: 4
**Subfolders**: 0
...
- **[convolution-example-matrix.gif_kw.md](convolution-example-matrix.gif_kw.md_docs.md)**: MD file
- **[convolution-example-matrix.gif_docs.md](convolution-example-matrix.gif_docs.md_docs.md)**: MD file
- **[resimg.jpg_kw.md](resimg.jpg_kw.md_docs.md)**: MD file
- **[resimg.jpg_docs.md](resimg.jpg_docs.md_docs.md)**: MD file
...
- **Parent Folder**: [docs/doc/tutorials/core/how_to_use_OpenCV_parallel_for_new/](../how_to_use_OpenCV_parallel_for_new/doc.md)
