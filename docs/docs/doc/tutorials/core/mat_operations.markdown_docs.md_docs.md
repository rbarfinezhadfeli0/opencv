# Documentation for `docs/doc/tutorials/core/mat_operations.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/core/mat_operations.markdown_docs.md`
- **File Name**: `mat_operations.markdown_docs.md`
- **File Size**: 10,283 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/core/mat_operations.markdown_docs.md](../../../../docs/doc/tutorials/core/mat_operations.markdown_docs.md)
...
# Documentation for `doc/tutorials/core/mat_operations.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/core/mat_operations.markdown`
- **File Name**: `mat_operations.markdown`
- **File Size**: 9,668 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/core/mat_operations.markdown](../../../doc/tutorials/core/mat_operations.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/core` directory and serves as part of the OpenCV library infrastructure.
