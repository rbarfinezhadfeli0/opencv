# Documentation for `docs/doc/tutorials/core/mat_the_basic_image_container/mat_the_basic_image_container.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/core/mat_the_basic_image_container/mat_the_basic_image_container.markdown_docs.md`
- **File Name**: `mat_the_basic_image_container.markdown_docs.md`
- **File Size**: 14,851 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/core/mat_the_basic_image_container/mat_the_basic_image_container.markdown_docs.md](../../../../../docs/doc/tutorials/core/mat_the_basic_image_container/mat_the_basic_image_container.markdown_docs.md)
...
# Documentation for `doc/tutorials/core/mat_the_basic_image_container/mat_the_basic_image_container.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/core/mat_the_basic_image_container/mat_the_basic_image_container.markdown`
- **File Name**: `mat_the_basic_image_container.markdown`
- **File Size**: 14,007 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/core/mat_the_basic_image_container/mat_the_basic_image_container.markdown](../../../../doc/tutorials/core/mat_the_basic_image_container/mat_the_basic_image_container.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/core/mat_the_basic_image_container` directory and serves as part of the OpenCV library infrastructure.
