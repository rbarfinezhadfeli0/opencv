# Documentation for `docs/doc/tutorials/dnn/dnn_OCR/dnn_OCR.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/dnn/dnn_OCR/dnn_OCR.markdown_docs.md`
- **File Name**: `dnn_OCR.markdown_docs.md`
- **File Size**: 3,853 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/dnn/dnn_OCR/dnn_OCR.markdown_docs.md](../../../../../docs/doc/tutorials/dnn/dnn_OCR/dnn_OCR.markdown_docs.md)
...
# Documentation for `doc/tutorials/dnn/dnn_OCR/dnn_OCR.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/dnn/dnn_OCR/dnn_OCR.markdown`
- **File Name**: `dnn_OCR.markdown`
- **File Size**: 3,235 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/dnn/dnn_OCR/dnn_OCR.markdown](../../../../doc/tutorials/dnn/dnn_OCR/dnn_OCR.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/dnn/dnn_OCR` directory and serves as part of the OpenCV library infrastructure.
