# Documentation for `docs/doc/tutorials/dnn/dnn_custom_layers/dnn_custom_layers.md_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/dnn/dnn_custom_layers/dnn_custom_layers.md_docs.md`
- **File Name**: `dnn_custom_layers.md_docs.md`
- **File Size**: 8,355 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/dnn/dnn_custom_layers/dnn_custom_layers.md_docs.md](../../../../../docs/doc/tutorials/dnn/dnn_custom_layers/dnn_custom_layers.md_docs.md)

## Purpose and Role

This file is located in the `docs/doc/tutorials/dnn/dnn_custom_layers` directory and serves as part of the OpenCV library infrastructure.

## Documentation Content

# Documentation for `doc/tutorials/dnn/dnn_custom_layers/dnn_custom_layers.md`

## File Metadata

- **Full Path**: `doc/tutorials/dnn/dnn_custom_layers/dnn_custom_layers.md`
- **File Name**: `dnn_custom_layers.md`
- **File Size**: 7,629 bytes
- **File Type**: .md
- **Link to Source**: [doc/tutorials/dnn/dnn_custom_layers/dnn_custom_layers.md](../../../../doc/tutorials/dnn/dnn_custom_layers/dnn_custom_layers.md)

## Purpose and Role

This file is located in the `doc/tutorials/dnn/dnn_custom_layers` directory and serves as part of the OpenCV library infrastructure.
