# Documentation for `docs/doc/tutorials/dnn/dnn_face/dnn_face.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/dnn/dnn_face/dnn_face.markdown_docs.md`
- **File Name**: `dnn_face.markdown_docs.md`
- **File Size**: 4,568 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/dnn/dnn_face/dnn_face.markdown_docs.md](../../../../../docs/doc/tutorials/dnn/dnn_face/dnn_face.markdown_docs.md)
...
# Documentation for `doc/tutorials/dnn/dnn_face/dnn_face.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/dnn/dnn_face/dnn_face.markdown`
- **File Name**: `dnn_face.markdown`
- **File Size**: 3,940 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/dnn/dnn_face/dnn_face.markdown](../../../../doc/tutorials/dnn/dnn_face/dnn_face.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/dnn/dnn_face` directory and serves as part of the OpenCV library infrastructure.
