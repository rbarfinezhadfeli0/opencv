# Documentation for `docs/doc/tutorials/dnn/dnn_halide_scheduling/dnn_halide_scheduling.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/dnn/dnn_halide_scheduling/dnn_halide_scheduling.markdown_docs.md`
- **File Name**: `dnn_halide_scheduling.markdown_docs.md`
- **File Size**: 4,394 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/dnn/dnn_halide_scheduling/dnn_halide_scheduling.markdown_docs.md](../../../../../docs/doc/tutorials/dnn/dnn_halide_scheduling/dnn_halide_scheduling.markdown_docs.md)

## Purpose and Role

This file is located in the `docs/doc/tutorials/dnn/dnn_halide_scheduling` directory and serves as part of the OpenCV library infrastructure.

## Documentation Content

# Documentation for `doc/tutorials/dnn/dnn_halide_scheduling/dnn_halide_scheduling.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/dnn/dnn_halide_scheduling/dnn_halide_scheduling.markdown`
- **File Name**: `dnn_halide_scheduling.markdown`
- **File Size**: 3,636 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/dnn/dnn_halide_scheduling/dnn_halide_scheduling.markdown](../../../../doc/tutorials/dnn/dnn_halide_scheduling/dnn_halide_scheduling.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/dnn/dnn_halide_scheduling` directory and serves as part of the OpenCV library infrastructure.
