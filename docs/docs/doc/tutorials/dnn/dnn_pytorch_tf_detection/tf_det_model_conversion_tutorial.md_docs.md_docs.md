# Documentation for `docs/doc/tutorials/dnn/dnn_pytorch_tf_detection/tf_det_model_conversion_tutorial.md_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/dnn/dnn_pytorch_tf_detection/tf_det_model_conversion_tutorial.md_docs.md`
- **File Name**: `tf_det_model_conversion_tutorial.md_docs.md`
- **File Size**: 7,333 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/dnn/dnn_pytorch_tf_detection/tf_det_model_conversion_tutorial.md_docs.md](../../../../../docs/doc/tutorials/dnn/dnn_pytorch_tf_detection/tf_det_model_conversion_tutorial.md_docs.md)

## Purpose and Role

This file is located in the `docs/doc/tutorials/dnn/dnn_pytorch_tf_detection` directory and serves as part of the OpenCV library infrastructure.

## Documentation Content

# Documentation for `doc/tutorials/dnn/dnn_pytorch_tf_detection/tf_det_model_conversion_tutorial.md`

## File Metadata

- **Full Path**: `doc/tutorials/dnn/dnn_pytorch_tf_detection/tf_det_model_conversion_tutorial.md`
- **File Name**: `tf_det_model_conversion_tutorial.md`
- **File Size**: 6,497 bytes
- **File Type**: .md
- **Link to Source**: [doc/tutorials/dnn/dnn_pytorch_tf_detection/tf_det_model_conversion_tutorial.md](../../../../doc/tutorials/dnn/dnn_pytorch_tf_detection/tf_det_model_conversion_tutorial.md)

## Purpose and Role

This file is located in the `doc/tutorials/dnn/dnn_pytorch_tf_detection` directory and serves as part of the OpenCV library infrastructure.
