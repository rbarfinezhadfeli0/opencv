# Documentation for `docs/doc/tutorials/dnn/dnn_text_spotting/dnn_text_spotting.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/dnn/dnn_text_spotting/dnn_text_spotting.markdown_docs.md`
- **File Name**: `dnn_text_spotting.markdown_docs.md`
- **File Size**: 12,809 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/dnn/dnn_text_spotting/dnn_text_spotting.markdown_docs.md](../../../../../docs/doc/tutorials/dnn/dnn_text_spotting/dnn_text_spotting.markdown_docs.md)
...
# Documentation for `doc/tutorials/dnn/dnn_text_spotting/dnn_text_spotting.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/dnn/dnn_text_spotting/dnn_text_spotting.markdown`
- **File Name**: `dnn_text_spotting.markdown`
- **File Size**: 12,090 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/dnn/dnn_text_spotting/dnn_text_spotting.markdown](../../../../doc/tutorials/dnn/dnn_text_spotting/dnn_text_spotting.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/dnn/dnn_text_spotting` directory and serves as part of the OpenCV library infrastructure.
