# Documentation for `docs/doc/tutorials/features2d/akaze_tracking/akaze_tracking.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/features2d/akaze_tracking/akaze_tracking.markdown_docs.md`
- **File Name**: `akaze_tracking.markdown_docs.md`
- **File Size**: 5,407 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/features2d/akaze_tracking/akaze_tracking.markdown_docs.md](../../../../../docs/doc/tutorials/features2d/akaze_tracking/akaze_tracking.markdown_docs.md)

## Purpose and Role

This file is located in the `docs/doc/tutorials/features2d/akaze_tracking` directory and serves as part of the OpenCV library infrastructure.

## Documentation Content

# Documentation for `doc/tutorials/features2d/akaze_tracking/akaze_tracking.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/features2d/akaze_tracking/akaze_tracking.markdown`
- **File Name**: `akaze_tracking.markdown`
- **File Size**: 4,684 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/features2d/akaze_tracking/akaze_tracking.markdown](../../../../doc/tutorials/features2d/akaze_tracking/akaze_tracking.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/features2d/akaze_tracking` directory and serves as part of the OpenCV library infrastructure.
