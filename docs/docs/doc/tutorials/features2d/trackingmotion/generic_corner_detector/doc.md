# Documentation for `docs/doc/tutorials/features2d/trackingmotion/generic_corner_detector/`
...
**Path**: `docs/doc/tutorials/features2d/trackingmotion/generic_corner_detector/`
**Direct Files**: 2
**Subfolders**: 1
...
- **[generic_corner_detector.markdown_docs.md](generic_corner_detector.markdown_docs.md_docs.md)**: MD file
- **[generic_corner_detector.markdown_kw.md](generic_corner_detector.markdown_kw.md_docs.md)**: MD file
...
- **Parent Folder**: [docs/doc/tutorials/features2d/trackingmotion/](../trackingmotion/doc.md)
