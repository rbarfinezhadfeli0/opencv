# Documentation for `docs/doc/tutorials/features2d/trackingmotion/harris_detector/harris_detector.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/features2d/trackingmotion/harris_detector/harris_detector.markdown_docs.md`
- **File Name**: `harris_detector.markdown_docs.md`
- **File Size**: 5,891 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/features2d/trackingmotion/harris_detector/harris_detector.markdown_docs.md](../../../../../../docs/doc/tutorials/features2d/trackingmotion/harris_detector/harris_detector.markdown_docs.md)
...
# Documentation for `doc/tutorials/features2d/trackingmotion/harris_detector/harris_detector.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/features2d/trackingmotion/harris_detector/harris_detector.markdown`
- **File Name**: `harris_detector.markdown`
- **File Size**: 5,080 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/features2d/trackingmotion/harris_detector/harris_detector.markdown](../../../../../doc/tutorials/features2d/trackingmotion/harris_detector/harris_detector.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/features2d/trackingmotion/harris_detector` directory and serves as part of the OpenCV library infrastructure.
