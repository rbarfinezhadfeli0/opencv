# Documentation for `docs/doc/tutorials/gapi/anisotropic_segmentation/porting_anisotropic_segmentation.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/gapi/anisotropic_segmentation/porting_anisotropic_segmentation.markdown_docs.md`
- **File Name**: `porting_anisotropic_segmentation.markdown_docs.md`
- **File Size**: 19,458 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/gapi/anisotropic_segmentation/porting_anisotropic_segmentation.markdown_docs.md](../../../../../docs/doc/tutorials/gapi/anisotropic_segmentation/porting_anisotropic_segmentation.markdown_docs.md)

## Purpose and Role

This file is located in the `docs/doc/tutorials/gapi/anisotropic_segmentation` directory and serves as part of the OpenCV library infrastructure.

## Documentation Content

# Documentation for `doc/tutorials/gapi/anisotropic_segmentation/porting_anisotropic_segmentation.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/gapi/anisotropic_segmentation/porting_anisotropic_segmentation.markdown`
- **File Name**: `porting_anisotropic_segmentation.markdown`
- **File Size**: 18,624 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/gapi/anisotropic_segmentation/porting_anisotropic_segmentation.markdown](../../../../doc/tutorials/gapi/anisotropic_segmentation/porting_anisotropic_segmentation.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/gapi/anisotropic_segmentation` directory and serves as part of the OpenCV library infrastructure.
