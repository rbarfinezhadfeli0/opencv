# Documentation for `docs/doc/tutorials/gapi/face_beautification/face_beautification.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/gapi/face_beautification/face_beautification.markdown_docs.md`
- **File Name**: `face_beautification.markdown_docs.md`
- **File Size**: 19,404 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/gapi/face_beautification/face_beautification.markdown_docs.md](../../../../../docs/doc/tutorials/gapi/face_beautification/face_beautification.markdown_docs.md)
...
# Documentation for `doc/tutorials/gapi/face_beautification/face_beautification.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/gapi/face_beautification/face_beautification.markdown`
- **File Name**: `face_beautification.markdown`
- **File Size**: 18,660 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/gapi/face_beautification/face_beautification.markdown](../../../../doc/tutorials/gapi/face_beautification/face_beautification.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/gapi/face_beautification` directory and serves as part of the OpenCV library infrastructure.
