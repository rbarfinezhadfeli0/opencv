# Documentation for `docs/doc/tutorials/gapi/interactive_face_detection/interactive_face_detection.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/gapi/interactive_face_detection/interactive_face_detection.markdown_docs.md`
- **File Name**: `interactive_face_detection.markdown_docs.md`
- **File Size**: 16,600 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/gapi/interactive_face_detection/interactive_face_detection.markdown_docs.md](../../../../../docs/doc/tutorials/gapi/interactive_face_detection/interactive_face_detection.markdown_docs.md)
...
# Documentation for `doc/tutorials/gapi/interactive_face_detection/interactive_face_detection.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/gapi/interactive_face_detection/interactive_face_detection.markdown`
- **File Name**: `interactive_face_detection.markdown`
- **File Size**: 15,786 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/gapi/interactive_face_detection/interactive_face_detection.markdown](../../../../doc/tutorials/gapi/interactive_face_detection/interactive_face_detection.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/gapi/interactive_face_detection` directory and serves as part of the OpenCV library infrastructure.
