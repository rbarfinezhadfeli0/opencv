# Documentation for `docs/doc/tutorials/gpu/gpu-basics-similarity/`
...
**Path**: `docs/doc/tutorials/gpu/gpu-basics-similarity/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[gpu_basics_similarity.markdown_docs.md](gpu_basics_similarity.markdown_docs.md_docs.md)**: MD file
- **[gpu_basics_similarity.markdown_kw.md](gpu_basics_similarity.markdown_kw.md_docs.md)**: MD file
