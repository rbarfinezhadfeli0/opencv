# Documentation for `docs/doc/tutorials/gpu/gpu-basics-similarity/gpu_basics_similarity.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/gpu/gpu-basics-similarity/gpu_basics_similarity.markdown_docs.md`
- **File Name**: `gpu_basics_similarity.markdown_docs.md`
- **File Size**: 13,377 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/gpu/gpu-basics-similarity/gpu_basics_similarity.markdown_docs.md](../../../../../docs/doc/tutorials/gpu/gpu-basics-similarity/gpu_basics_similarity.markdown_docs.md)

## Purpose and Role

This file is located in the `docs/doc/tutorials/gpu/gpu-basics-similarity` directory and serves as part of the OpenCV library infrastructure.

## Documentation Content

# Documentation for `doc/tutorials/gpu/gpu-basics-similarity/gpu_basics_similarity.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/gpu/gpu-basics-similarity/gpu_basics_similarity.markdown`
- **File Name**: `gpu_basics_similarity.markdown`
- **File Size**: 12,618 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/gpu/gpu-basics-similarity/gpu_basics_similarity.markdown](../../../../doc/tutorials/gpu/gpu-basics-similarity/gpu_basics_similarity.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/gpu/gpu-basics-similarity` directory and serves as part of the OpenCV library infrastructure.
