# Documentation for `docs/doc/tutorials/gpu/gpu-thrust-interop/gpu_thrust_interop.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/gpu/gpu-thrust-interop/gpu_thrust_interop.markdown_docs.md`
- **File Name**: `gpu_thrust_interop.markdown_docs.md`
- **File Size**: 5,229 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/gpu/gpu-thrust-interop/gpu_thrust_interop.markdown_docs.md](../../../../../docs/doc/tutorials/gpu/gpu-thrust-interop/gpu_thrust_interop.markdown_docs.md)
...
# Documentation for `doc/tutorials/gpu/gpu-thrust-interop/gpu_thrust_interop.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/gpu/gpu-thrust-interop/gpu_thrust_interop.markdown`
- **File Name**: `gpu_thrust_interop.markdown`
- **File Size**: 4,501 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/gpu/gpu-thrust-interop/gpu_thrust_interop.markdown](../../../../doc/tutorials/gpu/gpu-thrust-interop/gpu_thrust_interop.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/gpu/gpu-thrust-interop` directory and serves as part of the OpenCV library infrastructure.
