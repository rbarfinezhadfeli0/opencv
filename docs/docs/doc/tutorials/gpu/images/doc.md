# Documentation for `docs/doc/tutorials/gpu/images/`
...
**Path**: `docs/doc/tutorials/gpu/images/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[gpu-basics-similarity.png_kw.md](gpu-basics-similarity.png_kw.md_docs.md)**: MD file
- **[gpu-basics-similarity.png_docs.md](gpu-basics-similarity.png_docs.md_docs.md)**: MD file
...
- **Parent Folder**: [docs/doc/tutorials/gpu/](../gpu/doc.md)
