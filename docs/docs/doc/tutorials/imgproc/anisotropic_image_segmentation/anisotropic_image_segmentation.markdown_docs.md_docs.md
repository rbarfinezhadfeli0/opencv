# Documentation for `docs/doc/tutorials/imgproc/anisotropic_image_segmentation/anisotropic_image_segmentation.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/imgproc/anisotropic_image_segmentation/anisotropic_image_segmentation.markdown_docs.md`
- **File Name**: `anisotropic_image_segmentation.markdown_docs.md`
- **File Size**: 7,273 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/imgproc/anisotropic_image_segmentation/anisotropic_image_segmentation.markdown_docs.md](../../../../../docs/doc/tutorials/imgproc/anisotropic_image_segmentation/anisotropic_image_segmentation.markdown_docs.md)
...
# Documentation for `doc/tutorials/imgproc/anisotropic_image_segmentation/anisotropic_image_segmentation.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/imgproc/anisotropic_image_segmentation/anisotropic_image_segmentation.markdown`
- **File Name**: `anisotropic_image_segmentation.markdown`
- **File Size**: 6,405 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/imgproc/anisotropic_image_segmentation/anisotropic_image_segmentation.markdown](../../../../doc/tutorials/imgproc/anisotropic_image_segmentation/anisotropic_image_segmentation.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/imgproc/anisotropic_image_segmentation` directory and serves as part of the OpenCV library infrastructure.
