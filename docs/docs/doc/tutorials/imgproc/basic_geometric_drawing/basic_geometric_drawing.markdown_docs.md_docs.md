# Documentation for `docs/doc/tutorials/imgproc/basic_geometric_drawing/basic_geometric_drawing.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/imgproc/basic_geometric_drawing/basic_geometric_drawing.markdown_docs.md`
- **File Name**: `basic_geometric_drawing.markdown_docs.md`
- **File Size**: 9,773 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/imgproc/basic_geometric_drawing/basic_geometric_drawing.markdown_docs.md](../../../../../docs/doc/tutorials/imgproc/basic_geometric_drawing/basic_geometric_drawing.markdown_docs.md)

## Purpose and Role

This file is located in the `docs/doc/tutorials/imgproc/basic_geometric_drawing` directory and serves as part of the OpenCV library infrastructure.

## Documentation Content

# Documentation for `doc/tutorials/imgproc/basic_geometric_drawing/basic_geometric_drawing.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/imgproc/basic_geometric_drawing/basic_geometric_drawing.markdown`
- **File Name**: `basic_geometric_drawing.markdown`
- **File Size**: 8,975 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/imgproc/basic_geometric_drawing/basic_geometric_drawing.markdown](../../../../doc/tutorials/imgproc/basic_geometric_drawing/basic_geometric_drawing.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/imgproc/basic_geometric_drawing` directory and serves as part of the OpenCV library infrastructure.
