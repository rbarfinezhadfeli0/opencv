# Documentation for `docs/doc/tutorials/imgproc/erosion_dilatation/erosion_dilatation.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/imgproc/erosion_dilatation/erosion_dilatation.markdown_docs.md`
- **File Name**: `erosion_dilatation.markdown_docs.md`
- **File Size**: 13,105 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/imgproc/erosion_dilatation/erosion_dilatation.markdown_docs.md](../../../../../docs/doc/tutorials/imgproc/erosion_dilatation/erosion_dilatation.markdown_docs.md)

## Purpose and Role

This file is located in the `docs/doc/tutorials/imgproc/erosion_dilatation` directory and serves as part of the OpenCV library infrastructure.

## Documentation Content

# Documentation for `doc/tutorials/imgproc/erosion_dilatation/erosion_dilatation.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/imgproc/erosion_dilatation/erosion_dilatation.markdown`
- **File Name**: `erosion_dilatation.markdown`
- **File Size**: 12,356 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/imgproc/erosion_dilatation/erosion_dilatation.markdown](../../../../doc/tutorials/imgproc/erosion_dilatation/erosion_dilatation.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/imgproc/erosion_dilatation` directory and serves as part of the OpenCV library infrastructure.
