# Documentation for `docs/doc/tutorials/imgproc/histograms/back_projection/back_projection.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/imgproc/histograms/back_projection/back_projection.markdown_docs.md`
- **File Name**: `back_projection.markdown_docs.md`
- **File Size**: 13,521 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/imgproc/histograms/back_projection/back_projection.markdown_docs.md](../../../../../../docs/doc/tutorials/imgproc/histograms/back_projection/back_projection.markdown_docs.md)

## Purpose and Role

This file is located in the `docs/doc/tutorials/imgproc/histograms/back_projection` directory and serves as part of the OpenCV library infrastructure.

## Documentation Content

# Documentation for `doc/tutorials/imgproc/histograms/back_projection/back_projection.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/imgproc/histograms/back_projection/back_projection.markdown`
- **File Name**: `back_projection.markdown`
- **File Size**: 12,744 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/imgproc/histograms/back_projection/back_projection.markdown](../../../../../doc/tutorials/imgproc/histograms/back_projection/back_projection.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/imgproc/histograms/back_projection` directory and serves as part of the OpenCV library infrastructure.
