# Documentation for `docs/doc/tutorials/imgproc/histograms/histogram_equalization/histogram_equalization.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/imgproc/histograms/histogram_equalization/histogram_equalization.markdown_docs.md`
- **File Name**: `histogram_equalization.markdown_docs.md`
- **File Size**: 8,124 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/imgproc/histograms/histogram_equalization/histogram_equalization.markdown_docs.md](../../../../../../docs/doc/tutorials/imgproc/histograms/histogram_equalization/histogram_equalization.markdown_docs.md)

## Purpose and Role

This file is located in the `docs/doc/tutorials/imgproc/histograms/histogram_equalization` directory and serves as part of the OpenCV library infrastructure.

## Documentation Content

# Documentation for `doc/tutorials/imgproc/histograms/histogram_equalization/histogram_equalization.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/imgproc/histograms/histogram_equalization/histogram_equalization.markdown`
- **File Name**: `histogram_equalization.markdown`
- **File Size**: 7,278 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/imgproc/histograms/histogram_equalization/histogram_equalization.markdown](../../../../../doc/tutorials/imgproc/histograms/histogram_equalization/histogram_equalization.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/imgproc/histograms/histogram_equalization` directory and serves as part of the OpenCV library infrastructure.
