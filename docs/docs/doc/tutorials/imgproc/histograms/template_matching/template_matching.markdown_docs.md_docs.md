# Documentation for `docs/doc/tutorials/imgproc/histograms/template_matching/template_matching.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/imgproc/histograms/template_matching/template_matching.markdown_docs.md`
- **File Name**: `template_matching.markdown_docs.md`
- **File Size**: 13,422 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/imgproc/histograms/template_matching/template_matching.markdown_docs.md](../../../../../../docs/doc/tutorials/imgproc/histograms/template_matching/template_matching.markdown_docs.md)
...
# Documentation for `doc/tutorials/imgproc/histograms/template_matching/template_matching.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/imgproc/histograms/template_matching/template_matching.markdown`
- **File Name**: `template_matching.markdown`
- **File Size**: 12,625 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/imgproc/histograms/template_matching/template_matching.markdown](../../../../../doc/tutorials/imgproc/histograms/template_matching/template_matching.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/imgproc/histograms/template_matching` directory and serves as part of the OpenCV library infrastructure.
