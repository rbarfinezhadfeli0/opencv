# Documentation for `docs/doc/tutorials/imgproc/hitOrMiss/hitOrMiss.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/imgproc/hitOrMiss/hitOrMiss.markdown_docs.md`
- **File Name**: `hitOrMiss.markdown_docs.md`
- **File Size**: 4,635 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/imgproc/hitOrMiss/hitOrMiss.markdown_docs.md](../../../../../docs/doc/tutorials/imgproc/hitOrMiss/hitOrMiss.markdown_docs.md)

## Purpose and Role

This file is located in the `docs/doc/tutorials/imgproc/hitOrMiss` directory and serves as part of the OpenCV library infrastructure.

## Documentation Content

# Documentation for `doc/tutorials/imgproc/hitOrMiss/hitOrMiss.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/imgproc/hitOrMiss/hitOrMiss.markdown`
- **File Name**: `hitOrMiss.markdown`
- **File Size**: 3,977 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/imgproc/hitOrMiss/hitOrMiss.markdown](../../../../doc/tutorials/imgproc/hitOrMiss/hitOrMiss.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/imgproc/hitOrMiss` directory and serves as part of the OpenCV library infrastructure.
