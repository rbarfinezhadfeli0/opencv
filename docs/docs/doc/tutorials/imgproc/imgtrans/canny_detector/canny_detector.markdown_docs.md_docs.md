# Documentation for `docs/doc/tutorials/imgproc/imgtrans/canny_detector/canny_detector.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/imgproc/imgtrans/canny_detector/canny_detector.markdown_docs.md`
- **File Name**: `canny_detector.markdown_docs.md`
- **File Size**: 8,344 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/imgproc/imgtrans/canny_detector/canny_detector.markdown_docs.md](../../../../../../docs/doc/tutorials/imgproc/imgtrans/canny_detector/canny_detector.markdown_docs.md)

## Purpose and Role

This file is located in the `docs/doc/tutorials/imgproc/imgtrans/canny_detector` directory and serves as part of the OpenCV library infrastructure.

## Documentation Content

# Documentation for `doc/tutorials/imgproc/imgtrans/canny_detector/canny_detector.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/imgproc/imgtrans/canny_detector/canny_detector.markdown`
- **File Name**: `canny_detector.markdown`
- **File Size**: 7,588 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/imgproc/imgtrans/canny_detector/canny_detector.markdown](../../../../../doc/tutorials/imgproc/imgtrans/canny_detector/canny_detector.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/imgproc/imgtrans/canny_detector` directory and serves as part of the OpenCV library infrastructure.
