# Documentation for `docs/doc/tutorials/imgproc/imgtrans/copyMakeBorder/images/`
...
**Path**: `docs/doc/tutorials/imgproc/imgtrans/copyMakeBorder/images/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[CopyMakeBorder_Tutorial_Results.jpg_kw.md](CopyMakeBorder_Tutorial_Results.jpg_kw.md_docs.md)**: MD file
- **[CopyMakeBorder_Tutorial_Results.jpg_docs.md](CopyMakeBorder_Tutorial_Results.jpg_docs.md_docs.md)**: MD file
...
- **Parent Folder**: [docs/doc/tutorials/imgproc/imgtrans/copyMakeBorder/](../copyMakeBorder/doc.md)
