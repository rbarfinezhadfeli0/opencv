# Documentation for `docs/doc/tutorials/imgproc/imgtrans/distance_transformation/distance_transform.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/imgproc/imgtrans/distance_transformation/distance_transform.markdown_docs.md`
- **File Name**: `distance_transform.markdown_docs.md`
- **File Size**: 6,910 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/imgproc/imgtrans/distance_transformation/distance_transform.markdown_docs.md](../../../../../../docs/doc/tutorials/imgproc/imgtrans/distance_transformation/distance_transform.markdown_docs.md)

## Purpose and Role

This file is located in the `docs/doc/tutorials/imgproc/imgtrans/distance_transformation` directory and serves as part of the OpenCV library infrastructure.

## Documentation Content

# Documentation for `doc/tutorials/imgproc/imgtrans/distance_transformation/distance_transform.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/imgproc/imgtrans/distance_transformation/distance_transform.markdown`
- **File Name**: `distance_transform.markdown`
- **File Size**: 6,089 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/imgproc/imgtrans/distance_transformation/distance_transform.markdown](../../../../../doc/tutorials/imgproc/imgtrans/distance_transformation/distance_transform.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/imgproc/imgtrans/distance_transformation` directory and serves as part of the OpenCV library infrastructure.
