# Documentation for `docs/doc/tutorials/imgproc/imgtrans/sobel_derivatives/sobel_derivatives.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/imgproc/imgtrans/sobel_derivatives/sobel_derivatives.markdown_docs.md`
- **File Name**: `sobel_derivatives.markdown_docs.md`
- **File Size**: 7,711 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/imgproc/imgtrans/sobel_derivatives/sobel_derivatives.markdown_docs.md](../../../../../../docs/doc/tutorials/imgproc/imgtrans/sobel_derivatives/sobel_derivatives.markdown_docs.md)

## Purpose and Role

This file is located in the `docs/doc/tutorials/imgproc/imgtrans/sobel_derivatives` directory and serves as part of the OpenCV library infrastructure.

## Documentation Content

# Documentation for `doc/tutorials/imgproc/imgtrans/sobel_derivatives/sobel_derivatives.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/imgproc/imgtrans/sobel_derivatives/sobel_derivatives.markdown`
- **File Name**: `sobel_derivatives.markdown`
- **File Size**: 6,925 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/imgproc/imgtrans/sobel_derivatives/sobel_derivatives.markdown](../../../../../doc/tutorials/imgproc/imgtrans/sobel_derivatives/sobel_derivatives.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/imgproc/imgtrans/sobel_derivatives` directory and serves as part of the OpenCV library infrastructure.
