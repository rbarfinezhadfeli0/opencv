# Documentation for `docs/doc/tutorials/imgproc/imgtrans/warp_affine/warp_affine.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/imgproc/imgtrans/warp_affine/warp_affine.markdown_docs.md`
- **File Name**: `warp_affine.markdown_docs.md`
- **File Size**: 11,821 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/imgproc/imgtrans/warp_affine/warp_affine.markdown_docs.md](../../../../../../docs/doc/tutorials/imgproc/imgtrans/warp_affine/warp_affine.markdown_docs.md)

## Purpose and Role

This file is located in the `docs/doc/tutorials/imgproc/imgtrans/warp_affine` directory and serves as part of the OpenCV library infrastructure.

## Documentation Content

# Documentation for `doc/tutorials/imgproc/imgtrans/warp_affine/warp_affine.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/imgproc/imgtrans/warp_affine/warp_affine.markdown`
- **File Name**: `warp_affine.markdown`
- **File Size**: 11,094 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/imgproc/imgtrans/warp_affine/warp_affine.markdown](../../../../../doc/tutorials/imgproc/imgtrans/warp_affine/warp_affine.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/imgproc/imgtrans/warp_affine` directory and serves as part of the OpenCV library infrastructure.
