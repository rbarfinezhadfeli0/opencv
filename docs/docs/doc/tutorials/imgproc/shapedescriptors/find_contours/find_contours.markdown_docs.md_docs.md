# Documentation for `docs/doc/tutorials/imgproc/shapedescriptors/find_contours/find_contours.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/imgproc/shapedescriptors/find_contours/find_contours.markdown_docs.md`
- **File Name**: `find_contours.markdown_docs.md`
- **File Size**: 2,312 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/imgproc/shapedescriptors/find_contours/find_contours.markdown_docs.md](../../../../../../docs/doc/tutorials/imgproc/shapedescriptors/find_contours/find_contours.markdown_docs.md)
