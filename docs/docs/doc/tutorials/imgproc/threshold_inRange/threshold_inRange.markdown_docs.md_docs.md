# Documentation for `docs/doc/tutorials/imgproc/threshold_inRange/threshold_inRange.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/imgproc/threshold_inRange/threshold_inRange.markdown_docs.md`
- **File Name**: `threshold_inRange.markdown_docs.md`
- **File Size**: 7,249 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/imgproc/threshold_inRange/threshold_inRange.markdown_docs.md](../../../../../docs/doc/tutorials/imgproc/threshold_inRange/threshold_inRange.markdown_docs.md)
...
# Documentation for `doc/tutorials/imgproc/threshold_inRange/threshold_inRange.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/imgproc/threshold_inRange/threshold_inRange.markdown`
- **File Name**: `threshold_inRange.markdown`
- **File Size**: 6,511 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/imgproc/threshold_inRange/threshold_inRange.markdown](../../../../doc/tutorials/imgproc/threshold_inRange/threshold_inRange.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/imgproc/threshold_inRange` directory and serves as part of the OpenCV library infrastructure.
