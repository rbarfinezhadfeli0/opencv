# Documentation for `docs/doc/tutorials/introduction/android_binary_package/dev_with_OCV_on_Android.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/introduction/android_binary_package/dev_with_OCV_on_Android.markdown_docs.md`
- **File Name**: `dev_with_OCV_on_Android.markdown_docs.md`
- **File Size**: 11,379 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/introduction/android_binary_package/dev_with_OCV_on_Android.markdown_docs.md](../../../../../docs/doc/tutorials/introduction/android_binary_package/dev_with_OCV_on_Android.markdown_docs.md)
...
# Documentation for `doc/tutorials/introduction/android_binary_package/dev_with_OCV_on_Android.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/introduction/android_binary_package/dev_with_OCV_on_Android.markdown`
- **File Name**: `dev_with_OCV_on_Android.markdown`
- **File Size**: 10,560 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/introduction/android_binary_package/dev_with_OCV_on_Android.markdown](../../../../doc/tutorials/introduction/android_binary_package/dev_with_OCV_on_Android.markdown)
