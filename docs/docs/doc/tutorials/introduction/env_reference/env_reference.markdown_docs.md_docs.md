# Documentation for `docs/doc/tutorials/introduction/env_reference/env_reference.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/introduction/env_reference/env_reference.markdown_docs.md`
- **File Name**: `env_reference.markdown_docs.md`
- **File Size**: 23,711 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/introduction/env_reference/env_reference.markdown_docs.md](../../../../../docs/doc/tutorials/introduction/env_reference/env_reference.markdown_docs.md)
...
# Documentation for `doc/tutorials/introduction/env_reference/env_reference.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/introduction/env_reference/env_reference.markdown`
- **File Name**: `env_reference.markdown`
- **File Size**: 22,987 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/introduction/env_reference/env_reference.markdown](../../../../doc/tutorials/introduction/env_reference/env_reference.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/introduction/env_reference` directory and serves as part of the OpenCV library infrastructure.
