# Documentation for `docs/doc/tutorials/introduction/linux_eclipse/linux_eclipse.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/introduction/linux_eclipse/linux_eclipse.markdown_docs.md`
- **File Name**: `linux_eclipse.markdown_docs.md`
- **File Size**: 8,782 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/introduction/linux_eclipse/linux_eclipse.markdown_docs.md](../../../../../docs/doc/tutorials/introduction/linux_eclipse/linux_eclipse.markdown_docs.md)
...
# Documentation for `doc/tutorials/introduction/linux_eclipse/linux_eclipse.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/introduction/linux_eclipse/linux_eclipse.markdown`
- **File Name**: `linux_eclipse.markdown`
- **File Size**: 8,059 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/introduction/linux_eclipse/linux_eclipse.markdown](../../../../doc/tutorials/introduction/linux_eclipse/linux_eclipse.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/introduction/linux_eclipse` directory and serves as part of the OpenCV library infrastructure.
