# Documentation for `docs/doc/tutorials/introduction/linux_install/linux_install.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/introduction/linux_install/linux_install.markdown_docs.md`
- **File Name**: `linux_install.markdown_docs.md`
- **File Size**: 5,865 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/introduction/linux_install/linux_install.markdown_docs.md](../../../../../docs/doc/tutorials/introduction/linux_install/linux_install.markdown_docs.md)

## Purpose and Role

This file is located in the `docs/doc/tutorials/introduction/linux_install` directory and serves as part of the OpenCV library infrastructure.

## Documentation Content

# Documentation for `doc/tutorials/introduction/linux_install/linux_install.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/introduction/linux_install/linux_install.markdown`
- **File Name**: `linux_install.markdown`
- **File Size**: 5,142 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/introduction/linux_install/linux_install.markdown](../../../../doc/tutorials/introduction/linux_install/linux_install.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/introduction/linux_install` directory and serves as part of the OpenCV library infrastructure.
