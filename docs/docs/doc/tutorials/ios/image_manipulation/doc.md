# Documentation for `docs/doc/tutorials/ios/image_manipulation/`
...
**Path**: `docs/doc/tutorials/ios/image_manipulation/`
**Direct Files**: 2
**Subfolders**: 1
...
- **[image_manipulation.markdown_docs.md](image_manipulation.markdown_docs.md_docs.md)**: MD file
- **[image_manipulation.markdown_kw.md](image_manipulation.markdown_kw.md_docs.md)**: MD file
...
- **Parent Folder**: [docs/doc/tutorials/ios/](../ios/doc.md)

**Sibling Folders**:
- [hello/](../hello/doc.md)
- [ios_install/](../ios_install/doc.md)
- [video_processing/](../video_processing/doc.md)
