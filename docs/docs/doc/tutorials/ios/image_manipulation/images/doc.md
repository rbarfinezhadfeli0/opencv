# Documentation for `docs/doc/tutorials/ios/image_manipulation/images/`
...
**Path**: `docs/doc/tutorials/ios/image_manipulation/images/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[output.jpg_kw.md](output.jpg_kw.md_docs.md)**: MD file
- **[output.jpg_docs.md](output.jpg_docs.md_docs.md)**: MD file
...
- **Parent Folder**: [docs/doc/tutorials/ios/image_manipulation/](../image_manipulation/doc.md)
