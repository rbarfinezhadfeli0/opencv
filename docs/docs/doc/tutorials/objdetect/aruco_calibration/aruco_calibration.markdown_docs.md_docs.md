# Documentation for `docs/doc/tutorials/objdetect/aruco_calibration/aruco_calibration.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/objdetect/aruco_calibration/aruco_calibration.markdown_docs.md`
- **File Name**: `aruco_calibration.markdown_docs.md`
- **File Size**: 5,667 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/objdetect/aruco_calibration/aruco_calibration.markdown_docs.md](../../../../../docs/doc/tutorials/objdetect/aruco_calibration/aruco_calibration.markdown_docs.md)
...
# Documentation for `doc/tutorials/objdetect/aruco_calibration/aruco_calibration.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/objdetect/aruco_calibration/aruco_calibration.markdown`
- **File Name**: `aruco_calibration.markdown`
- **File Size**: 4,919 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/objdetect/aruco_calibration/aruco_calibration.markdown](../../../../doc/tutorials/objdetect/aruco_calibration/aruco_calibration.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/objdetect/aruco_calibration` directory and serves as part of the OpenCV library infrastructure.
