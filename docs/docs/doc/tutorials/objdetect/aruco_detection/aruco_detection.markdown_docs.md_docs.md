# Documentation for `docs/doc/tutorials/objdetect/aruco_detection/aruco_detection.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/objdetect/aruco_detection/aruco_detection.markdown_docs.md`
- **File Name**: `aruco_detection.markdown_docs.md`
- **File Size**: 35,960 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/objdetect/aruco_detection/aruco_detection.markdown_docs.md](../../../../../docs/doc/tutorials/objdetect/aruco_detection/aruco_detection.markdown_docs.md)
...
# Documentation for `doc/tutorials/objdetect/aruco_detection/aruco_detection.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/objdetect/aruco_detection/aruco_detection.markdown`
- **File Name**: `aruco_detection.markdown`
- **File Size**: 35,231 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/objdetect/aruco_detection/aruco_detection.markdown](../../../../doc/tutorials/objdetect/aruco_detection/aruco_detection.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/objdetect/aruco_detection` directory and serves as part of the OpenCV library infrastructure.
