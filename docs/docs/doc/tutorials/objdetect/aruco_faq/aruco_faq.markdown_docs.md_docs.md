# Documentation for `docs/doc/tutorials/objdetect/aruco_faq/aruco_faq.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/objdetect/aruco_faq/aruco_faq.markdown_docs.md`
- **File Name**: `aruco_faq.markdown_docs.md`
- **File Size**: 9,795 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/objdetect/aruco_faq/aruco_faq.markdown_docs.md](../../../../../docs/doc/tutorials/objdetect/aruco_faq/aruco_faq.markdown_docs.md)
...
# Documentation for `doc/tutorials/objdetect/aruco_faq/aruco_faq.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/objdetect/aruco_faq/aruco_faq.markdown`
- **File Name**: `aruco_faq.markdown`
- **File Size**: 9,127 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/objdetect/aruco_faq/aruco_faq.markdown](../../../../doc/tutorials/objdetect/aruco_faq/aruco_faq.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/objdetect/aruco_faq` directory and serves as part of the OpenCV library infrastructure.
