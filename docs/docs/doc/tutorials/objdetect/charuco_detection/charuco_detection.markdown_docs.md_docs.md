# Documentation for `docs/doc/tutorials/objdetect/charuco_detection/charuco_detection.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/objdetect/charuco_detection/charuco_detection.markdown_docs.md`
- **File Name**: `charuco_detection.markdown_docs.md`
- **File Size**: 13,394 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/objdetect/charuco_detection/charuco_detection.markdown_docs.md](../../../../../docs/doc/tutorials/objdetect/charuco_detection/charuco_detection.markdown_docs.md)

## Purpose and Role

This file is located in the `docs/doc/tutorials/objdetect/charuco_detection` directory and serves as part of the OpenCV library infrastructure.

## Documentation Content

# Documentation for `doc/tutorials/objdetect/charuco_detection/charuco_detection.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/objdetect/charuco_detection/charuco_detection.markdown`
- **File Name**: `charuco_detection.markdown`
- **File Size**: 12,645 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/objdetect/charuco_detection/charuco_detection.markdown](../../../../doc/tutorials/objdetect/charuco_detection/charuco_detection.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/objdetect/charuco_detection` directory and serves as part of the OpenCV library infrastructure.
