# Documentation for `docs/doc/tutorials/objdetect/charuco_diamond_detection/charuco_diamond_detection.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/objdetect/charuco_diamond_detection/charuco_diamond_detection.markdown_docs.md`
- **File Name**: `charuco_diamond_detection.markdown_docs.md`
- **File Size**: 9,015 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/objdetect/charuco_diamond_detection/charuco_diamond_detection.markdown_docs.md](../../../../../docs/doc/tutorials/objdetect/charuco_diamond_detection/charuco_diamond_detection.markdown_docs.md)
...
# Documentation for `doc/tutorials/objdetect/charuco_diamond_detection/charuco_diamond_detection.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/objdetect/charuco_diamond_detection/charuco_diamond_detection.markdown`
- **File Name**: `charuco_diamond_detection.markdown`
- **File Size**: 8,187 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/objdetect/charuco_diamond_detection/charuco_diamond_detection.markdown](../../../../doc/tutorials/objdetect/charuco_diamond_detection/charuco_diamond_detection.markdown)

## Purpose and Role

This file is located in the `doc/tutorials/objdetect/charuco_diamond_detection` directory and serves as part of the OpenCV library infrastructure.
