# Documentation for `docs/doc/tutorials/others/introduction_to_pca.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/others/introduction_to_pca.markdown_docs.md`
- **File Name**: `introduction_to_pca.markdown_docs.md`
- **File Size**: 10,587 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/others/introduction_to_pca.markdown_docs.md](../../../../docs/doc/tutorials/others/introduction_to_pca.markdown_docs.md)
...
# Documentation for `doc/tutorials/others/introduction_to_pca.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/others/introduction_to_pca.markdown`
- **File Name**: `introduction_to_pca.markdown`
- **File Size**: 9,937 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/others/introduction_to_pca.markdown](../../../doc/tutorials/others/introduction_to_pca.markdown)
