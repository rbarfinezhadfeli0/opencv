# Documentation for `docs/doc/tutorials/others/introduction_to_svm.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/others/introduction_to_svm.markdown_docs.md`
- **File Name**: `introduction_to_svm.markdown_docs.md`
- **File Size**: 12,376 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/others/introduction_to_svm.markdown_docs.md](../../../../docs/doc/tutorials/others/introduction_to_svm.markdown_docs.md)
...
# Documentation for `doc/tutorials/others/introduction_to_svm.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/others/introduction_to_svm.markdown`
- **File Name**: `introduction_to_svm.markdown`
- **File Size**: 11,725 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/others/introduction_to_svm.markdown](../../../doc/tutorials/others/introduction_to_svm.markdown)
