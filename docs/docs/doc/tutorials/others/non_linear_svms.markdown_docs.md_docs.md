# Documentation for `docs/doc/tutorials/others/non_linear_svms.markdown_docs.md`

## File Metadata

- **Full Path**: `docs/doc/tutorials/others/non_linear_svms.markdown_docs.md`
- **File Name**: `non_linear_svms.markdown_docs.md`
- **File Size**: 13,210 bytes
- **File Type**: .md
- **Link to Source**: [docs/doc/tutorials/others/non_linear_svms.markdown_docs.md](../../../../docs/doc/tutorials/others/non_linear_svms.markdown_docs.md)
...
# Documentation for `doc/tutorials/others/non_linear_svms.markdown`

## File Metadata

- **Full Path**: `doc/tutorials/others/non_linear_svms.markdown`
- **File Name**: `non_linear_svms.markdown`
- **File Size**: 12,579 bytes
- **File Type**: .markdown
- **Link to Source**: [doc/tutorials/others/non_linear_svms.markdown](../../../doc/tutorials/others/non_linear_svms.markdown)
