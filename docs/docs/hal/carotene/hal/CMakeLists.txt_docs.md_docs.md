# Documentation for `docs/hal/carotene/hal/CMakeLists.txt_docs.md`

## File Metadata

- **Full Path**: `docs/hal/carotene/hal/CMakeLists.txt_docs.md`
- **File Name**: `CMakeLists.txt_docs.md`
- **File Size**: 5,569 bytes
- **File Type**: .md
- **Link to Source**: [docs/hal/carotene/hal/CMakeLists.txt_docs.md](../../../../docs/hal/carotene/hal/CMakeLists.txt_docs.md)
...
# Documentation for `hal/carotene/hal/CMakeLists.txt`

## File Metadata

- **Full Path**: `hal/carotene/hal/CMakeLists.txt`
- **File Name**: `CMakeLists.txt`
- **File Size**: 4,606 bytes
- **File Type**: .txt
- **Link to Source**: [hal/carotene/hal/CMakeLists.txt](../../../hal/carotene/hal/CMakeLists.txt)
