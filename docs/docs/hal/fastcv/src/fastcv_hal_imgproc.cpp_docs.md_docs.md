# Documentation for `docs/hal/fastcv/src/fastcv_hal_imgproc.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/hal/fastcv/src/fastcv_hal_imgproc.cpp_docs.md`
- **File Name**: `fastcv_hal_imgproc.cpp_docs.md`
- **File Size**: 43,848 bytes
- **File Type**: .md
- **Link to Source**: [docs/hal/fastcv/src/fastcv_hal_imgproc.cpp_docs.md](../../../../docs/hal/fastcv/src/fastcv_hal_imgproc.cpp_docs.md)
...
# Documentation for `hal/fastcv/src/fastcv_hal_imgproc.cpp`

## File Metadata

- **Full Path**: `hal/fastcv/src/fastcv_hal_imgproc.cpp`
- **File Name**: `fastcv_hal_imgproc.cpp`
- **File Size**: 40,474 bytes
- **File Type**: .cpp
- **Link to Source**: [hal/fastcv/src/fastcv_hal_imgproc.cpp](../../../hal/fastcv/src/fastcv_hal_imgproc.cpp)
...
- **FcvSobelLoop_Invoker**: A class/struct defined in this file
- **FcvWarpPerspectiveLoop_Invoker**: A class/struct defined in this file
- **FcvGaussianBlurLoop_Invoker**: A class/struct defined in this file
- **FcvBoxLoop_Invoker**: A class/struct defined in this file
- **FcvPyrLoop_Invoker**: A class/struct defined in this file
