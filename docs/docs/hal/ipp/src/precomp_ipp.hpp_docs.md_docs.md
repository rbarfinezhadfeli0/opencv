# Documentation for `docs/hal/ipp/src/precomp_ipp.hpp_docs.md`

## File Metadata

- **Full Path**: `docs/hal/ipp/src/precomp_ipp.hpp_docs.md`
- **File Name**: `precomp_ipp.hpp_docs.md`
- **File Size**: 6,670 bytes
- **File Type**: .md
- **Link to Source**: [docs/hal/ipp/src/precomp_ipp.hpp_docs.md](../../../../docs/hal/ipp/src/precomp_ipp.hpp_docs.md)
