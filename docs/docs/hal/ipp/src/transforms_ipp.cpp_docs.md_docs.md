# Documentation for `docs/hal/ipp/src/transforms_ipp.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/hal/ipp/src/transforms_ipp.cpp_docs.md`
- **File Name**: `transforms_ipp.cpp_docs.md`
- **File Size**: 8,305 bytes
- **File Type**: .md
- **Link to Source**: [docs/hal/ipp/src/transforms_ipp.cpp_docs.md](../../../../docs/hal/ipp/src/transforms_ipp.cpp_docs.md)
