# Documentation for `docs/hal/ndsrvp/include/imgproc.hpp_docs.md`

## File Metadata

- **Full Path**: `docs/hal/ndsrvp/include/imgproc.hpp_docs.md`
- **File Name**: `imgproc.hpp_docs.md`
- **File Size**: 7,933 bytes
- **File Type**: .md
- **Link to Source**: [docs/hal/ndsrvp/include/imgproc.hpp_docs.md](../../../../docs/hal/ndsrvp/include/imgproc.hpp_docs.md)
