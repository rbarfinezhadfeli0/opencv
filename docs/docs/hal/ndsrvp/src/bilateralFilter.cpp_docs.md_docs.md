# Documentation for `docs/hal/ndsrvp/src/bilateralFilter.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/hal/ndsrvp/src/bilateralFilter.cpp_docs.md`
- **File Name**: `bilateralFilter.cpp_docs.md`
- **File Size**: 12,727 bytes
- **File Type**: .md
- **Link to Source**: [docs/hal/ndsrvp/src/bilateralFilter.cpp_docs.md](../../../../docs/hal/ndsrvp/src/bilateralFilter.cpp_docs.md)
...
# Documentation for `hal/ndsrvp/src/bilateralFilter.cpp`

## File Metadata

- **Full Path**: `hal/ndsrvp/src/bilateralFilter.cpp`
- **File Name**: `bilateralFilter.cpp`
- **File Size**: 9,762 bytes
- **File Type**: .cpp
- **Link to Source**: [hal/ndsrvp/src/bilateralFilter.cpp](../../../hal/ndsrvp/src/bilateralFilter.cpp)
