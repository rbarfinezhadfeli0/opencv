# Documentation for `docs/hal/ndsrvp/src/filter.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/hal/ndsrvp/src/filter.cpp_docs.md`
- **File Name**: `filter.cpp_docs.md`
- **File Size**: 14,805 bytes
- **File Type**: .md
- **Link to Source**: [docs/hal/ndsrvp/src/filter.cpp_docs.md](../../../../docs/hal/ndsrvp/src/filter.cpp_docs.md)
...
# Documentation for `hal/ndsrvp/src/filter.cpp`

## File Metadata

- **Full Path**: `hal/ndsrvp/src/filter.cpp`
- **File Name**: `filter.cpp`
- **File Size**: 11,801 bytes
- **File Type**: .cpp
- **Link to Source**: [hal/ndsrvp/src/filter.cpp](../../../hal/ndsrvp/src/filter.cpp)
...
- **FilterData**: A class/struct defined in this file
