# Documentation for `docs/hal/ndsrvp/src/medianBlur.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/hal/ndsrvp/src/medianBlur.cpp_docs.md`
- **File Name**: `medianBlur.cpp_docs.md`
- **File Size**: 18,784 bytes
- **File Type**: .md
- **Link to Source**: [docs/hal/ndsrvp/src/medianBlur.cpp_docs.md](../../../../docs/hal/ndsrvp/src/medianBlur.cpp_docs.md)
...
# Documentation for `hal/ndsrvp/src/medianBlur.cpp`

## File Metadata

- **Full Path**: `hal/ndsrvp/src/medianBlur.cpp`
- **File Name**: `medianBlur.cpp`
- **File Size**: 15,752 bytes
- **File Type**: .cpp
- **Link to Source**: [hal/ndsrvp/src/medianBlur.cpp](../../../hal/ndsrvp/src/medianBlur.cpp)
...
- **operators_minmax_t**: A class/struct defined in this file
