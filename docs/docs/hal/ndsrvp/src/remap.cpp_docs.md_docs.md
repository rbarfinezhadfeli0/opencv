# Documentation for `docs/hal/ndsrvp/src/remap.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/hal/ndsrvp/src/remap.cpp_docs.md`
- **File Name**: `remap.cpp_docs.md`
- **File Size**: 10,911 bytes
- **File Type**: .md
- **Link to Source**: [docs/hal/ndsrvp/src/remap.cpp_docs.md](../../../../docs/hal/ndsrvp/src/remap.cpp_docs.md)
...
# Documentation for `hal/ndsrvp/src/remap.cpp`

## File Metadata

- **Full Path**: `hal/ndsrvp/src/remap.cpp`
- **File Name**: `remap.cpp`
- **File Size**: 7,996 bytes
- **File Type**: .cpp
- **Link to Source**: [hal/ndsrvp/src/remap.cpp](../../../hal/ndsrvp/src/remap.cpp)
