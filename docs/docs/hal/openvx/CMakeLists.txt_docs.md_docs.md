# Documentation for `docs/hal/openvx/CMakeLists.txt_docs.md`

## File Metadata

- **Full Path**: `docs/hal/openvx/CMakeLists.txt_docs.md`
- **File Name**: `CMakeLists.txt_docs.md`
- **File Size**: 1,127 bytes
- **File Type**: .md
- **Link to Source**: [docs/hal/openvx/CMakeLists.txt_docs.md](../../../docs/hal/openvx/CMakeLists.txt_docs.md)
