# Documentation for `docs/hal/openvx/hal/openvx_hal.hpp_docs.md`

## File Metadata

- **Full Path**: `docs/hal/openvx/hal/openvx_hal.hpp_docs.md`
- **File Name**: `openvx_hal.hpp_docs.md`
- **File Size**: 15,964 bytes
- **File Type**: .md
- **Link to Source**: [docs/hal/openvx/hal/openvx_hal.hpp_docs.md](../../../../docs/hal/openvx/hal/openvx_hal.hpp_docs.md)
