# Documentation for `docs/hal/riscv-rvv/include/types.hpp_docs.md`

## File Metadata

- **Full Path**: `docs/hal/riscv-rvv/include/types.hpp_docs.md`
- **File Name**: `types.hpp_docs.md`
- **File Size**: 53,326 bytes
- **File Type**: .md
- **Link to Source**: [docs/hal/riscv-rvv/include/types.hpp_docs.md](../../../../docs/hal/riscv-rvv/include/types.hpp_docs.md)
...
# Documentation for `hal/riscv-rvv/include/types.hpp`

## File Metadata

- **Full Path**: `hal/riscv-rvv/include/types.hpp`
- **File Name**: `types.hpp`
- **File Size**: 49,631 bytes
- **File Type**: .hpp
- **Link to Source**: [hal/riscv-rvv/include/types.hpp](../../../hal/riscv-rvv/include/types.hpp)
...
- **HAL_RVV_GROUP()**: A function/method defined in this file
- **HAL_RVV_DEFINE_ALL()**: A function/method defined in this file
- **HAL_RVV_DEFINE_ONE()**: A function/method defined in this file
- **HAL_RVV_SIZE_UNRELATED()**: A function/method defined in this file
- **HAL_RVV_CVT2()**: A function/method defined in this file
- **HAL_RVV_SIZE_RELATED()**: A function/method defined in this file
- **HAL_RVV_BOOL_TYPE()**: A function/method defined in this file
- **HAL_RVV_SIZE_RELATED_CUSTOM()**: A function/method defined in this file
- **HAL_RVV_CVT()**: A function/method defined in this file
- **OPENCV_RVV_HAL_TYPES_HPP()**: A function/method defined in this file
