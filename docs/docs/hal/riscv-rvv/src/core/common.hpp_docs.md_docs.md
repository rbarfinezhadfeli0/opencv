# Documentation for `docs/hal/riscv-rvv/src/core/common.hpp_docs.md`

## File Metadata

- **Full Path**: `docs/hal/riscv-rvv/src/core/common.hpp_docs.md`
- **File Name**: `common.hpp_docs.md`
- **File Size**: 10,915 bytes
- **File Type**: .md
- **Link to Source**: [docs/hal/riscv-rvv/src/core/common.hpp_docs.md](../../../../../docs/hal/riscv-rvv/src/core/common.hpp_docs.md)
...
# Documentation for `hal/riscv-rvv/src/core/common.hpp`

## File Metadata

- **Full Path**: `hal/riscv-rvv/src/core/common.hpp`
- **File Name**: `common.hpp`
- **File Size**: 7,518 bytes
- **File Type**: .hpp
- **Link to Source**: [hal/riscv-rvv/src/core/common.hpp](../../../../hal/riscv-rvv/src/core/common.hpp)
...
- **Sqrt64f**: A class/struct defined in this file
- **Sqrt32f**: A class/struct defined in this file
- **AtanParams**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_HAL_RVV_CORE_COMMON_HPP_INCLUDED()**: A function/method defined in this file
- **more()**: A function/method defined in this file
