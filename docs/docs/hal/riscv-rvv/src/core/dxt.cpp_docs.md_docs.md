# Documentation for `docs/hal/riscv-rvv/src/core/dxt.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/hal/riscv-rvv/src/core/dxt.cpp_docs.md`
- **File Name**: `dxt.cpp_docs.md`
- **File Size**: 31,822 bytes
- **File Type**: .md
- **Link to Source**: [docs/hal/riscv-rvv/src/core/dxt.cpp_docs.md](../../../../../docs/hal/riscv-rvv/src/core/dxt.cpp_docs.md)
...
# Documentation for `hal/riscv-rvv/src/core/dxt.cpp`

## File Metadata

- **Full Path**: `hal/riscv-rvv/src/core/dxt.cpp`
- **File Name**: `dxt.cpp`
- **File Size**: 28,737 bytes
- **File Type**: .cpp
- **Link to Source**: [hal/riscv-rvv/src/core/dxt.cpp](../../../../hal/riscv-rvv/src/core/dxt.cpp)
