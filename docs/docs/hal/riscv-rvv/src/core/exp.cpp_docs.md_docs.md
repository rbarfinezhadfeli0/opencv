# Documentation for `docs/hal/riscv-rvv/src/core/exp.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/hal/riscv-rvv/src/core/exp.cpp_docs.md`
- **File Name**: `exp.cpp_docs.md`
- **File Size**: 12,301 bytes
- **File Type**: .md
- **Link to Source**: [docs/hal/riscv-rvv/src/core/exp.cpp_docs.md](../../../../../docs/hal/riscv-rvv/src/core/exp.cpp_docs.md)
...
# Documentation for `hal/riscv-rvv/src/core/exp.cpp`

## File Metadata

- **Full Path**: `hal/riscv-rvv/src/core/exp.cpp`
- **File Name**: `exp.cpp`
- **File Size**: 9,318 bytes
- **File Type**: .cpp
- **Link to Source**: [hal/riscv-rvv/src/core/exp.cpp](../../../../hal/riscv-rvv/src/core/exp.cpp)
...
- **EXP_TAB_VALUE()**: A function/method defined in this file
