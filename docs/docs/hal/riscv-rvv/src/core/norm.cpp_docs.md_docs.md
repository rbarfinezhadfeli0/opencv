# Documentation for `docs/hal/riscv-rvv/src/core/norm.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/hal/riscv-rvv/src/core/norm.cpp_docs.md`
- **File Name**: `norm.cpp_docs.md`
- **File Size**: 45,415 bytes
- **File Type**: .md
- **Link to Source**: [docs/hal/riscv-rvv/src/core/norm.cpp_docs.md](../../../../../docs/hal/riscv-rvv/src/core/norm.cpp_docs.md)
...
# Documentation for `hal/riscv-rvv/src/core/norm.cpp`

## File Metadata

- **Full Path**: `hal/riscv-rvv/src/core/norm.cpp`
- **File Name**: `norm.cpp`
- **File Size**: 42,128 bytes
- **File Type**: .cpp
- **Link to Source**: [hal/riscv-rvv/src/core/norm.cpp](../../../../hal/riscv-rvv/src/core/norm.cpp)
...
- **NormL1_RVV**: A class/struct defined in this file
- **MaskedNormInf_RVV**: A class/struct defined in this file
- **MaskedNormL2_RVV**: A class/struct defined in this file
- **NormL2_RVV**: A class/struct defined in this file
- **MaskedNormL1_RVV**: A class/struct defined in this file
- **NormInf_RVV**: A class/struct defined in this file
