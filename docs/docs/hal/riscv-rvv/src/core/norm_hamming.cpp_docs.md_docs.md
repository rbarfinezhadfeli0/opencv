# Documentation for `docs/hal/riscv-rvv/src/core/norm_hamming.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/hal/riscv-rvv/src/core/norm_hamming.cpp_docs.md`
- **File Name**: `norm_hamming.cpp_docs.md`
- **File Size**: 8,969 bytes
- **File Type**: .md
- **Link to Source**: [docs/hal/riscv-rvv/src/core/norm_hamming.cpp_docs.md](../../../../../docs/hal/riscv-rvv/src/core/norm_hamming.cpp_docs.md)
...
# Documentation for `hal/riscv-rvv/src/core/norm_hamming.cpp`

## File Metadata

- **Full Path**: `hal/riscv-rvv/src/core/norm_hamming.cpp`
- **File Name**: `norm_hamming.cpp`
- **File Size**: 5,822 bytes
- **File Type**: .cpp
- **Link to Source**: [hal/riscv-rvv/src/core/norm_hamming.cpp](../../../../hal/riscv-rvv/src/core/norm_hamming.cpp)
...
- **NormHammingCell4**: A class/struct defined in this file
- **NormHammingCell1**: A class/struct defined in this file
- **NormHammingCell2**: A class/struct defined in this file
