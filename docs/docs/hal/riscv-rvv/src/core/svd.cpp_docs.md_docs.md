# Documentation for `docs/hal/riscv-rvv/src/core/svd.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/hal/riscv-rvv/src/core/svd.cpp_docs.md`
- **File Name**: `svd.cpp_docs.md`
- **File Size**: 13,340 bytes
- **File Type**: .md
- **Link to Source**: [docs/hal/riscv-rvv/src/core/svd.cpp_docs.md](../../../../../docs/hal/riscv-rvv/src/core/svd.cpp_docs.md)
...
# Documentation for `hal/riscv-rvv/src/core/svd.cpp`

## File Metadata

- **Full Path**: `hal/riscv-rvv/src/core/svd.cpp`
- **File Name**: `svd.cpp`
- **File Size**: 10,286 bytes
- **File Type**: .cpp
- **Link to Source**: [hal/riscv-rvv/src/core/svd.cpp](../../../../hal/riscv-rvv/src/core/svd.cpp)
