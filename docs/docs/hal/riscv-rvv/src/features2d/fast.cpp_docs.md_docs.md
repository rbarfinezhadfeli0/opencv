# Documentation for `docs/hal/riscv-rvv/src/features2d/fast.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/hal/riscv-rvv/src/features2d/fast.cpp_docs.md`
- **File Name**: `fast.cpp_docs.md`
- **File Size**: 14,188 bytes
- **File Type**: .md
- **Link to Source**: [docs/hal/riscv-rvv/src/features2d/fast.cpp_docs.md](../../../../../docs/hal/riscv-rvv/src/features2d/fast.cpp_docs.md)
...
# Documentation for `hal/riscv-rvv/src/features2d/fast.cpp`

## File Metadata

- **Full Path**: `hal/riscv-rvv/src/features2d/fast.cpp`
- **File Name**: `fast.cpp`
- **File Size**: 11,233 bytes
- **File Type**: .cpp
- **Link to Source**: [hal/riscv-rvv/src/features2d/fast.cpp](../../../../hal/riscv-rvv/src/features2d/fast.cpp)
