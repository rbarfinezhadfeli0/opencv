# Documentation for `docs/hal/riscv-rvv/src/imgproc/color.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/hal/riscv-rvv/src/imgproc/color.cpp_docs.md`
- **File Name**: `color.cpp_docs.md`
- **File Size**: 104,387 bytes
- **File Type**: .md
- **Link to Source**: [docs/hal/riscv-rvv/src/imgproc/color.cpp_docs.md](../../../../../docs/hal/riscv-rvv/src/imgproc/color.cpp_docs.md)
...
int cvtBGRtoXYZ(const uchar * src_data, size_t src_step, uchar * dst_data, size_t dst_step, int width, int height, int depth, int scn, bool swapBlue)
{
    ...
    case CV_32F:
        return color::invoke(width, height, {BGRtoXYZ::cvtBGRtoXYZ<float>}, reinterpret_cast<const float*>(src_data), src_s
... [truncated]
