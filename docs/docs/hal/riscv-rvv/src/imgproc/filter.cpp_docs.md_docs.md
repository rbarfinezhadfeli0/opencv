# Documentation for `docs/hal/riscv-rvv/src/imgproc/filter.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/hal/riscv-rvv/src/imgproc/filter.cpp_docs.md`
- **File Name**: `filter.cpp_docs.md`
- **File Size**: 15,676 bytes
- **File Type**: .md
- **Link to Source**: [docs/hal/riscv-rvv/src/imgproc/filter.cpp_docs.md](../../../../../docs/hal/riscv-rvv/src/imgproc/filter.cpp_docs.md)
