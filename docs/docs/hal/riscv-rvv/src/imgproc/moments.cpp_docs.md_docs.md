# Documentation for `docs/hal/riscv-rvv/src/imgproc/moments.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/hal/riscv-rvv/src/imgproc/moments.cpp_docs.md`
- **File Name**: `moments.cpp_docs.md`
- **File Size**: 11,876 bytes
- **File Type**: .md
- **Link to Source**: [docs/hal/riscv-rvv/src/imgproc/moments.cpp_docs.md](../../../../../docs/hal/riscv-rvv/src/imgproc/moments.cpp_docs.md)
