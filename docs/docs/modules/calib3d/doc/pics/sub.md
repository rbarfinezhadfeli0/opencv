# Subtree Keyword Index for `docs/modules/calib3d/doc/pics/`

## Scope

This keyword index covers **all files** under `docs/modules/calib3d/doc/pics/` recursively, including all subdirectories.
