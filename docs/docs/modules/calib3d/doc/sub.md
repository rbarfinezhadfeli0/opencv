# Subtree Keyword Index for `docs/modules/calib3d/doc/`

## Scope

This keyword index covers **all files** under `docs/modules/calib3d/doc/` recursively, including all subdirectories.
