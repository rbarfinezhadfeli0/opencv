# Subtree Keyword Index for `docs/modules/calib3d/include/opencv2/calib3d/`

## Scope

This keyword index covers **all files** under `docs/modules/calib3d/include/opencv2/calib3d/` recursively, including all subdirectories.
