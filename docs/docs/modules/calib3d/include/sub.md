# Subtree Keyword Index for `docs/modules/calib3d/include/`

## Scope

This keyword index covers **all files** under `docs/modules/calib3d/include/` recursively, including all subdirectories.
