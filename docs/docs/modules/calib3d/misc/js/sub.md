# Subtree Keyword Index for `docs/modules/calib3d/misc/js/`

## Scope

This keyword index covers **all files** under `docs/modules/calib3d/misc/js/` recursively, including all subdirectories.
