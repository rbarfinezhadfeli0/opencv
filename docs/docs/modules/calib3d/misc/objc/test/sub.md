# Subtree Keyword Index for `docs/modules/calib3d/misc/objc/test/`

## Scope

This keyword index covers **all files** under `docs/modules/calib3d/misc/objc/test/` recursively, including all subdirectories.
