# Subtree Keyword Index for `docs/modules/calib3d/misc/python/`

## Scope

This keyword index covers **all files** under `docs/modules/calib3d/misc/python/` recursively, including all subdirectories.
