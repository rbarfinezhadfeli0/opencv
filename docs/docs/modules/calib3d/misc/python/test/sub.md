# Subtree Keyword Index for `docs/modules/calib3d/misc/python/test/`

## Scope

This keyword index covers **all files** under `docs/modules/calib3d/misc/python/test/` recursively, including all subdirectories.
