# Subtree Keyword Index for `docs/modules/calib3d/perf/opencl/`

## Scope

This keyword index covers **all files** under `docs/modules/calib3d/perf/opencl/` recursively, including all subdirectories.
