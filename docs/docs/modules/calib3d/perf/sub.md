# Subtree Keyword Index for `docs/modules/calib3d/perf/`

## Scope

This keyword index covers **all files** under `docs/modules/calib3d/perf/` recursively, including all subdirectories.
