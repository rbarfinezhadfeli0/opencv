# Subtree Keyword Index for `docs/modules/calib3d/src/opencl/`

## Scope

This keyword index covers **all files** under `docs/modules/calib3d/src/opencl/` recursively, including all subdirectories.
