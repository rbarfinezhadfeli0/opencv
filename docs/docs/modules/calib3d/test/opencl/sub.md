# Subtree Keyword Index for `docs/modules/calib3d/test/opencl/`

## Scope

This keyword index covers **all files** under `docs/modules/calib3d/test/opencl/` recursively, including all subdirectories.
