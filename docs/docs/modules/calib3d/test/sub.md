# Subtree Keyword Index for `docs/modules/calib3d/test/`

## Scope

This keyword index covers **all files** under `docs/modules/calib3d/test/` recursively, including all subdirectories.
