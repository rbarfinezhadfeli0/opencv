# Documentation for `docs/modules/core/3rdparty/SoftFloat/`
...
**Path**: `docs/modules/core/3rdparty/SoftFloat/`
**Direct Files**: 0
**Subfolders**: 0
...
- **Parent Folder**: [docs/modules/core/3rdparty/](../3rdparty/doc.md)
