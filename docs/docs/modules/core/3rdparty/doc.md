# Documentation for `docs/modules/core/3rdparty/`
...
**Path**: `docs/modules/core/3rdparty/`
**Direct Files**: 0
**Subfolders**: 1
...
- **SoftFloat/** - See [SoftFloat/doc.md](SoftFloat/doc.md)
...
- **Parent Folder**: [docs/modules/core/](../core/doc.md)
