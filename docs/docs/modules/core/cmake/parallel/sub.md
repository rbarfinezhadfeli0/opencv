# Subtree Keyword Index for `docs/modules/core/cmake/parallel/`

## Scope

This keyword index covers **all files** under `docs/modules/core/cmake/parallel/` recursively, including all subdirectories.
