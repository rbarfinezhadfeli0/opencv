# Subtree Keyword Index for `docs/modules/core/cmake/`

## Scope

This keyword index covers **all files** under `docs/modules/core/cmake/` recursively, including all subdirectories.
