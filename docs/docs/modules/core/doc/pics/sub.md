# Subtree Keyword Index for `docs/modules/core/doc/pics/`

## Scope

This keyword index covers **all files** under `docs/modules/core/doc/pics/` recursively, including all subdirectories.
