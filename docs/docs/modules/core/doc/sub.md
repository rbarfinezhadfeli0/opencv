# Subtree Keyword Index for `docs/modules/core/doc/`

## Scope

This keyword index covers **all files** under `docs/modules/core/doc/` recursively, including all subdirectories.
