# Subtree Keyword Index for `docs/modules/core/include/opencv2/core/detail/`

## Scope

This keyword index covers **all files** under `docs/modules/core/include/opencv2/core/detail/` recursively, including all subdirectories.
