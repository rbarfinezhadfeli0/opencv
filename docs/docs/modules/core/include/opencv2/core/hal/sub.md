# Subtree Keyword Index for `docs/modules/core/include/opencv2/core/hal/`

## Scope

This keyword index covers **all files** under `docs/modules/core/include/opencv2/core/hal/` recursively, including all subdirectories.
