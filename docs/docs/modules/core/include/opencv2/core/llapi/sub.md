# Subtree Keyword Index for `docs/modules/core/include/opencv2/core/llapi/`

## Scope

This keyword index covers **all files** under `docs/modules/core/include/opencv2/core/llapi/` recursively, including all subdirectories.
