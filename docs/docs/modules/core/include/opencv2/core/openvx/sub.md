# Subtree Keyword Index for `docs/modules/core/include/opencv2/core/openvx/`

## Scope

This keyword index covers **all files** under `docs/modules/core/include/opencv2/core/openvx/` recursively, including all subdirectories.
