# Index of `docs/modules/core/include/opencv2/core/parallel/`

## Overview

This folder is part of the OpenCV repository structure and contains and other repository content.

**Location**: `docs/modules/core/include/opencv2/core/parallel`
...
- **[backend/](backend/index.md)**: Subfolder containing 0 files
