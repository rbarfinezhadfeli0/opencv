# Subtree Keyword Index for `docs/modules/core/include/opencv2/core/utils/`

## Scope

This keyword index covers **all files** under `docs/modules/core/include/opencv2/core/utils/` recursively, including all subdirectories.
