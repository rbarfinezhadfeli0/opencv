# Subtree Keyword Index for `docs/modules/core/include/opencv2/`

## Scope

This keyword index covers **all files** under `docs/modules/core/include/opencv2/` recursively, including all subdirectories.
