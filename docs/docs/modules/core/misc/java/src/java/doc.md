# Documentation for `docs/modules/core/misc/java/src/java/`
...
**Path**: `docs/modules/core/misc/java/src/java/`
**Direct Files**: 0
**Subfolders**: 0
...
- **Parent Folder**: [docs/modules/core/misc/java/src/](../src/doc.md)
