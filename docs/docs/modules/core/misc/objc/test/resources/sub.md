# Subtree Keyword Index for `docs/modules/core/misc/objc/test/resources/`

## Scope

This keyword index covers **all files** under `docs/modules/core/misc/objc/test/resources/` recursively, including all subdirectories.
