# Documentation for `docs/modules/core/misc/plugins/`
...
**Path**: `docs/modules/core/misc/plugins/`
**Direct Files**: 0
**Subfolders**: 2
...
- **parallel_openmp/** - See [parallel_openmp/doc.md](parallel_openmp/doc.md)
- **parallel_tbb/** - See [parallel_tbb/doc.md](parallel_tbb/doc.md)
...
**Subfolders**:
- [parallel_openmp/](parallel_openmp/doc.md)
- [parallel_tbb/](parallel_tbb/doc.md)
