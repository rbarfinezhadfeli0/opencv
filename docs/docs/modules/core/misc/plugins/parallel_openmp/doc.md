# Documentation for `docs/modules/core/misc/plugins/parallel_openmp/`
...
**Path**: `docs/modules/core/misc/plugins/parallel_openmp/`
**Direct Files**: 0
**Subfolders**: 0
...
- **Parent Folder**: [docs/modules/core/misc/plugins/](../plugins/doc.md)
