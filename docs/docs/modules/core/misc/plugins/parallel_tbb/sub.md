# Subtree Keyword Index for `docs/modules/core/misc/plugins/parallel_tbb/`

## Scope

This keyword index covers **all files** under `docs/modules/core/misc/plugins/parallel_tbb/` recursively, including all subdirectories.
