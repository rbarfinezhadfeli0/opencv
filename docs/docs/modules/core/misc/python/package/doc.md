# Documentation for `docs/modules/core/misc/python/package/`
...
**Path**: `docs/modules/core/misc/python/package/`
**Direct Files**: 0
**Subfolders**: 2
...
- **mat_wrapper/** - See [mat_wrapper/doc.md](mat_wrapper/doc.md)
...
- **Parent Folder**: [docs/modules/core/misc/python/](../python/doc.md)

**Subfolders**:
- [mat_wrapper/](mat_wrapper/doc.md)
- [utils/](utils/doc.md)
