# Subtree Keyword Index for `docs/modules/core/perf/cuda/`

## Scope

This keyword index covers **all files** under `docs/modules/core/perf/cuda/` recursively, including all subdirectories.
