# Subtree Keyword Index for `docs/modules/core/perf/opencl/`

## Scope

This keyword index covers **all files** under `docs/modules/core/perf/opencl/` recursively, including all subdirectories.
