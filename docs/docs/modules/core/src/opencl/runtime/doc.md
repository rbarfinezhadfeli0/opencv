# Documentation for `docs/modules/core/src/opencl/runtime/`
...
**Path**: `docs/modules/core/src/opencl/runtime/`
**Direct Files**: 0
**Subfolders**: 2
...
- **Parent Folder**: [docs/modules/core/src/opencl/](../opencl/doc.md)
