# Index of `docs/modules/core/src/opencl/runtime/generator/`

## Overview

This folder is part of the OpenCV repository structure and contains and other repository content.

**Location**: `docs/modules/core/src/opencl/runtime/generator`
...
- **[filter/](filter/index.md)**: Subfolder containing 0 files
