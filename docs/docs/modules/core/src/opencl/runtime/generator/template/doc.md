# Documentation for `docs/modules/core/src/opencl/runtime/generator/template/`
...
**Path**: `docs/modules/core/src/opencl/runtime/generator/template/`
**Direct Files**: 0
**Subfolders**: 0
...
- **Parent Folder**: [docs/modules/core/src/opencl/runtime/generator/](../generator/doc.md)

**Sibling Folders**:
- [filter/](../filter/doc.md)
