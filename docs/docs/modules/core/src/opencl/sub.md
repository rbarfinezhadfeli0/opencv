# Subtree Keyword Index for `docs/modules/core/src/opencl/`

## Scope

This keyword index covers **all files** under `docs/modules/core/src/opencl/` recursively, including all subdirectories.
