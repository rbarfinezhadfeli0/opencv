# Subtree Keyword Index for `docs/modules/dnn/cmake/hooks/`

## Scope

This keyword index covers **all files** under `docs/modules/dnn/cmake/hooks/` recursively, including all subdirectories.
