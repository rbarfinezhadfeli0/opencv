# Subtree Keyword Index for `docs/modules/dnn/cmake/`

## Scope

This keyword index covers **all files** under `docs/modules/dnn/cmake/` recursively, including all subdirectories.
