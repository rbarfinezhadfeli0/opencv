# Subtree Keyword Index for `docs/modules/dnn/misc/objc/`

## Scope

This keyword index covers **all files** under `docs/modules/dnn/misc/objc/` recursively, including all subdirectories.
