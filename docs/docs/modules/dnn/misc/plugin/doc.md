# Documentation for `docs/modules/dnn/misc/plugin/`
...
**Path**: `docs/modules/dnn/misc/plugin/`
**Direct Files**: 0
**Subfolders**: 1
...
- **openvino/** - See [openvino/doc.md](openvino/doc.md)
...
- **Parent Folder**: [docs/modules/dnn/misc/](../misc/doc.md)
