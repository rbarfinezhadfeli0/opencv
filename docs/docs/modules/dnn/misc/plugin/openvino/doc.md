# Documentation for `docs/modules/dnn/misc/plugin/openvino/`
...
**Path**: `docs/modules/dnn/misc/plugin/openvino/`
**Direct Files**: 0
**Subfolders**: 0
...
- **Parent Folder**: [docs/modules/dnn/misc/plugin/](../plugin/doc.md)
