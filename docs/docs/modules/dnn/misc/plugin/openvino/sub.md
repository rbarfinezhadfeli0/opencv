# Subtree Keyword Index for `docs/modules/dnn/misc/plugin/openvino/`

## Scope

This keyword index covers **all files** under `docs/modules/dnn/misc/plugin/openvino/` recursively, including all subdirectories.
