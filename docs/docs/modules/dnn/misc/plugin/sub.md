# Subtree Keyword Index for `docs/modules/dnn/misc/plugin/`

## Scope

This keyword index covers **all files** under `docs/modules/dnn/misc/plugin/` recursively, including all subdirectories.
...
- **[openvino/](openvino/sub.md)**: 0 files
