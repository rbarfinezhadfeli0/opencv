# Subtree Keyword Index for `docs/modules/dnn/perf/`

## Scope

This keyword index covers **all files** under `docs/modules/dnn/perf/` recursively, including all subdirectories.
