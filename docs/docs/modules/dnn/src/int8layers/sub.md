# Subtree Keyword Index for `docs/modules/dnn/src/int8layers/`

## Scope

This keyword index covers **all files** under `docs/modules/dnn/src/int8layers/` recursively, including all subdirectories.
