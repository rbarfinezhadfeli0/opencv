# Documentation for `docs/modules/dnn/src/layers/cpu_kernels/`
...
**Path**: `docs/modules/dnn/src/layers/cpu_kernels/`
**Direct Files**: 0
**Subfolders**: 0
...
- **Parent Folder**: [docs/modules/dnn/src/layers/](../layers/doc.md)
