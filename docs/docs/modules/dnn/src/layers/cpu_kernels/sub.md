# Subtree Keyword Index for `docs/modules/dnn/src/layers/cpu_kernels/`

## Scope

This keyword index covers **all files** under `docs/modules/dnn/src/layers/cpu_kernels/` recursively, including all subdirectories.
