# Subtree Keyword Index for `docs/modules/dnn/src/ocl4dnn/include/`

## Scope

This keyword index covers **all files** under `docs/modules/dnn/src/ocl4dnn/include/` recursively, including all subdirectories.
