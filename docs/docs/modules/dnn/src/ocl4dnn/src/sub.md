# Subtree Keyword Index for `docs/modules/dnn/src/ocl4dnn/src/`

## Scope

This keyword index covers **all files** under `docs/modules/dnn/src/ocl4dnn/src/` recursively, including all subdirectories.
