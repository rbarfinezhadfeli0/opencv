# Subtree Keyword Index for `docs/modules/dnn/src/opencl/`

## Scope

This keyword index covers **all files** under `docs/modules/dnn/src/opencl/` recursively, including all subdirectories.
