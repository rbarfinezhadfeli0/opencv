# Subtree Keyword Index for `docs/modules/dnn/src/vkcom/shader/`

## Scope

This keyword index covers **all files** under `docs/modules/dnn/src/vkcom/shader/` recursively, including all subdirectories.
