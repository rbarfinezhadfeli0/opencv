# Subtree Keyword Index for `docs/modules/dnn/src/vkcom/src/`

## Scope

This keyword index covers **all files** under `docs/modules/dnn/src/vkcom/src/` recursively, including all subdirectories.
