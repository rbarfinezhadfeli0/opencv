# Documentation for `docs/modules/features2d/3rdparty/mscr/`
...
**Path**: `docs/modules/features2d/3rdparty/mscr/`
**Direct Files**: 0
**Subfolders**: 0
...
- **Parent Folder**: [docs/modules/features2d/3rdparty/](../3rdparty/doc.md)
