# Subtree Keyword Index for `docs/modules/features2d/3rdparty/mscr/`

## Scope

This keyword index covers **all files** under `docs/modules/features2d/3rdparty/mscr/` recursively, including all subdirectories.
