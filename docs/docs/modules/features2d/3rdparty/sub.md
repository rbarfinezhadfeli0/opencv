# Subtree Keyword Index for `docs/modules/features2d/3rdparty/`

## Scope

This keyword index covers **all files** under `docs/modules/features2d/3rdparty/` recursively, including all subdirectories.
