# Subtree Keyword Index for `docs/modules/features2d/perf/opencl/`

## Scope

This keyword index covers **all files** under `docs/modules/features2d/perf/opencl/` recursively, including all subdirectories.
