# Subtree Keyword Index for `docs/modules/features2d/perf/`

## Scope

This keyword index covers **all files** under `docs/modules/features2d/perf/` recursively, including all subdirectories.
