# Subtree Keyword Index for `docs/modules/features2d/src/opencl/`

## Scope

This keyword index covers **all files** under `docs/modules/features2d/src/opencl/` recursively, including all subdirectories.
