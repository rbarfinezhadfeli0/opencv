# Subtree Keyword Index for `docs/modules/gapi/cmake/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/cmake/` recursively, including all subdirectories.
