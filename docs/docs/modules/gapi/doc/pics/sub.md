# Subtree Keyword Index for `docs/modules/gapi/doc/pics/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/doc/pics/` recursively, including all subdirectories.
