# Subtree Keyword Index for `docs/modules/gapi/doc/slides/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/doc/slides/` recursively, including all subdirectories.
