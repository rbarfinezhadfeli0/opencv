# Subtree Keyword Index for `docs/modules/gapi/include/opencv2/gapi/cpu/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/include/opencv2/gapi/cpu/` recursively, including all subdirectories.
