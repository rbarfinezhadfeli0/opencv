# Subtree Keyword Index for `docs/modules/gapi/include/opencv2/gapi/fluid/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/include/opencv2/gapi/fluid/` recursively, including all subdirectories.
