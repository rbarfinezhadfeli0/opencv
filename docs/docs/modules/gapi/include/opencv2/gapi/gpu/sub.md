# Subtree Keyword Index for `docs/modules/gapi/include/opencv2/gapi/gpu/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/include/opencv2/gapi/gpu/` recursively, including all subdirectories.
