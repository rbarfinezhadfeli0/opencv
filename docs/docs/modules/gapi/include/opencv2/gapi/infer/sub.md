# Subtree Keyword Index for `docs/modules/gapi/include/opencv2/gapi/infer/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/include/opencv2/gapi/infer/` recursively, including all subdirectories.
