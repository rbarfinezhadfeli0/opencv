# Subtree Keyword Index for `docs/modules/gapi/include/opencv2/gapi/oak/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/include/opencv2/gapi/oak/` recursively, including all subdirectories.
