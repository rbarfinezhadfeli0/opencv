# Subtree Keyword Index for `docs/modules/gapi/include/opencv2/gapi/ocl/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/include/opencv2/gapi/ocl/` recursively, including all subdirectories.
