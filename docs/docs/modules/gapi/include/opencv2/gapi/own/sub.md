# Subtree Keyword Index for `docs/modules/gapi/include/opencv2/gapi/own/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/include/opencv2/gapi/own/` recursively, including all subdirectories.
