# Subtree Keyword Index for `docs/modules/gapi/include/opencv2/gapi/pysrc/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/include/opencv2/gapi/pysrc/` recursively, including all subdirectories.
