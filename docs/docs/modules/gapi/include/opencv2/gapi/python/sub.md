# Subtree Keyword Index for `docs/modules/gapi/include/opencv2/gapi/python/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/include/opencv2/gapi/python/` recursively, including all subdirectories.
