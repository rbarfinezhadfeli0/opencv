# Subtree Keyword Index for `docs/modules/gapi/include/opencv2/gapi/render/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/include/opencv2/gapi/render/` recursively, including all subdirectories.
