# Subtree Keyword Index for `docs/modules/gapi/include/opencv2/gapi/s11n/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/include/opencv2/gapi/s11n/` recursively, including all subdirectories.
