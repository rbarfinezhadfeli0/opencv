# Subtree Keyword Index for `docs/modules/gapi/include/opencv2/gapi/util/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/include/opencv2/gapi/util/` recursively, including all subdirectories.
