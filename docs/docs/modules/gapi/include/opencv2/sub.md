# Subtree Keyword Index for `docs/modules/gapi/include/opencv2/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/include/opencv2/` recursively, including all subdirectories.
