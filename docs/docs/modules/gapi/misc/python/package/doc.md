# Documentation for `docs/modules/gapi/misc/python/package/`
...
**Path**: `docs/modules/gapi/misc/python/package/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [docs/modules/gapi/misc/python/](../python/doc.md)
