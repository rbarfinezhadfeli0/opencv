# Documentation for `docs/modules/gapi/misc/python/package/gapi/`
...
**Path**: `docs/modules/gapi/misc/python/package/gapi/`
**Direct Files**: 0
**Subfolders**: 0
...
- **Parent Folder**: [docs/modules/gapi/misc/python/package/](../package/doc.md)
