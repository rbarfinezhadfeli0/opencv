# Subtree Keyword Index for `docs/modules/gapi/misc/python/samples/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/misc/python/samples/` recursively, including all subdirectories.
