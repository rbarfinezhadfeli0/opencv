# Subtree Keyword Index for `docs/modules/gapi/misc/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/misc/` recursively, including all subdirectories.
