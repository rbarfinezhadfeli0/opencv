# Subtree Keyword Index for `docs/modules/gapi/perf/common/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/perf/common/` recursively, including all subdirectories.
