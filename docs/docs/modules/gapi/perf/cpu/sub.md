# Subtree Keyword Index for `docs/modules/gapi/perf/cpu/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/perf/cpu/` recursively, including all subdirectories.
