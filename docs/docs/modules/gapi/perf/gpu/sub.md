# Subtree Keyword Index for `docs/modules/gapi/perf/gpu/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/perf/gpu/` recursively, including all subdirectories.
