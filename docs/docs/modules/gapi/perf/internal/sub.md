# Subtree Keyword Index for `docs/modules/gapi/perf/internal/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/perf/internal/` recursively, including all subdirectories.
