# Subtree Keyword Index for `docs/modules/gapi/perf/render/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/perf/render/` recursively, including all subdirectories.
