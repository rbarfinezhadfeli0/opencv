# Subtree Keyword Index for `docs/modules/gapi/perf/streaming/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/perf/streaming/` recursively, including all subdirectories.
