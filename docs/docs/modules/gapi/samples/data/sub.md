# Subtree Keyword Index for `docs/modules/gapi/samples/data/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/samples/data/` recursively, including all subdirectories.
