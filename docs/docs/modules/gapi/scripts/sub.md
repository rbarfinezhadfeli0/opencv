# Subtree Keyword Index for `docs/modules/gapi/scripts/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/scripts/` recursively, including all subdirectories.
