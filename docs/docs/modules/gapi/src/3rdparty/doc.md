# Documentation for `docs/modules/gapi/src/3rdparty/`
...
**Path**: `docs/modules/gapi/src/3rdparty/`
**Direct Files**: 0
**Subfolders**: 1
...
- **vasot/** - See [vasot/doc.md](vasot/doc.md)
...
- **Parent Folder**: [docs/modules/gapi/src/](../src/doc.md)
