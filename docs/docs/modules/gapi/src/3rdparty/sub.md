# Subtree Keyword Index for `docs/modules/gapi/src/3rdparty/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/src/3rdparty/` recursively, including all subdirectories.
