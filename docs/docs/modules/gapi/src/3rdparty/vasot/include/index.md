# Index of `docs/modules/gapi/src/3rdparty/vasot/include/`

## Overview

This folder is part of the OpenCV repository structure and contains and other repository content.

**Location**: `docs/modules/gapi/src/3rdparty/vasot/include`
...
- **[vas/](vas/index.md)**: Subfolder containing 0 files
