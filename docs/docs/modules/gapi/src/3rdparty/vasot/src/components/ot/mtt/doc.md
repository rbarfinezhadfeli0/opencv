# Documentation for `docs/modules/gapi/src/3rdparty/vasot/src/components/ot/mtt/`
...
**Path**: `docs/modules/gapi/src/3rdparty/vasot/src/components/ot/mtt/`
**Direct Files**: 0
**Subfolders**: 0
...
- **Parent Folder**: [docs/modules/gapi/src/3rdparty/vasot/src/components/ot/](../ot/doc.md)
