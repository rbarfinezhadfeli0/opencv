# Documentation for `docs/modules/gapi/src/3rdparty/vasot/src/`
...
**Path**: `docs/modules/gapi/src/3rdparty/vasot/src/`
**Direct Files**: 0
**Subfolders**: 2
...
- **components/** - See [components/doc.md](components/doc.md)
