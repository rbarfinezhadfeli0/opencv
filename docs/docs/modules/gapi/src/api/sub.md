# Subtree Keyword Index for `docs/modules/gapi/src/api/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/src/api/` recursively, including all subdirectories.
