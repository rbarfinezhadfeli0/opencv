# Subtree Keyword Index for `docs/modules/gapi/src/backends/cpu/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/src/backends/cpu/` recursively, including all subdirectories.
