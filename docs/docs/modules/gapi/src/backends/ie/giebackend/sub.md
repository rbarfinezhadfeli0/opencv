# Subtree Keyword Index for `docs/modules/gapi/src/backends/ie/giebackend/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/src/backends/ie/giebackend/` recursively, including all subdirectories.
