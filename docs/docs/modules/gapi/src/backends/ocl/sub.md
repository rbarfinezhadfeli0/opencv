# Subtree Keyword Index for `docs/modules/gapi/src/backends/ocl/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/src/backends/ocl/` recursively, including all subdirectories.
