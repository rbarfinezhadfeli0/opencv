# Subtree Keyword Index for `docs/modules/gapi/src/backends/onnx/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/src/backends/onnx/` recursively, including all subdirectories.
