# Subtree Keyword Index for `docs/modules/gapi/src/backends/plaidml/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/src/backends/plaidml/` recursively, including all subdirectories.
