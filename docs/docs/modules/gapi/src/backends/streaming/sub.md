# Subtree Keyword Index for `docs/modules/gapi/src/backends/streaming/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/src/backends/streaming/` recursively, including all subdirectories.
