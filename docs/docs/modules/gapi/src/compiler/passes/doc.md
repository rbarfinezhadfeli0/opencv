# Documentation for `docs/modules/gapi/src/compiler/passes/`
...
**Path**: `docs/modules/gapi/src/compiler/passes/`
**Direct Files**: 0
**Subfolders**: 0
...
- **Parent Folder**: [docs/modules/gapi/src/compiler/](../compiler/doc.md)
