# Subtree Keyword Index for `docs/modules/gapi/src/compiler/passes/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/src/compiler/passes/` recursively, including all subdirectories.
