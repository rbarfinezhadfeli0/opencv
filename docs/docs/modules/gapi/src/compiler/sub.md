# Subtree Keyword Index for `docs/modules/gapi/src/compiler/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/src/compiler/` recursively, including all subdirectories.
