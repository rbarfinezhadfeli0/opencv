# Subtree Keyword Index for `docs/modules/gapi/src/pysrc/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/src/pysrc/` recursively, including all subdirectories.
