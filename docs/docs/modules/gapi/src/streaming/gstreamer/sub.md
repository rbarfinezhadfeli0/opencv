# Subtree Keyword Index for `docs/modules/gapi/src/streaming/gstreamer/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/src/streaming/gstreamer/` recursively, including all subdirectories.
