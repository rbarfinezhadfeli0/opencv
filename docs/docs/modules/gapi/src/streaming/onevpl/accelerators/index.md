# Index of `docs/modules/gapi/src/streaming/onevpl/accelerators/`

## Overview

This folder is part of the OpenCV repository structure and contains and other repository content.

**Location**: `docs/modules/gapi/src/streaming/onevpl/accelerators`
...
- **[surface/](surface/index.md)**: Subfolder containing 0 files
