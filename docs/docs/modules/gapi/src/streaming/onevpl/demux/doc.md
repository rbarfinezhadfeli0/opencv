# Documentation for `docs/modules/gapi/src/streaming/onevpl/demux/`
...
**Path**: `docs/modules/gapi/src/streaming/onevpl/demux/`
**Direct Files**: 0
**Subfolders**: 0
...
- **Parent Folder**: [docs/modules/gapi/src/streaming/onevpl/](../onevpl/doc.md)
