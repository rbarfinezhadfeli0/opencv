# Documentation for `docs/modules/gapi/src/streaming/onevpl/`
...
**Path**: `docs/modules/gapi/src/streaming/onevpl/`
**Direct Files**: 0
**Subfolders**: 3
...
- **accelerators/** - See [accelerators/doc.md](accelerators/doc.md)
- **demux/** - See [demux/doc.md](demux/doc.md)
- **engine/** - See [engine/doc.md](engine/doc.md)
...
- **Parent Folder**: [docs/modules/gapi/src/streaming/](../streaming/doc.md)

**Sibling Folders**:
- [gstreamer/](../gstreamer/doc.md)

**Subfolders**:
- [accelerators/](accelerators/doc.md)
- [demux/](demux/doc.md)
