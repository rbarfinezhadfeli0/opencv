# Subtree Keyword Index for `docs/modules/gapi/test/infer/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/test/infer/` recursively, including all subdirectories.
