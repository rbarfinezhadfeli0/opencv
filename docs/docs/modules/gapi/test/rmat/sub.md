# Subtree Keyword Index for `docs/modules/gapi/test/rmat/`

## Scope

This keyword index covers **all files** under `docs/modules/gapi/test/rmat/` recursively, including all subdirectories.
