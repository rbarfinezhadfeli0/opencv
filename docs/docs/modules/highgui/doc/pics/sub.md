# Subtree Keyword Index for `docs/modules/highgui/doc/pics/`

## Scope

This keyword index covers **all files** under `docs/modules/highgui/doc/pics/` recursively, including all subdirectories.
