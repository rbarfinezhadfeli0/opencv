# Subtree Keyword Index for `docs/modules/highgui/doc/`

## Scope

This keyword index covers **all files** under `docs/modules/highgui/doc/` recursively, including all subdirectories.
