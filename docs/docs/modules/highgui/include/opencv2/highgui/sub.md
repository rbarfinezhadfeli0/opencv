# Subtree Keyword Index for `docs/modules/highgui/include/opencv2/highgui/`

## Scope

This keyword index covers **all files** under `docs/modules/highgui/include/opencv2/highgui/` recursively, including all subdirectories.
