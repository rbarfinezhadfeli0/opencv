# Documentation for `docs/modules/highgui/misc/plugins/plugin_gtk/`
...
**Path**: `docs/modules/highgui/misc/plugins/plugin_gtk/`
**Direct Files**: 0
**Subfolders**: 0
...
- **Parent Folder**: [docs/modules/highgui/misc/plugins/](../plugins/doc.md)
