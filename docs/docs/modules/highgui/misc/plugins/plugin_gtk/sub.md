# Subtree Keyword Index for `docs/modules/highgui/misc/plugins/plugin_gtk/`

## Scope

This keyword index covers **all files** under `docs/modules/highgui/misc/plugins/plugin_gtk/` recursively, including all subdirectories.
