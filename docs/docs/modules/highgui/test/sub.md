# Subtree Keyword Index for `docs/modules/highgui/test/`

## Scope

This keyword index covers **all files** under `docs/modules/highgui/test/` recursively, including all subdirectories.
