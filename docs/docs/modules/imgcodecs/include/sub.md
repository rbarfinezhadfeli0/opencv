# Subtree Keyword Index for `docs/modules/imgcodecs/include/`

## Scope

This keyword index covers **all files** under `docs/modules/imgcodecs/include/` recursively, including all subdirectories.
