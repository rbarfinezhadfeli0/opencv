# Subtree Keyword Index for `docs/modules/imgcodecs/misc/java/`

## Scope

This keyword index covers **all files** under `docs/modules/imgcodecs/misc/java/` recursively, including all subdirectories.
