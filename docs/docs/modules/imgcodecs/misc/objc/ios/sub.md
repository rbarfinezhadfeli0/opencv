# Subtree Keyword Index for `docs/modules/imgcodecs/misc/objc/ios/`

## Scope

This keyword index covers **all files** under `docs/modules/imgcodecs/misc/objc/ios/` recursively, including all subdirectories.
