# Subtree Keyword Index for `docs/modules/imgcodecs/misc/objc/macosx/`

## Scope

This keyword index covers **all files** under `docs/modules/imgcodecs/misc/objc/macosx/` recursively, including all subdirectories.
