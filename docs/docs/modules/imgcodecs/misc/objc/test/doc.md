# Documentation for `docs/modules/imgcodecs/misc/objc/test/`
...
**Path**: `docs/modules/imgcodecs/misc/objc/test/`
**Direct Files**: 0
**Subfolders**: 0
...
- **Parent Folder**: [docs/modules/imgcodecs/misc/objc/](../objc/doc.md)
