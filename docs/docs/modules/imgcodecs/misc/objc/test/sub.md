# Subtree Keyword Index for `docs/modules/imgcodecs/misc/objc/test/`

## Scope

This keyword index covers **all files** under `docs/modules/imgcodecs/misc/objc/test/` recursively, including all subdirectories.
