# Subtree Keyword Index for `docs/modules/imgcodecs/perf/`

## Scope

This keyword index covers **all files** under `docs/modules/imgcodecs/perf/` recursively, including all subdirectories.
