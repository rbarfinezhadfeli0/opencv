# Subtree Keyword Index for `docs/modules/imgcodecs/src/`

## Scope

This keyword index covers **all files** under `docs/modules/imgcodecs/src/` recursively, including all subdirectories.
