# Subtree Keyword Index for `docs/modules/imgproc/doc/pics/colormaps/`

## Scope

This keyword index covers **all files** under `docs/modules/imgproc/doc/pics/colormaps/` recursively, including all subdirectories.
