# Subtree Keyword Index for `docs/modules/imgproc/misc/js/`

## Scope

This keyword index covers **all files** under `docs/modules/imgproc/misc/js/` recursively, including all subdirectories.
