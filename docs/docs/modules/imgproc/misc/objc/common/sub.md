# Subtree Keyword Index for `docs/modules/imgproc/misc/objc/common/`

## Scope

This keyword index covers **all files** under `docs/modules/imgproc/misc/objc/common/` recursively, including all subdirectories.
