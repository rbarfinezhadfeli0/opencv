# Subtree Keyword Index for `docs/modules/imgproc/misc/objc/test/`

## Scope

This keyword index covers **all files** under `docs/modules/imgproc/misc/objc/test/` recursively, including all subdirectories.
