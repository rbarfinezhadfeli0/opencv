# Subtree Keyword Index for `docs/modules/imgproc/misc/python/`

## Scope

This keyword index covers **all files** under `docs/modules/imgproc/misc/python/` recursively, including all subdirectories.
