# Documentation for `docs/modules/imgproc/misc/python/test/`
...
**Path**: `docs/modules/imgproc/misc/python/test/`
**Direct Files**: 0
**Subfolders**: 0
...
- **Parent Folder**: [docs/modules/imgproc/misc/python/](../python/doc.md)
