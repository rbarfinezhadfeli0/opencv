# Subtree Keyword Index for `docs/modules/imgproc/misc/python/test/`

## Scope

This keyword index covers **all files** under `docs/modules/imgproc/misc/python/test/` recursively, including all subdirectories.
