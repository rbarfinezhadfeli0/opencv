# Subtree Keyword Index for `docs/modules/imgproc/perf/opencl/`

## Scope

This keyword index covers **all files** under `docs/modules/imgproc/perf/opencl/` recursively, including all subdirectories.
