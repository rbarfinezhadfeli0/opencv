# Subtree Keyword Index for `docs/modules/imgproc/perf/`

## Scope

This keyword index covers **all files** under `docs/modules/imgproc/perf/` recursively, including all subdirectories.
