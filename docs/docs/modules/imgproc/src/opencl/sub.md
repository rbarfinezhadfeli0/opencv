# Subtree Keyword Index for `docs/modules/imgproc/src/opencl/`

## Scope

This keyword index covers **all files** under `docs/modules/imgproc/src/opencl/` recursively, including all subdirectories.
