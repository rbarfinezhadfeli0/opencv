# Subtree Keyword Index for `docs/modules/imgproc/src/`

## Scope

This keyword index covers **all files** under `docs/modules/imgproc/src/` recursively, including all subdirectories.
