# Subtree Keyword Index for `docs/modules/imgproc/test/`

## Scope

This keyword index covers **all files** under `docs/modules/imgproc/test/` recursively, including all subdirectories.
