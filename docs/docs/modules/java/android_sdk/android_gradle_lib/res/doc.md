# Documentation for `docs/modules/java/android_sdk/android_gradle_lib/res/`
...
**Path**: `docs/modules/java/android_sdk/android_gradle_lib/res/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [docs/modules/java/android_sdk/android_gradle_lib/](../android_gradle_lib/doc.md)
