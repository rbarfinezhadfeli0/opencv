# Documentation for `docs/modules/java/android_sdk/android_lib/`
...
**Path**: `docs/modules/java/android_sdk/android_lib/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [docs/modules/java/android_sdk/](../android_sdk/doc.md)
