# Documentation for `docs/modules/java/android_sdk/android_lib/res/values/`
...
**Path**: `docs/modules/java/android_sdk/android_lib/res/values/`
**Direct Files**: 0
**Subfolders**: 0
...
- **Parent Folder**: [docs/modules/java/android_sdk/android_lib/res/](../res/doc.md)
