# Documentation for `docs/modules/java/generator/android/java/`
...
**Path**: `docs/modules/java/generator/android/java/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [docs/modules/java/generator/android/](../android/doc.md)
