# Subtree Keyword Index for `docs/modules/java/jni/`

## Scope

This keyword index covers **all files** under `docs/modules/java/jni/` recursively, including all subdirectories.
