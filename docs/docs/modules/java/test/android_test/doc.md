# Documentation for `docs/modules/java/test/android_test/`
...
**Path**: `docs/modules/java/test/android_test/`
**Direct Files**: 0
**Subfolders**: 2
...
- **tests_module/** - See [tests_module/doc.md](tests_module/doc.md)
...
- **Parent Folder**: [docs/modules/java/test/](../test/doc.md)
