# Documentation for `docs/modules/java/test/android_test/src/`
...
**Path**: `docs/modules/java/test/android_test/src/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [docs/modules/java/test/android_test/](../android_test/doc.md)

**Sibling Folders**:
- [tests_module/](../tests_module/doc.md)
