# Documentation for `docs/modules/java/test/common_test/res/`
...
**Path**: `docs/modules/java/test/common_test/res/`
**Direct Files**: 0
**Subfolders**: 4
...
- **Parent Folder**: [docs/modules/java/test/common_test/](../common_test/doc.md)
