# Documentation for `docs/modules/java/test/common_test/res/raw/`
...
**Path**: `docs/modules/java/test/common_test/res/raw/`
**Direct Files**: 0
**Subfolders**: 0
...
- **Parent Folder**: [docs/modules/java/test/common_test/res/](../res/doc.md)
