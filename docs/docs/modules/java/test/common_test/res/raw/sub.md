# Subtree Keyword Index for `docs/modules/java/test/common_test/res/raw/`

## Scope

This keyword index covers **all files** under `docs/modules/java/test/common_test/res/raw/` recursively, including all subdirectories.
