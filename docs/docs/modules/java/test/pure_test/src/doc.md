# Documentation for `docs/modules/java/test/pure_test/src/`
...
**Path**: `docs/modules/java/test/pure_test/src/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [docs/modules/java/test/pure_test/](../pure_test/doc.md)
