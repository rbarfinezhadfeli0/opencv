# Subtree Keyword Index for `docs/modules/js/perf/perf_imgproc/`

## Scope

This keyword index covers **all files** under `docs/modules/js/perf/perf_imgproc/` recursively, including all subdirectories.
