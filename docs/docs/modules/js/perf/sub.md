# Subtree Keyword Index for `docs/modules/js/perf/`

## Scope

This keyword index covers **all files** under `docs/modules/js/perf/` recursively, including all subdirectories.
...
- **[perf_imgproc/](perf_imgproc/sub.md)**: 0 files
