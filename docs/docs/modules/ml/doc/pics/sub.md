# Subtree Keyword Index for `docs/modules/ml/doc/pics/`

## Scope

This keyword index covers **all files** under `docs/modules/ml/doc/pics/` recursively, including all subdirectories.
