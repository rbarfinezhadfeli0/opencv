# Subtree Keyword Index for `docs/modules/objc/generator/`

## Scope

This keyword index covers **all files** under `docs/modules/objc/generator/` recursively, including all subdirectories.
...
- **[templates/](templates/sub.md)**: 0 files
