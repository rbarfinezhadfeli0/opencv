# Subtree Keyword Index for `docs/modules/objc/generator/templates/`

## Scope

This keyword index covers **all files** under `docs/modules/objc/generator/templates/` recursively, including all subdirectories.
