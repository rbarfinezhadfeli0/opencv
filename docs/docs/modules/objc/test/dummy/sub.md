# Subtree Keyword Index for `docs/modules/objc/test/dummy/`

## Scope

This keyword index covers **all files** under `docs/modules/objc/test/dummy/` recursively, including all subdirectories.
