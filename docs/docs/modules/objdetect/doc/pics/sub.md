# Subtree Keyword Index for `docs/modules/objdetect/doc/pics/`

## Scope

This keyword index covers **all files** under `docs/modules/objdetect/doc/pics/` recursively, including all subdirectories.
