# Subtree Keyword Index for `docs/modules/objdetect/doc/`

## Scope

This keyword index covers **all files** under `docs/modules/objdetect/doc/` recursively, including all subdirectories.
