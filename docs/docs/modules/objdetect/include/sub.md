# Subtree Keyword Index for `docs/modules/objdetect/include/`

## Scope

This keyword index covers **all files** under `docs/modules/objdetect/include/` recursively, including all subdirectories.
