# Documentation for `docs/modules/objdetect/misc/java/src/cpp/`
...
**Path**: `docs/modules/objdetect/misc/java/src/cpp/`
**Direct Files**: 0
**Subfolders**: 0
...
- **Parent Folder**: [docs/modules/objdetect/misc/java/src/](../src/doc.md)
