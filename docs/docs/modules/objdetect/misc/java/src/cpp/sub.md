# Subtree Keyword Index for `docs/modules/objdetect/misc/java/src/cpp/`

## Scope

This keyword index covers **all files** under `docs/modules/objdetect/misc/java/src/cpp/` recursively, including all subdirectories.
