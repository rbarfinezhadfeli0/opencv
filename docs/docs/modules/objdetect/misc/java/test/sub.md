# Subtree Keyword Index for `docs/modules/objdetect/misc/java/test/`

## Scope

This keyword index covers **all files** under `docs/modules/objdetect/misc/java/test/` recursively, including all subdirectories.
