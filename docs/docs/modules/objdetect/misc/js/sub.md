# Subtree Keyword Index for `docs/modules/objdetect/misc/js/`

## Scope

This keyword index covers **all files** under `docs/modules/objdetect/misc/js/` recursively, including all subdirectories.
