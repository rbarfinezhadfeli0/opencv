# Subtree Keyword Index for `docs/modules/objdetect/misc/objc/`

## Scope

This keyword index covers **all files** under `docs/modules/objdetect/misc/objc/` recursively, including all subdirectories.
