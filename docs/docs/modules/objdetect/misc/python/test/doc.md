# Documentation for `docs/modules/objdetect/misc/python/test/`
...
**Path**: `docs/modules/objdetect/misc/python/test/`
**Direct Files**: 0
**Subfolders**: 0
...
- **Parent Folder**: [docs/modules/objdetect/misc/python/](../python/doc.md)
