# Subtree Keyword Index for `docs/modules/objdetect/misc/python/test/`

## Scope

This keyword index covers **all files** under `docs/modules/objdetect/misc/python/test/` recursively, including all subdirectories.
