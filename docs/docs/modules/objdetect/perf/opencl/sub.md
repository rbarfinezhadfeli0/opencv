# Subtree Keyword Index for `docs/modules/objdetect/perf/opencl/`

## Scope

This keyword index covers **all files** under `docs/modules/objdetect/perf/opencl/` recursively, including all subdirectories.
