# Subtree Keyword Index for `docs/modules/objdetect/perf/`

## Scope

This keyword index covers **all files** under `docs/modules/objdetect/perf/` recursively, including all subdirectories.
