# Documentation for `docs/modules/objdetect/src/aruco/apriltag/`
...
**Path**: `docs/modules/objdetect/src/aruco/apriltag/`
**Direct Files**: 0
**Subfolders**: 0
...
- **Parent Folder**: [docs/modules/objdetect/src/aruco/](../aruco/doc.md)
