# Subtree Keyword Index for `docs/modules/objdetect/src/aruco/apriltag/`

## Scope

This keyword index covers **all files** under `docs/modules/objdetect/src/aruco/apriltag/` recursively, including all subdirectories.
