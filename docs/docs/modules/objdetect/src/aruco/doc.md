# Documentation for `docs/modules/objdetect/src/aruco/`
...
**Path**: `docs/modules/objdetect/src/aruco/`
**Direct Files**: 0
**Subfolders**: 1
...
- **apriltag/** - See [apriltag/doc.md](apriltag/doc.md)
...
- **Parent Folder**: [docs/modules/objdetect/src/](../src/doc.md)

**Sibling Folders**:
- [barcode_decoder/](../barcode_decoder/doc.md)
- [barcode_detector/](../barcode_detector/doc.md)
- [opencl/](../opencl/doc.md)

**Subfolders**:
- [apriltag/](apriltag/doc.md)
