# Documentation for `docs/modules/objdetect/src/barcode_decoder/common/`
...
**Path**: `docs/modules/objdetect/src/barcode_decoder/common/`
**Direct Files**: 0
**Subfolders**: 0
...
- **Parent Folder**: [docs/modules/objdetect/src/barcode_decoder/](../barcode_decoder/doc.md)
