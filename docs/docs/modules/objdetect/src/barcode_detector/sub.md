# Subtree Keyword Index for `docs/modules/objdetect/src/barcode_detector/`

## Scope

This keyword index covers **all files** under `docs/modules/objdetect/src/barcode_detector/` recursively, including all subdirectories.
