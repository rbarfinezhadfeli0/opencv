# Documentation for `docs/modules/objdetect/src/`
...
**Path**: `docs/modules/objdetect/src/`
**Direct Files**: 0
**Subfolders**: 4
...
- **barcode_decoder/** - See [barcode_decoder/doc.md](barcode_decoder/doc.md)
- **barcode_detector/** - See [barcode_detector/doc.md](barcode_detector/doc.md)
...
- **Parent Folder**: [docs/modules/objdetect/](../objdetect/doc.md)
