# Subtree Keyword Index for `docs/modules/objdetect/src/opencl/`

## Scope

This keyword index covers **all files** under `docs/modules/objdetect/src/opencl/` recursively, including all subdirectories.
