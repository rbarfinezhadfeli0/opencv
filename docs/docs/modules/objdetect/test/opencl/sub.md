# Subtree Keyword Index for `docs/modules/objdetect/test/opencl/`

## Scope

This keyword index covers **all files** under `docs/modules/objdetect/test/opencl/` recursively, including all subdirectories.
