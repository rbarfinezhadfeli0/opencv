# Subtree Keyword Index for `docs/modules/objdetect/test/`

## Scope

This keyword index covers **all files** under `docs/modules/objdetect/test/` recursively, including all subdirectories.
