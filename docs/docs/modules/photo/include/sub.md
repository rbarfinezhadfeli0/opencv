# Subtree Keyword Index for `docs/modules/photo/include/`

## Scope

This keyword index covers **all files** under `docs/modules/photo/include/` recursively, including all subdirectories.
