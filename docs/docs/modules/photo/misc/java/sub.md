# Subtree Keyword Index for `docs/modules/photo/misc/java/`

## Scope

This keyword index covers **all files** under `docs/modules/photo/misc/java/` recursively, including all subdirectories.
