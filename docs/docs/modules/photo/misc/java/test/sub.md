# Subtree Keyword Index for `docs/modules/photo/misc/java/test/`

## Scope

This keyword index covers **all files** under `docs/modules/photo/misc/java/test/` recursively, including all subdirectories.
