# Subtree Keyword Index for `docs/modules/photo/misc/js/`

## Scope

This keyword index covers **all files** under `docs/modules/photo/misc/js/` recursively, including all subdirectories.
