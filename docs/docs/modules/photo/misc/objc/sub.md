# Subtree Keyword Index for `docs/modules/photo/misc/objc/`

## Scope

This keyword index covers **all files** under `docs/modules/photo/misc/objc/` recursively, including all subdirectories.
