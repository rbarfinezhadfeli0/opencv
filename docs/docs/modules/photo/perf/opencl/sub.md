# Subtree Keyword Index for `docs/modules/photo/perf/opencl/`

## Scope

This keyword index covers **all files** under `docs/modules/photo/perf/opencl/` recursively, including all subdirectories.
