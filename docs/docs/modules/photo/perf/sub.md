# Subtree Keyword Index for `docs/modules/photo/perf/`

## Scope

This keyword index covers **all files** under `docs/modules/photo/perf/` recursively, including all subdirectories.
