# Subtree Keyword Index for `docs/modules/photo/src/cuda/`

## Scope

This keyword index covers **all files** under `docs/modules/photo/src/cuda/` recursively, including all subdirectories.
