# Subtree Keyword Index for `docs/modules/photo/src/opencl/`

## Scope

This keyword index covers **all files** under `docs/modules/photo/src/opencl/` recursively, including all subdirectories.
