# Subtree Keyword Index for `docs/modules/photo/test/ocl/`

## Scope

This keyword index covers **all files** under `docs/modules/photo/test/ocl/` recursively, including all subdirectories.
