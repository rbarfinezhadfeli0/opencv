# Subtree Keyword Index for `docs/modules/photo/test/`

## Scope

This keyword index covers **all files** under `docs/modules/photo/test/` recursively, including all subdirectories.
