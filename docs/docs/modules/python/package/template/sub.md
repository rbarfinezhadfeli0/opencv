# Subtree Keyword Index for `docs/modules/python/package/template/`

## Scope

This keyword index covers **all files** under `docs/modules/python/package/template/` recursively, including all subdirectories.
