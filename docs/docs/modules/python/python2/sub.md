# Subtree Keyword Index for `docs/modules/python/python2/`

## Scope

This keyword index covers **all files** under `docs/modules/python/python2/` recursively, including all subdirectories.
