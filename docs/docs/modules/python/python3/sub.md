# Subtree Keyword Index for `docs/modules/python/python3/`

## Scope

This keyword index covers **all files** under `docs/modules/python/python3/` recursively, including all subdirectories.
