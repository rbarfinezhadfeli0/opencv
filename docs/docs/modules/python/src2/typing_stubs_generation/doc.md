# Documentation for `docs/modules/python/src2/typing_stubs_generation/`
...
**Path**: `docs/modules/python/src2/typing_stubs_generation/`
**Direct Files**: 0
**Subfolders**: 1
...
- **nodes/** - See [nodes/doc.md](nodes/doc.md)
...
- **Parent Folder**: [docs/modules/python/src2/](../src2/doc.md)
