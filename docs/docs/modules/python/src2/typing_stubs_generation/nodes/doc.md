# Documentation for `docs/modules/python/src2/typing_stubs_generation/nodes/`
...
**Path**: `docs/modules/python/src2/typing_stubs_generation/nodes/`
**Direct Files**: 0
**Subfolders**: 0
...
- **Parent Folder**: [docs/modules/python/src2/typing_stubs_generation/](../typing_stubs_generation/doc.md)
