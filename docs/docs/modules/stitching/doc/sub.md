# Subtree Keyword Index for `docs/modules/stitching/doc/`

## Scope

This keyword index covers **all files** under `docs/modules/stitching/doc/` recursively, including all subdirectories.
