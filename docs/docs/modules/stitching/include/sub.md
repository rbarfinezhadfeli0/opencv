# Subtree Keyword Index for `docs/modules/stitching/include/`

## Scope

This keyword index covers **all files** under `docs/modules/stitching/include/` recursively, including all subdirectories.
