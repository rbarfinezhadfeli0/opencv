# Subtree Keyword Index for `docs/modules/stitching/misc/python/test/`

## Scope

This keyword index covers **all files** under `docs/modules/stitching/misc/python/test/` recursively, including all subdirectories.
