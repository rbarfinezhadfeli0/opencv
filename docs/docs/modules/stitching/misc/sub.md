# Subtree Keyword Index for `docs/modules/stitching/misc/`

## Scope

This keyword index covers **all files** under `docs/modules/stitching/misc/` recursively, including all subdirectories.
