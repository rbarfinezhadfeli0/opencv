# Subtree Keyword Index for `docs/modules/stitching/perf/opencl/`

## Scope

This keyword index covers **all files** under `docs/modules/stitching/perf/opencl/` recursively, including all subdirectories.
