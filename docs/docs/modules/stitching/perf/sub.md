# Subtree Keyword Index for `docs/modules/stitching/perf/`

## Scope

This keyword index covers **all files** under `docs/modules/stitching/perf/` recursively, including all subdirectories.
