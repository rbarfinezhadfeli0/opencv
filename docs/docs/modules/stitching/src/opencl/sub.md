# Subtree Keyword Index for `docs/modules/stitching/src/opencl/`

## Scope

This keyword index covers **all files** under `docs/modules/stitching/src/opencl/` recursively, including all subdirectories.
