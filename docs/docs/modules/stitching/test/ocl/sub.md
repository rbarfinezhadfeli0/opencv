# Subtree Keyword Index for `docs/modules/stitching/test/ocl/`

## Scope

This keyword index covers **all files** under `docs/modules/stitching/test/ocl/` recursively, including all subdirectories.
