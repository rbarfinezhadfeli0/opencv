# Subtree Keyword Index for `docs/modules/stitching/test/`

## Scope

This keyword index covers **all files** under `docs/modules/stitching/test/` recursively, including all subdirectories.
