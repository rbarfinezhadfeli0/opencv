# Subtree Keyword Index for `docs/modules/video/perf/opencl/`

## Scope

This keyword index covers **all files** under `docs/modules/video/perf/opencl/` recursively, including all subdirectories.
