# Subtree Keyword Index for `docs/modules/video/perf/`

## Scope

This keyword index covers **all files** under `docs/modules/video/perf/` recursively, including all subdirectories.
