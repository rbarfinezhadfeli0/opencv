# Subtree Keyword Index for `docs/modules/videoio/doc/pics/`

## Scope

This keyword index covers **all files** under `docs/modules/videoio/doc/pics/` recursively, including all subdirectories.
