# Documentation for `docs/modules/videoio/misc/java/src/cpp/`
...
**Path**: `docs/modules/videoio/misc/java/src/cpp/`
**Direct Files**: 0
**Subfolders**: 0
...
- **Parent Folder**: [docs/modules/videoio/misc/java/src/](../src/doc.md)
