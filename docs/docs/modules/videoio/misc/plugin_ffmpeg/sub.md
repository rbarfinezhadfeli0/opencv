# Subtree Keyword Index for `docs/modules/videoio/misc/plugin_ffmpeg/`

## Scope

This keyword index covers **all files** under `docs/modules/videoio/misc/plugin_ffmpeg/` recursively, including all subdirectories.
