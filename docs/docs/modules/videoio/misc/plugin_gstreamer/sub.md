# Subtree Keyword Index for `docs/modules/videoio/misc/plugin_gstreamer/`

## Scope

This keyword index covers **all files** under `docs/modules/videoio/misc/plugin_gstreamer/` recursively, including all subdirectories.
