# Subtree Keyword Index for `docs/modules/videoio/perf/`

## Scope

This keyword index covers **all files** under `docs/modules/videoio/perf/` recursively, including all subdirectories.
