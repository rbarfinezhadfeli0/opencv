# Subtree Keyword Index for `docs/modules/videoio/src/cap_winrt/`

## Scope

This keyword index covers **all files** under `docs/modules/videoio/src/cap_winrt/` recursively, including all subdirectories.
