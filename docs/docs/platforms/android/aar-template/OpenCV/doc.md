# Documentation for `docs/platforms/android/aar-template/OpenCV/`
...
**Path**: `docs/platforms/android/aar-template/OpenCV/`
**Direct Files**: 4
**Subfolders**: 1
...
- **[proguard-rules.pro_docs.md](proguard-rules.pro_docs.md_docs.md)**: MD file
- **[build.gradle.template_docs.md](build.gradle.template_docs.md_docs.md)**: MD file
- **[proguard-rules.pro_kw.md](proguard-rules.pro_kw.md_docs.md)**: MD file
- **[build.gradle.template_kw.md](build.gradle.template_kw.md_docs.md)**: MD file
...
- **Parent Folder**: [docs/platforms/android/aar-template/](../aar-template/doc.md)
