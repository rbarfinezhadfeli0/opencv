# Documentation for `docs/platforms/android/aar-template/OpenCV/src/`
...
**Path**: `docs/platforms/android/aar-template/OpenCV/src/`
**Direct Files**: 0
**Subfolders**: 1
...
- **main/** - See [main/doc.md](main/doc.md)
...
- **Parent Folder**: [docs/platforms/android/aar-template/OpenCV/](../OpenCV/doc.md)
