# Index of `docs/platforms/android/aar-template/OpenCV/src/`

## Overview

This folder is part of the OpenCV repository structure and contains and other repository content.

**Location**: `docs/platforms/android/aar-template/OpenCV/src`
...
- **[main/](main/index.md)**: Subfolder containing 2 files
