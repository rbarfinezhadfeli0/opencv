# Documentation for `docs/platforms/android/aar-template/OpenCV/src/main/cpp/`
...
**Path**: `docs/platforms/android/aar-template/OpenCV/src/main/cpp/`
**Direct Files**: 4
**Subfolders**: 1
...
- **[CMakeLists.txt.template_kw.md](CMakeLists.txt.template_kw.md_docs.md)**: Build configuration
- **[CMakeLists.txt.template_docs.md](CMakeLists.txt.template_docs.md_docs.md)**: Build configuration
...
- **Parent Folder**: [docs/platforms/android/aar-template/OpenCV/src/main/](../main/doc.md)
