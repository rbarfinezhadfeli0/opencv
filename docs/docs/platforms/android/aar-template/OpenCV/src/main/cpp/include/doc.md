# Documentation for `docs/platforms/android/aar-template/OpenCV/src/main/cpp/include/`
...
**Path**: `docs/platforms/android/aar-template/OpenCV/src/main/cpp/include/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[temp.h_kw.md](temp.h_kw.md_docs.md)**: MD file
- **[temp.h_docs.md](temp.h_docs.md_docs.md)**: MD file
...
- **Parent Folder**: [docs/platforms/android/aar-template/OpenCV/src/main/cpp/](../cpp/doc.md)
