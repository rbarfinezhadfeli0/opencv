# Documentation for `docs/platforms/android/aar-template/OpenCV/src/main/`
...
**Path**: `docs/platforms/android/aar-template/OpenCV/src/main/`
**Direct Files**: 2
**Subfolders**: 1
...
- **[AndroidManifest.xml_docs.md](AndroidManifest.xml_docs.md_docs.md)**: MD file
- **[AndroidManifest.xml_kw.md](AndroidManifest.xml_kw.md_docs.md)**: MD file
...
- **Parent Folder**: [docs/platforms/android/aar-template/OpenCV/src/](../src/doc.md)
