# Documentation for `docs/platforms/android/aar-template/README.md_docs.md`

## File Metadata

- **Full Path**: `docs/platforms/android/aar-template/README.md_docs.md`
- **File Name**: `README.md_docs.md`
- **File Size**: 2,137 bytes
- **File Type**: .md
- **Link to Source**: [docs/platforms/android/aar-template/README.md_docs.md](../../../../docs/platforms/android/aar-template/README.md_docs.md)
...
# Documentation for `platforms/android/aar-template/README.md`

## File Metadata

- **Full Path**: `platforms/android/aar-template/README.md`
- **File Name**: `README.md`
- **File Size**: 1,494 bytes
- **File Type**: .md
- **Link to Source**: [platforms/android/aar-template/README.md](../../../platforms/android/aar-template/README.md)
