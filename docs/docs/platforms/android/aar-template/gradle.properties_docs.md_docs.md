# Documentation for `docs/platforms/android/aar-template/gradle.properties_docs.md`

## File Metadata

- **Full Path**: `docs/platforms/android/aar-template/gradle.properties_docs.md`
- **File Name**: `gradle.properties_docs.md`
- **File Size**: 1,914 bytes
- **File Type**: .md
- **Link to Source**: [docs/platforms/android/aar-template/gradle.properties_docs.md](../../../../docs/platforms/android/aar-template/gradle.properties_docs.md)
