# Documentation for `docs/platforms/android/aar-template/gradle/`
...
**Path**: `docs/platforms/android/aar-template/gradle/`
**Direct Files**: 0
**Subfolders**: 1
...
- **wrapper/** - See [wrapper/doc.md](wrapper/doc.md)
