# Documentation for `docs/platforms/android/aar-template/gradle/wrapper/`
...
**Path**: `docs/platforms/android/aar-template/gradle/wrapper/`
**Direct Files**: 4
**Subfolders**: 0
...
- **[gradle-wrapper.properties_kw.md](gradle-wrapper.properties_kw.md_docs.md)**: MD file
...
- **[gradle-wrapper.properties_docs.md](gradle-wrapper.properties_docs.md_docs.md)**: MD file
...
- **Parent Folder**: [docs/platforms/android/aar-template/gradle/](../gradle/doc.md)
