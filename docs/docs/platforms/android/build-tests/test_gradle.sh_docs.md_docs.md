# Documentation for `docs/platforms/android/build-tests/test_gradle.sh_docs.md`

## File Metadata

- **Full Path**: `docs/platforms/android/build-tests/test_gradle.sh_docs.md`
- **File Name**: `test_gradle.sh_docs.md`
- **File Size**: 1,919 bytes
- **File Type**: .md
- **Link to Source**: [docs/platforms/android/build-tests/test_gradle.sh_docs.md](../../../../docs/platforms/android/build-tests/test_gradle.sh_docs.md)
...
# Documentation for `platforms/android/build-tests/test_gradle.sh`

## File Metadata

- **Full Path**: `platforms/android/build-tests/test_gradle.sh`
- **File Name**: `test_gradle.sh`
- **File Size**: 1,300 bytes
- **File Type**: .sh
- **Link to Source**: [platforms/android/build-tests/test_gradle.sh](../../../platforms/android/build-tests/test_gradle.sh)
