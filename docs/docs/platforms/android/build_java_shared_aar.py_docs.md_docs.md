# Documentation for `docs/platforms/android/build_java_shared_aar.py_docs.md`

## File Metadata

- **Full Path**: `docs/platforms/android/build_java_shared_aar.py_docs.md`
- **File Name**: `build_java_shared_aar.py_docs.md`
- **File Size**: 11,863 bytes
- **File Type**: .md
- **Link to Source**: [docs/platforms/android/build_java_shared_aar.py_docs.md](../../../docs/platforms/android/build_java_shared_aar.py_docs.md)
...
# Documentation for `platforms/android/build_java_shared_aar.py`

## File Metadata

- **Full Path**: `platforms/android/build_java_shared_aar.py`
- **File Name**: `build_java_shared_aar.py`
- **File Size**: 8,431 bytes
- **File Type**: .py
- **Link to Source**: [platforms/android/build_java_shared_aar.py](../../platforms/android/build_java_shared_aar.py)
...
- **get_ndk_version()**: A function/method defined in this file
- **get_compiled_aar_path()**: A function/method defined in this file
- **fill_template()**: A function/method defined in this file
- **cleanup()**: A function/method defined in this file
- **main()**: A function/method defined in this file
- **get_opencv_version()**: A function/method defined in this file
