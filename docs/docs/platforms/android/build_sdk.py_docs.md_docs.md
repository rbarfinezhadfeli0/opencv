# Documentation for `docs/platforms/android/build_sdk.py_docs.md`

## File Metadata

- **Full Path**: `docs/platforms/android/build_sdk.py_docs.md`
- **File Name**: `build_sdk.py_docs.md`
- **File Size**: 29,468 bytes
- **File Type**: .md
- **Link to Source**: [docs/platforms/android/build_sdk.py_docs.md](../../../docs/platforms/android/build_sdk.py_docs.md)
...
# Documentation for `platforms/android/build_sdk.py`

## File Metadata

- **Full Path**: `platforms/android/build_sdk.py`
- **File Name**: `build_sdk.py`
- **File Size**: 24,623 bytes
- **File Type**: .py
- **Link to Source**: [platforms/android/build_sdk.py](../../platforms/android/build_sdk.py)
...
- **Builder**: A class/struct defined in this file
- **ABI**: A class/struct defined in this file
- **Fail**: A class/struct defined in this file
- **R**: A class/struct defined in this file
- **BuildConfig**: A class/struct defined in this file

### Functions and Methods

- **haveKleidiCV()**: A function/method defined in this file
- **rm_one()**: A function/method defined in this file
- **add_extra_pack()**: A function/method defined in this file
- **check_dir()**: A function/method defined in this file
- **get_cmake()**: A function/method defined in this file
- **move_recurse()**: A function/method defined in this file
- **get_toolchain_file()**: A function/method defined in this file
- **haveIPP()**: A function/method defined in this file
- **__init__()**: A function/method defined in this file
- **build_library()**: A function/method defined in this file
- **get_ndk_dir()**: A function/method defined in this file
- **copy_recurse()**: A function/method defined in this file
- **__str__()**: A function/method defined in this file
- **determine_opencv_version()**: A function/method defined in this file
- **gather_results()**: A function/method defined in this file
- **check_executable()**: A function/method defined in this file
- **clean_library_build_dir()**: A function/method defined in this file
- **move_smart()**: A function/method defined in this file
- **build_javadoc()**: A function/method defined in this file
- **get_engine_apk_dest()**: A function/method defined in this file
- **get_highest_version()**: A function/method defined in this file
- **execute()**: A function/method defined in this file
- **get_ninja()**: A function/method defined in this file
- **copytree_smart()**: A function/method defined in this file
- **check_cmake_flag_enabled()**: A function/method defined in this file
