# Documentation for `docs/platforms/android/build_static_aar.py_docs.md`

## File Metadata

- **Full Path**: `docs/platforms/android/build_static_aar.py_docs.md`
- **File Name**: `build_static_aar.py_docs.md`
- **File Size**: 16,316 bytes
- **File Type**: .md
- **Link to Source**: [docs/platforms/android/build_static_aar.py_docs.md](../../../docs/platforms/android/build_static_aar.py_docs.md)
...
# Documentation for `platforms/android/build_static_aar.py`

## File Metadata

- **Full Path**: `platforms/android/build_static_aar.py`
- **File Name**: `build_static_aar.py`
- **File Size**: 12,755 bytes
- **File Type**: .py
- **Link to Source**: [platforms/android/build_static_aar.py](../../platforms/android/build_static_aar.py)
...
- **get_list_of_3rdparty_libs()**: A function/method defined in this file
- **get_list_of_opencv_libs()**: A function/method defined in this file
- **add_printing_linked_libs()**: A function/method defined in this file
- **convert_deps_list_to_prefab()**: A function/method defined in this file
- **main()**: A function/method defined in this file
- **merge_dependencies_lists()**: A function/method defined in this file
- **read_linked_libs()**: A function/method defined in this file
