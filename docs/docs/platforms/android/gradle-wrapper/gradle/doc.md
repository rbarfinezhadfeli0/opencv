# Documentation for `docs/platforms/android/gradle-wrapper/gradle/`
...
**Path**: `docs/platforms/android/gradle-wrapper/gradle/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [docs/platforms/android/gradle-wrapper/](../gradle-wrapper/doc.md)
