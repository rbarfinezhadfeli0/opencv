# Index of `docs/platforms/android/gradle-wrapper/gradle/`

## Overview

This folder is part of the OpenCV repository structure and contains and other repository content.

**Location**: `docs/platforms/android/gradle-wrapper/gradle`
...
- **[wrapper/](wrapper/index.md)**: Subfolder containing 4 files
