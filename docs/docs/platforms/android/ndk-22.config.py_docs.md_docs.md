# Documentation for `docs/platforms/android/ndk-22.config.py_docs.md`

## File Metadata

- **Full Path**: `docs/platforms/android/ndk-22.config.py_docs.md`
- **File Name**: `ndk-22.config.py_docs.md`
- **File Size**: 3,459 bytes
- **File Type**: .md
- **Link to Source**: [docs/platforms/android/ndk-22.config.py_docs.md](../../../docs/platforms/android/ndk-22.config.py_docs.md)
...
# Documentation for `platforms/android/ndk-22.config.py`

## File Metadata

- **Full Path**: `platforms/android/ndk-22.config.py`
- **File Name**: `ndk-22.config.py`
- **File Size**: 628 bytes
- **File Type**: .py
- **Link to Source**: [platforms/android/ndk-22.config.py](../../platforms/android/ndk-22.config.py)
