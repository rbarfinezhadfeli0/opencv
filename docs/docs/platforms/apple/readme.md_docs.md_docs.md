# Documentation for `docs/platforms/apple/readme.md_docs.md`

## File Metadata

- **Full Path**: `docs/platforms/apple/readme.md_docs.md`
- **File Name**: `readme.md_docs.md`
- **File Size**: 3,449 bytes
- **File Type**: .md
- **Link to Source**: [docs/platforms/apple/readme.md_docs.md](../../../docs/platforms/apple/readme.md_docs.md)
...
# Documentation for `platforms/apple/readme.md`

## File Metadata

- **Full Path**: `platforms/apple/readme.md`
- **File Name**: `readme.md`
- **File Size**: 2,884 bytes
- **File Type**: .md
- **Link to Source**: [platforms/apple/readme.md](../../platforms/apple/readme.md)
