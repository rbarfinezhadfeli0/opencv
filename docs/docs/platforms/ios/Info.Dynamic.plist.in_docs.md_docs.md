# Documentation for `docs/platforms/ios/Info.Dynamic.plist.in_docs.md`

## File Metadata

- **Full Path**: `docs/platforms/ios/Info.Dynamic.plist.in_docs.md`
- **File Name**: `Info.Dynamic.plist.in_docs.md`
- **File Size**: 1,629 bytes
- **File Type**: .md
- **Link to Source**: [docs/platforms/ios/Info.Dynamic.plist.in_docs.md](../../../docs/platforms/ios/Info.Dynamic.plist.in_docs.md)
