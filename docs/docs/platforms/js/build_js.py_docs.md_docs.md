# Documentation for `docs/platforms/js/build_js.py_docs.md`

## File Metadata

- **Full Path**: `docs/platforms/js/build_js.py_docs.md`
- **File Name**: `build_js.py_docs.md`
- **File Size**: 18,656 bytes
- **File Type**: .md
- **Link to Source**: [docs/platforms/js/build_js.py_docs.md](../../../docs/platforms/js/build_js.py_docs.md)

## Purpose and Role

This file is located in the `docs/platforms/js` directory and serves as part of the OpenCV library infrastructure.

## Documentation Content

# Documentation for `platforms/js/build_js.py`

## File Metadata

- **Full Path**: `platforms/js/build_js.py`
- **File Name**: `build_js.py`
- **File Size**: 14,665 bytes
- **File Type**: .py
- **Link to Source**: [platforms/js/build_js.py](../../platforms/js/build_js.py)
...
- **clean_build_dir()**: A function/method defined in this file
- **build_test()**: A function/method defined in this file
- **get_cmake_cmd()**: A function/method defined in this file
- **build_perf()**: A function/method defined in this file
- **build_doc()**: A function/method defined in this file
- **check_dir()**: A function/method defined in this file
- **build_opencvjs()**: A function/method defined in this file
- **build_loader()**: A function/method defined in this file
- **__str__()**: A function/method defined in this file
- **execute()**: A function/method defined in this file
- **get_build_flags()**: A function/method defined in this file
- **config()**: A function/method defined in this file
- **get_toolchain_file()**: A function/method defined in this file
- **check_file()**: A function/method defined in this file
