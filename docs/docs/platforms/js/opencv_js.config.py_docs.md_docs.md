# Documentation for `docs/platforms/js/opencv_js.config.py_docs.md`

## File Metadata

- **Full Path**: `docs/platforms/js/opencv_js.config.py_docs.md`
- **File Name**: `opencv_js.config.py_docs.md`
- **File Size**: 14,456 bytes
- **File Type**: .md
- **Link to Source**: [docs/platforms/js/opencv_js.config.py_docs.md](../../../docs/platforms/js/opencv_js.config.py_docs.md)
...
# Documentation for `platforms/js/opencv_js.config.py`

## File Metadata

- **Full Path**: `platforms/js/opencv_js.config.py`
- **File Name**: `opencv_js.config.py`
- **File Size**: 11,632 bytes
- **File Type**: .py
- **Link to Source**: [platforms/js/opencv_js.config.py](../../platforms/js/opencv_js.config.py)
