# Documentation for `docs/platforms/linux/gnu.toolchain.cmake_docs.md`

## File Metadata

- **Full Path**: `docs/platforms/linux/gnu.toolchain.cmake_docs.md`
- **File Name**: `gnu.toolchain.cmake_docs.md`
- **File Size**: 4,536 bytes
- **File Type**: .md
- **Link to Source**: [docs/platforms/linux/gnu.toolchain.cmake_docs.md](../../../docs/platforms/linux/gnu.toolchain.cmake_docs.md)
...
# Documentation for `platforms/linux/gnu.toolchain.cmake`

## File Metadata

- **Full Path**: `platforms/linux/gnu.toolchain.cmake`
- **File Name**: `gnu.toolchain.cmake`
- **File Size**: 3,554 bytes
- **File Type**: .cmake
- **Link to Source**: [platforms/linux/gnu.toolchain.cmake](../../platforms/linux/gnu.toolchain.cmake)
