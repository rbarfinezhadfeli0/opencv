# Documentation for `docs/platforms/maven/opencv-it/src/`
...
**Path**: `docs/platforms/maven/opencv-it/src/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [docs/platforms/maven/opencv-it/](../opencv-it/doc.md)
