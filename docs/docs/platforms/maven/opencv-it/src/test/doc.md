# Documentation for `docs/platforms/maven/opencv-it/src/test/`
...
**Path**: `docs/platforms/maven/opencv-it/src/test/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [docs/platforms/maven/opencv-it/src/](../src/doc.md)
