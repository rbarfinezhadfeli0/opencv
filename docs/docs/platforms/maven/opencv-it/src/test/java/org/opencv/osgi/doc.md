# Documentation for `docs/platforms/maven/opencv-it/src/test/java/org/opencv/osgi/`
...
**Path**: `docs/platforms/maven/opencv-it/src/test/java/org/opencv/osgi/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[DeployOpenCVTest.java_kw.md](DeployOpenCVTest.java_kw.md_docs.md)**: MD file
- **[DeployOpenCVTest.java_docs.md](DeployOpenCVTest.java_docs.md_docs.md)**: MD file
...
- **Parent Folder**: [docs/platforms/maven/opencv-it/src/test/java/org/opencv/](../opencv/doc.md)
