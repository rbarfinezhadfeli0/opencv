# Documentation for `docs/platforms/maven/opencv/resources/OSGI-INF/`
...
**Path**: `docs/platforms/maven/opencv/resources/OSGI-INF/`
**Direct Files**: 0
**Subfolders**: 1
...
- **blueprint/** - See [blueprint/doc.md](blueprint/doc.md)
...
- **Parent Folder**: [docs/platforms/maven/opencv/resources/](../resources/doc.md)

**Subfolders**:
- [blueprint/](blueprint/doc.md)
