# Index of `docs/platforms/maven/opencv/resources/OSGI-INF/`

## Overview

This folder is part of the OpenCV repository structure and contains and other repository content.

**Location**: `docs/platforms/maven/opencv/resources/OSGI-INF`
...
- **[blueprint/](blueprint/index.md)**: Subfolder containing 2 files
