# Documentation for `docs/platforms/maven/opencv/resources/`
...
**Path**: `docs/platforms/maven/opencv/resources/`
**Direct Files**: 0
**Subfolders**: 1
...
- **OSGI-INF/** - See [OSGI-INF/doc.md](OSGI-INF/doc.md)
