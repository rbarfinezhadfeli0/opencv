# Documentation for `docs/platforms/maven/opencv/scripts/properties_docs.md`

## File Metadata

- **Full Path**: `docs/platforms/maven/opencv/scripts/properties_docs.md`
- **File Name**: `properties_docs.md`
- **File Size**: 3,306 bytes
- **File Type**: .md
- **Link to Source**: [docs/platforms/maven/opencv/scripts/properties_docs.md](../../../../../docs/platforms/maven/opencv/scripts/properties_docs.md)
...
# Documentation for `platforms/maven/opencv/scripts/properties`

## File Metadata

- **Full Path**: `platforms/maven/opencv/scripts/properties`
- **File Name**: `properties`
- **File Size**: 2,690 bytes
- **File Type**: no extension
- **Link to Source**: [platforms/maven/opencv/scripts/properties](../../../../platforms/maven/opencv/scripts/properties)
