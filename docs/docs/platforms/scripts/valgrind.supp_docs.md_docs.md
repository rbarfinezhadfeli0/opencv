# Documentation for `docs/platforms/scripts/valgrind.supp_docs.md`

## File Metadata

- **Full Path**: `docs/platforms/scripts/valgrind.supp_docs.md`
- **File Name**: `valgrind.supp_docs.md`
- **File Size**: 4,758 bytes
- **File Type**: .md
- **Link to Source**: [docs/platforms/scripts/valgrind.supp_docs.md](../../../docs/platforms/scripts/valgrind.supp_docs.md)
...
# Documentation for `platforms/scripts/valgrind.supp`

## File Metadata

- **Full Path**: `platforms/scripts/valgrind.supp`
- **File Name**: `valgrind.supp`
- **File Size**: 4,205 bytes
- **File Type**: .supp
- **Link to Source**: [platforms/scripts/valgrind.supp](../../platforms/scripts/valgrind.supp)
