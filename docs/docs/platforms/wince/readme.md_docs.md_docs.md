# Documentation for `docs/platforms/wince/readme.md_docs.md`

## File Metadata

- **Full Path**: `docs/platforms/wince/readme.md_docs.md`
- **File Name**: `readme.md_docs.md`
- **File Size**: 2,590 bytes
- **File Type**: .md
- **Link to Source**: [docs/platforms/wince/readme.md_docs.md](../../../docs/platforms/wince/readme.md_docs.md)
...
# Documentation for `platforms/wince/readme.md`

## File Metadata

- **Full Path**: `platforms/wince/readme.md`
- **File Name**: `readme.md`
- **File Size**: 2,025 bytes
- **File Type**: .md
- **Link to Source**: [platforms/wince/readme.md](../../platforms/wince/readme.md)
