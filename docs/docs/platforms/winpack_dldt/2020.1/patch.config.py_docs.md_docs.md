# Documentation for `docs/platforms/winpack_dldt/2020.1/patch.config.py_docs.md`

## File Metadata

- **Full Path**: `docs/platforms/winpack_dldt/2020.1/patch.config.py_docs.md`
- **File Name**: `patch.config.py_docs.md`
- **File Size**: 3,164 bytes
- **File Type**: .md
- **Link to Source**: [docs/platforms/winpack_dldt/2020.1/patch.config.py_docs.md](../../../../docs/platforms/winpack_dldt/2020.1/patch.config.py_docs.md)
...
# Documentation for `platforms/winpack_dldt/2020.1/patch.config.py`

## File Metadata

- **Full Path**: `platforms/winpack_dldt/2020.1/patch.config.py`
- **File Name**: `patch.config.py`
- **File Size**: 275 bytes
- **File Type**: .py
- **Link to Source**: [platforms/winpack_dldt/2020.1/patch.config.py](../../../platforms/winpack_dldt/2020.1/patch.config.py)
