# Documentation for `docs/platforms/winpack_dldt/2020.2/sysroot.config.py_docs.md`

## File Metadata

- **Full Path**: `docs/platforms/winpack_dldt/2020.2/sysroot.config.py_docs.md`
- **File Name**: `sysroot.config.py_docs.md`
- **File Size**: 6,047 bytes
- **File Type**: .md
- **Link to Source**: [docs/platforms/winpack_dldt/2020.2/sysroot.config.py_docs.md](../../../../docs/platforms/winpack_dldt/2020.2/sysroot.config.py_docs.md)
...
# Documentation for `platforms/winpack_dldt/2020.2/sysroot.config.py`

## File Metadata

- **Full Path**: `platforms/winpack_dldt/2020.2/sysroot.config.py`
- **File Name**: `sysroot.config.py`
- **File Size**: 3,004 bytes
- **File Type**: .py
- **Link to Source**: [platforms/winpack_dldt/2020.2/sysroot.config.py](../../../platforms/winpack_dldt/2020.2/sysroot.config.py)
