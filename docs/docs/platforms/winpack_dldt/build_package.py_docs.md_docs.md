# Documentation for `docs/platforms/winpack_dldt/build_package.py_docs.md`

## File Metadata

- **Full Path**: `docs/platforms/winpack_dldt/build_package.py_docs.md`
- **File Name**: `build_package.py_docs.md`
- **File Size**: 28,431 bytes
- **File Type**: .md
- **Link to Source**: [docs/platforms/winpack_dldt/build_package.py_docs.md](../../../docs/platforms/winpack_dldt/build_package.py_docs.md)
...
# Documentation for `platforms/winpack_dldt/build_package.py`

## File Metadata

- **Full Path**: `platforms/winpack_dldt/build_package.py`
- **File Name**: `build_package.py`
- **File Size**: 23,895 bytes
- **File Type**: .py
- **Link to Source**: [platforms/winpack_dldt/build_package.py](../../platforms/winpack_dldt/build_package.py)

## Purpose and Role

This file is located in the `platforms/winpack_dldt` directory and serves as part of the OpenCV library infrastructure.
...
- **BuilderDLDT**: A class/struct defined in this file
...
- **prepare_dir()**: A function/method defined in this file
- **fix_path()**: A function/method defined in this file
- **do_clone()**: A function/method defined in this file
- **git_checkout()**: A function/method defined in this file
- **applyPatch()**: A function/method defined in this file
- **package_sources()**: A function/method defined in this file
- **cleanup()**: A function/method defined in this file
- **build()**: A function/method defined in this file
- **copytree()**: A function/method defined in this file
...
- **prepare_sources()**: A function/method defined in this file
- **init_patchset()**: A function/method defined in this file
- **check_executable()**: A function/method defined in this file
- **make_sysroot()**: A function/method defined in this file
- **main()**: A function/method defined in this file
- **execute()**: A function/method defined in this file
- **git_apply_patch()**: A function/method defined in this file
- **copy_sysroot()**: A function/method defined in this file
