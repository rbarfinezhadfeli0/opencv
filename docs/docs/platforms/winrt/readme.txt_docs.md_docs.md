# Documentation for `docs/platforms/winrt/readme.txt_docs.md`

## File Metadata

- **Full Path**: `docs/platforms/winrt/readme.txt_docs.md`
- **File Name**: `readme.txt_docs.md`
- **File Size**: 7,820 bytes
- **File Type**: .md
- **Link to Source**: [docs/platforms/winrt/readme.txt_docs.md](../../../docs/platforms/winrt/readme.txt_docs.md)
...
# Documentation for `platforms/winrt/readme.txt`

## File Metadata

- **Full Path**: `platforms/winrt/readme.txt`
- **File Name**: `readme.txt`
- **File Size**: 6,885 bytes
- **File Type**: .txt
- **Link to Source**: [platforms/winrt/readme.txt](../../platforms/winrt/readme.txt)
