# Documentation for `docs/samples/CMakeLists.txt_docs.md`

## File Metadata

- **Full Path**: `docs/samples/CMakeLists.txt_docs.md`
- **File Name**: `CMakeLists.txt_docs.md`
- **File Size**: 5,254 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/CMakeLists.txt_docs.md](../../docs/samples/CMakeLists.txt_docs.md)
...
- **Full Path**: `samples/CMakeLists.txt`
- **File Name**: `CMakeLists.txt`
- **File Size**: 4,342 bytes
- **File Type**: .txt
- **Link to Source**: [samples/CMakeLists.txt](../samples/CMakeLists.txt)
