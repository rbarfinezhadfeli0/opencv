# Documentation for `docs/samples/_winpack_build_sample.cmd_docs.md`

## File Metadata

- **Full Path**: `docs/samples/_winpack_build_sample.cmd_docs.md`
- **File Name**: `_winpack_build_sample.cmd_docs.md`
- **File Size**: 7,650 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/_winpack_build_sample.cmd_docs.md](../../docs/samples/_winpack_build_sample.cmd_docs.md)
...
# Documentation for `samples/_winpack_build_sample.cmd`

## File Metadata

- **Full Path**: `samples/_winpack_build_sample.cmd`
- **File Name**: `_winpack_build_sample.cmd`
- **File Size**: 7,330 bytes
- **File Type**: .cmd
- **Link to Source**: [samples/_winpack_build_sample.cmd](../samples/_winpack_build_sample.cmd)
