# Documentation for `docs/samples/_winpack_run_python_sample.cmd_docs.md`

## File Metadata

- **Full Path**: `docs/samples/_winpack_run_python_sample.cmd_docs.md`
- **File Name**: `_winpack_run_python_sample.cmd_docs.md`
- **File Size**: 4,330 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/_winpack_run_python_sample.cmd_docs.md](../../docs/samples/_winpack_run_python_sample.cmd_docs.md)
...
# Documentation for `samples/_winpack_run_python_sample.cmd`

## File Metadata

- **Full Path**: `samples/_winpack_run_python_sample.cmd`
- **File Name**: `_winpack_run_python_sample.cmd`
- **File Size**: 3,898 bytes
- **File Type**: .cmd
- **Link to Source**: [samples/_winpack_run_python_sample.cmd](../samples/_winpack_run_python_sample.cmd)
