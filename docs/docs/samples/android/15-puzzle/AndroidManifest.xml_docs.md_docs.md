# Documentation for `docs/samples/android/15-puzzle/AndroidManifest.xml_docs.md`

## File Metadata

- **Full Path**: `docs/samples/android/15-puzzle/AndroidManifest.xml_docs.md`
- **File Name**: `AndroidManifest.xml_docs.md`
- **File Size**: 2,303 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/android/15-puzzle/AndroidManifest.xml_docs.md](../../../../docs/samples/android/15-puzzle/AndroidManifest.xml_docs.md)
