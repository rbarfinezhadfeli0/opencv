# Documentation for `docs/samples/android/15-puzzle/res/`
...
**Path**: `docs/samples/android/15-puzzle/res/`
**Direct Files**: 0
**Subfolders**: 2
...
- **Parent Folder**: [docs/samples/android/15-puzzle/](../15-puzzle/doc.md)
