# Documentation for `docs/samples/android/15-puzzle/res/values/`
...
**Path**: `docs/samples/android/15-puzzle/res/values/`
**Direct Files**: 2
**Subfolders**: 0
...
- **Parent Folder**: [docs/samples/android/15-puzzle/res/](../res/doc.md)
