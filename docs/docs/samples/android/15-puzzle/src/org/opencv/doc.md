# Documentation for `docs/samples/android/15-puzzle/src/org/opencv/`
...
**Path**: `docs/samples/android/15-puzzle/src/org/opencv/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [docs/samples/android/15-puzzle/src/org/](../org/doc.md)
