# Index of `docs/samples/android/15-puzzle/src/org/opencv/samples/`

## Overview

This folder is part of the OpenCV repository structure and contains and other repository content.

**Location**: `docs/samples/android/15-puzzle/src/org/opencv/samples`
...
- **[puzzle15/](puzzle15/index.md)**: Subfolder containing 4 files
