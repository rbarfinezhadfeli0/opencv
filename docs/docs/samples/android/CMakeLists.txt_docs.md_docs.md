# Documentation for `docs/samples/android/CMakeLists.txt_docs.md`

## File Metadata

- **Full Path**: `docs/samples/android/CMakeLists.txt_docs.md`
- **File Name**: `CMakeLists.txt_docs.md`
- **File Size**: 1,722 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/android/CMakeLists.txt_docs.md](../../../docs/samples/android/CMakeLists.txt_docs.md)
