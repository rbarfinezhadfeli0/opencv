# Documentation for `docs/samples/android/build.gradle.in_docs.md`

## File Metadata

- **Full Path**: `docs/samples/android/build.gradle.in_docs.md`
- **File Name**: `build.gradle.in_docs.md`
- **File Size**: 4,100 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/android/build.gradle.in_docs.md](../../../docs/samples/android/build.gradle.in_docs.md)
...
# Documentation for `samples/android/build.gradle.in`

## File Metadata

- **Full Path**: `samples/android/build.gradle.in`
- **File Name**: `build.gradle.in`
- **File Size**: 3,549 bytes
- **File Type**: .in
- **Link to Source**: [samples/android/build.gradle.in](../../samples/android/build.gradle.in)
