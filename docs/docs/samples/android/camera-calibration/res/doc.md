# Documentation for `docs/samples/android/camera-calibration/res/`
...
**Path**: `docs/samples/android/camera-calibration/res/`
**Direct Files**: 0
**Subfolders**: 4
...
- **menu/** - See [menu/doc.md](menu/doc.md)
...
- **Parent Folder**: [docs/samples/android/camera-calibration/](../camera-calibration/doc.md)
