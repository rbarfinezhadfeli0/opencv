# Index of `docs/samples/android/camera-calibration/res/`

## Overview

This folder is part of the OpenCV repository structure and contains and other repository content.

**Location**: `docs/samples/android/camera-calibration/res`
...
- **[drawable/](drawable/index.md)**: Subfolder containing 2 files
- **[layout/](layout/index.md)**: Subfolder containing 2 files
- **[menu/](menu/index.md)**: Subfolder containing 2 files
- **[values/](values/index.md)**: Subfolder containing 2 files
