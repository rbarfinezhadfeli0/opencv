# Documentation for `docs/samples/android/camera-calibration/res/layout/`
...
**Path**: `docs/samples/android/camera-calibration/res/layout/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[camera_calibration_surface_view.xml_docs.md](camera_calibration_surface_view.xml_docs.md_docs.md)**: MD file
- **[camera_calibration_surface_view.xml_kw.md](camera_calibration_surface_view.xml_kw.md_docs.md)**: MD file
...
- **Parent Folder**: [docs/samples/android/camera-calibration/res/](../res/doc.md)
