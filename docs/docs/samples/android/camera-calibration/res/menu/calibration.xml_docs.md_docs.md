# Documentation for `docs/samples/android/camera-calibration/res/menu/calibration.xml_docs.md`

## File Metadata

- **Full Path**: `docs/samples/android/camera-calibration/res/menu/calibration.xml_docs.md`
- **File Name**: `calibration.xml_docs.md`
- **File Size**: 2,106 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/android/camera-calibration/res/menu/calibration.xml_docs.md](../../../../../../docs/samples/android/camera-calibration/res/menu/calibration.xml_docs.md)

## Purpose and Role

This file is located in the `docs/samples/android/camera-calibration/res/menu` directory and serves as part of the OpenCV library infrastructure.
