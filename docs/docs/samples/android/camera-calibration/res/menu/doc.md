# Documentation for `docs/samples/android/camera-calibration/res/menu/`
...
**Path**: `docs/samples/android/camera-calibration/res/menu/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[calibration.xml_docs.md](calibration.xml_docs.md_docs.md)**: MD file
- **[calibration.xml_kw.md](calibration.xml_kw.md_docs.md)**: MD file
