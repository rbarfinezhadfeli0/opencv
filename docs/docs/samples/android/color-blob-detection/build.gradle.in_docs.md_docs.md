# Documentation for `docs/samples/android/color-blob-detection/build.gradle.in_docs.md`

## File Metadata

- **Full Path**: `docs/samples/android/color-blob-detection/build.gradle.in_docs.md`
- **File Name**: `build.gradle.in_docs.md`
- **File Size**: 1,879 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/android/color-blob-detection/build.gradle.in_docs.md](../../../../docs/samples/android/color-blob-detection/build.gradle.in_docs.md)
