# Documentation for `docs/samples/android/color-blob-detection/res/`
...
**Path**: `docs/samples/android/color-blob-detection/res/`
**Direct Files**: 0
**Subfolders**: 3
...
- **Parent Folder**: [docs/samples/android/color-blob-detection/](../color-blob-detection/doc.md)
