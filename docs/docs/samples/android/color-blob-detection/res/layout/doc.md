# Documentation for `docs/samples/android/color-blob-detection/res/layout/`
...
**Path**: `docs/samples/android/color-blob-detection/res/layout/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[color_blob_detection_surface_view.xml_docs.md](color_blob_detection_surface_view.xml_docs.md_docs.md)**: MD file
- **[color_blob_detection_surface_view.xml_kw.md](color_blob_detection_surface_view.xml_kw.md_docs.md)**: MD file
...
- **Parent Folder**: [docs/samples/android/color-blob-detection/res/](../res/doc.md)
