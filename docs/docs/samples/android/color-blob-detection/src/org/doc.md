# Documentation for `docs/samples/android/color-blob-detection/src/org/`
...
**Path**: `docs/samples/android/color-blob-detection/src/org/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [docs/samples/android/color-blob-detection/src/](../src/doc.md)
