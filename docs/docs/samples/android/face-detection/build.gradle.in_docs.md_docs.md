# Documentation for `docs/samples/android/face-detection/build.gradle.in_docs.md`

## File Metadata

- **Full Path**: `docs/samples/android/face-detection/build.gradle.in_docs.md`
- **File Name**: `build.gradle.in_docs.md`
- **File Size**: 1,839 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/android/face-detection/build.gradle.in_docs.md](../../../../docs/samples/android/face-detection/build.gradle.in_docs.md)
...
# Documentation for `samples/android/face-detection/build.gradle.in`

## File Metadata

- **Full Path**: `samples/android/face-detection/build.gradle.in`
- **File Name**: `build.gradle.in`
- **File Size**: 1,210 bytes
- **File Type**: .in
- **Link to Source**: [samples/android/face-detection/build.gradle.in](../../../samples/android/face-detection/build.gradle.in)
