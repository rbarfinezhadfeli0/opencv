# Documentation for `docs/samples/android/face-detection/src/org/`
...
**Path**: `docs/samples/android/face-detection/src/org/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [docs/samples/android/face-detection/src/](../src/doc.md)
