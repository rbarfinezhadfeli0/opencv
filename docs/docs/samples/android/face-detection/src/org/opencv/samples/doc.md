# Documentation for `docs/samples/android/face-detection/src/org/opencv/samples/`
...
**Path**: `docs/samples/android/face-detection/src/org/opencv/samples/`
**Direct Files**: 0
**Subfolders**: 1
...
- **facedetect/** - See [facedetect/doc.md](facedetect/doc.md)
...
- **Parent Folder**: [docs/samples/android/face-detection/src/org/opencv/](../opencv/doc.md)

**Subfolders**:
- [facedetect/](facedetect/doc.md)
