# Documentation for `docs/samples/android/image-manipulations/build.gradle.in_docs.md`

## File Metadata

- **Full Path**: `docs/samples/android/image-manipulations/build.gradle.in_docs.md`
- **File Name**: `build.gradle.in_docs.md`
- **File Size**: 1,880 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/android/image-manipulations/build.gradle.in_docs.md](../../../../docs/samples/android/image-manipulations/build.gradle.in_docs.md)
...
# Documentation for `samples/android/image-manipulations/build.gradle.in`

## File Metadata

- **Full Path**: `samples/android/image-manipulations/build.gradle.in`
- **File Name**: `build.gradle.in`
- **File Size**: 1,226 bytes
- **File Type**: .in
- **Link to Source**: [samples/android/image-manipulations/build.gradle.in](../../../samples/android/image-manipulations/build.gradle.in)
