# Documentation for `docs/samples/android/image-manipulations/res/`
...
**Path**: `docs/samples/android/image-manipulations/res/`
**Direct Files**: 0
**Subfolders**: 3
...
- **Parent Folder**: [docs/samples/android/image-manipulations/](../image-manipulations/doc.md)
