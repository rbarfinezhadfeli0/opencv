# Documentation for `docs/samples/android/image-manipulations/res/layout/`
...
**Path**: `docs/samples/android/image-manipulations/res/layout/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[image_manipulations_surface_view.xml_docs.md](image_manipulations_surface_view.xml_docs.md_docs.md)**: MD file
- **[image_manipulations_surface_view.xml_kw.md](image_manipulations_surface_view.xml_kw.md_docs.md)**: MD file
...
- **Parent Folder**: [docs/samples/android/image-manipulations/res/](../res/doc.md)
