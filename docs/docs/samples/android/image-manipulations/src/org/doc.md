# Documentation for `docs/samples/android/image-manipulations/src/org/`
...
**Path**: `docs/samples/android/image-manipulations/src/org/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [docs/samples/android/image-manipulations/src/](../src/doc.md)
