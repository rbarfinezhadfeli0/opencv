# Documentation for `docs/samples/android/image-manipulations/src/org/opencv/`
...
**Path**: `docs/samples/android/image-manipulations/src/org/opencv/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [docs/samples/android/image-manipulations/src/org/](../org/doc.md)
