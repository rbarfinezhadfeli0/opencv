# Documentation for `docs/samples/android/image-manipulations/src/org/opencv/samples/`
...
**Path**: `docs/samples/android/image-manipulations/src/org/opencv/samples/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [docs/samples/android/image-manipulations/src/org/opencv/](../opencv/doc.md)
