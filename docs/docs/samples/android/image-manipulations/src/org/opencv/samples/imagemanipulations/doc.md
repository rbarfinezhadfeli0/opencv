# Documentation for `docs/samples/android/image-manipulations/src/org/opencv/samples/imagemanipulations/`
...
**Path**: `docs/samples/android/image-manipulations/src/org/opencv/samples/imagemanipulations/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[ImageManipulationsActivity.java_kw.md](ImageManipulationsActivity.java_kw.md_docs.md)**: MD file
- **[ImageManipulationsActivity.java_docs.md](ImageManipulationsActivity.java_docs.md_docs.md)**: MD file
...
- **Parent Folder**: [docs/samples/android/image-manipulations/src/org/opencv/samples/](../samples/doc.md)
