# Documentation for `docs/samples/android/mobilenet-objdetect/res/`
...
**Path**: `docs/samples/android/mobilenet-objdetect/res/`
**Direct Files**: 0
**Subfolders**: 3
...
- **Parent Folder**: [docs/samples/android/mobilenet-objdetect/](../mobilenet-objdetect/doc.md)
