# Documentation for `docs/samples/android/mobilenet-objdetect/res/layout/`
...
**Path**: `docs/samples/android/mobilenet-objdetect/res/layout/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[activity_main.xml_docs.md](activity_main.xml_docs.md_docs.md)**: Main entry point
- **[activity_main.xml_kw.md](activity_main.xml_kw.md_docs.md)**: Main entry point
...
- **Parent Folder**: [docs/samples/android/mobilenet-objdetect/res/](../res/doc.md)
