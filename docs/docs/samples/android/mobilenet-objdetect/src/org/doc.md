# Documentation for `docs/samples/android/mobilenet-objdetect/src/org/`
...
**Path**: `docs/samples/android/mobilenet-objdetect/src/org/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [docs/samples/android/mobilenet-objdetect/src/](../src/doc.md)
