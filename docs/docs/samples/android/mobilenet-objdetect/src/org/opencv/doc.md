# Documentation for `docs/samples/android/mobilenet-objdetect/src/org/opencv/`
...
**Path**: `docs/samples/android/mobilenet-objdetect/src/org/opencv/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [docs/samples/android/mobilenet-objdetect/src/org/](../org/doc.md)
