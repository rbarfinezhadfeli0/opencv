# Documentation for `docs/samples/android/mobilenet-objdetect/src/org/opencv/samples/`
...
**Path**: `docs/samples/android/mobilenet-objdetect/src/org/opencv/samples/`
**Direct Files**: 0
**Subfolders**: 1
...
- **opencv_mobilenet/** - See [opencv_mobilenet/doc.md](opencv_mobilenet/doc.md)
...
- **Parent Folder**: [docs/samples/android/mobilenet-objdetect/src/org/opencv/](../opencv/doc.md)

**Subfolders**:
- [opencv_mobilenet/](opencv_mobilenet/doc.md)
