# Documentation for `docs/samples/android/mobilenet-objdetect/src/org/opencv/samples/opencv_mobilenet/`
...
**Path**: `docs/samples/android/mobilenet-objdetect/src/org/opencv/samples/opencv_mobilenet/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[MainActivity.java_kw.md](MainActivity.java_kw.md_docs.md)**: Main entry point
- **[MainActivity.java_docs.md](MainActivity.java_docs.md_docs.md)**: Main entry point
...
- **Parent Folder**: [docs/samples/android/mobilenet-objdetect/src/org/opencv/samples/](../samples/doc.md)
