# Documentation for `docs/samples/android/qr-detection/res/`
...
**Path**: `docs/samples/android/qr-detection/res/`
**Direct Files**: 0
**Subfolders**: 2
...
- **Parent Folder**: [docs/samples/android/qr-detection/](../qr-detection/doc.md)
