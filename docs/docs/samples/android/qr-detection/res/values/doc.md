# Documentation for `docs/samples/android/qr-detection/res/values/`
...
**Path**: `docs/samples/android/qr-detection/res/values/`
**Direct Files**: 2
**Subfolders**: 0
...
- **Parent Folder**: [docs/samples/android/qr-detection/res/](../res/doc.md)
