# Documentation for `docs/samples/android/qr-detection/src/org/`
...
**Path**: `docs/samples/android/qr-detection/src/org/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [docs/samples/android/qr-detection/src/](../src/doc.md)
