# Documentation for `docs/samples/android/qr-detection/src/org/opencv/`
...
**Path**: `docs/samples/android/qr-detection/src/org/opencv/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [docs/samples/android/qr-detection/src/org/](../org/doc.md)
