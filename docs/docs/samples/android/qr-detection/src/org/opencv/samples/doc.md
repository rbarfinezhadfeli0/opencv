# Documentation for `docs/samples/android/qr-detection/src/org/opencv/samples/`
...
**Path**: `docs/samples/android/qr-detection/src/org/opencv/samples/`
**Direct Files**: 0
**Subfolders**: 1
...
- **qrdetection/** - See [qrdetection/doc.md](qrdetection/doc.md)
...
- **Parent Folder**: [docs/samples/android/qr-detection/src/org/opencv/](../opencv/doc.md)

**Subfolders**:
- [qrdetection/](qrdetection/doc.md)
