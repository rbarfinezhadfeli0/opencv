# Index of `docs/samples/android/qr-detection/src/org/opencv/samples/`

## Overview

This folder is part of the OpenCV repository structure and contains and other repository content.

**Location**: `docs/samples/android/qr-detection/src/org/opencv/samples`
...
- **[qrdetection/](qrdetection/index.md)**: Subfolder containing 4 files
