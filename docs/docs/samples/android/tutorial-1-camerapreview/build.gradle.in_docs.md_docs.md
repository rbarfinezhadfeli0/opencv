# Documentation for `docs/samples/android/tutorial-1-camerapreview/build.gradle.in_docs.md`

## File Metadata

- **Full Path**: `docs/samples/android/tutorial-1-camerapreview/build.gradle.in_docs.md`
- **File Name**: `build.gradle.in_docs.md`
- **File Size**: 1,882 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/android/tutorial-1-camerapreview/build.gradle.in_docs.md](../../../../docs/samples/android/tutorial-1-camerapreview/build.gradle.in_docs.md)
...
# Documentation for `samples/android/tutorial-1-camerapreview/build.gradle.in`

## File Metadata

- **Full Path**: `samples/android/tutorial-1-camerapreview/build.gradle.in`
- **File Name**: `build.gradle.in`
- **File Size**: 1,203 bytes
- **File Type**: .in
- **Link to Source**: [samples/android/tutorial-1-camerapreview/build.gradle.in](../../../samples/android/tutorial-1-camerapreview/build.gradle.in)
