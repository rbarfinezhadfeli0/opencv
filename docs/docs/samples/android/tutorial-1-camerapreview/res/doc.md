# Documentation for `docs/samples/android/tutorial-1-camerapreview/res/`
...
**Path**: `docs/samples/android/tutorial-1-camerapreview/res/`
**Direct Files**: 0
**Subfolders**: 3
...
- **Parent Folder**: [docs/samples/android/tutorial-1-camerapreview/](../tutorial-1-camerapreview/doc.md)
