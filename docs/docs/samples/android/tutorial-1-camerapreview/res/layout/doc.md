# Documentation for `docs/samples/android/tutorial-1-camerapreview/res/layout/`
...
**Path**: `docs/samples/android/tutorial-1-camerapreview/res/layout/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[tutorial1_surface_view.xml_docs.md](tutorial1_surface_view.xml_docs.md_docs.md)**: MD file
- **[tutorial1_surface_view.xml_kw.md](tutorial1_surface_view.xml_kw.md_docs.md)**: MD file
...
- **Parent Folder**: [docs/samples/android/tutorial-1-camerapreview/res/](../res/doc.md)
