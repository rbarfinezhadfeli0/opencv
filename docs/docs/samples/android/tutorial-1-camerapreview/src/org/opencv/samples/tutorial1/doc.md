# Documentation for `docs/samples/android/tutorial-1-camerapreview/src/org/opencv/samples/tutorial1/`
...
**Path**: `docs/samples/android/tutorial-1-camerapreview/src/org/opencv/samples/tutorial1/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[Tutorial1Activity.java_docs.md](Tutorial1Activity.java_docs.md_docs.md)**: MD file
- **[Tutorial1Activity.java_kw.md](Tutorial1Activity.java_kw.md_docs.md)**: MD file
...
- **Parent Folder**: [docs/samples/android/tutorial-1-camerapreview/src/org/opencv/samples/](../samples/doc.md)
