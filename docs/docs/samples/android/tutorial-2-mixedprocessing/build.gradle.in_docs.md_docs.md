# Documentation for `docs/samples/android/tutorial-2-mixedprocessing/build.gradle.in_docs.md`

## File Metadata

- **Full Path**: `docs/samples/android/tutorial-2-mixedprocessing/build.gradle.in_docs.md`
- **File Name**: `build.gradle.in_docs.md`
- **File Size**: 2,897 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/android/tutorial-2-mixedprocessing/build.gradle.in_docs.md](../../../../docs/samples/android/tutorial-2-mixedprocessing/build.gradle.in_docs.md)
...
# Documentation for `samples/android/tutorial-2-mixedprocessing/build.gradle.in`

## File Metadata

- **Full Path**: `samples/android/tutorial-2-mixedprocessing/build.gradle.in`
- **File Name**: `build.gradle.in`
- **File Size**: 2,208 bytes
- **File Type**: .in
- **Link to Source**: [samples/android/tutorial-2-mixedprocessing/build.gradle.in](../../../samples/android/tutorial-2-mixedprocessing/build.gradle.in)
