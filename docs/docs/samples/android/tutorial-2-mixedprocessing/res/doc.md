# Documentation for `docs/samples/android/tutorial-2-mixedprocessing/res/`
...
**Path**: `docs/samples/android/tutorial-2-mixedprocessing/res/`
**Direct Files**: 0
**Subfolders**: 3
...
- **drawable/** - See [drawable/doc.md](drawable/doc.md)
- **layout/** - See [layout/doc.md](layout/doc.md)
- **values/** - See [values/doc.md](values/doc.md)
...
- **Parent Folder**: [docs/samples/android/tutorial-2-mixedprocessing/](../tutorial-2-mixedprocessing/doc.md)
...
**Subfolders**:
- [drawable/](drawable/doc.md)
- [layout/](layout/doc.md)
- [values/](values/doc.md)
