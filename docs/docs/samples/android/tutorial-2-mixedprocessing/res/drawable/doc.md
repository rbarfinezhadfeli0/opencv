# Documentation for `docs/samples/android/tutorial-2-mixedprocessing/res/drawable/`
...
**Path**: `docs/samples/android/tutorial-2-mixedprocessing/res/drawable/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[icon.png_docs.md](icon.png_docs.md_docs.md)**: MD file
- **[icon.png_kw.md](icon.png_kw.md_docs.md)**: MD file
