# Documentation for `docs/samples/android/tutorial-2-mixedprocessing/res/values/`
...
**Path**: `docs/samples/android/tutorial-2-mixedprocessing/res/values/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[strings.xml_docs.md](strings.xml_docs.md_docs.md)**: MD file
- **[strings.xml_kw.md](strings.xml_kw.md_docs.md)**: MD file
