# Documentation for `docs/samples/android/tutorial-2-mixedprocessing/src/`
...
**Path**: `docs/samples/android/tutorial-2-mixedprocessing/src/`
**Direct Files**: 0
**Subfolders**: 1
