# Documentation for `docs/samples/android/tutorial-2-mixedprocessing/src/org/`
...
**Path**: `docs/samples/android/tutorial-2-mixedprocessing/src/org/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [docs/samples/android/tutorial-2-mixedprocessing/src/](../src/doc.md)
