# Documentation for `docs/samples/android/tutorial-3-cameracontrol/res/layout/`
...
**Path**: `docs/samples/android/tutorial-3-cameracontrol/res/layout/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[tutorial3_surface_view.xml_kw.md](tutorial3_surface_view.xml_kw.md_docs.md)**: MD file
- **[tutorial3_surface_view.xml_docs.md](tutorial3_surface_view.xml_docs.md_docs.md)**: MD file
...
- **Parent Folder**: [docs/samples/android/tutorial-3-cameracontrol/res/](../res/doc.md)
