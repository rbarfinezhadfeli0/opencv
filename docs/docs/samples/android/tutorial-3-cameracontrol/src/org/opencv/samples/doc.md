# Documentation for `docs/samples/android/tutorial-3-cameracontrol/src/org/opencv/samples/`
...
**Path**: `docs/samples/android/tutorial-3-cameracontrol/src/org/opencv/samples/`
**Direct Files**: 0
**Subfolders**: 1
...
- **tutorial3/** - See [tutorial3/doc.md](tutorial3/doc.md)
...
- **Parent Folder**: [docs/samples/android/tutorial-3-cameracontrol/src/org/opencv/](../opencv/doc.md)

**Subfolders**:
- [tutorial3/](tutorial3/doc.md)
