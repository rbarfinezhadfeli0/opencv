# Documentation for `docs/samples/android/tutorial-4-opencl/build.gradle.in_docs.md`

## File Metadata

- **Full Path**: `docs/samples/android/tutorial-4-opencl/build.gradle.in_docs.md`
- **File Name**: `build.gradle.in_docs.md`
- **File Size**: 3,000 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/android/tutorial-4-opencl/build.gradle.in_docs.md](../../../../docs/samples/android/tutorial-4-opencl/build.gradle.in_docs.md)
