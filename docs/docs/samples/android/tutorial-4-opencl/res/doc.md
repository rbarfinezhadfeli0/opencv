# Documentation for `docs/samples/android/tutorial-4-opencl/res/`
...
**Path**: `docs/samples/android/tutorial-4-opencl/res/`
**Direct Files**: 0
**Subfolders**: 3
...
- **Parent Folder**: [docs/samples/android/tutorial-4-opencl/](../tutorial-4-opencl/doc.md)
