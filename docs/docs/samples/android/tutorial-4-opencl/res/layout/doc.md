# Documentation for `docs/samples/android/tutorial-4-opencl/res/layout/`
...
**Path**: `docs/samples/android/tutorial-4-opencl/res/layout/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[activity.xml_docs.md](activity.xml_docs.md_docs.md)**: MD file
- **[activity.xml_kw.md](activity.xml_kw.md_docs.md)**: MD file
...
- **Parent Folder**: [docs/samples/android/tutorial-4-opencl/res/](../res/doc.md)
