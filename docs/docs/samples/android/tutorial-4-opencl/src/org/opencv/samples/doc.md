# Documentation for `docs/samples/android/tutorial-4-opencl/src/org/opencv/samples/`
...
**Path**: `docs/samples/android/tutorial-4-opencl/src/org/opencv/samples/`
**Direct Files**: 0
**Subfolders**: 1
...
- **tutorial4/** - See [tutorial4/doc.md](tutorial4/doc.md)
...
- **Parent Folder**: [docs/samples/android/tutorial-4-opencl/src/org/opencv/](../opencv/doc.md)

**Subfolders**:
- [tutorial4/](tutorial4/doc.md)
