# Documentation for `docs/samples/cpp/3calibration.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/3calibration.cpp_docs.md`
- **File Name**: `3calibration.cpp_docs.md`
- **File Size**: 15,410 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/3calibration.cpp_docs.md](../../../docs/samples/cpp/3calibration.cpp_docs.md)
...
# Documentation for `samples/cpp/3calibration.cpp`

## File Metadata

- **Full Path**: `samples/cpp/3calibration.cpp`
- **File Name**: `3calibration.cpp`
- **File Size**: 12,385 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/cpp/3calibration.cpp](../../samples/cpp/3calibration.cpp)
