# Documentation for `docs/samples/cpp/application_trace.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/application_trace.cpp_docs.md`
- **File Name**: `application_trace.cpp_docs.md`
- **File Size**: 5,734 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/application_trace.cpp_docs.md](../../../docs/samples/cpp/application_trace.cpp_docs.md)
