# Documentation for `docs/samples/cpp/aruco_dict_utils.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/aruco_dict_utils.cpp_docs.md`
- **File Name**: `aruco_dict_utils.cpp_docs.md`
- **File Size**: 17,384 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/aruco_dict_utils.cpp_docs.md](../../../docs/samples/cpp/aruco_dict_utils.cpp_docs.md)
...
# Documentation for `samples/cpp/aruco_dict_utils.cpp`

## File Metadata

- **Full Path**: `samples/cpp/aruco_dict_utils.cpp`
- **File Name**: `aruco_dict_utils.cpp`
- **File Size**: 14,448 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/cpp/aruco_dict_utils.cpp](../../samples/cpp/aruco_dict_utils.cpp)
