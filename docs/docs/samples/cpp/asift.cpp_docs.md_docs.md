# Documentation for `docs/samples/cpp/asift.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/asift.cpp_docs.md`
- **File Name**: `asift.cpp_docs.md`
- **File Size**: 9,548 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/asift.cpp_docs.md](../../../docs/samples/cpp/asift.cpp_docs.md)
