# Documentation for `docs/samples/cpp/audio_spectrogram.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/audio_spectrogram.cpp_docs.md`
- **File Name**: `audio_spectrogram.cpp_docs.md`
- **File Size**: 44,440 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/audio_spectrogram.cpp_docs.md](../../../docs/samples/cpp/audio_spectrogram.cpp_docs.md)
...
# Documentation for `samples/cpp/audio_spectrogram.cpp`

## File Metadata

- **Full Path**: `samples/cpp/audio_spectrogram.cpp`
- **File Name**: `audio_spectrogram.cpp`
- **File Size**: 41,216 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/cpp/audio_spectrogram.cpp](../../samples/cpp/audio_spectrogram.cpp)
