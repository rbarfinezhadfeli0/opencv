# Documentation for `docs/samples/cpp/calibration.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/calibration.cpp_docs.md`
- **File Name**: `calibration.cpp_docs.md`
- **File Size**: 32,983 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/calibration.cpp_docs.md](../../../docs/samples/cpp/calibration.cpp_docs.md)
...
# Documentation for `samples/cpp/calibration.cpp`

## File Metadata

- **Full Path**: `samples/cpp/calibration.cpp`
- **File Name**: `calibration.cpp`
- **File Size**: 29,721 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/cpp/calibration.cpp](../../samples/cpp/calibration.cpp)
