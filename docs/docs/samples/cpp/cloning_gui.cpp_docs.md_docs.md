# Documentation for `docs/samples/cpp/cloning_gui.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/cloning_gui.cpp_docs.md`
- **File Name**: `cloning_gui.cpp_docs.md`
- **File Size**: 17,726 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/cloning_gui.cpp_docs.md](../../../docs/samples/cpp/cloning_gui.cpp_docs.md)
...
# Documentation for `samples/cpp/cloning_gui.cpp`

## File Metadata

- **Full Path**: `samples/cpp/cloning_gui.cpp`
- **File Name**: `cloning_gui.cpp`
- **File Size**: 14,708 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/cpp/cloning_gui.cpp](../../samples/cpp/cloning_gui.cpp)
