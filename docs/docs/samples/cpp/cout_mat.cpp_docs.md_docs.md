# Documentation for `docs/samples/cpp/cout_mat.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/cout_mat.cpp_docs.md`
- **File Name**: `cout_mat.cpp_docs.md`
- **File Size**: 4,907 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/cout_mat.cpp_docs.md](../../../docs/samples/cpp/cout_mat.cpp_docs.md)
...
# Documentation for `samples/cpp/cout_mat.cpp`

## File Metadata

- **Full Path**: `samples/cpp/cout_mat.cpp`
- **File Name**: `cout_mat.cpp`
- **File Size**: 2,032 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/cpp/cout_mat.cpp](../../samples/cpp/cout_mat.cpp)
