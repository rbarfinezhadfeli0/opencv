# Documentation for `docs/samples/cpp/create_mask.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/create_mask.cpp_docs.md`
- **File Name**: `create_mask.cpp_docs.md`
- **File Size**: 5,691 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/create_mask.cpp_docs.md](../../../docs/samples/cpp/create_mask.cpp_docs.md)
