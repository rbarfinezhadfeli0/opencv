# Documentation for `docs/samples/cpp/dbt_face_detection.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/dbt_face_detection.cpp_docs.md`
- **File Name**: `dbt_face_detection.cpp_docs.md`
- **File Size**: 6,207 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/dbt_face_detection.cpp_docs.md](../../../docs/samples/cpp/dbt_face_detection.cpp_docs.md)
...
# Documentation for `samples/cpp/dbt_face_detection.cpp`

## File Metadata

- **Full Path**: `samples/cpp/dbt_face_detection.cpp`
- **File Name**: `dbt_face_detection.cpp`
- **File Size**: 3,031 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/cpp/dbt_face_detection.cpp](../../samples/cpp/dbt_face_detection.cpp)
