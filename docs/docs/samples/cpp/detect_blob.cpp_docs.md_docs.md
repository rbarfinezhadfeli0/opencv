# Documentation for `docs/samples/cpp/detect_blob.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/detect_blob.cpp_docs.md`
- **File Name**: `detect_blob.cpp_docs.md`
- **File Size**: 10,284 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/detect_blob.cpp_docs.md](../../../docs/samples/cpp/detect_blob.cpp_docs.md)
