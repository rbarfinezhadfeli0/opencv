# Documentation for `docs/samples/cpp/detect_mser.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/detect_mser.cpp_docs.md`
- **File Name**: `detect_mser.cpp_docs.md`
- **File Size**: 17,823 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/detect_mser.cpp_docs.md](../../../docs/samples/cpp/detect_mser.cpp_docs.md)
...
# Documentation for `samples/cpp/detect_mser.cpp`

## File Metadata

- **Full Path**: `samples/cpp/detect_mser.cpp`
- **File Name**: `detect_mser.cpp`
- **File Size**: 14,424 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/cpp/detect_mser.cpp](../../samples/cpp/detect_mser.cpp)
...
- **MSERParams**: A class/struct defined in this file
