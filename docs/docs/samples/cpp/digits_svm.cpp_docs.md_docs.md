# Documentation for `docs/samples/cpp/digits_svm.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/digits_svm.cpp_docs.md`
- **File Name**: `digits_svm.cpp_docs.md`
- **File Size**: 12,716 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/digits_svm.cpp_docs.md](../../../docs/samples/cpp/digits_svm.cpp_docs.md)
...
# Documentation for `samples/cpp/digits_svm.cpp`

## File Metadata

- **Full Path**: `samples/cpp/digits_svm.cpp`
- **File Name**: `digits_svm.cpp`
- **File Size**: 9,713 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/cpp/digits_svm.cpp](../../samples/cpp/digits_svm.cpp)
