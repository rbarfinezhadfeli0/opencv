# Documentation for `docs/samples/cpp/drawing.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/drawing.cpp_docs.md`
- **File Name**: `drawing.cpp_docs.md`
- **File Size**: 8,417 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/drawing.cpp_docs.md](../../../docs/samples/cpp/drawing.cpp_docs.md)
