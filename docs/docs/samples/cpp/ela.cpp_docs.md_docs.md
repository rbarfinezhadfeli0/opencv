# Documentation for `docs/samples/cpp/ela.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/ela.cpp_docs.md`
- **File Name**: `ela.cpp_docs.md`
- **File Size**: 4,984 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/ela.cpp_docs.md](../../../docs/samples/cpp/ela.cpp_docs.md)
