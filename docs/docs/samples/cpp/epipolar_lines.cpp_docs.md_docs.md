# Documentation for `docs/samples/cpp/epipolar_lines.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/epipolar_lines.cpp_docs.md`
- **File Name**: `epipolar_lines.cpp_docs.md`
- **File Size**: 7,616 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/epipolar_lines.cpp_docs.md](../../../docs/samples/cpp/epipolar_lines.cpp_docs.md)
...
# Documentation for `samples/cpp/epipolar_lines.cpp`

## File Metadata

- **Full Path**: `samples/cpp/epipolar_lines.cpp`
- **File Name**: `epipolar_lines.cpp`
- **File Size**: 4,614 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/cpp/epipolar_lines.cpp](../../samples/cpp/epipolar_lines.cpp)
