# Documentation for `docs/samples/cpp/example_cmake/CMakeLists.txt_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/example_cmake/CMakeLists.txt_docs.md`
- **File Name**: `CMakeLists.txt_docs.md`
- **File Size**: 1,949 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/example_cmake/CMakeLists.txt_docs.md](../../../../docs/samples/cpp/example_cmake/CMakeLists.txt_docs.md)
