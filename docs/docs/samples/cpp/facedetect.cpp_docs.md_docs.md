# Documentation for `docs/samples/cpp/facedetect.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/facedetect.cpp_docs.md`
- **File Name**: `facedetect.cpp_docs.md`
- **File Size**: 11,814 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/facedetect.cpp_docs.md](../../../docs/samples/cpp/facedetect.cpp_docs.md)
...
# Documentation for `samples/cpp/facedetect.cpp`

## File Metadata

- **Full Path**: `samples/cpp/facedetect.cpp`
- **File Name**: `facedetect.cpp`
- **File Size**: 8,745 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/cpp/facedetect.cpp](../../samples/cpp/facedetect.cpp)
