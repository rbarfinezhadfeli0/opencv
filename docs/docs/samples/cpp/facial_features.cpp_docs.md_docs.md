# Documentation for `docs/samples/cpp/facial_features.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/facial_features.cpp_docs.md`
- **File Name**: `facial_features.cpp_docs.md`
- **File Size**: 11,237 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/facial_features.cpp_docs.md](../../../docs/samples/cpp/facial_features.cpp_docs.md)
...
# Documentation for `samples/cpp/facial_features.cpp`

## File Metadata

- **Full Path**: `samples/cpp/facial_features.cpp`
- **File Name**: `facial_features.cpp`
- **File Size**: 8,238 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/cpp/facial_features.cpp](../../samples/cpp/facial_features.cpp)
