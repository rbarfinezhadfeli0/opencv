# Documentation for `docs/samples/cpp/image_alignment.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/image_alignment.cpp_docs.md`
- **File Name**: `image_alignment.cpp_docs.md`
- **File Size**: 16,610 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/image_alignment.cpp_docs.md](../../../docs/samples/cpp/image_alignment.cpp_docs.md)
...
# Documentation for `samples/cpp/image_alignment.cpp`

## File Metadata

- **Full Path**: `samples/cpp/image_alignment.cpp`
- **File Name**: `image_alignment.cpp`
- **File Size**: 13,519 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/cpp/image_alignment.cpp](../../samples/cpp/image_alignment.cpp)
