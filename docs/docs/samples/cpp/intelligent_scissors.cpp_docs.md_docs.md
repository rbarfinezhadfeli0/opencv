# Documentation for `docs/samples/cpp/intelligent_scissors.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/intelligent_scissors.cpp_docs.md`
- **File Name**: `intelligent_scissors.cpp_docs.md`
- **File Size**: 11,107 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/intelligent_scissors.cpp_docs.md](../../../docs/samples/cpp/intelligent_scissors.cpp_docs.md)
...
# Documentation for `samples/cpp/intelligent_scissors.cpp`

## File Metadata

- **Full Path**: `samples/cpp/intelligent_scissors.cpp`
- **File Name**: `intelligent_scissors.cpp`
- **File Size**: 7,931 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/cpp/intelligent_scissors.cpp](../../samples/cpp/intelligent_scissors.cpp)
...
- **Pix**: A class/struct defined in this file
- **Parameters**: A class/struct defined in this file
