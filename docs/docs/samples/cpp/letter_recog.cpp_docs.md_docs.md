# Documentation for `docs/samples/cpp/letter_recog.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/letter_recog.cpp_docs.md`
- **File Name**: `letter_recog.cpp_docs.md`
- **File Size**: 21,050 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/letter_recog.cpp_docs.md](../../../docs/samples/cpp/letter_recog.cpp_docs.md)
...
# Documentation for `samples/cpp/letter_recog.cpp`

## File Metadata

- **Full Path**: `samples/cpp/letter_recog.cpp`
- **File Name**: `letter_recog.cpp`
- **File Size**: 17,864 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/cpp/letter_recog.cpp](../../samples/cpp/letter_recog.cpp)
...
- **problems**: A class/struct defined in this file

### Functions and Methods

- **reads()**: A function/method defined in this file
