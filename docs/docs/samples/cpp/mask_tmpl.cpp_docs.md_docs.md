# Documentation for `docs/samples/cpp/mask_tmpl.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/mask_tmpl.cpp_docs.md`
- **File Name**: `mask_tmpl.cpp_docs.md`
- **File Size**: 5,100 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/mask_tmpl.cpp_docs.md](../../../docs/samples/cpp/mask_tmpl.cpp_docs.md)
