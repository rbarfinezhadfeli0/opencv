# Documentation for `docs/samples/cpp/matchmethod_orb_akaze_brisk.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/matchmethod_orb_akaze_brisk.cpp_docs.md`
- **File Name**: `matchmethod_orb_akaze_brisk.cpp_docs.md`
- **File Size**: 11,274 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/matchmethod_orb_akaze_brisk.cpp_docs.md](../../../docs/samples/cpp/matchmethod_orb_akaze_brisk.cpp_docs.md)
...
# Documentation for `samples/cpp/matchmethod_orb_akaze_brisk.cpp`

## File Metadata

- **Full Path**: `samples/cpp/matchmethod_orb_akaze_brisk.cpp`
- **File Name**: `matchmethod_orb_akaze_brisk.cpp`
- **File Size**: 8,218 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/cpp/matchmethod_orb_akaze_brisk.cpp](../../samples/cpp/matchmethod_orb_akaze_brisk.cpp)
