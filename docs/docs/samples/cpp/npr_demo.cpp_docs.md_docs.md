# Documentation for `docs/samples/cpp/npr_demo.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/npr_demo.cpp_docs.md`
- **File Name**: `npr_demo.cpp_docs.md`
- **File Size**: 5,341 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/npr_demo.cpp_docs.md](../../../docs/samples/cpp/npr_demo.cpp_docs.md)
