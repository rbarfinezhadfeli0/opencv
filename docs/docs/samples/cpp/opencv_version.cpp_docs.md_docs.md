# Documentation for `docs/samples/cpp/opencv_version.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/opencv_version.cpp_docs.md`
- **File Name**: `opencv_version.cpp_docs.md`
- **File Size**: 3,847 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/opencv_version.cpp_docs.md](../../../docs/samples/cpp/opencv_version.cpp_docs.md)
...
# Documentation for `samples/cpp/opencv_version.cpp`

## File Metadata

- **Full Path**: `samples/cpp/opencv_version.cpp`
- **File Name**: `opencv_version.cpp`
- **File Size**: 936 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/cpp/opencv_version.cpp](../../samples/cpp/opencv_version.cpp)
