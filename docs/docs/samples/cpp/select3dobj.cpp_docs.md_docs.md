# Documentation for `docs/samples/cpp/select3dobj.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/select3dobj.cpp_docs.md`
- **File Name**: `select3dobj.cpp_docs.md`
- **File Size**: 24,569 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/select3dobj.cpp_docs.md](../../../docs/samples/cpp/select3dobj.cpp_docs.md)
...
# Documentation for `samples/cpp/select3dobj.cpp`

## File Metadata

- **Full Path**: `samples/cpp/select3dobj.cpp`
- **File Name**: `select3dobj.cpp`
- **File Size**: 21,335 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/cpp/select3dobj.cpp](../../samples/cpp/select3dobj.cpp)
...
- **MouseEvent**: A class/struct defined in this file
