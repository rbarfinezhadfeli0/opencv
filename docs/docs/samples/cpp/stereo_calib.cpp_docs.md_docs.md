# Documentation for `docs/samples/cpp/stereo_calib.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/stereo_calib.cpp_docs.md`
- **File Name**: `stereo_calib.cpp_docs.md`
- **File Size**: 21,197 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/stereo_calib.cpp_docs.md](../../../docs/samples/cpp/stereo_calib.cpp_docs.md)
...
# Documentation for `samples/cpp/stereo_calib.cpp`

## File Metadata

- **Full Path**: `samples/cpp/stereo_calib.cpp`
- **File Name**: `stereo_calib.cpp`
- **File Size**: 18,066 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/cpp/stereo_calib.cpp](../../samples/cpp/stereo_calib.cpp)
