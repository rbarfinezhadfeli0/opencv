# Documentation for `docs/samples/cpp/stereo_match.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/stereo_match.cpp_docs.md`
- **File Name**: `stereo_match.cpp_docs.md`
- **File Size**: 13,875 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/stereo_match.cpp_docs.md](../../../docs/samples/cpp/stereo_match.cpp_docs.md)
...
# Documentation for `samples/cpp/stereo_match.cpp`

## File Metadata

- **Full Path**: `samples/cpp/stereo_match.cpp`
- **File Name**: `stereo_match.cpp`
- **File Size**: 10,854 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/cpp/stereo_match.cpp](../../samples/cpp/stereo_match.cpp)
