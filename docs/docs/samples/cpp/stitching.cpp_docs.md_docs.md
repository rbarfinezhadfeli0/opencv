# Documentation for `docs/samples/cpp/stitching.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/stitching.cpp_docs.md`
- **File Name**: `stitching.cpp_docs.md`
- **File Size**: 6,246 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/stitching.cpp_docs.md](../../../docs/samples/cpp/stitching.cpp_docs.md)
