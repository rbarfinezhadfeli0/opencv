# Documentation for `docs/samples/cpp/stitching_detailed.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/stitching_detailed.cpp_docs.md`
- **File Name**: `stitching_detailed.cpp_docs.md`
- **File Size**: 36,817 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/stitching_detailed.cpp_docs.md](../../../docs/samples/cpp/stitching_detailed.cpp_docs.md)
...
# Documentation for `samples/cpp/stitching_detailed.cpp`

## File Metadata

- **Full Path**: `samples/cpp/stitching_detailed.cpp`
- **File Name**: `stitching_detailed.cpp`
- **File Size**: 33,006 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/cpp/stitching_detailed.cpp](../../samples/cpp/stitching_detailed.cpp)
