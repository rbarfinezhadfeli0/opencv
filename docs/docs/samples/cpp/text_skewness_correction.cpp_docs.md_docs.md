# Documentation for `docs/samples/cpp/text_skewness_correction.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/text_skewness_correction.cpp_docs.md`
- **File Name**: `text_skewness_correction.cpp_docs.md`
- **File Size**: 5,422 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/text_skewness_correction.cpp_docs.md](../../../docs/samples/cpp/text_skewness_correction.cpp_docs.md)
