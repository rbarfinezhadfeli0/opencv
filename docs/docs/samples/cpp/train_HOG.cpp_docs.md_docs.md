# Documentation for `docs/samples/cpp/train_HOG.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/train_HOG.cpp_docs.md`
- **File Name**: `train_HOG.cpp_docs.md`
- **File Size**: 16,664 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/train_HOG.cpp_docs.md](../../../docs/samples/cpp/train_HOG.cpp_docs.md)
...
# Documentation for `samples/cpp/train_HOG.cpp`

## File Metadata

- **Full Path**: `samples/cpp/train_HOG.cpp`
- **File Name**: `train_HOG.cpp`
- **File Size**: 13,596 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/cpp/train_HOG.cpp](../../samples/cpp/train_HOG.cpp)
