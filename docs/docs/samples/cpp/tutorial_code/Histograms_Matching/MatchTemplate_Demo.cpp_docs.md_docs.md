# Documentation for `docs/samples/cpp/tutorial_code/Histograms_Matching/MatchTemplate_Demo.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/tutorial_code/Histograms_Matching/MatchTemplate_Demo.cpp_docs.md`
- **File Name**: `MatchTemplate_Demo.cpp_docs.md`
- **File Size**: 7,265 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/tutorial_code/Histograms_Matching/MatchTemplate_Demo.cpp_docs.md](../../../../../docs/samples/cpp/tutorial_code/Histograms_Matching/MatchTemplate_Demo.cpp_docs.md)
