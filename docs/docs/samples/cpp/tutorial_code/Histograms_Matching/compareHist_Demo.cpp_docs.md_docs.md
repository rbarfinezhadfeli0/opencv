# Documentation for `docs/samples/cpp/tutorial_code/Histograms_Matching/compareHist_Demo.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/tutorial_code/Histograms_Matching/compareHist_Demo.cpp_docs.md`
- **File Name**: `compareHist_Demo.cpp_docs.md`
- **File Size**: 7,112 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/tutorial_code/Histograms_Matching/compareHist_Demo.cpp_docs.md](../../../../../docs/samples/cpp/tutorial_code/Histograms_Matching/compareHist_Demo.cpp_docs.md)
