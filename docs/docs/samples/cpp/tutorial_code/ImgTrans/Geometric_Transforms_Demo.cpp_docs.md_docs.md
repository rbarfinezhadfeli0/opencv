# Documentation for `docs/samples/cpp/tutorial_code/ImgTrans/Geometric_Transforms_Demo.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/tutorial_code/ImgTrans/Geometric_Transforms_Demo.cpp_docs.md`
- **File Name**: `Geometric_Transforms_Demo.cpp_docs.md`
- **File Size**: 5,889 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/tutorial_code/ImgTrans/Geometric_Transforms_Demo.cpp_docs.md](../../../../../docs/samples/cpp/tutorial_code/ImgTrans/Geometric_Transforms_Demo.cpp_docs.md)
