# Documentation for `docs/samples/cpp/tutorial_code/ShapeDescriptors/pointPolygonTest_demo.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/tutorial_code/ShapeDescriptors/pointPolygonTest_demo.cpp_docs.md`
- **File Name**: `pointPolygonTest_demo.cpp_docs.md`
- **File Size**: 5,808 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/tutorial_code/ShapeDescriptors/pointPolygonTest_demo.cpp_docs.md](../../../../../docs/samples/cpp/tutorial_code/ShapeDescriptors/pointPolygonTest_demo.cpp_docs.md)
