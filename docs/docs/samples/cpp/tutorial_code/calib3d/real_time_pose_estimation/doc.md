# Documentation for `docs/samples/cpp/tutorial_code/calib3d/real_time_pose_estimation/`
...
**Path**: `docs/samples/cpp/tutorial_code/calib3d/real_time_pose_estimation/`
**Direct Files**: 2
**Subfolders**: 2
...
- **Parent Folder**: [docs/samples/cpp/tutorial_code/calib3d/](../calib3d/doc.md)
