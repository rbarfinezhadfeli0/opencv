# Documentation for `docs/samples/cpp/tutorial_code/calib3d/real_time_pose_estimation/src/Utils.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/tutorial_code/calib3d/real_time_pose_estimation/src/Utils.cpp_docs.md`
- **File Name**: `Utils.cpp_docs.md`
- **File Size**: 16,008 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/tutorial_code/calib3d/real_time_pose_estimation/src/Utils.cpp_docs.md](../../../../../../../docs/samples/cpp/tutorial_code/calib3d/real_time_pose_estimation/src/Utils.cpp_docs.md)
...
# Documentation for `samples/cpp/tutorial_code/calib3d/real_time_pose_estimation/src/Utils.cpp`

## File Metadata

- **Full Path**: `samples/cpp/tutorial_code/calib3d/real_time_pose_estimation/src/Utils.cpp`
- **File Name**: `Utils.cpp`
- **File Size**: 12,714 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/cpp/tutorial_code/calib3d/real_time_pose_estimation/src/Utils.cpp](../../../../../../samples/cpp/tutorial_code/calib3d/real_time_pose_estimation/src/Utils.cpp)
