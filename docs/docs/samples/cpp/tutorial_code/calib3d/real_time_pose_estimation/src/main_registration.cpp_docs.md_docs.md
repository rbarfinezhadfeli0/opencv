# Documentation for `docs/samples/cpp/tutorial_code/calib3d/real_time_pose_estimation/src/main_registration.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/tutorial_code/calib3d/real_time_pose_estimation/src/main_registration.cpp_docs.md`
- **File Name**: `main_registration.cpp_docs.md`
- **File Size**: 13,644 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/tutorial_code/calib3d/real_time_pose_estimation/src/main_registration.cpp_docs.md](../../../../../../../docs/samples/cpp/tutorial_code/calib3d/real_time_pose_estimation/src/main_registration.cpp_docs.md)
...
# Documentation for `samples/cpp/tutorial_code/calib3d/real_time_pose_estimation/src/main_registration.cpp`

## File Metadata

- **Full Path**: `samples/cpp/tutorial_code/calib3d/real_time_pose_estimation/src/main_registration.cpp`
- **File Name**: `main_registration.cpp`
- **File Size**: 10,280 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/cpp/tutorial_code/calib3d/real_time_pose_estimation/src/main_registration.cpp](../../../../../../samples/cpp/tutorial_code/calib3d/real_time_pose_estimation/src/main_registration.cpp)
