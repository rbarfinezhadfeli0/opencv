# Documentation for `docs/samples/cpp/tutorial_code/core/parallel_backend/example-openmp.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/tutorial_code/core/parallel_backend/example-openmp.cpp_docs.md`
- **File Name**: `example-openmp.cpp_docs.md`
- **File Size**: 4,507 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/tutorial_code/core/parallel_backend/example-openmp.cpp_docs.md](../../../../../../docs/samples/cpp/tutorial_code/core/parallel_backend/example-openmp.cpp_docs.md)
...
# Documentation for `samples/cpp/tutorial_code/core/parallel_backend/example-openmp.cpp`

## File Metadata

- **Full Path**: `samples/cpp/tutorial_code/core/parallel_backend/example-openmp.cpp`
- **File Name**: `example-openmp.cpp`
- **File Size**: 1,333 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/cpp/tutorial_code/core/parallel_backend/example-openmp.cpp](../../../../../samples/cpp/tutorial_code/core/parallel_backend/example-openmp.cpp)
