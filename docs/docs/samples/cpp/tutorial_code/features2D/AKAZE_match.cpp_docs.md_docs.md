# Documentation for `docs/samples/cpp/tutorial_code/features2D/AKAZE_match.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/tutorial_code/features2D/AKAZE_match.cpp_docs.md`
- **File Name**: `AKAZE_match.cpp_docs.md`
- **File Size**: 6,601 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/tutorial_code/features2D/AKAZE_match.cpp_docs.md](../../../../../docs/samples/cpp/tutorial_code/features2D/AKAZE_match.cpp_docs.md)

## Purpose and Role

This file is located in the `docs/samples/cpp/tutorial_code/features2D` directory and serves as part of the OpenCV library infrastructure.
