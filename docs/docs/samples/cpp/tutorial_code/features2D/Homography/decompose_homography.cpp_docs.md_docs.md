# Documentation for `docs/samples/cpp/tutorial_code/features2D/Homography/decompose_homography.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/tutorial_code/features2D/Homography/decompose_homography.cpp_docs.md`
- **File Name**: `decompose_homography.cpp_docs.md`
- **File Size**: 10,433 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/tutorial_code/features2D/Homography/decompose_homography.cpp_docs.md](../../../../../../docs/samples/cpp/tutorial_code/features2D/Homography/decompose_homography.cpp_docs.md)
...
# Documentation for `samples/cpp/tutorial_code/features2D/Homography/decompose_homography.cpp`

## File Metadata

- **Full Path**: `samples/cpp/tutorial_code/features2D/Homography/decompose_homography.cpp`
- **File Name**: `decompose_homography.cpp`
- **File Size**: 7,206 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/cpp/tutorial_code/features2D/Homography/decompose_homography.cpp](../../../../../samples/cpp/tutorial_code/features2D/Homography/decompose_homography.cpp)
