# Documentation for `docs/samples/cpp/tutorial_code/features2D/Homography/perspective_correction.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/tutorial_code/features2D/Homography/perspective_correction.cpp_docs.md`
- **File Name**: `perspective_correction.cpp_docs.md`
- **File Size**: 6,096 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/tutorial_code/features2D/Homography/perspective_correction.cpp_docs.md](../../../../../../docs/samples/cpp/tutorial_code/features2D/Homography/perspective_correction.cpp_docs.md)
