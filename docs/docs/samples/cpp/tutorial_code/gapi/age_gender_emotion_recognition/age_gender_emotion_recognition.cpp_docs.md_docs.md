# Documentation for `docs/samples/cpp/tutorial_code/gapi/age_gender_emotion_recognition/age_gender_emotion_recognition.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/tutorial_code/gapi/age_gender_emotion_recognition/age_gender_emotion_recognition.cpp_docs.md`
- **File Name**: `age_gender_emotion_recognition.cpp_docs.md`
- **File Size**: 21,455 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/tutorial_code/gapi/age_gender_emotion_recognition/age_gender_emotion_recognition.cpp_docs.md](../../../../../../docs/samples/cpp/tutorial_code/gapi/age_gender_emotion_recognition/age_gender_emotion_recognition.cpp_docs.md)

## Purpose and Role

This file is located in the `docs/samples/cpp/tutorial_code/gapi/age_gender_emotion_recognition` directory and serves as part of the OpenCV library infrastructure.

## Documentation Content

# Documentation for `samples/cpp/tutorial_code/gapi/age_gender_emotion_recognition/age_gender_emotion_recognition.cpp`

## File Metadata

- **Full Path**: `samples/cpp/tutorial_code/gapi/age_gender_emotion_recognition/age_gender_emotion_recognition.cpp`
- **File Name**: `age_gender_emotion_recognition.cpp`
- **File Size**: 17,644 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/cpp/tutorial_code/gapi/age_gender_emotion_recognition/age_gender_emotion_recognition.cpp](../../../../../samples/cpp/tutorial_code/gapi/age_gender_emotion_recognition/age_gender_emotion_recognition.cpp)

## Purpose and Role

This file is located in the `samples/cpp/tutorial_code/gapi/age_gender_emotion_recognition` directory and serves as part of the OpenCV library infrastructure.
...
- **Elapsed**: A class/struct defined in this file
- **to**: A class/struct defined in this file
- **Avg**: A class/struct defined in this file
