# Documentation for `docs/samples/cpp/tutorial_code/gapi/doc_snippets/api_ref_snippets.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/tutorial_code/gapi/doc_snippets/api_ref_snippets.cpp_docs.md`
- **File Name**: `api_ref_snippets.cpp_docs.md`
- **File Size**: 11,290 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/tutorial_code/gapi/doc_snippets/api_ref_snippets.cpp_docs.md](../../../../../../docs/samples/cpp/tutorial_code/gapi/doc_snippets/api_ref_snippets.cpp_docs.md)
