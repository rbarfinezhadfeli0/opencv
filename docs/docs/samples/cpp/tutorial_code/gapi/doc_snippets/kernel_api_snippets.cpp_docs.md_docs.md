# Documentation for `docs/samples/cpp/tutorial_code/gapi/doc_snippets/kernel_api_snippets.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/tutorial_code/gapi/doc_snippets/kernel_api_snippets.cpp_docs.md`
- **File Name**: `kernel_api_snippets.cpp_docs.md`
- **File Size**: 8,055 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/tutorial_code/gapi/doc_snippets/kernel_api_snippets.cpp_docs.md](../../../../../../docs/samples/cpp/tutorial_code/gapi/doc_snippets/kernel_api_snippets.cpp_docs.md)
