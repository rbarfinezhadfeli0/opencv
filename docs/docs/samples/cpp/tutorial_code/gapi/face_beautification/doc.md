# Documentation for `docs/samples/cpp/tutorial_code/gapi/face_beautification/`
...
**Path**: `docs/samples/cpp/tutorial_code/gapi/face_beautification/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[face_beautification.cpp_docs.md](face_beautification.cpp_docs.md_docs.md)**: MD file
- **[face_beautification.cpp_kw.md](face_beautification.cpp_kw.md_docs.md)**: MD file
