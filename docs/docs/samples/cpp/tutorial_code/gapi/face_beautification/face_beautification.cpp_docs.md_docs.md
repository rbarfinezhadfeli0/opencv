# Documentation for `docs/samples/cpp/tutorial_code/gapi/face_beautification/face_beautification.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/tutorial_code/gapi/face_beautification/face_beautification.cpp_docs.md`
- **File Name**: `face_beautification.cpp_docs.md`
- **File Size**: 41,058 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/tutorial_code/gapi/face_beautification/face_beautification.cpp_docs.md](../../../../../../docs/samples/cpp/tutorial_code/gapi/face_beautification/face_beautification.cpp_docs.md)

## Purpose and Role

This file is located in the `docs/samples/cpp/tutorial_code/gapi/face_beautification` directory and serves as part of the OpenCV library infrastructure.

## Documentation Content

# Documentation for `samples/cpp/tutorial_code/gapi/face_beautification/face_beautification.cpp`

## File Metadata

- **Full Path**: `samples/cpp/tutorial_code/gapi/face_beautification/face_beautification.cpp`
- **File Name**: `face_beautification.cpp`
- **File Size**: 37,266 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/cpp/tutorial_code/gapi/face_beautification/face_beautification.cpp](../../../../../samples/cpp/tutorial_code/gapi/face_beautification/face_beautification.cpp)

## Purpose and Role

This file is located in the `samples/cpp/tutorial_code/gapi/face_beautification` directory and serves as part of the OpenCV library infrastructure.
...
- **mask3C()**: A function/method defined in this file
- **approximates()**: A function/method defined in this file
