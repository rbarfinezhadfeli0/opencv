# Documentation for `docs/samples/cpp/tutorial_code/gapi/porting_anisotropic_image_segmentation/porting_anisotropic_image_segmentation_gapi.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/tutorial_code/gapi/porting_anisotropic_image_segmentation/porting_anisotropic_image_segmentation_gapi.cpp_docs.md`
- **File Name**: `porting_anisotropic_image_segmentation_gapi.cpp_docs.md`
- **File Size**: 7,262 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/tutorial_code/gapi/porting_anisotropic_image_segmentation/porting_anisotropic_image_segmentation_gapi.cpp_docs.md](../../../../../../docs/samples/cpp/tutorial_code/gapi/porting_anisotropic_image_segmentation/porting_anisotropic_image_segmentation_gapi.cpp_docs.md)
