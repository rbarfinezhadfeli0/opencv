# Documentation for `docs/samples/cpp/tutorial_code/gapi/porting_anisotropic_image_segmentation/porting_anisotropic_image_segmentation_gapi_fluid.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/tutorial_code/gapi/porting_anisotropic_image_segmentation/porting_anisotropic_image_segmentation_gapi_fluid.cpp_docs.md`
- **File Name**: `porting_anisotropic_image_segmentation_gapi_fluid.cpp_docs.md`
- **File Size**: 8,614 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/tutorial_code/gapi/porting_anisotropic_image_segmentation/porting_anisotropic_image_segmentation_gapi_fluid.cpp_docs.md](../../../../../../docs/samples/cpp/tutorial_code/gapi/porting_anisotropic_image_segmentation/porting_anisotropic_image_segmentation_gapi_fluid.cpp_docs.md)
...
# Documentation for `samples/cpp/tutorial_code/gapi/porting_anisotropic_image_segmentation/porting_anisotropic_image_segmentation_gapi_fluid.cpp`

## File Metadata

- **Full Path**: `samples/cpp/tutorial_code/gapi/porting_anisotropic_image_segmentation/porting_anisotropic_image_segmentation_gapi_fluid.cpp`
- **File Name**: `porting_anisotropic_image_segmentation_gapi_fluid.cpp`
- **File Size**: 4,860 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/cpp/tutorial_code/gapi/porting_anisotropic_image_segmentation/porting_anisotropic_image_segmentation_gapi_fluid.cpp](../../../../../samples/cpp/tutorial_code/gapi/porting_anisotropic_image_segmentation/porting_anisotropic_image_segmentation_gapi_fluid.cpp)
