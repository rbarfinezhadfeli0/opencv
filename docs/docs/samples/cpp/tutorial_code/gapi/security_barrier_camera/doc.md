# Documentation for `docs/samples/cpp/tutorial_code/gapi/security_barrier_camera/`
...
**Path**: `docs/samples/cpp/tutorial_code/gapi/security_barrier_camera/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[security_barrier_camera.cpp_kw.md](security_barrier_camera.cpp_kw.md_docs.md)**: MD file
- **[security_barrier_camera.cpp_docs.md](security_barrier_camera.cpp_docs.md_docs.md)**: MD file
