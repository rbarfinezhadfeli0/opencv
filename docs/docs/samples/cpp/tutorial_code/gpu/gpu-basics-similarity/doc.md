# Documentation for `docs/samples/cpp/tutorial_code/gpu/gpu-basics-similarity/`
...
**Path**: `docs/samples/cpp/tutorial_code/gpu/gpu-basics-similarity/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[gpu-basics-similarity.cpp_kw.md](gpu-basics-similarity.cpp_kw.md_docs.md)**: MD file
- **[gpu-basics-similarity.cpp_docs.md](gpu-basics-similarity.cpp_docs.md_docs.md)**: MD file
