# Documentation for `docs/samples/cpp/tutorial_code/gpu/gpu-basics-similarity/gpu-basics-similarity.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/tutorial_code/gpu/gpu-basics-similarity/gpu-basics-similarity.cpp_docs.md`
- **File Name**: `gpu-basics-similarity.cpp_docs.md`
- **File Size**: 18,784 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/tutorial_code/gpu/gpu-basics-similarity/gpu-basics-similarity.cpp_docs.md](../../../../../../docs/samples/cpp/tutorial_code/gpu/gpu-basics-similarity/gpu-basics-similarity.cpp_docs.md)
...
# Documentation for `samples/cpp/tutorial_code/gpu/gpu-basics-similarity/gpu-basics-similarity.cpp`

## File Metadata

- **Full Path**: `samples/cpp/tutorial_code/gpu/gpu-basics-similarity/gpu-basics-similarity.cpp`
- **File Name**: `gpu-basics-similarity.cpp`
- **File Size**: 15,316 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/cpp/tutorial_code/gpu/gpu-basics-similarity/gpu-basics-similarity.cpp](../../../../../samples/cpp/tutorial_code/gpu/gpu-basics-similarity/gpu-basics-similarity.cpp)

## Purpose and Role

This file is located in the `samples/cpp/tutorial_code/gpu/gpu-basics-similarity` directory and serves as part of the OpenCV library infrastructure.
...
- **BufferMSSIM**: A class/struct defined in this file
- **BufferPSNR**: A class/struct defined in this file
