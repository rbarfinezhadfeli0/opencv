# Documentation for `docs/samples/cpp/tutorial_code/gpu/gpu-thrust-interop/`
...
**Path**: `docs/samples/cpp/tutorial_code/gpu/gpu-thrust-interop/`
**Direct Files**: 6
**Subfolders**: 0
...
- **[main.cu_docs.md](main.cu_docs.md_docs.md)**: Main entry point
- **[main.cu_kw.md](main.cu_kw.md_docs.md)**: Main entry point
...
- **Parent Folder**: [docs/samples/cpp/tutorial_code/gpu/](../gpu/doc.md)
