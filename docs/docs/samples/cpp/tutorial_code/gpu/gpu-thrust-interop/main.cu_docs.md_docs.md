# Documentation for `docs/samples/cpp/tutorial_code/gpu/gpu-thrust-interop/main.cu_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/tutorial_code/gpu/gpu-thrust-interop/main.cu_docs.md`
- **File Name**: `main.cu_docs.md`
- **File Size**: 4,875 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/tutorial_code/gpu/gpu-thrust-interop/main.cu_docs.md](../../../../../../docs/samples/cpp/tutorial_code/gpu/gpu-thrust-interop/main.cu_docs.md)
...
# Documentation for `samples/cpp/tutorial_code/gpu/gpu-thrust-interop/main.cu`

## File Metadata

- **Full Path**: `samples/cpp/tutorial_code/gpu/gpu-thrust-interop/main.cu`
- **File Name**: `main.cu`
- **File Size**: 4,190 bytes
- **File Type**: .cu
- **Link to Source**: [samples/cpp/tutorial_code/gpu/gpu-thrust-interop/main.cu](../../../../../samples/cpp/tutorial_code/gpu/gpu-thrust-interop/main.cu)
