# Documentation for `docs/samples/cpp/tutorial_code/imgcodecs/GDAL_IO/`
...
**Path**: `docs/samples/cpp/tutorial_code/imgcodecs/GDAL_IO/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[gdal-image.cpp_kw.md](gdal-image.cpp_kw.md_docs.md)**: MD file
- **[gdal-image.cpp_docs.md](gdal-image.cpp_docs.md_docs.md)**: MD file
...
- **Parent Folder**: [docs/samples/cpp/tutorial_code/imgcodecs/](../imgcodecs/doc.md)
