# Documentation for `docs/samples/cpp/tutorial_code/introduction/display_image/`
...
**Path**: `docs/samples/cpp/tutorial_code/introduction/display_image/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[display_image.cpp_kw.md](display_image.cpp_kw.md_docs.md)**: MD file
- **[display_image.cpp_docs.md](display_image.cpp_docs.md_docs.md)**: MD file
