# Documentation for `docs/samples/cpp/tutorial_code/introduction/windows_visual_studio_opencv/`
...
**Path**: `docs/samples/cpp/tutorial_code/introduction/windows_visual_studio_opencv/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[introduction_windows_vs.cpp_docs.md](introduction_windows_vs.cpp_docs.md_docs.md)**: MD file
- **[introduction_windows_vs.cpp_kw.md](introduction_windows_vs.cpp_kw.md_docs.md)**: MD file
...
- **Parent Folder**: [docs/samples/cpp/tutorial_code/introduction/](../introduction/doc.md)
