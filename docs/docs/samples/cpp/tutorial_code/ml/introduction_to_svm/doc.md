# Documentation for `docs/samples/cpp/tutorial_code/ml/introduction_to_svm/`
...
**Path**: `docs/samples/cpp/tutorial_code/ml/introduction_to_svm/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[introduction_to_svm.cpp_kw.md](introduction_to_svm.cpp_kw.md_docs.md)**: MD file
- **[introduction_to_svm.cpp_docs.md](introduction_to_svm.cpp_docs.md_docs.md)**: MD file
...
- **Parent Folder**: [docs/samples/cpp/tutorial_code/ml/](../ml/doc.md)
