# Documentation for `docs/samples/cpp/tutorial_code/ml/non_linear_svms/non_linear_svms.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/tutorial_code/ml/non_linear_svms/non_linear_svms.cpp_docs.md`
- **File Name**: `non_linear_svms.cpp_docs.md`
- **File Size**: 8,730 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/tutorial_code/ml/non_linear_svms/non_linear_svms.cpp_docs.md](../../../../../../docs/samples/cpp/tutorial_code/ml/non_linear_svms/non_linear_svms.cpp_docs.md)
