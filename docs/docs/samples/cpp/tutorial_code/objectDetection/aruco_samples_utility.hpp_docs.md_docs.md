# Documentation for `docs/samples/cpp/tutorial_code/objectDetection/aruco_samples_utility.hpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/tutorial_code/objectDetection/aruco_samples_utility.hpp_docs.md`
- **File Name**: `aruco_samples_utility.hpp_docs.md`
- **File Size**: 6,718 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/tutorial_code/objectDetection/aruco_samples_utility.hpp_docs.md](../../../../../docs/samples/cpp/tutorial_code/objectDetection/aruco_samples_utility.hpp_docs.md)
