# Documentation for `docs/samples/cpp/tutorial_code/objectDetection/calibrate_camera_charuco.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/tutorial_code/objectDetection/calibrate_camera_charuco.cpp_docs.md`
- **File Name**: `calibrate_camera_charuco.cpp_docs.md`
- **File Size**: 10,861 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/tutorial_code/objectDetection/calibrate_camera_charuco.cpp_docs.md](../../../../../docs/samples/cpp/tutorial_code/objectDetection/calibrate_camera_charuco.cpp_docs.md)
...
# Documentation for `samples/cpp/tutorial_code/objectDetection/calibrate_camera_charuco.cpp`

## File Metadata

- **Full Path**: `samples/cpp/tutorial_code/objectDetection/calibrate_camera_charuco.cpp`
- **File Name**: `calibrate_camera_charuco.cpp`
- **File Size**: 7,564 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/cpp/tutorial_code/objectDetection/calibrate_camera_charuco.cpp](../../../../samples/cpp/tutorial_code/objectDetection/calibrate_camera_charuco.cpp)
