# Documentation for `docs/samples/cpp/tutorial_code/objectDetection/detect_board_charuco.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/tutorial_code/objectDetection/detect_board_charuco.cpp_docs.md`
- **File Name**: `detect_board_charuco.cpp_docs.md`
- **File Size**: 8,510 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/tutorial_code/objectDetection/detect_board_charuco.cpp_docs.md](../../../../../docs/samples/cpp/tutorial_code/objectDetection/detect_board_charuco.cpp_docs.md)
