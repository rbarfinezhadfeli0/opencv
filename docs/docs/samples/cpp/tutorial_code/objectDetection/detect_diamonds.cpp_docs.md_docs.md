# Documentation for `docs/samples/cpp/tutorial_code/objectDetection/detect_diamonds.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/tutorial_code/objectDetection/detect_diamonds.cpp_docs.md`
- **File Name**: `detect_diamonds.cpp_docs.md`
- **File Size**: 11,091 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/tutorial_code/objectDetection/detect_diamonds.cpp_docs.md](../../../../../docs/samples/cpp/tutorial_code/objectDetection/detect_diamonds.cpp_docs.md)
