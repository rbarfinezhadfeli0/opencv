# Documentation for `docs/samples/cpp/tutorial_code/objectDetection/tutorial_camera_params.yml_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/tutorial_code/objectDetection/tutorial_camera_params.yml_docs.md`
- **File Name**: `tutorial_camera_params.yml_docs.md`
- **File Size**: 1,443 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/tutorial_code/objectDetection/tutorial_camera_params.yml_docs.md](../../../../../docs/samples/cpp/tutorial_code/objectDetection/tutorial_camera_params.yml_docs.md)
