# Documentation for `docs/samples/cpp/tutorial_code/objectDetection/tutorial_dict.yml_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/tutorial_code/objectDetection/tutorial_dict.yml_docs.md`
- **File Name**: `tutorial_dict.yml_docs.md`
- **File Size**: 2,883 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/tutorial_code/objectDetection/tutorial_dict.yml_docs.md](../../../../../docs/samples/cpp/tutorial_code/objectDetection/tutorial_dict.yml_docs.md)
...
# Documentation for `samples/cpp/tutorial_code/objectDetection/tutorial_dict.yml`

## File Metadata

- **Full Path**: `samples/cpp/tutorial_code/objectDetection/tutorial_dict.yml`
- **File Name**: `tutorial_dict.yml`
- **File Size**: 1,777 bytes
- **File Type**: .yml
- **Link to Source**: [samples/cpp/tutorial_code/objectDetection/tutorial_dict.yml](../../../../samples/cpp/tutorial_code/objectDetection/tutorial_dict.yml)
