# Documentation for `docs/samples/cpp/tutorial_code/photo/decolorization/`
...
**Path**: `docs/samples/cpp/tutorial_code/photo/decolorization/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[decolor.cpp_kw.md](decolor.cpp_kw.md_docs.md)**: MD file
- **[decolor.cpp_docs.md](decolor.cpp_docs.md_docs.md)**: MD file
