# Documentation for `docs/samples/cpp/tutorial_code/photo/hdr_imaging/`
...
**Path**: `docs/samples/cpp/tutorial_code/photo/hdr_imaging/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[hdr_imaging.cpp_docs.md](hdr_imaging.cpp_docs.md_docs.md)**: MD file
- **[hdr_imaging.cpp_kw.md](hdr_imaging.cpp_kw.md_docs.md)**: MD file
