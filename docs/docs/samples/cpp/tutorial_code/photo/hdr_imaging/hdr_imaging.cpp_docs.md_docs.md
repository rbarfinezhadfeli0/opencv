# Documentation for `docs/samples/cpp/tutorial_code/photo/hdr_imaging/hdr_imaging.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/tutorial_code/photo/hdr_imaging/hdr_imaging.cpp_docs.md`
- **File Name**: `hdr_imaging.cpp_docs.md`
- **File Size**: 5,004 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/tutorial_code/photo/hdr_imaging/hdr_imaging.cpp_docs.md](../../../../../../docs/samples/cpp/tutorial_code/photo/hdr_imaging/hdr_imaging.cpp_docs.md)

## Purpose and Role

This file is located in the `docs/samples/cpp/tutorial_code/photo/hdr_imaging` directory and serves as part of the OpenCV library infrastructure.
