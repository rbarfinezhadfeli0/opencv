# Documentation for `docs/samples/cpp/tutorial_code/photo/non_photorealistic_rendering/`
...
**Path**: `docs/samples/cpp/tutorial_code/photo/non_photorealistic_rendering/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[npr_demo.cpp_docs.md](npr_demo.cpp_docs.md_docs.md)**: MD file
- **[npr_demo.cpp_kw.md](npr_demo.cpp_kw.md_docs.md)**: MD file
