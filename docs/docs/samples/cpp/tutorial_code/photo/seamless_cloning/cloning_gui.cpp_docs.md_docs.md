# Documentation for `docs/samples/cpp/tutorial_code/photo/seamless_cloning/cloning_gui.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/tutorial_code/photo/seamless_cloning/cloning_gui.cpp_docs.md`
- **File Name**: `cloning_gui.cpp_docs.md`
- **File Size**: 17,820 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/tutorial_code/photo/seamless_cloning/cloning_gui.cpp_docs.md](../../../../../../docs/samples/cpp/tutorial_code/photo/seamless_cloning/cloning_gui.cpp_docs.md)
...
# Documentation for `samples/cpp/tutorial_code/photo/seamless_cloning/cloning_gui.cpp`

## File Metadata

- **Full Path**: `samples/cpp/tutorial_code/photo/seamless_cloning/cloning_gui.cpp`
- **File Name**: `cloning_gui.cpp`
- **File Size**: 14,608 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/cpp/tutorial_code/photo/seamless_cloning/cloning_gui.cpp](../../../../../samples/cpp/tutorial_code/photo/seamless_cloning/cloning_gui.cpp)
