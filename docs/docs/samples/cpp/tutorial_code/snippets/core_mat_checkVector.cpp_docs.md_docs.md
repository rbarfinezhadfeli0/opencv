# Documentation for `docs/samples/cpp/tutorial_code/snippets/core_mat_checkVector.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/tutorial_code/snippets/core_mat_checkVector.cpp_docs.md`
- **File Name**: `core_mat_checkVector.cpp_docs.md`
- **File Size**: 4,264 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/tutorial_code/snippets/core_mat_checkVector.cpp_docs.md](../../../../../docs/samples/cpp/tutorial_code/snippets/core_mat_checkVector.cpp_docs.md)
