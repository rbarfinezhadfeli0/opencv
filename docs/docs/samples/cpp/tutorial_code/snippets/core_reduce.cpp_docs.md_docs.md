# Documentation for `docs/samples/cpp/tutorial_code/snippets/core_reduce.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/tutorial_code/snippets/core_reduce.cpp_docs.md`
- **File Name**: `core_reduce.cpp_docs.md`
- **File Size**: 5,190 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/tutorial_code/snippets/core_reduce.cpp_docs.md](../../../../../docs/samples/cpp/tutorial_code/snippets/core_reduce.cpp_docs.md)
