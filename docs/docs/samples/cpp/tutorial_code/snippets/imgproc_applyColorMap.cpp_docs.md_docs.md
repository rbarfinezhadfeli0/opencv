# Documentation for `docs/samples/cpp/tutorial_code/snippets/imgproc_applyColorMap.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/tutorial_code/snippets/imgproc_applyColorMap.cpp_docs.md`
- **File Name**: `imgproc_applyColorMap.cpp_docs.md`
- **File Size**: 4,023 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/tutorial_code/snippets/imgproc_applyColorMap.cpp_docs.md](../../../../../docs/samples/cpp/tutorial_code/snippets/imgproc_applyColorMap.cpp_docs.md)
