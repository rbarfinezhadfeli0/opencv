# Documentation for `docs/samples/cpp/tutorial_code/video/`
...
**Path**: `docs/samples/cpp/tutorial_code/video/`
**Direct Files**: 2
**Subfolders**: 2
...
- **[bg_sub.cpp_docs.md](bg_sub.cpp_docs.md_docs.md)**: MD file
- **[bg_sub.cpp_kw.md](bg_sub.cpp_kw.md_docs.md)**: MD file
