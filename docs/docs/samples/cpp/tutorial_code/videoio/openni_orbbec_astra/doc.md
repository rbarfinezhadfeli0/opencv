# Documentation for `docs/samples/cpp/tutorial_code/videoio/openni_orbbec_astra/`
...
**Path**: `docs/samples/cpp/tutorial_code/videoio/openni_orbbec_astra/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[openni_orbbec_astra.cpp_docs.md](openni_orbbec_astra.cpp_docs.md_docs.md)**: MD file
- **[openni_orbbec_astra.cpp_kw.md](openni_orbbec_astra.cpp_kw.md_docs.md)**: MD file
