# Documentation for `docs/samples/cpp/tutorial_code/xfeatures2D/LATCH_match.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/tutorial_code/xfeatures2D/LATCH_match.cpp_docs.md`
- **File Name**: `LATCH_match.cpp_docs.md`
- **File Size**: 7,135 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/tutorial_code/xfeatures2D/LATCH_match.cpp_docs.md](../../../../../docs/samples/cpp/tutorial_code/xfeatures2D/LATCH_match.cpp_docs.md)
