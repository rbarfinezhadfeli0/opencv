# Documentation for `docs/samples/cpp/videocapture_audio.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/videocapture_audio.cpp_docs.md`
- **File Name**: `videocapture_audio.cpp_docs.md`
- **File Size**: 4,741 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/videocapture_audio.cpp_docs.md](../../../docs/samples/cpp/videocapture_audio.cpp_docs.md)
...
# Documentation for `samples/cpp/videocapture_audio.cpp`

## File Metadata

- **Full Path**: `samples/cpp/videocapture_audio.cpp`
- **File Name**: `videocapture_audio.cpp`
- **File Size**: 1,768 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/cpp/videocapture_audio.cpp](../../samples/cpp/videocapture_audio.cpp)
