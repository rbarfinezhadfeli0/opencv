# Documentation for `docs/samples/cpp/videocapture_gstreamer_pipeline.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/videocapture_gstreamer_pipeline.cpp_docs.md`
- **File Name**: `videocapture_gstreamer_pipeline.cpp_docs.md`
- **File Size**: 15,913 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/videocapture_gstreamer_pipeline.cpp_docs.md](../../../docs/samples/cpp/videocapture_gstreamer_pipeline.cpp_docs.md)
