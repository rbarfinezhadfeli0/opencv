# Documentation for `docs/samples/cpp/videocapture_microphone.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/videocapture_microphone.cpp_docs.md`
- **File Name**: `videocapture_microphone.cpp_docs.md`
- **File Size**: 4,779 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/videocapture_microphone.cpp_docs.md](../../../docs/samples/cpp/videocapture_microphone.cpp_docs.md)
...
# Documentation for `samples/cpp/videocapture_microphone.cpp`

## File Metadata

- **Full Path**: `samples/cpp/videocapture_microphone.cpp`
- **File Name**: `videocapture_microphone.cpp`
- **File Size**: 1,781 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/cpp/videocapture_microphone.cpp](../../samples/cpp/videocapture_microphone.cpp)
