# Documentation for `docs/samples/cpp/videocapture_obsensor.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/videocapture_obsensor.cpp_docs.md`
- **File Name**: `videocapture_obsensor.cpp_docs.md`
- **File Size**: 8,617 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/videocapture_obsensor.cpp_docs.md](../../../docs/samples/cpp/videocapture_obsensor.cpp_docs.md)
