# Documentation for `docs/samples/cpp/videocapture_openni.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/videocapture_openni.cpp_docs.md`
- **File Name**: `videocapture_openni.cpp_docs.md`
- **File Size**: 13,863 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/videocapture_openni.cpp_docs.md](../../../docs/samples/cpp/videocapture_openni.cpp_docs.md)
...
# Documentation for `samples/cpp/videocapture_openni.cpp`

## File Metadata

- **Full Path**: `samples/cpp/videocapture_openni.cpp`
- **File Name**: `videocapture_openni.cpp`
- **File Size**: 10,819 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/cpp/videocapture_openni.cpp](../../samples/cpp/videocapture_openni.cpp)
