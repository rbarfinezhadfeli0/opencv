# Documentation for `docs/samples/cpp/videocapture_starter.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/videocapture_starter.cpp_docs.md`
- **File Name**: `videocapture_starter.cpp_docs.md`
- **File Size**: 6,249 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/videocapture_starter.cpp_docs.md](../../../docs/samples/cpp/videocapture_starter.cpp_docs.md)
