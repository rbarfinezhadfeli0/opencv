# Documentation for `docs/samples/cpp/videowriter_basic.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/videowriter_basic.cpp_docs.md`
- **File Name**: `videowriter_basic.cpp_docs.md`
- **File Size**: 5,012 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/videowriter_basic.cpp_docs.md](../../../docs/samples/cpp/videowriter_basic.cpp_docs.md)
