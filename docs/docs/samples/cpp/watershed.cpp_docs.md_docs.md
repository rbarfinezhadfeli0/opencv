# Documentation for `docs/samples/cpp/watershed.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/cpp/watershed.cpp_docs.md`
- **File Name**: `watershed.cpp_docs.md`
- **File Size**: 7,365 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/cpp/watershed.cpp_docs.md](../../../docs/samples/cpp/watershed.cpp_docs.md)
