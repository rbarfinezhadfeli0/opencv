# Documentation for `docs/samples/data/left_intrinsics.yml_docs.md`

## File Metadata

- **Full Path**: `docs/samples/data/left_intrinsics.yml_docs.md`
- **File Name**: `left_intrinsics.yml_docs.md`
- **File Size**: 4,152 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/data/left_intrinsics.yml_docs.md](../../../docs/samples/data/left_intrinsics.yml_docs.md)
...
# Documentation for `samples/data/left_intrinsics.yml`

## File Metadata

- **Full Path**: `samples/data/left_intrinsics.yml`
- **File Name**: `left_intrinsics.yml`
- **File Size**: 3,187 bytes
- **File Type**: .yml
- **Link to Source**: [samples/data/left_intrinsics.yml](../../samples/data/left_intrinsics.yml)
