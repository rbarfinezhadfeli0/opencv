# Documentation for `docs/samples/directx/CMakeLists.txt_docs.md`

## File Metadata

- **Full Path**: `docs/samples/directx/CMakeLists.txt_docs.md`
- **File Name**: `CMakeLists.txt_docs.md`
- **File Size**: 2,172 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/directx/CMakeLists.txt_docs.md](../../../docs/samples/directx/CMakeLists.txt_docs.md)
