# Documentation for `docs/samples/directx/d3d11_interop.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/directx/d3d11_interop.cpp_docs.md`
- **File Name**: `d3d11_interop.cpp_docs.md`
- **File Size**: 20,476 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/directx/d3d11_interop.cpp_docs.md](../../../docs/samples/directx/d3d11_interop.cpp_docs.md)
...
# Documentation for `samples/directx/d3d11_interop.cpp`

## File Metadata

- **Full Path**: `samples/directx/d3d11_interop.cpp`
- **File Name**: `d3d11_interop.cpp`
- **File Size**: 17,205 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/directx/d3d11_interop.cpp](../../samples/directx/d3d11_interop.cpp)
...
- **D3D11WinApp**: A class/struct defined in this file
