# Documentation for `docs/samples/directx/d3d9_interop.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/directx/d3d9_interop.cpp_docs.md`
- **File Name**: `d3d9_interop.cpp_docs.md`
- **File Size**: 12,137 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/directx/d3d9_interop.cpp_docs.md](../../../docs/samples/directx/d3d9_interop.cpp_docs.md)
...
# Documentation for `samples/directx/d3d9_interop.cpp`

## File Metadata

- **Full Path**: `samples/directx/d3d9_interop.cpp`
- **File Name**: `d3d9_interop.cpp`
- **File Size**: 8,884 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/directx/d3d9_interop.cpp](../../samples/directx/d3d9_interop.cpp)
...
- **D3D9WinApp**: A class/struct defined in this file
