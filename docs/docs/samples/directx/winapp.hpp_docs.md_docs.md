# Documentation for `docs/samples/directx/winapp.hpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/directx/winapp.hpp_docs.md`
- **File Name**: `winapp.hpp_docs.md`
- **File Size**: 6,594 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/directx/winapp.hpp_docs.md](../../../docs/samples/directx/winapp.hpp_docs.md)
