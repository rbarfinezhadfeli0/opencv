# Documentation for `docs/samples/dnn/classification.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/dnn/classification.cpp_docs.md`
- **File Name**: `classification.cpp_docs.md`
- **File Size**: 10,984 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/dnn/classification.cpp_docs.md](../../../docs/samples/dnn/classification.cpp_docs.md)
...
# Documentation for `samples/dnn/classification.cpp`

## File Metadata

- **Full Path**: `samples/dnn/classification.cpp`
- **File Name**: `classification.cpp`
- **File Size**: 7,874 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/dnn/classification.cpp](../../samples/dnn/classification.cpp)
