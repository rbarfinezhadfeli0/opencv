# Documentation for `docs/samples/dnn/common.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/dnn/common.py_docs.md`
- **File Name**: `common.py_docs.md`
- **File Size**: 8,417 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/dnn/common.py_docs.md](../../../docs/samples/dnn/common.py_docs.md)
