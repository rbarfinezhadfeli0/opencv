# Documentation for `docs/samples/dnn/custom_layers.hpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/dnn/custom_layers.hpp_docs.md`
- **File Name**: `custom_layers.hpp_docs.md`
- **File Size**: 14,208 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/dnn/custom_layers.hpp_docs.md](../../../docs/samples/dnn/custom_layers.hpp_docs.md)
...
# Documentation for `samples/dnn/custom_layers.hpp`

## File Metadata

- **Full Path**: `samples/dnn/custom_layers.hpp`
- **File Name**: `custom_layers.hpp`
- **File Size**: 10,854 bytes
- **File Type**: .hpp
- **Link to Source**: [samples/dnn/custom_layers.hpp](../../samples/dnn/custom_layers.hpp)
...
- **MyLayer**: A class/struct defined in this file
- **InterpLayer**: A class/struct defined in this file
- **ResizeBilinearLayer**: A class/struct defined in this file

### Functions and Methods

- **__OPENCV_SAMPLES_DNN_CUSTOM_LAYERS__()**: A function/method defined in this file
