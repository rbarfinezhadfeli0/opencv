# Documentation for `docs/samples/dnn/dnn_model_runner/dnn_conversion/common/abstract_model.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/dnn/dnn_model_runner/dnn_conversion/common/abstract_model.py_docs.md`
- **File Name**: `abstract_model.py_docs.md`
- **File Size**: 3,771 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/dnn/dnn_model_runner/dnn_conversion/common/abstract_model.py_docs.md](../../../../../../docs/samples/dnn/dnn_model_runner/dnn_conversion/common/abstract_model.py_docs.md)
