# Documentation for `docs/samples/dnn/dnn_model_runner/dnn_conversion/common/evaluation/classification/`
...
**Path**: `docs/samples/dnn/dnn_model_runner/dnn_conversion/common/evaluation/classification/`
**Direct Files**: 4
**Subfolders**: 0
...
- **[cls_accuracy_evaluator.py_kw.md](cls_accuracy_evaluator.py_kw.md_docs.md)**: MD file
- **[cls_accuracy_evaluator.py_docs.md](cls_accuracy_evaluator.py_docs.md_docs.md)**: MD file
- **[cls_data_fetcher.py_kw.md](cls_data_fetcher.py_kw.md_docs.md)**: MD file
- **[cls_data_fetcher.py_docs.md](cls_data_fetcher.py_docs.md_docs.md)**: MD file
...
- **Parent Folder**: [docs/samples/dnn/dnn_model_runner/dnn_conversion/common/evaluation/](../evaluation/doc.md)
