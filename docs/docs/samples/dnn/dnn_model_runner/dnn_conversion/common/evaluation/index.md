# Index of `docs/samples/dnn/dnn_model_runner/dnn_conversion/common/evaluation/`

## Overview

This folder is part of the OpenCV repository structure and contains and other repository content.

**Location**: `docs/samples/dnn/dnn_model_runner/dnn_conversion/common/evaluation`
...
- **[classification/](classification/index.md)**: Subfolder containing 4 files
