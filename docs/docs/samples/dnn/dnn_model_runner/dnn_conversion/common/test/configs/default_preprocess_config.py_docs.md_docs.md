# Documentation for `docs/samples/dnn/dnn_model_runner/dnn_conversion/common/test/configs/default_preprocess_config.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/dnn/dnn_model_runner/dnn_conversion/common/test/configs/default_preprocess_config.py_docs.md`
- **File Name**: `default_preprocess_config.py_docs.md`
- **File Size**: 3,978 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/dnn/dnn_model_runner/dnn_conversion/common/test/configs/default_preprocess_config.py_docs.md](../../../../../../../../docs/samples/dnn/dnn_model_runner/dnn_conversion/common/test/configs/default_preprocess_config.py_docs.md)
