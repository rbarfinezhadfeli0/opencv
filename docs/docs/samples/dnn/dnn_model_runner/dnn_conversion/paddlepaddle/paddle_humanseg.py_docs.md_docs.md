# Documentation for `docs/samples/dnn/dnn_model_runner/dnn_conversion/paddlepaddle/paddle_humanseg.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/dnn/dnn_model_runner/dnn_conversion/paddlepaddle/paddle_humanseg.py_docs.md`
- **File Name**: `paddle_humanseg.py_docs.md`
- **File Size**: 6,853 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/dnn/dnn_model_runner/dnn_conversion/paddlepaddle/paddle_humanseg.py_docs.md](../../../../../../docs/samples/dnn/dnn_model_runner/dnn_conversion/paddlepaddle/paddle_humanseg.py_docs.md)
