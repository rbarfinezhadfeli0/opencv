# Documentation for `docs/samples/dnn/dnn_model_runner/dnn_conversion/pytorch/`
...
**Path**: `docs/samples/dnn/dnn_model_runner/dnn_conversion/pytorch/`
**Direct Files**: 2
**Subfolders**: 1
...
- **[pytorch_model.py_kw.md](pytorch_model.py_kw.md_docs.md)**: MD file
- **[pytorch_model.py_docs.md](pytorch_model.py_docs.md_docs.md)**: MD file
...
- **classification/** - See [classification/doc.md](classification/doc.md)
...
- **Parent Folder**: [docs/samples/dnn/dnn_model_runner/dnn_conversion/](../dnn_conversion/doc.md)

**Sibling Folders**:
- [common/](../common/doc.md)
- [paddlepaddle/](../paddlepaddle/doc.md)
- [tf/](../tf/doc.md)

**Subfolders**:
- [classification/](classification/doc.md)
