# Documentation for `docs/samples/dnn/dnn_model_runner/dnn_conversion/tf/detection/`
...
**Path**: `docs/samples/dnn/dnn_model_runner/dnn_conversion/tf/detection/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[py_to_py_ssd_mobilenet.py_kw.md](py_to_py_ssd_mobilenet.py_kw.md_docs.md)**: MD file
- **[py_to_py_ssd_mobilenet.py_docs.md](py_to_py_ssd_mobilenet.py_docs.md_docs.md)**: MD file
