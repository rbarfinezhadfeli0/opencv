# Documentation for `docs/samples/dnn/dnn_model_runner/dnn_conversion/tf/`
...
**Path**: `docs/samples/dnn/dnn_model_runner/dnn_conversion/tf/`
**Direct Files**: 2
**Subfolders**: 2
...
- **[tf_model.py_kw.md](tf_model.py_kw.md_docs.md)**: MD file
- **[tf_model.py_docs.md](tf_model.py_docs.md_docs.md)**: MD file
...
- **detection/** - See [detection/doc.md](detection/doc.md)
...
- [pytorch/](../pytorch/doc.md)

**Subfolders**:
- [classification/](classification/doc.md)
- [detection/](detection/doc.md)
