# Documentation for `docs/samples/dnn/download_models.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/dnn/download_models.py_docs.md`
- **File Name**: `download_models.py_docs.md`
- **File Size**: 18,671 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/dnn/download_models.py_docs.md](../../../docs/samples/dnn/download_models.py_docs.md)
...
# Documentation for `samples/dnn/download_models.py`

## File Metadata

- **Full Path**: `samples/dnn/download_models.py`
- **File Name**: `download_models.py`
- **File Size**: 14,056 bytes
- **File Type**: .py
- **Link to Source**: [samples/dnn/download_models.py](../../samples/dnn/download_models.py)
...
- **DownloadInstance**: A class/struct defined in this file
- **GDriveLoader**: A class/struct defined in this file
- **HashMismatchException**: A class/struct defined in this file
- **URLLoader**: A class/struct defined in this file
- **Loader**: A class/struct defined in this file

### Functions and Methods

- **isArchive()**: A function/method defined in this file
- **parseMetalinkFile()**: A function/method defined in this file
- **cv2()**: A function/method defined in this file
- **load()**: A function/method defined in this file
- **printRequest()**: A function/method defined in this file
- **extract()**: A function/method defined in this file
- **downloadFile()**: A function/method defined in this file
...
- **produceDownloadInstance()**: A function/method defined in this file
- **get_confirm_token()**: A function/method defined in this file
- **get()**: A function/method defined in this file
- **getHashsumFromFile()**: A function/method defined in this file
- **getMB()**: A function/method defined in this file
- **checkHashsum()**: A function/method defined in this file
- **parseYAMLFile()**: A function/method defined in this file
- **download()**: A function/method defined in this file
- **getSaveDir()**: A function/method defined in this file
