# Documentation for `docs/samples/dnn/edge_detection.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/dnn/edge_detection.py_docs.md`
- **File Name**: `edge_detection.py_docs.md`
- **File Size**: 5,867 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/dnn/edge_detection.py_docs.md](../../../docs/samples/dnn/edge_detection.py_docs.md)
