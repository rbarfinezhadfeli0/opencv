# Documentation for `docs/samples/dnn/face_detect.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/dnn/face_detect.py_docs.md`
- **File Name**: `face_detect.py_docs.md`
- **File Size**: 10,009 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/dnn/face_detect.py_docs.md](../../../docs/samples/dnn/face_detect.py_docs.md)
...
# Documentation for `samples/dnn/face_detect.py`

## File Metadata

- **Full Path**: `samples/dnn/face_detect.py`
- **File Name**: `face_detect.py`
- **File Size**: 7,021 bytes
- **File Type**: .py
- **Link to Source**: [samples/dnn/face_detect.py](../../samples/dnn/face_detect.py)
...
- **str2bool()**: A function/method defined in this file
