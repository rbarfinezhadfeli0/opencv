# Documentation for `docs/samples/dnn/face_detector/deploy.prototxt_docs.md`

## File Metadata

- **Full Path**: `docs/samples/dnn/face_detector/deploy.prototxt_docs.md`
- **File Name**: `deploy.prototxt_docs.md`
- **File Size**: 28,715 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/dnn/face_detector/deploy.prototxt_docs.md](../../../../docs/samples/dnn/face_detector/deploy.prototxt_docs.md)
...
# Documentation for `samples/dnn/face_detector/deploy.prototxt`

## File Metadata

- **Full Path**: `samples/dnn/face_detector/deploy.prototxt`
- **File Name**: `deploy.prototxt`
- **File Size**: 28,104 bytes
- **File Type**: .prototxt
- **Link to Source**: [samples/dnn/face_detector/deploy.prototxt](../../../samples/dnn/face_detector/deploy.prototxt)
