# Documentation for `docs/samples/dnn/face_detector/deploy_lowres.prototxt_docs.md`

## File Metadata

- **Full Path**: `docs/samples/dnn/face_detector/deploy_lowres.prototxt_docs.md`
- **File Name**: `deploy_lowres.prototxt_docs.md`
- **File Size**: 29,205 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/dnn/face_detector/deploy_lowres.prototxt_docs.md](../../../../docs/samples/dnn/face_detector/deploy_lowres.prototxt_docs.md)
...
# Documentation for `samples/dnn/face_detector/deploy_lowres.prototxt`

## File Metadata

- **Full Path**: `samples/dnn/face_detector/deploy_lowres.prototxt`
- **File Name**: `deploy_lowres.prototxt`
- **File Size**: 28,559 bytes
- **File Type**: .prototxt
- **Link to Source**: [samples/dnn/face_detector/deploy_lowres.prototxt](../../../samples/dnn/face_detector/deploy_lowres.prototxt)
