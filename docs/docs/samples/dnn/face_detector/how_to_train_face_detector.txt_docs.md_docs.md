# Documentation for `docs/samples/dnn/face_detector/how_to_train_face_detector.txt_docs.md`

## File Metadata

- **Full Path**: `docs/samples/dnn/face_detector/how_to_train_face_detector.txt_docs.md`
- **File Name**: `how_to_train_face_detector.txt_docs.md`
- **File Size**: 4,728 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/dnn/face_detector/how_to_train_face_detector.txt_docs.md](../../../../docs/samples/dnn/face_detector/how_to_train_face_detector.txt_docs.md)
...
# Documentation for `samples/dnn/face_detector/how_to_train_face_detector.txt`

## File Metadata

- **Full Path**: `samples/dnn/face_detector/how_to_train_face_detector.txt`
- **File Name**: `how_to_train_face_detector.txt`
- **File Size**: 3,640 bytes
- **File Type**: .txt
- **Link to Source**: [samples/dnn/face_detector/how_to_train_face_detector.txt](../../../samples/dnn/face_detector/how_to_train_face_detector.txt)
