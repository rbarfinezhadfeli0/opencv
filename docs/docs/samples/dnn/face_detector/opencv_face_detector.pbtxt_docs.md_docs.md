# Documentation for `docs/samples/dnn/face_detector/opencv_face_detector.pbtxt_docs.md`

## File Metadata

- **Full Path**: `docs/samples/dnn/face_detector/opencv_face_detector.pbtxt_docs.md`
- **File Name**: `opencv_face_detector.pbtxt_docs.md`
- **File Size**: 35,638 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/dnn/face_detector/opencv_face_detector.pbtxt_docs.md](../../../../docs/samples/dnn/face_detector/opencv_face_detector.pbtxt_docs.md)
...
# Documentation for `samples/dnn/face_detector/opencv_face_detector.pbtxt`

## File Metadata

- **Full Path**: `samples/dnn/face_detector/opencv_face_detector.pbtxt`
- **File Name**: `opencv_face_detector.pbtxt`
- **File Size**: 34,975 bytes
- **File Type**: .pbtxt
- **Link to Source**: [samples/dnn/face_detector/opencv_face_detector.pbtxt](../../../samples/dnn/face_detector/opencv_face_detector.pbtxt)
