# Documentation for `docs/samples/dnn/face_detector/test.prototxt_docs.md`

## File Metadata

- **Full Path**: `docs/samples/dnn/face_detector/test.prototxt_docs.md`
- **File Name**: `test.prototxt_docs.md`
- **File Size**: 29,455 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/dnn/face_detector/test.prototxt_docs.md](../../../../docs/samples/dnn/face_detector/test.prototxt_docs.md)
...
# Documentation for `samples/dnn/face_detector/test.prototxt`

## File Metadata

- **Full Path**: `samples/dnn/face_detector/test.prototxt`
- **File Name**: `test.prototxt`
- **File Size**: 28,854 bytes
- **File Type**: .prototxt
- **Link to Source**: [samples/dnn/face_detector/test.prototxt](../../../samples/dnn/face_detector/test.prototxt)
