# Documentation for `docs/samples/dnn/face_detector/train.prototxt_docs.md`

## File Metadata

- **Full Path**: `docs/samples/dnn/face_detector/train.prototxt_docs.md`
- **File Name**: `train.prototxt_docs.md`
- **File Size**: 31,110 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/dnn/face_detector/train.prototxt_docs.md](../../../../docs/samples/dnn/face_detector/train.prototxt_docs.md)
...
# Documentation for `samples/dnn/face_detector/train.prototxt`

## File Metadata

- **Full Path**: `samples/dnn/face_detector/train.prototxt`
- **File Name**: `train.prototxt`
- **File Size**: 30,504 bytes
- **File Type**: .prototxt
- **Link to Source**: [samples/dnn/face_detector/train.prototxt](../../../samples/dnn/face_detector/train.prototxt)
