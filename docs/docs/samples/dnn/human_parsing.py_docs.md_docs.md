# Documentation for `docs/samples/dnn/human_parsing.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/dnn/human_parsing.py_docs.md`
- **File Name**: `human_parsing.py_docs.md`
- **File Size**: 11,237 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/dnn/human_parsing.py_docs.md](../../../docs/samples/dnn/human_parsing.py_docs.md)
...
# Documentation for `samples/dnn/human_parsing.py`

## File Metadata

- **Full Path**: `samples/dnn/human_parsing.py`
- **File Name**: `human_parsing.py`
- **File Size**: 7,997 bytes
- **File Type**: .py
- **Link to Source**: [samples/dnn/human_parsing.py](../../samples/dnn/human_parsing.py)
...
- **decode_labels()**: A function/method defined in this file
- **parse_human()**: A function/method defined in this file
