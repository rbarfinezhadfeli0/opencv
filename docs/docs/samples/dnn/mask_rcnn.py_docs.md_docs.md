# Documentation for `docs/samples/dnn/mask_rcnn.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/dnn/mask_rcnn.py_docs.md`
- **File Name**: `mask_rcnn.py_docs.md`
- **File Size**: 8,277 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/dnn/mask_rcnn.py_docs.md](../../../docs/samples/dnn/mask_rcnn.py_docs.md)
