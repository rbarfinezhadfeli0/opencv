# Documentation for `docs/samples/dnn/mobilenet_ssd_accuracy.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/dnn/mobilenet_ssd_accuracy.py_docs.md`
- **File Name**: `mobilenet_ssd_accuracy.py_docs.md`
- **File Size**: 8,158 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/dnn/mobilenet_ssd_accuracy.py_docs.md](../../../docs/samples/dnn/mobilenet_ssd_accuracy.py_docs.md)
