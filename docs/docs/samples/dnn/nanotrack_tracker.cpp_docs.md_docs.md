# Documentation for `docs/samples/dnn/nanotrack_tracker.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/dnn/nanotrack_tracker.cpp_docs.md`
- **File Name**: `nanotrack_tracker.cpp_docs.md`
- **File Size**: 9,111 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/dnn/nanotrack_tracker.cpp_docs.md](../../../docs/samples/dnn/nanotrack_tracker.cpp_docs.md)
...
# Documentation for `samples/dnn/nanotrack_tracker.cpp`

## File Metadata

- **Full Path**: `samples/dnn/nanotrack_tracker.cpp`
- **File Name**: `nanotrack_tracker.cpp`
- **File Size**: 6,070 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/dnn/nanotrack_tracker.cpp](../../samples/dnn/nanotrack_tracker.cpp)
