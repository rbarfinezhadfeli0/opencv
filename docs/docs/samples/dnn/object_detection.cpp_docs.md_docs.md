# Documentation for `docs/samples/dnn/object_detection.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/dnn/object_detection.cpp_docs.md`
- **File Name**: `object_detection.cpp_docs.md`
- **File Size**: 19,888 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/dnn/object_detection.cpp_docs.md](../../../docs/samples/dnn/object_detection.cpp_docs.md)
...
# Documentation for `samples/dnn/object_detection.cpp`

## File Metadata

- **Full Path**: `samples/dnn/object_detection.cpp`
- **File Name**: `object_detection.cpp`
- **File Size**: 16,611 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/dnn/object_detection.cpp](../../samples/dnn/object_detection.cpp)
...
- **USE_THREADS()**: A function/method defined in this file
