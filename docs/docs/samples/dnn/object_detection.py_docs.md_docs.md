# Documentation for `docs/samples/dnn/object_detection.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/dnn/object_detection.py_docs.md`
- **File Name**: `object_detection.py_docs.md`
- **File Size**: 17,418 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/dnn/object_detection.py_docs.md](../../../docs/samples/dnn/object_detection.py_docs.md)
...
# Documentation for `samples/dnn/object_detection.py`

## File Metadata

- **Full Path**: `samples/dnn/object_detection.py`
- **File Name**: `object_detection.py`
- **File Size**: 13,721 bytes
- **File Type**: .py
- **Link to Source**: [samples/dnn/object_detection.py](../../samples/dnn/object_detection.py)
...
- **QueueFPS**: A class/struct defined in this file

### Functions and Methods

- **put()**: A function/method defined in this file
- **framesThreadBody()**: A function/method defined in this file
- **getFPS()**: A function/method defined in this file
- **callback()**: A function/method defined in this file
- **drawPred()**: A function/method defined in this file
- **processingThreadBody()**: A function/method defined in this file
- **postprocess()**: A function/method defined in this file
...
- `argparse`
- `Queue`
- `tf_text_graph_faster_rcnn`
- `queue`
- `createFasterRCNNGraph`
