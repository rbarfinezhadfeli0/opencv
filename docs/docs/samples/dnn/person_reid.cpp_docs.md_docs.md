# Documentation for `docs/samples/dnn/person_reid.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/dnn/person_reid.cpp_docs.md`
- **File Name**: `person_reid.cpp_docs.md`
- **File Size**: 11,603 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/dnn/person_reid.cpp_docs.md](../../../docs/samples/dnn/person_reid.cpp_docs.md)
...
# Documentation for `samples/dnn/person_reid.cpp`

## File Metadata

- **Full Path**: `samples/dnn/person_reid.cpp`
- **File Name**: `person_reid.cpp`
- **File Size**: 8,654 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/dnn/person_reid.cpp](../../samples/dnn/person_reid.cpp)
