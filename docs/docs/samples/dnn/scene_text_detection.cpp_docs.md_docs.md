# Documentation for `docs/samples/dnn/scene_text_detection.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/dnn/scene_text_detection.cpp_docs.md`
- **File Name**: `scene_text_detection.cpp_docs.md`
- **File Size**: 9,453 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/dnn/scene_text_detection.cpp_docs.md](../../../docs/samples/dnn/scene_text_detection.cpp_docs.md)
...
# Documentation for `samples/dnn/scene_text_detection.cpp`

## File Metadata

- **Full Path**: `samples/dnn/scene_text_detection.cpp`
- **File Name**: `scene_text_detection.cpp`
- **File Size**: 6,428 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/dnn/scene_text_detection.cpp](../../samples/dnn/scene_text_detection.cpp)
