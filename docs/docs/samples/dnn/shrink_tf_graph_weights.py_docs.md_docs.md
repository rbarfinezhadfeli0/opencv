# Documentation for `docs/samples/dnn/shrink_tf_graph_weights.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/dnn/shrink_tf_graph_weights.py_docs.md`
- **File Name**: `shrink_tf_graph_weights.py_docs.md`
- **File Size**: 5,320 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/dnn/shrink_tf_graph_weights.py_docs.md](../../../docs/samples/dnn/shrink_tf_graph_weights.py_docs.md)
