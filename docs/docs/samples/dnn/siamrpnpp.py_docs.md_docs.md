# Documentation for `docs/samples/dnn/siamrpnpp.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/dnn/siamrpnpp.py_docs.md`
- **File Name**: `siamrpnpp.py_docs.md`
- **File Size**: 20,743 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/dnn/siamrpnpp.py_docs.md](../../../docs/samples/dnn/siamrpnpp.py_docs.md)
...
# Documentation for `samples/dnn/siamrpnpp.py`

## File Metadata

- **Full Path**: `samples/dnn/siamrpnpp.py`
- **File Name**: `siamrpnpp.py`
- **File Size**: 16,686 bytes
- **File Type**: .py
- **Link to Source**: [samples/dnn/siamrpnpp.py](../../samples/dnn/siamrpnpp.py)
...
- **Anchors**: A class/struct defined in this file
- **generates**: A class/struct defined in this file
- **generate**: A class/struct defined in this file
- **SiamRPNTracker**: A class/struct defined in this file
- **ModelBuilder**: A class/struct defined in this file

### Functions and Methods

- **track()**: A function/method defined in this file
- **_convert_score()**: A function/method defined in this file
- **change()**: A function/method defined in this file
- **generate_anchor()**: A function/method defined in this file
- **sz()**: A function/method defined in this file
- **get_frames()**: A function/method defined in this file
- **main()**: A function/method defined in this file
- **generate_anchors()**: A function/method defined in this file
- **_convert_bbox()**: A function/method defined in this file
- **init()**: A function/method defined in this file
- **_softmax()**: A function/method defined in this file
- **_bbox_clip()**: A function/method defined in this file
- **get_subwindow()**: A function/method defined in this file
