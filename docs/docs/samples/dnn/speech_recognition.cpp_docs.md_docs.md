# Documentation for `docs/samples/dnn/speech_recognition.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/dnn/speech_recognition.cpp_docs.md`
- **File Name**: `speech_recognition.cpp_docs.md`
- **File Size**: 23,230 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/dnn/speech_recognition.cpp_docs.md](../../../docs/samples/dnn/speech_recognition.cpp_docs.md)
...
# Documentation for `samples/dnn/speech_recognition.cpp`

## File Metadata

- **Full Path**: `samples/dnn/speech_recognition.cpp`
- **File Name**: `speech_recognition.cpp`
- **File Size**: 19,853 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/dnn/speech_recognition.cpp](../../samples/dnn/speech_recognition.cpp)
