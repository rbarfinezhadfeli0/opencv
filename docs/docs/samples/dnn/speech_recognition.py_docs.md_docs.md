# Documentation for `docs/samples/dnn/speech_recognition.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/dnn/speech_recognition.py_docs.md`
- **File Name**: `speech_recognition.py_docs.md`
- **File Size**: 27,342 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/dnn/speech_recognition.py_docs.md](../../../docs/samples/dnn/speech_recognition.py_docs.md)
...
# Documentation for `samples/dnn/speech_recognition.py`

## File Metadata

- **Full Path**: `samples/dnn/speech_recognition.py`
- **File Name**: `speech_recognition.py`
- **File Size**: 23,208 bytes
- **File Type**: .py
- **Link to Source**: [samples/dnn/speech_recognition.py](../../samples/dnn/speech_recognition.py)
...
- **Decoder**: A class/struct defined in this file
- **FilterbankFeatures**: A class/struct defined in this file

### Functions and Methods

- **pad_window_center()**: A function/method defined in this file
- **frame()**: A function/method defined in this file
- **predict()**: A function/method defined in this file
- **readAudioMicrophone()**: A function/method defined in this file
- **pad_mode()**: A function/method defined in this file
- **stft()**: A function/method defined in this file
- **calculate_features()**: A function/method defined in this file
- **decode()**: A function/method defined in this file
- **normalize_batch()**: A function/method defined in this file
- **mel_frequencies()**: A function/method defined in this file
- **dtype_r2c()**: A function/method defined in this file
- **mel_to_hz()**: A function/method defined in this file
- **hz_to_mel()**: A function/method defined in this file
- **mel()**: A function/method defined in this file
- **readAudioFile()**: A function/method defined in this file
