# Documentation for `docs/samples/dnn/text_detection.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/dnn/text_detection.cpp_docs.md`
- **File Name**: `text_detection.cpp_docs.md`
- **File Size**: 9,903 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/dnn/text_detection.cpp_docs.md](../../../docs/samples/dnn/text_detection.cpp_docs.md)
...
# Documentation for `samples/dnn/text_detection.cpp`

## File Metadata

- **Full Path**: `samples/dnn/text_detection.cpp`
- **File Name**: `text_detection.cpp`
- **File Size**: 6,861 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/dnn/text_detection.cpp](../../samples/dnn/text_detection.cpp)
