# Documentation for `docs/samples/dnn/text_detection.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/dnn/text_detection.py_docs.md`
- **File Name**: `text_detection.py_docs.md`
- **File Size**: 12,610 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/dnn/text_detection.py_docs.md](../../../docs/samples/dnn/text_detection.py_docs.md)
...
# Documentation for `samples/dnn/text_detection.py`

## File Metadata

- **Full Path**: `samples/dnn/text_detection.py`
- **File Name**: `text_detection.py`
- **File Size**: 9,341 bytes
- **File Type**: .py
- **Link to Source**: [samples/dnn/text_detection.py](../../samples/dnn/text_detection.py)
...
- **decodeBoundingBoxes()**: A function/method defined in this file
- **fourPointsTransform()**: A function/method defined in this file
- **decodeText()**: A function/method defined in this file
