# Documentation for `docs/samples/dnn/tf_text_graph_common.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/dnn/tf_text_graph_common.py_docs.md`
- **File Name**: `tf_text_graph_common.py_docs.md`
- **File Size**: 14,234 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/dnn/tf_text_graph_common.py_docs.md](../../../docs/samples/dnn/tf_text_graph_common.py_docs.md)
