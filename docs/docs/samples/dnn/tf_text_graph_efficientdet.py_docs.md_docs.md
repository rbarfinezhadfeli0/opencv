# Documentation for `docs/samples/dnn/tf_text_graph_efficientdet.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/dnn/tf_text_graph_efficientdet.py_docs.md`
- **File Name**: `tf_text_graph_efficientdet.py_docs.md`
- **File Size**: 12,699 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/dnn/tf_text_graph_efficientdet.py_docs.md](../../../docs/samples/dnn/tf_text_graph_efficientdet.py_docs.md)
...
# Documentation for `samples/dnn/tf_text_graph_efficientdet.py`

## File Metadata

- **Full Path**: `samples/dnn/tf_text_graph_efficientdet.py`
- **File Name**: `tf_text_graph_efficientdet.py`
- **File Size**: 9,239 bytes
- **File Type**: .py
- **Link to Source**: [samples/dnn/tf_text_graph_efficientdet.py](../../samples/dnn/tf_text_graph_efficientdet.py)
...
- **AnchorGenerator**: A class/struct defined in this file

### Functions and Methods

- **createGraph()**: A function/method defined in this file
