# Documentation for `docs/samples/dnn/tf_text_graph_faster_rcnn.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/dnn/tf_text_graph_faster_rcnn.py_docs.md`
- **File Name**: `tf_text_graph_faster_rcnn.py_docs.md`
- **File Size**: 15,861 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/dnn/tf_text_graph_faster_rcnn.py_docs.md](../../../docs/samples/dnn/tf_text_graph_faster_rcnn.py_docs.md)
...
# Documentation for `samples/dnn/tf_text_graph_faster_rcnn.py`

## File Metadata

- **Full Path**: `samples/dnn/tf_text_graph_faster_rcnn.py`
- **File Name**: `tf_text_graph_faster_rcnn.py`
- **File Size**: 12,689 bytes
- **File Type**: .py
- **Link to Source**: [samples/dnn/tf_text_graph_faster_rcnn.py](../../samples/dnn/tf_text_graph_faster_rcnn.py)
...
- **createFasterRCNNGraph()**: A function/method defined in this file
