# Documentation for `docs/samples/dnn/tf_text_graph_ssd.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/dnn/tf_text_graph_ssd.py_docs.md`
- **File Name**: `tf_text_graph_ssd.py_docs.md`
- **File Size**: 21,913 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/dnn/tf_text_graph_ssd.py_docs.md](../../../docs/samples/dnn/tf_text_graph_ssd.py_docs.md)
...
# Documentation for `samples/dnn/tf_text_graph_ssd.py`

## File Metadata

- **Full Path**: `samples/dnn/tf_text_graph_ssd.py`
- **File Name**: `tf_text_graph_ssd.py`
- **File Size**: 18,314 bytes
- **File Type**: .py
- **Link to Source**: [samples/dnn/tf_text_graph_ssd.py](../../samples/dnn/tf_text_graph_ssd.py)
...
- **MultiscaleAnchorGenerator**: A class/struct defined in this file
- **SSDAnchorGenerator**: A class/struct defined in this file

### Functions and Methods

- **get()**: A function/method defined in this file
- **checkSubgraph()**: A function/method defined in this file
- **to_remove()**: A function/method defined in this file
- **createSSDGraph()**: A function/method defined in this file
- **getUnconnectedNodes()**: A function/method defined in this file
- **addConcatNode()**: A function/method defined in this file
- **fuse_nodes()**: A function/method defined in this file
