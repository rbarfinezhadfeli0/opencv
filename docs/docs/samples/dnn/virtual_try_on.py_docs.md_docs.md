# Documentation for `docs/samples/dnn/virtual_try_on.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/dnn/virtual_try_on.py_docs.md`
- **File Name**: `virtual_try_on.py_docs.md`
- **File Size**: 24,996 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/dnn/virtual_try_on.py_docs.md](../../../docs/samples/dnn/virtual_try_on.py_docs.md)
...
# Documentation for `samples/dnn/virtual_try_on.py`

## File Metadata

- **Full Path**: `samples/dnn/virtual_try_on.py`
- **File Name**: `virtual_try_on.py`
- **File Size**: 20,727 bytes
- **File Type**: .py
- **Link to Source**: [samples/dnn/virtual_try_on.py](../../samples/dnn/virtual_try_on.py)
...
- **BilinearFilter**: A class/struct defined in this file
- **CorrelationLayer**: A class/struct defined in this file
- **CpVton**: A class/struct defined in this file

### Functions and Methods

- **_resample_horizontal()**: A function/method defined in this file
- **_generate_grid()**: A function/method defined in this file
- **__init__()**: A function/method defined in this file
- **_prepare_to_transform()**: A function/method defined in this file
- **_expand_torch()**: A function/method defined in this file
- **getMemoryShapes()**: A function/method defined in this file
- **forward()**: A function/method defined in this file
- **_resample_vertical()**: A function/method defined in this file
- **_apply_transformation()**: A function/method defined in this file
- **get_warped_cloth()**: A function/method defined in this file
- **_bilinear_sampler()**: A function/method defined in this file
- **prepare_agnostic()**: A function/method defined in this file
- **_compute_L_inverse()**: A function/method defined in this file
- **_precompute_coeffs()**: A function/method defined in this file
- **get_pose_map()**: A function/method defined in this file
- **get_tryon()**: A function/method defined in this file
- **imaging_resample()**: A function/method defined in this file
