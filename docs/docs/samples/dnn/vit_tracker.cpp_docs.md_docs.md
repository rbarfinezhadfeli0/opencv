# Documentation for `docs/samples/dnn/vit_tracker.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/dnn/vit_tracker.cpp_docs.md`
- **File Name**: `vit_tracker.cpp_docs.md`
- **File Size**: 8,996 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/dnn/vit_tracker.cpp_docs.md](../../../docs/samples/dnn/vit_tracker.cpp_docs.md)
