# Documentation for `docs/samples/dnn/yolo_detector.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/dnn/yolo_detector.cpp_docs.md`
- **File Name**: `yolo_detector.cpp_docs.md`
- **File Size**: 16,179 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/dnn/yolo_detector.cpp_docs.md](../../../docs/samples/dnn/yolo_detector.cpp_docs.md)
