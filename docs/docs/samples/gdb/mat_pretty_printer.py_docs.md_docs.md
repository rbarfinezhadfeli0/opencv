# Documentation for `docs/samples/gdb/mat_pretty_printer.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/gdb/mat_pretty_printer.py_docs.md`
- **File Name**: `mat_pretty_printer.py_docs.md`
- **File Size**: 10,370 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/gdb/mat_pretty_printer.py_docs.md](../../../docs/samples/gdb/mat_pretty_printer.py_docs.md)
...
# Documentation for `samples/gdb/mat_pretty_printer.py`

## File Metadata

- **Full Path**: `samples/gdb/mat_pretty_printer.py`
- **File Name**: `mat_pretty_printer.py`
- **File Size**: 5,910 bytes
- **File Type**: .py
- **Link to Source**: [samples/gdb/mat_pretty_printer.py](../../samples/gdb/mat_pretty_printer.py)
...
- **MagicMasks**: A class/struct defined in this file
- **Depth**: A class/struct defined in this file
- **Flags**: A class/struct defined in this file
- **Size**: A class/struct defined in this file
- **MatPrinter**: A class/struct defined in this file
- **MagicValues**: A class/struct defined in this file

### Functions and Methods

- **__iter__()**: A function/method defined in this file
- **views()**: A function/method defined in this file
- **is_submatrix()**: A function/method defined in this file
- **get_type()**: A function/method defined in this file
- **to_numpy()**: A function/method defined in this file
- **stri()**: A function/method defined in this file
- **mat_printer()**: A function/method defined in this file
- **booli()**: A function/method defined in this file
- **real()**: A function/method defined in this file
- **__init__()**: A function/method defined in this file
- **is_continuous()**: A function/method defined in this file
- **dtype()**: A function/method defined in this file
- **children()**: A function/method defined in this file
- **depth()**: A function/method defined in this file
- **make_type()**: A function/method defined in this file
- **type()**: A function/method defined in this file
- **create_enum()**: A function/method defined in this file
- **channels()**: A function/method defined in this file
- **dims()**: A function/method defined in this file
- **conv()**: A function/method defined in this file
