# Documentation for `docs/samples/gpu/CMakeLists.txt_docs.md`

## File Metadata

- **Full Path**: `docs/samples/gpu/CMakeLists.txt_docs.md`
- **File Name**: `CMakeLists.txt_docs.md`
- **File Size**: 2,683 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/gpu/CMakeLists.txt_docs.md](../../../docs/samples/gpu/CMakeLists.txt_docs.md)
...
# Documentation for `samples/gpu/CMakeLists.txt`

## File Metadata

- **Full Path**: `samples/gpu/CMakeLists.txt`
- **File Name**: `CMakeLists.txt`
- **File Size**: 1,748 bytes
- **File Type**: .txt
- **Link to Source**: [samples/gpu/CMakeLists.txt](../../samples/gpu/CMakeLists.txt)
