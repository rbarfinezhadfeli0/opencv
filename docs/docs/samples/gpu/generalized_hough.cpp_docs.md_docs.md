# Documentation for `docs/samples/gpu/generalized_hough.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/gpu/generalized_hough.cpp_docs.md`
- **File Name**: `generalized_hough.cpp_docs.md`
- **File Size**: 8,814 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/gpu/generalized_hough.cpp_docs.md](../../../docs/samples/gpu/generalized_hough.cpp_docs.md)
