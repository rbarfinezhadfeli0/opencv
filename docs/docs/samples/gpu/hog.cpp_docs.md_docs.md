# Documentation for `docs/samples/gpu/hog.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/gpu/hog.cpp_docs.md`
- **File Name**: `hog.cpp_docs.md`
- **File Size**: 20,671 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/gpu/hog.cpp_docs.md](../../../docs/samples/gpu/hog.cpp_docs.md)
...
# Documentation for `samples/gpu/hog.cpp`

## File Metadata

- **Full Path**: `samples/gpu/hog.cpp`
- **File Name**: `hog.cpp`
- **File Size**: 17,482 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/gpu/hog.cpp](../../samples/gpu/hog.cpp)
...
- **Args**: A class/struct defined in this file
