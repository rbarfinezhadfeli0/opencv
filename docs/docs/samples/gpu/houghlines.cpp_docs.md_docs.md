# Documentation for `docs/samples/gpu/houghlines.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/gpu/houghlines.cpp_docs.md`
- **File Name**: `houghlines.cpp_docs.md`
- **File Size**: 5,495 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/gpu/houghlines.cpp_docs.md](../../../docs/samples/gpu/houghlines.cpp_docs.md)
