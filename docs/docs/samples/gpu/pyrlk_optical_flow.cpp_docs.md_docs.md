# Documentation for `docs/samples/gpu/pyrlk_optical_flow.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/gpu/pyrlk_optical_flow.cpp_docs.md`
- **File Name**: `pyrlk_optical_flow.cpp_docs.md`
- **File Size**: 12,715 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/gpu/pyrlk_optical_flow.cpp_docs.md](../../../docs/samples/gpu/pyrlk_optical_flow.cpp_docs.md)
...
# Documentation for `samples/gpu/pyrlk_optical_flow.cpp`

## File Metadata

- **Full Path**: `samples/gpu/pyrlk_optical_flow.cpp`
- **File Name**: `pyrlk_optical_flow.cpp`
- **File Size**: 9,597 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/gpu/pyrlk_optical_flow.cpp](../../samples/gpu/pyrlk_optical_flow.cpp)
