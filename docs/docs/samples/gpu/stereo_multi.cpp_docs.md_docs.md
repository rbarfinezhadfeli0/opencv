# Documentation for `docs/samples/gpu/stereo_multi.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/gpu/stereo_multi.cpp_docs.md`
- **File Name**: `stereo_multi.cpp_docs.md`
- **File Size**: 18,186 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/gpu/stereo_multi.cpp_docs.md](../../../docs/samples/gpu/stereo_multi.cpp_docs.md)
...
# Documentation for `samples/gpu/stereo_multi.cpp`

## File Metadata

- **Full Path**: `samples/gpu/stereo_multi.cpp`
- **File Name**: `stereo_multi.cpp`
- **File Size**: 14,566 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/gpu/stereo_multi.cpp](../../samples/gpu/stereo_multi.cpp)
...
- **StereoLaunchData**: A class/struct defined in this file
- **StereoMultiGpuStream**: A class/struct defined in this file
- **Thread**: A class/struct defined in this file
- **UserData**: A class/struct defined in this file
- **StereoSingleGpu**: A class/struct defined in this file
- **StereoMultiGpuThread**: A class/struct defined in this file

### Functions and Methods

- **_WIN32()**: A function/method defined in this file
- **name()**: A function/method defined in this file
- **0()**: A function/method defined in this file
