# Documentation for `docs/samples/gpu/video_reader.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/gpu/video_reader.cpp_docs.md`
- **File Name**: `video_reader.cpp_docs.md`
- **File Size**: 4,492 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/gpu/video_reader.cpp_docs.md](../../../docs/samples/gpu/video_reader.cpp_docs.md)
