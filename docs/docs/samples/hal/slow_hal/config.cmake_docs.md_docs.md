# Documentation for `docs/samples/hal/slow_hal/config.cmake_docs.md`

## File Metadata

- **Full Path**: `docs/samples/hal/slow_hal/config.cmake_docs.md`
- **File Name**: `config.cmake_docs.md`
- **File Size**: 1,208 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/hal/slow_hal/config.cmake_docs.md](../../../../docs/samples/hal/slow_hal/config.cmake_docs.md)
...
# Documentation for `samples/hal/slow_hal/config.cmake`

## File Metadata

- **Full Path**: `samples/hal/slow_hal/config.cmake`
- **File Name**: `config.cmake`
- **File Size**: 235 bytes
- **File Type**: .cmake
- **Link to Source**: [samples/hal/slow_hal/config.cmake](../../../samples/hal/slow_hal/config.cmake)
