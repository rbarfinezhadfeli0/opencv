# Documentation for `docs/samples/java/ant/src/`
...
**Path**: `docs/samples/java/ant/src/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[SimpleSample.java_docs.md](SimpleSample.java_docs.md_docs.md)**: MD file
- **[SimpleSample.java_kw.md](SimpleSample.java_kw.md_docs.md)**: MD file
...
- **Parent Folder**: [docs/samples/java/ant/](../ant/doc.md)
