# Documentation for `docs/samples/java/clojure/`
...
**Path**: `docs/samples/java/clojure/`
**Direct Files**: 0
**Subfolders**: 1
...
- **simple-sample/** - See [simple-sample/doc.md](simple-sample/doc.md)
...
**Subfolders**:
- [simple-sample/](simple-sample/doc.md)
