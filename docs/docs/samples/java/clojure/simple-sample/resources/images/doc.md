# Documentation for `docs/samples/java/clojure/simple-sample/resources/images/`
...
**Path**: `docs/samples/java/clojure/simple-sample/resources/images/`
**Direct Files**: 2
**Subfolders**: 0
...
- **Parent Folder**: [docs/samples/java/clojure/simple-sample/resources/](../resources/doc.md)
