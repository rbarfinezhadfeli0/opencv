# Documentation for `docs/samples/java/clojure/simple-sample/src/simple_sample/core.clj_docs.md`

## File Metadata

- **Full Path**: `docs/samples/java/clojure/simple-sample/src/simple_sample/core.clj_docs.md`
- **File Name**: `core.clj_docs.md`
- **File Size**: 1,339 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/java/clojure/simple-sample/src/simple_sample/core.clj_docs.md](../../../../../../../docs/samples/java/clojure/simple-sample/src/simple_sample/core.clj_docs.md)
