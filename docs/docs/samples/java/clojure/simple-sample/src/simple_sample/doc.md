# Documentation for `docs/samples/java/clojure/simple-sample/src/simple_sample/`
...
**Path**: `docs/samples/java/clojure/simple-sample/src/simple_sample/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[core.clj_docs.md](core.clj_docs.md_docs.md)**: MD file
- **[core.clj_kw.md](core.clj_kw.md_docs.md)**: MD file
...
- **Parent Folder**: [docs/samples/java/clojure/simple-sample/src/](../src/doc.md)
