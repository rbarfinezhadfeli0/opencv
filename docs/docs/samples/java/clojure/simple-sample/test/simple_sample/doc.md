# Documentation for `docs/samples/java/clojure/simple-sample/test/simple_sample/`
...
**Path**: `docs/samples/java/clojure/simple-sample/test/simple_sample/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[core_test.clj_docs.md](core_test.clj_docs.md_docs.md)**: MD file
- **[core_test.clj_kw.md](core_test.clj_kw.md_docs.md)**: MD file
...
- **Parent Folder**: [docs/samples/java/clojure/simple-sample/test/](../test/doc.md)
