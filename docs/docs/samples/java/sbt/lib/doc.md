# Documentation for `docs/samples/java/sbt/lib/`
...
**Path**: `docs/samples/java/sbt/lib/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[copy_opencv_jar_here_docs.md](copy_opencv_jar_here_docs.md_docs.md)**: MD file
- **[copy_opencv_jar_here_kw.md](copy_opencv_jar_here_kw.md_docs.md)**: MD file
