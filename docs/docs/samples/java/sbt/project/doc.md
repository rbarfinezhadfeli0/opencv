# Documentation for `docs/samples/java/sbt/project/`
...
**Path**: `docs/samples/java/sbt/project/`
**Direct Files**: 4
**Subfolders**: 0
...
- **[plugins.sbt_docs.md](plugins.sbt_docs.md_docs.md)**: MD file
- **[build.scala_kw.md](build.scala_kw.md_docs.md)**: MD file
- **[build.scala_docs.md](build.scala_docs.md_docs.md)**: MD file
- **[plugins.sbt_kw.md](plugins.sbt_kw.md_docs.md)**: MD file
...
- **Parent Folder**: [docs/samples/java/sbt/](../sbt/doc.md)
