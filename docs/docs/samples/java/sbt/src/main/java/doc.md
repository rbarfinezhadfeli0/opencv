# Documentation for `docs/samples/java/sbt/src/main/java/`
...
**Path**: `docs/samples/java/sbt/src/main/java/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[DetectFaceDemo.java_docs.md](DetectFaceDemo.java_docs.md_docs.md)**: MD file
- **[DetectFaceDemo.java_kw.md](DetectFaceDemo.java_kw.md_docs.md)**: MD file
...
- **Parent Folder**: [docs/samples/java/sbt/src/main/](../main/doc.md)
