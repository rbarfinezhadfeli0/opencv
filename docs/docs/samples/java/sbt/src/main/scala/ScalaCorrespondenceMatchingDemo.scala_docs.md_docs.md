# Documentation for `docs/samples/java/sbt/src/main/scala/ScalaCorrespondenceMatchingDemo.scala_docs.md`

## File Metadata

- **Full Path**: `docs/samples/java/sbt/src/main/scala/ScalaCorrespondenceMatchingDemo.scala_docs.md`
- **File Name**: `ScalaCorrespondenceMatchingDemo.scala_docs.md`
- **File Size**: 3,635 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/java/sbt/src/main/scala/ScalaCorrespondenceMatchingDemo.scala_docs.md](../../../../../../../docs/samples/java/sbt/src/main/scala/ScalaCorrespondenceMatchingDemo.scala_docs.md)
...
# Documentation for `samples/java/sbt/src/main/scala/ScalaCorrespondenceMatchingDemo.scala`

## File Metadata

- **Full Path**: `samples/java/sbt/src/main/scala/ScalaCorrespondenceMatchingDemo.scala`
- **File Name**: `ScalaCorrespondenceMatchingDemo.scala`
- **File Size**: 2,879 bytes
- **File Type**: .scala
- **Link to Source**: [samples/java/sbt/src/main/scala/ScalaCorrespondenceMatchingDemo.scala](../../../../../../samples/java/sbt/src/main/scala/ScalaCorrespondenceMatchingDemo.scala)
