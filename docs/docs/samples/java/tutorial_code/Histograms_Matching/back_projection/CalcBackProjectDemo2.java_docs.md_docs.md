# Documentation for `docs/samples/java/tutorial_code/Histograms_Matching/back_projection/CalcBackProjectDemo2.java_docs.md`

## File Metadata

- **Full Path**: `docs/samples/java/tutorial_code/Histograms_Matching/back_projection/CalcBackProjectDemo2.java_docs.md`
- **File Name**: `CalcBackProjectDemo2.java_docs.md`
- **File Size**: 10,420 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/java/tutorial_code/Histograms_Matching/back_projection/CalcBackProjectDemo2.java_docs.md](../../../../../../docs/samples/java/tutorial_code/Histograms_Matching/back_projection/CalcBackProjectDemo2.java_docs.md)
