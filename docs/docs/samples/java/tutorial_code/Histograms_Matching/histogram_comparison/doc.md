# Documentation for `docs/samples/java/tutorial_code/Histograms_Matching/histogram_comparison/`
...
**Path**: `docs/samples/java/tutorial_code/Histograms_Matching/histogram_comparison/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[CompareHistDemo.java_docs.md](CompareHistDemo.java_docs.md_docs.md)**: MD file
- **[CompareHistDemo.java_kw.md](CompareHistDemo.java_kw.md_docs.md)**: MD file
