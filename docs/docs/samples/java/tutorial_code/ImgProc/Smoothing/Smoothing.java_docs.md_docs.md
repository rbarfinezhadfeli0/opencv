# Documentation for `docs/samples/java/tutorial_code/ImgProc/Smoothing/Smoothing.java_docs.md`

## File Metadata

- **Full Path**: `docs/samples/java/tutorial_code/ImgProc/Smoothing/Smoothing.java_docs.md`
- **File Name**: `Smoothing.java_docs.md`
- **File Size**: 6,268 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/java/tutorial_code/ImgProc/Smoothing/Smoothing.java_docs.md](../../../../../../docs/samples/java/tutorial_code/ImgProc/Smoothing/Smoothing.java_docs.md)
