# Documentation for `docs/samples/java/tutorial_code/ImgProc/threshold_inRange/ThresholdInRange.java_docs.md`

## File Metadata

- **Full Path**: `docs/samples/java/tutorial_code/ImgProc/threshold_inRange/ThresholdInRange.java_docs.md`
- **File Name**: `ThresholdInRange.java_docs.md`
- **File Size**: 13,220 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/java/tutorial_code/ImgProc/threshold_inRange/ThresholdInRange.java_docs.md](../../../../../../docs/samples/java/tutorial_code/ImgProc/threshold_inRange/ThresholdInRange.java_docs.md)
...
# Documentation for `samples/java/tutorial_code/ImgProc/threshold_inRange/ThresholdInRange.java`

## File Metadata

- **Full Path**: `samples/java/tutorial_code/ImgProc/threshold_inRange/ThresholdInRange.java`
- **File Name**: `ThresholdInRange.java`
- **File Size**: 9,450 bytes
- **File Type**: .java
- **Link to Source**: [samples/java/tutorial_code/ImgProc/threshold_inRange/ThresholdInRange.java](../../../../../samples/java/tutorial_code/ImgProc/threshold_inRange/ThresholdInRange.java)

## Purpose and Role

This file is located in the `samples/java/tutorial_code/ImgProc/threshold_inRange` directory and serves as part of the OpenCV library infrastructure.
...
- **CaptureTask**: A class/struct defined in this file
- **ThresholdInRange**: A class/struct defined in this file
