# Documentation for `docs/samples/java/tutorial_code/ImgProc/tutorial_template_matching/MatchTemplateDemo.java_docs.md`

## File Metadata

- **Full Path**: `docs/samples/java/tutorial_code/ImgProc/tutorial_template_matching/MatchTemplateDemo.java_docs.md`
- **File Name**: `MatchTemplateDemo.java_docs.md`
- **File Size**: 9,651 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/java/tutorial_code/ImgProc/tutorial_template_matching/MatchTemplateDemo.java_docs.md](../../../../../../docs/samples/java/tutorial_code/ImgProc/tutorial_template_matching/MatchTemplateDemo.java_docs.md)

## Purpose and Role

This file is located in the `docs/samples/java/tutorial_code/ImgProc/tutorial_template_matching` directory and serves as part of the OpenCV library infrastructure.
