# Documentation for `docs/samples/java/tutorial_code/ImgTrans/HoughCircle/`
...
**Path**: `docs/samples/java/tutorial_code/ImgTrans/HoughCircle/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[HoughCircles.java_docs.md](HoughCircles.java_docs.md_docs.md)**: MD file
- **[HoughCircles.java_kw.md](HoughCircles.java_kw.md_docs.md)**: MD file
