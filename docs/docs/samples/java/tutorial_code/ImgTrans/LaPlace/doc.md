# Documentation for `docs/samples/java/tutorial_code/ImgTrans/LaPlace/`
...
**Path**: `docs/samples/java/tutorial_code/ImgTrans/LaPlace/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[LaplaceDemo.java_kw.md](LaplaceDemo.java_kw.md_docs.md)**: MD file
- **[LaplaceDemo.java_docs.md](LaplaceDemo.java_docs.md_docs.md)**: MD file
