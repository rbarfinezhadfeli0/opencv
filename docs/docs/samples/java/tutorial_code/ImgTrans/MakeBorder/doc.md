# Documentation for `docs/samples/java/tutorial_code/ImgTrans/MakeBorder/`
...
**Path**: `docs/samples/java/tutorial_code/ImgTrans/MakeBorder/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[CopyMakeBorder.java_docs.md](CopyMakeBorder.java_docs.md_docs.md)**: MD file
- **[CopyMakeBorder.java_kw.md](CopyMakeBorder.java_kw.md_docs.md)**: MD file
