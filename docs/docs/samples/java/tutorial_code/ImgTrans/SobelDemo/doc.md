# Documentation for `docs/samples/java/tutorial_code/ImgTrans/SobelDemo/`
...
**Path**: `docs/samples/java/tutorial_code/ImgTrans/SobelDemo/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[SobelDemo.java_docs.md](SobelDemo.java_docs.md_docs.md)**: MD file
- **[SobelDemo.java_kw.md](SobelDemo.java_kw.md_docs.md)**: MD file
