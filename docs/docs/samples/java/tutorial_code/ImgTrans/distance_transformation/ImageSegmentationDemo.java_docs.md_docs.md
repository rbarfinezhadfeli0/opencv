# Documentation for `docs/samples/java/tutorial_code/ImgTrans/distance_transformation/ImageSegmentationDemo.java_docs.md`

## File Metadata

- **Full Path**: `docs/samples/java/tutorial_code/ImgTrans/distance_transformation/ImageSegmentationDemo.java_docs.md`
- **File Name**: `ImageSegmentationDemo.java_docs.md`
- **File Size**: 12,348 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/java/tutorial_code/ImgTrans/distance_transformation/ImageSegmentationDemo.java_docs.md](../../../../../../docs/samples/java/tutorial_code/ImgTrans/distance_transformation/ImageSegmentationDemo.java_docs.md)
...
# Documentation for `samples/java/tutorial_code/ImgTrans/distance_transformation/ImageSegmentationDemo.java`

## File Metadata

- **Full Path**: `samples/java/tutorial_code/ImgTrans/distance_transformation/ImageSegmentationDemo.java`
- **File Name**: `ImageSegmentationDemo.java`
- **File Size**: 8,728 bytes
- **File Type**: .java
- **Link to Source**: [samples/java/tutorial_code/ImgTrans/distance_transformation/ImageSegmentationDemo.java](../../../../../samples/java/tutorial_code/ImgTrans/distance_transformation/ImageSegmentationDemo.java)

## Purpose and Role

This file is located in the `samples/java/tutorial_code/ImgTrans/distance_transformation` directory and serves as part of the OpenCV library infrastructure.
...
- **ImageSegmentationDemo**: A class/struct defined in this file
- **ImageSegmentation**: A class/struct defined in this file
