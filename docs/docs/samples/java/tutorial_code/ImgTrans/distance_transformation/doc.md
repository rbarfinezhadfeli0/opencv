# Documentation for `docs/samples/java/tutorial_code/ImgTrans/distance_transformation/`
...
**Path**: `docs/samples/java/tutorial_code/ImgTrans/distance_transformation/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[ImageSegmentationDemo.java_kw.md](ImageSegmentationDemo.java_kw.md_docs.md)**: MD file
- **[ImageSegmentationDemo.java_docs.md](ImageSegmentationDemo.java_docs.md_docs.md)**: MD file
