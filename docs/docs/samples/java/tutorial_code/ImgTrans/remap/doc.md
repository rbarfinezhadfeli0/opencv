# Documentation for `docs/samples/java/tutorial_code/ImgTrans/remap/`
...
**Path**: `docs/samples/java/tutorial_code/ImgTrans/remap/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[RemapDemo.java_kw.md](RemapDemo.java_kw.md_docs.md)**: MD file
- **[RemapDemo.java_docs.md](RemapDemo.java_docs.md_docs.md)**: MD file
