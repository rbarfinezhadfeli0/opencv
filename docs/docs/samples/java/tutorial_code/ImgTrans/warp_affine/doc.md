# Documentation for `docs/samples/java/tutorial_code/ImgTrans/warp_affine/`
...
**Path**: `docs/samples/java/tutorial_code/ImgTrans/warp_affine/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[GeometricTransformsDemo.java_kw.md](GeometricTransformsDemo.java_kw.md_docs.md)**: MD file
- **[GeometricTransformsDemo.java_docs.md](GeometricTransformsDemo.java_docs.md_docs.md)**: MD file
...
- **Parent Folder**: [docs/samples/java/tutorial_code/ImgTrans/](../ImgTrans/doc.md)
