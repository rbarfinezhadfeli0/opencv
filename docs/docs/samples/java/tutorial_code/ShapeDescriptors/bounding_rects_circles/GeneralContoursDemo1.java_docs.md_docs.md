# Documentation for `docs/samples/java/tutorial_code/ShapeDescriptors/bounding_rects_circles/GeneralContoursDemo1.java_docs.md`

## File Metadata

- **Full Path**: `docs/samples/java/tutorial_code/ShapeDescriptors/bounding_rects_circles/GeneralContoursDemo1.java_docs.md`
- **File Name**: `GeneralContoursDemo1.java_docs.md`
- **File Size**: 10,452 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/java/tutorial_code/ShapeDescriptors/bounding_rects_circles/GeneralContoursDemo1.java_docs.md](../../../../../../docs/samples/java/tutorial_code/ShapeDescriptors/bounding_rects_circles/GeneralContoursDemo1.java_docs.md)
