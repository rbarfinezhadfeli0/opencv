# Documentation for `docs/samples/java/tutorial_code/ShapeDescriptors/bounding_rects_circles/`
...
**Path**: `docs/samples/java/tutorial_code/ShapeDescriptors/bounding_rects_circles/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[GeneralContoursDemo1.java_docs.md](GeneralContoursDemo1.java_docs.md_docs.md)**: MD file
- **[GeneralContoursDemo1.java_kw.md](GeneralContoursDemo1.java_kw.md_docs.md)**: MD file
