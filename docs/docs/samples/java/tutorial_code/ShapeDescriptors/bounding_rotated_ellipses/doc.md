# Documentation for `docs/samples/java/tutorial_code/ShapeDescriptors/bounding_rotated_ellipses/`
...
**Path**: `docs/samples/java/tutorial_code/ShapeDescriptors/bounding_rotated_ellipses/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[GeneralContoursDemo2.java_kw.md](GeneralContoursDemo2.java_kw.md_docs.md)**: MD file
- **[GeneralContoursDemo2.java_docs.md](GeneralContoursDemo2.java_docs.md_docs.md)**: MD file
