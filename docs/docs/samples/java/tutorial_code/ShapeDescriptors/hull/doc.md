# Documentation for `docs/samples/java/tutorial_code/ShapeDescriptors/hull/`
...
**Path**: `docs/samples/java/tutorial_code/ShapeDescriptors/hull/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[HullDemo.java_docs.md](HullDemo.java_docs.md_docs.md)**: MD file
- **[HullDemo.java_kw.md](HullDemo.java_kw.md_docs.md)**: MD file
