# Documentation for `docs/samples/java/tutorial_code/ShapeDescriptors/moments/MomentsDemo.java_docs.md`

## File Metadata

- **Full Path**: `docs/samples/java/tutorial_code/ShapeDescriptors/moments/MomentsDemo.java_docs.md`
- **File Name**: `MomentsDemo.java_docs.md`
- **File Size**: 10,234 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/java/tutorial_code/ShapeDescriptors/moments/MomentsDemo.java_docs.md](../../../../../../docs/samples/java/tutorial_code/ShapeDescriptors/moments/MomentsDemo.java_docs.md)
