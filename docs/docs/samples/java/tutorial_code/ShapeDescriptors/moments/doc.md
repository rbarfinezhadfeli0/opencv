# Documentation for `docs/samples/java/tutorial_code/ShapeDescriptors/moments/`
...
**Path**: `docs/samples/java/tutorial_code/ShapeDescriptors/moments/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[MomentsDemo.java_docs.md](MomentsDemo.java_docs.md_docs.md)**: MD file
- **[MomentsDemo.java_kw.md](MomentsDemo.java_kw.md_docs.md)**: MD file
