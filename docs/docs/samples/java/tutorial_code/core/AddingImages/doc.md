# Documentation for `docs/samples/java/tutorial_code/core/AddingImages/`
...
**Path**: `docs/samples/java/tutorial_code/core/AddingImages/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[AddingImages.java_kw.md](AddingImages.java_kw.md_docs.md)**: MD file
- **[AddingImages.java_docs.md](AddingImages.java_docs.md_docs.md)**: MD file
