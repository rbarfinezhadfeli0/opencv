# Documentation for `docs/samples/java/tutorial_code/core/mat_mask_operations/`
...
**Path**: `docs/samples/java/tutorial_code/core/mat_mask_operations/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[MatMaskOperations.java_docs.md](MatMaskOperations.java_docs.md_docs.md)**: MD file
- **[MatMaskOperations.java_kw.md](MatMaskOperations.java_kw.md_docs.md)**: MD file
