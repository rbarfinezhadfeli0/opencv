# Documentation for `docs/samples/java/tutorial_code/core/mat_operations/`
...
**Path**: `docs/samples/java/tutorial_code/core/mat_operations/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[MatOperations.java_docs.md](MatOperations.java_docs.md_docs.md)**: MD file
- **[MatOperations.java_kw.md](MatOperations.java_kw.md_docs.md)**: MD file
