# Documentation for `docs/samples/java/tutorial_code/features2D/akaze_matching/`
...
**Path**: `docs/samples/java/tutorial_code/features2D/akaze_matching/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[AKAZEMatchDemo.java_kw.md](AKAZEMatchDemo.java_kw.md_docs.md)**: MD file
- **[AKAZEMatchDemo.java_docs.md](AKAZEMatchDemo.java_docs.md_docs.md)**: MD file
