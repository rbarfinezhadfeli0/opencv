# Documentation for `docs/samples/java/tutorial_code/ml/introduction_to_pca/`
...
**Path**: `docs/samples/java/tutorial_code/ml/introduction_to_pca/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[IntroductionToPCADemo.java_docs.md](IntroductionToPCADemo.java_docs.md_docs.md)**: MD file
- **[IntroductionToPCADemo.java_kw.md](IntroductionToPCADemo.java_kw.md_docs.md)**: MD file
