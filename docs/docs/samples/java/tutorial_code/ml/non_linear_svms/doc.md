# Documentation for `docs/samples/java/tutorial_code/ml/non_linear_svms/`
...
**Path**: `docs/samples/java/tutorial_code/ml/non_linear_svms/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[NonLinearSVMsDemo.java_docs.md](NonLinearSVMsDemo.java_docs.md_docs.md)**: MD file
- **[NonLinearSVMsDemo.java_kw.md](NonLinearSVMsDemo.java_kw.md_docs.md)**: MD file
