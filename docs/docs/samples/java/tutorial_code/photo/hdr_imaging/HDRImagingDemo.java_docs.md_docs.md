# Documentation for `docs/samples/java/tutorial_code/photo/hdr_imaging/HDRImagingDemo.java_docs.md`

## File Metadata

- **Full Path**: `docs/samples/java/tutorial_code/photo/hdr_imaging/HDRImagingDemo.java_docs.md`
- **File Name**: `HDRImagingDemo.java_docs.md`
- **File Size**: 6,977 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/java/tutorial_code/photo/hdr_imaging/HDRImagingDemo.java_docs.md](../../../../../../docs/samples/java/tutorial_code/photo/hdr_imaging/HDRImagingDemo.java_docs.md)

## Purpose and Role

This file is located in the `docs/samples/java/tutorial_code/photo/hdr_imaging` directory and serves as part of the OpenCV library infrastructure.
