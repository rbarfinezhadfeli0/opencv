# Documentation for `docs/samples/java/tutorial_code/video/background_subtraction/`
...
**Path**: `docs/samples/java/tutorial_code/video/background_subtraction/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[BackgroundSubtractionDemo.java_docs.md](BackgroundSubtractionDemo.java_docs.md_docs.md)**: MD file
- **[BackgroundSubtractionDemo.java_kw.md](BackgroundSubtractionDemo.java_kw.md_docs.md)**: MD file
