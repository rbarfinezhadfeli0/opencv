# Documentation for `docs/samples/opengl/winapp.hpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/opengl/winapp.hpp_docs.md`
- **File Name**: `winapp.hpp_docs.md`
- **File Size**: 8,600 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/opengl/winapp.hpp_docs.md](../../../docs/samples/opengl/winapp.hpp_docs.md)
