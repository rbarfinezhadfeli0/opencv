# Documentation for `docs/samples/openvx/no_wrappers.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/openvx/no_wrappers.cpp_docs.md`
- **File Name**: `no_wrappers.cpp_docs.md`
- **File Size**: 15,691 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/openvx/no_wrappers.cpp_docs.md](../../../docs/samples/openvx/no_wrappers.cpp_docs.md)
...
# Documentation for `samples/openvx/no_wrappers.cpp`

## File Metadata

- **Full Path**: `samples/openvx/no_wrappers.cpp`
- **File Name**: `no_wrappers.cpp`
- **File Size**: 12,466 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/openvx/no_wrappers.cpp](../../samples/openvx/no_wrappers.cpp)
...
- **uintptr_t()**: A function/method defined in this file
