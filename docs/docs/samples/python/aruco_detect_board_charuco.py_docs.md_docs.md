# Documentation for `docs/samples/python/aruco_detect_board_charuco.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/python/aruco_detect_board_charuco.py_docs.md`
- **File Name**: `aruco_detect_board_charuco.py_docs.md`
- **File Size**: 8,552 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/python/aruco_detect_board_charuco.py_docs.md](../../../docs/samples/python/aruco_detect_board_charuco.py_docs.md)
...
# Documentation for `samples/python/aruco_detect_board_charuco.py`

## File Metadata

- **Full Path**: `samples/python/aruco_detect_board_charuco.py`
- **File Name**: `aruco_detect_board_charuco.py`
- **File Size**: 5,426 bytes
- **File Type**: .py
- **Link to Source**: [samples/python/aruco_detect_board_charuco.py](../../samples/python/aruco_detect_board_charuco.py)
...
- **read_camera_parameters()**: A function/method defined in this file
