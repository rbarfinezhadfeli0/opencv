# Documentation for `docs/samples/python/asift.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/python/asift.py_docs.md`
- **File Name**: `asift.py_docs.md`
- **File Size**: 8,753 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/python/asift.py_docs.md](../../../docs/samples/python/asift.py_docs.md)
