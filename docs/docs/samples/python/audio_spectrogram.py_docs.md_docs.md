# Documentation for `docs/samples/python/audio_spectrogram.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/python/audio_spectrogram.py_docs.md`
- **File Name**: `audio_spectrogram.py_docs.md`
- **File Size**: 37,971 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/python/audio_spectrogram.py_docs.md](../../../docs/samples/python/audio_spectrogram.py_docs.md)
...
# Documentation for `samples/python/audio_spectrogram.py`

## File Metadata

- **Full Path**: `samples/python/audio_spectrogram.py`
- **File Name**: `audio_spectrogram.py`
- **File Size**: 34,078 bytes
- **File Type**: .py
- **Link to Source**: [samples/python/audio_spectrogram.py](../../samples/python/audio_spectrogram.py)
...
- **AudioDrawing**: A class/struct defined in this file

### Functions and Methods

- **readAudioMicrophone()**: A function/method defined in this file
- **drawAmplitudeScale()**: A function/method defined in this file
- **dynamicMicrophone()**: A function/method defined in this file
- **drawAmplitude()**: A function/method defined in this file
- **drawSpectrogramColorbar()**: A function/method defined in this file
- **dynamicFile()**: A function/method defined in this file
- **initAndCheckArgs()**: A function/method defined in this file
- **STFT()**: A function/method defined in this file
- **drawSpectrogram()**: A function/method defined in this file
- **concatenateImages()**: A function/method defined in this file
