# Documentation for `docs/samples/python/camera_calibration_show_extrinsics.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/python/camera_calibration_show_extrinsics.py_docs.md`
- **File Name**: `camera_calibration_show_extrinsics.py_docs.md`
- **File Size**: 11,736 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/python/camera_calibration_show_extrinsics.py_docs.md](../../../docs/samples/python/camera_calibration_show_extrinsics.py_docs.md)
...
# Documentation for `samples/python/camera_calibration_show_extrinsics.py`

## File Metadata

- **Full Path**: `samples/python/camera_calibration_show_extrinsics.py`
- **File Name**: `camera_calibration_show_extrinsics.py`
- **File Size**: 8,143 bytes
- **File Type**: .py
- **Link to Source**: [samples/python/camera_calibration_show_extrinsics.py](../../samples/python/camera_calibration_show_extrinsics.py)
...
- **create_board_model()**: A function/method defined in this file
- **inverse_homogeneoux_matrix()**: A function/method defined in this file
- **transform_to_matplotlib_frame()**: A function/method defined in this file
- **create_camera_model()**: A function/method defined in this file
- **draw_camera_boards()**: A function/method defined in this file
