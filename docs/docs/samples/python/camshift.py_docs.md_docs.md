# Documentation for `docs/samples/python/camshift.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/python/camshift.py_docs.md`
- **File Name**: `camshift.py_docs.md`
- **File Size**: 7,257 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/python/camshift.py_docs.md](../../../docs/samples/python/camshift.py_docs.md)
