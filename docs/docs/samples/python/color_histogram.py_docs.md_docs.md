# Documentation for `docs/samples/python/color_histogram.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/python/color_histogram.py_docs.md`
- **File Name**: `color_histogram.py_docs.md`
- **File Size**: 4,820 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/python/color_histogram.py_docs.md](../../../docs/samples/python/color_histogram.py_docs.md)
