# Documentation for `docs/samples/python/contours.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/python/contours.py_docs.md`
- **File Name**: `contours.py_docs.md`
- **File Size**: 5,601 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/python/contours.py_docs.md](../../../docs/samples/python/contours.py_docs.md)
