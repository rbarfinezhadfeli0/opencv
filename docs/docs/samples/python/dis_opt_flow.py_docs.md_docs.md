# Documentation for `docs/samples/python/dis_opt_flow.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/python/dis_opt_flow.py_docs.md`
- **File Name**: `dis_opt_flow.py_docs.md`
- **File Size**: 6,759 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/python/dis_opt_flow.py_docs.md](../../../docs/samples/python/dis_opt_flow.py_docs.md)
...
# Documentation for `samples/python/dis_opt_flow.py`

## File Metadata

- **Full Path**: `samples/python/dis_opt_flow.py`
- **File Name**: `dis_opt_flow.py`
- **File Size**: 3,546 bytes
- **File Type**: .py
- **Link to Source**: [samples/python/dis_opt_flow.py](../../samples/python/dis_opt_flow.py)
...
- **draw_flow()**: A function/method defined in this file
- **import()**: A function/method defined in this file
- **warp_flow()**: A function/method defined in this file
- **draw_hsv()**: A function/method defined in this file
