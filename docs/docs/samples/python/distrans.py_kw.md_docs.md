# Documentation for `docs/samples/python/distrans.py_kw.md`

## File Metadata

- **Full Path**: `docs/samples/python/distrans.py_kw.md`
- **File Name**: `distrans.py_kw.md`
- **File Size**: 7,722 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/python/distrans.py_kw.md](../../../docs/samples/python/distrans.py_kw.md)
