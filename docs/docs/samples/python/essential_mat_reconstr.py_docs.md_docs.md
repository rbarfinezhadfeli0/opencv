# Documentation for `docs/samples/python/essential_mat_reconstr.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/python/essential_mat_reconstr.py_docs.md`
- **File Name**: `essential_mat_reconstr.py_docs.md`
- **File Size**: 8,964 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/python/essential_mat_reconstr.py_docs.md](../../../docs/samples/python/essential_mat_reconstr.py_docs.md)
...
# Documentation for `samples/python/essential_mat_reconstr.py`

## File Metadata

- **Full Path**: `samples/python/essential_mat_reconstr.py`
- **File Name**: `essential_mat_reconstr.py`
- **File Size**: 5,941 bytes
- **File Type**: .py
- **Link to Source**: [samples/python/essential_mat_reconstr.py](../../samples/python/essential_mat_reconstr.py)
...
- **getEpipolarError()**: A function/method defined in this file
