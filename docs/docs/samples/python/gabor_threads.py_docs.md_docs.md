# Documentation for `docs/samples/python/gabor_threads.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/python/gabor_threads.py_docs.md`
- **File Name**: `gabor_threads.py_docs.md`
- **File Size**: 5,263 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/python/gabor_threads.py_docs.md](../../../docs/samples/python/gabor_threads.py_docs.md)
