# Documentation for `docs/samples/python/grabcut.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/python/grabcut.py_docs.md`
- **File Name**: `grabcut.py_docs.md`
- **File Size**: 10,660 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/python/grabcut.py_docs.md](../../../docs/samples/python/grabcut.py_docs.md)
...
# Documentation for `samples/python/grabcut.py`

## File Metadata

- **Full Path**: `samples/python/grabcut.py`
- **File Name**: `grabcut.py`
- **File Size**: 7,510 bytes
- **File Type**: .py
- **Link to Source**: [samples/python/grabcut.py](../../samples/python/grabcut.py)
