# Documentation for `docs/samples/python/houghlines.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/python/houghlines.py_docs.md`
- **File Name**: `houghlines.py_docs.md`
- **File Size**: 4,607 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/python/houghlines.py_docs.md](../../../docs/samples/python/houghlines.py_docs.md)
