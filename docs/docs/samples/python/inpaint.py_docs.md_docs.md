# Documentation for `docs/samples/python/inpaint.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/python/inpaint.py_docs.md`
- **File Name**: `inpaint.py_docs.md`
- **File Size**: 4,223 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/python/inpaint.py_docs.md](../../../docs/samples/python/inpaint.py_docs.md)
...
# Documentation for `samples/python/inpaint.py`

## File Metadata

- **Full Path**: `samples/python/inpaint.py`
- **File Name**: `inpaint.py`
- **File Size**: 1,194 bytes
- **File Type**: .py
- **Link to Source**: [samples/python/inpaint.py](../../samples/python/inpaint.py)
