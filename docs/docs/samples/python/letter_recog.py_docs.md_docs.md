# Documentation for `docs/samples/python/letter_recog.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/python/letter_recog.py_docs.md`
- **File Name**: `letter_recog.py_docs.md`
- **File Size**: 10,166 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/python/letter_recog.py_docs.md](../../../docs/samples/python/letter_recog.py_docs.md)
