# Documentation for `docs/samples/python/lk_homography.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/python/lk_homography.py_docs.md`
- **File Name**: `lk_homography.py_docs.md`
- **File Size**: 7,121 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/python/lk_homography.py_docs.md](../../../docs/samples/python/lk_homography.py_docs.md)
...
# Documentation for `samples/python/lk_homography.py`

## File Metadata

- **Full Path**: `samples/python/lk_homography.py`
- **File Name**: `lk_homography.py`
- **File Size**: 3,794 bytes
- **File Type**: .py
- **Link to Source**: [samples/python/lk_homography.py](../../samples/python/lk_homography.py)
