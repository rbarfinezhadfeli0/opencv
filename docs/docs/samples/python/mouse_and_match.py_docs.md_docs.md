# Documentation for `docs/samples/python/mouse_and_match.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/python/mouse_and_match.py_docs.md`
- **File Name**: `mouse_and_match.py_docs.md`
- **File Size**: 6,375 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/python/mouse_and_match.py_docs.md](../../../docs/samples/python/mouse_and_match.py_docs.md)
