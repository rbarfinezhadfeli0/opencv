# Documentation for `docs/samples/python/peopledetect.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/python/peopledetect.py_docs.md`
- **File Name**: `peopledetect.py_docs.md`
- **File Size**: 5,289 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/python/peopledetect.py_docs.md](../../../docs/samples/python/peopledetect.py_docs.md)
