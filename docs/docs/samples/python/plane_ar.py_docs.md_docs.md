# Documentation for `docs/samples/python/plane_ar.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/python/plane_ar.py_docs.md`
- **File Name**: `plane_ar.py_docs.md`
- **File Size**: 7,050 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/python/plane_ar.py_docs.md](../../../docs/samples/python/plane_ar.py_docs.md)
...
# Documentation for `samples/python/plane_ar.py`

## File Metadata

- **Full Path**: `samples/python/plane_ar.py`
- **File Name**: `plane_ar.py`
- **File Size**: 3,650 bytes
- **File Type**: .py
- **Link to Source**: [samples/python/plane_ar.py](../../samples/python/plane_ar.py)
...
- **on_rect()**: A function/method defined in this file
- **is()**: A function/method defined in this file
- **draw_overlay()**: A function/method defined in this file
