# Documentation for `docs/samples/python/plane_tracker.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/python/plane_tracker.py_docs.md`
- **File Name**: `plane_tracker.py_docs.md`
- **File Size**: 9,643 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/python/plane_tracker.py_docs.md](../../../docs/samples/python/plane_tracker.py_docs.md)
...
# Documentation for `samples/python/plane_tracker.py`

## File Metadata

- **Full Path**: `samples/python/plane_tracker.py`
- **File Name**: `plane_tracker.py`
- **File Size**: 6,015 bytes
- **File Type**: .py
- **Link to Source**: [samples/python/plane_tracker.py](../../samples/python/plane_tracker.py)
