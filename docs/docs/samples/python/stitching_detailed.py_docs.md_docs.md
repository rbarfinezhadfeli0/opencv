# Documentation for `docs/samples/python/stitching_detailed.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/python/stitching_detailed.py_docs.md`
- **File Name**: `stitching_detailed.py_docs.md`
- **File Size**: 23,669 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/python/stitching_detailed.py_docs.md](../../../docs/samples/python/stitching_detailed.py_docs.md)
...
# Documentation for `samples/python/stitching_detailed.py`

## File Metadata

- **Full Path**: `samples/python/stitching_detailed.py`
- **File Name**: `stitching_detailed.py`
- **File Size**: 20,375 bytes
- **File Type**: .py
- **Link to Source**: [samples/python/stitching_detailed.py](../../samples/python/stitching_detailed.py)
...
- **get_matcher()**: A function/method defined in this file
- **main()**: A function/method defined in this file
- **get_compensator()**: A function/method defined in this file
