# Documentation for `docs/samples/python/tutorial_code/Histograms_Matching/back_projection/calcBackProject_Demo1.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/python/tutorial_code/Histograms_Matching/back_projection/calcBackProject_Demo1.py_docs.md`
- **File Name**: `calcBackProject_Demo1.py_docs.md`
- **File Size**: 5,399 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/python/tutorial_code/Histograms_Matching/back_projection/calcBackProject_Demo1.py_docs.md](../../../../../../docs/samples/python/tutorial_code/Histograms_Matching/back_projection/calcBackProject_Demo1.py_docs.md)
