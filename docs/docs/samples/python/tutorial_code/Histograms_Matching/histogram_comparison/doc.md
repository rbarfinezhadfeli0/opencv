# Documentation for `docs/samples/python/tutorial_code/Histograms_Matching/histogram_comparison/`
...
**Path**: `docs/samples/python/tutorial_code/Histograms_Matching/histogram_comparison/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[compareHist_Demo.py_docs.md](compareHist_Demo.py_docs.md_docs.md)**: MD file
- **[compareHist_Demo.py_kw.md](compareHist_Demo.py_kw.md_docs.md)**: MD file
