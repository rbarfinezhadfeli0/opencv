# Documentation for `docs/samples/python/tutorial_code/Histograms_Matching/histogram_equalization/`
...
**Path**: `docs/samples/python/tutorial_code/Histograms_Matching/histogram_equalization/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[EqualizeHist_Demo.py_kw.md](EqualizeHist_Demo.py_kw.md_docs.md)**: MD file
- **[EqualizeHist_Demo.py_docs.md](EqualizeHist_Demo.py_docs.md_docs.md)**: MD file
