# Documentation for `docs/samples/python/tutorial_code/ImgTrans/Filter2D/`
...
**Path**: `docs/samples/python/tutorial_code/ImgTrans/Filter2D/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[filter2D.py_kw.md](filter2D.py_kw.md_docs.md)**: MD file
- **[filter2D.py_docs.md](filter2D.py_docs.md_docs.md)**: MD file
