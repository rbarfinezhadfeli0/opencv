# Documentation for `docs/samples/python/tutorial_code/ImgTrans/HoughCircle/`
...
**Path**: `docs/samples/python/tutorial_code/ImgTrans/HoughCircle/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[hough_circle.py_kw.md](hough_circle.py_kw.md_docs.md)**: MD file
- **[hough_circle.py_docs.md](hough_circle.py_docs.md_docs.md)**: MD file
