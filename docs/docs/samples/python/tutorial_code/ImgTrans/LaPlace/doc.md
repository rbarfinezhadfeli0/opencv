# Documentation for `docs/samples/python/tutorial_code/ImgTrans/LaPlace/`
...
**Path**: `docs/samples/python/tutorial_code/ImgTrans/LaPlace/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[laplace_demo.py_docs.md](laplace_demo.py_docs.md_docs.md)**: MD file
- **[laplace_demo.py_kw.md](laplace_demo.py_kw.md_docs.md)**: MD file
