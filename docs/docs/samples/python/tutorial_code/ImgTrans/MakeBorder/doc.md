# Documentation for `docs/samples/python/tutorial_code/ImgTrans/MakeBorder/`
...
**Path**: `docs/samples/python/tutorial_code/ImgTrans/MakeBorder/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[copy_make_border.py_kw.md](copy_make_border.py_kw.md_docs.md)**: MD file
- **[copy_make_border.py_docs.md](copy_make_border.py_docs.md_docs.md)**: MD file
