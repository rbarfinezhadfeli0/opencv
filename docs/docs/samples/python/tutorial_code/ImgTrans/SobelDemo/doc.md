# Documentation for `docs/samples/python/tutorial_code/ImgTrans/SobelDemo/`
...
**Path**: `docs/samples/python/tutorial_code/ImgTrans/SobelDemo/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[sobel_demo.py_kw.md](sobel_demo.py_kw.md_docs.md)**: MD file
- **[sobel_demo.py_docs.md](sobel_demo.py_docs.md_docs.md)**: MD file
