# Documentation for `docs/samples/python/tutorial_code/ImgTrans/canny_detector/CannyDetector_Demo.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/python/tutorial_code/ImgTrans/canny_detector/CannyDetector_Demo.py_docs.md`
- **File Name**: `CannyDetector_Demo.py_docs.md`
- **File Size**: 4,266 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/python/tutorial_code/ImgTrans/canny_detector/CannyDetector_Demo.py_docs.md](../../../../../../docs/samples/python/tutorial_code/ImgTrans/canny_detector/CannyDetector_Demo.py_docs.md)
