# Documentation for `docs/samples/python/tutorial_code/ImgTrans/canny_detector/`
...
**Path**: `docs/samples/python/tutorial_code/ImgTrans/canny_detector/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[CannyDetector_Demo.py_docs.md](CannyDetector_Demo.py_docs.md_docs.md)**: MD file
- **[CannyDetector_Demo.py_kw.md](CannyDetector_Demo.py_kw.md_docs.md)**: MD file
