# Documentation for `docs/samples/python/tutorial_code/ImgTrans/distance_transformation/`
...
**Path**: `docs/samples/python/tutorial_code/ImgTrans/distance_transformation/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[imageSegmentation.py_docs.md](imageSegmentation.py_docs.md_docs.md)**: MD file
- **[imageSegmentation.py_kw.md](imageSegmentation.py_kw.md_docs.md)**: MD file
