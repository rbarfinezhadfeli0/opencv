# Documentation for `docs/samples/python/tutorial_code/ImgTrans/remap/`
...
**Path**: `docs/samples/python/tutorial_code/ImgTrans/remap/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[Remap_Demo.py_kw.md](Remap_Demo.py_kw.md_docs.md)**: MD file
- **[Remap_Demo.py_docs.md](Remap_Demo.py_docs.md_docs.md)**: MD file
