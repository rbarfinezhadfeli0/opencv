# Documentation for `docs/samples/python/tutorial_code/ShapeDescriptors/bounding_rects_circles/`
...
**Path**: `docs/samples/python/tutorial_code/ShapeDescriptors/bounding_rects_circles/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[generalContours_demo1.py_docs.md](generalContours_demo1.py_docs.md_docs.md)**: MD file
- **[generalContours_demo1.py_kw.md](generalContours_demo1.py_kw.md_docs.md)**: MD file
