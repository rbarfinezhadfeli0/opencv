# Documentation for `docs/samples/python/tutorial_code/ShapeDescriptors/bounding_rotated_ellipses/`
...
**Path**: `docs/samples/python/tutorial_code/ShapeDescriptors/bounding_rotated_ellipses/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[generalContours_demo2.py_kw.md](generalContours_demo2.py_kw.md_docs.md)**: MD file
- **[generalContours_demo2.py_docs.md](generalContours_demo2.py_docs.md_docs.md)**: MD file
...
- **Parent Folder**: [docs/samples/python/tutorial_code/ShapeDescriptors/](../ShapeDescriptors/doc.md)
