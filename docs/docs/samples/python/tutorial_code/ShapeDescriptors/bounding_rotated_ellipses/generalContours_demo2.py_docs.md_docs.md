# Documentation for `docs/samples/python/tutorial_code/ShapeDescriptors/bounding_rotated_ellipses/generalContours_demo2.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/python/tutorial_code/ShapeDescriptors/bounding_rotated_ellipses/generalContours_demo2.py_docs.md`
- **File Name**: `generalContours_demo2.py_docs.md`
- **File Size**: 5,842 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/python/tutorial_code/ShapeDescriptors/bounding_rotated_ellipses/generalContours_demo2.py_docs.md](../../../../../../docs/samples/python/tutorial_code/ShapeDescriptors/bounding_rotated_ellipses/generalContours_demo2.py_docs.md)
