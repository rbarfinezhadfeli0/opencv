# Documentation for `docs/samples/python/tutorial_code/ShapeDescriptors/find_contours/`
...
**Path**: `docs/samples/python/tutorial_code/ShapeDescriptors/find_contours/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[findContours_demo.py_docs.md](findContours_demo.py_docs.md_docs.md)**: MD file
- **[findContours_demo.py_kw.md](findContours_demo.py_kw.md_docs.md)**: MD file
