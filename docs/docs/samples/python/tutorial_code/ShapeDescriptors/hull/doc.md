# Documentation for `docs/samples/python/tutorial_code/ShapeDescriptors/hull/`
...
**Path**: `docs/samples/python/tutorial_code/ShapeDescriptors/hull/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[hull_demo.py_kw.md](hull_demo.py_kw.md_docs.md)**: MD file
- **[hull_demo.py_docs.md](hull_demo.py_docs.md_docs.md)**: MD file
