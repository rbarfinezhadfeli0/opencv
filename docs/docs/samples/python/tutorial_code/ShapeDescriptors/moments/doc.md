# Documentation for `docs/samples/python/tutorial_code/ShapeDescriptors/moments/`
...
**Path**: `docs/samples/python/tutorial_code/ShapeDescriptors/moments/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[moments_demo.py_docs.md](moments_demo.py_docs.md_docs.md)**: MD file
- **[moments_demo.py_kw.md](moments_demo.py_kw.md_docs.md)**: MD file
