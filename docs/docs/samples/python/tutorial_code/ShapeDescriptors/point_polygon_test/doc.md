# Documentation for `docs/samples/python/tutorial_code/ShapeDescriptors/point_polygon_test/`
...
**Path**: `docs/samples/python/tutorial_code/ShapeDescriptors/point_polygon_test/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[pointPolygonTest_demo.py_kw.md](pointPolygonTest_demo.py_kw.md_docs.md)**: MD file
- **[pointPolygonTest_demo.py_docs.md](pointPolygonTest_demo.py_docs.md_docs.md)**: MD file
