# Documentation for `docs/samples/python/tutorial_code/ShapeDescriptors/point_polygon_test/pointPolygonTest_demo.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/python/tutorial_code/ShapeDescriptors/point_polygon_test/pointPolygonTest_demo.py_docs.md`
- **File Name**: `pointPolygonTest_demo.py_docs.md`
- **File Size**: 4,847 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/python/tutorial_code/ShapeDescriptors/point_polygon_test/pointPolygonTest_demo.py_docs.md](../../../../../../docs/samples/python/tutorial_code/ShapeDescriptors/point_polygon_test/pointPolygonTest_demo.py_docs.md)
