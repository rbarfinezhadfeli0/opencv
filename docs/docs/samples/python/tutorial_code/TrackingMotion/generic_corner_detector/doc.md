# Documentation for `docs/samples/python/tutorial_code/TrackingMotion/generic_corner_detector/`
...
**Path**: `docs/samples/python/tutorial_code/TrackingMotion/generic_corner_detector/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[cornerDetector_Demo.py_docs.md](cornerDetector_Demo.py_docs.md_docs.md)**: MD file
- **[cornerDetector_Demo.py_kw.md](cornerDetector_Demo.py_kw.md_docs.md)**: MD file
