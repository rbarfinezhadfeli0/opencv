# Documentation for `docs/samples/python/tutorial_code/TrackingMotion/good_features_to_track/`
...
**Path**: `docs/samples/python/tutorial_code/TrackingMotion/good_features_to_track/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[goodFeaturesToTrack_Demo.py_docs.md](goodFeaturesToTrack_Demo.py_docs.md_docs.md)**: MD file
- **[goodFeaturesToTrack_Demo.py_kw.md](goodFeaturesToTrack_Demo.py_kw.md_docs.md)**: MD file
...
- **Parent Folder**: [docs/samples/python/tutorial_code/TrackingMotion/](../TrackingMotion/doc.md)
