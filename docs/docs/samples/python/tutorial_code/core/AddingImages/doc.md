# Documentation for `docs/samples/python/tutorial_code/core/AddingImages/`
...
**Path**: `docs/samples/python/tutorial_code/core/AddingImages/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[adding_images.py_docs.md](adding_images.py_docs.md_docs.md)**: MD file
- **[adding_images.py_kw.md](adding_images.py_kw.md_docs.md)**: MD file
