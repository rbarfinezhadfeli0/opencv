# Documentation for `docs/samples/python/tutorial_code/core/file_input_output/`
...
**Path**: `docs/samples/python/tutorial_code/core/file_input_output/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[file_input_output.py_docs.md](file_input_output.py_docs.md_docs.md)**: MD file
- **[file_input_output.py_kw.md](file_input_output.py_kw.md_docs.md)**: MD file
