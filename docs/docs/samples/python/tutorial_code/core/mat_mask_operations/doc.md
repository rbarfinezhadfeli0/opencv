# Documentation for `docs/samples/python/tutorial_code/core/mat_mask_operations/`
...
**Path**: `docs/samples/python/tutorial_code/core/mat_mask_operations/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[mat_mask_operations.py_docs.md](mat_mask_operations.py_docs.md_docs.md)**: MD file
- **[mat_mask_operations.py_kw.md](mat_mask_operations.py_kw.md_docs.md)**: MD file
