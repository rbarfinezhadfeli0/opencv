# Documentation for `docs/samples/python/tutorial_code/core/mat_operations/`
...
**Path**: `docs/samples/python/tutorial_code/core/mat_operations/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[mat_operations.py_docs.md](mat_operations.py_docs.md_docs.md)**: MD file
- **[mat_operations.py_kw.md](mat_operations.py_kw.md_docs.md)**: MD file
