# Index of `docs/samples/python/tutorial_code/dnn/dnn_conversion/common/`

## Overview

This folder is part of the OpenCV repository structure and contains and other repository content.

**Location**: `docs/samples/python/tutorial_code/dnn/dnn_conversion/common`
...
- **[test/](test/index.md)**: Subfolder containing 2 files
