# Documentation for `docs/samples/python/tutorial_code/dnn/dnn_conversion/`
...
**Path**: `docs/samples/python/tutorial_code/dnn/dnn_conversion/`
**Direct Files**: 0
**Subfolders**: 2
...
- **pytorch/** - See [pytorch/doc.md](pytorch/doc.md)
...
- **Parent Folder**: [docs/samples/python/tutorial_code/dnn/](../dnn/doc.md)
