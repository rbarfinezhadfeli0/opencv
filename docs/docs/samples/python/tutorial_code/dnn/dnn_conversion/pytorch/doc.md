# Documentation for `docs/samples/python/tutorial_code/dnn/dnn_conversion/pytorch/`
...
**Path**: `docs/samples/python/tutorial_code/dnn/dnn_conversion/pytorch/`
**Direct Files**: 0
**Subfolders**: 1
...
- **segmentation/** - See [segmentation/doc.md](segmentation/doc.md)
...
- **Parent Folder**: [docs/samples/python/tutorial_code/dnn/dnn_conversion/](../dnn_conversion/doc.md)

**Sibling Folders**:
- [common/](../common/doc.md)

**Subfolders**:
- [segmentation/](segmentation/doc.md)
