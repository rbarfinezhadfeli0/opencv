# Documentation for `docs/samples/python/tutorial_code/dnn/dnn_conversion/pytorch/segmentation/`
...
**Path**: `docs/samples/python/tutorial_code/dnn/dnn_conversion/pytorch/segmentation/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[py_to_py_fcn_resnet50.py_kw.md](py_to_py_fcn_resnet50.py_kw.md_docs.md)**: MD file
- **[py_to_py_fcn_resnet50.py_docs.md](py_to_py_fcn_resnet50.py_docs.md_docs.md)**: MD file
...
- **Parent Folder**: [docs/samples/python/tutorial_code/dnn/dnn_conversion/pytorch/](../pytorch/doc.md)
