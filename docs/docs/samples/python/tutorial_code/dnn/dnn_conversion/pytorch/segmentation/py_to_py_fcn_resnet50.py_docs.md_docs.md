# Documentation for `docs/samples/python/tutorial_code/dnn/dnn_conversion/pytorch/segmentation/py_to_py_fcn_resnet50.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/python/tutorial_code/dnn/dnn_conversion/pytorch/segmentation/py_to_py_fcn_resnet50.py_docs.md`
- **File Name**: `py_to_py_fcn_resnet50.py_docs.md`
- **File Size**: 5,355 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/python/tutorial_code/dnn/dnn_conversion/pytorch/segmentation/py_to_py_fcn_resnet50.py_docs.md](../../../../../../../../docs/samples/python/tutorial_code/dnn/dnn_conversion/pytorch/segmentation/py_to_py_fcn_resnet50.py_docs.md)
