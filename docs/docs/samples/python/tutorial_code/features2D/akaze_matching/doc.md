# Documentation for `docs/samples/python/tutorial_code/features2D/akaze_matching/`
...
**Path**: `docs/samples/python/tutorial_code/features2D/akaze_matching/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[AKAZE_match.py_kw.md](AKAZE_match.py_kw.md_docs.md)**: MD file
- **[AKAZE_match.py_docs.md](AKAZE_match.py_docs.md_docs.md)**: MD file
