# Documentation for `docs/samples/python/tutorial_code/features2D/feature_description/SURF_matching_Demo.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/python/tutorial_code/features2D/feature_description/SURF_matching_Demo.py_docs.md`
- **File Name**: `SURF_matching_Demo.py_docs.md`
- **File Size**: 4,678 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/python/tutorial_code/features2D/feature_description/SURF_matching_Demo.py_docs.md](../../../../../../docs/samples/python/tutorial_code/features2D/feature_description/SURF_matching_Demo.py_docs.md)
