# Documentation for `docs/samples/python/tutorial_code/features2D/feature_detection/`
...
**Path**: `docs/samples/python/tutorial_code/features2D/feature_detection/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[SURF_detection_Demo.py_docs.md](SURF_detection_Demo.py_docs.md_docs.md)**: MD file
- **[SURF_detection_Demo.py_kw.md](SURF_detection_Demo.py_kw.md_docs.md)**: MD file
