# Documentation for `docs/samples/python/tutorial_code/highgui/trackbar/`
...
**Path**: `docs/samples/python/tutorial_code/highgui/trackbar/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[AddingImagesTrackbar.py_kw.md](AddingImagesTrackbar.py_kw.md_docs.md)**: MD file
- **[AddingImagesTrackbar.py_docs.md](AddingImagesTrackbar.py_docs.md_docs.md)**: MD file
...
- **Parent Folder**: [docs/samples/python/tutorial_code/highgui/](../highgui/doc.md)
