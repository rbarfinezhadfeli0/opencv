# Documentation for `docs/samples/python/tutorial_code/imgProc/hough_line_transform/hough_line_transform.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/python/tutorial_code/imgProc/hough_line_transform/hough_line_transform.py_docs.md`
- **File Name**: `hough_line_transform.py_docs.md`
- **File Size**: 3,649 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/python/tutorial_code/imgProc/hough_line_transform/hough_line_transform.py_docs.md](../../../../../../docs/samples/python/tutorial_code/imgProc/hough_line_transform/hough_line_transform.py_docs.md)
