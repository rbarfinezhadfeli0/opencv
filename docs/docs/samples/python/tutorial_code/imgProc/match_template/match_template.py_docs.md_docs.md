# Documentation for `docs/samples/python/tutorial_code/imgProc/match_template/match_template.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/python/tutorial_code/imgProc/match_template/match_template.py_docs.md`
- **File Name**: `match_template.py_docs.md`
- **File Size**: 6,033 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/python/tutorial_code/imgProc/match_template/match_template.py_docs.md](../../../../../../docs/samples/python/tutorial_code/imgProc/match_template/match_template.py_docs.md)

## Purpose and Role

This file is located in the `docs/samples/python/tutorial_code/imgProc/match_template` directory and serves as part of the OpenCV library infrastructure.
