# Documentation for `docs/samples/python/tutorial_code/imgcodecs/`
...
**Path**: `docs/samples/python/tutorial_code/imgcodecs/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[animations.py_docs.md](animations.py_docs.md_docs.md)**: MD file
- **[animations.py_kw.md](animations.py_kw.md_docs.md)**: MD file
