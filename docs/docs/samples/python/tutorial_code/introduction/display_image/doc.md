# Documentation for `docs/samples/python/tutorial_code/introduction/display_image/`
...
**Path**: `docs/samples/python/tutorial_code/introduction/display_image/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[display_image.py_docs.md](display_image.py_docs.md_docs.md)**: MD file
- **[display_image.py_kw.md](display_image.py_kw.md_docs.md)**: MD file
