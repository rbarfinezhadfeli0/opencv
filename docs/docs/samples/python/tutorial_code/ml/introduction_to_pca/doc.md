# Documentation for `docs/samples/python/tutorial_code/ml/introduction_to_pca/`
...
**Path**: `docs/samples/python/tutorial_code/ml/introduction_to_pca/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[introduction_to_pca.py_kw.md](introduction_to_pca.py_kw.md_docs.md)**: MD file
- **[introduction_to_pca.py_docs.md](introduction_to_pca.py_docs.md_docs.md)**: MD file
