# Documentation for `docs/samples/python/tutorial_code/ml/non_linear_svms/`
...
**Path**: `docs/samples/python/tutorial_code/ml/non_linear_svms/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[non_linear_svms.py_kw.md](non_linear_svms.py_kw.md_docs.md)**: MD file
- **[non_linear_svms.py_docs.md](non_linear_svms.py_docs.md_docs.md)**: MD file
