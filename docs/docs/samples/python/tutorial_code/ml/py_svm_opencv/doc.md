# Documentation for `docs/samples/python/tutorial_code/ml/py_svm_opencv/`
...
**Path**: `docs/samples/python/tutorial_code/ml/py_svm_opencv/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[hogsvm.py_kw.md](hogsvm.py_kw.md_docs.md)**: MD file
- **[hogsvm.py_docs.md](hogsvm.py_docs.md_docs.md)**: MD file
