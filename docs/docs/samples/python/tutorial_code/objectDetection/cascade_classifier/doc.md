# Documentation for `docs/samples/python/tutorial_code/objectDetection/cascade_classifier/`
...
**Path**: `docs/samples/python/tutorial_code/objectDetection/cascade_classifier/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[objectDetection.py_kw.md](objectDetection.py_kw.md_docs.md)**: MD file
- **[objectDetection.py_docs.md](objectDetection.py_docs.md_docs.md)**: MD file
...
- **Parent Folder**: [docs/samples/python/tutorial_code/objectDetection/](../objectDetection/doc.md)
