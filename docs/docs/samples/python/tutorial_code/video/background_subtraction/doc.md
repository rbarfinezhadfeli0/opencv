# Documentation for `docs/samples/python/tutorial_code/video/background_subtraction/`
...
**Path**: `docs/samples/python/tutorial_code/video/background_subtraction/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[bg_sub.py_docs.md](bg_sub.py_docs.md_docs.md)**: MD file
- **[bg_sub.py_kw.md](bg_sub.py_kw.md_docs.md)**: MD file
