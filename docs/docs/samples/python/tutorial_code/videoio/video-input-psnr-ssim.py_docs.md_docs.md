# Documentation for `docs/samples/python/tutorial_code/videoio/video-input-psnr-ssim.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/python/tutorial_code/videoio/video-input-psnr-ssim.py_docs.md`
- **File Name**: `video-input-psnr-ssim.py_docs.md`
- **File Size**: 8,091 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/python/tutorial_code/videoio/video-input-psnr-ssim.py_docs.md](../../../../../docs/samples/python/tutorial_code/videoio/video-input-psnr-ssim.py_docs.md)

## Purpose and Role

This file is located in the `docs/samples/python/tutorial_code/videoio` directory and serves as part of the OpenCV library infrastructure.

## Documentation Content

# Documentation for `samples/python/tutorial_code/videoio/video-input-psnr-ssim.py`

## File Metadata

- **Full Path**: `samples/python/tutorial_code/videoio/video-input-psnr-ssim.py`
- **File Name**: `video-input-psnr-ssim.py`
- **File Size**: 4,773 bytes
- **File Type**: .py
- **Link to Source**: [samples/python/tutorial_code/videoio/video-input-psnr-ssim.py](../../../../samples/python/tutorial_code/videoio/video-input-psnr-ssim.py)

## Purpose and Role

This file is located in the `samples/python/tutorial_code/videoio` directory and serves as part of the OpenCV library infrastructure.
...
- **getMSSISM()**: A function/method defined in this file
- **import()**: A function/method defined in this file
- **getPSNR()**: A function/method defined in this file
