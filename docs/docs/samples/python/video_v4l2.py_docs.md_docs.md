# Documentation for `docs/samples/python/video_v4l2.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/python/video_v4l2.py_docs.md`
- **File Name**: `video_v4l2.py_docs.md`
- **File Size**: 5,378 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/python/video_v4l2.py_docs.md](../../../docs/samples/python/video_v4l2.py_docs.md)
