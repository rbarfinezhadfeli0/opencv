# Documentation for `docs/samples/python/videocapture_obsensor.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/python/videocapture_obsensor.py_docs.md`
- **File Name**: `videocapture_obsensor.py_docs.md`
- **File Size**: 4,064 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/python/videocapture_obsensor.py_docs.md](../../../docs/samples/python/videocapture_obsensor.py_docs.md)
