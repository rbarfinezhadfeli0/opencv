# Documentation for `docs/samples/python/watershed.py_docs.md`

## File Metadata

- **Full Path**: `docs/samples/python/watershed.py_docs.md`
- **File Name**: `watershed.py_docs.md`
- **File Size**: 5,653 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/python/watershed.py_docs.md](../../../docs/samples/python/watershed.py_docs.md)
