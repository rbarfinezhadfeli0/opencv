# Documentation for `docs/samples/samples_utils.cmake_docs.md`

## File Metadata

- **Full Path**: `docs/samples/samples_utils.cmake_docs.md`
- **File Name**: `samples_utils.cmake_docs.md`
- **File Size**: 2,712 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/samples_utils.cmake_docs.md](../../docs/samples/samples_utils.cmake_docs.md)
...
# Documentation for `samples/samples_utils.cmake`

## File Metadata

- **Full Path**: `samples/samples_utils.cmake`
- **File Name**: `samples_utils.cmake`
- **File Size**: 1,773 bytes
- **File Type**: .cmake
- **Link to Source**: [samples/samples_utils.cmake](../samples/samples_utils.cmake)
