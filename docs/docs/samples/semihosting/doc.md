# Documentation for `docs/samples/semihosting/`
...
- **histogram/** - See [histogram/doc.md](histogram/doc.md)
- **include/** - See [include/doc.md](include/doc.md)
- **norm/** - See [norm/doc.md](norm/doc.md)
