# Documentation for `docs/samples/swift/ios/ColorBlobDetection/ColorBlobDetectionDynamic.xcodeproj/project.pbxproj_docs.md`

## File Metadata

- **Full Path**: `docs/samples/swift/ios/ColorBlobDetection/ColorBlobDetectionDynamic.xcodeproj/project.pbxproj_docs.md`
- **File Name**: `project.pbxproj_docs.md`
- **File Size**: 17,739 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/swift/ios/ColorBlobDetection/ColorBlobDetectionDynamic.xcodeproj/project.pbxproj_docs.md](../../../../../../docs/samples/swift/ios/ColorBlobDetection/ColorBlobDetectionDynamic.xcodeproj/project.pbxproj_docs.md)

## Purpose and Role

This file is located in the `docs/samples/swift/ios/ColorBlobDetection/ColorBlobDetectionDynamic.xcodeproj` directory and serves as part of the OpenCV library infrastructure.

## Documentation Content

# Documentation for `samples/swift/ios/ColorBlobDetection/ColorBlobDetectionDynamic.xcodeproj/project.pbxproj`

## File Metadata

- **Full Path**: `samples/swift/ios/ColorBlobDetection/ColorBlobDetectionDynamic.xcodeproj/project.pbxproj`
- **File Name**: `project.pbxproj`
- **File Size**: 16,888 bytes
- **File Type**: .pbxproj
- **Link to Source**: [samples/swift/ios/ColorBlobDetection/ColorBlobDetectionDynamic.xcodeproj/project.pbxproj](../../../../../samples/swift/ios/ColorBlobDetection/ColorBlobDetectionDynamic.xcodeproj/project.pbxproj)

## Purpose and Role

This file is located in the `samples/swift/ios/ColorBlobDetection/ColorBlobDetectionDynamic.xcodeproj` directory and serves as part of the OpenCV library infrastructure.
