# Documentation for `docs/samples/swift/ios/ColorBlobDetection/ColorBlobDetectionDynamic.xcodeproj/project.xcworkspace/`
...
**Path**: `docs/samples/swift/ios/ColorBlobDetection/ColorBlobDetectionDynamic.xcodeproj/project.xcworkspace/`
**Direct Files**: 0
**Subfolders**: 1
...
- **xcshareddata/** - See [xcshareddata/doc.md](xcshareddata/doc.md)
...
- **Parent Folder**: [docs/samples/swift/ios/ColorBlobDetection/ColorBlobDetectionDynamic.xcodeproj/](../ColorBlobDetectionDynamic.xcodeproj/doc.md)

**Subfolders**:
- [xcshareddata/](xcshareddata/doc.md)
