# Documentation for `docs/samples/swift/ios/ColorBlobDetection/ColorBlobDetectionDynamic.xcodeproj/project.xcworkspace/xcshareddata/`
...
**Path**: `docs/samples/swift/ios/ColorBlobDetection/ColorBlobDetectionDynamic.xcodeproj/project.xcworkspace/xcshareddata/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[IDEWorkspaceChecks.plist_kw.md](IDEWorkspaceChecks.plist_kw.md_docs.md)**: MD file
- **[IDEWorkspaceChecks.plist_docs.md](IDEWorkspaceChecks.plist_docs.md_docs.md)**: MD file
...
- **Parent Folder**: [docs/samples/swift/ios/ColorBlobDetection/ColorBlobDetectionDynamic.xcodeproj/project.xcworkspace/](../project.xcworkspace/doc.md)
