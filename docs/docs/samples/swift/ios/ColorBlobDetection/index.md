# Index of `docs/samples/swift/ios/ColorBlobDetection/`

## Overview

This folder is part of the OpenCV repository structure and contains and other repository content.

**Location**: `docs/samples/swift/ios/ColorBlobDetection`
...
- **[ColorBlobDetection/](ColorBlobDetection/index.md)**: Subfolder containing 8 files
- **[ColorBlobDetection.xcodeproj/](ColorBlobDetection.xcodeproj/index.md)**: Subfolder containing 2 files
- **[ColorBlobDetectionDynamic.xcodeproj/](ColorBlobDetectionDynamic.xcodeproj/index.md)**: Subfolder containing 2 files
