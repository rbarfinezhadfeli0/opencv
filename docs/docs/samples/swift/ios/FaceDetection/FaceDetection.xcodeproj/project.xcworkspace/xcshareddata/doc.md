# Documentation for `docs/samples/swift/ios/FaceDetection/FaceDetection.xcodeproj/project.xcworkspace/xcshareddata/`
...
**Path**: `docs/samples/swift/ios/FaceDetection/FaceDetection.xcodeproj/project.xcworkspace/xcshareddata/`
**Direct Files**: 2
**Subfolders**: 0
...
- **Parent Folder**: [docs/samples/swift/ios/FaceDetection/FaceDetection.xcodeproj/project.xcworkspace/](../project.xcworkspace/doc.md)
