# Documentation for `docs/samples/swift/ios/FaceDetection/FaceDetectionDynamic.xcodeproj/project.pbxproj_docs.md`

## File Metadata

- **Full Path**: `docs/samples/swift/ios/FaceDetection/FaceDetectionDynamic.xcodeproj/project.pbxproj_docs.md`
- **File Name**: `project.pbxproj_docs.md`
- **File Size**: 18,943 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/swift/ios/FaceDetection/FaceDetectionDynamic.xcodeproj/project.pbxproj_docs.md](../../../../../../docs/samples/swift/ios/FaceDetection/FaceDetectionDynamic.xcodeproj/project.pbxproj_docs.md)
...
# Documentation for `samples/swift/ios/FaceDetection/FaceDetectionDynamic.xcodeproj/project.pbxproj`

## File Metadata

- **Full Path**: `samples/swift/ios/FaceDetection/FaceDetectionDynamic.xcodeproj/project.pbxproj`
- **File Name**: `project.pbxproj`
- **File Size**: 18,142 bytes
- **File Type**: .pbxproj
- **Link to Source**: [samples/swift/ios/FaceDetection/FaceDetectionDynamic.xcodeproj/project.pbxproj](../../../../../samples/swift/ios/FaceDetection/FaceDetectionDynamic.xcodeproj/project.pbxproj)

## Purpose and Role

This file is located in the `samples/swift/ios/FaceDetection/FaceDetectionDynamic.xcodeproj` directory and serves as part of the OpenCV library infrastructure.
