# Index of `docs/samples/swift/ios/FaceDetection/FaceDetectionDynamic.xcodeproj/project.xcworkspace/`

## Overview

This folder is part of the OpenCV repository structure and contains and other repository content.

**Location**: `docs/samples/swift/ios/FaceDetection/FaceDetectionDynamic.xcodeproj/project.xcworkspace`
