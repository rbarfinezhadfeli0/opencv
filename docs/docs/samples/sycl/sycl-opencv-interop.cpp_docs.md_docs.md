# Documentation for `docs/samples/sycl/sycl-opencv-interop.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/sycl/sycl-opencv-interop.cpp_docs.md`
- **File Name**: `sycl-opencv-interop.cpp_docs.md`
- **File Size**: 12,553 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/sycl/sycl-opencv-interop.cpp_docs.md](../../../docs/samples/sycl/sycl-opencv-interop.cpp_docs.md)
