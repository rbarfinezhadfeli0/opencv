# Documentation for `docs/samples/tapi/bgfg_segm.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/tapi/bgfg_segm.cpp_docs.md`
- **File Name**: `bgfg_segm.cpp_docs.md`
- **File Size**: 6,042 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/tapi/bgfg_segm.cpp_docs.md](../../../docs/samples/tapi/bgfg_segm.cpp_docs.md)
