# Documentation for `docs/samples/tapi/hog.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/tapi/hog.cpp_docs.md`
- **File Name**: `hog.cpp_docs.md`
- **File Size**: 12,939 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/tapi/hog.cpp_docs.md](../../../docs/samples/tapi/hog.cpp_docs.md)
...
# Documentation for `samples/tapi/hog.cpp`

## File Metadata

- **Full Path**: `samples/tapi/hog.cpp`
- **File Name**: `hog.cpp`
- **File Size**: 9,790 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/tapi/hog.cpp](../../samples/tapi/hog.cpp)
