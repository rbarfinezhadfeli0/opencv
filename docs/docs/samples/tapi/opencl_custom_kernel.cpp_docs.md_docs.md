# Documentation for `docs/samples/tapi/opencl_custom_kernel.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/tapi/opencl_custom_kernel.cpp_docs.md`
- **File Name**: `opencl_custom_kernel.cpp_docs.md`
- **File Size**: 8,513 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/tapi/opencl_custom_kernel.cpp_docs.md](../../../docs/samples/tapi/opencl_custom_kernel.cpp_docs.md)
...
# Documentation for `samples/tapi/opencl_custom_kernel.cpp`

## File Metadata

- **Full Path**: `samples/tapi/opencl_custom_kernel.cpp`
- **File Name**: `opencl_custom_kernel.cpp`
- **File Size**: 5,474 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/tapi/opencl_custom_kernel.cpp](../../samples/tapi/opencl_custom_kernel.cpp)
