# Documentation for `docs/samples/tapi/squares.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/tapi/squares.cpp_docs.md`
- **File Name**: `squares.cpp_docs.md`
- **File Size**: 9,463 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/tapi/squares.cpp_docs.md](../../../docs/samples/tapi/squares.cpp_docs.md)
...
# Documentation for `samples/tapi/squares.cpp`

## File Metadata

- **Full Path**: `samples/tapi/squares.cpp`
- **File Name**: `squares.cpp`
- **File Size**: 6,338 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/tapi/squares.cpp](../../samples/tapi/squares.cpp)
