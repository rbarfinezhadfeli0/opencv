# Documentation for `docs/samples/tapi/ufacedetect.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/tapi/ufacedetect.cpp_docs.md`
- **File Name**: `ufacedetect.cpp_docs.md`
- **File Size**: 11,864 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/tapi/ufacedetect.cpp_docs.md](../../../docs/samples/tapi/ufacedetect.cpp_docs.md)
...
# Documentation for `samples/tapi/ufacedetect.cpp`

## File Metadata

- **Full Path**: `samples/tapi/ufacedetect.cpp`
- **File Name**: `ufacedetect.cpp`
- **File Size**: 8,859 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/tapi/ufacedetect.cpp](../../samples/tapi/ufacedetect.cpp)
