# Documentation for `docs/samples/va_intel/CMakeLists.txt_docs.md`

## File Metadata

- **Full Path**: `docs/samples/va_intel/CMakeLists.txt_docs.md`
- **File Name**: `CMakeLists.txt_docs.md`
- **File Size**: 1,675 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/va_intel/CMakeLists.txt_docs.md](../../../docs/samples/va_intel/CMakeLists.txt_docs.md)
