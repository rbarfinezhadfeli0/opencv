# Documentation for `docs/samples/va_intel/display.cpp.inc_docs.md`

## File Metadata

- **Full Path**: `docs/samples/va_intel/display.cpp.inc_docs.md`
- **File Name**: `display.cpp.inc_docs.md`
- **File Size**: 6,355 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/va_intel/display.cpp.inc_docs.md](../../../docs/samples/va_intel/display.cpp.inc_docs.md)
...
# Documentation for `samples/va_intel/display.cpp.inc`

## File Metadata

- **Full Path**: `samples/va_intel/display.cpp.inc`
- **File Name**: `display.cpp.inc`
- **File Size**: 5,798 bytes
- **File Type**: .inc
- **Link to Source**: [samples/va_intel/display.cpp.inc](../../samples/va_intel/display.cpp.inc)
