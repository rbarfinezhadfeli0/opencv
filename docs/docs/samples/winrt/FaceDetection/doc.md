# Documentation for `docs/samples/winrt/FaceDetection/`
...
**Path**: `docs/samples/winrt/FaceDetection/`
**Direct Files**: 2
**Subfolders**: 1
...
- **[FaceDetection.sln_kw.md](FaceDetection.sln_kw.md_docs.md)**: MD file
- **[FaceDetection.sln_docs.md](FaceDetection.sln_docs.md_docs.md)**: MD file
