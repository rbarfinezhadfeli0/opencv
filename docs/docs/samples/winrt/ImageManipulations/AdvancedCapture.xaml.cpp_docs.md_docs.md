# Documentation for `docs/samples/winrt/ImageManipulations/AdvancedCapture.xaml.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/winrt/ImageManipulations/AdvancedCapture.xaml.cpp_docs.md`
- **File Name**: `AdvancedCapture.xaml.cpp_docs.md`
- **File Size**: 27,075 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/winrt/ImageManipulations/AdvancedCapture.xaml.cpp_docs.md](../../../../docs/samples/winrt/ImageManipulations/AdvancedCapture.xaml.cpp_docs.md)
...
# Documentation for `samples/winrt/ImageManipulations/AdvancedCapture.xaml.cpp`

## File Metadata

- **Full Path**: `samples/winrt/ImageManipulations/AdvancedCapture.xaml.cpp`
- **File Name**: `AdvancedCapture.xaml.cpp`
- **File Size**: 23,942 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/winrt/ImageManipulations/AdvancedCapture.xaml.cpp](../../../samples/winrt/ImageManipulations/AdvancedCapture.xaml.cpp)
...
- **ReencodeState**: A class/struct defined in this file
