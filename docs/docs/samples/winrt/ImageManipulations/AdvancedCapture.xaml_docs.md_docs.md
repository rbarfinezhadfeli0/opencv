# Documentation for `docs/samples/winrt/ImageManipulations/AdvancedCapture.xaml_docs.md`

## File Metadata

- **Full Path**: `docs/samples/winrt/ImageManipulations/AdvancedCapture.xaml_docs.md`
- **File Name**: `AdvancedCapture.xaml_docs.md`
- **File Size**: 4,658 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/winrt/ImageManipulations/AdvancedCapture.xaml_docs.md](../../../../docs/samples/winrt/ImageManipulations/AdvancedCapture.xaml_docs.md)
...
# Documentation for `samples/winrt/ImageManipulations/AdvancedCapture.xaml`

## File Metadata

- **Full Path**: `samples/winrt/ImageManipulations/AdvancedCapture.xaml`
- **File Name**: `AdvancedCapture.xaml`
- **File Size**: 3,992 bytes
- **File Type**: .xaml
- **Link to Source**: [samples/winrt/ImageManipulations/AdvancedCapture.xaml](../../../samples/winrt/ImageManipulations/AdvancedCapture.xaml)
