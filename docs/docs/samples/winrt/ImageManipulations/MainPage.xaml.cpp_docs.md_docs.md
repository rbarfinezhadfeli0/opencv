# Documentation for `docs/samples/winrt/ImageManipulations/MainPage.xaml.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/winrt/ImageManipulations/MainPage.xaml.cpp_docs.md`
- **File Name**: `MainPage.xaml.cpp_docs.md`
- **File Size**: 14,284 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/winrt/ImageManipulations/MainPage.xaml.cpp_docs.md](../../../../docs/samples/winrt/ImageManipulations/MainPage.xaml.cpp_docs.md)
...
# Documentation for `samples/winrt/ImageManipulations/MainPage.xaml.cpp`

## File Metadata

- **Full Path**: `samples/winrt/ImageManipulations/MainPage.xaml.cpp`
- **File Name**: `MainPage.xaml.cpp`
- **File Size**: 11,212 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/winrt/ImageManipulations/MainPage.xaml.cpp](../../../samples/winrt/ImageManipulations/MainPage.xaml.cpp)
