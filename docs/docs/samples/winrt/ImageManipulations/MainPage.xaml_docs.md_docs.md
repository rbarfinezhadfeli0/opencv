# Documentation for `docs/samples/winrt/ImageManipulations/MainPage.xaml_docs.md`

## File Metadata

- **Full Path**: `docs/samples/winrt/ImageManipulations/MainPage.xaml_docs.md`
- **File Name**: `MainPage.xaml_docs.md`
- **File Size**: 8,901 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/winrt/ImageManipulations/MainPage.xaml_docs.md](../../../../docs/samples/winrt/ImageManipulations/MainPage.xaml_docs.md)
...
# Documentation for `samples/winrt/ImageManipulations/MainPage.xaml`

## File Metadata

- **Full Path**: `samples/winrt/ImageManipulations/MainPage.xaml`
- **File Name**: `MainPage.xaml`
- **File Size**: 8,270 bytes
- **File Type**: .xaml
- **Link to Source**: [samples/winrt/ImageManipulations/MainPage.xaml](../../../samples/winrt/ImageManipulations/MainPage.xaml)
