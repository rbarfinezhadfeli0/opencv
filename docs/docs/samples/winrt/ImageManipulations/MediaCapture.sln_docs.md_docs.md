# Documentation for `docs/samples/winrt/ImageManipulations/MediaCapture.sln_docs.md`

## File Metadata

- **Full Path**: `docs/samples/winrt/ImageManipulations/MediaCapture.sln_docs.md`
- **File Name**: `MediaCapture.sln_docs.md`
- **File Size**: 3,817 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/winrt/ImageManipulations/MediaCapture.sln_docs.md](../../../../docs/samples/winrt/ImageManipulations/MediaCapture.sln_docs.md)
...
# Documentation for `samples/winrt/ImageManipulations/MediaCapture.sln`

## File Metadata

- **Full Path**: `samples/winrt/ImageManipulations/MediaCapture.sln`
- **File Name**: `MediaCapture.sln`
- **File Size**: 3,226 bytes
- **File Type**: .sln
- **Link to Source**: [samples/winrt/ImageManipulations/MediaCapture.sln](../../../samples/winrt/ImageManipulations/MediaCapture.sln)
