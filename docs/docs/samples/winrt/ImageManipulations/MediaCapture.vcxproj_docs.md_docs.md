# Documentation for `docs/samples/winrt/ImageManipulations/MediaCapture.vcxproj_docs.md`

## File Metadata

- **Full Path**: `docs/samples/winrt/ImageManipulations/MediaCapture.vcxproj_docs.md`
- **File Name**: `MediaCapture.vcxproj_docs.md`
- **File Size**: 11,458 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/winrt/ImageManipulations/MediaCapture.vcxproj_docs.md](../../../../docs/samples/winrt/ImageManipulations/MediaCapture.vcxproj_docs.md)
...
# Documentation for `samples/winrt/ImageManipulations/MediaCapture.vcxproj`

## File Metadata

- **Full Path**: `samples/winrt/ImageManipulations/MediaCapture.vcxproj`
- **File Name**: `MediaCapture.vcxproj`
- **File Size**: 10,987 bytes
- **File Type**: .vcxproj
- **Link to Source**: [samples/winrt/ImageManipulations/MediaCapture.vcxproj](../../../samples/winrt/ImageManipulations/MediaCapture.vcxproj)
