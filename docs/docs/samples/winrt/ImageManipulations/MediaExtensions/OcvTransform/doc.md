# Documentation for `docs/samples/winrt/ImageManipulations/MediaExtensions/OcvTransform/`
...
**Path**: `docs/samples/winrt/ImageManipulations/MediaExtensions/OcvTransform/`
**Direct Files**: 14
**Subfolders**: 0
...
- **[dllmain.cpp_docs.md](dllmain.cpp_docs.md_docs.md)**: Main entry point
- **[dllmain.cpp_kw.md](dllmain.cpp_kw.md_docs.md)**: Main entry point
