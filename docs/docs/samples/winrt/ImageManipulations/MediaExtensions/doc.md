# Documentation for `docs/samples/winrt/ImageManipulations/MediaExtensions/`
...
**Path**: `docs/samples/winrt/ImageManipulations/MediaExtensions/`
**Direct Files**: 0
**Subfolders**: 2
...
- **OcvTransform/** - See [OcvTransform/doc.md](OcvTransform/doc.md)
