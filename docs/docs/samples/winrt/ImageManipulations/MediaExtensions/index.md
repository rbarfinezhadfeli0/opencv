# Index of `docs/samples/winrt/ImageManipulations/MediaExtensions/`

## Overview

This folder is part of the OpenCV repository structure and contains and other repository content.

**Location**: `docs/samples/winrt/ImageManipulations/MediaExtensions`
...
- **[Common/](Common/index.md)**: Subfolder containing 10 files
- **[OcvTransform/](OcvTransform/index.md)**: Subfolder containing 14 files
