# Documentation for `docs/samples/winrt/ImageManipulations/common/LayoutAwarePage.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/winrt/ImageManipulations/common/LayoutAwarePage.cpp_docs.md`
- **File Name**: `LayoutAwarePage.cpp_docs.md`
- **File Size**: 21,255 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/winrt/ImageManipulations/common/LayoutAwarePage.cpp_docs.md](../../../../../docs/samples/winrt/ImageManipulations/common/LayoutAwarePage.cpp_docs.md)
...
# Documentation for `samples/winrt/ImageManipulations/common/LayoutAwarePage.cpp`

## File Metadata

- **Full Path**: `samples/winrt/ImageManipulations/common/LayoutAwarePage.cpp`
- **File Name**: `LayoutAwarePage.cpp`
- **File Size**: 18,120 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/winrt/ImageManipulations/common/LayoutAwarePage.cpp](../../../../samples/winrt/ImageManipulations/common/LayoutAwarePage.cpp)
