# Documentation for `docs/samples/winrt/ImageManipulations/common/suspensionmanager.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/winrt/ImageManipulations/common/suspensionmanager.cpp_docs.md`
- **File Name**: `suspensionmanager.cpp_docs.md`
- **File Size**: 21,607 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/winrt/ImageManipulations/common/suspensionmanager.cpp_docs.md](../../../../../docs/samples/winrt/ImageManipulations/common/suspensionmanager.cpp_docs.md)
...
# Documentation for `samples/winrt/ImageManipulations/common/suspensionmanager.cpp`

## File Metadata

- **Full Path**: `samples/winrt/ImageManipulations/common/suspensionmanager.cpp`
- **File Name**: `suspensionmanager.cpp`
- **File Size**: 18,385 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/winrt/ImageManipulations/common/suspensionmanager.cpp](../../../../samples/winrt/ImageManipulations/common/suspensionmanager.cpp)
...
- **WeakFrame**: A class/struct defined in this file
