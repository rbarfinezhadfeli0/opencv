# Keyword Map for `docs/samples/winrt/ImageManipulations/opencv.props_docs.md`

## File Path and Links

- **Source File**: [docs/samples/winrt/ImageManipulations/opencv.props_docs.md](../../../../docs/samples/winrt/ImageManipulations/opencv.props_docs.md)
- **Documentation**: [docs/samples/winrt/ImageManipulations/opencv.props_docs.md_docs.md](opencv.props_docs.md_docs.md)
