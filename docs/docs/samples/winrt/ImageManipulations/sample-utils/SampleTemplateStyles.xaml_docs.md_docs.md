# Documentation for `docs/samples/winrt/ImageManipulations/sample-utils/SampleTemplateStyles.xaml_docs.md`

## File Metadata

- **Full Path**: `docs/samples/winrt/ImageManipulations/sample-utils/SampleTemplateStyles.xaml_docs.md`
- **File Name**: `SampleTemplateStyles.xaml_docs.md`
- **File Size**: 2,954 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/winrt/ImageManipulations/sample-utils/SampleTemplateStyles.xaml_docs.md](../../../../../docs/samples/winrt/ImageManipulations/sample-utils/SampleTemplateStyles.xaml_docs.md)
