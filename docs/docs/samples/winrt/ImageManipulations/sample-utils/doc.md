# Documentation for `docs/samples/winrt/ImageManipulations/sample-utils/`
...
**Path**: `docs/samples/winrt/ImageManipulations/sample-utils/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[SampleTemplateStyles.xaml_kw.md](SampleTemplateStyles.xaml_kw.md_docs.md)**: MD file
- **[SampleTemplateStyles.xaml_docs.md](SampleTemplateStyles.xaml_docs.md_docs.md)**: MD file
