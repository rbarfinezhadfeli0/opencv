# Documentation for `docs/samples/winrt/JavaScript/MediaCaptureJavaScript.jsproj_docs.md`

## File Metadata

- **Full Path**: `docs/samples/winrt/JavaScript/MediaCaptureJavaScript.jsproj_docs.md`
- **File Name**: `MediaCaptureJavaScript.jsproj_docs.md`
- **File Size**: 6,346 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/winrt/JavaScript/MediaCaptureJavaScript.jsproj_docs.md](../../../../docs/samples/winrt/JavaScript/MediaCaptureJavaScript.jsproj_docs.md)
...
# Documentation for `samples/winrt/JavaScript/MediaCaptureJavaScript.jsproj`

## File Metadata

- **Full Path**: `samples/winrt/JavaScript/MediaCaptureJavaScript.jsproj`
- **File Name**: `MediaCaptureJavaScript.jsproj`
- **File Size**: 5,673 bytes
- **File Type**: .jsproj
- **Link to Source**: [samples/winrt/JavaScript/MediaCaptureJavaScript.jsproj](../../../samples/winrt/JavaScript/MediaCaptureJavaScript.jsproj)
