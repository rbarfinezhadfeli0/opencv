# Documentation for `docs/samples/winrt/JavaScript/html/`
...
**Path**: `docs/samples/winrt/JavaScript/html/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[AdvancedCapture.html_kw.md](AdvancedCapture.html_kw.md_docs.md)**: MD file
- **[AdvancedCapture.html_docs.md](AdvancedCapture.html_docs.md_docs.md)**: MD file
