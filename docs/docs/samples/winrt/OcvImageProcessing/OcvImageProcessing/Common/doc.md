# Documentation for `docs/samples/winrt/OcvImageProcessing/OcvImageProcessing/Common/`
...
**Path**: `docs/samples/winrt/OcvImageProcessing/OcvImageProcessing/Common/`
**Direct Files**: 2
**Subfolders**: 0
...
- **Parent Folder**: [docs/samples/winrt/OcvImageProcessing/OcvImageProcessing/](../OcvImageProcessing/doc.md)
