# Documentation for `docs/samples/winrt/OcvImageProcessing/OcvImageProcessing/MainPage.xaml.cpp_docs.md`

## File Metadata

- **Full Path**: `docs/samples/winrt/OcvImageProcessing/OcvImageProcessing/MainPage.xaml.cpp_docs.md`
- **File Name**: `MainPage.xaml.cpp_docs.md`
- **File Size**: 11,778 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/winrt/OcvImageProcessing/OcvImageProcessing/MainPage.xaml.cpp_docs.md](../../../../../docs/samples/winrt/OcvImageProcessing/OcvImageProcessing/MainPage.xaml.cpp_docs.md)
