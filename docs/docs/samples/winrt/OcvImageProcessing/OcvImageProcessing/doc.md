# Documentation for `docs/samples/winrt/OcvImageProcessing/OcvImageProcessing/`
...
**Path**: `docs/samples/winrt/OcvImageProcessing/OcvImageProcessing/`
**Direct Files**: 26
**Subfolders**: 2
...
- **Parent Folder**: [docs/samples/winrt/OcvImageProcessing/](../OcvImageProcessing/doc.md)
