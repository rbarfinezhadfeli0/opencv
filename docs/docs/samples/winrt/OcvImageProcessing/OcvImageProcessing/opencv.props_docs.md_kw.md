# Keyword Map for `docs/samples/winrt/OcvImageProcessing/OcvImageProcessing/opencv.props_docs.md`

## File Path and Links

- **Source File**: [docs/samples/winrt/OcvImageProcessing/OcvImageProcessing/opencv.props_docs.md](../../../../../docs/samples/winrt/OcvImageProcessing/OcvImageProcessing/opencv.props_docs.md)
- **Documentation**: [docs/samples/winrt/OcvImageProcessing/OcvImageProcessing/opencv.props_docs.md_docs.md](opencv.props_docs.md_docs.md)
...
- **OcvImageProcessing**: Technical term or identifier found in [opencv.props_docs.md](opencv.props_docs.md_docs.md)
