# Documentation for `docs/samples/winrt_universal/PhoneTutorial/Assets/`
...
**Path**: `docs/samples/winrt_universal/PhoneTutorial/Assets/`
**Direct Files**: 0
**Subfolders**: 0
...
- **Parent Folder**: [docs/samples/winrt_universal/PhoneTutorial/](../PhoneTutorial/doc.md)
