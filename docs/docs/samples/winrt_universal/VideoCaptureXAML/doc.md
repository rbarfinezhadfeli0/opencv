# Documentation for `docs/samples/winrt_universal/VideoCaptureXAML/`
...
**Path**: `docs/samples/winrt_universal/VideoCaptureXAML/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [docs/samples/winrt_universal/](../winrt_universal/doc.md)
