# Documentation for `docs/samples/wp8/OcvImageManipulation/ImageManipulation.sln_docs.md`

## File Metadata

- **Full Path**: `docs/samples/wp8/OcvImageManipulation/ImageManipulation.sln_docs.md`
- **File Name**: `ImageManipulation.sln_docs.md`
- **File Size**: 5,632 bytes
- **File Type**: .md
- **Link to Source**: [docs/samples/wp8/OcvImageManipulation/ImageManipulation.sln_docs.md](../../../../docs/samples/wp8/OcvImageManipulation/ImageManipulation.sln_docs.md)
...
# Documentation for `samples/wp8/OcvImageManipulation/ImageManipulation.sln`

## File Metadata

- **Full Path**: `samples/wp8/OcvImageManipulation/ImageManipulation.sln`
- **File Name**: `ImageManipulation.sln`
- **File Size**: 5,038 bytes
- **File Type**: .sln
- **Link to Source**: [samples/wp8/OcvImageManipulation/ImageManipulation.sln](../../../samples/wp8/OcvImageManipulation/ImageManipulation.sln)

## Purpose and Role

This file is located in the `samples/wp8/OcvImageManipulation` directory and serves as part of the OpenCV library infrastructure.
