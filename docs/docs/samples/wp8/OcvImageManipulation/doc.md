# Documentation for `docs/samples/wp8/OcvImageManipulation/`
...
**Path**: `docs/samples/wp8/OcvImageManipulation/`
**Direct Files**: 2
**Subfolders**: 1
...
- **[ImageManipulation.sln_docs.md](ImageManipulation.sln_docs.md_docs.md)**: MD file
- **[ImageManipulation.sln_kw.md](ImageManipulation.sln_kw.md_docs.md)**: MD file
...
- **PhoneXamlDirect3DApp1/** - See [PhoneXamlDirect3DApp1/doc.md](PhoneXamlDirect3DApp1/doc.md)
...
- **Parent Folder**: [docs/samples/wp8/](../wp8/doc.md)

**Sibling Folders**:
- [OcvRotatingCube/](../OcvRotatingCube/doc.md)
- [OpenCVXaml/](../OpenCVXaml/doc.md)
