# Documentation for `docs/samples/wp8/OcvRotatingCube/PhoneXamlDirect3DApp1/`
...
**Path**: `docs/samples/wp8/OcvRotatingCube/PhoneXamlDirect3DApp1/`
**Direct Files**: 0
**Subfolders**: 2
...
- **Parent Folder**: [docs/samples/wp8/OcvRotatingCube/](../OcvRotatingCube/doc.md)
