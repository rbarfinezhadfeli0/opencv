# Documentation for `docs/samples/wp8/OcvRotatingCube/`
...
**Path**: `docs/samples/wp8/OcvRotatingCube/`
**Direct Files**: 2
**Subfolders**: 1
...
- **[OcvRotatingCube.sln_kw.md](OcvRotatingCube.sln_kw.md_docs.md)**: MD file
- **[OcvRotatingCube.sln_docs.md](OcvRotatingCube.sln_docs.md_docs.md)**: MD file
...
**Sibling Folders**:
- [OcvImageManipulation/](../OcvImageManipulation/doc.md)
