# Documentation for `docs/samples/wp8/OpenCVXaml/`
...
**Path**: `docs/samples/wp8/OpenCVXaml/`
**Direct Files**: 2
**Subfolders**: 2
...
- **[OpenCVXaml.sln_docs.md](OpenCVXaml.sln_docs.md_docs.md)**: MD file
- **[OpenCVXaml.sln_kw.md](OpenCVXaml.sln_kw.md_docs.md)**: MD file
...
- **OpenCVComponent/** - See [OpenCVComponent/doc.md](OpenCVComponent/doc.md)
