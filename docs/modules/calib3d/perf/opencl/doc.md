# Documentation for `modules/calib3d/perf/opencl/`
...
**Path**: `modules/calib3d/perf/opencl/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[perf_stereobm.cpp](perf_stereobm.cpp_docs.md)**: CPP file
...
- **Parent Folder**: [modules/calib3d/perf/](../perf/doc.md)
