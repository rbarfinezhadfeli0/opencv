# Documentation for `modules/calib3d/src/ap3p.cpp`

## File Metadata

- **Full Path**: `modules/calib3d/src/ap3p.cpp`
- **File Name**: `ap3p.cpp`
- **File Size**: 14,472 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/calib3d/src/ap3p.cpp](../../../modules/calib3d/src/ap3p.cpp)
