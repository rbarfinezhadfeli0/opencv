# Documentation for `modules/calib3d/src/chessboard.hpp`

## File Metadata

- **Full Path**: `modules/calib3d/src/chessboard.hpp`
- **File Name**: `chessboard.hpp`
- **File Size**: 36,581 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/calib3d/src/chessboard.hpp](../../../modules/calib3d/src/chessboard.hpp)
...
- **Cell**: A class/struct defined in this file
- **FastX**: A class/struct defined in this file
- **Ellipse**: A class/struct defined in this file
- **Parameters**: A class/struct defined in this file
- **Chessboard**: A class/struct defined in this file
- **PointIter**: A class/struct defined in this file

### Functions and Methods

- **CHESSBOARD_HPP_()**: A function/method defined in this file
