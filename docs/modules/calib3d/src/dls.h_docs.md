# Documentation for `modules/calib3d/src/dls.h`

## File Metadata

- **Full Path**: `modules/calib3d/src/dls.h`
- **File Name**: `dls.h`
- **File Size**: 26,404 bytes
- **File Type**: .h
- **Link to Source**: [modules/calib3d/src/dls.h](../../../modules/calib3d/src/dls.h)
...
- **dls**: A class/struct defined in this file
- **EigenvalueDecomposition**: A class/struct defined in this file

### Functions and Methods

- **is()**: A function/method defined in this file
- **DLS_H_()**: A function/method defined in this file
