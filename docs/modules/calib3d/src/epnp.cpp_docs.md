# Documentation for `modules/calib3d/src/epnp.cpp`

## File Metadata

- **Full Path**: `modules/calib3d/src/epnp.cpp`
- **File Name**: `epnp.cpp`
- **File Size**: 16,640 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/calib3d/src/epnp.cpp](../../../modules/calib3d/src/epnp.cpp)
