# Documentation for `modules/calib3d/src/p3p.h`

## File Metadata

- **Full Path**: `modules/calib3d/src/p3p.h`
- **File Name**: `p3p.h`
- **File Size**: 396 bytes
- **File Type**: .h
- **Link to Source**: [modules/calib3d/src/p3p.h](../../../modules/calib3d/src/p3p.h)
...
- **p3p**: A class/struct defined in this file

### Functions and Methods

- **P3P_H()**: A function/method defined in this file
