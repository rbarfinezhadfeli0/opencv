# Documentation for `modules/calib3d/src/polynom_solver.cpp`

## File Metadata

- **Full Path**: `modules/calib3d/src/polynom_solver.cpp`
- **File Name**: `polynom_solver.cpp`
- **File Size**: 3,952 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/calib3d/src/polynom_solver.cpp](../../../modules/calib3d/src/polynom_solver.cpp)
