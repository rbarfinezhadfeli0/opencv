# Documentation for `modules/calib3d/src/polynom_solver.h`

## File Metadata

- **Full Path**: `modules/calib3d/src/polynom_solver.h`
- **File Name**: `polynom_solver.h`
- **File Size**: 396 bytes
- **File Type**: .h
- **Link to Source**: [modules/calib3d/src/polynom_solver.h](../../../modules/calib3d/src/polynom_solver.h)
...
- **POLYNOM_SOLVER_H()**: A function/method defined in this file
