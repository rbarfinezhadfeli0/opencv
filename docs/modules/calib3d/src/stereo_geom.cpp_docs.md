# Documentation for `modules/calib3d/src/stereo_geom.cpp`

## File Metadata

- **Full Path**: `modules/calib3d/src/stereo_geom.cpp`
- **File Name**: `stereo_geom.cpp`
- **File Size**: 23,783 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/calib3d/src/stereo_geom.cpp](../../../modules/calib3d/src/stereo_geom.cpp)
