# Documentation for `modules/calib3d/src/usac.hpp`

## File Metadata

- **Full Path**: `modules/calib3d/src/usac.hpp`
- **File Name**: `usac.hpp`
- **File Size**: 43,362 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/calib3d/src/usac.hpp](../../../modules/calib3d/src/usac.hpp)
...
- **EpipolarNonMinimalSolver**: A class/struct defined in this file
- **class**: A class/struct defined in this file
- **FundamentalMinimalSolver8pts**: A class/struct defined in this file
- **NormTransform**: A class/struct defined in this file
- **EssentialEstimator**: A class/struct defined in this file
- **TrifocalTensorMinimalSolver**: A class/struct defined in this file
- **LMedsQuality**: A class/struct defined in this file
- **PnPEstimator**: A class/struct defined in this file
- **HomographyNonMinimalSolver**: A class/struct defined in this file
- **P3PSolver**: A class/struct defined in this file
- **PnPMinimalSolver6Pts**: A class/struct defined in this file
- **SymmetricGeometricDistance**: A class/struct defined in this file
- **HomographyEstimator**: A class/struct defined in this file
- **ModelVerifier**: A class/struct defined in this file
- **MinimalSolver**: A class/struct defined in this file
- **Score**: A class/struct defined in this file
- **EssentialMinimalSolver5pts**: A class/struct defined in this file
- **GammaValues**: A class/struct defined in this file
- **FundamentalDegeneracy**: A class/struct defined in this file
- **ReprojectionErrorPmatrix**: A class/struct defined in this file
- **NonMinimalSolver**: A class/struct defined in this file
- **EssentialNonMinimalSolverViaF**: A class/struct defined in this file
- **EssentialDegeneracy**: A class/struct defined in this file
- **FundamentalEstimator**: A class/struct defined in this file
- **AffineEstimator**: A class/struct defined in this file
- **AffineNonMinimalSolver**: A class/struct defined in this file
- **MagsacQuality**: A class/struct defined in this file
- **LarssonOptimizer**: A class/struct defined in this file
- **FundamentalMinimalSolver7pts**: A class/struct defined in this file
- **EpipolarGeometryDegeneracy**: A class/struct defined in this file
- **PnPNonMinimalSolver**: A class/struct defined in this file
- **AdaptiveSPRT**: A class/struct defined in this file
- **EssentialNonMinimalSolverViaT**: A class/struct defined in this file
- **ReprojectionErrorSymmetric**: A class/struct defined in this file
- **ReprojectionErrorAffine**: A class/struct defined in this file
- **HomographyMinimalSolver4pts**: A class/struct defined in this file
- **SPRT_history**: A class/struct defined in this file
- **MsacQuality**: A class/struct defined in this file
- **FundamentalDegeneracyViaE**: A class/struct defined in this file
- **Quality**: A class/struct defined in this file
- **SampsonError**: A class/struct defined in this file
- **DLSPnP**: A class/struct defined in this file
- **TrifocalTensorReprError**: A class/struct defined in this file
- **Estimator**: A class/struct defined in this file
- **RansacQuality**: A class/struct defined in this file
- **PnPSVDSolver**: A class/struct defined in this file
- **AffineMinimalSolver**: A class/struct defined in this file
- **ReprojectionErrorForward**: A class/struct defined in this file
- **HomographyDegeneracy**: A class/struct defined in this file
- **Degeneracy**: A class/struct defined in this file

### Functions and Methods

- **std()**: A function/method defined in this file
- **OPENCV_USAC_USAC_HPP()**: A function/method defined in this file
- **of()**: A function/method defined in this file
- **virtual()**: A function/method defined in this file
