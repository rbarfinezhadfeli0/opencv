# Documentation for `modules/calib3d/src/usac/degeneracy.cpp`

## File Metadata

- **Full Path**: `modules/calib3d/src/usac/degeneracy.cpp`
- **File Name**: `degeneracy.cpp`
- **File Size**: 36,021 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/calib3d/src/usac/degeneracy.cpp](../../../../modules/calib3d/src/usac/degeneracy.cpp)
...
- **EssentialDegeneracyImpl**: A class/struct defined in this file
- **HomographyDegeneracyImpl**: A class/struct defined in this file
- **FundamentalDegeneracyImpl**: A class/struct defined in this file
- **FundamentalDegeneracyViaEImpl**: A class/struct defined in this file
- **EpipolarGeometryDegeneracyImpl**: A class/struct defined in this file
