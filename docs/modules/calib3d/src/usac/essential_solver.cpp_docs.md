# Documentation for `modules/calib3d/src/usac/essential_solver.cpp`

## File Metadata

- **Full Path**: `modules/calib3d/src/usac/essential_solver.cpp`
- **File Name**: `essential_solver.cpp`
- **File Size**: 27,454 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/calib3d/src/usac/essential_solver.cpp](../../../../modules/calib3d/src/usac/essential_solver.cpp)
...
- **EssentialMinimalSolver5ptsImpl**: A class/struct defined in this file
