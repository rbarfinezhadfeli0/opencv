# Documentation for `modules/calib3d/src/usac/estimator.cpp`

## File Metadata

- **Full Path**: `modules/calib3d/src/usac/estimator.cpp`
- **File Name**: `estimator.cpp`
- **File Size**: 29,422 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/calib3d/src/usac/estimator.cpp](../../../../modules/calib3d/src/usac/estimator.cpp)

## Purpose and Role

This file is located in the `modules/calib3d/src/usac` directory and serves as part of the OpenCV library infrastructure.
...
- **ReprojectionErrorForwardImpl**: A class/struct defined in this file
- **SampsonErrorImpl**: A class/struct defined in this file
- **NormTransformImpl**: A class/struct defined in this file
- **EssentialEstimatorImpl**: A class/struct defined in this file
- **ReprojectionErrorSymmetricImpl**: A class/struct defined in this file
- **AffineEstimatorImpl**: A class/struct defined in this file
- **FundamentalEstimatorImpl**: A class/struct defined in this file
- **ReprojectionErrorPmatrixImpl**: A class/struct defined in this file
- **PnPEstimatorImpl**: A class/struct defined in this file
- **SymmetricGeometricDistanceImpl**: A class/struct defined in this file
- **HomographyEstimatorImpl**: A class/struct defined in this file
- **ReprojectionDistanceAffineImpl**: A class/struct defined in this file
