# Documentation for `modules/calib3d/src/usac/fundamental_solver.cpp`

## File Metadata

- **Full Path**: `modules/calib3d/src/usac/fundamental_solver.cpp`
- **File Name**: `fundamental_solver.cpp`
- **File Size**: 25,134 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/calib3d/src/usac/fundamental_solver.cpp](../../../../modules/calib3d/src/usac/fundamental_solver.cpp)
...
- **CovarianceEpipolarSolverImpl**: A class/struct defined in this file
- **LarssonOptimizerImpl**: A class/struct defined in this file
- **EpipolarNonMinimalSolverImpl**: A class/struct defined in this file
- **FundamentalMinimalSolver8ptsImpl**: A class/struct defined in this file
- **FundamentalMinimalSolver7ptsImpl**: A class/struct defined in this file
