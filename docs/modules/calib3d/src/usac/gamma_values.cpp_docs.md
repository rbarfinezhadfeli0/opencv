# Documentation for `modules/calib3d/src/usac/gamma_values.cpp`

## File Metadata

- **Full Path**: `modules/calib3d/src/usac/gamma_values.cpp`
- **File Name**: `gamma_values.cpp`
- **File Size**: 9,896 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/calib3d/src/usac/gamma_values.cpp](../../../../modules/calib3d/src/usac/gamma_values.cpp)
...
- **GammaValuesImpl**: A class/struct defined in this file
