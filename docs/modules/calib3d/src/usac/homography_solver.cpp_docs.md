# Documentation for `modules/calib3d/src/usac/homography_solver.cpp`

## File Metadata

- **Full Path**: `modules/calib3d/src/usac/homography_solver.cpp`
- **File Name**: `homography_solver.cpp`
- **File Size**: 27,601 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/calib3d/src/usac/homography_solver.cpp](../../../../modules/calib3d/src/usac/homography_solver.cpp)
...
- **HomographyMinimalSolver4ptsImpl**: A class/struct defined in this file
- **AffineNonMinimalSolverImpl**: A class/struct defined in this file
- **CovarianceAffineSolverImpl**: A class/struct defined in this file
- **HomographyNonMinimalSolverImpl**: A class/struct defined in this file
- **AffineMinimalSolverImpl**: A class/struct defined in this file
- **CovarianceHomographySolverImpl**: A class/struct defined in this file
