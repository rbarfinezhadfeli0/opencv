# Documentation for `modules/calib3d/src/usac/local_optimization.cpp`

## File Metadata

- **Full Path**: `modules/calib3d/src/usac/local_optimization.cpp`
- **File Name**: `local_optimization.cpp`
- **File Size**: 30,791 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/calib3d/src/usac/local_optimization.cpp](../../../../modules/calib3d/src/usac/local_optimization.cpp)
...
- **SimpleLocalOptimizationImpl**: A class/struct defined in this file
- **GraphCutImpl**: A class/struct defined in this file
- **MagsacWeightFunctionImpl**: A class/struct defined in this file
- **InnerIterativeLocalOptimizationImpl**: A class/struct defined in this file
- **NonMinimalPolisherImpl**: A class/struct defined in this file
