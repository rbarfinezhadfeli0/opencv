# Documentation for `modules/calib3d/src/usac/pnp_solver.cpp`

## File Metadata

- **Full Path**: `modules/calib3d/src/usac/pnp_solver.cpp`
- **File Name**: `pnp_solver.cpp`
- **File Size**: 16,989 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/calib3d/src/usac/pnp_solver.cpp](../../../../modules/calib3d/src/usac/pnp_solver.cpp)
...
- **PnPSVDSolverImpl**: A class/struct defined in this file
- **P3PSolverImpl**: A class/struct defined in this file
- **PnPNonMinimalSolverImpl**: A class/struct defined in this file
- **PnPMinimalSolver6PtsImpl**: A class/struct defined in this file
