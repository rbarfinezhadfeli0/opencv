# Documentation for `modules/calib3d/src/usac/quality.cpp`

## File Metadata

- **Full Path**: `modules/calib3d/src/usac/quality.cpp`
- **File Name**: `quality.cpp`
- **File Size**: 27,595 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/calib3d/src/usac/quality.cpp](../../../../modules/calib3d/src/usac/quality.cpp)
...
- **MsacQualityImpl**: A class/struct defined in this file
- **LMedsQualityImpl**: A class/struct defined in this file
- **RansacQualityImpl**: A class/struct defined in this file
- **ModelVerifierImpl**: A class/struct defined in this file
- **AdaptiveSPRTImpl**: A class/struct defined in this file
- **MagsacQualityImpl**: A class/struct defined in this file
