# Documentation for `modules/calib3d/src/usac/ransac_solvers.cpp`

## File Metadata

- **Full Path**: `modules/calib3d/src/usac/ransac_solvers.cpp`
- **File Name**: `ransac_solvers.cpp`
- **File Size**: 82,573 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/calib3d/src/usac/ransac_solvers.cpp](../../../../modules/calib3d/src/usac/ransac_solvers.cpp)
...
- **RansacOutputImpl**: A class/struct defined in this file
- **Ransac**: A class/struct defined in this file
- **ModelImpl**: A class/struct defined in this file

### Functions and Methods

- **output()**: A function/method defined in this file
