# Documentation for `modules/calib3d/src/usac/sampler.cpp`

## File Metadata

- **Full Path**: `modules/calib3d/src/usac/sampler.cpp`
- **File Name**: `sampler.cpp`
- **File Size**: 22,875 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/calib3d/src/usac/sampler.cpp](../../../../modules/calib3d/src/usac/sampler.cpp)
...
- **ProsacSimpleSamplerImpl**: A class/struct defined in this file
- **ProsacSamplerImpl**: A class/struct defined in this file
- **NapsacSamplerImpl**: A class/struct defined in this file
- **UniformSamplerImpl**: A class/struct defined in this file
- **ProgressiveNapsacImpl**: A class/struct defined in this file
...
- **subset_size()**: A function/method defined in this file
- **q()**: A function/method defined in this file
