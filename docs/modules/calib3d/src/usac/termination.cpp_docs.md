# Documentation for `modules/calib3d/src/usac/termination.cpp`

## File Metadata

- **Full Path**: `modules/calib3d/src/usac/termination.cpp`
- **File Name**: `termination.cpp`
- **File Size**: 17,541 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/calib3d/src/usac/termination.cpp](../../../../modules/calib3d/src/usac/termination.cpp)
...
- **StandardTerminationCriteriaImpl**: A class/struct defined in this file
- **SPRTTerminationImpl**: A class/struct defined in this file
- **SPRTPNapsacTerminationImpl**: A class/struct defined in this file
- **ProsacTerminationCriteriaImpl**: A class/struct defined in this file
