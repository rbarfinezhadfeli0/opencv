# Documentation for `modules/calib3d/src/usac/utils.cpp`

## File Metadata

- **Full Path**: `modules/calib3d/src/usac/utils.cpp`
- **File Name**: `utils.cpp`
- **File Size**: 33,441 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/calib3d/src/usac/utils.cpp](../../../../modules/calib3d/src/usac/utils.cpp)
...
- **CellCoord**: A class/struct defined in this file
- **is**: A class/struct defined in this file
- **RadiusSearchNeighborhoodGraphImpl**: A class/struct defined in this file
- **SolvePoly**: A class/struct defined in this file
- **GridNeighborhoodGraphImpl**: A class/struct defined in this file
- **FlannNeighborhoodGraphImpl**: A class/struct defined in this file
- **Poly**: A class/struct defined in this file
- **UniformRandomGeneratorImpl**: A class/struct defined in this file

### Functions and Methods

- **has()**: A function/method defined in this file
- **changes()**: A function/method defined in this file
