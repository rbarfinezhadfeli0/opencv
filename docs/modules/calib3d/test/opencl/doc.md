# Documentation for `modules/calib3d/test/opencl/`
...
**Path**: `modules/calib3d/test/opencl/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[test_stereobm.cpp](test_stereobm.cpp_docs.md)**: CPP file
...
- **Parent Folder**: [modules/calib3d/test/](../test/doc.md)
