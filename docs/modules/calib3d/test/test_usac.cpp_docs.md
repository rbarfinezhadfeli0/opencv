# Documentation for `modules/calib3d/test/test_usac.cpp`

## File Metadata

- **Full Path**: `modules/calib3d/test/test_usac.cpp`
- **File Name**: `test_usac.cpp`
- **File Size**: 23,425 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/calib3d/test/test_usac.cpp](../../../modules/calib3d/test/test_usac.cpp)
...
- **generatePoints()**: A function/method defined in this file
