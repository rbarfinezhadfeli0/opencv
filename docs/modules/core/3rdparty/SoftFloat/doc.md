# Documentation for `modules/core/3rdparty/SoftFloat/`
...
**Path**: `modules/core/3rdparty/SoftFloat/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[COPYING.txt](COPYING.txt_docs.md)**: TXT file
...
- **Parent Folder**: [modules/core/3rdparty/](../3rdparty/doc.md)
