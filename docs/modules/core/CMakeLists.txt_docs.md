# Documentation for `modules/core/CMakeLists.txt`

## File Metadata

- **Full Path**: `modules/core/CMakeLists.txt`
- **File Name**: `CMakeLists.txt`
- **File Size**: 10,968 bytes
- **File Type**: .txt
- **Link to Source**: [modules/core/CMakeLists.txt](../../modules/core/CMakeLists.txt)

## Purpose and Role

This file is located in the `modules/core` directory and serves as part of the OpenCV library infrastructure.
