# Documentation for `modules/core/doc/cuda.markdown`

## File Metadata

- **Full Path**: `modules/core/doc/cuda.markdown`
- **File Name**: `cuda.markdown`
- **File Size**: 5,375 bytes
- **File Type**: .markdown
- **Link to Source**: [modules/core/doc/cuda.markdown](../../../modules/core/doc/cuda.markdown)
