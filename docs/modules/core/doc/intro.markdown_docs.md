# Documentation for `modules/core/doc/intro.markdown`

## File Metadata

- **Full Path**: `modules/core/doc/intro.markdown`
- **File Name**: `intro.markdown`
- **File Size**: 16,803 bytes
- **File Type**: .markdown
- **Link to Source**: [modules/core/doc/intro.markdown](../../../modules/core/doc/intro.markdown)

## Purpose and Role

This file is located in the `modules/core/doc` directory and serves as part of the OpenCV library infrastructure.
