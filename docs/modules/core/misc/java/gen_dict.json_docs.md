# Documentation for `modules/core/misc/java/gen_dict.json`

## File Metadata

- **Full Path**: `modules/core/misc/java/gen_dict.json`
- **File Name**: `gen_dict.json`
- **File Size**: 30,807 bytes
- **File Type**: .json
- **Link to Source**: [modules/core/misc/java/gen_dict.json](../../../../modules/core/misc/java/gen_dict.json)

## Purpose and Role

This file is located in the `modules/core/misc/java` directory and serves as part of the OpenCV library infrastructure.
