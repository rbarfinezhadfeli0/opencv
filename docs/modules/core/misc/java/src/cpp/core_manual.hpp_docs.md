# Documentation for `modules/core/misc/java/src/cpp/core_manual.hpp`

## File Metadata

- **Full Path**: `modules/core/misc/java/src/cpp/core_manual.hpp`
- **File Name**: `core_manual.hpp`
- **File Size**: 911 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/core/misc/java/src/cpp/core_manual.hpp](../../../../../../modules/core/misc/java/src/cpp/core_manual.hpp)

## Purpose and Role

This file is located in the `modules/core/misc/java/src/cpp` directory and serves as part of the OpenCV library infrastructure.
