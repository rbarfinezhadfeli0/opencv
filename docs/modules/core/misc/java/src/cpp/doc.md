# Documentation for `modules/core/misc/java/src/cpp/`
...
**Path**: `modules/core/misc/java/src/cpp/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[core_manual.cpp](core_manual.cpp_docs.md)**: CPP file
- **[core_manual.hpp](core_manual.hpp_docs.md)**: HPP file
...
- **Parent Folder**: [modules/core/misc/java/src/](../src/doc.md)
