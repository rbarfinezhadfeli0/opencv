# Documentation for `modules/core/misc/java/src/java/core+Core.jcode.in`

## File Metadata

- **Full Path**: `modules/core/misc/java/src/java/core+Core.jcode.in`
- **File Name**: `core+Core.jcode.in`
- **File Size**: 1,001 bytes
- **File Type**: .in
- **Link to Source**: [modules/core/misc/java/src/java/core+Core.jcode.in](../../../../../../modules/core/misc/java/src/java/core+Core.jcode.in)
