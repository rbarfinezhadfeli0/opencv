# Documentation for `modules/core/misc/java/src/java/core+MatAt.kt`

## File Metadata

- **Full Path**: `modules/core/misc/java/src/java/core+MatAt.kt`
- **File Name**: `core+MatAt.kt`
- **File Size**: 5,504 bytes
- **File Type**: .kt
- **Link to Source**: [modules/core/misc/java/src/java/core+MatAt.kt](../../../../../../modules/core/misc/java/src/java/core+MatAt.kt)
