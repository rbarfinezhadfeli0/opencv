# Documentation for `modules/core/misc/java/src/java/core+MatOfDouble.java`

## File Metadata

- **Full Path**: `modules/core/misc/java/src/java/core+MatOfDouble.java`
- **File Name**: `core+MatOfDouble.java`
- **File Size**: 2,170 bytes
- **File Type**: .java
- **Link to Source**: [modules/core/misc/java/src/java/core+MatOfDouble.java](../../../../../../modules/core/misc/java/src/java/core+MatOfDouble.java)
...
- **MatOfDouble**: A class/struct defined in this file
