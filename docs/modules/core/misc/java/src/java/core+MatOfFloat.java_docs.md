# Documentation for `modules/core/misc/java/src/java/core+MatOfFloat.java`

## File Metadata

- **Full Path**: `modules/core/misc/java/src/java/core+MatOfFloat.java`
- **File Name**: `core+MatOfFloat.java`
- **File Size**: 2,147 bytes
- **File Type**: .java
- **Link to Source**: [modules/core/misc/java/src/java/core+MatOfFloat.java](../../../../../../modules/core/misc/java/src/java/core+MatOfFloat.java)
...
- **MatOfFloat**: A class/struct defined in this file
