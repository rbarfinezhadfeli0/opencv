# Documentation for `modules/core/misc/java/src/java/core+MatOfFloat6.java`

## File Metadata

- **Full Path**: `modules/core/misc/java/src/java/core+MatOfFloat6.java`
- **File Name**: `core+MatOfFloat6.java`
- **File Size**: 2,154 bytes
- **File Type**: .java
- **Link to Source**: [modules/core/misc/java/src/java/core+MatOfFloat6.java](../../../../../../modules/core/misc/java/src/java/core+MatOfFloat6.java)
...
- **MatOfFloat6**: A class/struct defined in this file
