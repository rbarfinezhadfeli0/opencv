# Documentation for `modules/core/misc/java/src/java/core+MatOfInt4.java`

## File Metadata

- **Full Path**: `modules/core/misc/java/src/java/core+MatOfInt4.java`
- **File Name**: `core+MatOfInt4.java`
- **File Size**: 2,137 bytes
- **File Type**: .java
- **Link to Source**: [modules/core/misc/java/src/java/core+MatOfInt4.java](../../../../../../modules/core/misc/java/src/java/core+MatOfInt4.java)
