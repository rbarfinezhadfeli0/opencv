# Documentation for `modules/core/misc/java/src/java/core+MatOfPoint3.java`

## File Metadata

- **Full Path**: `modules/core/misc/java/src/java/core+MatOfPoint3.java`
- **File Name**: `core+MatOfPoint3.java`
- **File Size**: 2,176 bytes
- **File Type**: .java
- **Link to Source**: [modules/core/misc/java/src/java/core+MatOfPoint3.java](../../../../../../modules/core/misc/java/src/java/core+MatOfPoint3.java)
...
- **MatOfPoint3**: A class/struct defined in this file
