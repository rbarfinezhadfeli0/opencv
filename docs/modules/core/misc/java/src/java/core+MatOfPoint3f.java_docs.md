# Documentation for `modules/core/misc/java/src/java/core+MatOfPoint3f.java`

## File Metadata

- **Full Path**: `modules/core/misc/java/src/java/core+MatOfPoint3f.java`
- **File Name**: `core+MatOfPoint3f.java`
- **File Size**: 2,197 bytes
- **File Type**: .java
- **Link to Source**: [modules/core/misc/java/src/java/core+MatOfPoint3f.java](../../../../../../modules/core/misc/java/src/java/core+MatOfPoint3f.java)
