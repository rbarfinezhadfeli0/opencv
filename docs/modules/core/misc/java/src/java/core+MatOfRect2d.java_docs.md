# Documentation for `modules/core/misc/java/src/java/core+MatOfRect2d.java`

## File Metadata

- **Full Path**: `modules/core/misc/java/src/java/core+MatOfRect2d.java`
- **File Name**: `core+MatOfRect2d.java`
- **File Size**: 2,272 bytes
- **File Type**: .java
- **Link to Source**: [modules/core/misc/java/src/java/core+MatOfRect2d.java](../../../../../../modules/core/misc/java/src/java/core+MatOfRect2d.java)
...
- **MatOfRect2d**: A class/struct defined in this file
