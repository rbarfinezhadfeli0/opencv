# Documentation for `modules/core/misc/java/src/java/core+Rect.java`

## File Metadata

- **Full Path**: `modules/core/misc/java/src/java/core+Rect.java`
- **File Name**: `core+Rect.java`
- **File Size**: 2,663 bytes
- **File Type**: .java
- **Link to Source**: [modules/core/misc/java/src/java/core+Rect.java](../../../../../../modules/core/misc/java/src/java/core+Rect.java)
