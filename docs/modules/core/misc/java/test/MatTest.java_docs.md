# Documentation for `modules/core/misc/java/test/MatTest.java`

## File Metadata

- **Full Path**: `modules/core/misc/java/test/MatTest.java`
- **File Name**: `MatTest.java`
- **File Size**: 44,297 bytes
- **File Type**: .java
- **Link to Source**: [modules/core/misc/java/test/MatTest.java](../../../../../modules/core/misc/java/test/MatTest.java)
