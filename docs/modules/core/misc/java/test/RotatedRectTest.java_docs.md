# Documentation for `modules/core/misc/java/test/RotatedRectTest.java`

## File Metadata

- **Full Path**: `modules/core/misc/java/test/RotatedRectTest.java`
- **File Name**: `RotatedRectTest.java`
- **File Size**: 7,675 bytes
- **File Type**: .java
- **Link to Source**: [modules/core/misc/java/test/RotatedRectTest.java](../../../../../modules/core/misc/java/test/RotatedRectTest.java)
