# Documentation for `modules/core/misc/objc/common/MatOfKeyPoint.mm`

## File Metadata

- **Full Path**: `modules/core/misc/objc/common/MatOfKeyPoint.mm`
- **File Name**: `MatOfKeyPoint.mm`
- **File Size**: 3,175 bytes
- **File Type**: .mm
- **Link to Source**: [modules/core/misc/objc/common/MatOfKeyPoint.mm](../../../../../modules/core/misc/objc/common/MatOfKeyPoint.mm)
