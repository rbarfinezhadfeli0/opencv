# Documentation for `modules/core/misc/objc/common/Rect2f.mm`

## File Metadata

- **Full Path**: `modules/core/misc/objc/common/Rect2f.mm`
- **File Name**: `Rect2f.mm`
- **File Size**: 3,594 bytes
- **File Type**: .mm
- **Link to Source**: [modules/core/misc/objc/common/Rect2f.mm](../../../../../modules/core/misc/objc/common/Rect2f.mm)
