# Documentation for `modules/core/misc/objc/gen_dict.json`

## File Metadata

- **Full Path**: `modules/core/misc/objc/gen_dict.json`
- **File Name**: `gen_dict.json`
- **File Size**: 16,182 bytes
- **File Type**: .json
- **Link to Source**: [modules/core/misc/objc/gen_dict.json](../../../../modules/core/misc/objc/gen_dict.json)

## Purpose and Role

This file is located in the `modules/core/misc/objc` directory and serves as part of the OpenCV library infrastructure.
