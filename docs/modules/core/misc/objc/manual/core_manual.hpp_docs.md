# Documentation for `modules/core/misc/objc/manual/core_manual.hpp`

## File Metadata

- **Full Path**: `modules/core/misc/objc/manual/core_manual.hpp`
- **File Name**: `core_manual.hpp`
- **File Size**: 880 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/core/misc/objc/manual/core_manual.hpp](../../../../../modules/core/misc/objc/manual/core_manual.hpp)

## Purpose and Role

This file is located in the `modules/core/misc/objc/manual` directory and serves as part of the OpenCV library infrastructure.
