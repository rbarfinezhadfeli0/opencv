# Documentation for `modules/core/misc/objc/test/resources/`
...
**Path**: `modules/core/misc/objc/test/resources/`
**Direct Files**: 2
**Subfolders**: 0
...
- **Parent Folder**: [modules/core/misc/objc/test/](../test/doc.md)
