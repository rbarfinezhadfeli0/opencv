# Documentation for `modules/core/misc/plugins/parallel_tbb/`
...
**Path**: `modules/core/misc/plugins/parallel_tbb/`
**Direct Files**: 1
**Subfolders**: 0
...
- **Parent Folder**: [modules/core/misc/plugins/](../plugins/doc.md)
