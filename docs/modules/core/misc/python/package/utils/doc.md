# Documentation for `modules/core/misc/python/package/utils/`
...
**Path**: `modules/core/misc/python/package/utils/`
**Direct Files**: 1
**Subfolders**: 0
...
- **Parent Folder**: [modules/core/misc/python/package/](../package/doc.md)
