# Documentation for `modules/core/misc/python/pyopencv_core.hpp`

## File Metadata

- **Full Path**: `modules/core/misc/python/pyopencv_core.hpp`
- **File Name**: `pyopencv_core.hpp`
- **File Size**: 7,606 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/core/misc/python/pyopencv_core.hpp](../../../../modules/core/misc/python/pyopencv_core.hpp)
...
- **OPENCV_CORE_PYOPENCV_CORE_HPP()**: A function/method defined in this file
