# Documentation for `modules/core/perf/cuda/`
...
- **[perf_gpumat.cpp](perf_gpumat.cpp_docs.md)**: CPP file
...
- **Parent Folder**: [modules/core/perf/](../perf/doc.md)
