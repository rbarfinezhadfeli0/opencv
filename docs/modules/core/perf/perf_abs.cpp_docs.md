# Documentation for `modules/core/perf/perf_abs.cpp`

## File Metadata

- **Full Path**: `modules/core/perf/perf_abs.cpp`
- **File Name**: `perf_abs.cpp`
- **File Size**: 622 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/perf/perf_abs.cpp](../../../modules/core/perf/perf_abs.cpp)
