# Documentation for `modules/core/perf/perf_arithm.cpp`

## File Metadata

- **Full Path**: `modules/core/perf/perf_arithm.cpp`
- **File Name**: `perf_arithm.cpp`
- **File Size**: 21,231 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/perf/perf_arithm.cpp](../../../modules/core/perf/perf_arithm.cpp)
