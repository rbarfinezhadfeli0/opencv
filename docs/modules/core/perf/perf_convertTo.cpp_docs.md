# Documentation for `modules/core/perf/perf_convertTo.cpp`

## File Metadata

- **Full Path**: `modules/core/perf/perf_convertTo.cpp`
- **File Name**: `perf_convertTo.cpp`
- **File Size**: 1,395 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/perf/perf_convertTo.cpp](../../../modules/core/perf/perf_convertTo.cpp)
