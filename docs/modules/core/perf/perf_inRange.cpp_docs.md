# Documentation for `modules/core/perf/perf_inRange.cpp`

## File Metadata

- **Full Path**: `modules/core/perf/perf_inRange.cpp`
- **File Name**: `perf_inRange.cpp`
- **File Size**: 708 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/perf/perf_inRange.cpp](../../../modules/core/perf/perf_inRange.cpp)
