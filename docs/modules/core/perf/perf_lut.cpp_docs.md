# Documentation for `modules/core/perf/perf_lut.cpp`

## File Metadata

- **Full Path**: `modules/core/perf/perf_lut.cpp`
- **File Name**: `perf_lut.cpp`
- **File Size**: 872 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/perf/perf_lut.cpp](../../../modules/core/perf/perf_lut.cpp)
