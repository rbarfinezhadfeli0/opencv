# Documentation for `modules/core/perf/perf_math.cpp`

## File Metadata

- **Full Path**: `modules/core/perf/perf_math.cpp`
- **File Name**: `perf_math.cpp`
- **File Size**: 11,791 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/perf/perf_math.cpp](../../../modules/core/perf/perf_math.cpp)
