# Documentation for `modules/core/perf/perf_minmaxloc.cpp`

## File Metadata

- **Full Path**: `modules/core/perf/perf_minmaxloc.cpp`
- **File Name**: `perf_minmaxloc.cpp`
- **File Size**: 874 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/perf/perf_minmaxloc.cpp](../../../modules/core/perf/perf_minmaxloc.cpp)
