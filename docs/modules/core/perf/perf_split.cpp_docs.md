# Documentation for `modules/core/perf/perf_split.cpp`

## File Metadata

- **Full Path**: `modules/core/perf/perf_split.cpp`
- **File Name**: `perf_split.cpp`
- **File Size**: 831 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/perf/perf_split.cpp](../../../modules/core/perf/perf_split.cpp)
