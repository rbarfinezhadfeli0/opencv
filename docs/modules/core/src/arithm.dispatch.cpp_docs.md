# Documentation for `modules/core/src/arithm.dispatch.cpp`

## File Metadata

- **Full Path**: `modules/core/src/arithm.dispatch.cpp`
- **File Name**: `arithm.dispatch.cpp`
- **File Size**: 370 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/src/arithm.dispatch.cpp](../../../modules/core/src/arithm.dispatch.cpp)
