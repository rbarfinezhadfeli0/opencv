# Documentation for `modules/core/src/arithm_ipp.hpp`

## File Metadata

- **Full Path**: `modules/core/src/arithm_ipp.hpp`
- **File Name**: `arithm_ipp.hpp`
- **File Size**: 16,995 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/core/src/arithm_ipp.hpp](../../../modules/core/src/arithm_ipp.hpp)
