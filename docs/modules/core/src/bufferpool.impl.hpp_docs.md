# Documentation for `modules/core/src/bufferpool.impl.hpp`

## File Metadata

- **Full Path**: `modules/core/src/bufferpool.impl.hpp`
- **File Name**: `bufferpool.impl.hpp`
- **File Size**: 939 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/core/src/bufferpool.impl.hpp](../../../modules/core/src/bufferpool.impl.hpp)
...
- **DummyBufferPoolController**: A class/struct defined in this file

### Functions and Methods

- **__OPENCV_CORE_BUFFER_POOL_IMPL_HPP__()**: A function/method defined in this file
