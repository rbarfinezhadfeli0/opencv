# Documentation for `modules/core/src/channels.cpp`

## File Metadata

- **Full Path**: `modules/core/src/channels.cpp`
- **File Name**: `channels.cpp`
- **File Size**: 15,108 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/src/channels.cpp](../../../modules/core/src/channels.cpp)
