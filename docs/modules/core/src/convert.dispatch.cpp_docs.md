# Documentation for `modules/core/src/convert.dispatch.cpp`

## File Metadata

- **Full Path**: `modules/core/src/convert.dispatch.cpp`
- **File Name**: `convert.dispatch.cpp`
- **File Size**: 13,117 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/src/convert.dispatch.cpp](../../../modules/core/src/convert.dispatch.cpp)
