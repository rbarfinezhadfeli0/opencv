# Documentation for `modules/core/src/convert.hpp`

## File Metadata

- **Full Path**: `modules/core/src/convert.hpp`
- **File Name**: `convert.hpp`
- **File Size**: 12,707 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/core/src/convert.hpp](../../../modules/core/src/convert.hpp)
...
- **SRC_CONVERT_HPP()**: A function/method defined in this file
