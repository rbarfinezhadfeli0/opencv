# Documentation for `modules/core/src/convert_scale.dispatch.cpp`

## File Metadata

- **Full Path**: `modules/core/src/convert_scale.dispatch.cpp`
- **File Name**: `convert_scale.dispatch.cpp`
- **File Size**: 4,169 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/src/convert_scale.dispatch.cpp](../../../modules/core/src/convert_scale.dispatch.cpp)
