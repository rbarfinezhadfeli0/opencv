# Documentation for `modules/core/src/count_non_zero.dispatch.cpp`

## File Metadata

- **Full Path**: `modules/core/src/count_non_zero.dispatch.cpp`
- **File Name**: `count_non_zero.dispatch.cpp`
- **File Size**: 6,521 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/src/count_non_zero.dispatch.cpp](../../../modules/core/src/count_non_zero.dispatch.cpp)
