# Documentation for `modules/core/src/cuda/gpu_mat_nd.cu`

## File Metadata

- **Full Path**: `modules/core/src/cuda/gpu_mat_nd.cu`
- **File Name**: `gpu_mat_nd.cu`
- **File Size**: 6,492 bytes
- **File Type**: .cu
- **Link to Source**: [modules/core/src/cuda/gpu_mat_nd.cu](../../../../modules/core/src/cuda/gpu_mat_nd.cu)

## Purpose and Role

This file is located in the `modules/core/src/cuda` directory and serves as part of the OpenCV library infrastructure.
