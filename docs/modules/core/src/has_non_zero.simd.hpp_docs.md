# Documentation for `modules/core/src/has_non_zero.simd.hpp`

## File Metadata

- **Full Path**: `modules/core/src/has_non_zero.simd.hpp`
- **File Name**: `has_non_zero.simd.hpp`
- **File Size**: 10,024 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/core/src/has_non_zero.simd.hpp](../../../modules/core/src/has_non_zero.simd.hpp)
...
- **v_int32()**: A function/method defined in this file
