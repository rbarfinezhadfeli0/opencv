# Documentation for `modules/core/src/mathfuncs.hpp`

## File Metadata

- **Full Path**: `modules/core/src/mathfuncs.hpp`
- **File Name**: `mathfuncs.hpp`
- **File Size**: 484 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/core/src/mathfuncs.hpp](../../../modules/core/src/mathfuncs.hpp)
...
- **OPENCV_CORE_SRC_MATHFUNCS_HPP()**: A function/method defined in this file
