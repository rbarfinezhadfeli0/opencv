# Documentation for `modules/core/src/mathfuncs_core.dispatch.cpp`

## File Metadata

- **Full Path**: `modules/core/src/mathfuncs_core.dispatch.cpp`
- **File Name**: `mathfuncs_core.dispatch.cpp`
- **File Size**: 6,923 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/src/mathfuncs_core.dispatch.cpp](../../../modules/core/src/mathfuncs_core.dispatch.cpp)
