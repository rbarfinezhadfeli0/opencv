# Documentation for `modules/core/src/matrix.cpp`

## File Metadata

- **Full Path**: `modules/core/src/matrix.cpp`
- **File Name**: `matrix.cpp`
- **File Size**: 37,161 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/src/matrix.cpp](../../../modules/core/src/matrix.cpp)
...
- **StdMatAllocator**: A class/struct defined in this file
