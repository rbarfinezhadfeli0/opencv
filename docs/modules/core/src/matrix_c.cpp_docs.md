# Documentation for `modules/core/src/matrix_c.cpp`

## File Metadata

- **Full Path**: `modules/core/src/matrix_c.cpp`
- **File Name**: `matrix_c.cpp`
- **File Size**: 11,295 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/src/matrix_c.cpp](../../../modules/core/src/matrix_c.cpp)
