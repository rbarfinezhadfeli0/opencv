# Documentation for `modules/core/src/matrix_decomp.cpp`

## File Metadata

- **Full Path**: `modules/core/src/matrix_decomp.cpp`
- **File Name**: `matrix_decomp.cpp`
- **File Size**: 8,830 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/src/matrix_decomp.cpp](../../../modules/core/src/matrix_decomp.cpp)
