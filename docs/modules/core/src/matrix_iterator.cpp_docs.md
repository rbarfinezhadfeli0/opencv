# Documentation for `modules/core/src/matrix_iterator.cpp`

## File Metadata

- **Full Path**: `modules/core/src/matrix_iterator.cpp`
- **File Name**: `matrix_iterator.cpp`
- **File Size**: 8,519 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/src/matrix_iterator.cpp](../../../modules/core/src/matrix_iterator.cpp)
