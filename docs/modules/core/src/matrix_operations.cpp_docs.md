# Documentation for `modules/core/src/matrix_operations.cpp`

## File Metadata

- **Full Path**: `modules/core/src/matrix_operations.cpp`
- **File Name**: `matrix_operations.cpp`
- **File Size**: 43,132 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/src/matrix_operations.cpp](../../../modules/core/src/matrix_operations.cpp)
...
- **ReduceR_Invoker**: A class/struct defined in this file
- **ReduceC_Invoker**: A class/struct defined in this file
- **OpInit**: A class/struct defined in this file
...
- **CV_IPP_RUN()**: A function/method defined in this file
- **Ipp()**: A function/method defined in this file
- **HAVE_OPENCL()**: A function/method defined in this file
- **HAVE_IPP()**: A function/method defined in this file
- **CV_IPP_RUN_FAST()**: A function/method defined in this file
