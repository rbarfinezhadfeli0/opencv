# Documentation for `modules/core/src/matrix_sparse.cpp`

## File Metadata

- **Full Path**: `modules/core/src/matrix_sparse.cpp`
- **File Name**: `matrix_sparse.cpp`
- **File Size**: 24,835 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/src/matrix_sparse.cpp](../../../modules/core/src/matrix_sparse.cpp)
