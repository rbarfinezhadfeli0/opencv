# Documentation for `modules/core/src/matrix_transform.cpp`

## File Metadata

- **Full Path**: `modules/core/src/matrix_transform.cpp`
- **File Name**: `matrix_transform.cpp`
- **File Size**: 34,907 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/src/matrix_transform.cpp](../../../modules/core/src/matrix_transform.cpp)
...
- **OPENCV_CORE_BROADCAST_LOOP()**: A function/method defined in this file
