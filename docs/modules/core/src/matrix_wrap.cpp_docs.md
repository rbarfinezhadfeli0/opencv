# Documentation for `modules/core/src/matrix_wrap.cpp`

## File Metadata

- **Full Path**: `modules/core/src/matrix_wrap.cpp`
- **File Name**: `matrix_wrap.cpp`
- **File Size**: 53,733 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/src/matrix_wrap.cpp](../../../modules/core/src/matrix_wrap.cpp)
