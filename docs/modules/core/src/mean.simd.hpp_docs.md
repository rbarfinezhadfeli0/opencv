# Documentation for `modules/core/src/mean.simd.hpp`

## File Metadata

- **Full Path**: `modules/core/src/mean.simd.hpp`
- **File Name**: `mean.simd.hpp`
- **File Size**: 10,964 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/core/src/mean.simd.hpp](../../../modules/core/src/mean.simd.hpp)
...
- **SumSqr_SIMD**: A class/struct defined in this file
