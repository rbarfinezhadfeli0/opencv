# Documentation for `modules/core/src/merge.dispatch.cpp`

## File Metadata

- **Full Path**: `modules/core/src/merge.dispatch.cpp`
- **File Name**: `merge.dispatch.cpp`
- **File Size**: 7,965 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/src/merge.dispatch.cpp](../../../modules/core/src/merge.dispatch.cpp)
