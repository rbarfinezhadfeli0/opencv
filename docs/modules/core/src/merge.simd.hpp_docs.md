# Documentation for `modules/core/src/merge.simd.hpp`

## File Metadata

- **Full Path**: `modules/core/src/merge.simd.hpp`
- **File Name**: `merge.simd.hpp`
- **File Size**: 6,529 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/core/src/merge.simd.hpp](../../../modules/core/src/merge.simd.hpp)
