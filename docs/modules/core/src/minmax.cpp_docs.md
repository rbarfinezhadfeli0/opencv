# Documentation for `modules/core/src/minmax.cpp`

## File Metadata

- **Full Path**: `modules/core/src/minmax.cpp`
- **File Name**: `minmax.cpp`
- **File Size**: 52,816 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/src/minmax.cpp](../../../modules/core/src/minmax.cpp)
...
- **ReduceMode**: A class/struct defined in this file
- **reduceMinMaxImpl**: A class/struct defined in this file
- **Cmp**: A class/struct defined in this file
- **specifier**: A class/struct defined in this file
