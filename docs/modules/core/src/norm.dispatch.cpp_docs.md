# Documentation for `modules/core/src/norm.dispatch.cpp`

## File Metadata

- **Full Path**: `modules/core/src/norm.dispatch.cpp`
- **File Name**: `norm.dispatch.cpp`
- **File Size**: 30,278 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/src/norm.dispatch.cpp](../../../modules/core/src/norm.dispatch.cpp)
