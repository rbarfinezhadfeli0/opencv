# Documentation for `modules/core/src/norm.simd.hpp`

## File Metadata

- **Full Path**: `modules/core/src/norm.simd.hpp`
- **File Name**: `norm.simd.hpp`
- **File Size**: 51,715 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/core/src/norm.simd.hpp](../../../modules/core/src/norm.simd.hpp)
...
- **NormL2_SIMD**: A class/struct defined in this file
- **NormDiffInf_SIMD**: A class/struct defined in this file
- **NormInf_SIMD**: A class/struct defined in this file
- **NormL1_SIMD**: A class/struct defined in this file
- **NormDiffL1_SIMD**: A class/struct defined in this file
- **NormDiffL2_SIMD**: A class/struct defined in this file
