# Documentation for `modules/core/src/ocl_disabled.impl.hpp`

## File Metadata

- **Full Path**: `modules/core/src/ocl_disabled.impl.hpp`
- **File Name**: `ocl_disabled.impl.hpp`
- **File Size**: 19,008 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/core/src/ocl_disabled.impl.hpp](../../../modules/core/src/ocl_disabled.impl.hpp)
