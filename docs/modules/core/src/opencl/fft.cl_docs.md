# Documentation for `modules/core/src/opencl/fft.cl`

## File Metadata

- **Full Path**: `modules/core/src/opencl/fft.cl`
- **File Name**: `fft.cl`
- **File Size**: 27,716 bytes
- **File Type**: .cl
- **Link to Source**: [modules/core/src/opencl/fft.cl](../../../../modules/core/src/opencl/fft.cl)
