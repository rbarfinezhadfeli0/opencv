# Documentation for `modules/core/src/opencl/meanstddev.cl`

## File Metadata

- **Full Path**: `modules/core/src/opencl/meanstddev.cl`
- **File Name**: `meanstddev.cl`
- **File Size**: 3,790 bytes
- **File Type**: .cl
- **Link to Source**: [modules/core/src/opencl/meanstddev.cl](../../../../modules/core/src/opencl/meanstddev.cl)
