# Documentation for `modules/core/src/opencl/minmaxloc.cl`

## File Metadata

- **Full Path**: `modules/core/src/opencl/minmaxloc.cl`
- **File Name**: `minmaxloc.cl`
- **File Size**: 9,665 bytes
- **File Type**: .cl
- **Link to Source**: [modules/core/src/opencl/minmaxloc.cl](../../../../modules/core/src/opencl/minmaxloc.cl)
