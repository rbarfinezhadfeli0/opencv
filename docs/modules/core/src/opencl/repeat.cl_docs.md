# Documentation for `modules/core/src/opencl/repeat.cl`

## File Metadata

- **Full Path**: `modules/core/src/opencl/repeat.cl`
- **File Name**: `repeat.cl`
- **File Size**: 1,732 bytes
- **File Type**: .cl
- **Link to Source**: [modules/core/src/opencl/repeat.cl](../../../../modules/core/src/opencl/repeat.cl)
