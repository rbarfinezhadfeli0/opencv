# Documentation for `modules/core/src/parallel/plugin_parallel_wrapper.impl.hpp`

## File Metadata

- **Full Path**: `modules/core/src/parallel/plugin_parallel_wrapper.impl.hpp`
- **File Name**: `plugin_parallel_wrapper.impl.hpp`
- **File Size**: 11,022 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/core/src/parallel/plugin_parallel_wrapper.impl.hpp](../../../../modules/core/src/parallel/plugin_parallel_wrapper.impl.hpp)
...
- **PluginParallelBackendFactory**: A class/struct defined in this file
- **PluginParallelBackend**: A class/struct defined in this file

### Functions and Methods

- **CV_LOG_ERROR()**: A function/method defined in this file
- **_WIN32()**: A function/method defined in this file
- **CV_CORE_PARALLEL_PLUGIN_SUBDIRECTORY()**: A function/method defined in this file
