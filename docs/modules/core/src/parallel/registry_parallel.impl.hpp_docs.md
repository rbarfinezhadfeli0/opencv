# Documentation for `modules/core/src/parallel/registry_parallel.impl.hpp`

## File Metadata

- **Full Path**: `modules/core/src/parallel/registry_parallel.impl.hpp`
- **File Name**: `registry_parallel.impl.hpp`
- **File Size**: 6,390 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/core/src/parallel/registry_parallel.impl.hpp](../../../../modules/core/src/parallel/registry_parallel.impl.hpp)
...
- **ParallelBackendRegistry**: A class/struct defined in this file
