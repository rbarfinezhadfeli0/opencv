# Documentation for `modules/core/src/parallel_impl.cpp`

## File Metadata

- **Full Path**: `modules/core/src/parallel_impl.cpp`
- **File Name**: `parallel_impl.cpp`
- **File Size**: 27,672 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/src/parallel_impl.cpp](../../../modules/core/src/parallel_impl.cpp)
...
- **ParallelJob**: A class/struct defined in this file
- **WorkerThread**: A class/struct defined in this file
- **ThreadPool**: A class/struct defined in this file
- **ThreadStatistics**: A class/struct defined in this file

### Functions and Methods

- **CV_YIELD()**: A function/method defined in this file
- **CV_LOG_STRIP_LEVEL()**: A function/method defined in this file
- **HAVE_PTHREADS_PF()**: A function/method defined in this file
- **DECLARE_CV_PAUSE()**: A function/method defined in this file
- **DECLARE_CV_YIELD()**: A function/method defined in this file
- **OPENCV_WITH_ITT()**: A function/method defined in this file
- **CV_PAUSE()**: A function/method defined in this file
- **CV_PROFILE_THREADS()**: A function/method defined in this file
