# Documentation for `modules/core/src/parallel_impl.hpp`

## File Metadata

- **Full Path**: `modules/core/src/parallel_impl.hpp`
- **File Name**: `parallel_impl.hpp`
- **File Size**: 555 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/core/src/parallel_impl.hpp](../../../modules/core/src/parallel_impl.hpp)
...
- **OPENCV_CORE_PARALLEL_IMPL_HPP()**: A function/method defined in this file
