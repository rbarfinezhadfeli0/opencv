# Documentation for `modules/core/src/persistence.cpp`

## File Metadata

- **Full Path**: `modules/core/src/persistence.cpp`
- **File Name**: `persistence.cpp`
- **File Size**: 86,251 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/src/persistence.cpp](../../../modules/core/src/persistence.cpp)
