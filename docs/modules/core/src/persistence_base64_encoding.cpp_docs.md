# Documentation for `modules/core/src/persistence_base64_encoding.cpp`

## File Metadata

- **Full Path**: `modules/core/src/persistence_base64_encoding.cpp`
- **File Name**: `persistence_base64_encoding.cpp`
- **File Size**: 10,839 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/src/persistence_base64_encoding.cpp](../../../modules/core/src/persistence_base64_encoding.cpp)
...
- **base64**: A class/struct defined in this file
