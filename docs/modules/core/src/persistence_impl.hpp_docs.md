# Documentation for `modules/core/src/persistence_impl.hpp`

## File Metadata

- **Full Path**: `modules/core/src/persistence_impl.hpp`
- **File Name**: `persistence_impl.hpp`
- **File Size**: 6,857 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/core/src/persistence_impl.hpp](../../../modules/core/src/persistence_impl.hpp)
...
- **Base64Decoder**: A class/struct defined in this file

### Functions and Methods

- **std()**: A function/method defined in this file
- **OPENCV_CORE_PERSISTENCE_IMPL_HPP()**: A function/method defined in this file
