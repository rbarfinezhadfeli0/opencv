# Documentation for `modules/core/src/persistence_json.cpp`

## File Metadata

- **Full Path**: `modules/core/src/persistence_json.cpp`
- **File Name**: `persistence_json.cpp`
- **File Size**: 25,338 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/src/persistence_json.cpp](../../../modules/core/src/persistence_json.cpp)
...
- **JSONParser**: A class/struct defined in this file
