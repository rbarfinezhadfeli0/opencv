# Documentation for `modules/core/src/persistence_xml.cpp`

## File Metadata

- **Full Path**: `modules/core/src/persistence_xml.cpp`
- **File Name**: `persistence_xml.cpp`
- **File Size**: 29,039 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/src/persistence_xml.cpp](../../../modules/core/src/persistence_xml.cpp)
...
- **XMLParser**: A class/struct defined in this file
