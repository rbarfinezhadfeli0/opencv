# Documentation for `modules/core/src/persistence_yml.cpp`

## File Metadata

- **Full Path**: `modules/core/src/persistence_yml.cpp`
- **File Name**: `persistence_yml.cpp`
- **File Size**: 27,677 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/src/persistence_yml.cpp](../../../modules/core/src/persistence_yml.cpp)
...
- **flag**: A class/struct defined in this file
- **YAMLParser**: A class/struct defined in this file
