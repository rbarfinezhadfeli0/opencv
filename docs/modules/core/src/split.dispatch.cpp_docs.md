# Documentation for `modules/core/src/split.dispatch.cpp`

## File Metadata

- **Full Path**: `modules/core/src/split.dispatch.cpp`
- **File Name**: `split.dispatch.cpp`
- **File Size**: 7,091 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/src/split.dispatch.cpp](../../../modules/core/src/split.dispatch.cpp)
