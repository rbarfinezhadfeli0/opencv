# Documentation for `modules/core/src/sum.dispatch.cpp`

## File Metadata

- **Full Path**: `modules/core/src/sum.dispatch.cpp`
- **File Name**: `sum.dispatch.cpp`
- **File Size**: 6,723 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/src/sum.dispatch.cpp](../../../modules/core/src/sum.dispatch.cpp)
