# Documentation for `modules/core/src/sum.simd.hpp`

## File Metadata

- **Full Path**: `modules/core/src/sum.simd.hpp`
- **File Name**: `sum.simd.hpp`
- **File Size**: 13,593 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/core/src/sum.simd.hpp](../../../modules/core/src/sum.simd.hpp)
...
- **Sum_SIMD**: A class/struct defined in this file
