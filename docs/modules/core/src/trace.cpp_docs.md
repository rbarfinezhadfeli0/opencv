# Documentation for `modules/core/src/trace.cpp`

## File Metadata

- **Full Path**: `modules/core/src/trace.cpp`
- **File Name**: `trace.cpp`
- **File Size**: 34,874 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/src/trace.cpp](../../../modules/core/src/trace.cpp)
...
- **TraceArg**: A class/struct defined in this file
- **SyncTraceStorage**: A class/struct defined in this file
- **AsyncTraceStorage**: A class/struct defined in this file
