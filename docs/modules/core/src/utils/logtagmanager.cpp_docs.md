# Documentation for `modules/core/src/utils/logtagmanager.cpp`

## File Metadata

- **Full Path**: `modules/core/src/utils/logtagmanager.cpp`
- **File Name**: `logtagmanager.cpp`
- **File Size**: 14,753 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/src/utils/logtagmanager.cpp](../../../../modules/core/src/utils/logtagmanager.cpp)
