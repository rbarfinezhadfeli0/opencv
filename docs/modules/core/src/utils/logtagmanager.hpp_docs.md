# Documentation for `modules/core/src/utils/logtagmanager.hpp`

## File Metadata

- **Full Path**: `modules/core/src/utils/logtagmanager.hpp`
- **File Name**: `logtagmanager.hpp`
- **File Size**: 9,783 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/core/src/utils/logtagmanager.hpp](../../../../modules/core/src/utils/logtagmanager.hpp)
...
- **FullNameLookupResult**: A class/struct defined in this file
- **LogTagConfigParser**: A class/struct defined in this file
- **for**: A class/struct defined in this file
- **ParsedLevel**: A class/struct defined in this file
- **CrossReference**: A class/struct defined in this file
- **NamePartLookupResult**: A class/struct defined in this file
- **ptr**: A class/struct defined in this file
- **MatchingScope**: A class/struct defined in this file
- **are**: A class/struct defined in this file
- **NamePartInfo**: A class/struct defined in this file
- **LogTagManager**: A class/struct defined in this file
- **NameTable**: A class/struct defined in this file
- **FullNameInfo**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_CORE_LOGTAGMANAGER_HPP()**: A function/method defined in this file
