# Documentation for `modules/core/src/va_intel.cpp`

## File Metadata

- **Full Path**: `modules/core/src/va_intel.cpp`
- **File Name**: `va_intel.cpp`
- **File Size**: 31,777 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/src/va_intel.cpp](../../../modules/core/src/va_intel.cpp)
...
- **VAAPIInterop**: A class/struct defined in this file

### Functions and Methods

- **pointers()**: A function/method defined in this file
- **for()**: A function/method defined in this file
- **OPENCV_LIBVA_LINK()**: A function/method defined in this file
- **clEnqueueAcquireVA_APIMediaSurfacesINTEL()**: A function/method defined in this file
- **clEnqueueReleaseVA_APIMediaSurfacesINTEL()**: A function/method defined in this file
- **HAVE_VA_INTEL()**: A function/method defined in this file
- **HAVE_VA_INTEL_OLD_HEADER()**: A function/method defined in this file
- **clCreateFromVA_APIMediaSurfaceINTEL()**: A function/method defined in this file
- **clGetDeviceIDsFromVA_APIMediaAdapterINTEL()**: A function/method defined in this file
