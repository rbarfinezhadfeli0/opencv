# Documentation for `modules/core/src/va_wrapper.impl.hpp`

## File Metadata

- **Full Path**: `modules/core/src/va_wrapper.impl.hpp`
- **File Name**: `va_wrapper.impl.hpp`
- **File Size**: 4,259 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/core/src/va_wrapper.impl.hpp](../../../modules/core/src/va_wrapper.impl.hpp)
...
- **VAStatus()**: A function/method defined in this file
