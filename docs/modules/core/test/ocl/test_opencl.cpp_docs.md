# Documentation for `modules/core/test/ocl/test_opencl.cpp`

## File Metadata

- **Full Path**: `modules/core/test/ocl/test_opencl.cpp`
- **File Name**: `test_opencl.cpp`
- **File Size**: 11,530 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/test/ocl/test_opencl.cpp](../../../../modules/core/test/ocl/test_opencl.cpp)
