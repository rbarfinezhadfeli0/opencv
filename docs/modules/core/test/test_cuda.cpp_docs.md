# Documentation for `modules/core/test/test_cuda.cpp`

## File Metadata

- **Full Path**: `modules/core/test/test_cuda.cpp`
- **File Name**: `test_cuda.cpp`
- **File Size**: 506 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/test/test_cuda.cpp](../../../modules/core/test/test_cuda.cpp)
