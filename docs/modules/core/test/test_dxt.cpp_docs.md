# Documentation for `modules/core/test/test_dxt.cpp`

## File Metadata

- **Full Path**: `modules/core/test/test_dxt.cpp`
- **File Name**: `test_dxt.cpp`
- **File Size**: 28,876 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/test/test_dxt.cpp](../../../modules/core/test/test_dxt.cpp)
...
- **CxCore_DFTTest**: A class/struct defined in this file
- **CxCore_DXTBaseTest**: A class/struct defined in this file
- **Core_DFTComplexOutputTest**: A class/struct defined in this file
- **CxCore_MulSpectrumsTest**: A class/struct defined in this file
- **Core_DXTReverseTest**: A class/struct defined in this file
- **CxCore_DCTTest**: A class/struct defined in this file
