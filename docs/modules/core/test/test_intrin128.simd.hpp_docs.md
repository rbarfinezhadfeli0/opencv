# Documentation for `modules/core/test/test_intrin128.simd.hpp`

## File Metadata

- **Full Path**: `modules/core/test/test_intrin128.simd.hpp`
- **File Name**: `test_intrin128.simd.hpp`
- **File Size**: 654 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/core/test/test_intrin128.simd.hpp](../../../modules/core/test/test_intrin128.simd.hpp)
...
- **CV__SIMD_FORCE_WIDTH()**: A function/method defined in this file
