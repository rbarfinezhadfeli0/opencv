# Documentation for `modules/core/test/test_intrin_utils.hpp`

## File Metadata

- **Full Path**: `modules/core/test/test_intrin_utils.hpp`
- **File Name**: `test_intrin_utils.hpp`
- **File Size**: 80,613 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/core/test/test_intrin_utils.hpp](../../../modules/core/test/test_intrin_utils.hpp)
...
- **TheTest**: A class/struct defined in this file
- **Data**: A class/struct defined in this file
- **AlignedData**: A class/struct defined in this file
