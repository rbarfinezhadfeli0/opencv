# Documentation for `modules/core/test/test_logtagmanager.cpp`

## File Metadata

- **Full Path**: `modules/core/test/test_logtagmanager.cpp`
- **File Name**: `test_logtagmanager.cpp`
- **File Size**: 25,342 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/test/test_logtagmanager.cpp](../../../modules/core/test/test_logtagmanager.cpp)
...
- **LogTagManagerTestFixture**: A class/struct defined in this file
- **LogTagManagerSubstrNonConfusionFixture**: A class/struct defined in this file
- **LogTagManagerNamePartNonConfusionFixture**: A class/struct defined in this file
- **Timing**: A class/struct defined in this file
- **LogTagManagerGlobalSmokeTest**: A class/struct defined in this file
- **ByWhat**: A class/struct defined in this file
- **LogTagManagerNonGlobalSmokeTest**: A class/struct defined in this file
- **SubstringType**: A class/struct defined in this file
- **MyTestParam**: A class/struct defined in this file
...
**C++ Includes:**
- `../src/utils/logtagconfigparser.hpp`
- `test_precomp.hpp`
- `opencv2/core/utils/logger.hpp`
- `../src/utils/logtagmanager.hpp`
