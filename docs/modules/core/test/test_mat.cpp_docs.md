# Documentation for `modules/core/test/test_mat.cpp`

## File Metadata

- **Full Path**: `modules/core/test/test_mat.cpp`
- **File Name**: `test_mat.cpp`
- **File Size**: 85,092 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/test/test_mat.cpp](../../../modules/core/test/test_mat.cpp)
...
- **EmptyFunctor**: A class/struct defined in this file
- **InitializerFunctor5D**: A class/struct defined in this file
- **Core_SplitTest**: A class/struct defined in this file
- **cv**: A class/struct defined in this file
- **InitializerFunctor**: A class/struct defined in this file
- **T**: A class/struct defined in this file
- **Core_ReduceTest**: A class/struct defined in this file
- **Core_ArrayOpTest**: A class/struct defined in this file
- **const**: A class/struct defined in this file
- **Core_MergeTest**: A class/struct defined in this file
- **Type**: A class/struct defined in this file
- **TestInputArrayRangeChecking**: A class/struct defined in this file
- **CustomType**: A class/struct defined in this file
- **Core_MergeSplitBaseTest**: A class/struct defined in this file
...
- **OPENCV_TEST_BIGDATA()**: A function/method defined in this file
- **HAVE_EIGEN()**: A function/method defined in this file
- **CHECK_C()**: A function/method defined in this file
- **OPENCV_EIGEN_TENSOR_SUPPORT()**: A function/method defined in this file
