# Documentation for `modules/core/test/test_math.cpp`

## File Metadata

- **Full Path**: `modules/core/test/test_math.cpp`
- **File Name**: `test_math.cpp`
- **File Size**: 136,240 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/test/test_math.cpp](../../../modules/core/test/test_math.cpp)
...
- **Core_TransformTest**: A class/struct defined in this file
- **Core_PerspectiveTransformTest**: A class/struct defined in this file
- **Core_CheckRange**: A class/struct defined in this file
- **Core_CovarMatrixTest**: A class/struct defined in this file
- **pred_complex**: A class/struct defined in this file
- **Core_DotProductTest**: A class/struct defined in this file
- **Core_MatrixTest**: A class/struct defined in this file
- **Core_CrossProductTest**: A class/struct defined in this file
- **Core_SolveTest**: A class/struct defined in this file
- **Core_PowTest**: A class/struct defined in this file
- **Core_TraceTest**: A class/struct defined in this file
- **Core_PhaseTest**: A class/struct defined in this file
- **Core_GEMMTest**: A class/struct defined in this file
- **Core_SolvePolyTest**: A class/struct defined in this file
- **CV_KMeansSingularTest**: A class/struct defined in this file
- **Core_MulTransposedTest**: A class/struct defined in this file
- **Core_SVDTest**: A class/struct defined in this file
- **Core_TransformLargeTest**: A class/struct defined in this file
- **Core_SVBkSbTest**: A class/struct defined in this file
- **testvalues**: A class/struct defined in this file
- **Core_MahalanobisTest**: A class/struct defined in this file
- **Core_DetTest**: A class/struct defined in this file
- **pred_double**: A class/struct defined in this file
- **Core_MathTest**: A class/struct defined in this file
- **Core_InvertTest**: A class/struct defined in this file

### Functions and Methods

- **testing()**: A function/method defined in this file
- **__riscv()**: A function/method defined in this file
- **cvtest()**: A function/method defined in this file
- **std()**: A function/method defined in this file
- **Core_MathTest()**: A function/method defined in this file
- **Core_MatrixTest()**: A function/method defined in this file
