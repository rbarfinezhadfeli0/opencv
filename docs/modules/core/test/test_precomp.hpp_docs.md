# Documentation for `modules/core/test/test_precomp.hpp`

## File Metadata

- **Full Path**: `modules/core/test/test_precomp.hpp`
- **File Name**: `test_precomp.hpp`
- **File Size**: 426 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/core/test/test_precomp.hpp](../../../modules/core/test/test_precomp.hpp)
