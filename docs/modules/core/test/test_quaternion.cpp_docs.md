# Documentation for `modules/core/test/test_quaternion.cpp`

## File Metadata

- **Full Path**: `modules/core/test/test_quaternion.cpp`
- **File Name**: `test_quaternion.cpp`
- **File Size**: 22,391 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/test/test_quaternion.cpp](../../../modules/core/test/test_quaternion.cpp)
...
- **QuatTest**: A class/struct defined in this file
- **DualQuatTest**: A class/struct defined in this file
