# Documentation for `modules/core/test/test_rand.cpp`

## File Metadata

- **Full Path**: `modules/core/test/test_rand.cpp`
- **File Name**: `test_rand.cpp`
- **File Size**: 14,181 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/core/test/test_rand.cpp](../../../modules/core/test/test_rand.cpp)
...
- **RandRowFillParallelLoopBody**: A class/struct defined in this file
- **Core_RandTest**: A class/struct defined in this file
- **Core_RandRangeTest**: A class/struct defined in this file
