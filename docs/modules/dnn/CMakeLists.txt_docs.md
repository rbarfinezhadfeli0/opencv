# Documentation for `modules/dnn/CMakeLists.txt`

## File Metadata

- **Full Path**: `modules/dnn/CMakeLists.txt`
- **File Name**: `CMakeLists.txt`
- **File Size**: 13,685 bytes
- **File Type**: .txt
- **Link to Source**: [modules/dnn/CMakeLists.txt](../../modules/dnn/CMakeLists.txt)

## Purpose and Role

This file is located in the `modules/dnn` directory and serves as part of the OpenCV library infrastructure.
