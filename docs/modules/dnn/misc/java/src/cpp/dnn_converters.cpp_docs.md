# Documentation for `modules/dnn/misc/java/src/cpp/dnn_converters.cpp`

## File Metadata

- **Full Path**: `modules/dnn/misc/java/src/cpp/dnn_converters.cpp`
- **File Name**: `dnn_converters.cpp`
- **File Size**: 4,653 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/misc/java/src/cpp/dnn_converters.cpp](../../../../../../modules/dnn/misc/java/src/cpp/dnn_converters.cpp)
...
- **jLayerClass**: A class/struct defined in this file
