# Documentation for `modules/dnn/misc/objc/gen_dict.json`

## File Metadata

- **Full Path**: `modules/dnn/misc/objc/gen_dict.json`
- **File Name**: `gen_dict.json`
- **File Size**: 4,345 bytes
- **File Type**: .json
- **Link to Source**: [modules/dnn/misc/objc/gen_dict.json](../../../../modules/dnn/misc/objc/gen_dict.json)

## Purpose and Role

This file is located in the `modules/dnn/misc/objc` directory and serves as part of the OpenCV library infrastructure.
