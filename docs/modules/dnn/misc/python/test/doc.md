# Documentation for `modules/dnn/misc/python/test/`
...
**Path**: `modules/dnn/misc/python/test/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[test_dnn.py](test_dnn.py_docs.md)**: PY file
...
- **Parent Folder**: [modules/dnn/misc/python/](../python/doc.md)
