# Documentation for `modules/dnn/misc/quantize_face_detector.py`

## File Metadata

- **Full Path**: `modules/dnn/misc/quantize_face_detector.py`
- **File Name**: `quantize_face_detector.py`
- **File Size**: 16,645 bytes
- **File Type**: .py
- **Link to Source**: [modules/dnn/misc/quantize_face_detector.py](../../../modules/dnn/misc/quantize_face_detector.py)
...
- **batch_norm()**: A function/method defined in this file
- **tensorMsg()**: A function/method defined in this file
- **conv()**: A function/method defined in this file
- **scale()**: A function/method defined in this file
- **l2norm()**: A function/method defined in this file
- **dnnLayer()**: A function/method defined in this file
