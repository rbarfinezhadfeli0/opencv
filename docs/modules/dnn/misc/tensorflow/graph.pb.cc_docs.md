# Documentation for `modules/dnn/misc/tensorflow/graph.pb.cc`

## File Metadata

- **Full Path**: `modules/dnn/misc/tensorflow/graph.pb.cc`
- **File Name**: `graph.pb.cc`
- **File Size**: 36,080 bytes
- **File Type**: .cc
- **Link to Source**: [modules/dnn/misc/tensorflow/graph.pb.cc](../../../../modules/dnn/misc/tensorflow/graph.pb.cc)
