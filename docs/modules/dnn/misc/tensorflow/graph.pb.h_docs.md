# Documentation for `modules/dnn/misc/tensorflow/graph.pb.h`

## File Metadata

- **Full Path**: `modules/dnn/misc/tensorflow/graph.pb.h`
- **File Name**: `graph.pb.h`
- **File Size**: 40,335 bytes
- **File Type**: .h
- **Link to Source**: [modules/dnn/misc/tensorflow/graph.pb.h](../../../../modules/dnn/misc/tensorflow/graph.pb.h)
...
- **NodeDef_AttrEntry_DoNotUse**: A class/struct defined in this file
- **NodeDef**: A class/struct defined in this file
- **_Internal**: A class/struct defined in this file
- **GraphDefDefaultTypeInternal**: A class/struct defined in this file
- **NodeDef_AttrEntry_DoNotUseDefaultTypeInternal**: A class/struct defined in this file
- **NodeDefDefaultTypeInternal**: A class/struct defined in this file
- **TableStruct_graph_2eproto**: A class/struct defined in this file
...
- **GOOGLE_PROTOBUF_INCLUDED_graph_2eproto()**: A function/method defined in this file
