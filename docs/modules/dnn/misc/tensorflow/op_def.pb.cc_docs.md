# Documentation for `modules/dnn/misc/tensorflow/op_def.pb.cc`

## File Metadata

- **Full Path**: `modules/dnn/misc/tensorflow/op_def.pb.cc`
- **File Name**: `op_def.pb.cc`
- **File Size**: 86,763 bytes
- **File Type**: .cc
- **Link to Source**: [modules/dnn/misc/tensorflow/op_def.pb.cc](../../../../modules/dnn/misc/tensorflow/op_def.pb.cc)
