# Documentation for `modules/dnn/misc/tensorflow/tensor_shape.pb.cc`

## File Metadata

- **Full Path**: `modules/dnn/misc/tensorflow/tensor_shape.pb.cc`
- **File Name**: `tensor_shape.pb.cc`
- **File Size**: 21,927 bytes
- **File Type**: .cc
- **Link to Source**: [modules/dnn/misc/tensorflow/tensor_shape.pb.cc](../../../../modules/dnn/misc/tensorflow/tensor_shape.pb.cc)
