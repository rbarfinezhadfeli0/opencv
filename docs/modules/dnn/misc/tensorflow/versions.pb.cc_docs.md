# Documentation for `modules/dnn/misc/tensorflow/versions.pb.cc`

## File Metadata

- **Full Path**: `modules/dnn/misc/tensorflow/versions.pb.cc`
- **File Name**: `versions.pb.cc`
- **File Size**: 13,351 bytes
- **File Type**: .cc
- **Link to Source**: [modules/dnn/misc/tensorflow/versions.pb.cc](../../../../modules/dnn/misc/tensorflow/versions.pb.cc)
