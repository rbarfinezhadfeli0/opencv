# Documentation for `modules/dnn/misc/tensorflow/versions.pb.h`

## File Metadata

- **Full Path**: `modules/dnn/misc/tensorflow/versions.pb.h`
- **File Name**: `versions.pb.h`
- **File Size**: 12,470 bytes
- **File Type**: .h
- **Link to Source**: [modules/dnn/misc/tensorflow/versions.pb.h](../../../../modules/dnn/misc/tensorflow/versions.pb.h)
...
- **TableStruct_versions_2eproto**: A class/struct defined in this file
- **VersionDef**: A class/struct defined in this file
- **VersionDefDefaultTypeInternal**: A class/struct defined in this file
- **AnyMetadata**: A class/struct defined in this file

### Functions and Methods

- **GOOGLE_PROTOBUF_INCLUDED_versions_2eproto()**: A function/method defined in this file
