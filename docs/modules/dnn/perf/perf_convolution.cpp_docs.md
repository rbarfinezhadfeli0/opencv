# Documentation for `modules/dnn/perf/perf_convolution.cpp`

## File Metadata

- **Full Path**: `modules/dnn/perf/perf_convolution.cpp`
- **File Name**: `perf_convolution.cpp`
- **File Size**: 100,719 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/perf/perf_convolution.cpp](../../../modules/dnn/perf/perf_convolution.cpp)
...
- **ConvParam_t**: A class/struct defined in this file
- **ConvParamGenerator**: A class/struct defined in this file
- **TestSize_**: A class/struct defined in this file
