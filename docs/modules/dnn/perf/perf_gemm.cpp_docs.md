# Documentation for `modules/dnn/perf/perf_gemm.cpp`

## File Metadata

- **Full Path**: `modules/dnn/perf/perf_gemm.cpp`
- **File Name**: `perf_gemm.cpp`
- **File Size**: 12,349 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/perf/perf_gemm.cpp](../../../modules/dnn/perf/perf_gemm.cpp)
...
- **GemmParamId**: A class/struct defined in this file
- **GemmParam_t**: A class/struct defined in this file
- **MatMulParamId**: A class/struct defined in this file
