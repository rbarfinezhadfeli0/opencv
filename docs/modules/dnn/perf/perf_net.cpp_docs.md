# Documentation for `modules/dnn/perf/perf_net.cpp`

## File Metadata

- **Full Path**: `modules/dnn/perf/perf_net.cpp`
- **File Name**: `perf_net.cpp`
- **File Size**: 16,589 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/perf/perf_net.cpp](../../../modules/dnn/perf/perf_net.cpp)
