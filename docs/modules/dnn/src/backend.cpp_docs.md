# Documentation for `modules/dnn/src/backend.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/backend.cpp`
- **File Name**: `backend.cpp`
- **File Size**: 768 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/backend.cpp](../../../modules/dnn/src/backend.cpp)
