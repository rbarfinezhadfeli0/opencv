# Documentation for `modules/dnn/src/cuda/activation_eltwise.cu`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda/activation_eltwise.cu`
- **File Name**: `activation_eltwise.cu`
- **File Size**: 6,551 bytes
- **File Type**: .cu
- **Link to Source**: [modules/dnn/src/cuda/activation_eltwise.cu](../../../../modules/dnn/src/cuda/activation_eltwise.cu)
