# Documentation for `modules/dnn/src/cuda/activations.cu`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda/activations.cu`
- **File Name**: `activations.cu`
- **File Size**: 17,337 bytes
- **File Type**: .cu
- **Link to Source**: [modules/dnn/src/cuda/activations.cu](../../../../modules/dnn/src/cuda/activations.cu)
