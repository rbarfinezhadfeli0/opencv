# Documentation for `modules/dnn/src/cuda/bbox_utils.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda/bbox_utils.hpp`
- **File Name**: `bbox_utils.hpp`
- **File Size**: 1,025 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda/bbox_utils.hpp](../../../../modules/dnn/src/cuda/bbox_utils.hpp)
...
- **BoundingBox**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_DNN_SRC_CUDA_BBOX_UTILS_HPP()**: A function/method defined in this file
