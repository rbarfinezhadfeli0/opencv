# Documentation for `modules/dnn/src/cuda/bias_activation.cu`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda/bias_activation.cu`
- **File Name**: `bias_activation.cu`
- **File Size**: 6,191 bytes
- **File Type**: .cu
- **Link to Source**: [modules/dnn/src/cuda/bias_activation.cu](../../../../modules/dnn/src/cuda/bias_activation.cu)
