# Documentation for `modules/dnn/src/cuda/bias_activation_eltwise.cu`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda/bias_activation_eltwise.cu`
- **File Name**: `bias_activation_eltwise.cu`
- **File Size**: 7,905 bytes
- **File Type**: .cu
- **Link to Source**: [modules/dnn/src/cuda/bias_activation_eltwise.cu](../../../../modules/dnn/src/cuda/bias_activation_eltwise.cu)
