# Documentation for `modules/dnn/src/cuda/bias_eltwise_activation.cu`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda/bias_eltwise_activation.cu`
- **File Name**: `bias_eltwise_activation.cu`
- **File Size**: 8,526 bytes
- **File Type**: .cu
- **Link to Source**: [modules/dnn/src/cuda/bias_eltwise_activation.cu](../../../../modules/dnn/src/cuda/bias_eltwise_activation.cu)
