# Documentation for `modules/dnn/src/cuda/block_stride_range.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda/block_stride_range.hpp`
- **File Name**: `block_stride_range.hpp`
- **File Size**: 2,351 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda/block_stride_range.hpp](../../../../modules/dnn/src/cuda/block_stride_range.hpp)
...
- **block_stride_range_generic**: A class/struct defined in this file
- **iterator**: A class/struct defined in this file
- **size_type**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_DNN_SRC_CUDA_BLOCK_STRIDE_RANGE_HPP()**: A function/method defined in this file
