# Documentation for `modules/dnn/src/cuda/concat.cu`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda/concat.cu`
- **File Name**: `concat.cu`
- **File Size**: 12,827 bytes
- **File Type**: .cu
- **Link to Source**: [modules/dnn/src/cuda/concat.cu](../../../../modules/dnn/src/cuda/concat.cu)
