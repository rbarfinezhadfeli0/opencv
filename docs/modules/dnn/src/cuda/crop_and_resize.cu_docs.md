# Documentation for `modules/dnn/src/cuda/crop_and_resize.cu`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda/crop_and_resize.cu`
- **File Name**: `crop_and_resize.cu`
- **File Size**: 8,331 bytes
- **File Type**: .cu
- **Link to Source**: [modules/dnn/src/cuda/crop_and_resize.cu](../../../../modules/dnn/src/cuda/crop_and_resize.cu)
