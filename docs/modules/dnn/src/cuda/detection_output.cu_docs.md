# Documentation for `modules/dnn/src/cuda/detection_output.cu`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda/detection_output.cu`
- **File Name**: `detection_output.cu`
- **File Size**: 38,051 bytes
- **File Type**: .cu
- **Link to Source**: [modules/dnn/src/cuda/detection_output.cu](../../../../modules/dnn/src/cuda/detection_output.cu)
