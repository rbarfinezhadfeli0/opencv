# Documentation for `modules/dnn/src/cuda/eltwise_activation.cu`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda/eltwise_activation.cu`
- **File Name**: `eltwise_activation.cu`
- **File Size**: 6,367 bytes
- **File Type**: .cu
- **Link to Source**: [modules/dnn/src/cuda/eltwise_activation.cu](../../../../modules/dnn/src/cuda/eltwise_activation.cu)
