# Documentation for `modules/dnn/src/cuda/fp_conversion.cu`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda/fp_conversion.cu`
- **File Name**: `fp_conversion.cu`
- **File Size**: 4,214 bytes
- **File Type**: .cu
- **Link to Source**: [modules/dnn/src/cuda/fp_conversion.cu](../../../../modules/dnn/src/cuda/fp_conversion.cu)
