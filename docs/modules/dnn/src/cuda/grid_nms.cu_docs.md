# Documentation for `modules/dnn/src/cuda/grid_nms.cu`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda/grid_nms.cu`
- **File Name**: `grid_nms.cu`
- **File Size**: 20,423 bytes
- **File Type**: .cu
- **Link to Source**: [modules/dnn/src/cuda/grid_nms.cu](../../../../modules/dnn/src/cuda/grid_nms.cu)
