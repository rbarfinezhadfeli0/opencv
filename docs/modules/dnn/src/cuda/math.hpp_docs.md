# Documentation for `modules/dnn/src/cuda/math.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda/math.hpp`
- **File Name**: `math.hpp`
- **File Size**: 12,915 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda/math.hpp](../../../../modules/dnn/src/cuda/math.hpp)
...
- **OPENCV_DNN_SRC_CUDA_MATH_HPP()**: A function/method defined in this file
