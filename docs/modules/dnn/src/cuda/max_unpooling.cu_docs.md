# Documentation for `modules/dnn/src/cuda/max_unpooling.cu`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda/max_unpooling.cu`
- **File Name**: `max_unpooling.cu`
- **File Size**: 15,009 bytes
- **File Type**: .cu
- **Link to Source**: [modules/dnn/src/cuda/max_unpooling.cu](../../../../modules/dnn/src/cuda/max_unpooling.cu)
