# Documentation for `modules/dnn/src/cuda/memory.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda/memory.hpp`
- **File Name**: `memory.hpp`
- **File Size**: 819 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda/memory.hpp](../../../../modules/dnn/src/cuda/memory.hpp)
...
- **OPENCV_DNN_SRC_CUDA_MEMORY_HPP()**: A function/method defined in this file
