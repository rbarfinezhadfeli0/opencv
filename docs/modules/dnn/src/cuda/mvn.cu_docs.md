# Documentation for `modules/dnn/src/cuda/mvn.cu`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda/mvn.cu`
- **File Name**: `mvn.cu`
- **File Size**: 12,941 bytes
- **File Type**: .cu
- **Link to Source**: [modules/dnn/src/cuda/mvn.cu](../../../../modules/dnn/src/cuda/mvn.cu)
