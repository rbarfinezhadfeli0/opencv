# Documentation for `modules/dnn/src/cuda/normalize.cu`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda/normalize.cu`
- **File Name**: `normalize.cu`
- **File Size**: 4,965 bytes
- **File Type**: .cu
- **Link to Source**: [modules/dnn/src/cuda/normalize.cu](../../../../modules/dnn/src/cuda/normalize.cu)
