# Documentation for `modules/dnn/src/cuda/padding.cu`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda/padding.cu`
- **File Name**: `padding.cu`
- **File Size**: 9,184 bytes
- **File Type**: .cu
- **Link to Source**: [modules/dnn/src/cuda/padding.cu](../../../../modules/dnn/src/cuda/padding.cu)
