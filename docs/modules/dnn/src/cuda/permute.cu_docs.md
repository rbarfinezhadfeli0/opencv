# Documentation for `modules/dnn/src/cuda/permute.cu`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda/permute.cu`
- **File Name**: `permute.cu`
- **File Size**: 12,471 bytes
- **File Type**: .cu
- **Link to Source**: [modules/dnn/src/cuda/permute.cu](../../../../modules/dnn/src/cuda/permute.cu)
