# Documentation for `modules/dnn/src/cuda/prior_box.cu`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda/prior_box.cu`
- **File Name**: `prior_box.cu`
- **File Size**: 7,827 bytes
- **File Type**: .cu
- **Link to Source**: [modules/dnn/src/cuda/prior_box.cu](../../../../modules/dnn/src/cuda/prior_box.cu)
