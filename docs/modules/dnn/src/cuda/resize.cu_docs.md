# Documentation for `modules/dnn/src/cuda/resize.cu`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda/resize.cu`
- **File Name**: `resize.cu`
- **File Size**: 13,032 bytes
- **File Type**: .cu
- **Link to Source**: [modules/dnn/src/cuda/resize.cu](../../../../modules/dnn/src/cuda/resize.cu)
