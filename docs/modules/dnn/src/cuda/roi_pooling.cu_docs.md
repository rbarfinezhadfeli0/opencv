# Documentation for `modules/dnn/src/cuda/roi_pooling.cu`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda/roi_pooling.cu`
- **File Name**: `roi_pooling.cu`
- **File Size**: 9,185 bytes
- **File Type**: .cu
- **Link to Source**: [modules/dnn/src/cuda/roi_pooling.cu](../../../../modules/dnn/src/cuda/roi_pooling.cu)
