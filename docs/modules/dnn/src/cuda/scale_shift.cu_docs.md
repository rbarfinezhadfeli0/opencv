# Documentation for `modules/dnn/src/cuda/scale_shift.cu`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda/scale_shift.cu`
- **File Name**: `scale_shift.cu`
- **File Size**: 10,274 bytes
- **File Type**: .cu
- **Link to Source**: [modules/dnn/src/cuda/scale_shift.cu](../../../../modules/dnn/src/cuda/scale_shift.cu)
