# Documentation for `modules/dnn/src/cuda/shortcut.cu`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda/shortcut.cu`
- **File Name**: `shortcut.cu`
- **File Size**: 4,887 bytes
- **File Type**: .cu
- **Link to Source**: [modules/dnn/src/cuda/shortcut.cu](../../../../modules/dnn/src/cuda/shortcut.cu)
