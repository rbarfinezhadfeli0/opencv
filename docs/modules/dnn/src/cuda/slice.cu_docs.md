# Documentation for `modules/dnn/src/cuda/slice.cu`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda/slice.cu`
- **File Name**: `slice.cu`
- **File Size**: 8,753 bytes
- **File Type**: .cu
- **Link to Source**: [modules/dnn/src/cuda/slice.cu](../../../../modules/dnn/src/cuda/slice.cu)
