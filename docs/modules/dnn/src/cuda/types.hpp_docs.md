# Documentation for `modules/dnn/src/cuda/types.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda/types.hpp`
- **File Name**: `types.hpp`
- **File Size**: 968 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda/types.hpp](../../../../modules/dnn/src/cuda/types.hpp)
...
- **OPENCV_DNN_SRC_CUDA_TYPES_HPP()**: A function/method defined in this file
