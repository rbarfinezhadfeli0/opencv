# Documentation for `modules/dnn/src/cuda4dnn/csl/cublas.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/csl/cublas.hpp`
- **File Name**: `cublas.hpp`
- **File Size**: 22,700 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/csl/cublas.hpp](../../../../../modules/dnn/src/cuda4dnn/csl/cublas.hpp)
...
- **cuBLASException**: A class/struct defined in this file
- **Handle**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_DNN_SRC_CUDA4DNN_CSL_CUBLAS_HPP()**: A function/method defined in this file
