# Documentation for `modules/dnn/src/cuda4dnn/csl/cudnn/convolution.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/csl/cudnn/convolution.hpp`
- **File Name**: `convolution.hpp`
- **File Size**: 25,483 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/csl/cudnn/convolution.hpp](../../../../../../modules/dnn/src/cuda4dnn/csl/cudnn/convolution.hpp)
...
- **ConvolutionDescriptor**: A class/struct defined in this file
- **ForwardItr**: A class/struct defined in this file
- **FilterDescriptor**: A class/struct defined in this file
- **ConvolutionAlgorithm**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_DNN_CUDA4DNN_CSL_CUDNN_CONVOLUTION_HPP()**: A function/method defined in this file
