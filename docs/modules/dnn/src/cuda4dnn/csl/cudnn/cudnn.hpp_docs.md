# Documentation for `modules/dnn/src/cuda4dnn/csl/cudnn/cudnn.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/csl/cudnn/cudnn.hpp`
- **File Name**: `cudnn.hpp`
- **File Size**: 12,388 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/csl/cudnn/cudnn.hpp](../../../../../../modules/dnn/src/cuda4dnn/csl/cudnn/cudnn.hpp)
...
- **UniqueHandle**: A class/struct defined in this file
- **for**: A class/struct defined in this file
- **TensorDescriptor**: A class/struct defined in this file
- **T**: A class/struct defined in this file
- **TensorDescriptorsArray**: A class/struct defined in this file
- **cuDNNException**: A class/struct defined in this file
- **SequenceContainer**: A class/struct defined in this file
- **Handle**: A class/struct defined in this file
- **ForwardItr**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_DNN_CUDA4DNN_CSL_CUDNN_CUDNN_HPP()**: A function/method defined in this file
