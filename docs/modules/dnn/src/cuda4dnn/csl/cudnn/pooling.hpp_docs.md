# Documentation for `modules/dnn/src/cuda4dnn/csl/cudnn/pooling.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/csl/cudnn/pooling.hpp`
- **File Name**: `pooling.hpp`
- **File Size**: 8,519 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/csl/cudnn/pooling.hpp](../../../../../../modules/dnn/src/cuda4dnn/csl/cudnn/pooling.hpp)
...
- **PoolingType**: A class/struct defined in this file
- **SequenceContainer**: A class/struct defined in this file
- **T**: A class/struct defined in this file
- **PoolingDescriptor**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_DNN_CUDA4DNN_CSL_CUDNN_POOLING_HPP()**: A function/method defined in this file
