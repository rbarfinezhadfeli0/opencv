# Documentation for `modules/dnn/src/cuda4dnn/csl/nvcc_defs.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/csl/nvcc_defs.hpp`
- **File Name**: `nvcc_defs.hpp`
- **File Size**: 632 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/csl/nvcc_defs.hpp](../../../../../modules/dnn/src/cuda4dnn/csl/nvcc_defs.hpp)
...
- **OPENCV_DNN_SRC_CUDA4DNN_CSL_NVCC_DEFS_HPP()**: A function/method defined in this file
