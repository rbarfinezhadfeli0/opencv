# Documentation for `modules/dnn/src/cuda4dnn/csl/tensor.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/csl/tensor.hpp`
- **File Name**: `tensor.hpp`
- **File Size**: 48,586 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/csl/tensor.hpp](../../../../../modules/dnn/src/cuda4dnn/csl/tensor.hpp)
...
- **TensorType1**: A class/struct defined in this file
- **T**: A class/struct defined in this file
- **Tensor**: A class/struct defined in this file
- **TensorType**: A class/struct defined in this file
- **ForwardItr**: A class/struct defined in this file
- **TensorView**: A class/struct defined in this file
- **TensorType2**: A class/struct defined in this file
- **TensorSpan**: A class/struct defined in this file

### Functions and Methods

- **CSL_MAX_TENSOR_RANK()**: A function/method defined in this file
- **OPENCV_DNN_SRC_CUDA4DNN_CSL_TENSOR_HPP()**: A function/method defined in this file
