# Documentation for `modules/dnn/src/cuda4dnn/csl/tensor_ops.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/csl/tensor_ops.hpp`
- **File Name**: `tensor_ops.hpp`
- **File Size**: 27,787 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/csl/tensor_ops.hpp](../../../../../modules/dnn/src/cuda4dnn/csl/tensor_ops.hpp)
...
- **params_type**: A class/struct defined in this file
- **TransposeConvolution**: A class/struct defined in this file
- **T**: A class/struct defined in this file
- **LRN**: A class/struct defined in this file
- **Convolution**: A class/struct defined in this file
- **SequenceContainer**: A class/struct defined in this file
- **LSTM**: A class/struct defined in this file
- **TensorTransform**: A class/struct defined in this file
- **Pooling**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_DNN_SRC_CUDA4DNN_CSL_TENSOR_OPS_HPP()**: A function/method defined in this file
