# Documentation for `modules/dnn/src/cuda4dnn/cxx_utils/is_iterator.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/cxx_utils/is_iterator.hpp`
- **File Name**: `is_iterator.hpp`
- **File Size**: 1,174 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/cxx_utils/is_iterator.hpp](../../../../../modules/dnn/src/cuda4dnn/cxx_utils/is_iterator.hpp)
...
- **is_iterator_helper**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_DNN_SRC_CUDA4DNN_CXX_UTILS_IS_ITERATOR_HPP()**: A function/method defined in this file
