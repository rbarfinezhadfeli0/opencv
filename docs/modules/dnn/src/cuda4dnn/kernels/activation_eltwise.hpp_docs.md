# Documentation for `modules/dnn/src/cuda4dnn/kernels/activation_eltwise.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/kernels/activation_eltwise.hpp`
- **File Name**: `activation_eltwise.hpp`
- **File Size**: 1,694 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/kernels/activation_eltwise.hpp](../../../../../modules/dnn/src/cuda4dnn/kernels/activation_eltwise.hpp)
...
- **OPENCV_DNN_SRC_CUDA4DNN_KERNELS_ACTIVATION_ELTWISE_HPP()**: A function/method defined in this file
