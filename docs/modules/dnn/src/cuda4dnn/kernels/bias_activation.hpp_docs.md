# Documentation for `modules/dnn/src/cuda4dnn/kernels/bias_activation.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/kernels/bias_activation.hpp`
- **File Name**: `bias_activation.hpp`
- **File Size**: 1,711 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/kernels/bias_activation.hpp](../../../../../modules/dnn/src/cuda4dnn/kernels/bias_activation.hpp)
...
- **OPENCV_DNN_SRC_CUDA4DNN_KERNELS_BIAS_ACTIVATION_HPP()**: A function/method defined in this file
