# Documentation for `modules/dnn/src/cuda4dnn/kernels/concat.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/kernels/concat.hpp`
- **File Name**: `concat.hpp`
- **File Size**: 942 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/kernels/concat.hpp](../../../../../modules/dnn/src/cuda4dnn/kernels/concat.hpp)
...
- **OPENCV_DNN_SRC_CUDA4DNN_KERNELS_CONCAT_HPP()**: A function/method defined in this file
