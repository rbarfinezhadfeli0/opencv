# Documentation for `modules/dnn/src/cuda4dnn/kernels/eltwise_activation.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/kernels/eltwise_activation.hpp`
- **File Name**: `eltwise_activation.hpp`
- **File Size**: 1,625 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/kernels/eltwise_activation.hpp](../../../../../modules/dnn/src/cuda4dnn/kernels/eltwise_activation.hpp)
...
- **OPENCV_DNN_SRC_CUDA4DNN_KERNELS_ELTWISE_ACTIVATION_HPP()**: A function/method defined in this file
