# Documentation for `modules/dnn/src/cuda4dnn/kernels/eltwise_ops.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/kernels/eltwise_ops.hpp`
- **File Name**: `eltwise_ops.hpp`
- **File Size**: 2,060 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/kernels/eltwise_ops.hpp](../../../../../modules/dnn/src/cuda4dnn/kernels/eltwise_ops.hpp)
...
- **OPENCV_DNN_SRC_CUDA4DNN_KERNELS_ELTWISE_OPS_HPP()**: A function/method defined in this file
