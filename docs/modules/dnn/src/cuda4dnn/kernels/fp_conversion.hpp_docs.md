# Documentation for `modules/dnn/src/cuda4dnn/kernels/fp_conversion.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/kernels/fp_conversion.hpp`
- **File Name**: `fp_conversion.hpp`
- **File Size**: 751 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/kernels/fp_conversion.hpp](../../../../../modules/dnn/src/cuda4dnn/kernels/fp_conversion.hpp)
...
- **OPENCV_DNN_SRC_CUDA4DNN_KERNELS_FP_CONVERSION_HPP()**: A function/method defined in this file
