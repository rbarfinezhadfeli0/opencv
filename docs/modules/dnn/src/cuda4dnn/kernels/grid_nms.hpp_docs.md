# Documentation for `modules/dnn/src/cuda4dnn/kernels/grid_nms.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/kernels/grid_nms.hpp`
- **File Name**: `grid_nms.hpp`
- **File Size**: 921 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/kernels/grid_nms.hpp](../../../../../modules/dnn/src/cuda4dnn/kernels/grid_nms.hpp)
...
- **OPENCV_DNN_SRC_CUDA4DNN_KERNELS_GRID_NMS_HPP()**: A function/method defined in this file
