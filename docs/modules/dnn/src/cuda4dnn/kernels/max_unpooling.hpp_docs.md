# Documentation for `modules/dnn/src/cuda4dnn/kernels/max_unpooling.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/kernels/max_unpooling.hpp`
- **File Name**: `max_unpooling.hpp`
- **File Size**: 1,247 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/kernels/max_unpooling.hpp](../../../../../modules/dnn/src/cuda4dnn/kernels/max_unpooling.hpp)
...
- **OPENCV_DNN_SRC_CUDA4DNN_KERNELS_MAX_UNPOOLING_HPP()**: A function/method defined in this file
