# Documentation for `modules/dnn/src/cuda4dnn/kernels/normalize.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/kernels/normalize.hpp`
- **File Name**: `normalize.hpp`
- **File Size**: 830 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/kernels/normalize.hpp](../../../../../modules/dnn/src/cuda4dnn/kernels/normalize.hpp)
...
- **OPENCV_DNN_SRC_CUDA4DNN_KERNELS_NORMALIZE_HPP()**: A function/method defined in this file
