# Documentation for `modules/dnn/src/cuda4dnn/kernels/padding.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/kernels/padding.hpp`
- **File Name**: `padding.hpp`
- **File Size**: 815 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/kernels/padding.hpp](../../../../../modules/dnn/src/cuda4dnn/kernels/padding.hpp)
...
- **OPENCV_DNN_SRC_CUDA4DNN_KERNELS_PADDING_HPP()**: A function/method defined in this file
