# Documentation for `modules/dnn/src/cuda4dnn/kernels/permute.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/kernels/permute.hpp`
- **File Name**: `permute.hpp`
- **File Size**: 887 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/kernels/permute.hpp](../../../../../modules/dnn/src/cuda4dnn/kernels/permute.hpp)
...
- **OPENCV_DNN_SRC_CUDA4DNN_KERNELS_PERMUTE_HPP()**: A function/method defined in this file
