# Documentation for `modules/dnn/src/cuda4dnn/kernels/prior_box.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/kernels/prior_box.hpp`
- **File Name**: `prior_box.hpp`
- **File Size**: 1,040 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/kernels/prior_box.hpp](../../../../../modules/dnn/src/cuda4dnn/kernels/prior_box.hpp)
...
- **OPENCV_DNN_SRC_CUDA4DNN_KERNELS_PRIOR_BOX_HPP()**: A function/method defined in this file
