# Documentation for `modules/dnn/src/cuda4dnn/kernels/region.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/kernels/region.hpp`
- **File Name**: `region.hpp`
- **File Size**: 964 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/kernels/region.hpp](../../../../../modules/dnn/src/cuda4dnn/kernels/region.hpp)
...
- **OPENCV_DNN_SRC_CUDA4DNN_KERNELS_REGION_HPP()**: A function/method defined in this file
