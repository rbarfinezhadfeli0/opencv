# Documentation for `modules/dnn/src/cuda4dnn/kernels/resize.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/kernels/resize.hpp`
- **File Name**: `resize.hpp`
- **File Size**: 911 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/kernels/resize.hpp](../../../../../modules/dnn/src/cuda4dnn/kernels/resize.hpp)
...
- **OPENCV_DNN_SRC_CUDA4DNN_KERNELS_RESIZE_HPP()**: A function/method defined in this file
