# Documentation for `modules/dnn/src/cuda4dnn/kernels/roi_pooling.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/kernels/roi_pooling.hpp`
- **File Name**: `roi_pooling.hpp`
- **File Size**: 743 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/kernels/roi_pooling.hpp](../../../../../modules/dnn/src/cuda4dnn/kernels/roi_pooling.hpp)
...
- **OPENCV_DNN_SRC_CUDA4DNN_KERNELS_ROI_POOLING_HPP()**: A function/method defined in this file
