# Documentation for `modules/dnn/src/cuda4dnn/kernels/scale_shift.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/kernels/scale_shift.hpp`
- **File Name**: `scale_shift.hpp`
- **File Size**: 1,321 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/kernels/scale_shift.hpp](../../../../../modules/dnn/src/cuda4dnn/kernels/scale_shift.hpp)
...
- **OPENCV_DNN_SRC_CUDA4DNN_KERNELS_SCALE_HPP()**: A function/method defined in this file
