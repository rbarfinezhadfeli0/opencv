# Documentation for `modules/dnn/src/cuda4dnn/kernels/shortcut.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/kernels/shortcut.hpp`
- **File Name**: `shortcut.hpp`
- **File Size**: 695 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/kernels/shortcut.hpp](../../../../../modules/dnn/src/cuda4dnn/kernels/shortcut.hpp)
...
- **OPENCV_DNN_SRC_CUDA4DNN_KERNELS_SHORTCUT_HPP()**: A function/method defined in this file
