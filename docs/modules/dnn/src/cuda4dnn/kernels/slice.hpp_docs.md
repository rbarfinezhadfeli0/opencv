# Documentation for `modules/dnn/src/cuda4dnn/kernels/slice.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/kernels/slice.hpp`
- **File Name**: `slice.hpp`
- **File Size**: 722 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/kernels/slice.hpp](../../../../../modules/dnn/src/cuda4dnn/kernels/slice.hpp)
...
- **OPENCV_DNN_SRC_CUDA4DNN_KERNELS_SLICE_HPP()**: A function/method defined in this file
