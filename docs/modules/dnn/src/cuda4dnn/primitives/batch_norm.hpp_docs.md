# Documentation for `modules/dnn/src/cuda4dnn/primitives/batch_norm.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/primitives/batch_norm.hpp`
- **File Name**: `batch_norm.hpp`
- **File Size**: 1,981 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/primitives/batch_norm.hpp](../../../../../modules/dnn/src/cuda4dnn/primitives/batch_norm.hpp)
...
- **BatchNormOp**: A class/struct defined in this file
- **T**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_DNN_SRC_CUDA4DNN_PRIMITIVES_BATCH_NORM_HPP()**: A function/method defined in this file
