# Documentation for `modules/dnn/src/cuda4dnn/primitives/convolution.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/primitives/convolution.hpp`
- **File Name**: `convolution.hpp`
- **File Size**: 31,595 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/primitives/convolution.hpp](../../../../../modules/dnn/src/cuda4dnn/primitives/convolution.hpp)
...
- **PaddingMode**: A class/struct defined in this file
- **InternalFusionLocation**: A class/struct defined in this file
- **ConvolutionOp**: A class/struct defined in this file
- **T**: A class/struct defined in this file
- **FusionMode**: A class/struct defined in this file
- **ActivationType**: A class/struct defined in this file
- **ConvolutionConfiguration**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_DNN_SRC_CUDA4DNN_PRIMITIVES_CONVOLUTION_HPP()**: A function/method defined in this file
...
- `../../op_cuda.hpp`
- `../csl/cudnn.hpp`
- `../kernels/eltwise_activation.hpp`
- `cstddef`
- `opencv2/core.hpp`
- `../csl/tensor.hpp`
- `cstdint`
- `../kernels/activations.hpp`
- `../kernels/activation_eltwise.hpp`
- `../kernels/bias_eltwise_activation.hpp`
...
- `../kernels/bias_activation_eltwise.hpp`
