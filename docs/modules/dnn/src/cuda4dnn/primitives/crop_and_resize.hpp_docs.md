# Documentation for `modules/dnn/src/cuda4dnn/primitives/crop_and_resize.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/primitives/crop_and_resize.hpp`
- **File Name**: `crop_and_resize.hpp`
- **File Size**: 1,668 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/primitives/crop_and_resize.hpp](../../../../../modules/dnn/src/cuda4dnn/primitives/crop_and_resize.hpp)
...
- **CropAndResizeOp**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_DNN_SRC_CUDA4DNN_PRIMITIVES_CROP_AND_RESIZE_HPP()**: A function/method defined in this file
