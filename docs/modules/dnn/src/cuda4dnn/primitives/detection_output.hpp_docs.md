# Documentation for `modules/dnn/src/cuda4dnn/primitives/detection_output.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/primitives/detection_output.hpp`
- **File Name**: `detection_output.hpp`
- **File Size**: 11,894 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/primitives/detection_output.hpp](../../../../../modules/dnn/src/cuda4dnn/primitives/detection_output.hpp)
...
- **DetectionOutputConfiguration**: A class/struct defined in this file
- **DetectionOutputOp**: A class/struct defined in this file
- **T**: A class/struct defined in this file
- **CodeType**: A class/struct defined in this file
- **of**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_DNN_SRC_CUDA4DNN_PRIMITIVES_DETECTION_OUTPUT_HPP()**: A function/method defined in this file
...
- `utility`
- `../../op_cuda.hpp`
- `../kernels/detection_output.hpp`
- `../kernels/permute.hpp`
- `../csl/stream.hpp`
- `cstddef`
- `../kernels/fill_copy.hpp`
- `../kernels/grid_nms.hpp`
- `../csl/tensor.hpp`
