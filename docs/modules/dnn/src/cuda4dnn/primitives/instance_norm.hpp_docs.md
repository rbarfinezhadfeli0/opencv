# Documentation for `modules/dnn/src/cuda4dnn/primitives/instance_norm.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/primitives/instance_norm.hpp`
- **File Name**: `instance_norm.hpp`
- **File Size**: 3,146 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/primitives/instance_norm.hpp](../../../../../modules/dnn/src/cuda4dnn/primitives/instance_norm.hpp)
...
- **InstanceNormOp**: A class/struct defined in this file
- **T**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_DNN_SRC_CUDA4DNN_PRIMITIVES_INSTANCE_NORM_HPP()**: A function/method defined in this file
