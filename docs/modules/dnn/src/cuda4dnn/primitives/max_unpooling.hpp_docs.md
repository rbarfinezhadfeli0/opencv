# Documentation for `modules/dnn/src/cuda4dnn/primitives/max_unpooling.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/primitives/max_unpooling.hpp`
- **File Name**: `max_unpooling.hpp`
- **File Size**: 6,723 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/primitives/max_unpooling.hpp](../../../../../modules/dnn/src/cuda4dnn/primitives/max_unpooling.hpp)
...
- **MaxPoolingConfiguration**: A class/struct defined in this file
- **MaxPoolingOp**: A class/struct defined in this file
- **MaxUnpoolingOp**: A class/struct defined in this file
- **T**: A class/struct defined in this file
- **MaxUnpoolingConfiguration**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_DNN_SRC_CUDA4DNN_PRIMITIVES_MAX_UNPOOLING_HPP()**: A function/method defined in this file
