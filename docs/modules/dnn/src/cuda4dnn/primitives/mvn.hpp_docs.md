# Documentation for `modules/dnn/src/cuda4dnn/primitives/mvn.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/primitives/mvn.hpp`
- **File Name**: `mvn.hpp`
- **File Size**: 4,699 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/primitives/mvn.hpp](../../../../../modules/dnn/src/cuda4dnn/primitives/mvn.hpp)
...
- **MVNConfiguration**: A class/struct defined in this file
- **MVNOp**: A class/struct defined in this file
- **T**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_DNN_SRC_CUDA4DNN_PRIMITIVES_MVN_HPP()**: A function/method defined in this file
