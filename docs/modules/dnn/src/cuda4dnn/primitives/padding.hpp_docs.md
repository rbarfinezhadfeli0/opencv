# Documentation for `modules/dnn/src/cuda4dnn/primitives/padding.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/primitives/padding.hpp`
- **File Name**: `padding.hpp`
- **File Size**: 4,491 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/primitives/padding.hpp](../../../../../modules/dnn/src/cuda4dnn/primitives/padding.hpp)
...
- **PaddingOp**: A class/struct defined in this file
- **T**: A class/struct defined in this file
- **PaddingType**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_DNN_SRC_CUDA4DNN_PRIMITIVES_PADDING_HPP()**: A function/method defined in this file
