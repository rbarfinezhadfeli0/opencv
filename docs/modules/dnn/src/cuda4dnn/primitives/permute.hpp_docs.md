# Documentation for `modules/dnn/src/cuda4dnn/primitives/permute.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/primitives/permute.hpp`
- **File Name**: `permute.hpp`
- **File Size**: 2,180 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/primitives/permute.hpp](../../../../../modules/dnn/src/cuda4dnn/primitives/permute.hpp)
...
- **PermuteOp**: A class/struct defined in this file
- **T**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_DNN_SRC_CUDA4DNN_PRIMITIVES_PERMUTE_HPP()**: A function/method defined in this file
