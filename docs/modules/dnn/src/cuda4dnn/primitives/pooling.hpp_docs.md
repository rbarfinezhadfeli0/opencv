# Documentation for `modules/dnn/src/cuda4dnn/primitives/pooling.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/primitives/pooling.hpp`
- **File Name**: `pooling.hpp`
- **File Size**: 11,178 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/primitives/pooling.hpp](../../../../../modules/dnn/src/cuda4dnn/primitives/pooling.hpp)
...
- **PoolingMode**: A class/struct defined in this file
- **T**: A class/struct defined in this file
- **PoolingOp**: A class/struct defined in this file
- **RoundingMode**: A class/struct defined in this file
- **PoolingConfiguration**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_DNN_SRC_CUDA4DNN_PRIMITIVES_POOLING_HPP()**: A function/method defined in this file
