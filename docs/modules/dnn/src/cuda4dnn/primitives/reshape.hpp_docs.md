# Documentation for `modules/dnn/src/cuda4dnn/primitives/reshape.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/primitives/reshape.hpp`
- **File Name**: `reshape.hpp`
- **File Size**: 1,992 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/primitives/reshape.hpp](../../../../../modules/dnn/src/cuda4dnn/primitives/reshape.hpp)
...
- **ReshapeOp**: A class/struct defined in this file
- **T**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_DNN_SRC_CUDA4DNN_PRIMITIVES_RESHAPE_HPP()**: A function/method defined in this file
