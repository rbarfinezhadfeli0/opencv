# Documentation for `modules/dnn/src/cuda4dnn/primitives/roi_pooling.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/primitives/roi_pooling.hpp`
- **File Name**: `roi_pooling.hpp`
- **File Size**: 1,698 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/primitives/roi_pooling.hpp](../../../../../modules/dnn/src/cuda4dnn/primitives/roi_pooling.hpp)
...
- **ROIPoolingOp**: A class/struct defined in this file
- **T**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_DNN_SRC_CUDA4DNN_PRIMITIVES_ROI_POOLING_HPP()**: A function/method defined in this file
