# Documentation for `modules/dnn/src/cuda4dnn/primitives/softmax.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/primitives/softmax.hpp`
- **File Name**: `softmax.hpp`
- **File Size**: 1,687 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/primitives/softmax.hpp](../../../../../modules/dnn/src/cuda4dnn/primitives/softmax.hpp)
...
- **SoftmaxOp**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_DNN_SRC_CUDA4DNN_PRIMITIVES_SOFTMAX_HPP()**: A function/method defined in this file
