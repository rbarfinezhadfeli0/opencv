# Documentation for `modules/dnn/src/cuda4dnn/primitives/transpose_convolution.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/cuda4dnn/primitives/transpose_convolution.hpp`
- **File Name**: `transpose_convolution.hpp`
- **File Size**: 10,276 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/cuda4dnn/primitives/transpose_convolution.hpp](../../../../../modules/dnn/src/cuda4dnn/primitives/transpose_convolution.hpp)
...
- **TransposeConvolutionOp**: A class/struct defined in this file
- **TransposeConvolutionConfiguration**: A class/struct defined in this file
- **PaddingMode**: A class/struct defined in this file
- **T**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_DNN_SRC_CUDA4DNN_PRIMITIVES_TRANSPOSE_CONVOLUTION_HPP()**: A function/method defined in this file
