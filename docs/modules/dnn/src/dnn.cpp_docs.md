# Documentation for `modules/dnn/src/dnn.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/dnn.cpp`
- **File Name**: `dnn.cpp`
- **File Size**: 547 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/dnn.cpp](../../../modules/dnn/src/dnn.cpp)
...
// This is a stub file to provide git history information.
// Content has been moved, see PR: https://github.com/opencv/opencv/pull/21662
