# Documentation for `modules/dnn/src/dnn_utils.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/dnn_utils.cpp`
- **File Name**: `dnn_utils.cpp`
- **File Size**: 21,208 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/dnn_utils.cpp](../../../modules/dnn/src/dnn_utils.cpp)
...
- **Tmat**: A class/struct defined in this file
