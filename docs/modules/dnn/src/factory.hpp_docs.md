# Documentation for `modules/dnn/src/factory.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/factory.hpp`
- **File Name**: `factory.hpp`
- **File Size**: 878 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/factory.hpp](../../../modules/dnn/src/factory.hpp)
...
- **IDNNBackendFactory**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_DNN_FACTORY_HPP()**: A function/method defined in this file
