# Documentation for `modules/dnn/src/halide_scheduler.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/halide_scheduler.hpp`
- **File Name**: `halide_scheduler.hpp`
- **File Size**: 937 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/halide_scheduler.hpp](../../../modules/dnn/src/halide_scheduler.hpp)
...
- **HalideScheduler**: A class/struct defined in this file

### Functions and Methods

- **__OPENCV_DNN_HALIDE_SCHEDULER_HPP__()**: A function/method defined in this file
- **scheduled()**: A function/method defined in this file
