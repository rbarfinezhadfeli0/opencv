# Documentation for `modules/dnn/src/ie_ngraph.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/ie_ngraph.cpp`
- **File Name**: `ie_ngraph.cpp`
- **File Size**: 23,542 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/ie_ngraph.cpp](../../../modules/dnn/src/ie_ngraph.cpp)
...
- **NgraphCustomOp**: A class/struct defined in this file
