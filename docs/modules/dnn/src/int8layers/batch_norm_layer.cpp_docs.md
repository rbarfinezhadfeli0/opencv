# Documentation for `modules/dnn/src/int8layers/batch_norm_layer.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/int8layers/batch_norm_layer.cpp`
- **File Name**: `batch_norm_layer.cpp`
- **File Size**: 11,887 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/int8layers/batch_norm_layer.cpp](../../../../modules/dnn/src/int8layers/batch_norm_layer.cpp)
...
- **BatchNormLayerInt8Impl**: A class/struct defined in this file
