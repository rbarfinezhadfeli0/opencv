# Documentation for `modules/dnn/src/int8layers/convolution_layer.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/int8layers/convolution_layer.cpp`
- **File Name**: `convolution_layer.cpp`
- **File Size**: 77,253 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/int8layers/convolution_layer.cpp](../../../../modules/dnn/src/int8layers/convolution_layer.cpp)
...
- **ConvolutionLayerInt8Impl**: A class/struct defined in this file
- **BaseConvolutionLayerInt8Impl**: A class/struct defined in this file
- **ParallelConv**: A class/struct defined in this file
