# Documentation for `modules/dnn/src/int8layers/elementwise_layers.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/int8layers/elementwise_layers.cpp`
- **File Name**: `elementwise_layers.cpp`
- **File Size**: 13,408 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/int8layers/elementwise_layers.cpp](../../../../modules/dnn/src/int8layers/elementwise_layers.cpp)
...
- **ActivationLayerInt8Impl**: A class/struct defined in this file
- **Activation**: A class/struct defined in this file
