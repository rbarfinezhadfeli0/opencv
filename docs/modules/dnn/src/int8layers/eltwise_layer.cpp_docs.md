# Documentation for `modules/dnn/src/int8layers/eltwise_layer.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/int8layers/eltwise_layer.cpp`
- **File Name**: `eltwise_layer.cpp`
- **File Size**: 29,454 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/int8layers/eltwise_layer.cpp](../../../../modules/dnn/src/int8layers/eltwise_layer.cpp)
...
- **EltwiseLayerInt8Impl**: A class/struct defined in this file
