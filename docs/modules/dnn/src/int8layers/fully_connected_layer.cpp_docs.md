# Documentation for `modules/dnn/src/int8layers/fully_connected_layer.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/int8layers/fully_connected_layer.cpp`
- **File Name**: `fully_connected_layer.cpp`
- **File Size**: 20,023 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/int8layers/fully_connected_layer.cpp](../../../../modules/dnn/src/int8layers/fully_connected_layer.cpp)
...
- **FullyConnectedLayerInt8Impl**: A class/struct defined in this file
