# Documentation for `modules/dnn/src/int8layers/layers_common.simd.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/int8layers/layers_common.simd.hpp`
- **File Name**: `layers_common.simd.hpp`
- **File Size**: 85,464 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/int8layers/layers_common.simd.hpp](../../../../modules/dnn/src/int8layers/layers_common.simd.hpp)
