# Documentation for `modules/dnn/src/int8layers/pooling_layer.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/int8layers/pooling_layer.cpp`
- **File Name**: `pooling_layer.cpp`
- **File Size**: 34,054 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/int8layers/pooling_layer.cpp](../../../../modules/dnn/src/int8layers/pooling_layer.cpp)
...
- **PoolingLayerInt8Impl**: A class/struct defined in this file
