# Documentation for `modules/dnn/src/int8layers/quantization_utils.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/int8layers/quantization_utils.cpp`
- **File Name**: `quantization_utils.cpp`
- **File Size**: 20,649 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/int8layers/quantization_utils.cpp](../../../../modules/dnn/src/int8layers/quantization_utils.cpp)
...
- **QuantizeLayerImpl**: A class/struct defined in this file
- **DequantizeLayerImpl**: A class/struct defined in this file
- **RequantizeLayerImpl**: A class/struct defined in this file
