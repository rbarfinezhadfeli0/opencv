# Documentation for `modules/dnn/src/int8layers/scale_layer.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/int8layers/scale_layer.cpp`
- **File Name**: `scale_layer.cpp`
- **File Size**: 9,016 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/int8layers/scale_layer.cpp](../../../../modules/dnn/src/int8layers/scale_layer.cpp)
...
- **ScaleLayerInt8Impl**: A class/struct defined in this file
