# Documentation for `modules/dnn/src/int8layers/softmax_layer.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/int8layers/softmax_layer.cpp`
- **File Name**: `softmax_layer.cpp`
- **File Size**: 15,403 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/int8layers/softmax_layer.cpp](../../../../modules/dnn/src/int8layers/softmax_layer.cpp)
...
- **SoftmaxInt8OutputFloatInvoker**: A class/struct defined in this file
- **SoftMaxLayerInt8Impl**: A class/struct defined in this file
- **SoftmaxInt8Invoker**: A class/struct defined in this file
