# Documentation for `modules/dnn/src/layers/batch_norm_layer.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/layers/batch_norm_layer.cpp`
- **File Name**: `batch_norm_layer.cpp`
- **File Size**: 20,462 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/layers/batch_norm_layer.cpp](../../../../modules/dnn/src/layers/batch_norm_layer.cpp)
...
- **BatchNormLayerImpl**: A class/struct defined in this file
