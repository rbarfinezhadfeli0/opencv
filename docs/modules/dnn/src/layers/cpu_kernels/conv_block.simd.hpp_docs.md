# Documentation for `modules/dnn/src/layers/cpu_kernels/conv_block.simd.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/layers/cpu_kernels/conv_block.simd.hpp`
- **File Name**: `conv_block.simd.hpp`
- **File Size**: 27,045 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/layers/cpu_kernels/conv_block.simd.hpp](../../../../../modules/dnn/src/layers/cpu_kernels/conv_block.simd.hpp)
...
- **_FX_STORE_CBUF_ROW()**: A function/method defined in this file
- **_FX_UPDATE_CBUF_ROW()**: A function/method defined in this file
