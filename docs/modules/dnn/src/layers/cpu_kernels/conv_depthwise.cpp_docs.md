# Documentation for `modules/dnn/src/layers/cpu_kernels/conv_depthwise.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/layers/cpu_kernels/conv_depthwise.cpp`
- **File Name**: `conv_depthwise.cpp`
- **File Size**: 18,587 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/layers/cpu_kernels/conv_depthwise.cpp](../../../../../modules/dnn/src/layers/cpu_kernels/conv_depthwise.cpp)
...
**C++ Includes:**
- `../../precomp.hpp`
- `layers/cpu_kernels/conv_depthwise.simd_declarations.hpp`
- `conv_depthwise.simd.hpp`
- `convolution.hpp`
