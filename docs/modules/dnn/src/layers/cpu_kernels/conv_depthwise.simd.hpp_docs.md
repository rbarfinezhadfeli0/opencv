# Documentation for `modules/dnn/src/layers/cpu_kernels/conv_depthwise.simd.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/layers/cpu_kernels/conv_depthwise.simd.hpp`
- **File Name**: `conv_depthwise.simd.hpp`
- **File Size**: 24,401 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/layers/cpu_kernels/conv_depthwise.simd.hpp](../../../../../modules/dnn/src/layers/cpu_kernels/conv_depthwise.simd.hpp)
