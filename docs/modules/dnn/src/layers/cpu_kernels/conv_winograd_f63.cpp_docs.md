# Documentation for `modules/dnn/src/layers/cpu_kernels/conv_winograd_f63.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/layers/cpu_kernels/conv_winograd_f63.cpp`
- **File Name**: `conv_winograd_f63.cpp`
- **File Size**: 11,522 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/layers/cpu_kernels/conv_winograd_f63.cpp](../../../../../modules/dnn/src/layers/cpu_kernels/conv_winograd_f63.cpp)
