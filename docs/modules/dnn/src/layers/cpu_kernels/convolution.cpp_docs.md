# Documentation for `modules/dnn/src/layers/cpu_kernels/convolution.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/layers/cpu_kernels/convolution.cpp`
- **File Name**: `convolution.cpp`
- **File Size**: 88,153 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/layers/cpu_kernels/convolution.cpp](../../../../../modules/dnn/src/layers/cpu_kernels/convolution.cpp)
...
**C++ Includes:**
- `layers/cpu_kernels/conv_block.simd_declarations.hpp`
- `convolution.hpp`
- `../../precomp.hpp`
