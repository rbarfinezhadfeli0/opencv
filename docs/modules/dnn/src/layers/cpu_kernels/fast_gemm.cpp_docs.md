# Documentation for `modules/dnn/src/layers/cpu_kernels/fast_gemm.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/layers/cpu_kernels/fast_gemm.cpp`
- **File Name**: `fast_gemm.cpp`
- **File Size**: 14,763 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/layers/cpu_kernels/fast_gemm.cpp](../../../../../modules/dnn/src/layers/cpu_kernels/fast_gemm.cpp)
...
- `../../precomp.hpp`
- `fast_gemm.hpp`
- `fast_gemm_kernels.simd.hpp`
- `fast_gemm_kernels.default.hpp`
- `layers/cpu_kernels/fast_gemm_kernels.simd_declarations.hpp`
