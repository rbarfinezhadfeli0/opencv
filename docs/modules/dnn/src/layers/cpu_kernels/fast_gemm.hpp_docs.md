# Documentation for `modules/dnn/src/layers/cpu_kernels/fast_gemm.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/layers/cpu_kernels/fast_gemm.hpp`
- **File Name**: `fast_gemm.hpp`
- **File Size**: 6,290 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/layers/cpu_kernels/fast_gemm.hpp](../../../../../modules/dnn/src/layers/cpu_kernels/fast_gemm.hpp)
...
- **FastGemmOpt**: A class/struct defined in this file
- **MatMulHelper**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_DNN_FAST_GEMM_HPP()**: A function/method defined in this file
