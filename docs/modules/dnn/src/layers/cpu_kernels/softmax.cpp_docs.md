# Documentation for `modules/dnn/src/layers/cpu_kernels/softmax.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/layers/cpu_kernels/softmax.cpp`
- **File Name**: `softmax.cpp`
- **File Size**: 5,018 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/layers/cpu_kernels/softmax.cpp](../../../../../modules/dnn/src/layers/cpu_kernels/softmax.cpp)
