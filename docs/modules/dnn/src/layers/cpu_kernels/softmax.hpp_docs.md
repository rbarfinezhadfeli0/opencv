# Documentation for `modules/dnn/src/layers/cpu_kernels/softmax.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/layers/cpu_kernels/softmax.hpp`
- **File Name**: `softmax.hpp`
- **File Size**: 842 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/layers/cpu_kernels/softmax.hpp](../../../../../modules/dnn/src/layers/cpu_kernels/softmax.hpp)
...
- **OPENCV_DNN_SOFTMAX_HPP()**: A function/method defined in this file
