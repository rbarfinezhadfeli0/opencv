# Documentation for `modules/dnn/src/layers/depth_space_ops_layer.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/layers/depth_space_ops_layer.cpp`
- **File Name**: `depth_space_ops_layer.cpp`
- **File Size**: 22,560 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/layers/depth_space_ops_layer.cpp](../../../../modules/dnn/src/layers/depth_space_ops_layer.cpp)
...
- **DepthToSpaceLayerImpl**: A class/struct defined in this file
- **DepthSpaceOps**: A class/struct defined in this file
- **SpaceToDepthLayerImpl**: A class/struct defined in this file
...
- `../op_cann.hpp`
- `../op_cuda.hpp`
- `../cuda4dnn/primitives/depth_space_ops.hpp`
