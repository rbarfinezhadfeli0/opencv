# Documentation for `modules/dnn/src/layers/einsum_layer.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/layers/einsum_layer.cpp`
- **File Name**: `einsum_layer.cpp`
- **File Size**: 57,408 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/layers/einsum_layer.cpp](../../../../modules/dnn/src/layers/einsum_layer.cpp)
...
- **LayerEinsumImpl**: A class/struct defined in this file

### Functions and Methods

- **HAVE_DNN_NGRAPH()**: A function/method defined in this file
- **IsTransposeReshapeForEinsum()**: A function/method defined in this file
