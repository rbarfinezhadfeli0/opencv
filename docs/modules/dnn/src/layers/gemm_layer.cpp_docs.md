# Documentation for `modules/dnn/src/layers/gemm_layer.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/layers/gemm_layer.cpp`
- **File Name**: `gemm_layer.cpp`
- **File Size**: 16,374 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/layers/gemm_layer.cpp](../../../../modules/dnn/src/layers/gemm_layer.cpp)
...
- **GemmLayerImpl**: A class/struct defined in this file
