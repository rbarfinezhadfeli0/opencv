# Documentation for `modules/dnn/src/layers/instance_norm_layer.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/layers/instance_norm_layer.cpp`
- **File Name**: `instance_norm_layer.cpp`
- **File Size**: 11,787 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/layers/instance_norm_layer.cpp](../../../../modules/dnn/src/layers/instance_norm_layer.cpp)
...
- **InstanceNormLayerImpl**: A class/struct defined in this file
...
- `../cuda4dnn/primitives/instance_norm.hpp`
