# Documentation for `modules/dnn/src/layers/layer_norm.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/layers/layer_norm.cpp`
- **File Name**: `layer_norm.cpp`
- **File Size**: 16,333 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/layers/layer_norm.cpp](../../../../modules/dnn/src/layers/layer_norm.cpp)
...
- **LayerNormLayerImpl**: A class/struct defined in this file
...
- `../op_cann.hpp`
- `../op_cuda.hpp`
- `../cuda4dnn/primitives/layer_norm.hpp`
