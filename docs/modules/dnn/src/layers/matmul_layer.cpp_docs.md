# Documentation for `modules/dnn/src/layers/matmul_layer.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/layers/matmul_layer.cpp`
- **File Name**: `matmul_layer.cpp`
- **File Size**: 20,270 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/layers/matmul_layer.cpp](../../../../modules/dnn/src/layers/matmul_layer.cpp)
...
- **MatMulLayerImpl**: A class/struct defined in this file
...
- `../op_vkcom.hpp`
- `../cuda4dnn/primitives/matmul_broadcast.hpp`
