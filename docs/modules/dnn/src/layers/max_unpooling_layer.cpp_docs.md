# Documentation for `modules/dnn/src/layers/max_unpooling_layer.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/layers/max_unpooling_layer.cpp`
- **File Name**: `max_unpooling_layer.cpp`
- **File Size**: 9,143 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/layers/max_unpooling_layer.cpp](../../../../modules/dnn/src/layers/max_unpooling_layer.cpp)
...
- **MaxUnpoolLayerImpl**: A class/struct defined in this file
