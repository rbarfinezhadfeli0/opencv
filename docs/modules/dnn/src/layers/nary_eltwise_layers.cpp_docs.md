# Documentation for `modules/dnn/src/layers/nary_eltwise_layers.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/layers/nary_eltwise_layers.cpp`
- **File Name**: `nary_eltwise_layers.cpp`
- **File Size**: 45,658 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/layers/nary_eltwise_layers.cpp](../../../../modules/dnn/src/layers/nary_eltwise_layers.cpp)
...
- **NaryEltwiseLayerImpl**: A class/struct defined in this file
- **NaryEltwiseHelper**: A class/struct defined in this file

### Functions and Methods

- **HAVE_DNN_NGRAPH()**: A function/method defined in this file
- **BUILD_CANN_ELTWISE_OP()**: A function/method defined in this file
