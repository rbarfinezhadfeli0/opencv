# Documentation for `modules/dnn/src/layers/padding_layer.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/layers/padding_layer.cpp`
- **File Name**: `padding_layer.cpp`
- **File Size**: 12,333 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/layers/padding_layer.cpp](../../../../modules/dnn/src/layers/padding_layer.cpp)
...
- **PaddingLayerImpl**: A class/struct defined in this file
