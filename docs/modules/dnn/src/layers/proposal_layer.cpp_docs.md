# Documentation for `modules/dnn/src/layers/proposal_layer.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/layers/proposal_layer.cpp`
- **File Name**: `proposal_layer.cpp`
- **File Size**: 16,066 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/layers/proposal_layer.cpp](../../../../modules/dnn/src/layers/proposal_layer.cpp)
...
- **ProposalLayerImpl**: A class/struct defined in this file
