# Documentation for `modules/dnn/src/layers/reduce_layer.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/layers/reduce_layer.cpp`
- **File Name**: `reduce_layer.cpp`
- **File Size**: 22,145 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/layers/reduce_layer.cpp](../../../../modules/dnn/src/layers/reduce_layer.cpp)
...
- **ReduceInvoker**: A class/struct defined in this file
- **ReduceMax**: A class/struct defined in this file
- **ReduceMean**: A class/struct defined in this file
- **ReduceSumSquare**: A class/struct defined in this file
- **ReduceLogSumExp**: A class/struct defined in this file
- **ReduceLogSum**: A class/struct defined in this file
- **ReduceLayerImpl**: A class/struct defined in this file
- **ReduceL1**: A class/struct defined in this file
- **ReduceProd**: A class/struct defined in this file
- **ReduceMin**: A class/struct defined in this file
- **ReduceSum**: A class/struct defined in this file
- **ReduceAllInvoker**: A class/struct defined in this file
- **ReduceBase**: A class/struct defined in this file
- **ReduceL2**: A class/struct defined in this file

### Functions and Methods

- **BUILD_CANN_REDUCE_OP()**: A function/method defined in this file
