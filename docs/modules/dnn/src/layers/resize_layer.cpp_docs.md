# Documentation for `modules/dnn/src/layers/resize_layer.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/layers/resize_layer.cpp`
- **File Name**: `resize_layer.cpp`
- **File Size**: 21,102 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/layers/resize_layer.cpp](../../../../modules/dnn/src/layers/resize_layer.cpp)
...
- **ResizeLayerImpl**: A class/struct defined in this file
- **InterpLayerImpl**: A class/struct defined in this file
