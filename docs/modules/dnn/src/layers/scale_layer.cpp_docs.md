# Documentation for `modules/dnn/src/layers/scale_layer.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/layers/scale_layer.cpp`
- **File Name**: `scale_layer.cpp`
- **File Size**: 21,021 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/layers/scale_layer.cpp](../../../../modules/dnn/src/layers/scale_layer.cpp)
...
- **ScaleLayerImpl**: A class/struct defined in this file
- **DataAugmentationLayerImpl**: A class/struct defined in this file
