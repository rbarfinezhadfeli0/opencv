# Documentation for `modules/dnn/src/layers/scatter_layer.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/layers/scatter_layer.cpp`
- **File Name**: `scatter_layer.cpp`
- **File Size**: 9,168 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/layers/scatter_layer.cpp](../../../../modules/dnn/src/layers/scatter_layer.cpp)
...
- **ScatterLayerImpl**: A class/struct defined in this file
