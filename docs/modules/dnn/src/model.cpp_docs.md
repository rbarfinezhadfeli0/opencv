# Documentation for `modules/dnn/src/model.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/model.cpp`
- **File Name**: `model.cpp`
- **File Size**: 51,335 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/model.cpp](../../../modules/dnn/src/model.cpp)
...
- **DetectionModel_Impl**: A class/struct defined in this file
- **ClassificationModel_Impl**: A class/struct defined in this file
- **TextRecognitionModel_Impl**: A class/struct defined in this file
- **PrefixHash**: A class/struct defined in this file
- **TextDetectionModel_EAST_Impl**: A class/struct defined in this file
- **TextDetectionModel_DB_Impl**: A class/struct defined in this file
- **PrefixScore**: A class/struct defined in this file
- **TextDetectionModel_Impl**: A class/struct defined in this file
