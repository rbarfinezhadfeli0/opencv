# Documentation for `modules/dnn/src/net_cann.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/net_cann.cpp`
- **File Name**: `net_cann.cpp`
- **File Size**: 13,574 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/net_cann.cpp](../../../modules/dnn/src/net_cann.cpp)
...
- **NetImplCann**: A class/struct defined in this file
