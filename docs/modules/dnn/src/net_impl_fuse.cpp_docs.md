# Documentation for `modules/dnn/src/net_impl_fuse.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/net_impl_fuse.cpp`
- **File Name**: `net_impl_fuse.cpp`
- **File Size**: 44,897 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/net_impl_fuse.cpp](../../../modules/dnn/src/net_impl_fuse.cpp)
