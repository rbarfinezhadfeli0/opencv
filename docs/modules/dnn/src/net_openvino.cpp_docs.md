# Documentation for `modules/dnn/src/net_openvino.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/net_openvino.cpp`
- **File Name**: `net_openvino.cpp`
- **File Size**: 33,261 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/net_openvino.cpp](../../../modules/dnn/src/net_openvino.cpp)
...
- **NetworkBackendOpenVINO**: A class/struct defined in this file
- **NetImplOpenVINO**: A class/struct defined in this file

### Functions and Methods

- **BUILD_PLUGIN()**: A function/method defined in this file
- **Net()**: A function/method defined in this file
