# Documentation for `modules/dnn/src/net_quantization.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/net_quantization.cpp`
- **File Name**: `net_quantization.cpp`
- **File Size**: 12,169 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/net_quantization.cpp](../../../modules/dnn/src/net_quantization.cpp)
