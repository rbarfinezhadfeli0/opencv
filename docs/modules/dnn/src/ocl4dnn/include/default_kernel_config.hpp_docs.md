# Documentation for `modules/dnn/src/ocl4dnn/include/default_kernel_config.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/ocl4dnn/include/default_kernel_config.hpp`
- **File Name**: `default_kernel_config.hpp`
- **File Size**: 94,568 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/ocl4dnn/include/default_kernel_config.hpp](../../../../../modules/dnn/src/ocl4dnn/include/default_kernel_config.hpp)
...
- **suffix()**: A function/method defined in this file
- **_OPENCV_OCL4DNN_DEFAULT_KERNEL_CONFIG_HPP_()**: A function/method defined in this file
