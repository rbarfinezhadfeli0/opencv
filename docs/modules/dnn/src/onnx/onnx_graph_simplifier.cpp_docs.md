# Documentation for `modules/dnn/src/onnx/onnx_graph_simplifier.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/onnx/onnx_graph_simplifier.cpp`
- **File Name**: `onnx_graph_simplifier.cpp`
- **File Size**: 71,017 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/onnx/onnx_graph_simplifier.cpp](../../../../modules/dnn/src/onnx/onnx_graph_simplifier.cpp)
...
- **ONNXGraphWrapper**: A class/struct defined in this file
- **MulCastSubgraph**: A class/struct defined in this file
- **LayerNormSubGraph**: A class/struct defined in this file
- **ResizeSubgraph1**: A class/struct defined in this file
- **AttentionSingleHeadSubGraph**: A class/struct defined in this file
- **LogSoftMaxSubgraph**: A class/struct defined in this file
- **NormalizeSubgraphBase**: A class/struct defined in this file
- **NormalizeSubgraph2_2**: A class/struct defined in this file
- **BatchNormalizationSubgraph2**: A class/struct defined in this file
- **MishSubgraph**: A class/struct defined in this file
- **CeluSubgraph**: A class/struct defined in this file
- **SoftplusSubgraph**: A class/struct defined in this file
- **UpsampleSubgraph**: A class/struct defined in this file
- **GeluApproximationSubGraph**: A class/struct defined in this file
- **NormalizeSubgraph4**: A class/struct defined in this file
- **ONNXNodeWrapper**: A class/struct defined in this file
- **NormalizeSubgraph1**: A class/struct defined in this file
- **AttentionSubGraph**: A class/struct defined in this file
- **ResizeSubgraph3**: A class/struct defined in this file
- **NormalizeSubgraph3**: A class/struct defined in this file
- **ExtractScalesSubgraph**: A class/struct defined in this file
- **ResizeSubgraph2**: A class/struct defined in this file
- **SoftMaxSubgraphBase**: A class/struct defined in this file
- **NormalizeSubgraph2**: A class/struct defined in this file
- **BatchNormalizationSubgraph1**: A class/struct defined in this file
- **GeluSubGraph**: A class/struct defined in this file
- **ExpandSubgraph**: A class/struct defined in this file
- **NormalizeSubgraph5**: A class/struct defined in this file
- **BiasedMatmulSubgraph**: A class/struct defined in this file
- **AdjustSliceAllOptionalInputsSubgraph**: A class/struct defined in this file
- **BatchNormalizationSubgraphBase**: A class/struct defined in this file
- **SoftMaxSubgraph2**: A class/struct defined in this file
- **SoftMaxSubgraph**: A class/struct defined in this file
- **HardSwishSubgraph**: A class/struct defined in this file
- **GatherCastSubgraph**: A class/struct defined in this file
