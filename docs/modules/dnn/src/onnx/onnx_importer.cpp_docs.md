# Documentation for `modules/dnn/src/onnx/onnx_importer.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/onnx/onnx_importer.cpp`
- **File Name**: `onnx_importer.cpp`
- **File Size**: 159,921 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/onnx/onnx_importer.cpp](../../../../modules/dnn/src/onnx/onnx_importer.cpp)
...
- **_Buf**: A class/struct defined in this file
- **ONNXImporter**: A class/struct defined in this file
- **LayerInfo**: A class/struct defined in this file
- **TensorInfo**: A class/struct defined in this file
- **ONNXLayerHandler**: A class/struct defined in this file
