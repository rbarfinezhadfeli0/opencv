# Documentation for `modules/dnn/src/op_cuda.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/op_cuda.hpp`
- **File Name**: `op_cuda.hpp`
- **File Size**: 23,466 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/op_cuda.hpp](../../../modules/dnn/src/op_cuda.hpp)
...
- **GetCUDABackendWrapperType_**: A class/struct defined in this file
- **for**: A class/struct defined in this file
- **ConcatOp**: A class/struct defined in this file
- **shared_block_type**: A class/struct defined in this file
- **NodeType**: A class/struct defined in this file
- **T**: A class/struct defined in this file
- **CUDABackendWrapper**: A class/struct defined in this file
- **CSLContext**: A class/struct defined in this file
- **CUDABackendNode**: A class/struct defined in this file
- **GenericCUDABackendWrapper**: A class/struct defined in this file
- **U**: A class/struct defined in this file

### Functions and Methods

- **HAVE_CUDA()**: A function/method defined in this file
- **OPENCV_DNN_SRC_OP_CUDA_HPP()**: A function/method defined in this file
- **CUDABackendWrapperFP16()**: A function/method defined in this file
- **aids()**: A function/method defined in this file
- **CUDABackendWrapperFP32()**: A function/method defined in this file
...
- `cuda4dnn/csl/event.hpp`
- `iterator`
- `cstddef`
- `cuda4dnn/kernels/fp_conversion.hpp`
- `memory`
