# Documentation for `modules/dnn/src/op_halide.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/op_halide.cpp`
- **File Name**: `op_halide.cpp`
- **File Size**: 13,061 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/op_halide.cpp](../../../modules/dnn/src/op_halide.cpp)
