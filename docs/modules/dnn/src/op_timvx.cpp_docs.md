# Documentation for `modules/dnn/src/op_timvx.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/op_timvx.cpp`
- **File Name**: `op_timvx.cpp`
- **File Size**: 26,217 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/op_timvx.cpp](../../../modules/dnn/src/op_timvx.cpp)
