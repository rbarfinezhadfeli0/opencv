# Documentation for `modules/dnn/src/op_webnn.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/op_webnn.cpp`
- **File Name**: `op_webnn.cpp`
- **File Size**: 18,030 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/op_webnn.cpp](../../../modules/dnn/src/op_webnn.cpp)
