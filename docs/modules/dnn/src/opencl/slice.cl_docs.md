# Documentation for `modules/dnn/src/opencl/slice.cl`

## File Metadata

- **Full Path**: `modules/dnn/src/opencl/slice.cl`
- **File Name**: `slice.cl`
- **File Size**: 7,518 bytes
- **File Type**: .cl
- **Link to Source**: [modules/dnn/src/opencl/slice.cl](../../../../modules/dnn/src/opencl/slice.cl)
