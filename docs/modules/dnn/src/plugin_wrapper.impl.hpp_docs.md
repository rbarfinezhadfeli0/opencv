# Documentation for `modules/dnn/src/plugin_wrapper.impl.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/plugin_wrapper.impl.hpp`
- **File Name**: `plugin_wrapper.impl.hpp`
- **File Size**: 11,630 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/plugin_wrapper.impl.hpp](../../../modules/dnn/src/plugin_wrapper.impl.hpp)
...
- **PluginDNNBackendFactory**: A class/struct defined in this file
- **PluginDNNBackend**: A class/struct defined in this file

### Functions and Methods

- **CV_LOG_ERROR()**: A function/method defined in this file
- **_WIN32()**: A function/method defined in this file
- **CV_DNN_PLUGIN_SUBDIRECTORY()**: A function/method defined in this file
