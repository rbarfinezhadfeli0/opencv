# Documentation for `modules/dnn/src/tensorflow/graph.proto`

## File Metadata

- **Full Path**: `modules/dnn/src/tensorflow/graph.proto`
- **File Name**: `graph.proto`
- **File Size**: 4,579 bytes
- **File Type**: .proto
- **Link to Source**: [modules/dnn/src/tensorflow/graph.proto](../../../../modules/dnn/src/tensorflow/graph.proto)
