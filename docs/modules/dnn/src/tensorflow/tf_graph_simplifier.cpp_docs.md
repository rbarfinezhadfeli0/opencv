# Documentation for `modules/dnn/src/tensorflow/tf_graph_simplifier.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/tensorflow/tf_graph_simplifier.cpp`
- **File Name**: `tf_graph_simplifier.cpp`
- **File Size**: 42,351 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/tensorflow/tf_graph_simplifier.cpp](../../../../modules/dnn/src/tensorflow/tf_graph_simplifier.cpp)
...
- **ResizeBilinearSubgraphDown**: A class/struct defined in this file
- **BatchNormSubgraph**: A class/struct defined in this file
- **DeconvolutionSameKerasSubgraph**: A class/struct defined in this file
- **FlattenShapeSubgraph**: A class/struct defined in this file
- **TFGraphWrapper**: A class/struct defined in this file
- **TFSubgraph**: A class/struct defined in this file
- **ResizeBilinearSubgraph**: A class/struct defined in this file
- **BatchNormNoGammaSubgraph**: A class/struct defined in this file
- **PReLUSubgraph**: A class/struct defined in this file
- **L2NormalizeSubgraph**: A class/struct defined in this file
- **FlattenProdSubgraph**: A class/struct defined in this file
- **ClipByValueSubgraph**: A class/struct defined in this file
- **DeconvolutionValidKerasSubgraph**: A class/struct defined in this file
- **UpsamplingKerasSubgraph**: A class/struct defined in this file
- **SoftMaxKerasSubgraph**: A class/struct defined in this file
- **SoftMaxSlimV2Subgraph**: A class/struct defined in this file
- **FlattenSubgraph**: A class/struct defined in this file
- **KerasMVNSubgraph**: A class/struct defined in this file
- **ReLU6KerasSubgraph**: A class/struct defined in this file
- **SoftMaxSlimSubgraph**: A class/struct defined in this file
- **ReshapeAsShapeSubgraph**: A class/struct defined in this file
- **TFNodeWrapper**: A class/struct defined in this file
- **ReshapeKerasSubgraph**: A class/struct defined in this file
