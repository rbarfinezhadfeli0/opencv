# Documentation for `modules/dnn/src/tensorflow/tf_graph_simplifier.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/tensorflow/tf_graph_simplifier.hpp`
- **File Name**: `tf_graph_simplifier.hpp`
- **File Size**: 988 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/tensorflow/tf_graph_simplifier.hpp](../../../../modules/dnn/src/tensorflow/tf_graph_simplifier.hpp)
...
- **__OPENCV_DNN_TF_SIMPLIFIER_HPP__()**: A function/method defined in this file
