# Documentation for `modules/dnn/src/tensorflow/tf_importer.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/tensorflow/tf_importer.cpp`
- **File Name**: `tf_importer.cpp`
- **File Size**: 126,950 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/tensorflow/tf_importer.cpp](../../../../modules/dnn/src/tensorflow/tf_importer.cpp)
...
- **Pin**: A class/struct defined in this file
- **TFImporter**: A class/struct defined in this file
- **GRAPH_DEF**: A class/struct defined in this file
- **TFLayerHandler**: A class/struct defined in this file
