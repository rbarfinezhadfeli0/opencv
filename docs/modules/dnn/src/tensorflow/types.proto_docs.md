# Documentation for `modules/dnn/src/tensorflow/types.proto`

## File Metadata

- **Full Path**: `modules/dnn/src/tensorflow/types.proto`
- **File Name**: `types.proto`
- **File Size**: 1,650 bytes
- **File Type**: .proto
- **Link to Source**: [modules/dnn/src/tensorflow/types.proto](../../../../modules/dnn/src/tensorflow/types.proto)
