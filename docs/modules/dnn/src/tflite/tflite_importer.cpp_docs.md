# Documentation for `modules/dnn/src/tflite/tflite_importer.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/tflite/tflite_importer.cpp`
- **File Name**: `tflite_importer.cpp`
- **File Size**: 54,605 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/tflite/tflite_importer.cpp](../../../../modules/dnn/src/tflite/tflite_importer.cpp)

## Purpose and Role

This file is located in the `modules/dnn/src/tflite` directory and serves as part of the OpenCV library infrastructure.
...
- **TFLiteImporter**: A class/struct defined in this file
...
- **HAVE_FLATBUFFERS()**: A function/method defined in this file
