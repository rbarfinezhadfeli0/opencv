# Documentation for `modules/dnn/src/torch/THFilePrivate.h`

## File Metadata

- **Full Path**: `modules/dnn/src/torch/THFilePrivate.h`
- **File Name**: `THFilePrivate.h`
- **File Size**: 960 bytes
- **File Type**: .h
- **Link to Source**: [modules/dnn/src/torch/THFilePrivate.h](../../../../modules/dnn/src/torch/THFilePrivate.h)
