# Documentation for `modules/dnn/src/torch/THGeneral.h`

## File Metadata

- **Full Path**: `modules/dnn/src/torch/THGeneral.h`
- **File Name**: `THGeneral.h`
- **File Size**: 418 bytes
- **File Type**: .h
- **Link to Source**: [modules/dnn/src/torch/THGeneral.h](../../../../modules/dnn/src/torch/THGeneral.h)
...
- **TH_GENERAL_INC()**: A function/method defined in this file
