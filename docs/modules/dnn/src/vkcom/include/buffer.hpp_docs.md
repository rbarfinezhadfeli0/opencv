# Documentation for `modules/dnn/src/vkcom/include/buffer.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/vkcom/include/buffer.hpp`
- **File Name**: `buffer.hpp`
- **File Size**: 1,125 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/vkcom/include/buffer.hpp](../../../../../modules/dnn/src/vkcom/include/buffer.hpp)
...
- **OPENCV_DNN_VKCOM_BUFFER_HPP()**: A function/method defined in this file
