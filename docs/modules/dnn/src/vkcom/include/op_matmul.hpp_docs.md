# Documentation for `modules/dnn/src/vkcom/include/op_matmul.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/vkcom/include/op_matmul.hpp`
- **File Name**: `op_matmul.hpp`
- **File Size**: 1,102 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/vkcom/include/op_matmul.hpp](../../../../../modules/dnn/src/vkcom/include/op_matmul.hpp)
...
- **OpMatMul**: A class/struct defined in this file
- **MatMulShaderConfig**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_OP_MATMUL_HPP()**: A function/method defined in this file
