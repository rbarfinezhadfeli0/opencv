# Documentation for `modules/dnn/src/vkcom/shader/conv_1x1_fast.comp`

## File Metadata

- **Full Path**: `modules/dnn/src/vkcom/shader/conv_1x1_fast.comp`
- **File Name**: `conv_1x1_fast.comp`
- **File Size**: 4,897 bytes
- **File Type**: .comp
- **Link to Source**: [modules/dnn/src/vkcom/shader/conv_1x1_fast.comp](../../../../../modules/dnn/src/vkcom/shader/conv_1x1_fast.comp)
