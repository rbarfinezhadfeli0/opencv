# Documentation for `modules/dnn/src/vkcom/shader/conv_depthwise.comp`

## File Metadata

- **Full Path**: `modules/dnn/src/vkcom/shader/conv_depthwise.comp`
- **File Name**: `conv_depthwise.comp`
- **File Size**: 3,035 bytes
- **File Type**: .comp
- **Link to Source**: [modules/dnn/src/vkcom/shader/conv_depthwise.comp](../../../../../modules/dnn/src/vkcom/shader/conv_depthwise.comp)
