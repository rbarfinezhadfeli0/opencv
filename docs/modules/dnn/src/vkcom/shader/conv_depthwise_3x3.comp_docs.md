# Documentation for `modules/dnn/src/vkcom/shader/conv_depthwise_3x3.comp`

## File Metadata

- **Full Path**: `modules/dnn/src/vkcom/shader/conv_depthwise_3x3.comp`
- **File Name**: `conv_depthwise_3x3.comp`
- **File Size**: 2,899 bytes
- **File Type**: .comp
- **Link to Source**: [modules/dnn/src/vkcom/shader/conv_depthwise_3x3.comp](../../../../../modules/dnn/src/vkcom/shader/conv_depthwise_3x3.comp)
