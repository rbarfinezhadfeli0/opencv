# Documentation for `modules/dnn/src/vkcom/shader/conv_implicit_gemm.comp`

## File Metadata

- **Full Path**: `modules/dnn/src/vkcom/shader/conv_implicit_gemm.comp`
- **File Name**: `conv_implicit_gemm.comp`
- **File Size**: 5,334 bytes
- **File Type**: .comp
- **Link to Source**: [modules/dnn/src/vkcom/shader/conv_implicit_gemm.comp](../../../../../modules/dnn/src/vkcom/shader/conv_implicit_gemm.comp)
