# Documentation for `modules/dnn/src/vkcom/shader/gemm.comp`

## File Metadata

- **Full Path**: `modules/dnn/src/vkcom/shader/gemm.comp`
- **File Name**: `gemm.comp`
- **File Size**: 4,550 bytes
- **File Type**: .comp
- **Link to Source**: [modules/dnn/src/vkcom/shader/gemm.comp](../../../../../modules/dnn/src/vkcom/shader/gemm.comp)
