# Documentation for `modules/dnn/src/vkcom/shader/spv_shader.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/vkcom/shader/spv_shader.hpp`
- **File Name**: `spv_shader.hpp`
- **File Size**: 812 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/vkcom/shader/spv_shader.hpp](../../../../../modules/dnn/src/vkcom/shader/spv_shader.hpp)
