# Documentation for `modules/dnn/src/vkcom/src/fence.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/vkcom/src/fence.cpp`
- **File Name**: `fence.cpp`
- **File Size**: 1,040 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/vkcom/src/fence.cpp](../../../../../modules/dnn/src/vkcom/src/fence.cpp)
