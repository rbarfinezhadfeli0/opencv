# Documentation for `modules/dnn/src/vkcom/src/op_conv.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/vkcom/src/op_conv.cpp`
- **File Name**: `op_conv.cpp`
- **File Size**: 8,507 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/vkcom/src/op_conv.cpp](../../../../../modules/dnn/src/vkcom/src/op_conv.cpp)
