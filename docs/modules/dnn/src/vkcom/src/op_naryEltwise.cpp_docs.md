# Documentation for `modules/dnn/src/vkcom/src/op_naryEltwise.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/vkcom/src/op_naryEltwise.cpp`
- **File Name**: `op_naryEltwise.cpp`
- **File Size**: 6,709 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/vkcom/src/op_naryEltwise.cpp](../../../../../modules/dnn/src/vkcom/src/op_naryEltwise.cpp)
