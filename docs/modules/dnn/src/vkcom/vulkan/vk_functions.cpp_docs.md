# Documentation for `modules/dnn/src/vkcom/vulkan/vk_functions.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/vkcom/vulkan/vk_functions.cpp`
- **File Name**: `vk_functions.cpp`
- **File Size**: 835 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/vkcom/vulkan/vk_functions.cpp](../../../../../modules/dnn/src/vkcom/vulkan/vk_functions.cpp)
