# Documentation for `modules/dnn/src/vkcom/vulkan/vk_functions.hpp`

## File Metadata

- **Full Path**: `modules/dnn/src/vkcom/vulkan/vk_functions.hpp`
- **File Name**: `vk_functions.hpp`
- **File Size**: 968 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/src/vkcom/vulkan/vk_functions.hpp](../../../../../modules/dnn/src/vkcom/vulkan/vk_functions.hpp)
...
- **OPENCV_DNN_VKCOM_VULKAN_VK_FUNCTONS_HPP()**: A function/method defined in this file
