# Documentation for `modules/dnn/src/vkcom/vulkan/vk_loader.cpp`

## File Metadata

- **Full Path**: `modules/dnn/src/vkcom/vulkan/vk_loader.cpp`
- **File Name**: `vk_loader.cpp`
- **File Size**: 4,452 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/src/vkcom/vulkan/vk_loader.cpp](../../../../../modules/dnn/src/vkcom/vulkan/vk_loader.cpp)
...
- **DEFAULT_VK_LIBRARY_PATH()**: A function/method defined in this file
