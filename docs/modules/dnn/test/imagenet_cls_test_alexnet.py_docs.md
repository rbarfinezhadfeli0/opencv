# Documentation for `modules/dnn/test/imagenet_cls_test_alexnet.py`

## File Metadata

- **Full Path**: `modules/dnn/test/imagenet_cls_test_alexnet.py`
- **File Name**: `imagenet_cls_test_alexnet.py`
- **File Size**: 10,206 bytes
- **File Type**: .py
- **Link to Source**: [modules/dnn/test/imagenet_cls_test_alexnet.py](../../../modules/dnn/test/imagenet_cls_test_alexnet.py)
...
- **MeanChannelsFetch**: A class/struct defined in this file
- **MeanBlobFetch**: A class/struct defined in this file
- **ClsAccEvaluation**: A class/struct defined in this file
- **MeanValueFetch**: A class/struct defined in this file
- **DataFetch**: A class/struct defined in this file
- **CaffeModel**: A class/struct defined in this file
- **DnnCaffeModel**: A class/struct defined in this file
- **DNNOnnxModel**: A class/struct defined in this file
