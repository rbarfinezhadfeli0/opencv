# Documentation for `modules/dnn/test/npy_blob.hpp`

## File Metadata

- **Full Path**: `modules/dnn/test/npy_blob.hpp`
- **File Name**: `npy_blob.hpp`
- **File Size**: 575 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/test/npy_blob.hpp](../../../modules/dnn/test/npy_blob.hpp)
...
- **__OPENCV_DNN_TEST_NPY_BLOB_HPP__()**: A function/method defined in this file
