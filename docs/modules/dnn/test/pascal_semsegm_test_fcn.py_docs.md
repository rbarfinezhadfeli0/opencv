# Documentation for `modules/dnn/test/pascal_semsegm_test_fcn.py`

## File Metadata

- **Full Path**: `modules/dnn/test/pascal_semsegm_test_fcn.py`
- **File Name**: `pascal_semsegm_test_fcn.py`
- **File Size**: 9,567 bytes
- **File Type**: .py
- **Link to Source**: [modules/dnn/test/pascal_semsegm_test_fcn.py](../../../modules/dnn/test/pascal_semsegm_test_fcn.py)
...
- **PASCALDataFetch**: A class/struct defined in this file
- **DatasetImageFetch**: A class/struct defined in this file
- **MeanChannelsPreproc**: A class/struct defined in this file
- **SemSegmEvaluation**: A class/struct defined in this file

### Functions and Methods

- **eval_segm_result()**: A function/method defined in this file
- **read_colors()**: A function/method defined in this file
- **pix_to_c()**: A function/method defined in this file
- **get_metrics()**: A function/method defined in this file
- **__iter__()**: A function/method defined in this file
- **__next__()**: A function/method defined in this file
- **color_to_gt()**: A function/method defined in this file
- **get_conf_mat()**: A function/method defined in this file
