# Documentation for `modules/dnn/test/test_backends.cpp`

## File Metadata

- **Full Path**: `modules/dnn/test/test_backends.cpp`
- **File Name**: `test_backends.cpp`
- **File Size**: 62,132 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/test/test_backends.cpp](../../../modules/dnn/test/test_backends.cpp)
...
- **Test_layers_backends**: A class/struct defined in this file
- **DNNTestNetwork**: A class/struct defined in this file
