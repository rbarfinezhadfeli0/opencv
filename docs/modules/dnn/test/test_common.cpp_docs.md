# Documentation for `modules/dnn/test/test_common.cpp`

## File Metadata

- **Full Path**: `modules/dnn/test/test_common.cpp`
- **File Name**: `test_common.cpp`
- **File Size**: 282 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/test/test_common.cpp](../../../modules/dnn/test/test_common.cpp)
