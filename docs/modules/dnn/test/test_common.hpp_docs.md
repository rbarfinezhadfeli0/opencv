# Documentation for `modules/dnn/test/test_common.hpp`

## File Metadata

- **Full Path**: `modules/dnn/test/test_common.hpp`
- **File Name**: `test_common.hpp`
- **File Size**: 9,561 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/test/test_common.hpp](../../../modules/dnn/test/test_common.hpp)
...
- **DNNTestLayer**: A class/struct defined in this file

### Functions and Methods

- **HAVE_OPENCL()**: A function/method defined in this file
- **CV_TEST_TAG_DNN_SKIP_IE_VERSION()**: A function/method defined in this file
- **HAVE_INF_ENGINE()**: A function/method defined in this file
- **__OPENCV_TEST_COMMON_HPP__()**: A function/method defined in this file
