# Documentation for `modules/dnn/test/test_common.impl.hpp`

## File Metadata

- **Full Path**: `modules/dnn/test/test_common.impl.hpp`
- **File Name**: `test_common.impl.hpp`
- **File Size**: 17,796 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/test/test_common.impl.hpp](../../../modules/dnn/test/test_common.impl.hpp)
