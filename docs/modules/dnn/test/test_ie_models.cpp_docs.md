# Documentation for `modules/dnn/test/test_ie_models.cpp`

## File Metadata

- **Full Path**: `modules/dnn/test/test_ie_models.cpp`
- **File Name**: `test_ie_models.cpp`
- **File Size**: 16,410 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/test/test_ie_models.cpp](../../../modules/dnn/test/test_ie_models.cpp)
...
- **OpenVINOModelTestCaseInfo**: A class/struct defined in this file
