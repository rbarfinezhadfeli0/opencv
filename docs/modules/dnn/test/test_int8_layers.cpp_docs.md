# Documentation for `modules/dnn/test/test_int8_layers.cpp`

## File Metadata

- **Full Path**: `modules/dnn/test/test_int8_layers.cpp`
- **File Name**: `test_int8_layers.cpp`
- **File Size**: 58,459 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/test/test_int8_layers.cpp](../../../modules/dnn/test/test_int8_layers.cpp)
...
- **Test_Int8_nets**: A class/struct defined in this file
- **Test_Int8_layers**: A class/struct defined in this file
