# Documentation for `modules/dnn/test/test_model.cpp`

## File Metadata

- **Full Path**: `modules/dnn/test/test_model.cpp`
- **File Name**: `test_model.cpp`
- **File Size**: 34,638 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/test/test_model.cpp](../../../modules/dnn/test/test_model.cpp)
...
- **Test_Model**: A class/struct defined in this file
