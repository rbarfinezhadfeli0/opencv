# Documentation for `modules/dnn/test/test_onnx_conformance.cpp`

## File Metadata

- **Full Path**: `modules/dnn/test/test_onnx_conformance.cpp`
- **File Name**: `test_onnx_conformance.cpp`
- **File Size**: 54,112 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/test/test_onnx_conformance.cpp](../../../modules/dnn/test/test_onnx_conformance.cpp)
...
- **Test_ONNX_conformance**: A class/struct defined in this file
- **TestCase**: A class/struct defined in this file
...
- `test_onnx_conformance_layer_filter__cuda_fp16_denylist.inl.hpp`
