# Documentation for `modules/dnn/test/test_onnx_conformance_layer_filter__cuda_denylist.inl.hpp`

## File Metadata

- **Full Path**: `modules/dnn/test/test_onnx_conformance_layer_filter__cuda_denylist.inl.hpp`
- **File Name**: `test_onnx_conformance_layer_filter__cuda_denylist.inl.hpp`
- **File Size**: 3,326 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/dnn/test/test_onnx_conformance_layer_filter__cuda_denylist.inl.hpp](../../../modules/dnn/test/test_onnx_conformance_layer_filter__cuda_denylist.inl.hpp)
