# Documentation for `modules/dnn/test/test_onnx_importer.cpp`

## File Metadata

- **Full Path**: `modules/dnn/test/test_onnx_importer.cpp`
- **File Name**: `test_onnx_importer.cpp`
- **File Size**: 119,750 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/dnn/test/test_onnx_importer.cpp](../../../modules/dnn/test/test_onnx_importer.cpp)
...
- **Test_ONNX_layers**: A class/struct defined in this file
- **Test_ONNX_nets**: A class/struct defined in this file
- **mapping**: A class/struct defined in this file
