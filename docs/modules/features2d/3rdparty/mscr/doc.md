# Documentation for `modules/features2d/3rdparty/mscr/`
...
**Path**: `modules/features2d/3rdparty/mscr/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[chi_table.h](chi_table.h_docs.md)**: H file
- **[chi_table_LICENSE.txt](chi_table_LICENSE.txt_docs.md)**: TXT file
...
- **Parent Folder**: [modules/features2d/3rdparty/](../3rdparty/doc.md)
