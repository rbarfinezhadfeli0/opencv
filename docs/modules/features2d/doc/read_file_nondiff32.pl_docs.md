# Documentation for `modules/features2d/doc/read_file_nondiff32.pl`

## File Metadata

- **Full Path**: `modules/features2d/doc/read_file_nondiff32.pl`
- **File Name**: `read_file_nondiff32.pl`
- **File Size**: 8,623 bytes
- **File Type**: .pl
- **Link to Source**: [modules/features2d/doc/read_file_nondiff32.pl](../../../modules/features2d/doc/read_file_nondiff32.pl)
