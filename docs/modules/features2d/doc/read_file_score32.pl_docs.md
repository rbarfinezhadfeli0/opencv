# Documentation for `modules/features2d/doc/read_file_score32.pl`

## File Metadata

- **Full Path**: `modules/features2d/doc/read_file_score32.pl`
- **File Name**: `read_file_score32.pl`
- **File Size**: 7,242 bytes
- **File Type**: .pl
- **Link to Source**: [modules/features2d/doc/read_file_score32.pl](../../../modules/features2d/doc/read_file_score32.pl)
