# Documentation for `modules/features2d/doc/run_agast_tables.bat`

## File Metadata

- **Full Path**: `modules/features2d/doc/run_agast_tables.bat`
- **File Name**: `run_agast_tables.bat`
- **File Size**: 1,450 bytes
- **File Type**: .bat
- **Link to Source**: [modules/features2d/doc/run_agast_tables.bat](../../../modules/features2d/doc/run_agast_tables.bat)
