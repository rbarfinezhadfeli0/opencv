# Documentation for `modules/features2d/misc/java/test/AGASTFeatureDetectorTest.java`

## File Metadata

- **Full Path**: `modules/features2d/misc/java/test/AGASTFeatureDetectorTest.java`
- **File Name**: `AGASTFeatureDetectorTest.java`
- **File Size**: 2,997 bytes
- **File Type**: .java
- **Link to Source**: [modules/features2d/misc/java/test/AGASTFeatureDetectorTest.java](../../../../../modules/features2d/misc/java/test/AGASTFeatureDetectorTest.java)
...
- **AGASTFeatureDetectorTest**: A class/struct defined in this file
