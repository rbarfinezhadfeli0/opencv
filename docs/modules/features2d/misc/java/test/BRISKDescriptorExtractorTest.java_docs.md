# Documentation for `modules/features2d/misc/java/test/BRISKDescriptorExtractorTest.java`

## File Metadata

- **Full Path**: `modules/features2d/misc/java/test/BRISKDescriptorExtractorTest.java`
- **File Name**: `BRISKDescriptorExtractorTest.java`
- **File Size**: 1,835 bytes
- **File Type**: .java
- **Link to Source**: [modules/features2d/misc/java/test/BRISKDescriptorExtractorTest.java](../../../../../modules/features2d/misc/java/test/BRISKDescriptorExtractorTest.java)
...
- **BRISKDescriptorExtractorTest**: A class/struct defined in this file
