# Documentation for `modules/features2d/misc/java/test/BruteForceDescriptorMatcherTest.java`

## File Metadata

- **Full Path**: `modules/features2d/misc/java/test/BruteForceDescriptorMatcherTest.java`
- **File Name**: `BruteForceDescriptorMatcherTest.java`
- **File Size**: 9,446 bytes
- **File Type**: .java
- **Link to Source**: [modules/features2d/misc/java/test/BruteForceDescriptorMatcherTest.java](../../../../../modules/features2d/misc/java/test/BruteForceDescriptorMatcherTest.java)
...
- **BruteForceDescriptorMatcherTest**: A class/struct defined in this file
