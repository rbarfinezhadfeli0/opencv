# Documentation for `modules/features2d/misc/java/test/BruteForceHammingDescriptorMatcherTest.java`

## File Metadata

- **Full Path**: `modules/features2d/misc/java/test/BruteForceHammingDescriptorMatcherTest.java`
- **File Name**: `BruteForceHammingDescriptorMatcherTest.java`
- **File Size**: 7,763 bytes
- **File Type**: .java
- **Link to Source**: [modules/features2d/misc/java/test/BruteForceHammingDescriptorMatcherTest.java](../../../../../modules/features2d/misc/java/test/BruteForceHammingDescriptorMatcherTest.java)
...
- **BruteForceHammingDescriptorMatcherTest**: A class/struct defined in this file
