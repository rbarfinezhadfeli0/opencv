# Documentation for `modules/features2d/misc/java/test/BruteForceHammingLUTDescriptorMatcherTest.java`

## File Metadata

- **Full Path**: `modules/features2d/misc/java/test/BruteForceHammingLUTDescriptorMatcherTest.java`
- **File Name**: `BruteForceHammingLUTDescriptorMatcherTest.java`
- **File Size**: 7,442 bytes
- **File Type**: .java
- **Link to Source**: [modules/features2d/misc/java/test/BruteForceHammingLUTDescriptorMatcherTest.java](../../../../../modules/features2d/misc/java/test/BruteForceHammingLUTDescriptorMatcherTest.java)
...
- **BruteForceHammingLUTDescriptorMatcherTest**: A class/struct defined in this file
