# Documentation for `modules/features2d/misc/java/test/BruteForceL1DescriptorMatcherTest.java`

## File Metadata

- **Full Path**: `modules/features2d/misc/java/test/BruteForceL1DescriptorMatcherTest.java`
- **File Name**: `BruteForceL1DescriptorMatcherTest.java`
- **File Size**: 8,174 bytes
- **File Type**: .java
- **Link to Source**: [modules/features2d/misc/java/test/BruteForceL1DescriptorMatcherTest.java](../../../../../modules/features2d/misc/java/test/BruteForceL1DescriptorMatcherTest.java)
...
- **BruteForceL1DescriptorMatcherTest**: A class/struct defined in this file
