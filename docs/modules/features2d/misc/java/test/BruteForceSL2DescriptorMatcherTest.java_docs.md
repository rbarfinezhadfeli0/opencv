# Documentation for `modules/features2d/misc/java/test/BruteForceSL2DescriptorMatcherTest.java`

## File Metadata

- **Full Path**: `modules/features2d/misc/java/test/BruteForceSL2DescriptorMatcherTest.java`
- **File Name**: `BruteForceSL2DescriptorMatcherTest.java`
- **File Size**: 8,470 bytes
- **File Type**: .java
- **Link to Source**: [modules/features2d/misc/java/test/BruteForceSL2DescriptorMatcherTest.java](../../../../../modules/features2d/misc/java/test/BruteForceSL2DescriptorMatcherTest.java)
...
- **BruteForceSL2DescriptorMatcherTest**: A class/struct defined in this file
