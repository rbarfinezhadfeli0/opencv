# Documentation for `modules/features2d/misc/java/test/FlannBasedDescriptorMatcherTest.java`

## File Metadata

- **Full Path**: `modules/features2d/misc/java/test/FlannBasedDescriptorMatcherTest.java`
- **File Name**: `FlannBasedDescriptorMatcherTest.java`
- **File Size**: 12,312 bytes
- **File Type**: .java
- **Link to Source**: [modules/features2d/misc/java/test/FlannBasedDescriptorMatcherTest.java](../../../../../modules/features2d/misc/java/test/FlannBasedDescriptorMatcherTest.java)
...
- **FlannBasedDescriptorMatcherTest**: A class/struct defined in this file
