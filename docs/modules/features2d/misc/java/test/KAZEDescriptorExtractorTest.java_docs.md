# Documentation for `modules/features2d/misc/java/test/KAZEDescriptorExtractorTest.java`

## File Metadata

- **Full Path**: `modules/features2d/misc/java/test/KAZEDescriptorExtractorTest.java`
- **File Name**: `KAZEDescriptorExtractorTest.java`
- **File Size**: 2,124 bytes
- **File Type**: .java
- **Link to Source**: [modules/features2d/misc/java/test/KAZEDescriptorExtractorTest.java](../../../../../modules/features2d/misc/java/test/KAZEDescriptorExtractorTest.java)
...
- **KAZEDescriptorExtractorTest**: A class/struct defined in this file
