# Documentation for `modules/features2d/misc/java/test/SIMPLEBLOBFeatureDetectorTest.java`

## File Metadata

- **Full Path**: `modules/features2d/misc/java/test/SIMPLEBLOBFeatureDetectorTest.java`
- **File Name**: `SIMPLEBLOBFeatureDetectorTest.java`
- **File Size**: 6,120 bytes
- **File Type**: .java
- **Link to Source**: [modules/features2d/misc/java/test/SIMPLEBLOBFeatureDetectorTest.java](../../../../../modules/features2d/misc/java/test/SIMPLEBLOBFeatureDetectorTest.java)
...
- **SIMPLEBLOBFeatureDetectorTest**: A class/struct defined in this file
