# Documentation for `modules/features2d/misc/python/`
...
**Path**: `modules/features2d/misc/python/`
**Direct Files**: 1
**Subfolders**: 1
...
- **[pyopencv_features2d.hpp](pyopencv_features2d.hpp_docs.md)**: HPP file
...
- **Parent Folder**: [modules/features2d/misc/](../misc/doc.md)
