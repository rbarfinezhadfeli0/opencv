# Documentation for `modules/features2d/src/kaze/AKAZEFeatures.cpp`

## File Metadata

- **Full Path**: `modules/features2d/src/kaze/AKAZEFeatures.cpp`
- **File Name**: `AKAZEFeatures.cpp`
- **File Size**: 74,580 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/features2d/src/kaze/AKAZEFeatures.cpp](../../../../modules/features2d/src/kaze/AKAZEFeatures.cpp)
...
- **MSURF_Upright_Descriptor_64_Invoker**: A class/struct defined in this file
- **FindKeypointsSameScale**: A class/struct defined in this file
- **ComputeKeypointOrientation**: A class/struct defined in this file
- **for**: A class/struct defined in this file
- **Upright_MLDB_Descriptor_Subset_Invoker**: A class/struct defined in this file
- **MLDB_Full_Descriptor_Invoker**: A class/struct defined in this file
- **gtable**: A class/struct defined in this file
- **SURF_Descriptor_64_Invoker**: A class/struct defined in this file
- **DeterminantHessianResponse**: A class/struct defined in this file
- **MSURF_Descriptor_64_Invoker**: A class/struct defined in this file
- **NonLinearScalarDiffusionStep**: A class/struct defined in this file
- **SURF_Descriptor_Upright_64_Invoker**: A class/struct defined in this file
- **MLDB_Descriptor_Subset_Invoker**: A class/struct defined in this file
- **Upright_MLDB_Full_Descriptor_Invoker**: A class/struct defined in this file

### Functions and Methods

- **creates()**: A function/method defined in this file
- **keeps()**: A function/method defined in this file
- **computes()**: A function/method defined in this file
- **samples()**: A function/method defined in this file
- **sorts()**: A function/method defined in this file
- **c()**: A function/method defined in this file
