# Documentation for `modules/features2d/src/kaze/KAZEFeatures.cpp`

## File Metadata

- **Full Path**: `modules/features2d/src/kaze/KAZEFeatures.cpp`
- **File Name**: `KAZEFeatures.cpp`
- **File Size**: 46,125 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/features2d/src/kaze/KAZEFeatures.cpp](../../../../modules/features2d/src/kaze/KAZEFeatures.cpp)
...
- **MultiscaleDerivativesKAZEInvoker**: A class/struct defined in this file
- **KAZE_Descriptor_Invoker**: A class/struct defined in this file
- **FindExtremumKAZEInvoker**: A class/struct defined in this file
