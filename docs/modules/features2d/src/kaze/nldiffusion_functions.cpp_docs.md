# Documentation for `modules/features2d/src/kaze/nldiffusion_functions.cpp`

## File Metadata

- **Full Path**: `modules/features2d/src/kaze/nldiffusion_functions.cpp`
- **File Name**: `nldiffusion_functions.cpp`
- **File Size**: 18,401 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/features2d/src/kaze/nldiffusion_functions.cpp](../../../../modules/features2d/src/kaze/nldiffusion_functions.cpp)
...
- **Nld_Step_Scalar_Invoker**: A class/struct defined in this file

### Functions and Methods

- **downsamples()**: A function/method defined in this file
