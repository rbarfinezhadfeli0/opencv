# Documentation for `modules/features2d/src/opencl/akaze.cl`

## File Metadata

- **Full Path**: `modules/features2d/src/opencl/akaze.cl`
- **File Name**: `akaze.cl`
- **File Size**: 3,996 bytes
- **File Type**: .cl
- **Link to Source**: [modules/features2d/src/opencl/akaze.cl](../../../../modules/features2d/src/opencl/akaze.cl)
