# Documentation for `modules/features2d/src/opencl/fast.cl`

## File Metadata

- **Full Path**: `modules/features2d/src/opencl/fast.cl`
- **File Name**: `fast.cl`
- **File Size**: 5,129 bytes
- **File Type**: .cl
- **Link to Source**: [modules/features2d/src/opencl/fast.cl](../../../../modules/features2d/src/opencl/fast.cl)
