# Documentation for `modules/features2d/test/test_affine_feature.cpp`

## File Metadata

- **Full Path**: `modules/features2d/test/test_affine_feature.cpp`
- **File Name**: `test_affine_feature.cpp`
- **File Size**: 8,110 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/features2d/test/test_affine_feature.cpp](../../../modules/features2d/test/test_affine_feature.cpp)
