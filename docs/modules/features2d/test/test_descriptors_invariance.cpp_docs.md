# Documentation for `modules/features2d/test/test_descriptors_invariance.cpp`

## File Metadata

- **Full Path**: `modules/features2d/test/test_descriptors_invariance.cpp`
- **File Name**: `test_descriptors_invariance.cpp`
- **File Size**: 2,269 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/features2d/test/test_descriptors_invariance.cpp](../../../modules/features2d/test/test_descriptors_invariance.cpp)
