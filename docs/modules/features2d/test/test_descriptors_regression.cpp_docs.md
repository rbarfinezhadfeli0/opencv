# Documentation for `modules/features2d/test/test_descriptors_regression.cpp`

## File Metadata

- **Full Path**: `modules/features2d/test/test_descriptors_regression.cpp`
- **File Name**: `test_descriptors_regression.cpp`
- **File Size**: 7,293 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/features2d/test/test_descriptors_regression.cpp](../../../modules/features2d/test/test_descriptors_regression.cpp)
...
- **DescriptorImage**: A class/struct defined in this file
