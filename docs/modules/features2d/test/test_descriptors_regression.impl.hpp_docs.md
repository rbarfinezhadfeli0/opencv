# Documentation for `modules/features2d/test/test_descriptors_regression.impl.hpp`

## File Metadata

- **Full Path**: `modules/features2d/test/test_descriptors_regression.impl.hpp`
- **File Name**: `test_descriptors_regression.impl.hpp`
- **File Size**: 13,007 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/features2d/test/test_descriptors_regression.impl.hpp](../../../modules/features2d/test/test_descriptors_regression.impl.hpp)
...
- **Distance**: A class/struct defined in this file
- **CV_DescriptorExtractorTest**: A class/struct defined in this file
