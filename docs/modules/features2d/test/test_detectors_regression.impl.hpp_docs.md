# Documentation for `modules/features2d/test/test_detectors_regression.impl.hpp`

## File Metadata

- **Full Path**: `modules/features2d/test/test_detectors_regression.impl.hpp`
- **File Name**: `test_detectors_regression.impl.hpp`
- **File Size**: 6,900 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/features2d/test/test_detectors_regression.impl.hpp](../../../modules/features2d/test/test_detectors_regression.impl.hpp)
...
- **CV_FeatureDetectorTest**: A class/struct defined in this file
