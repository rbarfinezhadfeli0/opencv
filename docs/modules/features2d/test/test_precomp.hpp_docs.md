# Documentation for `modules/features2d/test/test_precomp.hpp`

## File Metadata

- **Full Path**: `modules/features2d/test/test_precomp.hpp`
- **File Name**: `test_precomp.hpp`
- **File Size**: 335 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/features2d/test/test_precomp.hpp](../../../modules/features2d/test/test_precomp.hpp)
