# Documentation for `modules/flann/src/precomp.hpp`

## File Metadata

- **Full Path**: `modules/flann/src/precomp.hpp`
- **File Name**: `precomp.hpp`
- **File Size**: 509 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/flann/src/precomp.hpp](../../../modules/flann/src/precomp.hpp)
...
- **OPENCV_FLANN_PRECOMP_HPP()**: A function/method defined in this file
