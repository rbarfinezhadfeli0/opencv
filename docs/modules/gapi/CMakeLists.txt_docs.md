# Documentation for `modules/gapi/CMakeLists.txt`

## File Metadata

- **Full Path**: `modules/gapi/CMakeLists.txt`
- **File Name**: `CMakeLists.txt`
- **File Size**: 16,866 bytes
- **File Type**: .txt
- **Link to Source**: [modules/gapi/CMakeLists.txt](../../modules/gapi/CMakeLists.txt)

## Purpose and Role

This file is located in the `modules/gapi` directory and serves as part of the OpenCV library infrastructure.
