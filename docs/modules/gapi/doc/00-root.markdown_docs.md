# Documentation for `modules/gapi/doc/00-root.markdown`

## File Metadata

- **Full Path**: `modules/gapi/doc/00-root.markdown`
- **File Name**: `00-root.markdown`
- **File Size**: 4,616 bytes
- **File Type**: .markdown
- **Link to Source**: [modules/gapi/doc/00-root.markdown](../../../modules/gapi/doc/00-root.markdown)
