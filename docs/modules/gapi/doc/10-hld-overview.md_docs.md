# Documentation for `modules/gapi/doc/10-hld-overview.md`

## File Metadata

- **Full Path**: `modules/gapi/doc/10-hld-overview.md`
- **File Name**: `10-hld-overview.md`
- **File Size**: 7,509 bytes
- **File Type**: .md
- **Link to Source**: [modules/gapi/doc/10-hld-overview.md](../../../modules/gapi/doc/10-hld-overview.md)
