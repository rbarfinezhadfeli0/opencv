# Documentation for `modules/gapi/doc/20-kernel-api.markdown`

## File Metadata

- **Full Path**: `modules/gapi/doc/20-kernel-api.markdown`
- **File Name**: `20-kernel-api.markdown`
- **File Size**: 7,972 bytes
- **File Type**: .markdown
- **Link to Source**: [modules/gapi/doc/20-kernel-api.markdown](../../../modules/gapi/doc/20-kernel-api.markdown)
