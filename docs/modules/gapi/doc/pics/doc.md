# Documentation for `modules/gapi/doc/pics/`
...
- **[demo.jpg](demo.jpg_docs.md)**: JPG file
- **[gapi_scheme.png](gapi_scheme.png_docs.md)**: PNG file
- **[render_example.png](render_example.png_docs.md)**: PNG file
...
- **Parent Folder**: [modules/gapi/doc/](../doc/doc.md)

**Sibling Folders**:
- [slides/](../slides/doc.md)
