# Documentation for `modules/gapi/doc/slides/get_sty.sh`

## File Metadata

- **Full Path**: `modules/gapi/doc/slides/get_sty.sh`
- **File Name**: `get_sty.sh`
- **File Size**: 667 bytes
- **File Type**: .sh
- **Link to Source**: [modules/gapi/doc/slides/get_sty.sh](../../../../modules/gapi/doc/slides/get_sty.sh)
