# Documentation for `modules/gapi/include/opencv2/gapi/cpu/gcpukernel.hpp`

## File Metadata

- **Full Path**: `modules/gapi/include/opencv2/gapi/cpu/gcpukernel.hpp`
- **File Name**: `gcpukernel.hpp`
- **File Size**: 18,095 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/include/opencv2/gapi/cpu/gcpukernel.hpp](../../../../../../modules/gapi/include/opencv2/gapi/cpu/gcpukernel.hpp)

## Purpose and Role

This file is located in the `modules/gapi/include/opencv2/gapi/cpu` directory and serves as part of the OpenCV library infrastructure.
...
- **tracked_cv_mat**: A class/struct defined in this file
- **class**: A class/struct defined in this file
- **get_out**: A class/struct defined in this file
- **OCVCallHelper**: A class/struct defined in this file
- **get_in**: A class/struct defined in this file
- **GCPUStKernelImpl**: A class/struct defined in this file
...
- **GCPUKernelImpl**: A class/struct defined in this file
- **gimpl**: A class/struct defined in this file
- **GAPI_EXPORTS**: A class/struct defined in this file
- **GOCVFunctor**: A class/struct defined in this file
- **OCVSetupHelper**: A class/struct defined in this file
- **to**: A class/struct defined in this file
- **OCVStCallHelper**: A class/struct defined in this file
- **Name**: A class/struct defined in this file

### Functions and Methods

- **is()**: A function/method defined in this file
- **OPENCV_GAPI_GCPUKERNEL_HPP()**: A function/method defined in this file
- **call_and_postprocess()**: A function/method defined in this file
