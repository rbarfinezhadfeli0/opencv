# Documentation for `modules/gapi/include/opencv2/gapi/gkernel.hpp`

## File Metadata

- **Full Path**: `modules/gapi/include/opencv2/gapi/gkernel.hpp`
- **File Name**: `gkernel.hpp`
- **File Size**: 27,878 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/include/opencv2/gapi/gkernel.hpp](../../../../../modules/gapi/include/opencv2/gapi/gkernel.hpp)
...
- **GKernelType**: A class/struct defined in this file
- **which**: A class/struct defined in this file
- **is**: A class/struct defined in this file
- **NoTag**: A class/struct defined in this file
- **Yield**: A class/struct defined in this file
- **GAPI_EXPORTS**: A class/struct defined in this file
- **for**: A class/struct defined in this file
- **GKernelTypeM**: A class/struct defined in this file
- **GFunctor**: A class/struct defined in this file
- **Priv**: A class/struct defined in this file
- **hash**: A class/struct defined in this file
- **G_ID_HELPER_CLASS**: A class/struct defined in this file
- **CompileArgTag**: A class/struct defined in this file
- **to**: A class/struct defined in this file
- **MetaType**: A class/struct defined in this file
- **MetaHelper**: A class/struct defined in this file
- **KernelTypeMedium**: A class/struct defined in this file
- **GAPI_EXPORTS_W_SIMPLE**: A class/struct defined in this file
- **eliminates**: A class/struct defined in this file
- **Class**: A class/struct defined in this file
- **GTypeInfo**: A class/struct defined in this file

### Functions and Methods

- **returning()**: A function/method defined in this file
- **successively()**: A function/method defined in this file
...
- **OPENCV_GAPI_GKERNEL_HPP()**: A function/method defined in this file
