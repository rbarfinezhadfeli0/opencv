# Documentation for `modules/gapi/include/opencv2/gapi/gtype_traits.hpp`

## File Metadata

- **Full Path**: `modules/gapi/include/opencv2/gapi/gtype_traits.hpp`
- **File Name**: `gtype_traits.hpp`
- **File Size**: 11,124 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/include/opencv2/gapi/gtype_traits.hpp](../../../../../modules/gapi/include/opencv2/gapi/gtype_traits.hpp)
...
- **GObtainCtor**: A class/struct defined in this file
- **GTypeOf**: A class/struct defined in this file
- **GTypeTraits**: A class/struct defined in this file
- **T**: A class/struct defined in this file
- **has_custom_wrap**: A class/struct defined in this file
- **Custom**: A class/struct defined in this file
- **ArgKind**: A class/struct defined in this file
- **check**: A class/struct defined in this file
- **WrapValue**: A class/struct defined in this file
- **has_gshape**: A class/struct defined in this file
- **contains_shape_field**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_GAPI_GTYPE_TRAITS_HPP()**: A function/method defined in this file
