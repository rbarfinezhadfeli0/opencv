# Documentation for `modules/gapi/include/opencv2/gapi/infer.hpp`

## File Metadata

- **Full Path**: `modules/gapi/include/opencv2/gapi/infer.hpp`
- **File Name**: `infer.hpp`
- **File Size**: 24,858 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/include/opencv2/gapi/infer.hpp](../../../../../modules/gapi/include/opencv2/gapi/infer.hpp)
...
- **GInferList**: A class/struct defined in this file
- **Generic**: A class/struct defined in this file
- **this**: A class/struct defined in this file
- **T**: A class/struct defined in this file
- **GInferInputsTyped**: A class/struct defined in this file
- **GInferROI**: A class/struct defined in this file
- **GInferBase**: A class/struct defined in this file
- **valid_infer2_types**: A class/struct defined in this file
- **GInferList2**: A class/struct defined in this file
- **InferAPIRoi**: A class/struct defined in this file
- **for**: A class/struct defined in this file
- **GInfer**: A class/struct defined in this file
- **InferAPIList2**: A class/struct defined in this file
- **GInferROIBase**: A class/struct defined in this file
- **Priv**: A class/struct defined in this file
- **GNetworkType**: A class/struct defined in this file
- **Net**: A class/struct defined in this file
- **accepted_infer_types**: A class/struct defined in this file
- **GInferListBase**: A class/struct defined in this file
- **InferAPI**: A class/struct defined in this file
- **CompileArgTag**: A class/struct defined in this file
- **GInferOutputsTyped**: A class/struct defined in this file
- **GInferList2Base**: A class/struct defined in this file
- **InferAPIList**: A class/struct defined in this file
- **GAPI_EXPORTS_W_SIMPLE**: A class/struct defined in this file
- **InOutInfo**: A class/struct defined in this file
- **InferROITraits**: A class/struct defined in this file
- **Class**: A class/struct defined in this file

### Functions and Methods

- **round()**: A function/method defined in this file
- **API()**: A function/method defined in this file
- **OPENCV_GAPI_INFER_HPP()**: A function/method defined in this file
