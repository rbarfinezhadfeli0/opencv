# Documentation for `modules/gapi/include/opencv2/gapi/util/variant.hpp`

## File Metadata

- **Full Path**: `modules/gapi/include/opencv2/gapi/util/variant.hpp`
- **File Name**: `variant.hpp`
- **File Size**: 26,856 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/include/opencv2/gapi/util/variant.hpp](../../../../../../modules/gapi/include/opencv2/gapi/util/variant.hpp)
...
- **swap_h**: A class/struct defined in this file
- **variant_size**: A class/struct defined in this file
- **conditional_ref**: A class/struct defined in this file
- **Value**: A class/struct defined in this file
- **cnvrt_ctor_h**: A class/struct defined in this file
- **copy_h**: A class/struct defined in this file
- **visitor_return_type_deduction_helper**: A class/struct defined in this file
- **is**: A class/struct defined in this file
- **type_list_element**: A class/struct defined in this file
- **cctr_h**: A class/struct defined in this file
- **T**: A class/struct defined in this file
- **monostate**: A class/struct defined in this file
- **type_list_index_helper**: A class/struct defined in this file
- **bad_variant_access**: A class/struct defined in this file
- **variant**: A class/struct defined in this file
- **equal_h**: A class/struct defined in this file
- **Visitor**: A class/struct defined in this file
- **static_visitor**: A class/struct defined in this file
- **type_list_index**: A class/struct defined in this file
- **visitor_interface**: A class/struct defined in this file
- **mctr_h**: A class/struct defined in this file
- **static_indexed_visitor**: A class/struct defined in this file
- **cnvrt_assign_h**: A class/struct defined in this file
- **move_h**: A class/struct defined in this file
- **before**: A class/struct defined in this file
- **dtor_h**: A class/struct defined in this file
- **invocation**: A class/struct defined in this file
...
- **OPENCV_GAPI_UTIL_VARIANT_HPP()**: A function/method defined in this file
