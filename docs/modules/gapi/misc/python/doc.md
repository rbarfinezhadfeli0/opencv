# Documentation for `modules/gapi/misc/python/`
...
- **[pyopencv_gapi.hpp](pyopencv_gapi.hpp_docs.md)**: HPP file
- **[shadow_gapi.hpp](shadow_gapi.hpp_docs.md)**: HPP file
- **[python_bridge.hpp](python_bridge.hpp_docs.md)**: HPP file
...
- **package/** - See [package/doc.md](package/doc.md)
...
- **Parent Folder**: [modules/gapi/misc/](../misc/doc.md)

**Subfolders**:
- [package/](package/doc.md)
