# Documentation for `modules/gapi/misc/python/pyopencv_gapi.hpp`

## File Metadata

- **Full Path**: `modules/gapi/misc/python/pyopencv_gapi.hpp`
- **File Name**: `pyopencv_gapi.hpp`
- **File Size**: 45,112 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/misc/python/pyopencv_gapi.hpp](../../../../modules/gapi/misc/python/pyopencv_gapi.hpp)
...
- **PythonCustomStreamSource**: A class/struct defined in this file
- **PyOpenCV_Converter**: A class/struct defined in this file
- **PyObjectHolder**: A class/struct defined in this file
...
- **UNSUPPORTED()**: A function/method defined in this file
- **HAVE_OPENCV_GAPI()**: A function/method defined in this file
- **HC()**: A function/method defined in this file
- **TRY_EXTRACT()**: A function/method defined in this file
- **OPENCV_GAPI_PYOPENCV_GAPI_HPP()**: A function/method defined in this file
