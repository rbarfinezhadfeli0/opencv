# Documentation for `modules/gapi/misc/python/python_bridge.hpp`

## File Metadata

- **Full Path**: `modules/gapi/misc/python/python_bridge.hpp`
- **File Name**: `python_bridge.hpp`
- **File Size**: 11,188 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/misc/python/python_bridge.hpp](../../../../modules/gapi/misc/python/python_bridge.hpp)
...
- **WrapType**: A class/struct defined in this file
- **ArgTypeTraits**: A class/struct defined in this file
- **GAPI_EXPORTS_W_SIMPLE**: A class/struct defined in this file
- **Priv**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_GAPI_PYTHON_BRIDGE_HPP()**: A function/method defined in this file
