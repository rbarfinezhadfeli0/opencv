# Documentation for `modules/gapi/misc/python/samples/gaze_estimation.py`

## File Metadata

- **Full Path**: `modules/gapi/misc/python/samples/gaze_estimation.py`
- **File Name**: `gaze_estimation.py`
- **File Size**: 16,929 bytes
- **File Type**: .py
- **Link to Source**: [modules/gapi/misc/python/samples/gaze_estimation.py](../../../../../modules/gapi/misc/python/samples/gaze_estimation.py)

## Purpose and Role

This file is located in the `modules/gapi/misc/python/samples` directory and serves as part of the OpenCV library infrastructure.
...
- **GParseEyes**: A class/struct defined in this file
- **GProcessPoses**: A class/struct defined in this file
- **GProcessPosesImpl**: A class/struct defined in this file
- **GGetStatesImpl**: A class/struct defined in this file
- **GGetStates**: A class/struct defined in this file
- **GParseEyesImpl**: A class/struct defined in this file

### Functions and Methods

- **eye_box()**: A function/method defined in this file
- **build_argparser()**: A function/method defined in this file
- **intersection()**: A function/method defined in this file
- **weight_path()**: A function/method defined in this file
- **outMeta()**: A function/method defined in this file
- **process_landmarks()**: A function/method defined in this file
