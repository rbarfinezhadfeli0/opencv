# Documentation for `modules/gapi/misc/python/test/test_gapi_infer_onnx.py`

## File Metadata

- **Full Path**: `modules/gapi/misc/python/test/test_gapi_infer_onnx.py`
- **File Name**: `test_gapi_infer_onnx.py`
- **File Size**: 2,037 bytes
- **File Type**: .py
- **Link to Source**: [modules/gapi/misc/python/test/test_gapi_infer_onnx.py](../../../../../modules/gapi/misc/python/test/test_gapi_infer_onnx.py)
...
- **test_onnx_classification()**: A function/method defined in this file
