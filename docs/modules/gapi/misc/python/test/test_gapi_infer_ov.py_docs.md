# Documentation for `modules/gapi/misc/python/test/test_gapi_infer_ov.py`

## File Metadata

- **Full Path**: `modules/gapi/misc/python/test/test_gapi_infer_ov.py`
- **File Name**: `test_gapi_infer_ov.py`
- **File Size**: 9,484 bytes
- **File Type**: .py
- **Link to Source**: [modules/gapi/misc/python/test/test_gapi_infer_ov.py](../../../../../modules/gapi/misc/python/test/test_gapi_infer_ov.py)
...
- **AgeGenderOV**: A class/struct defined in this file
- **AgeGenderGAPI**: A class/struct defined in this file
- **TestSkip**: A class/struct defined in this file
- **test_gapi_infer_ov**: A class/struct defined in this file

### Functions and Methods

- **test_skip()**: A function/method defined in this file
- **test_age_gender_infer_batch()**: A function/method defined in this file
- **cfgPrePostProcessing()**: A function/method defined in this file
- **reshape()**: A function/method defined in this file
- **preproc()**: A function/method defined in this file
- **skip_if_openvino_not_available()**: A function/method defined in this file
- **test_age_gender_infer_image()**: A function/method defined in this file
- **setUp()**: A function/method defined in this file
- **test_age_gender_infer_planar()**: A function/method defined in this file
- **test_age_gender_infer_tensor()**: A function/method defined in this file
- **apply()**: A function/method defined in this file
