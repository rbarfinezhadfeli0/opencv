# Documentation for `modules/gapi/misc/python/test/test_gapi_sample_pipelines.py`

## File Metadata

- **Full Path**: `modules/gapi/misc/python/test/test_gapi_sample_pipelines.py`
- **File Name**: `test_gapi_sample_pipelines.py`
- **File Size**: 25,346 bytes
- **File Type**: .py
- **Link to Source**: [modules/gapi/misc/python/test/test_gapi_sample_pipelines.py](../../../../../modules/gapi/misc/python/test/test_gapi_sample_pipelines.py)
...
- **GResize**: A class/struct defined in this file
- **GSquare**: A class/struct defined in this file
- **GConcatImpl**: A class/struct defined in this file
- **gapi_sample_pipelines**: A class/struct defined in this file
- **GAddC**: A class/struct defined in this file
- **Op**: A class/struct defined in this file
- **GSquareMean**: A class/struct defined in this file
- **GSumImpl**: A class/struct defined in this file
- **GSizeRImpl**: A class/struct defined in this file
- **TestSkip**: A class/struct defined in this file
- **GAddImpl**: A class/struct defined in this file
- **GAddCImpl**: A class/struct defined in this file
- **GBoundingRect**: A class/struct defined in this file
- **GConcat**: A class/struct defined in this file
- **GSplit3**: A class/struct defined in this file
- **GGoodFeatures**: A class/struct defined in this file
- **GMean**: A class/struct defined in this file
- **GLookUp**: A class/struct defined in this file
- **GSplit3Impl**: A class/struct defined in this file
- **GGoodFeaturesImpl**: A class/struct defined in this file
- **GSquareImpl**: A class/struct defined in this file
- **GSquareMeanImpl**: A class/struct defined in this file
- **GResizeImpl**: A class/struct defined in this file
- **GSum**: A class/struct defined in this file
- **GTranspose**: A class/struct defined in this file
- **GMeanImpl**: A class/struct defined in this file
- **GSize**: A class/struct defined in this file
- **GSizeR**: A class/struct defined in this file
- **GSizeImpl**: A class/struct defined in this file
- **GAdd**: A class/struct defined in this file
- **GTransposeImpl**: A class/struct defined in this file
- **GBoundingRectImpl**: A class/struct defined in this file
- **GLookUpImpl**: A class/struct defined in this file

### Functions and Methods

- **test_opaq_with_custom_type()**: A function/method defined in this file
- **test_custom_op_boundingRect()**: A function/method defined in this file
- **test_invalid_op()**: A function/method defined in this file
- **test_custom_op_add()**: A function/method defined in this file
- **test_custom_op_goodFeaturesToTrack()**: A function/method defined in this file
- **test_invalid_op_input()**: A function/method defined in this file
- **test_different_output_opaque_kinds()**: A function/method defined in this file
- **test_pipeline_with_custom_kernels()**: A function/method defined in this file
- **test_custom_op_sizeR()**: A function/method defined in this file
- **test_custom_op_addC()**: A function/method defined in this file
- **run()**: A function/method defined in this file
- **test_raise_in_outMeta()**: A function/method defined in this file
- **test_invalid_outMeta()**: A function/method defined in this file
- **test_state_in_class()**: A function/method defined in this file
- **test_custom_op_mean()**: A function/method defined in this file
- **outMeta()**: A function/method defined in this file
- **test_custom_op_size()**: A function/method defined in this file
- **test_raise_in_kernel()**: A function/method defined in this file
- **test_skip()**: A function/method defined in this file
- **test_array_with_custom_type()**: A function/method defined in this file
- **setUp()**: A function/method defined in this file
- **test_custom_op_split3()**: A function/method defined in this file
- **create_op()**: A function/method defined in this file
