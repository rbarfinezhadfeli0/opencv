# Documentation for `modules/gapi/perf/common/gapi_imgproc_perf_tests_inl.hpp`

## File Metadata

- **Full Path**: `modules/gapi/perf/common/gapi_imgproc_perf_tests_inl.hpp`
- **File Name**: `gapi_imgproc_perf_tests_inl.hpp`
- **File Size**: 55,212 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/perf/common/gapi_imgproc_perf_tests_inl.hpp](../../../../modules/gapi/perf/common/gapi_imgproc_perf_tests_inl.hpp)
...
- **OPENCV_GAPI_IMGPROC_PERF_TESTS_INL_HPP()**: A function/method defined in this file
...
**C++ Includes:**
- `../../test/common/gapi_imgproc_tests_common.hpp`
