# Documentation for `modules/gapi/perf/cpu/gapi_core_perf_tests_fluid.cpp`

## File Metadata

- **Full Path**: `modules/gapi/perf/cpu/gapi_core_perf_tests_fluid.cpp`
- **File Name**: `gapi_core_perf_tests_fluid.cpp`
- **File Size**: 15,328 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/perf/cpu/gapi_core_perf_tests_fluid.cpp](../../../../modules/gapi/perf/cpu/gapi_core_perf_tests_fluid.cpp)
