# Documentation for `modules/gapi/perf/perf_precomp.hpp`

## File Metadata

- **Full Path**: `modules/gapi/perf/perf_precomp.hpp`
- **File Name**: `perf_precomp.hpp`
- **File Size**: 849 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/perf/perf_precomp.hpp](../../../modules/gapi/perf/perf_precomp.hpp)
...
- **__OPENCV_GAPI_PERF_PRECOMP_HPP__()**: A function/method defined in this file
