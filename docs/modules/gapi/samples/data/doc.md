# Documentation for `modules/gapi/samples/data/`
...
**Path**: `modules/gapi/samples/data/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[config_template.yml](config_template.yml_docs.md)**: YML file
...
- **Parent Folder**: [modules/gapi/samples/](../samples/doc.md)
