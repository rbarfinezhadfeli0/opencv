# Documentation for `modules/gapi/samples/face_detection_mtcnn.cpp`

## File Metadata

- **Full Path**: `modules/gapi/samples/face_detection_mtcnn.cpp`
- **File Name**: `face_detection_mtcnn.cpp`
- **File Size**: 30,898 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/samples/face_detection_mtcnn.cpp](../../../modules/gapi/samples/face_detection_mtcnn.cpp)
...
- **BBox**: A class/struct defined in this file
- **Face**: A class/struct defined in this file

### Functions and Methods

- **namespace()**: A function/method defined in this file
