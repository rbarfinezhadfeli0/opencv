# Documentation for `modules/gapi/samples/gaze_estimation.cpp`

## File Metadata

- **Full Path**: `modules/gapi/samples/gaze_estimation.cpp`
- **File Name**: `gaze_estimation.cpp`
- **File Size**: 15,030 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/samples/gaze_estimation.cpp](../../../modules/gapi/samples/gaze_estimation.cpp)
