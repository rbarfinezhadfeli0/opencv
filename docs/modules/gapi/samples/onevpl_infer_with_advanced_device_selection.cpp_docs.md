# Documentation for `modules/gapi/samples/onevpl_infer_with_advanced_device_selection.cpp`

## File Metadata

- **Full Path**: `modules/gapi/samples/onevpl_infer_with_advanced_device_selection.cpp`
- **File Name**: `onevpl_infer_with_advanced_device_selection.cpp`
- **File Size**: 30,676 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/samples/onevpl_infer_with_advanced_device_selection.cpp](../../../modules/gapi/samples/onevpl_infer_with_advanced_device_selection.cpp)
...
- **flow**: A class/struct defined in this file
