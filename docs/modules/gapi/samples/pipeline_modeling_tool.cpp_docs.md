# Documentation for `modules/gapi/samples/pipeline_modeling_tool.cpp`

## File Metadata

- **Full Path**: `modules/gapi/samples/pipeline_modeling_tool.cpp`
- **File Name**: `pipeline_modeling_tool.cpp`
- **File Size**: 20,294 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/samples/pipeline_modeling_tool.cpp](../../../modules/gapi/samples/pipeline_modeling_tool.cpp)
...
- **WaitMode**: A class/struct defined in this file
- **AppMode**: A class/struct defined in this file
...
- `pipeline_modeling_tool/dummy_source.hpp`
- `exception`
- `vector`
- `iostream`
- `opencv2/gapi.hpp`
- `pipeline_modeling_tool/utils.hpp`
- `pipeline_modeling_tool/pipeline_builder.hpp`
- `opencv2/highgui.hpp`
- `thread`
