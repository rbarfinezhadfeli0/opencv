# Documentation for `modules/gapi/samples/pipeline_modeling_tool/pipeline_builder.hpp`

## File Metadata

- **Full Path**: `modules/gapi/samples/pipeline_modeling_tool/pipeline_builder.hpp`
- **File Name**: `pipeline_builder.hpp`
- **File Size**: 25,913 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/samples/pipeline_modeling_tool/pipeline_builder.hpp](../../../../modules/gapi/samples/pipeline_modeling_tool/pipeline_builder.hpp)
...
- **LoadPath**: A class/struct defined in this file
- **InferParams**: A class/struct defined in this file
- **InferCall**: A class/struct defined in this file
- **NumItersCriterion**: A class/struct defined in this file
- **CallParams**: A class/struct defined in this file
- **DummyState**: A class/struct defined in this file
- **State**: A class/struct defined in this file
- **DataNode**: A class/struct defined in this file
- **PipelineBuilder**: A class/struct defined in this file
- **NodeEdges**: A class/struct defined in this file
- **DummyParams**: A class/struct defined in this file
- **ImportPath**: A class/struct defined in this file
- **SubGraphCall**: A class/struct defined in this file
- **Edge**: A class/struct defined in this file
- **CallNode**: A class/struct defined in this file
- **ElapsedTimeCriterion**: A class/struct defined in this file
- **P**: A class/struct defined in this file
- **SourceCall**: A class/struct defined in this file
- **DummyCall**: A class/struct defined in this file
- **SubGraphState**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_GAPI_PIPELINE_MODELING_TOOL_PIPELINE_BUILDER_HPP()**: A function/method defined in this file
