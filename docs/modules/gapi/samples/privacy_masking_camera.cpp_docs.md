# Documentation for `modules/gapi/samples/privacy_masking_camera.cpp`

## File Metadata

- **Full Path**: `modules/gapi/samples/privacy_masking_camera.cpp`
- **File Name**: `privacy_masking_camera.cpp`
- **File Size**: 6,625 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/samples/privacy_masking_camera.cpp](../../../modules/gapi/samples/privacy_masking_camera.cpp)
