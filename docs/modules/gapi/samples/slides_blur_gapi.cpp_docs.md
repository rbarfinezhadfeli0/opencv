# Documentation for `modules/gapi/samples/slides_blur_gapi.cpp`

## File Metadata

- **Full Path**: `modules/gapi/samples/slides_blur_gapi.cpp`
- **File Name**: `slides_blur_gapi.cpp`
- **File Size**: 902 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/samples/slides_blur_gapi.cpp](../../../modules/gapi/samples/slides_blur_gapi.cpp)
