# Documentation for `modules/gapi/samples/slides_sobel_cv.cpp`

## File Metadata

- **Full Path**: `modules/gapi/samples/slides_sobel_cv.cpp`
- **File Name**: `slides_sobel_cv.cpp`
- **File Size**: 544 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/samples/slides_sobel_cv.cpp](../../../modules/gapi/samples/slides_sobel_cv.cpp)
