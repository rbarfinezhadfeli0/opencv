# Documentation for `modules/gapi/samples/slides_sobel_gapi.cpp`

## File Metadata

- **Full Path**: `modules/gapi/samples/slides_sobel_gapi.cpp`
- **File Name**: `slides_sobel_gapi.cpp`
- **File Size**: 686 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/samples/slides_sobel_gapi.cpp](../../../modules/gapi/samples/slides_sobel_gapi.cpp)
