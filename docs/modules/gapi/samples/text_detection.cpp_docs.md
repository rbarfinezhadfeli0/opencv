# Documentation for `modules/gapi/samples/text_detection.cpp`

## File Metadata

- **Full Path**: `modules/gapi/samples/text_detection.cpp`
- **File Name**: `text_detection.cpp`
- **File Size**: 27,581 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/samples/text_detection.cpp](../../../modules/gapi/samples/text_detection.cpp)
...
- **BeamElement**: A class/struct defined in this file
