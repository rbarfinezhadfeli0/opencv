# Documentation for `modules/gapi/src/3rdparty/vasot/src/common/`
...
**Path**: `modules/gapi/src/3rdparty/vasot/src/common/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[exception.hpp](exception.hpp_docs.md)**: HPP file
- **[prof.hpp](prof.hpp_docs.md)**: HPP file
