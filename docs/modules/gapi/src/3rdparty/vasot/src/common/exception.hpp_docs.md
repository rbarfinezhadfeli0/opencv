# Documentation for `modules/gapi/src/3rdparty/vasot/src/common/exception.hpp`

## File Metadata

- **Full Path**: `modules/gapi/src/3rdparty/vasot/src/common/exception.hpp`
- **File Name**: `exception.hpp`
- **File Size**: 1,047 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/src/3rdparty/vasot/src/common/exception.hpp](../../../../../../../modules/gapi/src/3rdparty/vasot/src/common/exception.hpp)
...
- **VAS_COMMON_EXCEPTION_HPP()**: A function/method defined in this file
