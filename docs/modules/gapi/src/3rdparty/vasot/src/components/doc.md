# Documentation for `modules/gapi/src/3rdparty/vasot/src/components/`
...
**Path**: `modules/gapi/src/3rdparty/vasot/src/components/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [modules/gapi/src/3rdparty/vasot/src/](../src/doc.md)
