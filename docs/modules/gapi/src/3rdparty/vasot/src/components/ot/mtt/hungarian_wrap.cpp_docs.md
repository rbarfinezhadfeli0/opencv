# Documentation for `modules/gapi/src/3rdparty/vasot/src/components/ot/mtt/hungarian_wrap.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/3rdparty/vasot/src/components/ot/mtt/hungarian_wrap.cpp`
- **File Name**: `hungarian_wrap.cpp`
- **File Size**: 10,663 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/3rdparty/vasot/src/components/ot/mtt/hungarian_wrap.cpp](../../../../../../../../../modules/gapi/src/3rdparty/vasot/src/components/ot/mtt/hungarian_wrap.cpp)
