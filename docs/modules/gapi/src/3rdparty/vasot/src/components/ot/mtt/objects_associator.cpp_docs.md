# Documentation for `modules/gapi/src/3rdparty/vasot/src/components/ot/mtt/objects_associator.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/3rdparty/vasot/src/components/ot/mtt/objects_associator.cpp`
- **File Name**: `objects_associator.cpp`
- **File Size**: 8,041 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/3rdparty/vasot/src/components/ot/mtt/objects_associator.cpp](../../../../../../../../../modules/gapi/src/3rdparty/vasot/src/components/ot/mtt/objects_associator.cpp)
