# Documentation for `modules/gapi/src/3rdparty/vasot/src/components/ot/mtt/rgb_histogram.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/3rdparty/vasot/src/components/ot/mtt/rgb_histogram.cpp`
- **File Name**: `rgb_histogram.cpp`
- **File Size**: 4,679 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/3rdparty/vasot/src/components/ot/mtt/rgb_histogram.cpp](../../../../../../../../../modules/gapi/src/3rdparty/vasot/src/components/ot/mtt/rgb_histogram.cpp)
