# Documentation for `modules/gapi/src/3rdparty/vasot/src/components/ot/zero_term_imageless_tracker.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/3rdparty/vasot/src/components/ot/zero_term_imageless_tracker.cpp`
- **File Name**: `zero_term_imageless_tracker.cpp`
- **File Size**: 7,588 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/3rdparty/vasot/src/components/ot/zero_term_imageless_tracker.cpp](../../../../../../../../modules/gapi/src/3rdparty/vasot/src/components/ot/zero_term_imageless_tracker.cpp)
