# Documentation for `modules/gapi/src/api/garray.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/api/garray.cpp`
- **File Name**: `garray.cpp`
- **File Size**: 1,261 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/api/garray.cpp](../../../../modules/gapi/src/api/garray.cpp)
