# Documentation for `modules/gapi/src/api/gbackend.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/api/gbackend.cpp`
- **File Name**: `gbackend.cpp`
- **File Size**: 13,997 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/api/gbackend.cpp](../../../../modules/gapi/src/api/gbackend.cpp)
