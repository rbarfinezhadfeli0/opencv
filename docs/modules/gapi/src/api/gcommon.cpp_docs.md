# Documentation for `modules/gapi/src/api/gcommon.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/api/gcommon.cpp`
- **File Name**: `gcommon.cpp`
- **File Size**: 536 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/api/gcommon.cpp](../../../../modules/gapi/src/api/gcommon.cpp)
