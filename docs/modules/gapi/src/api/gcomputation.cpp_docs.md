# Documentation for `modules/gapi/src/api/gcomputation.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/api/gcomputation.cpp`
- **File Name**: `gcomputation.cpp`
- **File Size**: 12,060 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/api/gcomputation.cpp](../../../../modules/gapi/src/api/gcomputation.cpp)
