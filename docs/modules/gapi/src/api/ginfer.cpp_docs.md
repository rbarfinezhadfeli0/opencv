# Documentation for `modules/gapi/src/api/ginfer.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/api/ginfer.cpp`
- **File Name**: `ginfer.cpp`
- **File Size**: 795 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/api/ginfer.cpp](../../../../modules/gapi/src/api/ginfer.cpp)
