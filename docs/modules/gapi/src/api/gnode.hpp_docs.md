# Documentation for `modules/gapi/src/api/gnode.hpp`

## File Metadata

- **Full Path**: `modules/gapi/src/api/gnode.hpp`
- **File Name**: `gnode.hpp`
- **File Size**: 1,278 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/src/api/gnode.hpp](../../../../modules/gapi/src/api/gnode.hpp)
...
- **NodeShape**: A class/struct defined in this file
- **ConstTag**: A class/struct defined in this file
- **Priv**: A class/struct defined in this file
- **won**: A class/struct defined in this file
- **ParamTag**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_GAPI_GNODE_HPP()**: A function/method defined in this file
