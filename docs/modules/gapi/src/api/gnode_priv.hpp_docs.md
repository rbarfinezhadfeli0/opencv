# Documentation for `modules/gapi/src/api/gnode_priv.hpp`

## File Metadata

- **Full Path**: `modules/gapi/src/api/gnode_priv.hpp`
- **File Name**: `gnode_priv.hpp`
- **File Size**: 1,193 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/src/api/gnode_priv.hpp](../../../../modules/gapi/src/api/gnode_priv.hpp)
...
- **ConstTag**: A class/struct defined in this file
- **ParamTag**: A class/struct defined in this file

### Functions and Methods

- **util()**: A function/method defined in this file
- **OPENCV_GNODE_PRIV_HPP()**: A function/method defined in this file
