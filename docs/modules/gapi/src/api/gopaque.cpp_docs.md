# Documentation for `modules/gapi/src/api/gopaque.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/api/gopaque.cpp`
- **File Name**: `gopaque.cpp`
- **File Size**: 1,144 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/api/gopaque.cpp](../../../../modules/gapi/src/api/gopaque.cpp)
