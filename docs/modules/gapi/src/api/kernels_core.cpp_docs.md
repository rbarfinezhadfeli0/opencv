# Documentation for `modules/gapi/src/api/kernels_core.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/api/kernels_core.cpp`
- **File Name**: `kernels_core.cpp`
- **File Size**: 10,909 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/api/kernels_core.cpp](../../../../modules/gapi/src/api/kernels_core.cpp)
