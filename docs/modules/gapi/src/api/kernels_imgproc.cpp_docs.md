# Documentation for `modules/gapi/src/api/kernels_imgproc.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/api/kernels_imgproc.cpp`
- **File Name**: `kernels_imgproc.cpp`
- **File Size**: 10,014 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/api/kernels_imgproc.cpp](../../../../modules/gapi/src/api/kernels_imgproc.cpp)
