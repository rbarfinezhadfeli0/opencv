# Documentation for `modules/gapi/src/api/kernels_nnparsers.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/api/kernels_nnparsers.cpp`
- **File Name**: `kernels_nnparsers.cpp`
- **File Size**: 1,542 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/api/kernels_nnparsers.cpp](../../../../modules/gapi/src/api/kernels_nnparsers.cpp)
