# Documentation for `modules/gapi/src/api/kernels_ot.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/api/kernels_ot.cpp`
- **File Name**: `kernels_ot.cpp`
- **File Size**: 1,324 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/api/kernels_ot.cpp](../../../../modules/gapi/src/api/kernels_ot.cpp)
