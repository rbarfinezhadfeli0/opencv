# Documentation for `modules/gapi/src/api/kernels_stereo.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/api/kernels_stereo.cpp`
- **File Name**: `kernels_stereo.cpp`
- **File Size**: 500 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/api/kernels_stereo.cpp](../../../../modules/gapi/src/api/kernels_stereo.cpp)
