# Documentation for `modules/gapi/src/api/media.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/api/media.cpp`
- **File Name**: `media.cpp`
- **File Size**: 1,350 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/api/media.cpp](../../../../modules/gapi/src/api/media.cpp)
