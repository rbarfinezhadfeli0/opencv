# Documentation for `modules/gapi/src/api/render_ocv.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/api/render_ocv.cpp`
- **File Name**: `render_ocv.cpp`
- **File Size**: 8,097 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/api/render_ocv.cpp](../../../../modules/gapi/src/api/render_ocv.cpp)
...
- **BGR2YUVConverter**: A class/struct defined in this file
- **EmptyConverter**: A class/struct defined in this file
