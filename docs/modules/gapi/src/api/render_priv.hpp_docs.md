# Documentation for `modules/gapi/src/api/render_priv.hpp`

## File Metadata

- **Full Path**: `modules/gapi/src/api/render_priv.hpp`
- **File Name**: `render_priv.hpp`
- **File Size**: 707 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/src/api/render_priv.hpp](../../../../modules/gapi/src/api/render_priv.hpp)
...
- **OPENCV_RENDER_PRIV_HPP()**: A function/method defined in this file
