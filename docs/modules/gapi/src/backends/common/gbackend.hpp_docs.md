# Documentation for `modules/gapi/src/backends/common/gbackend.hpp`

## File Metadata

- **Full Path**: `modules/gapi/src/backends/common/gbackend.hpp`
- **File Name**: `gbackend.hpp`
- **File Size**: 8,397 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/src/backends/common/gbackend.hpp](../../../../../modules/gapi/src/backends/common/gbackend.hpp)
...
- **magazine**: A class/struct defined in this file
- **HandleRMat**: A class/struct defined in this file
- **RcDesc**: A class/struct defined in this file
- **RMatOnMat**: A class/struct defined in this file
...
- **OPENCV_GAPI_GBACKEND_HPP()**: A function/method defined in this file
