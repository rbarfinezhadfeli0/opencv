# Documentation for `modules/gapi/src/backends/common/serialization.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/backends/common/serialization.cpp`
- **File Name**: `serialization.cpp`
- **File Size**: 33,825 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/backends/common/serialization.cpp](../../../../../modules/gapi/src/backends/common/serialization.cpp)
...
- **putToStream**: A class/struct defined in this file
- **the**: A class/struct defined in this file
- **getFromStream**: A class/struct defined in this file
- **initCtor**: A class/struct defined in this file
