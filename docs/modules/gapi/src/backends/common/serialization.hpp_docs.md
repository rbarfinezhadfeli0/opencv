# Documentation for `modules/gapi/src/backends/common/serialization.hpp`

## File Metadata

- **Full Path**: `modules/gapi/src/backends/common/serialization.hpp`
- **File Name**: `serialization.hpp`
- **File Size**: 10,571 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/src/backends/common/serialization.hpp](../../../../../modules/gapi/src/backends/common/serialization.hpp)
...
- **GSerialized**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_GAPI_COMMON_SERIALIZATION_HPP()**: A function/method defined in this file
