# Documentation for `modules/gapi/src/backends/cpu/gcpubackend.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/backends/cpu/gcpubackend.cpp`
- **File Name**: `gcpubackend.cpp`
- **File Size**: 12,025 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/backends/cpu/gcpubackend.cpp](../../../../../modules/gapi/src/backends/cpu/gcpubackend.cpp)
...
- **GCPUBackendImpl**: A class/struct defined in this file
