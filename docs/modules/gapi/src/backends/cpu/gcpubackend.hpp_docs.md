# Documentation for `modules/gapi/src/backends/cpu/gcpubackend.hpp`

## File Metadata

- **Full Path**: `modules/gapi/src/backends/cpu/gcpubackend.hpp`
- **File Name**: `gcpubackend.hpp`
- **File Size**: 2,385 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/src/backends/cpu/gcpubackend.hpp](../../../../../modules/gapi/src/backends/cpu/gcpubackend.hpp)
...
- **CPUUnit**: A class/struct defined in this file
- **OperationInfo**: A class/struct defined in this file
- **GCPUExecutable**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_GAPI_GCPUBACKEND_HPP()**: A function/method defined in this file
