# Documentation for `modules/gapi/src/backends/cpu/gcpucore.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/backends/cpu/gcpucore.cpp`
- **File Name**: `gcpucore.cpp`
- **File Size**: 20,627 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/backends/cpu/gcpucore.cpp](../../../../../modules/gapi/src/backends/cpu/gcpucore.cpp)
