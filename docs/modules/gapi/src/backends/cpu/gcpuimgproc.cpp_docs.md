# Documentation for `modules/gapi/src/backends/cpu/gcpuimgproc.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/backends/cpu/gcpuimgproc.cpp`
- **File Name**: `gcpuimgproc.cpp`
- **File Size**: 22,433 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/backends/cpu/gcpuimgproc.cpp](../../../../../modules/gapi/src/backends/cpu/gcpuimgproc.cpp)
...
**C++ Includes:**
- `backends/fluid/gfluidimgproc_func.hpp`
