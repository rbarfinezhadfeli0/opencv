# Documentation for `modules/gapi/src/backends/cpu/gnnparsers.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/backends/cpu/gnnparsers.cpp`
- **File Name**: `gnnparsers.cpp`
- **File Size**: 10,199 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/backends/cpu/gnnparsers.cpp](../../../../../modules/gapi/src/backends/cpu/gnnparsers.cpp)
...
- **SSDParser**: A class/struct defined in this file
- **YoloParser**: A class/struct defined in this file
