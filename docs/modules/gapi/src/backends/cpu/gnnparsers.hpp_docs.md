# Documentation for `modules/gapi/src/backends/cpu/gnnparsers.hpp`

## File Metadata

- **Full Path**: `modules/gapi/src/backends/cpu/gnnparsers.hpp`
- **File Name**: `gnnparsers.hpp`
- **File Size**: 1,118 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/src/backends/cpu/gnnparsers.hpp](../../../../../modules/gapi/src/backends/cpu/gnnparsers.hpp)
...
- **OPENCV_NNPARSERS_OCV_HPP()**: A function/method defined in this file
