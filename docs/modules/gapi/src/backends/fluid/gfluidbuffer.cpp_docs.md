# Documentation for `modules/gapi/src/backends/fluid/gfluidbuffer.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/backends/fluid/gfluidbuffer.cpp`
- **File Name**: `gfluidbuffer.cpp`
- **File Size**: 23,469 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/backends/fluid/gfluidbuffer.cpp](../../../../../modules/gapi/src/backends/fluid/gfluidbuffer.cpp)
...
- `backends/fluid/gfluidutils.hpp`
- `precomp.hpp`
