# Documentation for `modules/gapi/src/backends/fluid/gfluidbuffer_priv.hpp`

## File Metadata

- **Full Path**: `modules/gapi/src/backends/fluid/gfluidbuffer_priv.hpp`
- **File Name**: `gfluidbuffer_priv.hpp`
- **File Size**: 9,333 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/src/backends/fluid/gfluidbuffer_priv.hpp](../../../../../modules/gapi/src/backends/fluid/gfluidbuffer_priv.hpp)
...
- **BufferStorageWithoutBorder**: A class/struct defined in this file
- **BorderHandlerT**: A class/struct defined in this file
- **View**: A class/struct defined in this file
- **ViewPrivWithoutOwnBorder**: A class/struct defined in this file
- **BorderHandler**: A class/struct defined in this file
- **BufferStorageWithBorder**: A class/struct defined in this file
- **ViewPrivWithOwnBorder**: A class/struct defined in this file
- **BufferStorage**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_GAPI_FLUID_BUFFER_PRIV_HPP()**: A function/method defined in this file
