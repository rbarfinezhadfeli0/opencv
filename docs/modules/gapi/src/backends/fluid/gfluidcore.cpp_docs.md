# Documentation for `modules/gapi/src/backends/fluid/gfluidcore.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/backends/fluid/gfluidcore.cpp`
- **File Name**: `gfluidcore.cpp`
- **File Size**: 91,463 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/backends/fluid/gfluidcore.cpp](../../../../../modules/gapi/src/backends/fluid/gfluidcore.cpp)
