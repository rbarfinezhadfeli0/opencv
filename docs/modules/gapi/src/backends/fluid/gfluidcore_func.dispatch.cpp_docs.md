# Documentation for `modules/gapi/src/backends/fluid/gfluidcore_func.dispatch.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/backends/fluid/gfluidcore_func.dispatch.cpp`
- **File Name**: `gfluidcore_func.dispatch.cpp`
- **File Size**: 13,330 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/backends/fluid/gfluidcore_func.dispatch.cpp](../../../../../modules/gapi/src/backends/fluid/gfluidcore_func.dispatch.cpp)
...
**C++ Includes:**
- `cmath`
- `gfluidcore_func.simd.hpp`
- `backends/fluid/gfluidcore_func.simd_declarations.hpp`
- `cstdlib`
- `gfluidutils.hpp`
