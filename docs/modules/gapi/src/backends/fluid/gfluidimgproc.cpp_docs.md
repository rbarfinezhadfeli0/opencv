# Documentation for `modules/gapi/src/backends/fluid/gfluidimgproc.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/backends/fluid/gfluidimgproc.cpp`
- **File Name**: `gfluidimgproc.cpp`
- **File Size**: 74,347 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/backends/fluid/gfluidimgproc.cpp](../../../../../modules/gapi/src/backends/fluid/gfluidimgproc.cpp)
...
- **BufHelper**: A class/struct defined in this file
- **MapperUnit**: A class/struct defined in this file
- **Mapper**: A class/struct defined in this file
- **LinearScratchDesc**: A class/struct defined in this file

### Functions and Methods

- **MapperUnit()**: A function/method defined in this file
