# Documentation for `modules/gapi/src/backends/fluid/gfluidimgproc_func.simd.hpp`

## File Metadata

- **Full Path**: `modules/gapi/src/backends/fluid/gfluidimgproc_func.simd.hpp`
- **File Name**: `gfluidimgproc_func.simd.hpp`
- **File Size**: 104,337 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/src/backends/fluid/gfluidimgproc_func.simd.hpp](../../../../../modules/gapi/src/backends/fluid/gfluidimgproc_func.simd.hpp)
...
- **order**: A class/struct defined in this file
