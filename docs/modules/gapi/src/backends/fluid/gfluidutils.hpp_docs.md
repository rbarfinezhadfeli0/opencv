# Documentation for `modules/gapi/src/backends/fluid/gfluidutils.hpp`

## File Metadata

- **Full Path**: `modules/gapi/src/backends/fluid/gfluidutils.hpp`
- **File Name**: `gfluidutils.hpp`
- **File Size**: 4,779 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/src/backends/fluid/gfluidutils.hpp](../../../../../modules/gapi/src/backends/fluid/gfluidutils.hpp)
...
- **GFLUIDUTILS_HPP()**: A function/method defined in this file
