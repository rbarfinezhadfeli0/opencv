# Documentation for `modules/gapi/src/backends/ie/giebackend.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/backends/ie/giebackend.cpp`
- **File Name**: `giebackend.cpp`
- **File Size**: 102,982 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/backends/ie/giebackend.cpp](../../../../../modules/gapi/src/backends/ie/giebackend.cpp)
...
- **Infer**: A class/struct defined in this file
- **InferROI**: A class/struct defined in this file
- **InferList**: A class/struct defined in this file
- **IECallContext**: A class/struct defined in this file
- **which**: A class/struct defined in this file
- **AsyncInferExecutor**: A class/struct defined in this file
- **SyncInferExecutor**: A class/struct defined in this file
- **GIEBackendImpl**: A class/struct defined in this file
- **IECallable**: A class/struct defined in this file
- **cv**: A class/struct defined in this file
- **PostOutputsList**: A class/struct defined in this file
- **Task**: A class/struct defined in this file
- **InferList2**: A class/struct defined in this file
- **Priv**: A class/struct defined in this file
- **MatType**: A class/struct defined in this file
- **IEUnit**: A class/struct defined in this file
- **KImpl**: A class/struct defined in this file
- **InputFramesDesc**: A class/struct defined in this file
- **IInferExecutor**: A class/struct defined in this file
...
- **HANDLE()**: A function/method defined in this file
