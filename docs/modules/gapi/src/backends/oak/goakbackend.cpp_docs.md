# Documentation for `modules/gapi/src/backends/oak/goakbackend.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/backends/oak/goakbackend.cpp`
- **File Name**: `goakbackend.cpp`
- **File Size**: 44,358 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/backends/oak/goakbackend.cpp](../../../../../modules/gapi/src/backends/oak/goakbackend.cpp)
...
- **get_out**: A class/struct defined in this file
- **OutArgs**: A class/struct defined in this file
- **get_in**: A class/struct defined in this file
- **OAKKernelParams**: A class/struct defined in this file
- **K**: A class/struct defined in this file
- **OAKNodeInfo**: A class/struct defined in this file
- **T**: A class/struct defined in this file
- **GOAKBackendImpl**: A class/struct defined in this file
- **Impl**: A class/struct defined in this file
- **OAKOutQueueInfo**: A class/struct defined in this file
- **GOAKContext**: A class/struct defined in this file
- **OAKComponent**: A class/struct defined in this file
- **ExtractTypeHelper**: A class/struct defined in this file
- **GOAKExecutable**: A class/struct defined in this file
- **OAKCallHelper**: A class/struct defined in this file
- **GOAKKernel**: A class/struct defined in this file
- **Name**: A class/struct defined in this file
- **GOAKKernelImpl**: A class/struct defined in this file
- **InArgs**: A class/struct defined in this file

### Functions and Methods

- **for()**: A function/method defined in this file
- **links()**: A function/method defined in this file
