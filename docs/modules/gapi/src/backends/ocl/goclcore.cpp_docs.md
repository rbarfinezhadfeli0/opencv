# Documentation for `modules/gapi/src/backends/ocl/goclcore.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/backends/ocl/goclcore.cpp`
- **File Name**: `goclcore.cpp`
- **File Size**: 18,517 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/backends/ocl/goclcore.cpp](../../../../../modules/gapi/src/backends/ocl/goclcore.cpp)
