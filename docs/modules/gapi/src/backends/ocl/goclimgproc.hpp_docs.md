# Documentation for `modules/gapi/src/backends/ocl/goclimgproc.hpp`

## File Metadata

- **Full Path**: `modules/gapi/src/backends/ocl/goclimgproc.hpp`
- **File Name**: `goclimgproc.hpp`
- **File Size**: 610 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/src/backends/ocl/goclimgproc.hpp](../../../../../modules/gapi/src/backends/ocl/goclimgproc.hpp)
...
- **OPENCV_GAPI_GOCLIMGPROC_HPP()**: A function/method defined in this file
