# Documentation for `modules/gapi/src/backends/onnx/coreml_ep.hpp`

## File Metadata

- **Full Path**: `modules/gapi/src/backends/onnx/coreml_ep.hpp`
- **File Name**: `coreml_ep.hpp`
- **File Size**: 659 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/src/backends/onnx/coreml_ep.hpp](../../../../../modules/gapi/src/backends/onnx/coreml_ep.hpp)
...
- **OPENCV_GAPI_COREML_EP_HPP()**: A function/method defined in this file
