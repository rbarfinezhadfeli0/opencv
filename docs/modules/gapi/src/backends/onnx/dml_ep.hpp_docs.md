# Documentation for `modules/gapi/src/backends/onnx/dml_ep.hpp`

## File Metadata

- **Full Path**: `modules/gapi/src/backends/onnx/dml_ep.hpp`
- **File Name**: `dml_ep.hpp`
- **File Size**: 643 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/src/backends/onnx/dml_ep.hpp](../../../../../modules/gapi/src/backends/onnx/dml_ep.hpp)
...
- **OPENCV_GAPI_DML_EP_HPP()**: A function/method defined in this file
