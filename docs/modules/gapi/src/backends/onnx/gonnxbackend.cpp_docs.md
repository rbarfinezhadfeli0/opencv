# Documentation for `modules/gapi/src/backends/onnx/gonnxbackend.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/backends/onnx/gonnxbackend.cpp`
- **File Name**: `gonnxbackend.cpp`
- **File Size**: 55,766 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/backends/onnx/gonnxbackend.cpp](../../../../../modules/gapi/src/backends/onnx/gonnxbackend.cpp)
...
- **ONNXCallable**: A class/struct defined in this file
- **KImpl**: A class/struct defined in this file
- **GONNXBackendImpl**: A class/struct defined in this file
- **Infer**: A class/struct defined in this file
- **ONNXCompiled**: A class/struct defined in this file
- **TensorInfo**: A class/struct defined in this file
- **MeanStdev**: A class/struct defined in this file
...
- **ONNXUnit**: A class/struct defined in this file
- **ONNXCallContext**: A class/struct defined in this file
...
- `backends/onnx/gonnxbackend.hpp`
