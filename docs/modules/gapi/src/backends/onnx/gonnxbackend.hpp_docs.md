# Documentation for `modules/gapi/src/backends/onnx/gonnxbackend.hpp`

## File Metadata

- **Full Path**: `modules/gapi/src/backends/onnx/gonnxbackend.hpp`
- **File Name**: `gonnxbackend.hpp`
- **File Size**: 1,613 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/src/backends/onnx/gonnxbackend.hpp](../../../../../modules/gapi/src/backends/onnx/gonnxbackend.hpp)
...
- **GONNXExecutable**: A class/struct defined in this file

### Functions and Methods

- **HAVE_ONNX()**: A function/method defined in this file
- **OPENCV_GAPI_GONNXBACKEND_HPP()**: A function/method defined in this file
