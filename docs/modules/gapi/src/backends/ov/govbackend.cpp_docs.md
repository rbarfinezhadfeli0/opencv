# Documentation for `modules/gapi/src/backends/ov/govbackend.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/backends/ov/govbackend.cpp`
- **File Name**: `govbackend.cpp`
- **File Size**: 69,915 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/backends/ov/govbackend.cpp](../../../../../modules/gapi/src/backends/ov/govbackend.cpp)
...
- **OVUnit**: A class/struct defined in this file
- **PostOutputsList**: A class/struct defined in this file
- **InferROI**: A class/struct defined in this file
- **GOVBackendImpl**: A class/struct defined in this file
- **PrePostProcWrapper**: A class/struct defined in this file
- **InferList**: A class/struct defined in this file
- **which**: A class/struct defined in this file
- **OVCallable**: A class/struct defined in this file
- **Priv**: A class/struct defined in this file
- **OVCallContext**: A class/struct defined in this file
