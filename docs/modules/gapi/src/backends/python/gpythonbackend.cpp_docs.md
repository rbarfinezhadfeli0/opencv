# Documentation for `modules/gapi/src/backends/python/gpythonbackend.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/backends/python/gpythonbackend.cpp`
- **File Name**: `gpythonbackend.cpp`
- **File Size**: 9,497 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/backends/python/gpythonbackend.cpp](../../../../../modules/gapi/src/backends/python/gpythonbackend.cpp)

## Purpose and Role

This file is located in the `modules/gapi/src/backends/python` directory and serves as part of the OpenCV library infrastructure.
...
- **PythonUnit**: A class/struct defined in this file
- **GPythonBackendImpl**: A class/struct defined in this file
- **GPythonExecutable**: A class/struct defined in this file
