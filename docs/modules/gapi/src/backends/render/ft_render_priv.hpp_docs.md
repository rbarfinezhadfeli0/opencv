# Documentation for `modules/gapi/src/backends/render/ft_render_priv.hpp`

## File Metadata

- **Full Path**: `modules/gapi/src/backends/render/ft_render_priv.hpp`
- **File Name**: `ft_render_priv.hpp`
- **File Size**: 932 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/src/backends/render/ft_render_priv.hpp](../../../../../modules/gapi/src/backends/render/ft_render_priv.hpp)
...
- **FTTextRender**: A class/struct defined in this file

### Functions and Methods

- **HAVE_FREETYPE()**: A function/method defined in this file
- **OPENCV_FT_RENDER_PRIV_HPP()**: A function/method defined in this file
