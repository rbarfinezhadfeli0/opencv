# Documentation for `modules/gapi/src/backends/streaming/gstreamingbackend.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/backends/streaming/gstreamingbackend.cpp`
- **File Name**: `gstreamingbackend.cpp`
- **File Size**: 16,624 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/backends/streaming/gstreamingbackend.cpp](../../../../../modules/gapi/src/backends/streaming/gstreamingbackend.cpp)
...
- **Actor**: A class/struct defined in this file
- **StreamingCreateFunction**: A class/struct defined in this file
- **GAccessorActorBase**: A class/struct defined in this file
- **GOCVBGR**: A class/struct defined in this file
- **Copy**: A class/struct defined in this file
- **GOCVY**: A class/struct defined in this file
- **GStreamingBackendImpl**: A class/struct defined in this file
- **GStreamingIntrinExecutable**: A class/struct defined in this file
- **GOCVUV**: A class/struct defined in this file
