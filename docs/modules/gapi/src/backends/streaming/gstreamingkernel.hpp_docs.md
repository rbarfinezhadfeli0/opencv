# Documentation for `modules/gapi/src/backends/streaming/gstreamingkernel.hpp`

## File Metadata

- **Full Path**: `modules/gapi/src/backends/streaming/gstreamingkernel.hpp`
- **File Name**: `gstreamingkernel.hpp`
- **File Size**: 959 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/src/backends/streaming/gstreamingkernel.hpp](../../../../../modules/gapi/src/backends/streaming/gstreamingkernel.hpp)
...
- **IActor**: A class/struct defined in this file
- **GStreamingKernel**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_GAPI_GSTREAMINGKERNEL_HPP()**: A function/method defined in this file
