# Documentation for `modules/gapi/src/compiler/gcompiler.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/compiler/gcompiler.cpp`
- **File Name**: `gcompiler.cpp`
- **File Size**: 22,293 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/compiler/gcompiler.cpp](../../../../modules/gapi/src/compiler/gcompiler.cpp)
...
**C++ Includes:**
- `executor/gthreadedexecutor.hpp`
