# Documentation for `modules/gapi/src/compiler/gislandmodel.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/compiler/gislandmodel.cpp`
- **File Name**: `gislandmodel.cpp`
- **File Size**: 16,116 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/compiler/gislandmodel.cpp](../../../../modules/gapi/src/compiler/gislandmodel.cpp)
