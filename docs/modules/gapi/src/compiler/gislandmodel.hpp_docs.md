# Documentation for `modules/gapi/src/compiler/gislandmodel.hpp`

## File Metadata

- **Full Path**: `modules/gapi/src/compiler/gislandmodel.hpp`
- **File Name**: `gislandmodel.hpp`
- **File Size**: 10,830 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/src/compiler/gislandmodel.hpp](../../../../modules/gapi/src/compiler/gislandmodel.hpp)
...
- **Emitter**: A class/struct defined in this file
- **GIslandEmitter**: A class/struct defined in this file
- **will**: A class/struct defined in this file
- **NodeKind**: A class/struct defined in this file
- **IODesc**: A class/struct defined in this file
- **IInput**: A class/struct defined in this file
- **GIslandExecutable**: A class/struct defined in this file
- **DesyncIslEdge**: A class/struct defined in this file
- **IslandsCompiled**: A class/struct defined in this file
- **EndOfStream**: A class/struct defined in this file
- **doesn**: A class/struct defined in this file
- **Sink**: A class/struct defined in this file
- **IOutput**: A class/struct defined in this file
- **GAPI_EXPORTS**: A class/struct defined in this file
- **IslandExec**: A class/struct defined in this file
- **DataSlot**: A class/struct defined in this file
- **comes**: A class/struct defined in this file
- **FusedIsland**: A class/struct defined in this file
- **Exception**: A class/struct defined in this file

### Functions and Methods

- **void()**: A function/method defined in this file
- **OPENCV_GAPI_GISLANDMODEL_HPP()**: A function/method defined in this file
