# Documentation for `modules/gapi/src/compiler/gobjref.hpp`

## File Metadata

- **Full Path**: `modules/gapi/src/compiler/gobjref.hpp`
- **File Name**: `gobjref.hpp`
- **File Size**: 1,440 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/src/compiler/gobjref.hpp](../../../../modules/gapi/src/compiler/gobjref.hpp)
...
- **OPENCV_GAPI_GOBJREF_HPP()**: A function/method defined in this file
