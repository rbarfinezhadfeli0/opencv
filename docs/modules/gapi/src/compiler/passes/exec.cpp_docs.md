# Documentation for `modules/gapi/src/compiler/passes/exec.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/compiler/passes/exec.cpp`
- **File Name**: `exec.cpp`
- **File Size**: 29,878 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/compiler/passes/exec.cpp](../../../../../modules/gapi/src/compiler/passes/exec.cpp)
...
- **MergeAction**: A class/struct defined in this file
- **CycleHasher**: A class/struct defined in this file
- **MergeContext**: A class/struct defined in this file
- **MergeObjects**: A class/struct defined in this file

### Functions and Methods

- **DEBUG_MERGE()**: A function/method defined in this file
