# Documentation for `modules/gapi/src/compiler/passes/intrin.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/compiler/passes/intrin.cpp`
- **File Name**: `intrin.cpp`
- **File Size**: 12,042 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/compiler/passes/intrin.cpp](../../../../../modules/gapi/src/compiler/passes/intrin.cpp)
...
- **propagates()**: A function/method defined in this file
