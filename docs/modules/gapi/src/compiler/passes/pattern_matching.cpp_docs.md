# Documentation for `modules/gapi/src/compiler/passes/pattern_matching.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/compiler/passes/pattern_matching.cpp`
- **File Name**: `pattern_matching.cpp`
- **File Size**: 26,792 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/compiler/passes/pattern_matching.cpp](../../../../../modules/gapi/src/compiler/passes/pattern_matching.cpp)
