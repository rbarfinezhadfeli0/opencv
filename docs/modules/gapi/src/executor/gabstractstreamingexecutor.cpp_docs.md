# Documentation for `modules/gapi/src/executor/gabstractstreamingexecutor.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/executor/gabstractstreamingexecutor.cpp`
- **File Name**: `gabstractstreamingexecutor.cpp`
- **File Size**: 870 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/executor/gabstractstreamingexecutor.cpp](../../../../modules/gapi/src/executor/gabstractstreamingexecutor.cpp)
