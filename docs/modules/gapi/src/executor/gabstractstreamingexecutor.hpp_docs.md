# Documentation for `modules/gapi/src/executor/gabstractstreamingexecutor.hpp`

## File Metadata

- **Full Path**: `modules/gapi/src/executor/gabstractstreamingexecutor.hpp`
- **File Name**: `gabstractstreamingexecutor.hpp`
- **File Size**: 1,503 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/src/executor/gabstractstreamingexecutor.hpp](../../../../modules/gapi/src/executor/gabstractstreamingexecutor.hpp)
...
- **GAbstractStreamingExecutor**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_GAPI_GABSTRACT_STREAMING_EXECUTOR_HPP()**: A function/method defined in this file
