# Documentation for `modules/gapi/src/executor/gasync.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/executor/gasync.cpp`
- **File Name**: `gasync.cpp`
- **File Size**: 8,604 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/executor/gasync.cpp](../../../../modules/gapi/src/executor/gasync.cpp)
...
- **async_service**: A class/struct defined in this file
- **DummyContext**: A class/struct defined in this file
