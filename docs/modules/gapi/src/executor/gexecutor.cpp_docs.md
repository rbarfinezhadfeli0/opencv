# Documentation for `modules/gapi/src/executor/gexecutor.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/executor/gexecutor.cpp`
- **File Name**: `gexecutor.cpp`
- **File Size**: 15,534 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/executor/gexecutor.cpp](../../../../modules/gapi/src/executor/gexecutor.cpp)
