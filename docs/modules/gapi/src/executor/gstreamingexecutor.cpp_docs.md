# Documentation for `modules/gapi/src/executor/gstreamingexecutor.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/executor/gstreamingexecutor.cpp`
- **File Name**: `gstreamingexecutor.cpp`
- **File Size**: 78,585 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/executor/gstreamingexecutor.cpp](../../../../modules/gapi/src/executor/gstreamingexecutor.cpp)
...
- **StreamingOutput**: A class/struct defined in this file
- **C**: A class/struct defined in this file
- **StreamingInput**: A class/struct defined in this file
- **cv**: A class/struct defined in this file
- **DataQueue**: A class/struct defined in this file
- **QueueReader**: A class/struct defined in this file
- **Posting**: A class/struct defined in this file
- **ConstEmitter**: A class/struct defined in this file
- **VideoEmitter**: A class/struct defined in this file
- **which**: A class/struct defined in this file
- **DesyncSpecialCase**: A class/struct defined in this file

### Functions and Methods

- **from()**: A function/method defined in this file
- **HANDLE_CASE()**: A function/method defined in this file
...
- `backends/streaming/gstreamingbackend.hpp`
- `opencv2/gapi/opencv_includes.hpp`
- `compiler/gcompiler.hpp`
- `executor/gstreamingexecutor.hpp`
