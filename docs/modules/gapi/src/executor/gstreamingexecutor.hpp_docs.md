# Documentation for `modules/gapi/src/executor/gstreamingexecutor.hpp`

## File Metadata

- **Full Path**: `modules/gapi/src/executor/gstreamingexecutor.hpp`
- **File Name**: `gstreamingexecutor.hpp`
- **File Size**: 6,824 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/src/executor/gstreamingexecutor.hpp](../../../../modules/gapi/src/executor/gstreamingexecutor.hpp)
...
- **Start**: A class/struct defined in this file
- **Kind**: A class/struct defined in this file
- **Stop**: A class/struct defined in this file
- **is**: A class/struct defined in this file
- **DesyncQueue**: A class/struct defined in this file
- **DataDesc**: A class/struct defined in this file
- **SyncQueue**: A class/struct defined in this file
- **GStreamingExecutor**: A class/struct defined in this file
- **OpDesc**: A class/struct defined in this file
- **CollectorThreadInfo**: A class/struct defined in this file
- **Q**: A class/struct defined in this file
- **State**: A class/struct defined in this file
- **Result**: A class/struct defined in this file
- **Synchronizer**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_GAPI_GSTREAMING_EXECUTOR_HPP()**: A function/method defined in this file
