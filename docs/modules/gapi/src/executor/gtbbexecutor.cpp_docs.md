# Documentation for `modules/gapi/src/executor/gtbbexecutor.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/executor/gtbbexecutor.cpp`
- **File Name**: `gtbbexecutor.cpp`
- **File Size**: 17,229 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/executor/gtbbexecutor.cpp](../../../../modules/gapi/src/executor/gtbbexecutor.cpp)
...
- **root_wait_lock_t**: A class/struct defined in this file
- **use_tbb_scheduler_bypass**: A class/struct defined in this file
- **destroy_tbb_task**: A class/struct defined in this file
- **root_decrement_ref_count**: A class/struct defined in this file
- **wake_tbb_master**: A class/struct defined in this file
- **async_tasks_t**: A class/struct defined in this file
- **task_body**: A class/struct defined in this file
- **sleep_unlock**: A class/struct defined in this file
- **exec_ctx**: A class/struct defined in this file
- **functor_task**: A class/struct defined in this file
- **is_tbb_work_present**: A class/struct defined in this file
- **master_thread_sleep_lock_t**: A class/struct defined in this file
