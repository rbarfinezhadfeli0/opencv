# Documentation for `modules/gapi/src/executor/gthreadedexecutor.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/executor/gthreadedexecutor.cpp`
- **File Name**: `gthreadedexecutor.cpp`
- **File Size**: 19,175 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/executor/gthreadedexecutor.cpp](../../../../modules/gapi/src/executor/gthreadedexecutor.cpp)
