# Documentation for `modules/gapi/src/executor/gthreadedexecutor.hpp`

## File Metadata

- **Full Path**: `modules/gapi/src/executor/gthreadedexecutor.hpp`
- **File Name**: `gthreadedexecutor.hpp`
- **File Size**: 3,414 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/src/executor/gthreadedexecutor.hpp](../../../../modules/gapi/src/executor/gthreadedexecutor.hpp)
...
- **TaskManager**: A class/struct defined in this file
- **GraphState**: A class/struct defined in this file
- **GThreadedExecutor**: A class/struct defined in this file
- **Output**: A class/struct defined in this file
- **Input**: A class/struct defined in this file
- **IslandActor**: A class/struct defined in this file
- **Task**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_GAPI_GTHREADEDEXECUTOR_HPP()**: A function/method defined in this file
