# Documentation for `modules/gapi/src/executor/thread_pool.hpp`

## File Metadata

- **Full Path**: `modules/gapi/src/executor/thread_pool.hpp`
- **File Name**: `thread_pool.hpp`
- **File Size**: 1,747 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/src/executor/thread_pool.hpp](../../../../modules/gapi/src/executor/thread_pool.hpp)
...
- **OPENCV_GAPI_THREAD_POOL_HPP()**: A function/method defined in this file
