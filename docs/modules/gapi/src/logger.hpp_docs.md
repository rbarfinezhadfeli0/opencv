# Documentation for `modules/gapi/src/logger.hpp`

## File Metadata

- **Full Path**: `modules/gapi/src/logger.hpp`
- **File Name**: `logger.hpp`
- **File Size**: 914 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/src/logger.hpp](../../../modules/gapi/src/logger.hpp)
...
- **__OPENCV_GAPI_LOGGER_HPP__()**: A function/method defined in this file
