# Documentation for `modules/gapi/src/streaming/gstreamer/gstreamer_buffer_utils.hpp`

## File Metadata

- **Full Path**: `modules/gapi/src/streaming/gstreamer/gstreamer_buffer_utils.hpp`
- **File Name**: `gstreamer_buffer_utils.hpp`
- **File Size**: 847 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/src/streaming/gstreamer/gstreamer_buffer_utils.hpp](../../../../../modules/gapi/src/streaming/gstreamer/gstreamer_buffer_utils.hpp)
...
- **OPENCV_GAPI_STREAMING_GSTREAMER_GSTREAMER_BUFFER_UTILS_HPP()**: A function/method defined in this file
