# Documentation for `modules/gapi/src/streaming/gstreamer/gstreamerenv.hpp`

## File Metadata

- **Full Path**: `modules/gapi/src/streaming/gstreamer/gstreamerenv.hpp`
- **File Name**: `gstreamerenv.hpp`
- **File Size**: 851 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/src/streaming/gstreamer/gstreamerenv.hpp](../../../../../modules/gapi/src/streaming/gstreamer/gstreamerenv.hpp)
...
- **GStreamerEnv**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_GAPI_STREAMING_GSTREAMER_GSTREAMERENV_HPP()**: A function/method defined in this file
