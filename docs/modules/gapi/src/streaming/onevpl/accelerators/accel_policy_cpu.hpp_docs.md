# Documentation for `modules/gapi/src/streaming/onevpl/accelerators/accel_policy_cpu.hpp`

## File Metadata

- **Full Path**: `modules/gapi/src/streaming/onevpl/accelerators/accel_policy_cpu.hpp`
- **File Name**: `accel_policy_cpu.hpp`
- **File Size**: 1,806 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/src/streaming/onevpl/accelerators/accel_policy_cpu.hpp](../../../../../../modules/gapi/src/streaming/onevpl/accelerators/accel_policy_cpu.hpp)
...
- **GAPI_STREAMING_ONEVPL_ACCELERATORS_ACCEL_POLICY_CPU_HPP()**: A function/method defined in this file
