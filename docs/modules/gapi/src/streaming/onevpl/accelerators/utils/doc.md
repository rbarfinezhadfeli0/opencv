# Documentation for `modules/gapi/src/streaming/onevpl/accelerators/utils/`
...
**Path**: `modules/gapi/src/streaming/onevpl/accelerators/utils/`
**Direct Files**: 3
**Subfolders**: 0
...
- **[shared_lock.cpp](shared_lock.cpp_docs.md)**: CPP file
- **[shared_lock.hpp](shared_lock.hpp_docs.md)**: HPP file
- **[elastic_barrier.hpp](elastic_barrier.hpp_docs.md)**: HPP file
...
- **Parent Folder**: [modules/gapi/src/streaming/onevpl/accelerators/](../accelerators/doc.md)
