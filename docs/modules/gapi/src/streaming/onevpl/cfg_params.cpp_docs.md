# Documentation for `modules/gapi/src/streaming/onevpl/cfg_params.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/streaming/onevpl/cfg_params.cpp`
- **File Name**: `cfg_params.cpp`
- **File Size**: 8,011 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/streaming/onevpl/cfg_params.cpp](../../../../../modules/gapi/src/streaming/onevpl/cfg_params.cpp)
...
- **CfgParam**: A class/struct defined in this file
- **variant_comparator**: A class/struct defined in this file
- **variant_stringifier**: A class/struct defined in this file
