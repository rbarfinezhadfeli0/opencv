# Documentation for `modules/gapi/src/streaming/onevpl/cfg_params_parser.hpp`

## File Metadata

- **Full Path**: `modules/gapi/src/streaming/onevpl/cfg_params_parser.hpp`
- **File Name**: `cfg_params_parser.hpp`
- **File Size**: 1,408 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/src/streaming/onevpl/cfg_params_parser.hpp](../../../../../modules/gapi/src/streaming/onevpl/cfg_params_parser.hpp)
...
- **GAPI_STREAMING_ONEVPL_CFG_PARAM_PARSER_HPP()**: A function/method defined in this file
