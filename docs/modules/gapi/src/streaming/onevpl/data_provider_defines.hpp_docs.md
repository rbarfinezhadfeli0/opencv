# Documentation for `modules/gapi/src/streaming/onevpl/data_provider_defines.hpp`

## File Metadata

- **Full Path**: `modules/gapi/src/streaming/onevpl/data_provider_defines.hpp`
- **File Name**: `data_provider_defines.hpp`
- **File Size**: 814 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/src/streaming/onevpl/data_provider_defines.hpp](../../../../../modules/gapi/src/streaming/onevpl/data_provider_defines.hpp)
...
- **GAPI_STREAMING_ONEVPL_DATA_PROVIDER_DEFINES_HPP()**: A function/method defined in this file
