# Documentation for `modules/gapi/src/streaming/onevpl/data_provider_dispatcher.hpp`

## File Metadata

- **Full Path**: `modules/gapi/src/streaming/onevpl/data_provider_dispatcher.hpp`
- **File Name**: `data_provider_dispatcher.hpp`
- **File Size**: 934 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/src/streaming/onevpl/data_provider_dispatcher.hpp](../../../../../modules/gapi/src/streaming/onevpl/data_provider_dispatcher.hpp)
...
- **GAPI_STREAMING_ONEVPL_DATA_PROVIDER_DISPATCHER_HPP()**: A function/method defined in this file
