# Documentation for `modules/gapi/src/streaming/onevpl/engine/decode/decode_engine_legacy.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/streaming/onevpl/engine/decode/decode_engine_legacy.cpp`
- **File Name**: `decode_engine_legacy.cpp`
- **File Size**: 19,761 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/streaming/onevpl/engine/decode/decode_engine_legacy.cpp](../../../../../../../modules/gapi/src/streaming/onevpl/engine/decode/decode_engine_legacy.cpp)
...
- **detected()**: A function/method defined in this file
