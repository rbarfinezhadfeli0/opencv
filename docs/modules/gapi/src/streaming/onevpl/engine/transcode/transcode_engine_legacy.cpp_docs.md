# Documentation for `modules/gapi/src/streaming/onevpl/engine/transcode/transcode_engine_legacy.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/streaming/onevpl/engine/transcode/transcode_engine_legacy.cpp`
- **File Name**: `transcode_engine_legacy.cpp`
- **File Size**: 23,546 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/streaming/onevpl/engine/transcode/transcode_engine_legacy.cpp](../../../../../../../modules/gapi/src/streaming/onevpl/engine/transcode/transcode_engine_legacy.cpp)
