# Documentation for `modules/gapi/src/streaming/onevpl/source_priv.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/streaming/onevpl/source_priv.cpp`
- **File Name**: `source_priv.cpp`
- **File Size**: 14,420 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/streaming/onevpl/source_priv.cpp](../../../../../modules/gapi/src/streaming/onevpl/source_priv.cpp)
