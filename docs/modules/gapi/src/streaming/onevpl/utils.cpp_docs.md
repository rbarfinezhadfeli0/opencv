# Documentation for `modules/gapi/src/streaming/onevpl/utils.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/streaming/onevpl/utils.cpp`
- **File Name**: `utils.cpp`
- **File Size**: 19,616 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/streaming/onevpl/utils.cpp](../../../../../modules/gapi/src/streaming/onevpl/utils.cpp)
...
- **declared**: A class/struct defined in this file
