# Documentation for `modules/gapi/src/utils/itt.cpp`

## File Metadata

- **Full Path**: `modules/gapi/src/utils/itt.cpp`
- **File Name**: `itt.cpp`
- **File Size**: 559 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/src/utils/itt.cpp](../../../../modules/gapi/src/utils/itt.cpp)
