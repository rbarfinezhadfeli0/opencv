# Documentation for `modules/gapi/test/common/gapi_compoundkernel_tests.cpp`

## File Metadata

- **Full Path**: `modules/gapi/test/common/gapi_compoundkernel_tests.cpp`
- **File Name**: `gapi_compoundkernel_tests.cpp`
- **File Size**: 19,502 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/test/common/gapi_compoundkernel_tests.cpp](../../../../modules/gapi/test/common/gapi_compoundkernel_tests.cpp)
