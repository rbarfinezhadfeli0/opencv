# Documentation for `modules/gapi/test/common/gapi_core_tests_common.hpp`

## File Metadata

- **Full Path**: `modules/gapi/test/common/gapi_core_tests_common.hpp`
- **File Name**: `gapi_core_tests_common.hpp`
- **File Size**: 7,831 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/test/common/gapi_core_tests_common.hpp](../../../../modules/gapi/test/common/gapi_core_tests_common.hpp)
...
- **OPENCV_GAPI_CORE_TESTS_COMMON_HPP()**: A function/method defined in this file
