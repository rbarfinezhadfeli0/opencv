# Documentation for `modules/gapi/test/common/gapi_core_tests_inl.hpp`

## File Metadata

- **Full Path**: `modules/gapi/test/common/gapi_core_tests_inl.hpp`
- **File Name**: `gapi_core_tests_inl.hpp`
- **File Size**: 62,324 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/test/common/gapi_core_tests_inl.hpp](../../../../modules/gapi/test/common/gapi_core_tests_inl.hpp)
...
- **OPENCV_GAPI_CORE_TESTS_INL_HPP()**: A function/method defined in this file
