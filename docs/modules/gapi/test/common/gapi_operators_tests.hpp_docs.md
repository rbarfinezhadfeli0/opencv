# Documentation for `modules/gapi/test/common/gapi_operators_tests.hpp`

## File Metadata

- **Full Path**: `modules/gapi/test/common/gapi_operators_tests.hpp`
- **File Name**: `gapi_operators_tests.hpp`
- **File Size**: 10,873 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/test/common/gapi_operators_tests.hpp](../../../../modules/gapi/test/common/gapi_operators_tests.hpp)
...
- **g_api_ocv_pair_mat_scalar**: A class/struct defined in this file
- **g_api_ocv_pair_mat_mat**: A class/struct defined in this file

### Functions and Methods

- **CASE()**: A function/method defined in this file
- **OPENCV_GAPI_OPERATOR_TESTS_COMMON_HPP()**: A function/method defined in this file
