# Documentation for `modules/gapi/test/common/gapi_parsers_tests_common.hpp`

## File Metadata

- **Full Path**: `modules/gapi/test/common/gapi_parsers_tests_common.hpp`
- **File Name**: `gapi_parsers_tests_common.hpp`
- **File Size**: 13,408 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/test/common/gapi_parsers_tests_common.hpp](../../../../modules/gapi/test/common/gapi_parsers_tests_common.hpp)
...
- **ParserSSDTest**: A class/struct defined in this file
- **YoloParams**: A class/struct defined in this file
- **SSDitem**: A class/struct defined in this file
- **ParserYoloTest**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_GAPI_PARSERS_TESTS_COMMON_HPP()**: A function/method defined in this file
