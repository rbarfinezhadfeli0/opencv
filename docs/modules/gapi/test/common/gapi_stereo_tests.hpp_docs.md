# Documentation for `modules/gapi/test/common/gapi_stereo_tests.hpp`

## File Metadata

- **Full Path**: `modules/gapi/test/common/gapi_stereo_tests.hpp`
- **File Name**: `gapi_stereo_tests.hpp`
- **File Size**: 866 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/test/common/gapi_stereo_tests.hpp](../../../../modules/gapi/test/common/gapi_stereo_tests.hpp)
...
- **OPENCV_GAPI_STEREO_TESTS_HPP()**: A function/method defined in this file
