# Documentation for `modules/gapi/test/common/gapi_tests_common.hpp`

## File Metadata

- **Full Path**: `modules/gapi/test/common/gapi_tests_common.hpp`
- **File Name**: `gapi_tests_common.hpp`
- **File Size**: 38,340 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/test/common/gapi_tests_common.hpp](../../../../modules/gapi/test/common/gapi_tests_common.hpp)
...
- **CompareF**: A class/struct defined in this file
- **ToleranceColor**: A class/struct defined in this file
- **Pt**: A class/struct defined in this file
- **MatType2**: A class/struct defined in this file
- **TestWithParams**: A class/struct defined in this file
- **RelDiffToleranceVec**: A class/struct defined in this file
- **AbsTolerance**: A class/struct defined in this file
- **TestWithParamsBase**: A class/struct defined in this file
- **Tolerance_FloatRel_IntAbs**: A class/struct defined in this file
- **AbsExact**: A class/struct defined in this file
- **WrappableVec**: A class/struct defined in this file
- **AbsExactVector**: A class/struct defined in this file
- **TestWithParamsSpecific**: A class/struct defined in this file
- **TestPerfParams**: A class/struct defined in this file
- **T**: A class/struct defined in this file
- **AbsToleranceScalar**: A class/struct defined in this file
- **WrappableRect**: A class/struct defined in this file
- **ToleranceFilter**: A class/struct defined in this file
- **Fixture**: A class/struct defined in this file
- **ParamsBase**: A class/struct defined in this file
- **for**: A class/struct defined in this file
- **Wrappable**: A class/struct defined in this file
- **IoUToleranceRect**: A class/struct defined in this file
- **API**: A class/struct defined in this file
- **Params**: A class/struct defined in this file
- **ParamsSpecific**: A class/struct defined in this file
- **WrappableScalar**: A class/struct defined in this file
- **TestFunctional**: A class/struct defined in this file
- **WrappableVector**: A class/struct defined in this file
- **AbsSimilarPoints**: A class/struct defined in this file
- **and**: A class/struct defined in this file

### Functions and Methods

- **CASE()**: A function/method defined in this file
- **intended()**: A function/method defined in this file
- **OPENCV_GAPI_TESTS_COMMON_HPP()**: A function/method defined in this file
