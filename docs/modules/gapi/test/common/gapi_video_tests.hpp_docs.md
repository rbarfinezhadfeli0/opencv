# Documentation for `modules/gapi/test/common/gapi_video_tests.hpp`

## File Metadata

- **Full Path**: `modules/gapi/test/common/gapi_video_tests.hpp`
- **File Name**: `gapi_video_tests.hpp`
- **File Size**: 2,194 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/test/common/gapi_video_tests.hpp](../../../../modules/gapi/test/common/gapi_video_tests.hpp)
...
- **OPENCV_GAPI_VIDEO_TESTS_HPP()**: A function/method defined in this file
