# Documentation for `modules/gapi/test/common/gapi_video_tests_inl.hpp`

## File Metadata

- **Full Path**: `modules/gapi/test/common/gapi_video_tests_inl.hpp`
- **File Name**: `gapi_video_tests_inl.hpp`
- **File Size**: 11,349 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/test/common/gapi_video_tests_inl.hpp](../../../../modules/gapi/test/common/gapi_video_tests_inl.hpp)
...
- **OPENCV_GAPI_VIDEO_TESTS_INL_HPP()**: A function/method defined in this file
