# Documentation for `modules/gapi/test/cpu/gapi_core_tests_cpu.cpp`

## File Metadata

- **Full Path**: `modules/gapi/test/cpu/gapi_core_tests_cpu.cpp`
- **File Name**: `gapi_core_tests_cpu.cpp`
- **File Size**: 25,428 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/test/cpu/gapi_core_tests_cpu.cpp](../../../../modules/gapi/test/cpu/gapi_core_tests_cpu.cpp)
