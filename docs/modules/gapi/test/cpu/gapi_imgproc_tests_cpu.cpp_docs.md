# Documentation for `modules/gapi/test/cpu/gapi_imgproc_tests_cpu.cpp`

## File Metadata

- **Full Path**: `modules/gapi/test/cpu/gapi_imgproc_tests_cpu.cpp`
- **File Name**: `gapi_imgproc_tests_cpu.cpp`
- **File Size**: 29,115 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/test/cpu/gapi_imgproc_tests_cpu.cpp](../../../../modules/gapi/test/cpu/gapi_imgproc_tests_cpu.cpp)
