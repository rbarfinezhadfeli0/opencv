# Documentation for `modules/gapi/test/cpu/gapi_ocv_stateful_kernel_test_utils.hpp`

## File Metadata

- **Full Path**: `modules/gapi/test/cpu/gapi_ocv_stateful_kernel_test_utils.hpp`
- **File Name**: `gapi_ocv_stateful_kernel_test_utils.hpp`
- **File Size**: 1,571 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/test/cpu/gapi_ocv_stateful_kernel_test_utils.hpp](../../../../modules/gapi/test/cpu/gapi_ocv_stateful_kernel_test_utils.hpp)
...
- **UserStruct**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_GAPI_OCV_STATEFUL_KERNEL_TESTS_UTILS_HPP()**: A function/method defined in this file
