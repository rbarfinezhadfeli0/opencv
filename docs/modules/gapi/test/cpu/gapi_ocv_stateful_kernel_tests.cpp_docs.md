# Documentation for `modules/gapi/test/cpu/gapi_ocv_stateful_kernel_tests.cpp`

## File Metadata

- **Full Path**: `modules/gapi/test/cpu/gapi_ocv_stateful_kernel_tests.cpp`
- **File Name**: `gapi_ocv_stateful_kernel_tests.cpp`
- **File Size**: 22,558 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/test/cpu/gapi_ocv_stateful_kernel_tests.cpp](../../../../modules/gapi/test/cpu/gapi_ocv_stateful_kernel_tests.cpp)
...
- **SetupStateTypedTest**: A class/struct defined in this file
- **StateInitOnce**: A class/struct defined in this file
- **BackSubStateParams**: A class/struct defined in this file
- **CountStateSetupsParams**: A class/struct defined in this file
