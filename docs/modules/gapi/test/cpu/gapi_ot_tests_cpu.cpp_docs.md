# Documentation for `modules/gapi/test/cpu/gapi_ot_tests_cpu.cpp`

## File Metadata

- **Full Path**: `modules/gapi/test/cpu/gapi_ot_tests_cpu.cpp`
- **File Name**: `gapi_ot_tests_cpu.cpp`
- **File Size**: 11,539 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/test/cpu/gapi_ot_tests_cpu.cpp](../../../../modules/gapi/test/cpu/gapi_ot_tests_cpu.cpp)
...
- **FrameDetectionsParams**: A class/struct defined in this file
- **TrackerReferenceParams**: A class/struct defined in this file
- **TrackerReference**: A class/struct defined in this file
- **FrameDetections**: A class/struct defined in this file
