# Documentation for `modules/gapi/test/gapi_basic_hetero_tests.cpp`

## File Metadata

- **Full Path**: `modules/gapi/test/gapi_basic_hetero_tests.cpp`
- **File Name**: `gapi_basic_hetero_tests.cpp`
- **File Size**: 9,109 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/test/gapi_basic_hetero_tests.cpp](../../../modules/gapi/test/gapi_basic_hetero_tests.cpp)
...
- **GAPIHeteroTest**: A class/struct defined in this file
- **GAPIBigHeteroTest**: A class/struct defined in this file
