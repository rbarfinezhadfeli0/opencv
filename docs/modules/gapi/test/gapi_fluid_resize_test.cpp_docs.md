# Documentation for `modules/gapi/test/gapi_fluid_resize_test.cpp`

## File Metadata

- **Full Path**: `modules/gapi/test/gapi_fluid_resize_test.cpp`
- **File Name**: `gapi_fluid_resize_test.cpp`
- **File Size**: 38,886 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/test/gapi_fluid_resize_test.cpp](../../../modules/gapi/test/gapi_fluid_resize_test.cpp)
...
- **NV12PlusResizeTest**: A class/struct defined in this file
- **Resize**: A class/struct defined in this file
- **FResize**: A class/struct defined in this file
- **Unit**: A class/struct defined in this file
- **BlursAfterResizeTest**: A class/struct defined in this file
- **Preproc4lpiTest**: A class/struct defined in this file
- **Mapper**: A class/struct defined in this file
- **ResizeTestFluid**: A class/struct defined in this file
- **ResizeAndAnotherReaderTest**: A class/struct defined in this file

### Functions and Methods

- **RESIZE_SWITCH()**: A function/method defined in this file
- **RESIZE_CASE()**: A function/method defined in this file
- **constexpr()**: A function/method defined in this file
- **ADD_RESIZE_KERNEL_WITH_LPI()**: A function/method defined in this file
