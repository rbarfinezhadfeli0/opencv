# Documentation for `modules/gapi/test/gapi_fluid_test.cpp`

## File Metadata

- **Full Path**: `modules/gapi/test/gapi_fluid_test.cpp`
- **File Name**: `gapi_fluid_test.cpp`
- **File Size**: 29,934 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/test/gapi_fluid_test.cpp](../../../modules/gapi/test/gapi_fluid_test.cpp)
...
- **InputImageBorderTest**: A class/struct defined in this file
- **TwoReadersTest**: A class/struct defined in this file
- **TwoBlursTest**: A class/struct defined in this file
- **SequenceOfBlursTest**: A class/struct defined in this file
- **NV12RoiTest**: A class/struct defined in this file
- **LPISequenceTest**: A class/struct defined in this file
