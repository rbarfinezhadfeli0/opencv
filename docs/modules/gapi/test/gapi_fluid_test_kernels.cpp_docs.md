# Documentation for `modules/gapi/test/gapi_fluid_test_kernels.cpp`

## File Metadata

- **Full Path**: `modules/gapi/test/gapi_fluid_test_kernels.cpp`
- **File Name**: `gapi_fluid_test_kernels.cpp`
- **File Size**: 19,271 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/test/gapi_fluid_test_kernels.cpp](../../../modules/gapi/test/gapi_fluid_test_kernels.cpp)
