# Documentation for `modules/gapi/test/gapi_kernel_tests.cpp`

## File Metadata

- **Full Path**: `modules/gapi/test/gapi_kernel_tests.cpp`
- **File Name**: `gapi_kernel_tests.cpp`
- **File Size**: 16,491 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/test/gapi_kernel_tests.cpp](../../../modules/gapi/test/gapi_kernel_tests.cpp)
...
- **KernelTags**: A class/struct defined in this file
- **HeteroGraph**: A class/struct defined in this file
