# Documentation for `modules/gapi/test/gapi_opaque_tests.cpp`

## File Metadata

- **Full Path**: `modules/gapi/test/gapi_opaque_tests.cpp`
- **File Name**: `gapi_opaque_tests.cpp`
- **File Size**: 9,468 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/test/gapi_opaque_tests.cpp](../../../modules/gapi/test/gapi_opaque_tests.cpp)
