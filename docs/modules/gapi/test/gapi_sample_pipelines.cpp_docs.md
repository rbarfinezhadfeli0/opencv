# Documentation for `modules/gapi/test/gapi_sample_pipelines.cpp`

## File Metadata

- **Full Path**: `modules/gapi/test/gapi_sample_pipelines.cpp`
- **File Name**: `gapi_sample_pipelines.cpp`
- **File Size**: 20,467 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/test/gapi_sample_pipelines.cpp](../../../modules/gapi/test/gapi_sample_pipelines.cpp)
...
- **AddImpl**: A class/struct defined in this file
