# Documentation for `modules/gapi/test/gapi_transform_tests.cpp`

## File Metadata

- **Full Path**: `modules/gapi/test/gapi_transform_tests.cpp`
- **File Name**: `gapi_transform_tests.cpp`
- **File Size**: 10,619 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/test/gapi_transform_tests.cpp](../../../modules/gapi/test/gapi_transform_tests.cpp)
...
- **AnotherCustomType**: A class/struct defined in this file
