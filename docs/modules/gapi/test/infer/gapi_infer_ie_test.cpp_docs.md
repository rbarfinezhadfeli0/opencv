# Documentation for `modules/gapi/test/infer/gapi_infer_ie_test.cpp`

## File Metadata

- **Full Path**: `modules/gapi/test/infer/gapi_infer_ie_test.cpp`
- **File Name**: `gapi_infer_ie_test.cpp`
- **File Size**: 121,120 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/test/infer/gapi_infer_ie_test.cpp](../../../../modules/gapi/test/infer/gapi_infer_ie_test.cpp)
...
- **InferWithReshapeNV12**: A class/struct defined in this file
- **ROIListNV12**: A class/struct defined in this file
- **SingleROINV12**: A class/struct defined in this file
- **LimitedSourceInfer**: A class/struct defined in this file
- **GMockSource**: A class/struct defined in this file
- **TestMediaBGR**: A class/struct defined in this file
- **TestMediaNV12**: A class/struct defined in this file
- **SingleROI**: A class/struct defined in this file
- **InferWithReshape**: A class/struct defined in this file
- **AgeGenderInferTest**: A class/struct defined in this file
- **Sync**: A class/struct defined in this file
- **ROIList**: A class/struct defined in this file
- **GMockMediaAdapter**: A class/struct defined in this file

### Functions and Methods

- **HAVE_NGRAPH()**: A function/method defined in this file
