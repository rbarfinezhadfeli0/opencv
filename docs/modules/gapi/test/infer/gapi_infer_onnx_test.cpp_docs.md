# Documentation for `modules/gapi/test/infer/gapi_infer_onnx_test.cpp`

## File Metadata

- **Full Path**: `modules/gapi/test/infer/gapi_infer_onnx_test.cpp`
- **File Name**: `gapi_infer_onnx_test.cpp`
- **File Size**: 42,881 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/test/infer/gapi_infer_onnx_test.cpp](../../../../modules/gapi/test/infer/gapi_infer_onnx_test.cpp)
...
- **ONNXInitPath**: A class/struct defined in this file
- **ONNXtest**: A class/struct defined in this file
- **ONNXGRayScale**: A class/struct defined in this file
- **ONNXYoloV3**: A class/struct defined in this file
- **TestMediaBGR**: A class/struct defined in this file
- **ONNXWithRemap**: A class/struct defined in this file
- **ONNXMediaFrame**: A class/struct defined in this file
- **ONNXClassification**: A class/struct defined in this file
- **TestMediaNV12**: A class/struct defined in this file
- **ONNXRCNN**: A class/struct defined in this file
