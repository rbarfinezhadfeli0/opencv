# Documentation for `modules/gapi/test/infer/gapi_infer_ov_tests.cpp`

## File Metadata

- **Full Path**: `modules/gapi/test/infer/gapi_infer_ov_tests.cpp`
- **File Name**: `gapi_infer_ov_tests.cpp`
- **File Size**: 33,228 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/test/infer/gapi_infer_ov_tests.cpp](../../../../modules/gapi/test/infer/gapi_infer_ov_tests.cpp)

## Purpose and Role

This file is located in the `modules/gapi/test/infer` directory and serves as part of the OpenCV library infrastructure.
...
- **AGNetTypedParams**: A class/struct defined in this file
- **AGNetTypedComp**: A class/struct defined in this file
- **AGNetROIGenComp**: A class/struct defined in this file
- **ImageInputPreproc**: A class/struct defined in this file
- **TestAgeGenderListOV**: A class/struct defined in this file
- **AGNetGenComp**: A class/struct defined in this file
- **TestMediaBGR**: A class/struct defined in this file
- **AGNetOVCompiled**: A class/struct defined in this file
- **TestMeanScaleOV**: A class/struct defined in this file
- **AGNetList2GenComp**: A class/struct defined in this file
- **TestAgeGenderOV**: A class/struct defined in this file
- **AGNetOVComp**: A class/struct defined in this file
- **TestMediaNV12**: A class/struct defined in this file
- **MediaFrameTestAgeGenderOV**: A class/struct defined in this file
- **AGNetListGenComp**: A class/struct defined in this file
- **AGNetGenParams**: A class/struct defined in this file
- **BaseAgeGenderOV**: A class/struct defined in this file
