# Documentation for `modules/gapi/test/infer/gapi_infer_tests.cpp`

## File Metadata

- **Full Path**: `modules/gapi/test/infer/gapi_infer_tests.cpp`
- **File Name**: `gapi_infer_tests.cpp`
- **File Size**: 3,296 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/test/infer/gapi_infer_tests.cpp](../../../../modules/gapi/test/infer/gapi_infer_tests.cpp)
