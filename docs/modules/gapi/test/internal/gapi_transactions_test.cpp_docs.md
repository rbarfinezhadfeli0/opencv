# Documentation for `modules/gapi/test/internal/gapi_transactions_test.cpp`

## File Metadata

- **Full Path**: `modules/gapi/test/internal/gapi_transactions_test.cpp`
- **File Name**: `gapi_transactions_test.cpp`
- **File Size**: 10,137 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/test/internal/gapi_transactions_test.cpp](../../../../modules/gapi/test/internal/gapi_transactions_test.cpp)
...
- **MetaInt**: A class/struct defined in this file
- **Transactions**: A class/struct defined in this file
- **MetaStr**: A class/struct defined in this file
- **SimpleGraph**: A class/struct defined in this file
