# Documentation for `modules/gapi/test/opencl_kernels_test_gapi.hpp`

## File Metadata

- **Full Path**: `modules/gapi/test/opencl_kernels_test_gapi.hpp`
- **File Name**: `opencl_kernels_test_gapi.hpp`
- **File Size**: 11,718 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/gapi/test/opencl_kernels_test_gapi.hpp](../../../modules/gapi/test/opencl_kernels_test_gapi.hpp)
