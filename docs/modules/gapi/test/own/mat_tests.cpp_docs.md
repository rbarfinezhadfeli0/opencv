# Documentation for `modules/gapi/test/own/mat_tests.cpp`

## File Metadata

- **Full Path**: `modules/gapi/test/own/mat_tests.cpp`
- **File Name**: `mat_tests.cpp`
- **File Size**: 18,829 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/test/own/mat_tests.cpp](../../../../modules/gapi/test/own/mat_tests.cpp)
...
- **OwnMatMoveSemantics**: A class/struct defined in this file
- **OwnMatSharedSemantics**: A class/struct defined in this file
- **NonEmptyMat**: A class/struct defined in this file
- **OwnMatNonOwningView**: A class/struct defined in this file
