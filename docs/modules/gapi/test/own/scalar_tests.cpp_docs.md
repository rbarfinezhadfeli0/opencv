# Documentation for `modules/gapi/test/own/scalar_tests.cpp`

## File Metadata

- **Full Path**: `modules/gapi/test/own/scalar_tests.cpp`
- **File Name**: `scalar_tests.cpp`
- **File Size**: 859 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/test/own/scalar_tests.cpp](../../../../modules/gapi/test/own/scalar_tests.cpp)
