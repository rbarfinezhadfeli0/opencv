# Documentation for `modules/gapi/test/render/gapi_render_tests_ocv.cpp`

## File Metadata

- **Full Path**: `modules/gapi/test/render/gapi_render_tests_ocv.cpp`
- **File Name**: `gapi_render_tests_ocv.cpp`
- **File Size**: 37,728 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/test/render/gapi_render_tests_ocv.cpp](../../../../modules/gapi/test/render/gapi_render_tests_ocv.cpp)
