# Documentation for `modules/gapi/test/s11n/gapi_s11n_tests.cpp`

## File Metadata

- **Full Path**: `modules/gapi/test/s11n/gapi_s11n_tests.cpp`
- **File Name**: `gapi_s11n_tests.cpp`
- **File Size**: 33,568 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/test/s11n/gapi_s11n_tests.cpp](../../../../modules/gapi/test/s11n/gapi_s11n_tests.cpp)

## Purpose and Role

This file is located in the `modules/gapi/test/s11n` directory and serves as part of the OpenCV library infrastructure.
...
- **MyCustomTypeNoS11N**: A class/struct defined in this file
- **CompileArgTag**: A class/struct defined in this file
- **S11N**: A class/struct defined in this file
- **EmptyCustomType**: A class/struct defined in this file
- **MyCustomType**: A class/struct defined in this file
- **MyRMatAdapter**: A class/struct defined in this file
- **MyMediaFrameAdapter**: A class/struct defined in this file
- **S11N_Basic**: A class/struct defined in this file
