# Documentation for `modules/gapi/test/streaming/gapi_streaming_vpl_core_test.cpp`

## File Metadata

- **Full Path**: `modules/gapi/test/streaming/gapi_streaming_vpl_core_test.cpp`
- **File Name**: `gapi_streaming_vpl_core_test.cpp`
- **File Size**: 50,908 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/test/streaming/gapi_streaming_vpl_core_test.cpp](../../../../modules/gapi/test/streaming/gapi_streaming_vpl_core_test.cpp)
...
- **TestLockableAllocator**: A class/struct defined in this file
- **TestProcessingEngine**: A class/struct defined in this file
- **UnlockProcessor**: A class/struct defined in this file
- **LockProcessor**: A class/struct defined in this file
- **TestProcessingSession**: A class/struct defined in this file
- **L**: A class/struct defined in this file
