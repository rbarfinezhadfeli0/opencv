# Documentation for `modules/gapi/test/streaming/gapi_streaming_vpl_data_provider.cpp`

## File Metadata

- **Full Path**: `modules/gapi/test/streaming/gapi_streaming_vpl_data_provider.cpp`
- **File Name**: `gapi_streaming_vpl_data_provider.cpp`
- **File Size**: 12,223 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/test/streaming/gapi_streaming_vpl_data_provider.cpp](../../../../modules/gapi/test/streaming/gapi_streaming_vpl_data_provider.cpp)
...
- **IntrusiveAsyncDemuxDataProvider**: A class/struct defined in this file
- **OneVPL_Source_MFPAsyncDispatcherTest**: A class/struct defined in this file
