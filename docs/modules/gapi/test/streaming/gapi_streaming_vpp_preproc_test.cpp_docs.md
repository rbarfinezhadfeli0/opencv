# Documentation for `modules/gapi/test/streaming/gapi_streaming_vpp_preproc_test.cpp`

## File Metadata

- **Full Path**: `modules/gapi/test/streaming/gapi_streaming_vpp_preproc_test.cpp`
- **File Name**: `gapi_streaming_vpp_preproc_test.cpp`
- **File Size**: 31,526 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/test/streaming/gapi_streaming_vpp_preproc_test.cpp](../../../../modules/gapi/test/streaming/gapi_streaming_vpp_preproc_test.cpp)
...
- **VPPPreprocDispatcherROIParams**: A class/struct defined in this file
- **IStopAdapter**: A class/struct defined in this file
- **VPPPreprocROIParams**: A class/struct defined in this file
- **SafeQueue**: A class/struct defined in this file
- **OneVPL_PreproEngineTest**: A class/struct defined in this file
- **EmptyDataProvider**: A class/struct defined in this file
- **VPPPreprocParams**: A class/struct defined in this file
- **ProcessingEngine**: A class/struct defined in this file

### Functions and Methods

- **private()**: A function/method defined in this file
- **HAVE_ONEVPL()**: A function/method defined in this file
- **protected()**: A function/method defined in this file
...
- `streaming/onevpl/accelerators/surface/dx11_frame_adapter.hpp`
