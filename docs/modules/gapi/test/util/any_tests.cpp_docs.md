# Documentation for `modules/gapi/test/util/any_tests.cpp`

## File Metadata

- **Full Path**: `modules/gapi/test/util/any_tests.cpp`
- **File Name**: `any_tests.cpp`
- **File Size**: 2,544 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/test/util/any_tests.cpp](../../../../modules/gapi/test/util/any_tests.cpp)
