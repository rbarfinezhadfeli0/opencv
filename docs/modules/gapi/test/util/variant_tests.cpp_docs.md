# Documentation for `modules/gapi/test/util/variant_tests.cpp`

## File Metadata

- **Full Path**: `modules/gapi/test/util/variant_tests.cpp`
- **File Name**: `variant_tests.cpp`
- **File Size**: 20,408 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/gapi/test/util/variant_tests.cpp](../../../../modules/gapi/test/util/variant_tests.cpp)
...
- **MyBoolNoParamNonIndexedVisitor**: A class/struct defined in this file
- **MyBoolParamIndexedVisitor**: A class/struct defined in this file
- **MyClass**: A class/struct defined in this file
- **MyVoidNoParamIndexedVisitor**: A class/struct defined in this file
- **MyType**: A class/struct defined in this file
- **Type**: A class/struct defined in this file
- **MyVoidNoParamNonIndexedVisitor**: A class/struct defined in this file

### Functions and Methods

- **util()**: A function/method defined in this file
