# Documentation for `modules/highgui/CMakeLists.txt`

## File Metadata

- **Full Path**: `modules/highgui/CMakeLists.txt`
- **File Name**: `CMakeLists.txt`
- **File Size**: 11,960 bytes
- **File Type**: .txt
- **Link to Source**: [modules/highgui/CMakeLists.txt](../../modules/highgui/CMakeLists.txt)

## Purpose and Role

This file is located in the `modules/highgui` directory and serves as part of the OpenCV library infrastructure.
