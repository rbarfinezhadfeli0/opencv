# Documentation for `modules/highgui/misc/plugins/build_plugins.sh`

## File Metadata

- **Full Path**: `modules/highgui/misc/plugins/build_plugins.sh`
- **File Name**: `build_plugins.sh`
- **File Size**: 1,605 bytes
- **File Type**: .sh
- **Link to Source**: [modules/highgui/misc/plugins/build_plugins.sh](../../../../modules/highgui/misc/plugins/build_plugins.sh)

## Purpose and Role

This file is located in the `modules/highgui/misc/plugins` directory and serves as part of the OpenCV library infrastructure.
