# Documentation for `modules/highgui/misc/plugins/`
...
**Path**: `modules/highgui/misc/plugins/`
**Direct Files**: 1
**Subfolders**: 1
...
- **[build_plugins.sh](build_plugins.sh_docs.md)**: SH file
...
- **plugin_gtk/** - See [plugin_gtk/doc.md](plugin_gtk/doc.md)
...
- **Parent Folder**: [modules/highgui/misc/](../misc/doc.md)

**Sibling Folders**:
- [java/](../java/doc.md)

**Subfolders**:
- [plugin_gtk/](plugin_gtk/doc.md)
