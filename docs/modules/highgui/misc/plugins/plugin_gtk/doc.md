# Documentation for `modules/highgui/misc/plugins/plugin_gtk/`
...
**Path**: `modules/highgui/misc/plugins/plugin_gtk/`
**Direct Files**: 4
**Subfolders**: 0
...
- **Parent Folder**: [modules/highgui/misc/plugins/](../plugins/doc.md)
