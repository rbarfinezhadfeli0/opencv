# Documentation for `modules/highgui/src/factory.hpp`

## File Metadata

- **Full Path**: `modules/highgui/src/factory.hpp`
- **File Name**: `factory.hpp`
- **File Size**: 1,199 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/highgui/src/factory.hpp](../../../modules/highgui/src/factory.hpp)
...
- **IUIBackendFactory**: A class/struct defined in this file
- **StaticBackendFactory**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_UI_FACTORY_HPP()**: A function/method defined in this file
