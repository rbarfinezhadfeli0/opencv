# Documentation for `modules/highgui/src/plugin_wrapper.impl.hpp`

## File Metadata

- **Full Path**: `modules/highgui/src/plugin_wrapper.impl.hpp`
- **File Name**: `plugin_wrapper.impl.hpp`
- **File Size**: 10,714 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/highgui/src/plugin_wrapper.impl.hpp](../../../modules/highgui/src/plugin_wrapper.impl.hpp)
...
- **PluginUIBackendFactory**: A class/struct defined in this file
- **PluginUIBackend**: A class/struct defined in this file

### Functions and Methods

- **CV_LOG_ERROR()**: A function/method defined in this file
- **HAVE_OPENCV_IMGCODECS()**: A function/method defined in this file
- **CV_UI_PLUGIN_SUBDIRECTORY()**: A function/method defined in this file
