# Documentation for `modules/highgui/src/registry.hpp`

## File Metadata

- **Full Path**: `modules/highgui/src/registry.hpp`
- **File Name**: `registry.hpp`
- **File Size**: 760 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/highgui/src/registry.hpp](../../../modules/highgui/src/registry.hpp)
...
- **BackendInfo**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_HIGHGUI_REGISTRY_HPP()**: A function/method defined in this file
