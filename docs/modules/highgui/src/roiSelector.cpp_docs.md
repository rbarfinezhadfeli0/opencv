# Documentation for `modules/highgui/src/roiSelector.cpp`

## File Metadata

- **Full Path**: `modules/highgui/src/roiSelector.cpp`
- **File Name**: `roiSelector.cpp`
- **File Size**: 7,713 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/highgui/src/roiSelector.cpp](../../../modules/highgui/src/roiSelector.cpp)
...
- **handlerT**: A class/struct defined in this file
- **ROISelector**: A class/struct defined in this file
