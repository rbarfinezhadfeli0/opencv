# Documentation for `modules/highgui/src/window_framebuffer.cpp`

## File Metadata

- **Full Path**: `modules/highgui/src/window_framebuffer.cpp`
- **File Name**: `window_framebuffer.cpp`
- **File Size**: 20,659 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/highgui/src/window_framebuffer.cpp](../../../modules/highgui/src/window_framebuffer.cpp)
...
- **HAVE_FRAMEBUFFER_XVFB()**: A function/method defined in this file
