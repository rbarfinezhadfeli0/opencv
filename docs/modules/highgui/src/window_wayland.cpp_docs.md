# Documentation for `modules/highgui/src/window_wayland.cpp`

## File Metadata

- **Full Path**: `modules/highgui/src/window_wayland.cpp`
- **File Name**: `window_wayland.cpp`
- **File Size**: 82,385 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/highgui/src/window_wayland.cpp](../../../modules/highgui/src/window_wayland.cpp)
...
- **cv_wl_buffer**: A class/struct defined in this file
- **cv_wl_window**: A class/struct defined in this file
- **cv_wl_core**: A class/struct defined in this file
- **wl_compositor**: A class/struct defined in this file
- **wl_display**: A class/struct defined in this file
- **cv_wl_titlebar**: A class/struct defined in this file
- **wl_registry_listener**: A class/struct defined in this file
- **cv_wl_input**: A class/struct defined in this file
- **cv_wl_trackbar**: A class/struct defined in this file
- **cv_wl_keyboard**: A class/struct defined in this file
- **xdg_surface**: A class/struct defined in this file
- **epoller**: A class/struct defined in this file
- **cv_wl_viewer**: A class/struct defined in this file
- **xdg_wm_base_listener**: A class/struct defined in this file
- **cv_wl_mouse**: A class/struct defined in this file
- **wl_surface**: A class/struct defined in this file
- **cv_wl_display**: A class/struct defined in this file
- **wl_shm**: A class/struct defined in this file
- **cv_wl_cursor_theme**: A class/struct defined in this file
- **wl_shm_listener**: A class/struct defined in this file
- **wl_pointer**: A class/struct defined in this file
- **xdg_wm_base**: A class/struct defined in this file
- **cv_wl_cursor**: A class/struct defined in this file
- **wl_registry**: A class/struct defined in this file
- **wl_pointer_listener**: A class/struct defined in this file
- **cv_wl_widget**: A class/struct defined in this file
- **epoll_event**: A class/struct defined in this file

### Functions and Methods

- **if()**: A function/method defined in this file
- **HAVE_OPENGL()**: A function/method defined in this file
- **XDG_TOPLEVEL_CONFIGURE_BOUNDS_SINCE_VERSION()**: A function/method defined in this file
- **XDG_TOPLEVEL_WM_CAPABILITIES_SINCE_VERSION()**: A function/method defined in this file
- **WL_POINTER_AXIS_VALUE120_SINCE_VERSION()**: A function/method defined in this file
- **NDEBUG()**: A function/method defined in this file
- **WL_POINTER_AXIS_RELATIVE_DIRECTION_SINCE_VERSION()**: A function/method defined in this file
