# Documentation for `modules/imgcodecs/CMakeLists.txt`

## File Metadata

- **Full Path**: `modules/imgcodecs/CMakeLists.txt`
- **File Name**: `CMakeLists.txt`
- **File Size**: 6,776 bytes
- **File Type**: .txt
- **Link to Source**: [modules/imgcodecs/CMakeLists.txt](../../modules/imgcodecs/CMakeLists.txt)

## Purpose and Role

This file is located in the `modules/imgcodecs` directory and serves as part of the OpenCV library infrastructure.
