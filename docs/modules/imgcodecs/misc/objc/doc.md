# Documentation for `modules/imgcodecs/misc/objc/`
...
**Path**: `modules/imgcodecs/misc/objc/`
**Direct Files**: 1
**Subfolders**: 3
...
- **macosx/** - See [macosx/doc.md](macosx/doc.md)
...
- **Parent Folder**: [modules/imgcodecs/misc/](../misc/doc.md)
