# Documentation for `modules/imgcodecs/misc/objc/ios/MatQuickLook.mm`

## File Metadata

- **Full Path**: `modules/imgcodecs/misc/objc/ios/MatQuickLook.mm`
- **File Name**: `MatQuickLook.mm`
- **File Size**: 7,401 bytes
- **File Type**: .mm
- **Link to Source**: [modules/imgcodecs/misc/objc/ios/MatQuickLook.mm](../../../../../modules/imgcodecs/misc/objc/ios/MatQuickLook.mm)
...
- **UIFont()**: A function/method defined in this file
