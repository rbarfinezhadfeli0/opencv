# Documentation for `modules/imgcodecs/src/apple_conversions.h`

## File Metadata

- **Full Path**: `modules/imgcodecs/src/apple_conversions.h`
- **File Name**: `apple_conversions.h`
- **File Size**: 485 bytes
- **File Type**: .h
- **Link to Source**: [modules/imgcodecs/src/apple_conversions.h](../../../modules/imgcodecs/src/apple_conversions.h)
