# Documentation for `modules/imgcodecs/src/bitstrm.cpp`

## File Metadata

- **Full Path**: `modules/imgcodecs/src/bitstrm.cpp`
- **File Name**: `bitstrm.cpp`
- **File Size**: 10,771 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/imgcodecs/src/bitstrm.cpp](../../../modules/imgcodecs/src/bitstrm.cpp)
