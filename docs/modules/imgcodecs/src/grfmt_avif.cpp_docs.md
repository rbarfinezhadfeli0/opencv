# Documentation for `modules/imgcodecs/src/grfmt_avif.cpp`

## File Metadata

- **Full Path**: `modules/imgcodecs/src/grfmt_avif.cpp`
- **File Name**: `grfmt_avif.cpp`
- **File Size**: 15,155 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/imgcodecs/src/grfmt_avif.cpp](../../../modules/imgcodecs/src/grfmt_avif.cpp)
...
- **AvifImageDeleter**: A class/struct defined in this file
