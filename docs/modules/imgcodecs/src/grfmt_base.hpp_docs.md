# Documentation for `modules/imgcodecs/src/grfmt_base.hpp`

## File Metadata

- **Full Path**: `modules/imgcodecs/src/grfmt_base.hpp`
- **File Name**: `grfmt_base.hpp`
- **File Size**: 11,658 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/imgcodecs/src/grfmt_base.hpp](../../../modules/imgcodecs/src/grfmt_base.hpp)
...
- **BaseImageEncoder**: A class/struct defined in this file
- **provides**: A class/struct defined in this file
- **BaseImageDecoder**: A class/struct defined in this file
...
- **_GRFMT_BASE_H_()**: A function/method defined in this file
