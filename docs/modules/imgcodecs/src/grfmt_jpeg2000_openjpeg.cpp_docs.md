# Documentation for `modules/imgcodecs/src/grfmt_jpeg2000_openjpeg.cpp`

## File Metadata

- **Full Path**: `modules/imgcodecs/src/grfmt_jpeg2000_openjpeg.cpp`
- **File Name**: `grfmt_jpeg2000_openjpeg.cpp`
- **File Size**: 24,410 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/imgcodecs/src/grfmt_jpeg2000_openjpeg.cpp](../../../modules/imgcodecs/src/grfmt_jpeg2000_openjpeg.cpp)
...
- **ChannelsIterator**: A class/struct defined in this file
- **as**: A class/struct defined in this file
- **Traits**: A class/struct defined in this file
- **NonConstItTraits**: A class/struct defined in this file
- **ConstItTraits**: A class/struct defined in this file
