# Documentation for `modules/imgcodecs/src/grfmt_jpegxl.cpp`

## File Metadata

- **Full Path**: `modules/imgcodecs/src/grfmt_jpegxl.cpp`
- **File Name**: `grfmt_jpegxl.cpp`
- **File Size**: 24,405 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/imgcodecs/src/grfmt_jpegxl.cpp](../../../modules/imgcodecs/src/grfmt_jpegxl.cpp)
