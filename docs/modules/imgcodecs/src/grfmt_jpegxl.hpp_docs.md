# Documentation for `modules/imgcodecs/src/grfmt_jpegxl.hpp`

## File Metadata

- **Full Path**: `modules/imgcodecs/src/grfmt_jpegxl.hpp`
- **File Name**: `grfmt_jpegxl.hpp`
- **File Size**: 1,510 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/imgcodecs/src/grfmt_jpegxl.hpp](../../../modules/imgcodecs/src/grfmt_jpegxl.hpp)
...
- **JpegXLDecoder**: A class/struct defined in this file
- **JpegXLEncoder**: A class/struct defined in this file

### Functions and Methods

- **HAVE_JPEGXL()**: A function/method defined in this file
- **_GRFMT_JPEGXL_H_()**: A function/method defined in this file
