# Documentation for `modules/imgcodecs/src/grfmt_pfm.hpp`

## File Metadata

- **Full Path**: `modules/imgcodecs/src/grfmt_pfm.hpp`
- **File Name**: `grfmt_pfm.hpp`
- **File Size**: 1,278 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/imgcodecs/src/grfmt_pfm.hpp](../../../modules/imgcodecs/src/grfmt_pfm.hpp)
...
- **PFMDecoder**: A class/struct defined in this file
- **PFMEncoder**: A class/struct defined in this file

### Functions and Methods

- **_GRFMT_PFM_H_()**: A function/method defined in this file
