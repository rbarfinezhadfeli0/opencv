# Documentation for `modules/imgcodecs/src/grfmt_spng.cpp`

## File Metadata

- **Full Path**: `modules/imgcodecs/src/grfmt_spng.cpp`
- **File Name**: `grfmt_spng.cpp`
- **File Size**: 31,711 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/imgcodecs/src/grfmt_spng.cpp](../../../modules/imgcodecs/src/grfmt_spng.cpp)
