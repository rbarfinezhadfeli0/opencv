# Documentation for `modules/imgcodecs/src/grfmt_sunras.cpp`

## File Metadata

- **Full Path**: `modules/imgcodecs/src/grfmt_sunras.cpp`
- **File Name**: `grfmt_sunras.cpp`
- **File Size**: 12,471 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/imgcodecs/src/grfmt_sunras.cpp](../../../modules/imgcodecs/src/grfmt_sunras.cpp)
