# Documentation for `modules/imgcodecs/test/test_animation.cpp`

## File Metadata

- **Full Path**: `modules/imgcodecs/test/test_animation.cpp`
- **File Name**: `test_animation.cpp`
- **File Size**: 27,433 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/imgcodecs/test/test_animation.cpp](../../../modules/imgcodecs/test/test_animation.cpp)
...
- **successfully()**: A function/method defined in this file
