# Documentation for `modules/imgcodecs/test/test_common.hpp`

## File Metadata

- **Full Path**: `modules/imgcodecs/test/test_common.hpp`
- **File Name**: `test_common.hpp`
- **File Size**: 505 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/imgcodecs/test/test_common.hpp](../../../modules/imgcodecs/test/test_common.hpp)
...
- **OPENCV_TEST_IMGCODECS_COMMON_HPP()**: A function/method defined in this file
