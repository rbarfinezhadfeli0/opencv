# Documentation for `modules/imgcodecs/test/test_exif.cpp`

## File Metadata

- **Full Path**: `modules/imgcodecs/test/test_exif.cpp`
- **File Name**: `test_exif.cpp`
- **File Size**: 22,926 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/imgcodecs/test/test_exif.cpp](../../../modules/imgcodecs/test/test_exif.cpp)
...
- **OPENCV_IMGCODECS_PNG_WITH_EXIF()**: A function/method defined in this file
