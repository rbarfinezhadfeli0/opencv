# Documentation for `modules/imgcodecs/test/test_exr.impl.hpp`

## File Metadata

- **Full Path**: `modules/imgcodecs/test/test_exr.impl.hpp`
- **File Name**: `test_exr.impl.hpp`
- **File Size**: 13,333 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/imgcodecs/test/test_exr.impl.hpp](../../../modules/imgcodecs/test/test_exr.impl.hpp)
