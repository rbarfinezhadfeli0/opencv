# Documentation for `modules/imgcodecs/test/test_gif.cpp`

## File Metadata

- **Full Path**: `modules/imgcodecs/test/test_gif.cpp`
- **File Name**: `test_gif.cpp`
- **File Size**: 17,629 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/imgcodecs/test/test_gif.cpp](../../../modules/imgcodecs/test/test_gif.cpp)
