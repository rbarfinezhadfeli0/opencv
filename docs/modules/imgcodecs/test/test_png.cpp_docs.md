# Documentation for `modules/imgcodecs/test/test_png.cpp`

## File Metadata

- **Full Path**: `modules/imgcodecs/test/test_png.cpp`
- **File Name**: `test_png.cpp`
- **File Size**: 21,604 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/imgcodecs/test/test_png.cpp](../../../modules/imgcodecs/test/test_png.cpp)
...
- **full**: A class/struct defined in this file
