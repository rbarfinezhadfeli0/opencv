# Documentation for `modules/imgcodecs/test/test_read_write.cpp`

## File Metadata

- **Full Path**: `modules/imgcodecs/test/test_read_write.cpp`
- **File Name**: `test_read_write.cpp`
- **File Size**: 19,548 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/imgcodecs/test/test_read_write.cpp](../../../modules/imgcodecs/test/test_read_write.cpp)
