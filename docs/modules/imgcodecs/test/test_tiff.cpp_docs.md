# Documentation for `modules/imgcodecs/test/test_tiff.cpp`

## File Metadata

- **Full Path**: `modules/imgcodecs/test/test_tiff.cpp`
- **File Name**: `test_tiff.cpp`
- **File Size**: 52,484 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/imgcodecs/test/test_tiff.cpp](../../../modules/imgcodecs/test/test_tiff.cpp)
