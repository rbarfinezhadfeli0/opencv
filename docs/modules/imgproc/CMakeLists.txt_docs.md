# Documentation for `modules/imgproc/CMakeLists.txt`

## File Metadata

- **Full Path**: `modules/imgproc/CMakeLists.txt`
- **File Name**: `CMakeLists.txt`
- **File Size**: 1,207 bytes
- **File Type**: .txt
- **Link to Source**: [modules/imgproc/CMakeLists.txt](../../modules/imgproc/CMakeLists.txt)

## Purpose and Role

This file is located in the `modules/imgproc` directory and serves as part of the OpenCV library infrastructure.
