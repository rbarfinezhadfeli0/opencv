# Documentation for `modules/imgproc/misc/java/src/java/`
...
**Path**: `modules/imgproc/misc/java/src/java/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[imgproc+Moments.java](imgproc+Moments.java_docs.md)**: JAVA file
...
- **Parent Folder**: [modules/imgproc/misc/java/src/](../src/doc.md)
