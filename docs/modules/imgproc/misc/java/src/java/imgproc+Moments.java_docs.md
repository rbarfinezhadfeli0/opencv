# Documentation for `modules/imgproc/misc/java/src/java/imgproc+Moments.java`

## File Metadata

- **Full Path**: `modules/imgproc/misc/java/src/java/imgproc+Moments.java`
- **File Name**: `imgproc+Moments.java`
- **File Size**: 7,596 bytes
- **File Type**: .java
- **Link to Source**: [modules/imgproc/misc/java/src/java/imgproc+Moments.java](../../../../../../modules/imgproc/misc/java/src/java/imgproc+Moments.java)

## Purpose and Role

This file is located in the `modules/imgproc/misc/java/src/java` directory and serves as part of the OpenCV library infrastructure.
