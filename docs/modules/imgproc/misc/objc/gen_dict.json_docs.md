# Documentation for `modules/imgproc/misc/objc/gen_dict.json`

## File Metadata

- **Full Path**: `modules/imgproc/misc/objc/gen_dict.json`
- **File Name**: `gen_dict.json`
- **File Size**: 7,530 bytes
- **File Type**: .json
- **Link to Source**: [modules/imgproc/misc/objc/gen_dict.json](../../../../modules/imgproc/misc/objc/gen_dict.json)

## Purpose and Role

This file is located in the `modules/imgproc/misc/objc` directory and serves as part of the OpenCV library infrastructure.
