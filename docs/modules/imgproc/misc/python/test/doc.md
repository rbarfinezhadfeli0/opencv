# Documentation for `modules/imgproc/misc/python/test/`
...
**Path**: `modules/imgproc/misc/python/test/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[test_imgproc.py](test_imgproc.py_docs.md)**: PY file
...
- **Parent Folder**: [modules/imgproc/misc/python/](../python/doc.md)
