# Documentation for `modules/imgproc/perf/perf_bilateral.cpp`

## File Metadata

- **Full Path**: `modules/imgproc/perf/perf_bilateral.cpp`
- **File Name**: `perf_bilateral.cpp`
- **File Size**: 1,131 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/imgproc/perf/perf_bilateral.cpp](../../../modules/imgproc/perf/perf_bilateral.cpp)
