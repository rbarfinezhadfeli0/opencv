# Documentation for `modules/imgproc/perf/perf_canny.cpp`

## File Metadata

- **Full Path**: `modules/imgproc/perf/perf_canny.cpp`
- **File Name**: `perf_canny.cpp`
- **File Size**: 1,471 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/imgproc/perf/perf_canny.cpp](../../../modules/imgproc/perf/perf_canny.cpp)
