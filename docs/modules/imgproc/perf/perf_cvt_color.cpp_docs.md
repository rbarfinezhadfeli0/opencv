# Documentation for `modules/imgproc/perf/perf_cvt_color.cpp`

## File Metadata

- **Full Path**: `modules/imgproc/perf/perf_cvt_color.cpp`
- **File Name**: `perf_cvt_color.cpp`
- **File Size**: 19,661 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/imgproc/perf/perf_cvt_color.cpp](../../../modules/imgproc/perf/perf_cvt_color.cpp)
...
- **ChPair**: A class/struct defined in this file
