# Documentation for `modules/imgproc/perf/perf_intelligent_scissors.cpp`

## File Metadata

- **Full Path**: `modules/imgproc/perf/perf_intelligent_scissors.cpp`
- **File Name**: `perf_intelligent_scissors.cpp`
- **File Size**: 873 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/imgproc/perf/perf_intelligent_scissors.cpp](../../../modules/imgproc/perf/perf_intelligent_scissors.cpp)
