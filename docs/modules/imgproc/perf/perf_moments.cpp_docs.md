# Documentation for `modules/imgproc/perf/perf_moments.cpp`

## File Metadata

- **Full Path**: `modules/imgproc/perf/perf_moments.cpp`
- **File Name**: `perf_moments.cpp`
- **File Size**: 1,265 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/imgproc/perf/perf_moments.cpp](../../../modules/imgproc/perf/perf_moments.cpp)
