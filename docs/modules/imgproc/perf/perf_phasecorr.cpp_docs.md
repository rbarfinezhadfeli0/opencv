# Documentation for `modules/imgproc/perf/perf_phasecorr.cpp`

## File Metadata

- **Full Path**: `modules/imgproc/perf/perf_phasecorr.cpp`
- **File Name**: `perf_phasecorr.cpp`
- **File Size**: 632 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/imgproc/perf/perf_phasecorr.cpp](../../../modules/imgproc/perf/perf_phasecorr.cpp)
