# Documentation for `modules/imgproc/perf/perf_warp.cpp`

## File Metadata

- **Full Path**: `modules/imgproc/perf/perf_warp.cpp`
- **File Name**: `perf_warp.cpp`
- **File Size**: 10,453 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/imgproc/perf/perf_warp.cpp](../../../modules/imgproc/perf/perf_warp.cpp)
