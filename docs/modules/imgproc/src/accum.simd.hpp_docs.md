# Documentation for `modules/imgproc/src/accum.simd.hpp`

## File Metadata

- **Full Path**: `modules/imgproc/src/accum.simd.hpp`
- **File Name**: `accum.simd.hpp`
- **File Size**: 143,271 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/imgproc/src/accum.simd.hpp](../../../modules/imgproc/src/accum.simd.hpp)
