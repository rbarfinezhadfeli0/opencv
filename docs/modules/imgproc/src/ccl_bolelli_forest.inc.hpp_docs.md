# Documentation for `modules/imgproc/src/ccl_bolelli_forest.inc.hpp`

## File Metadata

- **Full Path**: `modules/imgproc/src/ccl_bolelli_forest.inc.hpp`
- **File Name**: `ccl_bolelli_forest.inc.hpp`
- **File Size**: 50,812 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/imgproc/src/ccl_bolelli_forest.inc.hpp](../../../modules/imgproc/src/ccl_bolelli_forest.inc.hpp)
