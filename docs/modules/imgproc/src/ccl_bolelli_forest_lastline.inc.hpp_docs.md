# Documentation for `modules/imgproc/src/ccl_bolelli_forest_lastline.inc.hpp`

## File Metadata

- **Full Path**: `modules/imgproc/src/ccl_bolelli_forest_lastline.inc.hpp`
- **File Name**: `ccl_bolelli_forest_lastline.inc.hpp`
- **File Size**: 20,977 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/imgproc/src/ccl_bolelli_forest_lastline.inc.hpp](../../../modules/imgproc/src/ccl_bolelli_forest_lastline.inc.hpp)
