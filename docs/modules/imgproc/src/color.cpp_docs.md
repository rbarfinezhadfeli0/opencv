# Documentation for `modules/imgproc/src/color.cpp`

## File Metadata

- **Full Path**: `modules/imgproc/src/color.cpp`
- **File Name**: `color.cpp`
- **File Size**: 17,400 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/imgproc/src/color.cpp](../../../modules/imgproc/src/color.cpp)
