# Documentation for `modules/imgproc/src/color.hpp`

## File Metadata

- **Full Path**: `modules/imgproc/src/color.hpp`
- **File Name**: `color.hpp`
- **File Size**: 23,446 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/imgproc/src/color.hpp](../../../modules/imgproc/src/color.hpp)
...
- **CvtHelper**: A class/struct defined in this file
- **CvtColorIPPLoop_Invoker**: A class/struct defined in this file
- **OclHelper**: A class/struct defined in this file
- **IPPGeneralReorderFunctor**: A class/struct defined in this file
- **IPPGeneralFunctor**: A class/struct defined in this file
- **IPPReorderGeneralFunctor**: A class/struct defined in this file
- **IPPReorderFunctor**: A class/struct defined in this file
