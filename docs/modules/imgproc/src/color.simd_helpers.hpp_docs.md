# Documentation for `modules/imgproc/src/color.simd_helpers.hpp`

## File Metadata

- **Full Path**: `modules/imgproc/src/color.simd_helpers.hpp`
- **File Name**: `color.simd_helpers.hpp`
- **File Size**: 4,976 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/imgproc/src/color.simd_helpers.hpp](../../../modules/imgproc/src/color.simd_helpers.hpp)
...
- **Set**: A class/struct defined in this file
- **CvtColorLoop_Invoker**: A class/struct defined in this file
