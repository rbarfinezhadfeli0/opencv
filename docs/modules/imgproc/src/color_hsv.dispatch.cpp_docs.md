# Documentation for `modules/imgproc/src/color_hsv.dispatch.cpp`

## File Metadata

- **Full Path**: `modules/imgproc/src/color_hsv.dispatch.cpp`
- **File Name**: `color_hsv.dispatch.cpp`
- **File Size**: 12,768 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/imgproc/src/color_hsv.dispatch.cpp](../../../modules/imgproc/src/color_hsv.dispatch.cpp)
