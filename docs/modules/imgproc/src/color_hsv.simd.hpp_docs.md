# Documentation for `modules/imgproc/src/color_hsv.simd.hpp`

## File Metadata

- **Full Path**: `modules/imgproc/src/color_hsv.simd.hpp`
- **File Name**: `color_hsv.simd.hpp`
- **File Size**: 45,998 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/imgproc/src/color_hsv.simd.hpp](../../../modules/imgproc/src/color_hsv.simd.hpp)
...
- **RGB2HLS_f**: A class/struct defined in this file
- **HSV2RGB_f**: A class/struct defined in this file
- **TablesSingleton**: A class/struct defined in this file
- **RGB2HSV_b**: A class/struct defined in this file
- **HLS2RGB_f**: A class/struct defined in this file
- **HLS2RGB_b**: A class/struct defined in this file
- **HSV2RGB_b**: A class/struct defined in this file
- **RGB2HLS_b**: A class/struct defined in this file
