# Documentation for `modules/imgproc/src/color_rgb.dispatch.cpp`

## File Metadata

- **Full Path**: `modules/imgproc/src/color_rgb.dispatch.cpp`
- **File Name**: `color_rgb.dispatch.cpp`
- **File Size**: 20,790 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/imgproc/src/color_rgb.dispatch.cpp](../../../modules/imgproc/src/color_rgb.dispatch.cpp)
...
- **IPPGray2BGRFunctor**: A class/struct defined in this file
- **IPPColor2GrayFunctor**: A class/struct defined in this file
- **IPPGray2BGRAFunctor**: A class/struct defined in this file
