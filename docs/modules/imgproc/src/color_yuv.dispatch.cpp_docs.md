# Documentation for `modules/imgproc/src/color_yuv.dispatch.cpp`

## File Metadata

- **Full Path**: `modules/imgproc/src/color_yuv.dispatch.cpp`
- **File Name**: `color_yuv.dispatch.cpp`
- **File Size**: 21,249 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/imgproc/src/color_yuv.dispatch.cpp](../../../modules/imgproc/src/color_yuv.dispatch.cpp)
