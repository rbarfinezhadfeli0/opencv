# Documentation for `modules/imgproc/src/contours_approx.cpp`

## File Metadata

- **Full Path**: `modules/imgproc/src/contours_approx.cpp`
- **File Name**: `contours_approx.cpp`
- **File Size**: 9,800 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/imgproc/src/contours_approx.cpp](../../../modules/imgproc/src/contours_approx.cpp)
...
- **ApproxItem**: A class/struct defined in this file
