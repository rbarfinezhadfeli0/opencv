# Documentation for `modules/imgproc/src/contours_common.hpp`

## File Metadata

- **Full Path**: `modules/imgproc/src/contours_common.hpp`
- **File Name**: `contours_common.hpp`
- **File Size**: 8,811 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/imgproc/src/contours_common.hpp](../../../modules/imgproc/src/contours_common.hpp)
...
- **Tree**: A class/struct defined in this file
- **TreeIterator**: A class/struct defined in this file
- **ContourDataStorage**: A class/struct defined in this file
- **Contour**: A class/struct defined in this file
- **TreeNode**: A class/struct defined in this file

### Functions and Methods

- **T()**: A function/method defined in this file
- **Tree()**: A function/method defined in this file
- **TreeIterator()**: A function/method defined in this file
- **ContourDataStorage()**: A function/method defined in this file
- **OPENCV_CONTOURS_COMMON_HPP()**: A function/method defined in this file
- **BlockStorage()**: A function/method defined in this file
- **TreeNode()**: A function/method defined in this file
