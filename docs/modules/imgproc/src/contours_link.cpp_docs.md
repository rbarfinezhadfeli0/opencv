# Documentation for `modules/imgproc/src/contours_link.cpp`

## File Metadata

- **Full Path**: `modules/imgproc/src/contours_link.cpp`
- **File Name**: `contours_link.cpp`
- **File Size**: 12,459 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/imgproc/src/contours_link.cpp](../../../modules/imgproc/src/contours_link.cpp)
...
- **LinkRunner**: A class/struct defined in this file
- **LinkRunPoint**: A class/struct defined in this file

### Functions and Methods

- **LinkRunPoint()**: A function/method defined in this file
