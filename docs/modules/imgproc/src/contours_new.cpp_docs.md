# Documentation for `modules/imgproc/src/contours_new.cpp`

## File Metadata

- **Full Path**: `modules/imgproc/src/contours_new.cpp`
- **File Name**: `contours_new.cpp`
- **File Size**: 21,109 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/imgproc/src/contours_new.cpp](../../../modules/imgproc/src/contours_new.cpp)
...
- **ContourScanner_**: A class/struct defined in this file
- **Trait**: A class/struct defined in this file

### Functions and Methods

- **shared_ptr()**: A function/method defined in this file
