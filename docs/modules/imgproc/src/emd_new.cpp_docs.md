# Documentation for `modules/imgproc/src/emd_new.cpp`

## File Metadata

- **Full Path**: `modules/imgproc/src/emd_new.cpp`
- **File Name**: `emd_new.cpp`
- **File Size**: 27,821 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/imgproc/src/emd_new.cpp](../../../modules/imgproc/src/emd_new.cpp)
...
- **Node1D**: A class/struct defined in this file
- **struct**: A class/struct defined in this file
- **Node2D**: A class/struct defined in this file
