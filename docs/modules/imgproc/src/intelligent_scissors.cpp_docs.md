# Documentation for `modules/imgproc/src/intelligent_scissors.cpp`

## File Metadata

- **Full Path**: `modules/imgproc/src/intelligent_scissors.cpp`
- **File Name**: `intelligent_scissors.cpp`
- **File Size**: 26,116 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/imgproc/src/intelligent_scissors.cpp](../../../modules/imgproc/src/intelligent_scissors.cpp)
...
- **IntelligentScissorsMB**: A class/struct defined in this file
