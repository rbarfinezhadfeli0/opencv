# Documentation for `modules/imgproc/src/min_enclosing_convex_polygon.cpp`

## File Metadata

- **Full Path**: `modules/imgproc/src/min_enclosing_convex_polygon.cpp`
- **File Name**: `min_enclosing_convex_polygon.cpp`
- **File Size**: 34,248 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/imgproc/src/min_enclosing_convex_polygon.cpp](../../../modules/imgproc/src/min_enclosing_convex_polygon.cpp)
...
- **IntersectionPoint**: A class/struct defined in this file
- **Side**: A class/struct defined in this file
- **Kgon**: A class/struct defined in this file
- **FlushIntersections**: A class/struct defined in this file
- **FlushIntersect**: A class/struct defined in this file
- **the**: A class/struct defined in this file
- **Minimum**: A class/struct defined in this file
- **Segment**: A class/struct defined in this file
- **BalancedIntersect**: A class/struct defined in this file
- **declarations**: A class/struct defined in this file
- **BalancedIntersections**: A class/struct defined in this file
- **Chains**: A class/struct defined in this file
- **functions**: A class/struct defined in this file
- **constructors**: A class/struct defined in this file
