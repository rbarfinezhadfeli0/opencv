# Documentation for `modules/imgproc/src/opencl/accumulate.cl`

## File Metadata

- **Full Path**: `modules/imgproc/src/opencl/accumulate.cl`
- **File Name**: `accumulate.cl`
- **File Size**: 2,965 bytes
- **File Type**: .cl
- **Link to Source**: [modules/imgproc/src/opencl/accumulate.cl](../../../../modules/imgproc/src/opencl/accumulate.cl)
