# Documentation for `modules/imgproc/src/opencl/covardata.cl`

## File Metadata

- **Full Path**: `modules/imgproc/src/opencl/covardata.cl`
- **File Name**: `covardata.cl`
- **File Size**: 10,783 bytes
- **File Type**: .cl
- **Link to Source**: [modules/imgproc/src/opencl/covardata.cl](../../../../modules/imgproc/src/opencl/covardata.cl)
