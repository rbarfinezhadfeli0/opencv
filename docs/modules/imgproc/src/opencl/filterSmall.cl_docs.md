# Documentation for `modules/imgproc/src/opencl/filterSmall.cl`

## File Metadata

- **Full Path**: `modules/imgproc/src/opencl/filterSmall.cl`
- **File Name**: `filterSmall.cl`
- **File Size**: 13,388 bytes
- **File Type**: .cl
- **Link to Source**: [modules/imgproc/src/opencl/filterSmall.cl](../../../../modules/imgproc/src/opencl/filterSmall.cl)
