# Documentation for `modules/imgproc/src/opencl/hough_lines.cl`

## File Metadata

- **Full Path**: `modules/imgproc/src/opencl/hough_lines.cl`
- **File Name**: `hough_lines.cl`
- **File Size**: 11,332 bytes
- **File Type**: .cl
- **Link to Source**: [modules/imgproc/src/opencl/hough_lines.cl](../../../../modules/imgproc/src/opencl/hough_lines.cl)
