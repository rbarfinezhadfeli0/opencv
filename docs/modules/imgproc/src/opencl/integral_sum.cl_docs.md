# Documentation for `modules/imgproc/src/opencl/integral_sum.cl`

## File Metadata

- **Full Path**: `modules/imgproc/src/opencl/integral_sum.cl`
- **File Name**: `integral_sum.cl`
- **File Size**: 6,338 bytes
- **File Type**: .cl
- **Link to Source**: [modules/imgproc/src/opencl/integral_sum.cl](../../../../modules/imgproc/src/opencl/integral_sum.cl)
