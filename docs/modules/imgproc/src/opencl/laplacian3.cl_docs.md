# Documentation for `modules/imgproc/src/opencl/laplacian3.cl`

## File Metadata

- **Full Path**: `modules/imgproc/src/opencl/laplacian3.cl`
- **File Name**: `laplacian3.cl`
- **File Size**: 5,454 bytes
- **File Type**: .cl
- **Link to Source**: [modules/imgproc/src/opencl/laplacian3.cl](../../../../modules/imgproc/src/opencl/laplacian3.cl)
