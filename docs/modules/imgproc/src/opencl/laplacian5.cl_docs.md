# Documentation for `modules/imgproc/src/opencl/laplacian5.cl`

## File Metadata

- **Full Path**: `modules/imgproc/src/opencl/laplacian5.cl`
- **File Name**: `laplacian5.cl`
- **File Size**: 6,696 bytes
- **File Type**: .cl
- **Link to Source**: [modules/imgproc/src/opencl/laplacian5.cl](../../../../modules/imgproc/src/opencl/laplacian5.cl)
