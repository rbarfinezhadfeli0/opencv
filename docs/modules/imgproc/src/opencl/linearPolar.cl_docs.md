# Documentation for `modules/imgproc/src/opencl/linearPolar.cl`

## File Metadata

- **Full Path**: `modules/imgproc/src/opencl/linearPolar.cl`
- **File Name**: `linearPolar.cl`
- **File Size**: 2,106 bytes
- **File Type**: .cl
- **Link to Source**: [modules/imgproc/src/opencl/linearPolar.cl](../../../../modules/imgproc/src/opencl/linearPolar.cl)
