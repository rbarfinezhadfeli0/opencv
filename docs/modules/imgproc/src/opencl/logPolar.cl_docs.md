# Documentation for `modules/imgproc/src/opencl/logPolar.cl`

## File Metadata

- **Full Path**: `modules/imgproc/src/opencl/logPolar.cl`
- **File Name**: `logPolar.cl`
- **File Size**: 2,081 bytes
- **File Type**: .cl
- **Link to Source**: [modules/imgproc/src/opencl/logPolar.cl](../../../../modules/imgproc/src/opencl/logPolar.cl)
