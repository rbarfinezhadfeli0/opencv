# Documentation for `modules/imgproc/src/opencl/moments.cl`

## File Metadata

- **Full Path**: `modules/imgproc/src/opencl/moments.cl`
- **File Name**: `moments.cl`
- **File Size**: 7,256 bytes
- **File Type**: .cl
- **Link to Source**: [modules/imgproc/src/opencl/moments.cl](../../../../modules/imgproc/src/opencl/moments.cl)
