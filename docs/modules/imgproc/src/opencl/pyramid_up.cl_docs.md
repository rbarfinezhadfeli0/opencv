# Documentation for `modules/imgproc/src/opencl/pyramid_up.cl`

## File Metadata

- **Full Path**: `modules/imgproc/src/opencl/pyramid_up.cl`
- **File Name**: `pyramid_up.cl`
- **File Size**: 4,928 bytes
- **File Type**: .cl
- **Link to Source**: [modules/imgproc/src/opencl/pyramid_up.cl](../../../../modules/imgproc/src/opencl/pyramid_up.cl)
