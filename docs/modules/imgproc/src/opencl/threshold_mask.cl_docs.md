# Documentation for `modules/imgproc/src/opencl/threshold_mask.cl`

## File Metadata

- **Full Path**: `modules/imgproc/src/opencl/threshold_mask.cl`
- **File Name**: `threshold_mask.cl`
- **File Size**: 2,397 bytes
- **File Type**: .cl
- **Link to Source**: [modules/imgproc/src/opencl/threshold_mask.cl](../../../../modules/imgproc/src/opencl/threshold_mask.cl)
