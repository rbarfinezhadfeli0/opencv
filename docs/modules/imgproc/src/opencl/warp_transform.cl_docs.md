# Documentation for `modules/imgproc/src/opencl/warp_transform.cl`

## File Metadata

- **Full Path**: `modules/imgproc/src/opencl/warp_transform.cl`
- **File Name**: `warp_transform.cl`
- **File Size**: 15,957 bytes
- **File Type**: .cl
- **Link to Source**: [modules/imgproc/src/opencl/warp_transform.cl](../../../../modules/imgproc/src/opencl/warp_transform.cl)
