# Documentation for `modules/imgproc/src/tables.cpp`

## File Metadata

- **Full Path**: `modules/imgproc/src/tables.cpp`
- **File Name**: `tables.cpp`
- **File Size**: 14,672 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/imgproc/src/tables.cpp](../../../modules/imgproc/src/tables.cpp)
