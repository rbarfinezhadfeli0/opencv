# Documentation for `modules/imgproc/test/ocl/test_houghlines.cpp`

## File Metadata

- **Full Path**: `modules/imgproc/test/ocl/test_houghlines.cpp`
- **File Name**: `test_houghlines.cpp`
- **File Size**: 5,334 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/imgproc/test/ocl/test_houghlines.cpp](../../../../modules/imgproc/test/ocl/test_houghlines.cpp)
