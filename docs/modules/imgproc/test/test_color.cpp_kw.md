# Keyword Map for `modules/imgproc/test/test_color.cpp`

## File Path and Links

- **Source File**: [modules/imgproc/test/test_color.cpp](../../../modules/imgproc/test/test_color.cpp)
- **Documentation**: [modules/imgproc/test/test_color.cpp_docs.md](test_color.cpp_docs.md)
...
- **ArrayTest**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
...
- **CV_16U**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **CV_32F**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **CV_8U**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **CV_ColorCvtBaseTest**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **CV_MAKETYPE**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **CV_MAT_DEPTH**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
...
- **INPUT**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
...
- **NULL**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)

### O

- **OUTPUT**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
...
- **REF_OUTPUT**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **RNG**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **Redistribution**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)

### S

- **Scalar**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
...
- **_allow_16u**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **_allow_32f**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **_custom_inv_transform**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
...
- **allow_16u**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **allow_32f**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
...
- **base**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **binary**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **blue_idx**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
...
- **called**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **caused**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **char**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **class**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **code**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **color**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
...
- **convert_backward**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **convert_forward**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **convert_row_abc2bgr_32f_c3**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **convert_row_bgr2abc_32f_c3**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
...
- **custom_inv_transform**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
...
- **dst2**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **dst_row**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)

### E

- **element_wise_relative_error**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **else**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **endorse**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **enum**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
...
- **false**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **fitness**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **float**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
...
- **function**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **fwd_code**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **fwd_code_str**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **fwd_transform**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)

### G

- **get_minmax_bounds**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **get_rng**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **get_test_array_types_and_sizes**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **goods**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)

### H

- **high**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
...
- **hue_range**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)

### I

- **imgproc**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **implementation**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
...
- **inplace**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **input**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
...
- **inv_code**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **inv_code_str**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **inv_transform**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
...
- **low**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
...
- **prepare_test_case**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **prepare_to_validation**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
...
- **protected**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
...
- **push_back**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)

### R

- **randInt**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **ref_output**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
...
- **rng**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **run_func**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
...
- **sizes**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
...
- **src_row**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **srgb**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **static**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
...
- **template**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **test**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **test_array**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
- **test_case_idx**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
...
- **transformations**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
...
- **types**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
...
- **vector**: Technical term or identifier found in [test_color.cpp](test_color.cpp_docs.md)
