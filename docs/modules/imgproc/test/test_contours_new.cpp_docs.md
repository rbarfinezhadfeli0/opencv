# Documentation for `modules/imgproc/test/test_contours_new.cpp`

## File Metadata

- **Full Path**: `modules/imgproc/test/test_contours_new.cpp`
- **File Name**: `test_contours_new.cpp`
- **File Size**: 20,901 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/imgproc/test/test_contours_new.cpp](../../../modules/imgproc/test/test_contours_new.cpp)
...
- **results()**: A function/method defined in this file
