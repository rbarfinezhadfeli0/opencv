# Documentation for `modules/imgproc/test/test_fitellipse_ams.cpp`

## File Metadata

- **Full Path**: `modules/imgproc/test/test_fitellipse_ams.cpp`
- **File Name**: `test_fitellipse_ams.cpp`
- **File Size**: 19,767 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/imgproc/test/test_fitellipse_ams.cpp](../../../modules/imgproc/test/test_fitellipse_ams.cpp)
