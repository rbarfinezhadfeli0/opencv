# Documentation for `modules/imgproc/test/test_intelligent_scissors.cpp`

## File Metadata

- **Full Path**: `modules/imgproc/test/test_intelligent_scissors.cpp`
- **File Name**: `test_intelligent_scissors.cpp`
- **File Size**: 12,829 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/imgproc/test/test_intelligent_scissors.cpp](../../../modules/imgproc/test/test_intelligent_scissors.cpp)
...
- **GENERATE_TEST_DATA()**: A function/method defined in this file
- **tool()**: A function/method defined in this file
