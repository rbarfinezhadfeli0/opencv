# Documentation for `modules/imgproc/test/test_intersectconvexconvex.cpp`

## File Metadata

- **Full Path**: `modules/imgproc/test/test_intersectconvexconvex.cpp`
- **File Name**: `test_intersectconvexconvex.cpp`
- **File Size**: 12,378 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/imgproc/test/test_intersectconvexconvex.cpp](../../../modules/imgproc/test/test_intersectconvexconvex.cpp)
