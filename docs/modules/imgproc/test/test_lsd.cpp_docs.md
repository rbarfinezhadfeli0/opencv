# Documentation for `modules/imgproc/test/test_lsd.cpp`

## File Metadata

- **Full Path**: `modules/imgproc/test/test_lsd.cpp`
- **File Name**: `test_lsd.cpp`
- **File Size**: 11,490 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/imgproc/test/test_lsd.cpp](../../../modules/imgproc/test/test_lsd.cpp)
...
- **Imgproc_LSD_NONE**: A class/struct defined in this file
- **Imgproc_LSD_Common**: A class/struct defined in this file
- **Imgproc_LSD_STD**: A class/struct defined in this file
- **Imgproc_LSD_ADV**: A class/struct defined in this file
- **LSDBase**: A class/struct defined in this file
