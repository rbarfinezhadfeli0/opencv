# Documentation for `modules/imgproc/test/test_precomp.hpp`

## File Metadata

- **Full Path**: `modules/imgproc/test/test_precomp.hpp`
- **File Name**: `test_precomp.hpp`
- **File Size**: 567 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/imgproc/test/test_precomp.hpp](../../../modules/imgproc/test/test_precomp.hpp)
