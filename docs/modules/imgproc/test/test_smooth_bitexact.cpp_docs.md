# Documentation for `modules/imgproc/test/test_smooth_bitexact.cpp`

## File Metadata

- **Full Path**: `modules/imgproc/test/test_smooth_bitexact.cpp`
- **File Name**: `test_smooth_bitexact.cpp`
- **File Size**: 16,079 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/imgproc/test/test_smooth_bitexact.cpp](../../../modules/imgproc/test/test_smooth_bitexact.cpp)
...
- **GaussianBlurVsBitexact**: A class/struct defined in this file

### Functions and Methods

- **CV_TEST_INACCURATE_GAUSSIAN_BLUR()**: A function/method defined in this file
