# Documentation for `modules/imgproc/test/test_structuring_element.cpp`

## File Metadata

- **Full Path**: `modules/imgproc/test/test_structuring_element.cpp`
- **File Name**: `test_structuring_element.cpp`
- **File Size**: 427 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/imgproc/test/test_structuring_element.cpp](../../../modules/imgproc/test/test_structuring_element.cpp)
