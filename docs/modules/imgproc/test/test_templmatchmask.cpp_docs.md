# Documentation for `modules/imgproc/test/test_templmatchmask.cpp`

## File Metadata

- **Full Path**: `modules/imgproc/test/test_templmatchmask.cpp`
- **File Name**: `test_templmatchmask.cpp`
- **File Size**: 10,130 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/imgproc/test/test_templmatchmask.cpp](../../../modules/imgproc/test/test_templmatchmask.cpp)
...
- **Imgproc_MatchTemplateWithMask2**: A class/struct defined in this file
- **Imgproc_MatchTemplateWithMask**: A class/struct defined in this file
