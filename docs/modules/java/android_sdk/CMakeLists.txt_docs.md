# Documentation for `modules/java/android_sdk/CMakeLists.txt`

## File Metadata

- **Full Path**: `modules/java/android_sdk/CMakeLists.txt`
- **File Name**: `CMakeLists.txt`
- **File Size**: 11,164 bytes
- **File Type**: .txt
- **Link to Source**: [modules/java/android_sdk/CMakeLists.txt](../../../modules/java/android_sdk/CMakeLists.txt)
