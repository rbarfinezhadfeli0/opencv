# Documentation for `modules/java/android_sdk/android_gradle_lib/`
...
**Path**: `modules/java/android_sdk/android_gradle_lib/`
**Direct Files**: 1
**Subfolders**: 1
...
- **[AndroidManifest.xml](AndroidManifest.xml_docs.md)**: XML file
...
- **Parent Folder**: [modules/java/android_sdk/](../android_sdk/doc.md)
