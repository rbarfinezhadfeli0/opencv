# Documentation for `modules/java/android_sdk/android_gradle_lib/res/values/`
...
**Path**: `modules/java/android_sdk/android_gradle_lib/res/values/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[attrs.xml](attrs.xml_docs.md)**: XML file
...
- **Parent Folder**: [modules/java/android_sdk/android_gradle_lib/res/](../res/doc.md)
