# Documentation for `modules/java/android_sdk/android_lib/res/`
...
**Path**: `modules/java/android_sdk/android_lib/res/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [modules/java/android_sdk/android_lib/](../android_lib/doc.md)
