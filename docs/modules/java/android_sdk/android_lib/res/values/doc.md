# Documentation for `modules/java/android_sdk/android_lib/res/values/`
...
**Path**: `modules/java/android_sdk/android_lib/res/values/`
**Direct Files**: 1
**Subfolders**: 0
...
- **Parent Folder**: [modules/java/android_sdk/android_lib/res/](../res/doc.md)
