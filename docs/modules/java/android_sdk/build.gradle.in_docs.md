# Documentation for `modules/java/android_sdk/build.gradle.in`

## File Metadata

- **Full Path**: `modules/java/android_sdk/build.gradle.in`
- **File Name**: `build.gradle.in`
- **File Size**: 5,216 bytes
- **File Type**: .in
- **Link to Source**: [modules/java/android_sdk/build.gradle.in](../../../modules/java/android_sdk/build.gradle.in)

## Purpose and Role

This file is located in the `modules/java/android_sdk` directory and serves as part of the OpenCV library infrastructure.
