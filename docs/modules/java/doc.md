# Documentation for `modules/java/`
...
- **android_sdk/** - See [android_sdk/doc.md](android_sdk/doc.md)
- **generator/** - See [generator/doc.md](generator/doc.md)
- **jar/** - See [jar/doc.md](jar/doc.md)
...
- **Parent Folder**: [modules/](../modules/doc.md)
