# Documentation for `modules/java/generator/CMakeLists.txt`

## File Metadata

- **Full Path**: `modules/java/generator/CMakeLists.txt`
- **File Name**: `CMakeLists.txt`
- **File Size**: 4,117 bytes
- **File Type**: .txt
- **Link to Source**: [modules/java/generator/CMakeLists.txt](../../../modules/java/generator/CMakeLists.txt)
