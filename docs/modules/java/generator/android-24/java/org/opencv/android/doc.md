# Documentation for `modules/java/generator/android-24/java/org/opencv/android/`
...
**Path**: `modules/java/generator/android-24/java/org/opencv/android/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[NativeCameraView.java](NativeCameraView.java_docs.md)**: JAVA file
...
- **Parent Folder**: [modules/java/generator/android-24/java/org/opencv/](../opencv/doc.md)
