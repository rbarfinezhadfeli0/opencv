# Documentation for `modules/java/generator/src/cpp/Mat.cpp`

## File Metadata

- **Full Path**: `modules/java/generator/src/cpp/Mat.cpp`
- **File Name**: `Mat.cpp`
- **File Size**: 84,753 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/java/generator/src/cpp/Mat.cpp](../../../../../modules/java/generator/src/cpp/Mat.cpp)
...
- **JavaOpenCVTrait**: A class/struct defined in this file
...
- **JOCvT()**: A function/method defined in this file
