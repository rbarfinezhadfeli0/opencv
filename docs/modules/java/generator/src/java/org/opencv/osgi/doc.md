# Documentation for `modules/java/generator/src/java/org/opencv/osgi/`
...
**Path**: `modules/java/generator/src/java/org/opencv/osgi/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[OpenCVNativeLoader.java.in](OpenCVNativeLoader.java.in_docs.md)**: IN file
- **[OpenCVInterface.java](OpenCVInterface.java_docs.md)**: JAVA file
...
- **Parent Folder**: [modules/java/generator/src/java/org/opencv/](../opencv/doc.md)
