# Documentation for `modules/java/jar/CMakeLists.txt`

## File Metadata

- **Full Path**: `modules/java/jar/CMakeLists.txt`
- **File Name**: `CMakeLists.txt`
- **File Size**: 5,809 bytes
- **File Type**: .txt
- **Link to Source**: [modules/java/jar/CMakeLists.txt](../../../modules/java/jar/CMakeLists.txt)
