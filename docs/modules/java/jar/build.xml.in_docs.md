# Documentation for `modules/java/jar/build.xml.in`

## File Metadata

- **Full Path**: `modules/java/jar/build.xml.in`
- **File Name**: `build.xml.in`
- **File Size**: 2,882 bytes
- **File Type**: .in
- **Link to Source**: [modules/java/jar/build.xml.in](../../../modules/java/jar/build.xml.in)
