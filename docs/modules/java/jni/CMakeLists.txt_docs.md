# Documentation for `modules/java/jni/CMakeLists.txt`

## File Metadata

- **Full Path**: `modules/java/jni/CMakeLists.txt`
- **File Name**: `CMakeLists.txt`
- **File Size**: 4,060 bytes
- **File Type**: .txt
- **Link to Source**: [modules/java/jni/CMakeLists.txt](../../../modules/java/jni/CMakeLists.txt)

## Purpose and Role

This file is located in the `modules/java/jni` directory and serves as part of the OpenCV library infrastructure.
