# Documentation for `modules/java/test/android_test/tests_module/`
...
**Path**: `modules/java/test/android_test/tests_module/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[build.gradle.in](build.gradle.in_docs.md)**: IN file
