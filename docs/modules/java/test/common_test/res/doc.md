# Documentation for `modules/java/test/common_test/res/`
...
**Path**: `modules/java/test/common_test/res/`
**Direct Files**: 0
**Subfolders**: 4
...
- **Parent Folder**: [modules/java/test/common_test/](../common_test/doc.md)
