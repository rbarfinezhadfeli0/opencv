# Documentation for `modules/java/test/common_test/res/drawable/`
...
**Path**: `modules/java/test/common_test/res/drawable/`
**Direct Files**: 3
**Subfolders**: 0
...
- **[chessboard.jpg](chessboard.jpg_docs.md)**: JPG file
- **[icon.png](icon.png_docs.md)**: PNG file
...
- **Parent Folder**: [modules/java/test/common_test/res/](../res/doc.md)
