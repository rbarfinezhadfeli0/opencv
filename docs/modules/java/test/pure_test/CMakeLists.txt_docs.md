# Documentation for `modules/java/test/pure_test/CMakeLists.txt`

## File Metadata

- **Full Path**: `modules/java/test/pure_test/CMakeLists.txt`
- **File Name**: `CMakeLists.txt`
- **File Size**: 3,187 bytes
- **File Type**: .txt
- **Link to Source**: [modules/java/test/pure_test/CMakeLists.txt](../../../../modules/java/test/pure_test/CMakeLists.txt)

## Purpose and Role

This file is located in the `modules/java/test/pure_test` directory and serves as part of the OpenCV library infrastructure.
