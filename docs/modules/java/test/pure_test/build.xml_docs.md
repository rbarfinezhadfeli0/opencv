# Documentation for `modules/java/test/pure_test/build.xml`

## File Metadata

- **Full Path**: `modules/java/test/pure_test/build.xml`
- **File Name**: `build.xml`
- **File Size**: 2,588 bytes
- **File Type**: .xml
- **Link to Source**: [modules/java/test/pure_test/build.xml](../../../../modules/java/test/pure_test/build.xml)
