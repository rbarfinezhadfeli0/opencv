# Documentation for `modules/java/test/pure_test/lib/`
...
**Path**: `modules/java/test/pure_test/lib/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[junit-4.11.jar](junit-4.11.jar_docs.md)**: JAR file
...
- **Parent Folder**: [modules/java/test/pure_test/](../pure_test/doc.md)
