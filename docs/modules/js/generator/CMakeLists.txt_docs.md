# Documentation for `modules/js/generator/CMakeLists.txt`

## File Metadata

- **Full Path**: `modules/js/generator/CMakeLists.txt`
- **File Name**: `CMakeLists.txt`
- **File Size**: 4,958 bytes
- **File Type**: .txt
- **Link to Source**: [modules/js/generator/CMakeLists.txt](../../../modules/js/generator/CMakeLists.txt)
