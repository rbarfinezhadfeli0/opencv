# Documentation for `modules/js/perf/`
...
- **perf_imgproc/** - See [perf_imgproc/doc.md](perf_imgproc/doc.md)
...
- **Parent Folder**: [modules/js/](../js/doc.md)
...
**Subfolders**:
- [perf_imgproc/](perf_imgproc/doc.md)
