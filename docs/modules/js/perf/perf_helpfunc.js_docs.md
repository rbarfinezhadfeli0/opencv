# Documentation for `modules/js/perf/perf_helpfunc.js`

## File Metadata

- **Full Path**: `modules/js/perf/perf_helpfunc.js`
- **File Name**: `perf_helpfunc.js`
- **File Size**: 10,260 bytes
- **File Type**: .js
- **Link to Source**: [modules/js/perf/perf_helpfunc.js](../../../modules/js/perf/perf_helpfunc.js)
...
- **judgeCombin()**: A function/method defined in this file
- **permute()**: A function/method defined in this file
- **constructParamLog()**: A function/method defined in this file
