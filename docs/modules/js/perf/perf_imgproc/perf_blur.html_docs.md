# Documentation for `modules/js/perf/perf_imgproc/perf_blur.html`

## File Metadata

- **Full Path**: `modules/js/perf/perf_imgproc/perf_blur.html`
- **File Name**: `perf_blur.html`
- **File Size**: 2,215 bytes
- **File Type**: .html
- **Link to Source**: [modules/js/perf/perf_imgproc/perf_blur.html](../../../../modules/js/perf/perf_imgproc/perf_blur.html)
