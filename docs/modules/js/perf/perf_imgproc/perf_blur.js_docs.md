# Documentation for `modules/js/perf/perf_imgproc/perf_blur.js`

## File Metadata

- **Full Path**: `modules/js/perf/perf_imgproc/perf_blur.js`
- **File Name**: `perf_blur.js`
- **File Size**: 5,012 bytes
- **File Type**: .js
- **Link to Source**: [modules/js/perf/perf_imgproc/perf_blur.js](../../../../modules/js/perf/perf_imgproc/perf_blur.js)
...
- **addBlurModeCase()**: A function/method defined in this file
- **addBlurCase()**: A function/method defined in this file
