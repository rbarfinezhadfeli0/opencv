# Documentation for `modules/js/perf/perf_imgproc/perf_cvtcolor.html`

## File Metadata

- **Full Path**: `modules/js/perf/perf_imgproc/perf_cvtcolor.html`
- **File Name**: `perf_cvtcolor.html`
- **File Size**: 2,211 bytes
- **File Type**: .html
- **Link to Source**: [modules/js/perf/perf_imgproc/perf_cvtcolor.html](../../../../modules/js/perf/perf_imgproc/perf_cvtcolor.html)
