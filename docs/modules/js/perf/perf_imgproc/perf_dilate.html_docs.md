# Documentation for `modules/js/perf/perf_imgproc/perf_dilate.html`

## File Metadata

- **Full Path**: `modules/js/perf/perf_imgproc/perf_dilate.html`
- **File Name**: `perf_dilate.html`
- **File Size**: 2,201 bytes
- **File Type**: .html
- **Link to Source**: [modules/js/perf/perf_imgproc/perf_dilate.html](../../../../modules/js/perf/perf_imgproc/perf_dilate.html)
