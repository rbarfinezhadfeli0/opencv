# Documentation for `modules/js/perf/perf_imgproc/perf_erode.html`

## File Metadata

- **Full Path**: `modules/js/perf/perf_imgproc/perf_erode.html`
- **File Name**: `perf_erode.html`
- **File Size**: 2,199 bytes
- **File Type**: .html
- **Link to Source**: [modules/js/perf/perf_imgproc/perf_erode.html](../../../../modules/js/perf/perf_imgproc/perf_erode.html)
