# Documentation for `modules/js/perf/perf_imgproc/perf_erode.js`

## File Metadata

- **Full Path**: `modules/js/perf/perf_imgproc/perf_erode.js`
- **File Name**: `perf_erode.js`
- **File Size**: 3,964 bytes
- **File Type**: .js
- **Link to Source**: [modules/js/perf/perf_imgproc/perf_erode.js](../../../../modules/js/perf/perf_imgproc/perf_erode.js)
...
- **addErodeModeCase()**: A function/method defined in this file
- **addErodeCase()**: A function/method defined in this file
