# Documentation for `modules/js/perf/perf_imgproc/perf_filter2D.html`

## File Metadata

- **Full Path**: `modules/js/perf/perf_imgproc/perf_filter2D.html`
- **File Name**: `perf_filter2D.html`
- **File Size**: 2,215 bytes
- **File Type**: .html
- **Link to Source**: [modules/js/perf/perf_imgproc/perf_filter2D.html](../../../../modules/js/perf/perf_imgproc/perf_filter2D.html)
