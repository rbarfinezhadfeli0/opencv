# Documentation for `modules/js/perf/perf_imgproc/perf_medianBlur.html`

## File Metadata

- **Full Path**: `modules/js/perf/perf_imgproc/perf_medianBlur.html`
- **File Name**: `perf_medianBlur.html`
- **File Size**: 2,212 bytes
- **File Type**: .html
- **Link to Source**: [modules/js/perf/perf_imgproc/perf_medianBlur.html](../../../../modules/js/perf/perf_imgproc/perf_medianBlur.html)
