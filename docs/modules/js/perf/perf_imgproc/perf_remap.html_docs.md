# Documentation for `modules/js/perf/perf_imgproc/perf_remap.html`

## File Metadata

- **Full Path**: `modules/js/perf/perf_imgproc/perf_remap.html`
- **File Name**: `perf_remap.html`
- **File Size**: 2,224 bytes
- **File Type**: .html
- **Link to Source**: [modules/js/perf/perf_imgproc/perf_remap.html](../../../../modules/js/perf/perf_imgproc/perf_remap.html)
