# Documentation for `modules/js/perf/perf_imgproc/perf_resize.html`

## File Metadata

- **Full Path**: `modules/js/perf/perf_imgproc/perf_resize.html`
- **File Name**: `perf_resize.html`
- **File Size**: 2,207 bytes
- **File Type**: .html
- **Link to Source**: [modules/js/perf/perf_imgproc/perf_resize.html](../../../../modules/js/perf/perf_imgproc/perf_resize.html)
