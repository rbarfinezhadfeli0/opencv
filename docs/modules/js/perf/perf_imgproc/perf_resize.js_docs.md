# Documentation for `modules/js/perf/perf_imgproc/perf_resize.js`

## File Metadata

- **Full Path**: `modules/js/perf/perf_imgproc/perf_resize.js`
- **File Name**: `perf_resize.js`
- **File Size**: 6,087 bytes
- **File Type**: .js
- **Link to Source**: [modules/js/perf/perf_imgproc/perf_resize.js](../../../../modules/js/perf/perf_imgproc/perf_resize.js)
...
- **addResizeCase()**: A function/method defined in this file
- **addResizeModeCase()**: A function/method defined in this file
