# Documentation for `modules/js/perf/perf_imgproc/perf_scharr.html`

## File Metadata

- **Full Path**: `modules/js/perf/perf_imgproc/perf_scharr.html`
- **File Name**: `perf_scharr.html`
- **File Size**: 2,226 bytes
- **File Type**: .html
- **Link to Source**: [modules/js/perf/perf_imgproc/perf_scharr.html](../../../../modules/js/perf/perf_imgproc/perf_scharr.html)
