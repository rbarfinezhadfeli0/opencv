# Documentation for `modules/js/perf/perf_imgproc/perf_scharr.js`

## File Metadata

- **Full Path**: `modules/js/perf/perf_imgproc/perf_scharr.js`
- **File Name**: `perf_scharr.js`
- **File Size**: 6,559 bytes
- **File Type**: .js
- **Link to Source**: [modules/js/perf/perf_imgproc/perf_scharr.js](../../../../modules/js/perf/perf_imgproc/perf_scharr.js)
...
- **addScharrCase()**: A function/method defined in this file
- **addScharrModeCase()**: A function/method defined in this file
