# Documentation for `modules/js/perf/perf_imgproc/perf_sobel.html`

## File Metadata

- **Full Path**: `modules/js/perf/perf_imgproc/perf_sobel.html`
- **File Name**: `perf_sobel.html`
- **File Size**: 2,224 bytes
- **File Type**: .html
- **Link to Source**: [modules/js/perf/perf_imgproc/perf_sobel.html](../../../../modules/js/perf/perf_imgproc/perf_sobel.html)
