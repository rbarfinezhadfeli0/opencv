# Documentation for `modules/js/perf/perf_imgproc/perf_sobel.js`

## File Metadata

- **Full Path**: `modules/js/perf/perf_imgproc/perf_sobel.js`
- **File Name**: `perf_sobel.js`
- **File Size**: 7,494 bytes
- **File Type**: .js
- **Link to Source**: [modules/js/perf/perf_imgproc/perf_sobel.js](../../../../modules/js/perf/perf_imgproc/perf_sobel.js)
...
- **addSobelCase()**: A function/method defined in this file
- **addSobelModeCase()**: A function/method defined in this file
