# Documentation for `modules/js/perf/perf_imgproc/perf_warpAffine.html`

## File Metadata

- **Full Path**: `modules/js/perf/perf_imgproc/perf_warpAffine.html`
- **File Name**: `perf_warpAffine.html`
- **File Size**: 2,231 bytes
- **File Type**: .html
- **Link to Source**: [modules/js/perf/perf_imgproc/perf_warpAffine.html](../../../../modules/js/perf/perf_imgproc/perf_warpAffine.html)
