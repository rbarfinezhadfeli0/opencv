# Documentation for `modules/js/perf/perf_imgproc/perf_warpPerspective.js`

## File Metadata

- **Full Path**: `modules/js/perf/perf_imgproc/perf_warpPerspective.js`
- **File Name**: `perf_warpPerspective.js`
- **File Size**: 5,458 bytes
- **File Type**: .js
- **Link to Source**: [modules/js/perf/perf_imgproc/perf_warpPerspective.js](../../../../modules/js/perf/perf_imgproc/perf_warpPerspective.js)
...
- **addWarpPerspectiveCase()**: A function/method defined in this file
- **genBenchmarkCase()**: A function/method defined in this file
- **main()**: A function/method defined in this file
- **addWarpPerspectiveModeCase()**: A function/method defined in this file
