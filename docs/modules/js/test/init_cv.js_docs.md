# Documentation for `modules/js/test/init_cv.js`

## File Metadata

- **Full Path**: `modules/js/test/init_cv.js`
- **File Name**: `init_cv.js`
- **File Size**: 590 bytes
- **File Type**: .js
- **Link to Source**: [modules/js/test/init_cv.js](../../../modules/js/test/init_cv.js)
