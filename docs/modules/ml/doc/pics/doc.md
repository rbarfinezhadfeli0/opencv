# Documentation for `modules/ml/doc/pics/`
...
- **[sigmoid_bipolar.png](sigmoid_bipolar.png_docs.md)**: PNG file
- **[mlp.png](mlp.png_docs.md)**: PNG file
- **[SVM_Comparison.png](SVM_Comparison.png_docs.md)**: PNG file
- **[neuron_model.png](neuron_model.png_docs.md)**: PNG file
...
- **Parent Folder**: [modules/ml/doc/](../doc/doc.md)
