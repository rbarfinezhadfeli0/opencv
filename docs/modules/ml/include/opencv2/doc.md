# Documentation for `modules/ml/include/opencv2/`
...
**Path**: `modules/ml/include/opencv2/`
**Direct Files**: 1
**Subfolders**: 1
...
- **[ml.hpp](ml.hpp_docs.md)**: HPP file
...
- **Parent Folder**: [modules/ml/include/](../include/doc.md)
