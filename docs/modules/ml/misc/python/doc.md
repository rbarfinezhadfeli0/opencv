# Documentation for `modules/ml/misc/python/`
...
- **[pyopencv_ml.hpp](pyopencv_ml.hpp_docs.md)**: HPP file
...
- **Parent Folder**: [modules/ml/misc/](../misc/doc.md)
