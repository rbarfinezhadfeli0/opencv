# Documentation for `modules/ml/misc/python/test/`
...
**Path**: `modules/ml/misc/python/test/`
**Direct Files**: 4
**Subfolders**: 0
...
- **[test_letter_recog.py](test_letter_recog.py_docs.md)**: PY file
- **[test_knearest.py](test_knearest.py_docs.md)**: PY file
- **[test_goodfeatures.py](test_goodfeatures.py_docs.md)**: PY file
- **[test_digits.py](test_digits.py_docs.md)**: PY file
...
- **Parent Folder**: [modules/ml/misc/python/](../python/doc.md)
