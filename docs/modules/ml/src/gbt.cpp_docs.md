# Documentation for `modules/ml/src/gbt.cpp`

## File Metadata

- **Full Path**: `modules/ml/src/gbt.cpp`
- **File Name**: `gbt.cpp`
- **File Size**: 41,345 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/ml/src/gbt.cpp](../../../modules/ml/src/gbt.cpp)
...
- **Sample_predictor**: A class/struct defined in this file
- **Tree_predictor**: A class/struct defined in this file
