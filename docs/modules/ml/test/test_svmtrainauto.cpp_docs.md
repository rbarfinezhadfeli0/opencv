# Documentation for `modules/ml/test/test_svmtrainauto.cpp`

## File Metadata

- **Full Path**: `modules/ml/test/test_svmtrainauto.cpp`
- **File Name**: `test_svmtrainauto.cpp`
- **File Size**: 5,722 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/ml/test/test_svmtrainauto.cpp](../../../modules/ml/test/test_svmtrainauto.cpp)
