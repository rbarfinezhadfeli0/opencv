# Documentation for `modules/objc/generator/CMakeLists.txt`

## File Metadata

- **Full Path**: `modules/objc/generator/CMakeLists.txt`
- **File Name**: `CMakeLists.txt`
- **File Size**: 5,175 bytes
- **File Type**: .txt
- **Link to Source**: [modules/objc/generator/CMakeLists.txt](../../../modules/objc/generator/CMakeLists.txt)
