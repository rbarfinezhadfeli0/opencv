# Documentation for `modules/objc/generator/templates/cmakelists.template`

## File Metadata

- **Full Path**: `modules/objc/generator/templates/cmakelists.template`
- **File Name**: `cmakelists.template`
- **File Size**: 2,667 bytes
- **File Type**: .template
- **Link to Source**: [modules/objc/generator/templates/cmakelists.template](../../../../modules/objc/generator/templates/cmakelists.template)
