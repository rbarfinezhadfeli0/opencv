# Documentation for `modules/objc/test/cmakelists.template`

## File Metadata

- **Full Path**: `modules/objc/test/cmakelists.template`
- **File Name**: `cmakelists.template`
- **File Size**: 1,744 bytes
- **File Type**: .template
- **Link to Source**: [modules/objc/test/cmakelists.template](../../../modules/objc/test/cmakelists.template)

## Purpose and Role

This file is located in the `modules/objc/test` directory and serves as part of the OpenCV library infrastructure.
