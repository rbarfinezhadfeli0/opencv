# Documentation for `modules/objdetect/doc/objdetect.bib`

## File Metadata

- **Full Path**: `modules/objdetect/doc/objdetect.bib`
- **File Name**: `objdetect.bib`
- **File Size**: 1,676 bytes
- **File Type**: .bib
- **Link to Source**: [modules/objdetect/doc/objdetect.bib](../../../modules/objdetect/doc/objdetect.bib)

## Purpose and Role

This file is located in the `modules/objdetect/doc` directory and serves as part of the OpenCV library infrastructure.
