# Documentation for `modules/objdetect/misc/python/`
...
**Path**: `modules/objdetect/misc/python/`
**Direct Files**: 1
**Subfolders**: 1
...
- **[pyopencv_objdetect.hpp](pyopencv_objdetect.hpp_docs.md)**: HPP file
...
- **Parent Folder**: [modules/objdetect/misc/](../misc/doc.md)
