# Documentation for `modules/objdetect/misc/python/test/`
...
**Path**: `modules/objdetect/misc/python/test/`
**Direct Files**: 5
**Subfolders**: 0
...
- **[test_peopledetect.py](test_peopledetect.py_docs.md)**: PY file
- **[test_objdetect_aruco.py](test_objdetect_aruco.py_docs.md)**: PY file
- **[test_qrcode_detect.py](test_qrcode_detect.py_docs.md)**: PY file
- **[test_barcode_detector.py](test_barcode_detector.py_docs.md)**: PY file
- **[test_facedetect.py](test_facedetect.py_docs.md)**: PY file
...
- **Parent Folder**: [modules/objdetect/misc/python/](../python/doc.md)
