# Documentation for `modules/objdetect/perf/opencl/`
...
**Path**: `modules/objdetect/perf/opencl/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[perf_hogdetect.cpp](perf_hogdetect.cpp_docs.md)**: CPP file
- **[perf_cascades.cpp](perf_cascades.cpp_docs.md)**: CPP file
...
- **Parent Folder**: [modules/objdetect/perf/](../perf/doc.md)
