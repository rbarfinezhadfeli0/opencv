# Documentation for `modules/objdetect/perf/perf_aruco.cpp`

## File Metadata

- **Full Path**: `modules/objdetect/perf/perf_aruco.cpp`
- **File Name**: `perf_aruco.cpp`
- **File Size**: 12,661 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/objdetect/perf/perf_aruco.cpp](../../../modules/objdetect/perf/perf_aruco.cpp)
...
- **Aruco3Params**: A class/struct defined in this file
- **MarkerPainter**: A class/struct defined in this file
