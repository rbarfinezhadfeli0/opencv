# Documentation for `modules/objdetect/src/aruco/apriltag/apriltag_quad_thresh.cpp`

## File Metadata

- **Full Path**: `modules/objdetect/src/aruco/apriltag/apriltag_quad_thresh.cpp`
- **File Name**: `apriltag_quad_thresh.cpp`
- **File Size**: 54,663 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/objdetect/src/aruco/apriltag/apriltag_quad_thresh.cpp](../../../../../modules/objdetect/src/aruco/apriltag/apriltag_quad_thresh.cpp)
...
- **remove_vertex**: A class/struct defined in this file
- **sQuad**: A class/struct defined in this file
- **uint64_zarray_entry**: A class/struct defined in this file
- **line_fit_pt**: A class/struct defined in this file
- **pt**: A class/struct defined in this file
- **segment**: A class/struct defined in this file
- **quad_task**: A class/struct defined in this file

### Functions and Methods

- **APRIL_DEBUG()**: A function/method defined in this file
- **DO_CONN()**: A function/method defined in this file
- **MERGE()**: A function/method defined in this file
- **MAYBE_SWAP()**: A function/method defined in this file
- **DO_UNIONFIND()**: A function/method defined in this file
