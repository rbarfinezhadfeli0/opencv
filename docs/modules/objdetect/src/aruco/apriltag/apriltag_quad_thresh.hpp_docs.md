# Documentation for `modules/objdetect/src/aruco/apriltag/apriltag_quad_thresh.hpp`

## File Metadata

- **Full Path**: `modules/objdetect/src/aruco/apriltag/apriltag_quad_thresh.hpp`
- **File Name**: `apriltag_quad_thresh.hpp`
- **File Size**: 3,774 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/objdetect/src/aruco/apriltag/apriltag_quad_thresh.hpp](../../../../../modules/objdetect/src/aruco/apriltag/apriltag_quad_thresh.hpp)
...
- **_OPENCV_APRIL_QUAD_THRESH_HPP_()**: A function/method defined in this file
