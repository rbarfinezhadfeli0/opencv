# Documentation for `modules/objdetect/src/aruco/aruco_board.cpp`

## File Metadata

- **Full Path**: `modules/objdetect/src/aruco/aruco_board.cpp`
- **File Name**: `aruco_board.cpp`
- **File Size**: 25,279 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/objdetect/src/aruco/aruco_board.cpp](../../../../modules/objdetect/src/aruco/aruco_board.cpp)
...
- **GridBoardImpl**: A class/struct defined in this file
- **CharucoBoardImpl**: A class/struct defined in this file
