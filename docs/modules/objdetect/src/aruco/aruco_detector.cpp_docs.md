# Documentation for `modules/objdetect/src/aruco/aruco_detector.cpp`

## File Metadata

- **Full Path**: `modules/objdetect/src/aruco/aruco_detector.cpp`
- **File Name**: `aruco_detector.cpp`
- **File Size**: 68,750 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/objdetect/src/aruco/aruco_detector.cpp](../../../../modules/objdetect/src/aruco/aruco_detector.cpp)

## Purpose and Role

This file is located in the `modules/objdetect/src/aruco` directory and serves as part of the OpenCV library infrastructure.
...
- **Board**: A class/struct defined in this file
- **MarkerCandidate**: A class/struct defined in this file
- **DictionaryMode**: A class/struct defined in this file
- **ArucoDetector**: A class/struct defined in this file
- **MarkerCandidateTree**: A class/struct defined in this file

### Functions and Methods

- **refineCandidateLines()**: A function/method defined in this file
- **detectMarkers()**: A function/method defined in this file
- **refineDetectedMarkers()**: A function/method defined in this file
...
**C++ Includes:**
- `cmath`
- `apriltag/apriltag_quad_thresh.hpp`
- `../precomp.hpp`
- `map`
