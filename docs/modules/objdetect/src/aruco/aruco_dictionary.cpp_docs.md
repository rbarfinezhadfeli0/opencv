# Documentation for `modules/objdetect/src/aruco/aruco_dictionary.cpp`

## File Metadata

- **Full Path**: `modules/objdetect/src/aruco/aruco_dictionary.cpp`
- **File Name**: `aruco_dictionary.cpp`
- **File Size**: 17,816 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/objdetect/src/aruco/aruco_dictionary.cpp](../../../../modules/objdetect/src/aruco/aruco_dictionary.cpp)
...
- `apriltag/predefined_dictionaries_apriltag.hpp`
