# Documentation for `modules/objdetect/src/aruco/aruco_utils.hpp`

## File Metadata

- **Full Path**: `modules/objdetect/src/aruco/aruco_utils.hpp`
- **File Name**: `aruco_utils.hpp`
- **File Size**: 1,263 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/objdetect/src/aruco/aruco_utils.hpp](../../../../modules/objdetect/src/aruco/aruco_utils.hpp)
...
- **__OPENCV_OBJDETECT_ARUCO_UTILS_HPP__()**: A function/method defined in this file
