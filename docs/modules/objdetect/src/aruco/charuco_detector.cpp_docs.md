# Documentation for `modules/objdetect/src/aruco/charuco_detector.cpp`

## File Metadata

- **Full Path**: `modules/objdetect/src/aruco/charuco_detector.cpp`
- **File Name**: `charuco_detector.cpp`
- **File Size**: 31,837 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/objdetect/src/aruco/charuco_detector.cpp](../../../../modules/objdetect/src/aruco/charuco_detector.cpp)
...
- **CharucoDetector**: A class/struct defined in this file
