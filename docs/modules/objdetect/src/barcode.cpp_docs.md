# Documentation for `modules/objdetect/src/barcode.cpp`

## File Metadata

- **Full Path**: `modules/objdetect/src/barcode.cpp`
- **File Name**: `barcode.cpp`
- **File Size**: 13,465 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/objdetect/src/barcode.cpp](../../../modules/objdetect/src/barcode.cpp)
...
- **BarcodeImpl**: A class/struct defined in this file
- **BarDecode**: A class/struct defined in this file
- **definition**: A class/struct defined in this file
...
**C++ Includes:**
- `barcode_decoder/ean13_decoder.hpp`
- `opencv2/core/utils/filesystem.hpp`
- `graphical_code_detector_impl.hpp`
- `opencv2/objdetect/barcode.hpp`
- `barcode_detector/bardetect.hpp`
- `barcode_decoder/ean8_decoder.hpp`
- `precomp.hpp`
- `barcode_decoder/common/utils.hpp`
- `barcode_decoder/common/super_scale.hpp`
