# Documentation for `modules/objdetect/src/barcode_decoder/common/utils.hpp`

## File Metadata

- **Full Path**: `modules/objdetect/src/barcode_decoder/common/utils.hpp`
- **File Name**: `utils.hpp`
- **File Size**: 612 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/objdetect/src/barcode_decoder/common/utils.hpp](../../../../../modules/objdetect/src/barcode_decoder/common/utils.hpp)
...
- **OPENCV_BARCODE_UTILS_HPP()**: A function/method defined in this file
