# Documentation for `modules/objdetect/src/barcode_decoder/upcean_decoder.cpp`

## File Metadata

- **Full Path**: `modules/objdetect/src/barcode_decoder/upcean_decoder.cpp`
- **File Name**: `upcean_decoder.cpp`
- **File Size**: 10,022 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/objdetect/src/barcode_decoder/upcean_decoder.cpp](../../../../modules/objdetect/src/barcode_decoder/upcean_decoder.cpp)
