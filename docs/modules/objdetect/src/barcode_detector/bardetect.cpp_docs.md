# Documentation for `modules/objdetect/src/barcode_detector/bardetect.cpp`

## File Metadata

- **Full Path**: `modules/objdetect/src/barcode_detector/bardetect.cpp`
- **File Name**: `bardetect.cpp`
- **File Size**: 18,991 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/objdetect/src/barcode_detector/bardetect.cpp](../../../../modules/objdetect/src/barcode_detector/bardetect.cpp)
