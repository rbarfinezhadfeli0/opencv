# Documentation for `modules/objdetect/src/barcode_detector/`
...
**Path**: `modules/objdetect/src/barcode_detector/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[bardetect.cpp](bardetect.cpp_docs.md)**: CPP file
- **[bardetect.hpp](bardetect.hpp_docs.md)**: HPP file
