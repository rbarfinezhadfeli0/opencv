# Documentation for `modules/objdetect/src/cascadedetect.hpp`

## File Metadata

- **Full Path**: `modules/objdetect/src/cascadedetect.hpp`
- **File Name**: `cascadedetect.hpp`
- **File Size**: 22,811 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/objdetect/src/cascadedetect.hpp](../../../modules/objdetect/src/cascadedetect.hpp)
...
- **CascadeClassifierImpl**: A class/struct defined in this file
- **OptFeature**: A class/struct defined in this file
- **Feature**: A class/struct defined in this file
- **DTree**: A class/struct defined in this file
- **CascadeClassifierInvoker**: A class/struct defined in this file
- **Stump**: A class/struct defined in this file
- **RectWeigth**: A class/struct defined in this file
- **FeatureEvaluator**: A class/struct defined in this file
- **HaarEvaluator**: A class/struct defined in this file
- **LBPEvaluator**: A class/struct defined in this file
- **SparseCascadeClassifierInvoker**: A class/struct defined in this file
- **DTreeNode**: A class/struct defined in this file
- **Stage**: A class/struct defined in this file
- **FEval**: A class/struct defined in this file
- **Data**: A class/struct defined in this file
- **ScaleData**: A class/struct defined in this file
