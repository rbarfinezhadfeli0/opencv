# Documentation for `modules/objdetect/src/graphical_code_detector_impl.hpp`

## File Metadata

- **Full Path**: `modules/objdetect/src/graphical_code_detector_impl.hpp`
- **File Name**: `graphical_code_detector_impl.hpp`
- **File Size**: 1,504 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/objdetect/src/graphical_code_detector_impl.hpp](../../../modules/objdetect/src/graphical_code_detector_impl.hpp)
...
- **QRCodeDecoder**: A class/struct defined in this file
- **GraphicalCodeDetector**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_OBJDETECT_GRAPHICAL_CODE_DETECTOR_IMPL_HPP()**: A function/method defined in this file
