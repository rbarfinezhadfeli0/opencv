# Documentation for `modules/objdetect/src/opencl/cascadedetect.cl`

## File Metadata

- **Full Path**: `modules/objdetect/src/opencl/cascadedetect.cl`
- **File Name**: `cascadedetect.cl`
- **File Size**: 27,337 bytes
- **File Type**: .cl
- **Link to Source**: [modules/objdetect/src/opencl/cascadedetect.cl](../../../../modules/objdetect/src/opencl/cascadedetect.cl)
