# Documentation for `modules/objdetect/src/qrcode_encoder.cpp`

## File Metadata

- **Full Path**: `modules/objdetect/src/qrcode_encoder.cpp`
- **File Name**: `qrcode_encoder.cpp`
- **File Size**: 61,641 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/objdetect/src/qrcode_encoder.cpp](../../../modules/objdetect/src/qrcode_encoder.cpp)
...
- **QRCodeEncoderImpl**: A class/struct defined in this file
- **QRCodeDecoderImpl**: A class/struct defined in this file
