# Documentation for `modules/objdetect/test/opencl/`
...
**Path**: `modules/objdetect/test/opencl/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[test_hogdetector.cpp](test_hogdetector.cpp_docs.md)**: CPP file
...
- **Parent Folder**: [modules/objdetect/test/](../test/doc.md)
