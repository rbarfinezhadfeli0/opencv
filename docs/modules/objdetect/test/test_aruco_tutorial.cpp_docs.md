# Documentation for `modules/objdetect/test/test_aruco_tutorial.cpp`

## File Metadata

- **Full Path**: `modules/objdetect/test/test_aruco_tutorial.cpp`
- **File Name**: `test_aruco_tutorial.cpp`
- **File Size**: 12,085 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/objdetect/test/test_aruco_tutorial.cpp](../../../modules/objdetect/test/test_aruco_tutorial.cpp)
