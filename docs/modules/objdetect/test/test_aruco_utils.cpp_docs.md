# Documentation for `modules/objdetect/test/test_aruco_utils.cpp`

## File Metadata

- **Full Path**: `modules/objdetect/test/test_aruco_utils.cpp`
- **File Name**: `test_aruco_utils.cpp`
- **File Size**: 8,351 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/objdetect/test/test_aruco_utils.cpp](../../../modules/objdetect/test/test_aruco_utils.cpp)
