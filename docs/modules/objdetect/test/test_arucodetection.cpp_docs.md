# Documentation for `modules/objdetect/test/test_arucodetection.cpp`

## File Metadata

- **Full Path**: `modules/objdetect/test/test_arucodetection.cpp`
- **File Name**: `test_arucodetection.cpp`
- **File Size**: 36,420 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/objdetect/test/test_arucodetection.cpp](../../../modules/objdetect/test/test_arucodetection.cpp)
...
- **CV_ArucoDetectionMarkerSize**: A class/struct defined in this file
- **CV_ArucoDetectionSimple**: A class/struct defined in this file
- **ArucoAlgParams**: A class/struct defined in this file
- **CV_ArucoBitCorrection**: A class/struct defined in this file
- **ArucoThreading**: A class/struct defined in this file
- **CV_ArucoDetectionPerspective**: A class/struct defined in this file
- **NumThreadsSetter**: A class/struct defined in this file

### Functions and Methods

- **CV_ArucoDetectionPerspective()**: A function/method defined in this file
