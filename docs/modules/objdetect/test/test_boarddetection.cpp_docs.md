# Documentation for `modules/objdetect/test/test_boarddetection.cpp`

## File Metadata

- **Full Path**: `modules/objdetect/test/test_boarddetection.cpp`
- **File Name**: `test_boarddetection.cpp`
- **File Size**: 15,014 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/objdetect/test/test_boarddetection.cpp](../../../modules/objdetect/test/test_boarddetection.cpp)
...
- **CV_ArucoRefine**: A class/struct defined in this file
- **ArucoAlgParams**: A class/struct defined in this file
- **CV_ArucoBoardPose**: A class/struct defined in this file

### Functions and Methods

- **gridboard()**: A function/method defined in this file
- **board()**: A function/method defined in this file
- **CV_ArucoRefine()**: A function/method defined in this file
- **CV_ArucoBoardPose()**: A function/method defined in this file
