# Documentation for `modules/objdetect/test/test_charucodetection.cpp`

## File Metadata

- **Full Path**: `modules/objdetect/test/test_charucodetection.cpp`
- **File Name**: `test_charucodetection.cpp`
- **File Size**: 37,766 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/objdetect/test/test_charucodetection.cpp](../../../modules/objdetect/test/test_charucodetection.cpp)
...
- **CV_CharucoBoardCreation**: A class/struct defined in this file
- **CV_CharucoDiamondDetection**: A class/struct defined in this file
- **CV_CharucoPoseEstimation**: A class/struct defined in this file
- **CV_CharucoDetection**: A class/struct defined in this file
