# Documentation for `modules/objdetect/test/test_main.cpp`

## File Metadata

- **Full Path**: `modules/objdetect/test/test_main.cpp`
- **File Name**: `test_main.cpp`
- **File Size**: 455 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/objdetect/test/test_main.cpp](../../../modules/objdetect/test/test_main.cpp)
