# Documentation for `modules/objdetect/test/test_qrcode.cpp`

## File Metadata

- **Full Path**: `modules/objdetect/test/test_qrcode.cpp`
- **File Name**: `test_qrcode.cpp`
- **File Size**: 28,764 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/objdetect/test/test_qrcode.cpp](../../../modules/objdetect/test/test_qrcode.cpp)
...
- **UPDATE_QRCODE_TEST_DATA()**: A function/method defined in this file
