# Documentation for `modules/objdetect/test/test_qrcode_encode.cpp`

## File Metadata

- **Full Path**: `modules/objdetect/test/test_qrcode_encode.cpp`
- **File Name**: `test_qrcode_encode.cpp`
- **File Size**: 26,000 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/objdetect/test/test_qrcode_encode.cpp](../../../modules/objdetect/test/test_qrcode_encode.cpp)
...
- **UPDATE_TEST_DATA()**: A function/method defined in this file
