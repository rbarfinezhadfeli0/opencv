# Documentation for `modules/photo/perf/opencl/`
...
**Path**: `modules/photo/perf/opencl/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[perf_denoising.cpp](perf_denoising.cpp_docs.md)**: CPP file
...
- **Parent Folder**: [modules/photo/perf/](../perf/doc.md)
