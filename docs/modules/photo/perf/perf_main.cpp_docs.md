# Documentation for `modules/photo/perf/perf_main.cpp`

## File Metadata

- **Full Path**: `modules/photo/perf/perf_main.cpp`
- **File Name**: `perf_main.cpp`
- **File Size**: 277 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/photo/perf/perf_main.cpp](../../../modules/photo/perf/perf_main.cpp)
