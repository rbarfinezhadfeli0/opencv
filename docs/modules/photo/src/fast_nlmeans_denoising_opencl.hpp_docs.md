# Documentation for `modules/photo/src/fast_nlmeans_denoising_opencl.hpp`

## File Metadata

- **Full Path**: `modules/photo/src/fast_nlmeans_denoising_opencl.hpp`
- **File Name**: `fast_nlmeans_denoising_opencl.hpp`
- **File Size**: 10,196 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/photo/src/fast_nlmeans_denoising_opencl.hpp](../../../modules/photo/src/fast_nlmeans_denoising_opencl.hpp)
...
- **__OPENCV_FAST_NLMEANS_DENOISING_OPENCL_HPP__()**: A function/method defined in this file
