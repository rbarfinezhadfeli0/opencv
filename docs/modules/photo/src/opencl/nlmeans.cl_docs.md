# Documentation for `modules/photo/src/opencl/nlmeans.cl`

## File Metadata

- **Full Path**: `modules/photo/src/opencl/nlmeans.cl`
- **File Name**: `nlmeans.cl`
- **File Size**: 11,546 bytes
- **File Type**: .cl
- **Link to Source**: [modules/photo/src/opencl/nlmeans.cl](../../../../modules/photo/src/opencl/nlmeans.cl)

## Purpose and Role

This file is located in the `modules/photo/src/opencl` directory and serves as part of the OpenCV library infrastructure.
