# Documentation for `modules/photo/test/ocl/`
...
- **[test_denoising.cpp](test_denoising.cpp_docs.md)**: CPP file
...
- **Parent Folder**: [modules/photo/test/](../test/doc.md)
