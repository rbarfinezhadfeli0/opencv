# Documentation for `modules/python/bindings/CMakeLists.txt`

## File Metadata

- **Full Path**: `modules/python/bindings/CMakeLists.txt`
- **File Name**: `CMakeLists.txt`
- **File Size**: 6,253 bytes
- **File Type**: .txt
- **Link to Source**: [modules/python/bindings/CMakeLists.txt](../../../modules/python/bindings/CMakeLists.txt)

## Purpose and Role

This file is located in the `modules/python/bindings` directory and serves as part of the OpenCV library infrastructure.
