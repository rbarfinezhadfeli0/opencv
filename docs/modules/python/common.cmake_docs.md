# Documentation for `modules/python/common.cmake`

## File Metadata

- **Full Path**: `modules/python/common.cmake`
- **File Name**: `common.cmake`
- **File Size**: 9,503 bytes
- **File Type**: .cmake
- **Link to Source**: [modules/python/common.cmake](../../modules/python/common.cmake)
