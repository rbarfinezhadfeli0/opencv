# Documentation for `modules/python/package/template/`
...
**Path**: `modules/python/package/template/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[config.py.in](config.py.in_docs.md)**: IN file
- **[config-x.y.py.in](config-x.y.py.in_docs.md)**: IN file
...
- **Parent Folder**: [modules/python/package/](../package/doc.md)

**Sibling Folders**:
- [cv2/](../cv2/doc.md)
- [extra_modules/](../extra_modules/doc.md)
