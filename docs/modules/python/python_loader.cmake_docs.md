# Documentation for `modules/python/python_loader.cmake`

## File Metadata

- **Full Path**: `modules/python/python_loader.cmake`
- **File Name**: `python_loader.cmake`
- **File Size**: 6,712 bytes
- **File Type**: .cmake
- **Link to Source**: [modules/python/python_loader.cmake](../../modules/python/python_loader.cmake)
