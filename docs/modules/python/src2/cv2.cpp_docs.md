# Documentation for `modules/python/src2/cv2.cpp`

## File Metadata

- **Full Path**: `modules/python/src2/cv2.cpp`
- **File Name**: `cv2.cpp`
- **File Size**: 20,282 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/python/src2/cv2.cpp](../../../modules/python/src2/cv2.cpp)
...
- **PyModuleDef**: A class/struct defined in this file
- **with**: A class/struct defined in this file
- **ConstDef**: A class/struct defined in this file

### Functions and Methods

- **CVPY_TYPE()**: A function/method defined in this file
- **Py_LIMITED_API()**: A function/method defined in this file
- **PUBLISH()**: A function/method defined in this file
- **std()**: A function/method defined in this file
- **PUBLISH_()**: A function/method defined in this file
...
- **CVPY_MODULE()**: A function/method defined in this file
