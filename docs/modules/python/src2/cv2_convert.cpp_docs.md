# Documentation for `modules/python/src2/cv2_convert.cpp`

## File Metadata

- **Full Path**: `modules/python/src2/cv2_convert.cpp`
- **File Name**: `cv2_convert.cpp`
- **File Size**: 32,981 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/python/src2/cv2_convert.cpp](../../../modules/python/src2/cv2_convert.cpp)
...
- **pyopencv_RotatedRect_t**: A class/struct defined in this file

### Functions and Methods

- **CV_MAX_DIM()**: A function/method defined in this file
