# Documentation for `modules/python/src2/cv2_convert.hpp`

## File Metadata

- **Full Path**: `modules/python/src2/cv2_convert.hpp`
- **File Name**: `cv2_convert.hpp`
- **File Size**: 21,610 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/python/src2/cv2_convert.hpp](../../../modules/python/src2/cv2_convert.hpp)
...
- **TEnable**: A class/struct defined in this file
...
- **DType**: A class/struct defined in this file
- **IsRepresentableAsMatDataType**: A class/struct defined in this file
- **BooleanConstant**: A class/struct defined in this file

### Functions and Methods

- **void()**: A function/method defined in this file
- **cv()**: A function/method defined in this file
- **CV2_CONVERT_HPP()**: A function/method defined in this file
- **return()**: A function/method defined in this file
- **BooleanConstant()**: A function/method defined in this file
