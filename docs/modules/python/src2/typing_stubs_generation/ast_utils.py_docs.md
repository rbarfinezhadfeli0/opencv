# Documentation for `modules/python/src2/typing_stubs_generation/ast_utils.py`

## File Metadata

- **Full Path**: `modules/python/src2/typing_stubs_generation/ast_utils.py`
- **File Name**: `ast_utils.py`
- **File Size**: 17,579 bytes
- **File Type**: .py
- **Link to Source**: [modules/python/src2/typing_stubs_generation/ast_utils.py](../../../../modules/python/src2/typing_stubs_generation/ast_utils.py)
...
- **ScopeNotFoundError**: A class/struct defined in this file
- **SymbolName**: A class/struct defined in this file
- **is**: A class/struct defined in this file
- **node**: A class/struct defined in this file
- **name**: A class/struct defined in this file
- **SymbolNotFoundError**: A class/struct defined in this file
- **names**: A class/struct defined in this file

### Functions and Methods

- **with()**: A function/method defined in this file
- **find_scope()**: A function/method defined in this file
- **update_full_export_name()**: A function/method defined in this file
- **parse()**: A function/method defined in this file
- **create_class_node()**: A function/method defined in this file
- **for_each_function_overload()**: A function/method defined in this file
- **interface()**: A function/method defined in this file
- **create_class_node_in_scope()**: A function/method defined in this file
- **prepare_overload_arguments_and_return_type()**: A function/method defined in this file
- **get_enclosing_namespace()**: A function/method defined in this file
- **for_each_function()**: A function/method defined in this file
- **goes()**: A function/method defined in this file
...
- **create_function_node_in_scope()**: A function/method defined in this file
- **for_each_class()**: A function/method defined in this file
- **get_enum_module_and_export_name()**: A function/method defined in this file
- **__repr__()**: A function/method defined in this file
- **resolve_enum_scopes()**: A function/method defined in this file
- **find_function_node()**: A function/method defined in this file
