# Documentation for `modules/python/src2/typing_stubs_generation/`
...
**Path**: `modules/python/src2/typing_stubs_generation/`
**Direct Files**: 6
**Subfolders**: 1
...
- **Parent Folder**: [modules/python/src2/](../src2/doc.md)
