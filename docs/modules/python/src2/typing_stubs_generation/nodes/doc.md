# Documentation for `modules/python/src2/typing_stubs_generation/nodes/`
...
**Path**: `modules/python/src2/typing_stubs_generation/nodes/`
**Direct Files**: 8
**Subfolders**: 0
...
- **Parent Folder**: [modules/python/src2/typing_stubs_generation/](../typing_stubs_generation/doc.md)
