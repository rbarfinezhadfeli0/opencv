# Documentation for `modules/python/src2/typing_stubs_generation/nodes/type_node.py`

## File Metadata

- **Full Path**: `modules/python/src2/typing_stubs_generation/nodes/type_node.py`
- **File Name**: `type_node.py`
- **File Size**: 35,135 bytes
- **File Type**: .py
- **Link to Source**: [modules/python/src2/typing_stubs_generation/nodes/type_node.py](../../../../../modules/python/src2/typing_stubs_generation/nodes/type_node.py)
...
- **OptionalTypeNode**: A class/struct defined in this file
- **ConditionalAliasTypeNode**: A class/struct defined in this file
- **DictTypeNode**: A class/struct defined in this file
- **TypeNode**: A class/struct defined in this file
- **TypeResolutionError**: A class/struct defined in this file
- **CallableTypeNode**: A class/struct defined in this file
- **AnyTypeNode**: A class/struct defined in this file
- **PrimitiveTypeNode**: A class/struct defined in this file
- **AliasTypeNode**: A class/struct defined in this file
- **AliasRefTypeNode**: A class/struct defined in this file
- **UnionTypeNode**: A class/struct defined in this file
- **AggregatedTypeNode**: A class/struct defined in this file
- **ClassTypeNode**: A class/struct defined in this file
- **NDArrayTypeNode**: A class/struct defined in this file
- **PathLikeTypeNode**: A class/struct defined in this file
- **and**: A class/struct defined in this file
- **NoneTypeNode**: A class/struct defined in this file
- **ContainerTypeNode**: A class/struct defined in this file
- **as**: A class/struct defined in this file
- **scopes**: A class/struct defined in this file
- **TupleTypeNode**: A class/struct defined in this file
- **property**: A class/struct defined in this file
- **ASTNodeTypeNode**: A class/struct defined in this file
- **SequenceTypeNode**: A class/struct defined in this file

### Functions and Methods

- **ret_type()**: A function/method defined in this file
- **bool_()**: A function/method defined in this file
- **__iter__()**: A function/method defined in this file
- **float_()**: A function/method defined in this file
- **key_type()**: A function/method defined in this file
- **with()**: A function/method defined in this file
- **resolve()**: A function/method defined in this file
- **arg_types()**: A function/method defined in this file
- **__len__()**: A function/method defined in this file
- **union_()**: A function/method defined in this file
- **ast_node()**: A function/method defined in this file
- **is_resolved()**: A function/method defined in this file
- **image_reading_callback()**: A function/method defined in this file
- **numpy_array_()**: A function/method defined in this file
- **sequence_()**: A function/method defined in this file
- **class_()**: A function/method defined in this file
- **optional_()**: A function/method defined in this file
- **required_modules()**: A function/method defined in this file
- **argument()**: A function/method defined in this file
- **full_typename()**: A function/method defined in this file
- **__init__()**: A function/method defined in this file
- **dict_()**: A function/method defined in this file
- **int_()**: A function/method defined in this file
- **required_usage_imports()**: A function/method defined in this file
- **required_definition_imports()**: A function/method defined in this file
- **relative_typename()**: A function/method defined in this file
- **types_separator()**: A function/method defined in this file
- **callable_()**: A function/method defined in this file
- **typename()**: A function/method defined in this file
- **tuple_()**: A function/method defined in this file
- **declaration()**: A function/method defined in this file
- **str_()**: A function/method defined in this file
- **array_ref_()**: A function/method defined in this file
- **ref_()**: A function/method defined in this file
- **value_type()**: A function/method defined in this file
- **type_format()**: A function/method defined in this file
...
- `e`
- `itertools`
- `item.required_definition_imports`
- `Sequence`
- `self.positive_branch_type.required_usage_imports`
- `.node`
- `item.required_usage_imports`
- `NONE`
- `cv2.typing`
- `the`
- `in`
...
- `library`
- `statements`
- `self.negative_branch_type.required_usage_imports`
- `numpy`
- `abc`
- `typing`
- `os`
- `self._condition_required_imports`
