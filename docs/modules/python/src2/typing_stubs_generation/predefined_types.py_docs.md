# Documentation for `modules/python/src2/typing_stubs_generation/predefined_types.py`

## File Metadata

- **Full Path**: `modules/python/src2/typing_stubs_generation/predefined_types.py`
- **File Name**: `predefined_types.py`
- **File Size**: 14,901 bytes
- **File Type**: .py
- **Link to Source**: [modules/python/src2/typing_stubs_generation/predefined_types.py](../../../../modules/python/src2/typing_stubs_generation/predefined_types.py)
