# Documentation for `modules/python/standalone.cmake`

## File Metadata

- **Full Path**: `modules/python/standalone.cmake`
- **File Name**: `standalone.cmake`
- **File Size**: 2,451 bytes
- **File Type**: .cmake
- **Link to Source**: [modules/python/standalone.cmake](../../modules/python/standalone.cmake)
