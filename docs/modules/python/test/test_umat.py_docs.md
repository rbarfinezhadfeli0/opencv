# Documentation for `modules/python/test/test_umat.py`

## File Metadata

- **Full Path**: `modules/python/test/test_umat.py`
- **File Name**: `test_umat.py`
- **File Size**: 5,238 bytes
- **File Type**: .py
- **Link to Source**: [modules/python/test/test_umat.py](../../../modules/python/test/test_umat.py)
...
- **test_umat_construct()**: A function/method defined in this file
- **test_umat_merge_mertens()**: A function/method defined in this file
- **import()**: A function/method defined in this file
- **load_exposure_seq()**: A function/method defined in this file
- **test_umat_handle()**: A function/method defined in this file
- **test_umat_matching()**: A function/method defined in this file
- **test_umat_optical_flow()**: A function/method defined in this file
