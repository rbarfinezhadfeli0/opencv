# Documentation for `modules/stitching/misc/python/`
...
**Path**: `modules/stitching/misc/python/`
**Direct Files**: 1
**Subfolders**: 1
...
- **[pyopencv_stitching.hpp](pyopencv_stitching.hpp_docs.md)**: HPP file
...
- **Parent Folder**: [modules/stitching/misc/](../misc/doc.md)
