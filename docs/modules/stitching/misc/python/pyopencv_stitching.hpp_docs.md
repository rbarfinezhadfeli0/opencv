# Documentation for `modules/stitching/misc/python/pyopencv_stitching.hpp`

## File Metadata

- **Full Path**: `modules/stitching/misc/python/pyopencv_stitching.hpp`
- **File Name**: `pyopencv_stitching.hpp`
- **File Size**: 1,400 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/stitching/misc/python/pyopencv_stitching.hpp](../../../../modules/stitching/misc/python/pyopencv_stitching.hpp)

## Purpose and Role

This file is located in the `modules/stitching/misc/python` directory and serves as part of the OpenCV library infrastructure.
...
- **Stitcher()**: A function/method defined in this file
