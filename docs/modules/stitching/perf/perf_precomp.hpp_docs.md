# Documentation for `modules/stitching/perf/perf_precomp.hpp`

## File Metadata

- **Full Path**: `modules/stitching/perf/perf_precomp.hpp`
- **File Name**: `perf_precomp.hpp`
- **File Size**: 641 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/stitching/perf/perf_precomp.hpp](../../../modules/stitching/perf/perf_precomp.hpp)
