# Documentation for `modules/stitching/src/cuda/multiband_blend.cu`

## File Metadata

- **Full Path**: `modules/stitching/src/cuda/multiband_blend.cu`
- **File Name**: `multiband_blend.cu`
- **File Size**: 4,726 bytes
- **File Type**: .cu
- **Link to Source**: [modules/stitching/src/cuda/multiband_blend.cu](../../../../modules/stitching/src/cuda/multiband_blend.cu)

## Purpose and Role

This file is located in the `modules/stitching/src/cuda` directory and serves as part of the OpenCV library infrastructure.
