# Documentation for `modules/stitching/src/opencl/multibandblend.cl`

## File Metadata

- **Full Path**: `modules/stitching/src/opencl/multibandblend.cl`
- **File Name**: `multibandblend.cl`
- **File Size**: 10,611 bytes
- **File Type**: .cl
- **Link to Source**: [modules/stitching/src/opencl/multibandblend.cl](../../../../modules/stitching/src/opencl/multibandblend.cl)

## Purpose and Role

This file is located in the `modules/stitching/src/opencl` directory and serves as part of the OpenCV library infrastructure.
