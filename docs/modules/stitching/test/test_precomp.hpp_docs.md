# Documentation for `modules/stitching/test/test_precomp.hpp`

## File Metadata

- **Full Path**: `modules/stitching/test/test_precomp.hpp`
- **File Name**: `test_precomp.hpp`
- **File Size**: 632 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/stitching/test/test_precomp.hpp](../../../modules/stitching/test/test_precomp.hpp)
