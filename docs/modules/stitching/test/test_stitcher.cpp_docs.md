# Documentation for `modules/stitching/test/test_stitcher.cpp`

## File Metadata

- **Full Path**: `modules/stitching/test/test_stitcher.cpp`
- **File Name**: `test_stitcher.cpp`
- **File Size**: 1,099 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/stitching/test/test_stitcher.cpp](../../../modules/stitching/test/test_stitcher.cpp)
