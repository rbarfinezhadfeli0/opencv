# Documentation for `modules/ts/CMakeLists.txt`

## File Metadata

- **Full Path**: `modules/ts/CMakeLists.txt`
- **File Name**: `CMakeLists.txt`
- **File Size**: 1,805 bytes
- **File Type**: .txt
- **Link to Source**: [modules/ts/CMakeLists.txt](../../modules/ts/CMakeLists.txt)

## Purpose and Role

This file is located in the `modules/ts` directory and serves as part of the OpenCV library infrastructure.
