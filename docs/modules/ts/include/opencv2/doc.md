# Documentation for `modules/ts/include/opencv2/`
...
**Path**: `modules/ts/include/opencv2/`
**Direct Files**: 1
**Subfolders**: 1
...
- **[ts.hpp](ts.hpp_docs.md)**: HPP file
...
- **Parent Folder**: [modules/ts/include/](../include/doc.md)
