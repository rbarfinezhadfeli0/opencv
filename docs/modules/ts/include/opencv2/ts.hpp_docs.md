# Documentation for `modules/ts/include/opencv2/ts.hpp`

## File Metadata

- **Full Path**: `modules/ts/include/opencv2/ts.hpp`
- **File Name**: `ts.hpp`
- **File Size**: 32,340 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/ts/include/opencv2/ts.hpp](../../../../modules/ts/include/opencv2/ts.hpp)

## Purpose and Role

This file is located in the `modules/ts/include/opencv2` directory and serves as part of the OpenCV library infrastructure.
...
- **BaseTest**: A class/struct defined in this file
- **required_namespace_specificatin_here_for_symbol_**: A class/struct defined in this file
- **F**: A class/struct defined in this file
- **MatInfo**: A class/struct defined in this file
- **ArrayTest**: A class/struct defined in this file
- **MatComparator**: A class/struct defined in this file
- **TestInfo**: A class/struct defined in this file
- **TS**: A class/struct defined in this file
- **name**: A class/struct defined in this file
- **DefaultRngAuto**: A class/struct defined in this file
- **TSParams**: A class/struct defined in this file
- **ifstream**: A class/struct defined in this file
- **SkipTestExceptionBase**: A class/struct defined in this file
- **ofstream**: A class/struct defined in this file
- **SkipTestException**: A class/struct defined in this file
- **of**: A class/struct defined in this file
- **BadArgTest**: A class/struct defined in this file
- **SystemInfoCollector**: A class/struct defined in this file

### Functions and Methods

- **__OPENCV_TESTS()**: A function/method defined in this file
- **__CV_TEST_EXEC_ARGS()**: A function/method defined in this file
- **ifstream()**: A function/method defined in this file
- **hung()**: A function/method defined in this file
- **FAIL_HANG()**: A function/method defined in this file
- **virtual()**: A function/method defined in this file
- **OPENCV_TS_HPP()**: A function/method defined in this file
- **WINRT()**: A function/method defined in this file
- **returned()**: A function/method defined in this file
- **__FSTREAM_EMULATED__()**: A function/method defined in this file
- **has()**: A function/method defined in this file
- **OPENCV_32BIT_CONFIGURATION()**: A function/method defined in this file
- **GTEST_LANG_CXX11()**: A function/method defined in this file
- **ofstream()**: A function/method defined in this file
- **raised()**: A function/method defined in this file
- **crashed()**: A function/method defined in this file
- **corrupted()**: A function/method defined in this file
- **GTEST_USES_POSIX_RE()**: A function/method defined in this file
- **GTEST_USES_SIMPLE_RE()**: A function/method defined in this file
