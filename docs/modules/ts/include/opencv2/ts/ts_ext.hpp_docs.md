# Documentation for `modules/ts/include/opencv2/ts/ts_ext.hpp`

## File Metadata

- **Full Path**: `modules/ts/include/opencv2/ts/ts_ext.hpp`
- **File Name**: `ts_ext.hpp`
- **File Size**: 9,627 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/ts/include/opencv2/ts/ts_ext.hpp](../../../../../modules/ts/include/opencv2/ts/ts_ext.hpp)
...
- **SkipThisTest**: A class/struct defined in this file
- **test_case_name**: A class/struct defined in this file
- **test_fixture**: A class/struct defined in this file

### Functions and Methods

- **TEST_P()**: A function/method defined in this file
- **TEST_F()**: A function/method defined in this file
- **OPENCV_TS_EXT_HPP()**: A function/method defined in this file
- **TEST()**: A function/method defined in this file
