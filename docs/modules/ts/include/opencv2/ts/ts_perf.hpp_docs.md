# Documentation for `modules/ts/include/opencv2/ts/ts_perf.hpp`

## File Metadata

- **Full Path**: `modules/ts/include/opencv2/ts/ts_perf.hpp`
- **File Name**: `ts_perf.hpp`
- **File Size**: 28,589 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/ts/include/opencv2/ts/ts_perf.hpp](../../../../../modules/ts/include/opencv2/ts/ts_perf.hpp)
...
- **performance_metrics**: A class/struct defined in this file
- **FooTest**: A class/struct defined in this file
- **PerfSkipTestException**: A class/struct defined in this file
- **RectLess_**: A class/struct defined in this file
- **TestBaseWithParam**: A class/struct defined in this file
- **GpuPerf**: A class/struct defined in this file
- **ImplData**: A class/struct defined in this file
- **must**: A class/struct defined in this file
- **TestBase**: A class/struct defined in this file
- **fixture**: A class/struct defined in this file
- **KeypointGreater**: A class/struct defined in this file
- **InstumentData**: A class/struct defined in this file
- **Regression**: A class/struct defined in this file
- **_declareHelper**: A class/struct defined in this file
- **class_name**: A class/struct defined in this file
- **MatType**: A class/struct defined in this file
- **means**: A class/struct defined in this file

### Functions and Methods

- **ENABLE_INSTRUMENTATION()**: A function/method defined in this file
- **RectLess_()**: A function/method defined in this file
- **TestBaseWithParam()**: A function/method defined in this file
- **std()**: A function/method defined in this file
- **OPENCV_TS_PERF_HPP()**: A function/method defined in this file
