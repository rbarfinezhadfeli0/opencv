# Documentation for `modules/ts/misc/chart.py`

## File Metadata

- **Full Path**: `modules/ts/misc/chart.py`
- **File Name**: `chart.py`
- **File Size**: 9,863 bytes
- **File Type**: .py
- **Link to Source**: [modules/ts/misc/chart.py](../../../modules/ts/misc/chart.py)
...
- **keyselector()**: A function/method defined in this file
- **getValueParams()**: A function/method defined in this file
- **nextPermutation()**: A function/method defined in this file
- **getTestWideName()**: A function/method defined in this file
