# Documentation for `modules/ts/misc/run.py`

## File Metadata

- **Full Path**: `modules/ts/misc/run.py`
- **File Name**: `run.py`
- **File Size**: 9,284 bytes
- **File Type**: .py
- **Link to Source**: [modules/ts/misc/run.py](../../../modules/ts/misc/run.py)
...
- **parseTests()**: A function/method defined in this file
