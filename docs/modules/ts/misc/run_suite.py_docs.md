# Documentation for `modules/ts/misc/run_suite.py`

## File Metadata

- **Full Path**: `modules/ts/misc/run_suite.py`
- **File Name**: `run_suite.py`
- **File Size**: 8,851 bytes
- **File Type**: .py
- **Link to Source**: [modules/ts/misc/run_suite.py](../../../modules/ts/misc/run_suite.py)
...
- **TestSuite**: A class/struct defined in this file

### Functions and Methods

- **getLogName()**: A function/method defined in this file
- **getAlias()**: A function/method defined in this file
- **getAliases()**: A function/method defined in this file
- **getOS()**: A function/method defined in this file
- **getTestList()**: A function/method defined in this file
- **tryCommand()**: A function/method defined in this file
- **isTest()**: A function/method defined in this file
- **runTest()**: A function/method defined in this file
- **getCuts()**: A function/method defined in this file
- **runTests()**: A function/method defined in this file
- **getTest()**: A function/method defined in this file
- **wrapCommand()**: A function/method defined in this file
- **listTests()**: A function/method defined in this file
