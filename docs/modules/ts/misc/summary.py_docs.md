# Documentation for `modules/ts/misc/summary.py`

## File Metadata

- **Full Path**: `modules/ts/misc/summary.py`
- **File Name**: `summary.py`
- **File Size**: 15,643 bytes
- **File Type**: .py
- **Link to Source**: [modules/ts/misc/summary.py](../../../modules/ts/misc/summary.py)
...
- **addHeaderColumns()**: A function/method defined in this file
- **getSetName()**: A function/method defined in this file
- **getRegression()**: A function/method defined in this file
- **parseRegressionColumn()**: A function/method defined in this file
