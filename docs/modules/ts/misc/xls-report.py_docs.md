# Documentation for `modules/ts/misc/xls-report.py`

## File Metadata

- **Full Path**: `modules/ts/misc/xls-report.py`
- **File Name**: `xls-report.py`
- **File Size**: 15,987 bytes
- **File Type**: .py
- **Link to Source**: [modules/ts/misc/xls-report.py](../../../modules/ts/misc/xls-report.py)
...
- **Collector**: A class/struct defined in this file

### Functions and Methods

- **make_match_func()**: A function/method defined in this file
- **self()**: A function/method defined in this file
- **match_func()**: A function/method defined in this file
- **def()**: A function/method defined in this file
- **__format_config_cache_key()**: A function/method defined in this file
- **collect_from()**: A function/method defined in this file
