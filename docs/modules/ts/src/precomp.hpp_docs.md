# Documentation for `modules/ts/src/precomp.hpp`

## File Metadata

- **Full Path**: `modules/ts/src/precomp.hpp`
- **File Name**: `precomp.hpp`
- **File Size**: 349 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/ts/src/precomp.hpp](../../../modules/ts/src/precomp.hpp)
...
- **GTEST_LINKED_AS_SHARED_LIBRARY()**: A function/method defined in this file
