# Documentation for `modules/ts/src/ts_func.cpp`

## File Metadata

- **Full Path**: `modules/ts/src/ts_func.cpp`
- **File Name**: `ts_func.cpp`
- **File Size**: 99,297 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/ts/src/ts_func.cpp](../../../modules/ts/src/ts_func.cpp)
...
- **MatPart**: A class/struct defined in this file
