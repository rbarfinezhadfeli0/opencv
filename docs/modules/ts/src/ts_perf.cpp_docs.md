# Documentation for `modules/ts/src/ts_perf.cpp`

## File Metadata

- **Full Path**: `modules/ts/src/ts_perf.cpp`
- **File Name**: `ts_perf.cpp`
- **File Size**: 74,888 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/ts/src/ts_perf.cpp](../../../modules/ts/src/ts_perf.cpp)
...
- **KeypointComparator**: A class/struct defined in this file
- **for**: A class/struct defined in this file
- **PerfEarlyExitException**: A class/struct defined in this file
- **PerfValidationEnvironment**: A class/struct defined in this file
- **PerfEnvironment**: A class/struct defined in this file

### Functions and Methods

- **ENABLE_INSTRUMENTATION()**: A function/method defined in this file
- **WINRT_8_0()**: A function/method defined in this file
