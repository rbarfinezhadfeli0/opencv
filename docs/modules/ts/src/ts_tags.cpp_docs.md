# Documentation for `modules/ts/src/ts_tags.cpp`

## File Metadata

- **Full Path**: `modules/ts/src/ts_tags.cpp`
- **File Name**: `ts_tags.cpp`
- **File Size**: 18,714 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/ts/src/ts_tags.cpp](../../../modules/ts/src/ts_tags.cpp)
...
- **TestTagsListener**: A class/struct defined in this file
