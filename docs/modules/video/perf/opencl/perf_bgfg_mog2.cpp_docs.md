# Documentation for `modules/video/perf/opencl/perf_bgfg_mog2.cpp`

## File Metadata

- **Full Path**: `modules/video/perf/opencl/perf_bgfg_mog2.cpp`
- **File Name**: `perf_bgfg_mog2.cpp`
- **File Size**: 2,795 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/video/perf/opencl/perf_bgfg_mog2.cpp](../../../../modules/video/perf/opencl/perf_bgfg_mog2.cpp)
