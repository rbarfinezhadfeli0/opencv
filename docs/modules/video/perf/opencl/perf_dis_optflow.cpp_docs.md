# Documentation for `modules/video/perf/opencl/perf_dis_optflow.cpp`

## File Metadata

- **Full Path**: `modules/video/perf/opencl/perf_dis_optflow.cpp`
- **File Name**: `perf_dis_optflow.cpp`
- **File Size**: 2,501 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/video/perf/opencl/perf_dis_optflow.cpp](../../../../modules/video/perf/opencl/perf_dis_optflow.cpp)
