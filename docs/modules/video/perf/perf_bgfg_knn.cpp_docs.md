# Documentation for `modules/video/perf/perf_bgfg_knn.cpp`

## File Metadata

- **Full Path**: `modules/video/perf/perf_bgfg_knn.cpp`
- **File Name**: `perf_bgfg_knn.cpp`
- **File Size**: 2,568 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/video/perf/perf_bgfg_knn.cpp](../../../modules/video/perf/perf_bgfg_knn.cpp)
