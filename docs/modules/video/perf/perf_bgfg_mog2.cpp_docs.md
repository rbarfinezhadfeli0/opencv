# Documentation for `modules/video/perf/perf_bgfg_mog2.cpp`

## File Metadata

- **Full Path**: `modules/video/perf/perf_bgfg_mog2.cpp`
- **File Name**: `perf_bgfg_mog2.cpp`
- **File Size**: 2,593 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/video/perf/perf_bgfg_mog2.cpp](../../../modules/video/perf/perf_bgfg_mog2.cpp)
