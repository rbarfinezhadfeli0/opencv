# Documentation for `modules/video/perf/perf_main.cpp`

## File Metadata

- **Full Path**: `modules/video/perf/perf_main.cpp`
- **File Name**: `perf_main.cpp`
- **File Size**: 324 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/video/perf/perf_main.cpp](../../../modules/video/perf/perf_main.cpp)
