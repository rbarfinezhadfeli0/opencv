# Documentation for `modules/video/perf/perf_optflowpyrlk.cpp`

## File Metadata

- **Full Path**: `modules/video/perf/perf_optflowpyrlk.cpp`
- **File Name**: `perf_optflowpyrlk.cpp`
- **File Size**: 9,651 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/video/perf/perf_optflowpyrlk.cpp](../../../modules/video/perf/perf_optflowpyrlk.cpp)
