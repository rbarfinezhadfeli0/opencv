# Documentation for `modules/video/src/opencl/bgfg_mog2.cl`

## File Metadata

- **Full Path**: `modules/video/src/opencl/bgfg_mog2.cl`
- **File Name**: `bgfg_mog2.cl`
- **File Size**: 9,097 bytes
- **File Type**: .cl
- **Link to Source**: [modules/video/src/opencl/bgfg_mog2.cl](../../../../modules/video/src/opencl/bgfg_mog2.cl)
