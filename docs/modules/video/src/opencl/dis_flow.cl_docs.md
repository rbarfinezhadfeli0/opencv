# Documentation for `modules/video/src/opencl/dis_flow.cl`

## File Metadata

- **Full Path**: `modules/video/src/opencl/dis_flow.cl`
- **File Name**: `dis_flow.cl`
- **File Size**: 20,174 bytes
- **File Type**: .cl
- **Link to Source**: [modules/video/src/opencl/dis_flow.cl](../../../../modules/video/src/opencl/dis_flow.cl)
