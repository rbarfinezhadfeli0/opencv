# Documentation for `modules/video/src/tracking/detail/tracker_feature_set.cpp`

## File Metadata

- **Full Path**: `modules/video/src/tracking/detail/tracker_feature_set.cpp`
- **File Name**: `tracker_feature_set.cpp`
- **File Size**: 1,307 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/video/src/tracking/detail/tracker_feature_set.cpp](../../../../../modules/video/src/tracking/detail/tracker_feature_set.cpp)
