# Documentation for `modules/video/src/tracking/detail/tracker_mil_model.hpp`

## File Metadata

- **Full Path**: `modules/video/src/tracking/detail/tracker_mil_model.hpp`
- **File Name**: `tracker_mil_model.hpp`
- **File Size**: 1,695 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/video/src/tracking/detail/tracker_mil_model.hpp](../../../../../modules/video/src/tracking/detail/tracker_mil_model.hpp)
...
- **TrackerMILModel**: A class/struct defined in this file

### Functions and Methods

- **__OPENCV_TRACKER_MIL_MODEL_HPP__()**: A function/method defined in this file
