# Documentation for `modules/video/src/tracking/detail/tracker_state_estimator.cpp`

## File Metadata

- **Full Path**: `modules/video/src/tracking/detail/tracker_state_estimator.cpp`
- **File Name**: `tracker_state_estimator.cpp`
- **File Size**: 909 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/video/src/tracking/detail/tracker_state_estimator.cpp](../../../../../modules/video/src/tracking/detail/tracker_state_estimator.cpp)
