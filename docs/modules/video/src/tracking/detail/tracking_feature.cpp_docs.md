# Documentation for `modules/video/src/tracking/detail/tracking_feature.cpp`

## File Metadata

- **Full Path**: `modules/video/src/tracking/detail/tracking_feature.cpp`
- **File Name**: `tracking_feature.cpp`
- **File Size**: 21,767 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/video/src/tracking/detail/tracking_feature.cpp](../../../../../modules/video/src/tracking/detail/tracking_feature.cpp)
