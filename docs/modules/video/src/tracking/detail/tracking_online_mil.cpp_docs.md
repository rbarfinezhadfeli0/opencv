# Documentation for `modules/video/src/tracking/detail/tracking_online_mil.cpp`

## File Metadata

- **Full Path**: `modules/video/src/tracking/detail/tracking_online_mil.cpp`
- **File Name**: `tracking_online_mil.cpp`
- **File Size**: 9,283 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/video/src/tracking/detail/tracking_online_mil.cpp](../../../../../modules/video/src/tracking/detail/tracking_online_mil.cpp)
...
- **SortableElementRev**: A class/struct defined in this file
