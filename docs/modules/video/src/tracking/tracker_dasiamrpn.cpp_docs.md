# Documentation for `modules/video/src/tracking/tracker_dasiamrpn.cpp`

## File Metadata

- **Full Path**: `modules/video/src/tracking/tracker_dasiamrpn.cpp`
- **File Name**: `tracker_dasiamrpn.cpp`
- **File Size**: 14,656 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/video/src/tracking/tracker_dasiamrpn.cpp](../../../../modules/video/src/tracking/tracker_dasiamrpn.cpp)
...
- **TrackerDaSiamRPNImpl**: A class/struct defined in this file
- **trackerConfig**: A class/struct defined in this file
