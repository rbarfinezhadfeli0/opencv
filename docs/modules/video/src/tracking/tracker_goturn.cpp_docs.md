# Documentation for `modules/video/src/tracking/tracker_goturn.cpp`

## File Metadata

- **Full Path**: `modules/video/src/tracking/tracker_goturn.cpp`
- **File Name**: `tracker_goturn.cpp`
- **File Size**: 5,198 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/video/src/tracking/tracker_goturn.cpp](../../../../modules/video/src/tracking/tracker_goturn.cpp)
...
- **TrackerGOTURNImpl**: A class/struct defined in this file
