# Documentation for `modules/video/src/tracking/tracker_nano.cpp`

## File Metadata

- **Full Path**: `modules/video/src/tracking/tracker_nano.cpp`
- **File Name**: `tracker_nano.cpp`
- **File Size**: 11,265 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/video/src/tracking/tracker_nano.cpp](../../../../modules/video/src/tracking/tracker_nano.cpp)
...
- **TrackerNanoImpl**: A class/struct defined in this file
