# Documentation for `modules/video/src/tracking/tracker_vit.cpp`

## File Metadata

- **Full Path**: `modules/video/src/tracking/tracker_vit.cpp`
- **File Name**: `tracker_vit.cpp`
- **File Size**: 6,929 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/video/src/tracking/tracker_vit.cpp](../../../../modules/video/src/tracking/tracker_vit.cpp)
...
- **TrackerVitImpl**: A class/struct defined in this file
