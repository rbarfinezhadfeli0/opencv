# Documentation for `modules/video/test/test_main.cpp`

## File Metadata

- **Full Path**: `modules/video/test/test_main.cpp`
- **File Name**: `test_main.cpp`
- **File Size**: 512 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/video/test/test_main.cpp](../../../modules/video/test/test_main.cpp)
