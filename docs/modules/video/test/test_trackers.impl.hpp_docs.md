# Documentation for `modules/video/test/test_trackers.impl.hpp`

## File Metadata

- **Full Path**: `modules/video/test/test_trackers.impl.hpp`
- **File Name**: `test_trackers.impl.hpp`
- **File Size**: 11,077 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/video/test/test_trackers.impl.hpp](../../../modules/video/test/test_trackers.impl.hpp)
...
- **TrackerTest**: A class/struct defined in this file
