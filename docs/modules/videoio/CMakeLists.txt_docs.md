# Documentation for `modules/videoio/CMakeLists.txt`

## File Metadata

- **Full Path**: `modules/videoio/CMakeLists.txt`
- **File Name**: `CMakeLists.txt`
- **File Size**: 12,840 bytes
- **File Type**: .txt
- **Link to Source**: [modules/videoio/CMakeLists.txt](../../modules/videoio/CMakeLists.txt)

## Purpose and Role

This file is located in the `modules/videoio` directory and serves as part of the OpenCV library infrastructure.
