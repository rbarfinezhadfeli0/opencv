# Documentation for `modules/videoio/cmake/plugin.cmake`

## File Metadata

- **Full Path**: `modules/videoio/cmake/plugin.cmake`
- **File Name**: `plugin.cmake`
- **File Size**: 1,941 bytes
- **File Type**: .cmake
- **Link to Source**: [modules/videoio/cmake/plugin.cmake](../../../modules/videoio/cmake/plugin.cmake)
