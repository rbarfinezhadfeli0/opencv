# Documentation for `modules/videoio/include/opencv2/videoio/legacy/constants_c.h`

## File Metadata

- **Full Path**: `modules/videoio/include/opencv2/videoio/legacy/constants_c.h`
- **File Name**: `constants_c.h`
- **File Size**: 30,532 bytes
- **File Type**: .h
- **Link to Source**: [modules/videoio/include/opencv2/videoio/legacy/constants_c.h](../../../../../../modules/videoio/include/opencv2/videoio/legacy/constants_c.h)

## Purpose and Role

This file is located in the `modules/videoio/include/opencv2/videoio/legacy` directory and serves as part of the OpenCV library infrastructure.
...
- **CvCapture_Android**: A class/struct defined in this file
- **CV_CAP_GSTREAMER_QUEUE_LENGTH**: A class/struct defined in this file
- **CV_CAP_PROP_IOS_DEVICE_FOCUS**: A class/struct defined in this file
- **CV_CAP_PROP_XI_DOWNSAMPLING**: A class/struct defined in this file
- **bandwidth**: A class/struct defined in this file

### Functions and Methods

- **OPENCV_VIDEOIO_LEGACY_CONSTANTS_H()**: A function/method defined in this file
- **xiGetImage()**: A function/method defined in this file
