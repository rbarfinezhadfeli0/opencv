# Documentation for `modules/videoio/misc/plugin_ffmpeg/build-standalone.sh`

## File Metadata

- **Full Path**: `modules/videoio/misc/plugin_ffmpeg/build-standalone.sh`
- **File Name**: `build-standalone.sh`
- **File Size**: 649 bytes
- **File Type**: .sh
- **Link to Source**: [modules/videoio/misc/plugin_ffmpeg/build-standalone.sh](../../../../modules/videoio/misc/plugin_ffmpeg/build-standalone.sh)
