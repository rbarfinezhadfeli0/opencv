# Documentation for `modules/videoio/misc/python/`
...
**Path**: `modules/videoio/misc/python/`
**Direct Files**: 1
**Subfolders**: 1
...
- **[pyopencv_videoio.hpp](pyopencv_videoio.hpp_docs.md)**: HPP file
...
- **Parent Folder**: [modules/videoio/misc/](../misc/doc.md)
