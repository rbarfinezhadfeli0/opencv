# Documentation for `modules/videoio/misc/python/test/`
...
**Path**: `modules/videoio/misc/python/test/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[test_videoio.py](test_videoio.py_docs.md)**: PY file
...
- **Parent Folder**: [modules/videoio/misc/python/](../python/doc.md)
