# Documentation for `modules/videoio/src/backend_plugin.cpp`

## File Metadata

- **Full Path**: `modules/videoio/src/backend_plugin.cpp`
- **File Name**: `backend_plugin.cpp`
- **File Size**: 31,784 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/videoio/src/backend_plugin.cpp](../../../modules/videoio/src/backend_plugin.cpp)
...
- **PluginCapture**: A class/struct defined in this file
- **PluginBackendFactory**: A class/struct defined in this file
- **PluginBackend**: A class/struct defined in this file
- **PluginWriter**: A class/struct defined in this file

### Functions and Methods

- **CV_LOG_ERROR()**: A function/method defined in this file
- **CV_VIDEOIO_PLUGIN_SUBDIRECTORY()**: A function/method defined in this file
