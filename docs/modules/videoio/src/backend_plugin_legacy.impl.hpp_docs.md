# Documentation for `modules/videoio/src/backend_plugin_legacy.impl.hpp`

## File Metadata

- **Full Path**: `modules/videoio/src/backend_plugin_legacy.impl.hpp`
- **File Name**: `backend_plugin_legacy.impl.hpp`
- **File Size**: 7,230 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/videoio/src/backend_plugin_legacy.impl.hpp](../../../modules/videoio/src/backend_plugin_legacy.impl.hpp)
