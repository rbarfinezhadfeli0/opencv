# Documentation for `modules/videoio/src/cap_android_camera.cpp`

## File Metadata

- **Full Path**: `modules/videoio/src/cap_android_camera.cpp`
- **File Name**: `cap_android_camera.cpp`
- **File Size**: 34,144 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/videoio/src/cap_android_camera.cpp](../../../modules/videoio/src/cap_android_camera.cpp)
...
- **AndroidCameraCapture**: A class/struct defined in this file
- **RangeValue**: A class/struct defined in this file
- **functions**: A class/struct defined in this file
- **CaptureSessionState**: A class/struct defined in this file
