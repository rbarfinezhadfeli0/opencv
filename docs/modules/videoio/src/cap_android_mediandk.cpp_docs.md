# Documentation for `modules/videoio/src/cap_android_mediandk.cpp`

## File Metadata

- **Full Path**: `modules/videoio/src/cap_android_mediandk.cpp`
- **File Name**: `cap_android_mediandk.cpp`
- **File Size**: 28,650 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/videoio/src/cap_android_mediandk.cpp](../../../modules/videoio/src/cap_android_mediandk.cpp)
...
- **AndroidMediaNdkCapture**: A class/struct defined in this file
- **AndroidMediaNdkVideoWriter**: A class/struct defined in this file
