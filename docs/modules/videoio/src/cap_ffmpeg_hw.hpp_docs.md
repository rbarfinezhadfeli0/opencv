# Documentation for `modules/videoio/src/cap_ffmpeg_hw.hpp`

## File Metadata

- **Full Path**: `modules/videoio/src/cap_ffmpeg_hw.hpp`
- **File Name**: `cap_ffmpeg_hw.hpp`
- **File Size**: 38,799 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/videoio/src/cap_ffmpeg_hw.hpp](../../../modules/videoio/src/cap_ffmpeg_hw.hpp)
...
- **OpenCL_FFMPEG_Context**: A class/struct defined in this file
- **HWAccelIterator**: A class/struct defined in this file
- **HWTypeFFMPEG**: A class/struct defined in this file
- **AVCodecContext**: A class/struct defined in this file
- **AVHWDeviceContext**: A class/struct defined in this file
- **FreeChildContext**: A class/struct defined in this file
- **AVHWFramesContext**: A class/struct defined in this file
- **D3D11SingleTexture**: A class/struct defined in this file

### Functions and Methods

- **HAVE_VA_INTEL()**: A function/method defined in this file
- **HAVE_VA_INTEL_OLD_HEADER()**: A function/method defined in this file
...
- **hw_get_d3d11_single_texture()**: A function/method defined in this file
- **HAVE_VA()**: A function/method defined in this file
- **CL_TARGET_OPENCL_VERSION()**: A function/method defined in this file
- **HAVE_OPENCL()**: A function/method defined in this file
- **HAVE_DRM()**: A function/method defined in this file
