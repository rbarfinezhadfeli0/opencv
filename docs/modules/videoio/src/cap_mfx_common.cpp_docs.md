# Documentation for `modules/videoio/src/cap_mfx_common.cpp`

## File Metadata

- **Full Path**: `modules/videoio/src/cap_mfx_common.cpp`
- **File Name**: `cap_mfx_common.cpp`
- **File Size**: 7,713 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/videoio/src/cap_mfx_common.cpp](../../../modules/videoio/src/cap_mfx_common.cpp)
