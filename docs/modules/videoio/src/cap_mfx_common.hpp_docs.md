# Documentation for `modules/videoio/src/cap_mfx_common.hpp`

## File Metadata

- **Full Path**: `modules/videoio/src/cap_mfx_common.hpp`
- **File Name**: `cap_mfx_common.hpp`
- **File Size**: 11,716 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/videoio/src/cap_mfx_common.hpp](../../../modules/videoio/src/cap_mfx_common.hpp)
...
- **VAHandle**: A class/struct defined in this file
- **HexWrap**: A class/struct defined in this file
...
- **DXHandle**: A class/struct defined in this file
- **FourCC**: A class/struct defined in this file
- **MFXVideoSession_WRAP**: A class/struct defined in this file
- **SurfacePool**: A class/struct defined in this file

### Functions and Methods

- **MFXHELPER_H()**: A function/method defined in this file
...
- **HAVE_MFX_PLUGIN()**: A function/method defined in this file
