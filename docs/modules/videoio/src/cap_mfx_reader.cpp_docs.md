# Documentation for `modules/videoio/src/cap_mfx_reader.cpp`

## File Metadata

- **Full Path**: `modules/videoio/src/cap_mfx_reader.cpp`
- **File Name**: `cap_mfx_reader.cpp`
- **File Size**: 8,159 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/videoio/src/cap_mfx_reader.cpp](../../../modules/videoio/src/cap_mfx_reader.cpp)
