# Documentation for `modules/videoio/src/cap_mfx_writer.cpp`

## File Metadata

- **Full Path**: `modules/videoio/src/cap_mfx_writer.cpp`
- **File Name**: `cap_mfx_writer.cpp`
- **File Size**: 9,494 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/videoio/src/cap_mfx_writer.cpp](../../../modules/videoio/src/cap_mfx_writer.cpp)
