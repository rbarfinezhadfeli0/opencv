# Documentation for `modules/videoio/src/cap_obsensor/obsensor_uvc_stream_channel.cpp`

## File Metadata

- **Full Path**: `modules/videoio/src/cap_obsensor/obsensor_uvc_stream_channel.cpp`
- **File Name**: `obsensor_uvc_stream_channel.cpp`
- **File Size**: 19,329 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/videoio/src/cap_obsensor/obsensor_uvc_stream_channel.cpp](../../../../modules/videoio/src/cap_obsensor/obsensor_uvc_stream_channel.cpp)
