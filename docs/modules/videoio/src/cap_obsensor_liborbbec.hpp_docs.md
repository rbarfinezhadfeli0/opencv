# Documentation for `modules/videoio/src/cap_obsensor_liborbbec.hpp`

## File Metadata

- **Full Path**: `modules/videoio/src/cap_obsensor_liborbbec.hpp`
- **File Name**: `cap_obsensor_liborbbec.hpp`
- **File Size**: 2,169 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/videoio/src/cap_obsensor_liborbbec.hpp](../../../modules/videoio/src/cap_obsensor_liborbbec.hpp)
...
- **_CAP_LIBORBBEC_HPP_()**: A function/method defined in this file
