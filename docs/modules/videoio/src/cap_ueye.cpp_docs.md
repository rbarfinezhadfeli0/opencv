# Documentation for `modules/videoio/src/cap_ueye.cpp`

## File Metadata

- **Full Path**: `modules/videoio/src/cap_ueye.cpp`
- **File Name**: `cap_ueye.cpp`
- **File Size**: 15,650 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/videoio/src/cap_ueye.cpp](../../../modules/videoio/src/cap_ueye.cpp)
...
- **VideoCapture_uEye**: A class/struct defined in this file
- **image_buffer**: A class/struct defined in this file
