# Documentation for `modules/videoio/src/cap_ximea.cpp`

## File Metadata

- **Full Path**: `modules/videoio/src/cap_ximea.cpp`
- **File Name**: `cap_ximea.cpp`
- **File Size**: 57,155 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/videoio/src/cap_ximea.cpp](../../../modules/videoio/src/cap_ximea.cpp)
...
- **CvCaptureCAM_XIMEA**: A class/struct defined in this file

### Functions and Methods

- **_WIN32()**: A function/method defined in this file
- **locked()**: A function/method defined in this file
