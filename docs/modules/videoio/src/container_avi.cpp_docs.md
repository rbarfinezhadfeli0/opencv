# Documentation for `modules/videoio/src/container_avi.cpp`

## File Metadata

- **Full Path**: `modules/videoio/src/container_avi.cpp`
- **File Name**: `container_avi.cpp`
- **File Size**: 29,566 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/videoio/src/container_avi.cpp](../../../modules/videoio/src/container_avi.cpp)
...
- **BitmapInfoHeader**: A class/struct defined in this file
- **RiffChunk**: A class/struct defined in this file
- **BitStream**: A class/struct defined in this file
- **AviMainHeader**: A class/struct defined in this file
- **RiffList**: A class/struct defined in this file
- **AviStreamHeader**: A class/struct defined in this file
- **VideoInputStream**: A class/struct defined in this file
- **AviIndex**: A class/struct defined in this file
