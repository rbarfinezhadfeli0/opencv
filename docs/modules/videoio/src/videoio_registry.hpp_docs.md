# Documentation for `modules/videoio/src/videoio_registry.hpp`

## File Metadata

- **Full Path**: `modules/videoio/src/videoio_registry.hpp`
- **File Name**: `videoio_registry.hpp`
- **File Size**: 1,611 bytes
- **File Type**: .hpp
- **Link to Source**: [modules/videoio/src/videoio_registry.hpp](../../../modules/videoio/src/videoio_registry.hpp)
...
- **__OPENCV_VIDEOIO_VIDEOIO_REGISTRY_HPP__()**: A function/method defined in this file
