# Documentation for `modules/videoio/src/wrl.h`

## File Metadata

- **Full Path**: `modules/videoio/src/wrl.h`
- **File Name**: `wrl.h`
- **File Size**: 23,706 bytes
- **File Type**: .h
- **Link to Source**: [modules/videoio/src/wrl.h](../../../modules/videoio/src/wrl.h)
...
- **hierarchy**: A class/struct defined in this file
- **__abi_CaptureBase**: A class/struct defined in this file
- **__abi_FunctorCapture6**: A class/struct defined in this file
- **__abi_FunctorCapture10**: A class/struct defined in this file
- **__abi_FunctorCapture9**: A class/struct defined in this file
- **Guid**: A class/struct defined in this file
- **winrt_prop_type**: A class/struct defined in this file
- **winrt_type**: A class/struct defined in this file
- **__abi_FunctorCapture0**: A class/struct defined in this file
- **__abi_FunctorCapture7**: A class/struct defined in this file
- **__abi_FunctorCapture8**: A class/struct defined in this file
- **__abi_FunctorCapture1**: A class/struct defined in this file
- **__abi_FunctorCapture5**: A class/struct defined in this file
- **__abi_FunctorCapture4**: A class/struct defined in this file
- **__abi_FunctorCapture3**: A class/struct defined in this file
- **__abi_FunctorCapture2**: A class/struct defined in this file
- **__abi_CapturePtr**: A class/struct defined in this file
- **__declspec**: A class/struct defined in this file
- **DerefHelper**: A class/struct defined in this file
- **winrt_array_type**: A class/struct defined in this file
