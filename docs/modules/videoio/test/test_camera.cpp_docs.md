# Documentation for `modules/videoio/test/test_camera.cpp`

## File Metadata

- **Full Path**: `modules/videoio/test/test_camera.cpp`
- **File Name**: `test_camera.cpp`
- **File Size**: 13,971 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/videoio/test/test_camera.cpp](../../../modules/videoio/test/test_camera.cpp)
