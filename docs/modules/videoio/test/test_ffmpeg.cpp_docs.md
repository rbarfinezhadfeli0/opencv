# Documentation for `modules/videoio/test/test_ffmpeg.cpp`

## File Metadata

- **Full Path**: `modules/videoio/test/test_ffmpeg.cpp`
- **File Name**: `test_ffmpeg.cpp`
- **File Size**: 45,001 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/videoio/test/test_ffmpeg.cpp](../../../modules/videoio/test/test_ffmpeg.cpp)
