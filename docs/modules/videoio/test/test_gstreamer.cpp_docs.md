# Documentation for `modules/videoio/test/test_gstreamer.cpp`

## File Metadata

- **Full Path**: `modules/videoio/test/test_gstreamer.cpp`
- **File Name**: `test_gstreamer.cpp`
- **File Size**: 9,340 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/videoio/test/test_gstreamer.cpp](../../../modules/videoio/test/test_gstreamer.cpp)
