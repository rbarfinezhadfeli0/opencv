# Documentation for `modules/videoio/test/test_images.cpp`

## File Metadata

- **Full Path**: `modules/videoio/test/test_images.cpp`
- **File Name**: `test_images.cpp`
- **File Size**: 10,033 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/videoio/test/test_images.cpp](../../../modules/videoio/test/test_images.cpp)
