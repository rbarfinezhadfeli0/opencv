# Documentation for `modules/videoio/test/test_main.cpp`

## File Metadata

- **Full Path**: `modules/videoio/test/test_main.cpp`
- **File Name**: `test_main.cpp`
- **File Size**: 813 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/videoio/test/test_main.cpp](../../../modules/videoio/test/test_main.cpp)
