# Documentation for `modules/videoio/test/test_mfx.cpp`

## File Metadata

- **Full Path**: `modules/videoio/test/test_mfx.cpp`
- **File Name**: `test_mfx.cpp`
- **File Size**: 6,563 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/videoio/test/test_mfx.cpp](../../../modules/videoio/test/test_mfx.cpp)
