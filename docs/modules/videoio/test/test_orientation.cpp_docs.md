# Documentation for `modules/videoio/test/test_orientation.cpp`

## File Metadata

- **Full Path**: `modules/videoio/test/test_orientation.cpp`
- **File Name**: `test_orientation.cpp`
- **File Size**: 2,591 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/videoio/test/test_orientation.cpp](../../../modules/videoio/test/test_orientation.cpp)
...
- **VideoCaptureAPITests**: A class/struct defined in this file
