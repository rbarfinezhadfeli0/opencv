# Documentation for `modules/videoio/test/test_video_io.cpp`

## File Metadata

- **Full Path**: `modules/videoio/test/test_video_io.cpp`
- **File Name**: `test_video_io.cpp`
- **File Size**: 45,551 bytes
- **File Type**: .cpp
- **Link to Source**: [modules/videoio/test/test_video_io.cpp](../../../modules/videoio/test/test_video_io.cpp)
...
- **Videoio_Writer**: A class/struct defined in this file
- **Videoio_Test_Base**: A class/struct defined in this file
- **Ext_Fourcc_PSNR**: A class/struct defined in this file
- **videoio_bunny**: A class/struct defined in this file
- **VideoCaptureAccelerationInput**: A class/struct defined in this file
- **videoio_synthetic**: A class/struct defined in this file
- **BufferStream**: A class/struct defined in this file
- **Ext_Fourcc_API**: A class/struct defined in this file

### Functions and Methods

- **Videoio_Writer()**: A function/method defined in this file
- **testing()**: A function/method defined in this file
- **HAVE_MSMF_DISABLED()**: A function/method defined in this file
- **HAVE_AVFOUNDATION()**: A function/method defined in this file
- **HAVE_QUICKTIME()**: A function/method defined in this file
