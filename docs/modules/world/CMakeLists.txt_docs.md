# Documentation for `modules/world/CMakeLists.txt`

## File Metadata

- **Full Path**: `modules/world/CMakeLists.txt`
- **File Name**: `CMakeLists.txt`
- **File Size**: 3,198 bytes
- **File Type**: .txt
- **Link to Source**: [modules/world/CMakeLists.txt](../../modules/world/CMakeLists.txt)

## Purpose and Role

This file is located in the `modules/world` directory and serves as part of the OpenCV library infrastructure.
