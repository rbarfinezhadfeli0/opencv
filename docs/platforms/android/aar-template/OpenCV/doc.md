# Documentation for `platforms/android/aar-template/OpenCV/`
...
**Path**: `platforms/android/aar-template/OpenCV/`
**Direct Files**: 2
**Subfolders**: 1
...
- **[build.gradle.template](build.gradle.template_docs.md)**: TEMPLATE file
- **[proguard-rules.pro](proguard-rules.pro_docs.md)**: PRO file
...
- **Parent Folder**: [platforms/android/aar-template/](../aar-template/doc.md)
