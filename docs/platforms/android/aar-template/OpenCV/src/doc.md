# Documentation for `platforms/android/aar-template/OpenCV/src/`
...
**Path**: `platforms/android/aar-template/OpenCV/src/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [platforms/android/aar-template/OpenCV/](../OpenCV/doc.md)
