# Documentation for `platforms/android/aar-template/OpenCV/src/main/cpp/`
...
**Path**: `platforms/android/aar-template/OpenCV/src/main/cpp/`
**Direct Files**: 2
**Subfolders**: 1
...
- **[CMakeLists.txt.template](CMakeLists.txt.template_docs.md)**: Build configuration
...
- **Parent Folder**: [platforms/android/aar-template/OpenCV/src/main/](../main/doc.md)
