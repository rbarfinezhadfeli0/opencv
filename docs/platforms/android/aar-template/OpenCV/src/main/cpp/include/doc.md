# Documentation for `platforms/android/aar-template/OpenCV/src/main/cpp/include/`
...
**Path**: `platforms/android/aar-template/OpenCV/src/main/cpp/include/`
**Direct Files**: 1
**Subfolders**: 0
...
- **Parent Folder**: [platforms/android/aar-template/OpenCV/src/main/cpp/](../cpp/doc.md)
