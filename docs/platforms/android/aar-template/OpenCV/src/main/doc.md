# Documentation for `platforms/android/aar-template/OpenCV/src/main/`
...
**Path**: `platforms/android/aar-template/OpenCV/src/main/`
**Direct Files**: 1
**Subfolders**: 1
...
- **Parent Folder**: [platforms/android/aar-template/OpenCV/src/](../src/doc.md)
