# Documentation for `platforms/android/aar-template/gradle/wrapper/`
...
**Path**: `platforms/android/aar-template/gradle/wrapper/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[gradle-wrapper.properties](gradle-wrapper.properties_docs.md)**: PROPERTIES file
...
- **Parent Folder**: [platforms/android/aar-template/gradle/](../gradle/doc.md)
