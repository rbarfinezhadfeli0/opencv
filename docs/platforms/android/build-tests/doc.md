# Documentation for `platforms/android/build-tests/`
...
**Path**: `platforms/android/build-tests/`
**Direct Files**: 3
**Subfolders**: 0
...
- **[test_gradle.sh](test_gradle.sh_docs.md)**: SH file
- **[test_cmake_build.py](test_cmake_build.py_docs.md)**: PY file
- **[test_gradle_aar.sh](test_gradle_aar.sh_docs.md)**: SH file
...
- **Parent Folder**: [platforms/android/](../android/doc.md)
