# Documentation for `platforms/android/gradle-wrapper/gradle/`
...
**Path**: `platforms/android/gradle-wrapper/gradle/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [platforms/android/gradle-wrapper/](../gradle-wrapper/doc.md)
