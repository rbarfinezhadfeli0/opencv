# Documentation for `platforms/android/gradle-wrapper/gradle/wrapper/`
...
**Path**: `platforms/android/gradle-wrapper/gradle/wrapper/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[gradle-wrapper.properties.in](gradle-wrapper.properties.in_docs.md)**: IN file
- **[gradle-wrapper.jar](gradle-wrapper.jar_docs.md)**: JAR file
...
- **Parent Folder**: [platforms/android/gradle-wrapper/gradle/](../gradle/doc.md)
