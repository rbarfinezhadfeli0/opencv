# Documentation for `platforms/maven/opencv-it/src/test/java/`
...
**Path**: `platforms/maven/opencv-it/src/test/java/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [platforms/maven/opencv-it/src/test/](../test/doc.md)
