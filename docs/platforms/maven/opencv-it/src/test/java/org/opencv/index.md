# Index of `platforms/maven/opencv-it/src/test/java/org/opencv/`

## Overview

This folder is part of the OpenCV repository structure and contains and other repository content.

**Location**: `platforms/maven/opencv-it/src/test/java/org/opencv`
...
- **[osgi/](osgi/index.md)**: Subfolder containing 1 files
