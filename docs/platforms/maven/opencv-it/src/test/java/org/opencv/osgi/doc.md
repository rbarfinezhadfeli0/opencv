# Documentation for `platforms/maven/opencv-it/src/test/java/org/opencv/osgi/`
...
**Path**: `platforms/maven/opencv-it/src/test/java/org/opencv/osgi/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[DeployOpenCVTest.java](DeployOpenCVTest.java_docs.md)**: JAVA file
...
- **Parent Folder**: [platforms/maven/opencv-it/src/test/java/org/opencv/](../opencv/doc.md)
