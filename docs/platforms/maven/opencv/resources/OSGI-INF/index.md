# Index of `platforms/maven/opencv/resources/OSGI-INF/`

## Overview

This folder is part of the OpenCV repository structure and contains and other repository content.

**Location**: `platforms/maven/opencv/resources/OSGI-INF`
...
- **[blueprint/](blueprint/index.md)**: Subfolder containing 1 files
