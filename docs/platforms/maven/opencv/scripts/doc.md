# Documentation for `platforms/maven/opencv/scripts/`
...
**Path**: `platforms/maven/opencv/scripts/`
**Direct Files**: 4
**Subfolders**: 0
...
- **[deb_package_check](deb_package_check_docs.md)**: File
- **[functions](functions_docs.md)**: File
- **[properties](properties_docs.md)**: File
- **[execstack_check](execstack_check_docs.md)**: File
...
- **Parent Folder**: [platforms/maven/opencv/](../opencv/doc.md)
