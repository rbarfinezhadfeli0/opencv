# Documentation for `samples/android/15-puzzle/src/org/opencv/samples/`
...
**Path**: `samples/android/15-puzzle/src/org/opencv/samples/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [samples/android/15-puzzle/src/org/opencv/](../opencv/doc.md)
