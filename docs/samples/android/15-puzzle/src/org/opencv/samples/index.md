# Index of `samples/android/15-puzzle/src/org/opencv/samples/`

## Overview

This folder is part of the OpenCV repository structure and contains and other repository content.

**Location**: `samples/android/15-puzzle/src/org/opencv/samples`
...
- **[puzzle15/](puzzle15/index.md)**: Subfolder containing 2 files
