# Documentation for `samples/android/15-puzzle/src/org/opencv/samples/puzzle15/`
...
**Path**: `samples/android/15-puzzle/src/org/opencv/samples/puzzle15/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[Puzzle15Activity.java](Puzzle15Activity.java_docs.md)**: JAVA file
- **[Puzzle15Processor.java](Puzzle15Processor.java_docs.md)**: JAVA file
...
- **Parent Folder**: [samples/android/15-puzzle/src/org/opencv/samples/](../samples/doc.md)
