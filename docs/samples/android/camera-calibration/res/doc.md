# Documentation for `samples/android/camera-calibration/res/`
...
**Path**: `samples/android/camera-calibration/res/`
**Direct Files**: 0
**Subfolders**: 4
...
- **Parent Folder**: [samples/android/camera-calibration/](../camera-calibration/doc.md)
