# Documentation for `samples/android/camera-calibration/res/layout/`
...
**Path**: `samples/android/camera-calibration/res/layout/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[camera_calibration_surface_view.xml](camera_calibration_surface_view.xml_docs.md)**: XML file
...
- **Parent Folder**: [samples/android/camera-calibration/res/](../res/doc.md)
