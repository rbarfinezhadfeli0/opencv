# Documentation for `samples/android/camera-calibration/res/menu/`
...
**Path**: `samples/android/camera-calibration/res/menu/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[calibration.xml](calibration.xml_docs.md)**: XML file
