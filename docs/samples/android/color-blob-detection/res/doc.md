# Documentation for `samples/android/color-blob-detection/res/`
...
**Path**: `samples/android/color-blob-detection/res/`
**Direct Files**: 0
**Subfolders**: 3
...
- **Parent Folder**: [samples/android/color-blob-detection/](../color-blob-detection/doc.md)
