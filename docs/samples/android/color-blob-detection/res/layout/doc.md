# Documentation for `samples/android/color-blob-detection/res/layout/`
...
**Path**: `samples/android/color-blob-detection/res/layout/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[color_blob_detection_surface_view.xml](color_blob_detection_surface_view.xml_docs.md)**: XML file
...
- **Parent Folder**: [samples/android/color-blob-detection/res/](../res/doc.md)
