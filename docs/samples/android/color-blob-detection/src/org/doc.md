# Documentation for `samples/android/color-blob-detection/src/org/`
...
**Path**: `samples/android/color-blob-detection/src/org/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [samples/android/color-blob-detection/src/](../src/doc.md)
