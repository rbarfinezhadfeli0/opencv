# Documentation for `samples/android/color-blob-detection/src/org/opencv/`
...
**Path**: `samples/android/color-blob-detection/src/org/opencv/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [samples/android/color-blob-detection/src/org/](../org/doc.md)
