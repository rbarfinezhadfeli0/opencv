# Documentation for `samples/android/color-blob-detection/src/org/opencv/samples/`
...
**Path**: `samples/android/color-blob-detection/src/org/opencv/samples/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [samples/android/color-blob-detection/src/org/opencv/](../opencv/doc.md)
