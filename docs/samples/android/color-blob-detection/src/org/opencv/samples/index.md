# Index of `samples/android/color-blob-detection/src/org/opencv/samples/`

## Overview

This folder is part of the OpenCV repository structure and contains and other repository content.

**Location**: `samples/android/color-blob-detection/src/org/opencv/samples`
...
- **[colorblobdetect/](colorblobdetect/index.md)**: Subfolder containing 2 files
