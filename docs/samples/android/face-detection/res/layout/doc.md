# Documentation for `samples/android/face-detection/res/layout/`
...
**Path**: `samples/android/face-detection/res/layout/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[face_detect_surface_view.xml](face_detect_surface_view.xml_docs.md)**: XML file
...
- **Parent Folder**: [samples/android/face-detection/res/](../res/doc.md)
