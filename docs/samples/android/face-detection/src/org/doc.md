# Documentation for `samples/android/face-detection/src/org/`
...
**Path**: `samples/android/face-detection/src/org/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [samples/android/face-detection/src/](../src/doc.md)
