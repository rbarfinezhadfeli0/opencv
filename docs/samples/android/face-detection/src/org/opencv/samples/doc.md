# Documentation for `samples/android/face-detection/src/org/opencv/samples/`
...
**Path**: `samples/android/face-detection/src/org/opencv/samples/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [samples/android/face-detection/src/org/opencv/](../opencv/doc.md)
