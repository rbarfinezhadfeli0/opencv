# Documentation for `samples/android/face-detection/src/org/opencv/samples/facedetect/`
...
**Path**: `samples/android/face-detection/src/org/opencv/samples/facedetect/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[FaceDetectActivity.java](FaceDetectActivity.java_docs.md)**: JAVA file
...
- **Parent Folder**: [samples/android/face-detection/src/org/opencv/samples/](../samples/doc.md)
