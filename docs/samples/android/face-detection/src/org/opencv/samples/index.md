# Index of `samples/android/face-detection/src/org/opencv/samples/`

## Overview

This folder is part of the OpenCV repository structure and contains and other repository content.

**Location**: `samples/android/face-detection/src/org/opencv/samples`
...
- **[facedetect/](facedetect/index.md)**: Subfolder containing 1 files
