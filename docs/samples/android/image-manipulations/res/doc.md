# Documentation for `samples/android/image-manipulations/res/`
...
**Path**: `samples/android/image-manipulations/res/`
**Direct Files**: 0
**Subfolders**: 3
...
- **Parent Folder**: [samples/android/image-manipulations/](../image-manipulations/doc.md)
