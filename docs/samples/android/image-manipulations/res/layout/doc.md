# Documentation for `samples/android/image-manipulations/res/layout/`
...
**Path**: `samples/android/image-manipulations/res/layout/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[image_manipulations_surface_view.xml](image_manipulations_surface_view.xml_docs.md)**: XML file
...
- **Parent Folder**: [samples/android/image-manipulations/res/](../res/doc.md)
