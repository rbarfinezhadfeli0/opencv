# Documentation for `samples/android/image-manipulations/src/org/`
...
**Path**: `samples/android/image-manipulations/src/org/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [samples/android/image-manipulations/src/](../src/doc.md)
