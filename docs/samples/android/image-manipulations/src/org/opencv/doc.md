# Documentation for `samples/android/image-manipulations/src/org/opencv/`
...
**Path**: `samples/android/image-manipulations/src/org/opencv/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [samples/android/image-manipulations/src/org/](../org/doc.md)
