# Documentation for `samples/android/image-manipulations/src/org/opencv/samples/`
...
**Path**: `samples/android/image-manipulations/src/org/opencv/samples/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [samples/android/image-manipulations/src/org/opencv/](../opencv/doc.md)
