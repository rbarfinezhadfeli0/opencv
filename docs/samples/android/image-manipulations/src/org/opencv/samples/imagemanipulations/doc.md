# Documentation for `samples/android/image-manipulations/src/org/opencv/samples/imagemanipulations/`
...
**Path**: `samples/android/image-manipulations/src/org/opencv/samples/imagemanipulations/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[ImageManipulationsActivity.java](ImageManipulationsActivity.java_docs.md)**: JAVA file
...
- **Parent Folder**: [samples/android/image-manipulations/src/org/opencv/samples/](../samples/doc.md)
