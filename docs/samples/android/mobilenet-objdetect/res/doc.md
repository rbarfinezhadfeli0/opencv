# Documentation for `samples/android/mobilenet-objdetect/res/`
...
**Path**: `samples/android/mobilenet-objdetect/res/`
**Direct Files**: 0
**Subfolders**: 3
...
- **Parent Folder**: [samples/android/mobilenet-objdetect/](../mobilenet-objdetect/doc.md)
