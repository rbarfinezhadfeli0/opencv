# Documentation for `samples/android/mobilenet-objdetect/res/layout/`
...
**Path**: `samples/android/mobilenet-objdetect/res/layout/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[activity_main.xml](activity_main.xml_docs.md)**: Main entry point
...
- **Parent Folder**: [samples/android/mobilenet-objdetect/res/](../res/doc.md)
