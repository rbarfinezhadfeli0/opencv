# Documentation for `samples/android/mobilenet-objdetect/src/org/`
...
**Path**: `samples/android/mobilenet-objdetect/src/org/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [samples/android/mobilenet-objdetect/src/](../src/doc.md)
