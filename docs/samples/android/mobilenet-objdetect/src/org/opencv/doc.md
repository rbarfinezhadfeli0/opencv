# Documentation for `samples/android/mobilenet-objdetect/src/org/opencv/`
...
**Path**: `samples/android/mobilenet-objdetect/src/org/opencv/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [samples/android/mobilenet-objdetect/src/org/](../org/doc.md)
