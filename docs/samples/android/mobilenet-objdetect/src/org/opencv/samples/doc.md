# Documentation for `samples/android/mobilenet-objdetect/src/org/opencv/samples/`
...
**Path**: `samples/android/mobilenet-objdetect/src/org/opencv/samples/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [samples/android/mobilenet-objdetect/src/org/opencv/](../opencv/doc.md)
