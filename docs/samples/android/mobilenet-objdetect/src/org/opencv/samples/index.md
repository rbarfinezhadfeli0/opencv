# Index of `samples/android/mobilenet-objdetect/src/org/opencv/samples/`

## Overview

This folder is part of the OpenCV repository structure and contains and other repository content.

**Location**: `samples/android/mobilenet-objdetect/src/org/opencv/samples`
...
- **[opencv_mobilenet/](opencv_mobilenet/index.md)**: Subfolder containing 1 files
