# Documentation for `samples/android/mobilenet-objdetect/src/org/opencv/samples/opencv_mobilenet/`
...
**Path**: `samples/android/mobilenet-objdetect/src/org/opencv/samples/opencv_mobilenet/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[MainActivity.java](MainActivity.java_docs.md)**: Main entry point
...
- **Parent Folder**: [samples/android/mobilenet-objdetect/src/org/opencv/samples/](../samples/doc.md)
