# Documentation for `samples/android/qr-detection/res/values/`
...
**Path**: `samples/android/qr-detection/res/values/`
**Direct Files**: 1
**Subfolders**: 0
...
- **Parent Folder**: [samples/android/qr-detection/res/](../res/doc.md)
