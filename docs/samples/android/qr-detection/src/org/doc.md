# Documentation for `samples/android/qr-detection/src/org/`
...
**Path**: `samples/android/qr-detection/src/org/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [samples/android/qr-detection/src/](../src/doc.md)
