# Documentation for `samples/android/qr-detection/src/org/opencv/`
...
**Path**: `samples/android/qr-detection/src/org/opencv/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [samples/android/qr-detection/src/org/](../org/doc.md)
