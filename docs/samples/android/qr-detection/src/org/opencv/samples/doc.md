# Documentation for `samples/android/qr-detection/src/org/opencv/samples/`
...
**Path**: `samples/android/qr-detection/src/org/opencv/samples/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [samples/android/qr-detection/src/org/opencv/](../opencv/doc.md)
