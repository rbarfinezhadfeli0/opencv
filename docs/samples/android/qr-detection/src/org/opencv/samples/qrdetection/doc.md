# Documentation for `samples/android/qr-detection/src/org/opencv/samples/qrdetection/`
...
**Path**: `samples/android/qr-detection/src/org/opencv/samples/qrdetection/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[QRProcessor.java](QRProcessor.java_docs.md)**: JAVA file
- **[QRdetectionActivity.java](QRdetectionActivity.java_docs.md)**: JAVA file
...
- **Parent Folder**: [samples/android/qr-detection/src/org/opencv/samples/](../samples/doc.md)
