# Documentation for `samples/android/tutorial-1-camerapreview/res/layout/`
...
**Path**: `samples/android/tutorial-1-camerapreview/res/layout/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[tutorial1_surface_view.xml](tutorial1_surface_view.xml_docs.md)**: XML file
...
- **Parent Folder**: [samples/android/tutorial-1-camerapreview/res/](../res/doc.md)
