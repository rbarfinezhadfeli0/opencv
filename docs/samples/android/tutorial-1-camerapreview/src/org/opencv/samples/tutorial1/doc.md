# Documentation for `samples/android/tutorial-1-camerapreview/src/org/opencv/samples/tutorial1/`
...
**Path**: `samples/android/tutorial-1-camerapreview/src/org/opencv/samples/tutorial1/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[Tutorial1Activity.java](Tutorial1Activity.java_docs.md)**: JAVA file
...
- **Parent Folder**: [samples/android/tutorial-1-camerapreview/src/org/opencv/samples/](../samples/doc.md)
