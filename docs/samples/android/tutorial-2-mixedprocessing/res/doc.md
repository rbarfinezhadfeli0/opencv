# Documentation for `samples/android/tutorial-2-mixedprocessing/res/`
...
**Path**: `samples/android/tutorial-2-mixedprocessing/res/`
**Direct Files**: 0
**Subfolders**: 3
...
- **Parent Folder**: [samples/android/tutorial-2-mixedprocessing/](../tutorial-2-mixedprocessing/doc.md)
