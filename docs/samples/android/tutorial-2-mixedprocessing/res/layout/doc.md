# Documentation for `samples/android/tutorial-2-mixedprocessing/res/layout/`
...
**Path**: `samples/android/tutorial-2-mixedprocessing/res/layout/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[tutorial2_surface_view.xml](tutorial2_surface_view.xml_docs.md)**: XML file
...
- **Parent Folder**: [samples/android/tutorial-2-mixedprocessing/res/](../res/doc.md)
