# Documentation for `samples/android/tutorial-2-mixedprocessing/res/values/`
...
**Path**: `samples/android/tutorial-2-mixedprocessing/res/values/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[strings.xml](strings.xml_docs.md)**: XML file
