# Documentation for `samples/android/tutorial-2-mixedprocessing/src/org/`
...
**Path**: `samples/android/tutorial-2-mixedprocessing/src/org/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [samples/android/tutorial-2-mixedprocessing/src/](../src/doc.md)
