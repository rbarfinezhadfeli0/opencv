# Documentation for `samples/android/tutorial-2-mixedprocessing/src/org/opencv/samples/`
...
**Path**: `samples/android/tutorial-2-mixedprocessing/src/org/opencv/samples/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [samples/android/tutorial-2-mixedprocessing/src/org/opencv/](../opencv/doc.md)
