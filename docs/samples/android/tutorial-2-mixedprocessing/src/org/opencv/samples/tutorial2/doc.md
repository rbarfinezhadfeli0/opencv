# Documentation for `samples/android/tutorial-2-mixedprocessing/src/org/opencv/samples/tutorial2/`
...
**Path**: `samples/android/tutorial-2-mixedprocessing/src/org/opencv/samples/tutorial2/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[Tutorial2Activity.java](Tutorial2Activity.java_docs.md)**: JAVA file
...
- **Parent Folder**: [samples/android/tutorial-2-mixedprocessing/src/org/opencv/samples/](../samples/doc.md)
