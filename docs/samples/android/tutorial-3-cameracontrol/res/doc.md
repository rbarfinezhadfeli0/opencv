# Documentation for `samples/android/tutorial-3-cameracontrol/res/`
...
**Path**: `samples/android/tutorial-3-cameracontrol/res/`
**Direct Files**: 0
**Subfolders**: 3
...
- **Parent Folder**: [samples/android/tutorial-3-cameracontrol/](../tutorial-3-cameracontrol/doc.md)
