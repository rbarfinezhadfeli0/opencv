# Documentation for `samples/android/tutorial-3-cameracontrol/res/layout/`
...
**Path**: `samples/android/tutorial-3-cameracontrol/res/layout/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[tutorial3_surface_view.xml](tutorial3_surface_view.xml_docs.md)**: XML file
...
- **Parent Folder**: [samples/android/tutorial-3-cameracontrol/res/](../res/doc.md)
