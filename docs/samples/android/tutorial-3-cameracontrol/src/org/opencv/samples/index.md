# Index of `samples/android/tutorial-3-cameracontrol/src/org/opencv/samples/`

## Overview

This folder is part of the OpenCV repository structure and contains and other repository content.

**Location**: `samples/android/tutorial-3-cameracontrol/src/org/opencv/samples`
...
- **[tutorial3/](tutorial3/index.md)**: Subfolder containing 2 files
