# Documentation for `samples/android/tutorial-4-opencl/res/`
...
**Path**: `samples/android/tutorial-4-opencl/res/`
**Direct Files**: 0
**Subfolders**: 3
...
- **Parent Folder**: [samples/android/tutorial-4-opencl/](../tutorial-4-opencl/doc.md)
