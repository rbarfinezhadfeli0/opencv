# Documentation for `samples/android/tutorial-4-opencl/res/layout/`
...
**Path**: `samples/android/tutorial-4-opencl/res/layout/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[activity.xml](activity.xml_docs.md)**: XML file
...
- **Parent Folder**: [samples/android/tutorial-4-opencl/res/](../res/doc.md)
