# Documentation for `samples/android/tutorial-4-opencl/src/org/opencv/`
...
**Path**: `samples/android/tutorial-4-opencl/src/org/opencv/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [samples/android/tutorial-4-opencl/src/org/](../org/doc.md)
