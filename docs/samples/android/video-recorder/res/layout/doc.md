# Documentation for `samples/android/video-recorder/res/layout/`
...
**Path**: `samples/android/video-recorder/res/layout/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[recorder_surface_view.xml](recorder_surface_view.xml_docs.md)**: XML file
...
- **Parent Folder**: [samples/android/video-recorder/res/](../res/doc.md)
