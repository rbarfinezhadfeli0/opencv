# Documentation for `samples/android/video-recorder/src/org/opencv/samples/recorder/`
...
**Path**: `samples/android/video-recorder/src/org/opencv/samples/recorder/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[RecorderActivity.java](RecorderActivity.java_docs.md)**: JAVA file
...
- **Parent Folder**: [samples/android/video-recorder/src/org/opencv/samples/](../samples/doc.md)
