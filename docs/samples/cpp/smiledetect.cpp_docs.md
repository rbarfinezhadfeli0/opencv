# Documentation for `samples/cpp/smiledetect.cpp`

## File Metadata

- **Full Path**: `samples/cpp/smiledetect.cpp`
- **File Name**: `smiledetect.cpp`
- **File Size**: 7,335 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/cpp/smiledetect.cpp](../../samples/cpp/smiledetect.cpp)
