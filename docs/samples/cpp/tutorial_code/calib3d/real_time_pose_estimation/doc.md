# Documentation for `samples/cpp/tutorial_code/calib3d/real_time_pose_estimation/`
...
**Path**: `samples/cpp/tutorial_code/calib3d/real_time_pose_estimation/`
**Direct Files**: 1
**Subfolders**: 2
...
- **Parent Folder**: [samples/cpp/tutorial_code/calib3d/](../calib3d/doc.md)
