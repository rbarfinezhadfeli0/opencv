# Documentation for `samples/cpp/tutorial_code/calib3d/real_time_pose_estimation/src/`
...
**Path**: `samples/cpp/tutorial_code/calib3d/real_time_pose_estimation/src/`
**Direct Files**: 18
**Subfolders**: 0
...
- **[main_detection.cpp](main_detection.cpp_docs.md)**: Main entry point
- **[main_registration.cpp](main_registration.cpp_docs.md)**: Main entry point
