# Documentation for `samples/cpp/tutorial_code/features2D/feature_detection/`
...
**Path**: `samples/cpp/tutorial_code/features2D/feature_detection/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[SURF_detection_Demo.cpp](SURF_detection_Demo.cpp_docs.md)**: CPP file
