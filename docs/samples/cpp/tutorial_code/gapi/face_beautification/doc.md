# Documentation for `samples/cpp/tutorial_code/gapi/face_beautification/`
...
**Path**: `samples/cpp/tutorial_code/gapi/face_beautification/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[face_beautification.cpp](face_beautification.cpp_docs.md)**: CPP file
