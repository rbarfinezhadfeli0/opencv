# Documentation for `samples/cpp/tutorial_code/gapi/security_barrier_camera/`
...
**Path**: `samples/cpp/tutorial_code/gapi/security_barrier_camera/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[security_barrier_camera.cpp](security_barrier_camera.cpp_docs.md)**: CPP file
