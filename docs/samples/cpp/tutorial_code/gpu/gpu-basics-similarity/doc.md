# Documentation for `samples/cpp/tutorial_code/gpu/gpu-basics-similarity/`
...
**Path**: `samples/cpp/tutorial_code/gpu/gpu-basics-similarity/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[gpu-basics-similarity.cpp](gpu-basics-similarity.cpp_docs.md)**: CPP file
...
- **Parent Folder**: [samples/cpp/tutorial_code/gpu/](../gpu/doc.md)
