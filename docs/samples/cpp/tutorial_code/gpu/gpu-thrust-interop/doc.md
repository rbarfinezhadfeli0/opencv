# Documentation for `samples/cpp/tutorial_code/gpu/gpu-thrust-interop/`
...
**Path**: `samples/cpp/tutorial_code/gpu/gpu-thrust-interop/`
**Direct Files**: 3
**Subfolders**: 0
...
- **[main.cu](main.cu_docs.md)**: Main entry point
