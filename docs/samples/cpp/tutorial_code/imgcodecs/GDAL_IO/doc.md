# Documentation for `samples/cpp/tutorial_code/imgcodecs/GDAL_IO/`
...
**Path**: `samples/cpp/tutorial_code/imgcodecs/GDAL_IO/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[gdal-image.cpp](gdal-image.cpp_docs.md)**: CPP file
...
- **Parent Folder**: [samples/cpp/tutorial_code/imgcodecs/](../imgcodecs/doc.md)
