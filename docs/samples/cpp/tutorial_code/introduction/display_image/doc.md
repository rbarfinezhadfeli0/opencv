# Documentation for `samples/cpp/tutorial_code/introduction/display_image/`
...
**Path**: `samples/cpp/tutorial_code/introduction/display_image/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[display_image.cpp](display_image.cpp_docs.md)**: CPP file
