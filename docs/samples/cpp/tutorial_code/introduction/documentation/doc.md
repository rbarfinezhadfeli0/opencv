# Documentation for `samples/cpp/tutorial_code/introduction/documentation/`
...
**Path**: `samples/cpp/tutorial_code/introduction/documentation/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[documentation.cpp](documentation.cpp_docs.md)**: CPP file
...
- **Parent Folder**: [samples/cpp/tutorial_code/introduction/](../introduction/doc.md)
