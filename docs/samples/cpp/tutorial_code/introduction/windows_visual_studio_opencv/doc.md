# Documentation for `samples/cpp/tutorial_code/introduction/windows_visual_studio_opencv/`
...
**Path**: `samples/cpp/tutorial_code/introduction/windows_visual_studio_opencv/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[introduction_windows_vs.cpp](introduction_windows_vs.cpp_docs.md)**: CPP file
