# Documentation for `samples/cpp/tutorial_code/ml/introduction_to_pca/`
...
**Path**: `samples/cpp/tutorial_code/ml/introduction_to_pca/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[introduction_to_pca.cpp](introduction_to_pca.cpp_docs.md)**: CPP file
