# Documentation for `samples/cpp/tutorial_code/ml/introduction_to_svm/`
...
**Path**: `samples/cpp/tutorial_code/ml/introduction_to_svm/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[introduction_to_svm.cpp](introduction_to_svm.cpp_docs.md)**: CPP file
...
- **Parent Folder**: [samples/cpp/tutorial_code/ml/](../ml/doc.md)
