# Documentation for `samples/cpp/tutorial_code/ml/non_linear_svms/`
...
**Path**: `samples/cpp/tutorial_code/ml/non_linear_svms/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[non_linear_svms.cpp](non_linear_svms.cpp_docs.md)**: CPP file
