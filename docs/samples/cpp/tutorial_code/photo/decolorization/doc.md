# Documentation for `samples/cpp/tutorial_code/photo/decolorization/`
...
**Path**: `samples/cpp/tutorial_code/photo/decolorization/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[decolor.cpp](decolor.cpp_docs.md)**: CPP file
