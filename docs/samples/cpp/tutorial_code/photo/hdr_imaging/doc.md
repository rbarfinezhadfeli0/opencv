# Documentation for `samples/cpp/tutorial_code/photo/hdr_imaging/`
...
**Path**: `samples/cpp/tutorial_code/photo/hdr_imaging/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[hdr_imaging.cpp](hdr_imaging.cpp_docs.md)**: CPP file
...
- **Parent Folder**: [samples/cpp/tutorial_code/photo/](../photo/doc.md)
