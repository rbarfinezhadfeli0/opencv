# Documentation for `samples/cpp/tutorial_code/photo/non_photorealistic_rendering/`
...
**Path**: `samples/cpp/tutorial_code/photo/non_photorealistic_rendering/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[npr_demo.cpp](npr_demo.cpp_docs.md)**: CPP file
