# Documentation for `samples/cpp/tutorial_code/video/meanshift/`
...
**Path**: `samples/cpp/tutorial_code/video/meanshift/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[meanshift.cpp](meanshift.cpp_docs.md)**: CPP file
- **[camshift.cpp](camshift.cpp_docs.md)**: CPP file
