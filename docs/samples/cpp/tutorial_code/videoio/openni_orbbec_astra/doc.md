# Documentation for `samples/cpp/tutorial_code/videoio/openni_orbbec_astra/`
...
**Path**: `samples/cpp/tutorial_code/videoio/openni_orbbec_astra/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[openni_orbbec_astra.cpp](openni_orbbec_astra.cpp_docs.md)**: CPP file
