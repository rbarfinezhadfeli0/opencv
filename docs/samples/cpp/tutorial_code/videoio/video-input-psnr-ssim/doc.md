# Documentation for `samples/cpp/tutorial_code/videoio/video-input-psnr-ssim/`
...
**Path**: `samples/cpp/tutorial_code/videoio/video-input-psnr-ssim/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[video-input-psnr-ssim.cpp](video-input-psnr-ssim.cpp_docs.md)**: CPP file
...
- **Parent Folder**: [samples/cpp/tutorial_code/videoio/](../videoio/doc.md)
