# Documentation for `samples/cpp/tutorial_code/videoio/video-write/`
...
**Path**: `samples/cpp/tutorial_code/videoio/video-write/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[video-write.cpp](video-write.cpp_docs.md)**: CPP file
