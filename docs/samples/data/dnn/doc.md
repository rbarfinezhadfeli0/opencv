# Documentation for `samples/data/dnn/`
...
- **[classification_classes_ILSVRC2012.txt](classification_classes_ILSVRC2012.txt_docs.md)**: TXT file
- **[object_detection_classes_pascal_voc.txt](object_detection_classes_pascal_voc.txt_docs.md)**: TXT file
- **[enet-classes.txt](enet-classes.txt_docs.md)**: TXT file
- **[action_recongnition_kinetics.txt](action_recongnition_kinetics.txt_docs.md)**: TXT file
- **[object_detection_classes_yolo.txt](object_detection_classes_yolo.txt_docs.md)**: TXT file
- **[object_detection_classes_coco.txt](object_detection_classes_coco.txt_docs.md)**: TXT file
...
- **Parent Folder**: [samples/data/](../data/doc.md)
