# Documentation for `samples/dnn/dnn_model_runner/dnn_conversion/common/`
...
**Path**: `samples/dnn/dnn_model_runner/dnn_conversion/common/`
**Direct Files**: 3
**Subfolders**: 2
...
- **[abstract_model.py](abstract_model.py_docs.md)**: PY file
- **[utils.py](utils.py_docs.md)**: PY file
- **[img_utils.py](img_utils.py_docs.md)**: PY file
...
- **evaluation/** - See [evaluation/doc.md](evaluation/doc.md)
