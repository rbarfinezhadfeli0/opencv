# Documentation for `samples/dnn/dnn_model_runner/dnn_conversion/common/evaluation/classification/`
...
**Path**: `samples/dnn/dnn_model_runner/dnn_conversion/common/evaluation/classification/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[cls_data_fetcher.py](cls_data_fetcher.py_docs.md)**: PY file
- **[cls_accuracy_evaluator.py](cls_accuracy_evaluator.py_docs.md)**: PY file
...
- **Parent Folder**: [samples/dnn/dnn_model_runner/dnn_conversion/common/evaluation/](../evaluation/doc.md)
