# Documentation for `samples/dnn/dnn_model_runner/dnn_conversion/common/test/configs/`
...
**Path**: `samples/dnn/dnn_model_runner/dnn_conversion/common/test/configs/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[default_preprocess_config.py](default_preprocess_config.py_docs.md)**: PY file
- **[test_config.py](test_config.py_docs.md)**: PY file
...
- **Parent Folder**: [samples/dnn/dnn_model_runner/dnn_conversion/common/test/](../test/doc.md)
