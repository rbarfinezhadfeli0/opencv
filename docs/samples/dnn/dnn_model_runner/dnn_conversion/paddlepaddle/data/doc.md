# Documentation for `samples/dnn/dnn_model_runner/dnn_conversion/paddlepaddle/data/`
...
**Path**: `samples/dnn/dnn_model_runner/dnn_conversion/paddlepaddle/data/`
**Direct Files**: 3
**Subfolders**: 0
...
- **[labels.txt](labels.txt_docs.md)**: TXT file
- **[cat.jpg](cat.jpg_docs.md)**: JPG file
- **[result_test_human.jpg](result_test_human.jpg_docs.md)**: JPG file
...
- **Parent Folder**: [samples/dnn/dnn_model_runner/dnn_conversion/paddlepaddle/](../paddlepaddle/doc.md)
