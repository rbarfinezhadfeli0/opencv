# Documentation for `samples/dnn/dnn_model_runner/dnn_conversion/pytorch/classification/`
...
**Path**: `samples/dnn/dnn_model_runner/dnn_conversion/pytorch/classification/`
**Direct Files**: 3
**Subfolders**: 0
...
- **[py_to_py_cls.py](py_to_py_cls.py_docs.md)**: PY file
- **[py_to_py_resnet50.py](py_to_py_resnet50.py_docs.md)**: PY file
- **[py_to_py_resnet50_onnx.py](py_to_py_resnet50_onnx.py_docs.md)**: PY file
...
- **Parent Folder**: [samples/dnn/dnn_model_runner/dnn_conversion/pytorch/](../pytorch/doc.md)
