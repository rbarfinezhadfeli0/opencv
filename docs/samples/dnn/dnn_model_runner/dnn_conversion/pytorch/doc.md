# Documentation for `samples/dnn/dnn_model_runner/dnn_conversion/pytorch/`
...
**Path**: `samples/dnn/dnn_model_runner/dnn_conversion/pytorch/`
**Direct Files**: 1
**Subfolders**: 1
...
- **[pytorch_model.py](pytorch_model.py_docs.md)**: PY file
...
- **Parent Folder**: [samples/dnn/dnn_model_runner/dnn_conversion/](../dnn_conversion/doc.md)
