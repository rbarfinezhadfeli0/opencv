# Documentation for `samples/dnn/dnn_model_runner/dnn_conversion/tf/classification/`
...
**Path**: `samples/dnn/dnn_model_runner/dnn_conversion/tf/classification/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[py_to_py_mobilenet.py](py_to_py_mobilenet.py_docs.md)**: PY file
...
- **Parent Folder**: [samples/dnn/dnn_model_runner/dnn_conversion/tf/](../tf/doc.md)
