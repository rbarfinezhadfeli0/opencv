# Documentation for `samples/dnn/dnn_model_runner/dnn_conversion/tf/detection/`
...
**Path**: `samples/dnn/dnn_model_runner/dnn_conversion/tf/detection/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[py_to_py_ssd_mobilenet.py](py_to_py_ssd_mobilenet.py_docs.md)**: PY file
