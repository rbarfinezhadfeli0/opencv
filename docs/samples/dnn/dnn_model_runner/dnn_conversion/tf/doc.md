# Documentation for `samples/dnn/dnn_model_runner/dnn_conversion/tf/`
...
**Path**: `samples/dnn/dnn_model_runner/dnn_conversion/tf/`
**Direct Files**: 1
**Subfolders**: 2
...
- **[tf_model.py](tf_model.py_docs.md)**: PY file
