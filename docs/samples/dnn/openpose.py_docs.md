# Documentation for `samples/dnn/openpose.py`

## File Metadata

- **Full Path**: `samples/dnn/openpose.py`
- **File Name**: `openpose.py`
- **File Size**: 6,602 bytes
- **File Type**: .py
- **Link to Source**: [samples/dnn/openpose.py](../../samples/dnn/openpose.py)
