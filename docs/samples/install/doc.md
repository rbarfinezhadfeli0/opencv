# Documentation for `samples/install/`
...
- **[linux_install_a.sh](linux_install_a.sh_docs.md)**: SH file
- **[linux_install_b.sh](linux_install_b.sh_docs.md)**: SH file
- **[linux_verify.sh](linux_verify.sh_docs.md)**: SH file
- **[linux_quick_install_contrib.sh](linux_quick_install_contrib.sh_docs.md)**: SH file
- **[linux_quick_install.sh](linux_quick_install.sh_docs.md)**: SH file
