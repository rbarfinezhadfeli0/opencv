# Documentation for `samples/java/ant/src/`
...
- **[SimpleSample.java](SimpleSample.java_docs.md)**: JAVA file
...
- **Parent Folder**: [samples/java/ant/](../ant/doc.md)
