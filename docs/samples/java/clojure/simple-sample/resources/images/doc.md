# Documentation for `samples/java/clojure/simple-sample/resources/images/`
...
**Path**: `samples/java/clojure/simple-sample/resources/images/`
**Direct Files**: 1
**Subfolders**: 0
...
- **Parent Folder**: [samples/java/clojure/simple-sample/resources/](../resources/doc.md)
