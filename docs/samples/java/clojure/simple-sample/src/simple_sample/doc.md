# Documentation for `samples/java/clojure/simple-sample/src/simple_sample/`
...
**Path**: `samples/java/clojure/simple-sample/src/simple_sample/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[core.clj](core.clj_docs.md)**: CLJ file
...
- **Parent Folder**: [samples/java/clojure/simple-sample/src/](../src/doc.md)
