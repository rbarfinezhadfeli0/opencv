# Documentation for `samples/java/clojure/simple-sample/test/simple_sample/`
...
**Path**: `samples/java/clojure/simple-sample/test/simple_sample/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[core_test.clj](core_test.clj_docs.md)**: CLJ file
...
- **Parent Folder**: [samples/java/clojure/simple-sample/test/](../test/doc.md)
