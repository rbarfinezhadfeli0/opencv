# Documentation for `samples/java/eclipse/HelloCV/`
...
**Path**: `samples/java/eclipse/HelloCV/`
**Direct Files**: 2
**Subfolders**: 2
...
- **[.project](.project_docs.md)**: File
- **[.classpath](.classpath_docs.md)**: File
...
- **.settings/** - See [.settings/doc.md](.settings/doc.md)
...
- **Parent Folder**: [samples/java/eclipse/](../eclipse/doc.md)
