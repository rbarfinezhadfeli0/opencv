# Documentation for `samples/java/eclipse/HelloCV/src/`
...
**Path**: `samples/java/eclipse/HelloCV/src/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[Main.java](Main.java_docs.md)**: Main entry point
...
- **Parent Folder**: [samples/java/eclipse/HelloCV/](../HelloCV/doc.md)
