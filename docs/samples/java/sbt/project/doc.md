# Documentation for `samples/java/sbt/project/`
...
- **[build.scala](build.scala_docs.md)**: SCALA file
- **[plugins.sbt](plugins.sbt_docs.md)**: SBT file
