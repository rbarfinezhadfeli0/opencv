# Documentation for `samples/java/sbt/src/main/resources/`
...
**Path**: `samples/java/sbt/src/main/resources/`
**Direct Files**: 3
**Subfolders**: 0
...
- **[AverageMaleFace.jpg](AverageMaleFace.jpg_docs.md)**: JPG file
- **[img1.png](img1.png_docs.md)**: PNG file
- **[img2.png](img2.png_docs.md)**: PNG file
...
- **Parent Folder**: [samples/java/sbt/src/main/](../main/doc.md)
