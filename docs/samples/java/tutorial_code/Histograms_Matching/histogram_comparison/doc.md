# Documentation for `samples/java/tutorial_code/Histograms_Matching/histogram_comparison/`
...
**Path**: `samples/java/tutorial_code/Histograms_Matching/histogram_comparison/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[CompareHistDemo.java](CompareHistDemo.java_docs.md)**: JAVA file
