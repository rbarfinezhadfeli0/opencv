# Documentation for `samples/java/tutorial_code/Histograms_Matching/histogram_equalization/`
...
**Path**: `samples/java/tutorial_code/Histograms_Matching/histogram_equalization/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[EqualizeHistDemo.java](EqualizeHistDemo.java_docs.md)**: JAVA file
