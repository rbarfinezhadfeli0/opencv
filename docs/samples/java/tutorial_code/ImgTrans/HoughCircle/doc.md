# Documentation for `samples/java/tutorial_code/ImgTrans/HoughCircle/`
...
**Path**: `samples/java/tutorial_code/ImgTrans/HoughCircle/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[HoughCircles.java](HoughCircles.java_docs.md)**: JAVA file
