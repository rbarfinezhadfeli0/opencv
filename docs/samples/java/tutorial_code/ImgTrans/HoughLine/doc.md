# Documentation for `samples/java/tutorial_code/ImgTrans/HoughLine/`
...
**Path**: `samples/java/tutorial_code/ImgTrans/HoughLine/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[HoughLines.java](HoughLines.java_docs.md)**: JAVA file
