# Documentation for `samples/java/tutorial_code/ImgTrans/LaPlace/`
...
**Path**: `samples/java/tutorial_code/ImgTrans/LaPlace/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[LaplaceDemo.java](LaplaceDemo.java_docs.md)**: JAVA file
