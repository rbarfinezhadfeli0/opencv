# Documentation for `samples/java/tutorial_code/ImgTrans/MakeBorder/`
...
**Path**: `samples/java/tutorial_code/ImgTrans/MakeBorder/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[CopyMakeBorder.java](CopyMakeBorder.java_docs.md)**: JAVA file
