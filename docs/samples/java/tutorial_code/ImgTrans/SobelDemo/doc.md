# Documentation for `samples/java/tutorial_code/ImgTrans/SobelDemo/`
...
**Path**: `samples/java/tutorial_code/ImgTrans/SobelDemo/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[SobelDemo.java](SobelDemo.java_docs.md)**: JAVA file
