# Documentation for `samples/java/tutorial_code/ImgTrans/distance_transformation/`
...
**Path**: `samples/java/tutorial_code/ImgTrans/distance_transformation/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[ImageSegmentationDemo.java](ImageSegmentationDemo.java_docs.md)**: JAVA file
