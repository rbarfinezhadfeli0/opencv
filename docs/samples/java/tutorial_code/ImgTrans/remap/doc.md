# Documentation for `samples/java/tutorial_code/ImgTrans/remap/`
...
**Path**: `samples/java/tutorial_code/ImgTrans/remap/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[RemapDemo.java](RemapDemo.java_docs.md)**: JAVA file
