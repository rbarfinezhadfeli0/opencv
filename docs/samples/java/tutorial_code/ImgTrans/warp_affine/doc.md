# Documentation for `samples/java/tutorial_code/ImgTrans/warp_affine/`
...
**Path**: `samples/java/tutorial_code/ImgTrans/warp_affine/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[GeometricTransformsDemo.java](GeometricTransformsDemo.java_docs.md)**: JAVA file
...
- **Parent Folder**: [samples/java/tutorial_code/ImgTrans/](../ImgTrans/doc.md)
