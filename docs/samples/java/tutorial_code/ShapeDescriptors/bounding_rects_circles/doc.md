# Documentation for `samples/java/tutorial_code/ShapeDescriptors/bounding_rects_circles/`
...
**Path**: `samples/java/tutorial_code/ShapeDescriptors/bounding_rects_circles/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[GeneralContoursDemo1.java](GeneralContoursDemo1.java_docs.md)**: JAVA file
