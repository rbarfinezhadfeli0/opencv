# Documentation for `samples/java/tutorial_code/ShapeDescriptors/bounding_rotated_ellipses/`
...
**Path**: `samples/java/tutorial_code/ShapeDescriptors/bounding_rotated_ellipses/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[GeneralContoursDemo2.java](GeneralContoursDemo2.java_docs.md)**: JAVA file
