# Documentation for `samples/java/tutorial_code/ShapeDescriptors/find_contours/`
...
**Path**: `samples/java/tutorial_code/ShapeDescriptors/find_contours/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[FindContoursDemo.java](FindContoursDemo.java_docs.md)**: JAVA file
