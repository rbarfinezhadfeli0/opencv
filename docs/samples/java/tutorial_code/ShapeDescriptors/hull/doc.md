# Documentation for `samples/java/tutorial_code/ShapeDescriptors/hull/`
...
**Path**: `samples/java/tutorial_code/ShapeDescriptors/hull/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[HullDemo.java](HullDemo.java_docs.md)**: JAVA file
