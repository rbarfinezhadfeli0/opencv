# Documentation for `samples/java/tutorial_code/ShapeDescriptors/moments/`
...
**Path**: `samples/java/tutorial_code/ShapeDescriptors/moments/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[MomentsDemo.java](MomentsDemo.java_docs.md)**: JAVA file
