# Documentation for `samples/java/tutorial_code/ShapeDescriptors/point_polygon_test/`
...
**Path**: `samples/java/tutorial_code/ShapeDescriptors/point_polygon_test/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[PointPolygonTestDemo.java](PointPolygonTestDemo.java_docs.md)**: JAVA file
...
- **Parent Folder**: [samples/java/tutorial_code/ShapeDescriptors/](../ShapeDescriptors/doc.md)
