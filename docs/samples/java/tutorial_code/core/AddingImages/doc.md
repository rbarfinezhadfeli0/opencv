# Documentation for `samples/java/tutorial_code/core/AddingImages/`
...
**Path**: `samples/java/tutorial_code/core/AddingImages/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[AddingImages.java](AddingImages.java_docs.md)**: JAVA file
