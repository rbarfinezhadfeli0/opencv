# Documentation for `samples/java/tutorial_code/core/discrete_fourier_transform/`
...
**Path**: `samples/java/tutorial_code/core/discrete_fourier_transform/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[DiscreteFourierTransform.java](DiscreteFourierTransform.java_docs.md)**: JAVA file
...
- **Parent Folder**: [samples/java/tutorial_code/core/](../core/doc.md)
