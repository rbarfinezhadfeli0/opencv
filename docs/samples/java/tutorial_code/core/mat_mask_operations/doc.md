# Documentation for `samples/java/tutorial_code/core/mat_mask_operations/`
...
**Path**: `samples/java/tutorial_code/core/mat_mask_operations/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[MatMaskOperations.java](MatMaskOperations.java_docs.md)**: JAVA file
