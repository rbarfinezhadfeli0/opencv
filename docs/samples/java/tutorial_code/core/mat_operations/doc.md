# Documentation for `samples/java/tutorial_code/core/mat_operations/`
...
**Path**: `samples/java/tutorial_code/core/mat_operations/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[MatOperations.java](MatOperations.java_docs.md)**: JAVA file
