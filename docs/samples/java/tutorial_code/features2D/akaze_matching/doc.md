# Documentation for `samples/java/tutorial_code/features2D/akaze_matching/`
...
**Path**: `samples/java/tutorial_code/features2D/akaze_matching/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[AKAZEMatchDemo.java](AKAZEMatchDemo.java_docs.md)**: JAVA file
