# Documentation for `samples/java/tutorial_code/ml/introduction_to_pca/`
...
**Path**: `samples/java/tutorial_code/ml/introduction_to_pca/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[IntroductionToPCADemo.java](IntroductionToPCADemo.java_docs.md)**: JAVA file
