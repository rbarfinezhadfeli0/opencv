# Documentation for `samples/java/tutorial_code/ml/introduction_to_svm/`
...
**Path**: `samples/java/tutorial_code/ml/introduction_to_svm/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[IntroductionToSVMDemo.java](IntroductionToSVMDemo.java_docs.md)**: JAVA file
...
- **Parent Folder**: [samples/java/tutorial_code/ml/](../ml/doc.md)
