# Documentation for `samples/java/tutorial_code/ml/non_linear_svms/`
...
**Path**: `samples/java/tutorial_code/ml/non_linear_svms/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[NonLinearSVMsDemo.java](NonLinearSVMsDemo.java_docs.md)**: JAVA file
