# Documentation for `samples/java/tutorial_code/objectDetection/cascade_classifier/`
...
**Path**: `samples/java/tutorial_code/objectDetection/cascade_classifier/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[ObjectDetectionDemo.java](ObjectDetectionDemo.java_docs.md)**: JAVA file
...
- **Parent Folder**: [samples/java/tutorial_code/objectDetection/](../objectDetection/doc.md)
