# Documentation for `samples/java/tutorial_code/photo/hdr_imaging/`
...
**Path**: `samples/java/tutorial_code/photo/hdr_imaging/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[HDRImagingDemo.java](HDRImagingDemo.java_docs.md)**: JAVA file
...
- **Parent Folder**: [samples/java/tutorial_code/photo/](../photo/doc.md)
