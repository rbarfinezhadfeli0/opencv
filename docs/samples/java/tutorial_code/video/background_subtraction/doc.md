# Documentation for `samples/java/tutorial_code/video/background_subtraction/`
...
**Path**: `samples/java/tutorial_code/video/background_subtraction/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[BackgroundSubtractionDemo.java](BackgroundSubtractionDemo.java_docs.md)**: JAVA file
