# Documentation for `samples/java/tutorial_code/video/meanshift/`
...
**Path**: `samples/java/tutorial_code/video/meanshift/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[MeanshiftDemo.java](MeanshiftDemo.java_docs.md)**: JAVA file
- **[CamshiftDemo.java](CamshiftDemo.java_docs.md)**: JAVA file
