# Documentation for `samples/opencl/CMakeLists.txt`

## File Metadata

- **Full Path**: `samples/opencl/CMakeLists.txt`
- **File Name**: `CMakeLists.txt`
- **File Size**: 1,080 bytes
- **File Type**: .txt
- **Link to Source**: [samples/opencl/CMakeLists.txt](../../samples/opencl/CMakeLists.txt)
