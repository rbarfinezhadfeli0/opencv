# Documentation for `samples/opencl/opencl-opencv-interop.cpp`

## File Metadata

- **Full Path**: `samples/opencl/opencl-opencv-interop.cpp`
- **File Name**: `opencl-opencv-interop.cpp`
- **File Size**: 35,319 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/opencl/opencl-opencv-interop.cpp](../../samples/opencl/opencl-opencv-interop.cpp)

## Purpose and Role

This file is located in the `samples/opencl` directory and serves as part of the OpenCV library infrastructure.
...
- **DeviceInfo**: A class/struct defined in this file
