# Documentation for `samples/python/squares.py`

## File Metadata

- **Full Path**: `samples/python/squares.py`
- **File Name**: `squares.py`
- **File Size**: 1,858 bytes
- **File Type**: .py
- **Link to Source**: [samples/python/squares.py](../../samples/python/squares.py)
