# Documentation for `samples/python/stereo_match.py`

## File Metadata

- **Full Path**: `samples/python/stereo_match.py`
- **File Name**: `stereo_match.py`
- **File Size**: 2,376 bytes
- **File Type**: .py
- **Link to Source**: [samples/python/stereo_match.py](../../samples/python/stereo_match.py)
...
- **write_ply()**: A function/method defined in this file
