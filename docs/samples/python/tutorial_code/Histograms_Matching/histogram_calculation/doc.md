# Documentation for `samples/python/tutorial_code/Histograms_Matching/histogram_calculation/`
...
**Path**: `samples/python/tutorial_code/Histograms_Matching/histogram_calculation/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[calcHist_Demo.py](calcHist_Demo.py_docs.md)**: PY file
