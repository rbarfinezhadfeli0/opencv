# Documentation for `samples/python/tutorial_code/Histograms_Matching/histogram_comparison/`
...
**Path**: `samples/python/tutorial_code/Histograms_Matching/histogram_comparison/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[compareHist_Demo.py](compareHist_Demo.py_docs.md)**: PY file
