# Documentation for `samples/python/tutorial_code/Histograms_Matching/histogram_equalization/`
...
**Path**: `samples/python/tutorial_code/Histograms_Matching/histogram_equalization/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[EqualizeHist_Demo.py](EqualizeHist_Demo.py_docs.md)**: PY file
