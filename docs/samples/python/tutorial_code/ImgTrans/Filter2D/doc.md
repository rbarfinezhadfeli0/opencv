# Documentation for `samples/python/tutorial_code/ImgTrans/Filter2D/`
...
**Path**: `samples/python/tutorial_code/ImgTrans/Filter2D/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[filter2D.py](filter2D.py_docs.md)**: PY file
