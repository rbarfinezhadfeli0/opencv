# Documentation for `samples/python/tutorial_code/ImgTrans/HoughCircle/`
...
**Path**: `samples/python/tutorial_code/ImgTrans/HoughCircle/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[hough_circle.py](hough_circle.py_docs.md)**: PY file
