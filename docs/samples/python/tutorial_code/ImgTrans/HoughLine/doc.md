# Documentation for `samples/python/tutorial_code/ImgTrans/HoughLine/`
...
**Path**: `samples/python/tutorial_code/ImgTrans/HoughLine/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[hough_lines.py](hough_lines.py_docs.md)**: PY file
