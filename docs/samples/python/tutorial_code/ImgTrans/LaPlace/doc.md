# Documentation for `samples/python/tutorial_code/ImgTrans/LaPlace/`
...
**Path**: `samples/python/tutorial_code/ImgTrans/LaPlace/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[laplace_demo.py](laplace_demo.py_docs.md)**: PY file
