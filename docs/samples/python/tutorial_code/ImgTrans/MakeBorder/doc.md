# Documentation for `samples/python/tutorial_code/ImgTrans/MakeBorder/`
...
**Path**: `samples/python/tutorial_code/ImgTrans/MakeBorder/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[copy_make_border.py](copy_make_border.py_docs.md)**: PY file
