# Documentation for `samples/python/tutorial_code/ImgTrans/SobelDemo/`
...
**Path**: `samples/python/tutorial_code/ImgTrans/SobelDemo/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[sobel_demo.py](sobel_demo.py_docs.md)**: PY file
