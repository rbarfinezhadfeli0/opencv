# Documentation for `samples/python/tutorial_code/ImgTrans/canny_detector/`
...
**Path**: `samples/python/tutorial_code/ImgTrans/canny_detector/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[CannyDetector_Demo.py](CannyDetector_Demo.py_docs.md)**: PY file
