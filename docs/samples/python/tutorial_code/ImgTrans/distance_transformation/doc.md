# Documentation for `samples/python/tutorial_code/ImgTrans/distance_transformation/`
...
**Path**: `samples/python/tutorial_code/ImgTrans/distance_transformation/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[imageSegmentation.py](imageSegmentation.py_docs.md)**: PY file
