# Documentation for `samples/python/tutorial_code/ImgTrans/remap/`
...
**Path**: `samples/python/tutorial_code/ImgTrans/remap/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[Remap_Demo.py](Remap_Demo.py_docs.md)**: PY file
