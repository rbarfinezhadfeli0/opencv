# Documentation for `samples/python/tutorial_code/ImgTrans/warp_affine/`
...
**Path**: `samples/python/tutorial_code/ImgTrans/warp_affine/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[Geometric_Transforms_Demo.py](Geometric_Transforms_Demo.py_docs.md)**: PY file
...
- **Parent Folder**: [samples/python/tutorial_code/ImgTrans/](../ImgTrans/doc.md)
