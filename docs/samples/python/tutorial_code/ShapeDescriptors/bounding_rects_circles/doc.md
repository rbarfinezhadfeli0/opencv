# Documentation for `samples/python/tutorial_code/ShapeDescriptors/bounding_rects_circles/`
...
**Path**: `samples/python/tutorial_code/ShapeDescriptors/bounding_rects_circles/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[generalContours_demo1.py](generalContours_demo1.py_docs.md)**: PY file
