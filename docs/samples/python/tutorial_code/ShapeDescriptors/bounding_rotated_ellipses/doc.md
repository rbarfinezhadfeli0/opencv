# Documentation for `samples/python/tutorial_code/ShapeDescriptors/bounding_rotated_ellipses/`
...
**Path**: `samples/python/tutorial_code/ShapeDescriptors/bounding_rotated_ellipses/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[generalContours_demo2.py](generalContours_demo2.py_docs.md)**: PY file
