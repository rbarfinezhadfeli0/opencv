# Documentation for `samples/python/tutorial_code/ShapeDescriptors/find_contours/`
...
**Path**: `samples/python/tutorial_code/ShapeDescriptors/find_contours/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[findContours_demo.py](findContours_demo.py_docs.md)**: PY file
