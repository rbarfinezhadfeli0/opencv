# Subtree Keyword Index for `samples/python/tutorial_code/ShapeDescriptors/find_contours/`

## Scope

This keyword index covers **all files** under `samples/python/tutorial_code/ShapeDescriptors/find_contours/` recursively, including all subdirectories.
...
**ArgumentParser** - Found in 1 file:
  - [samples/python/tutorial_code/ShapeDescriptors/find_contours/findContours_demo.py](findContours_demo.py_docs.md) ([keywords](findContours_demo.py_kw.md))
...
**findContours_demo** - Found in 1 file:
  - [samples/python/tutorial_code/ShapeDescriptors/find_contours/findContours_demo.py](findContours_demo.py_docs.md) ([keywords](findContours_demo.py_kw.md))
...
- **your**: 1 occurrences
- **None**: 1 occurrences
- **findContours_demo**: 1 occurrences
- **for**: 1 occurrences
- **exit**: 1 occurrences
