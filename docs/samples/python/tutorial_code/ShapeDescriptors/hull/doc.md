# Documentation for `samples/python/tutorial_code/ShapeDescriptors/hull/`
...
**Path**: `samples/python/tutorial_code/ShapeDescriptors/hull/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[hull_demo.py](hull_demo.py_docs.md)**: PY file
