# Subtree Keyword Index for `samples/python/tutorial_code/ShapeDescriptors/hull/`

## Scope

This keyword index covers **all files** under `samples/python/tutorial_code/ShapeDescriptors/hull/` recursively, including all subdirectories.
...
**ArgumentParser** - Found in 1 file:
  - [samples/python/tutorial_code/ShapeDescriptors/hull/hull_demo.py](hull_demo.py_docs.md) ([keywords](hull_demo.py_kw.md))
...
- **CHAIN_APPROX_SIMPLE**: 1 occurrences
