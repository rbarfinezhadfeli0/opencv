# Documentation for `samples/python/tutorial_code/ShapeDescriptors/moments/`
...
**Path**: `samples/python/tutorial_code/ShapeDescriptors/moments/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[moments_demo.py](moments_demo.py_docs.md)**: PY file
