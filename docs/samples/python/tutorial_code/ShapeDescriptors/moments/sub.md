# Subtree Keyword Index for `samples/python/tutorial_code/ShapeDescriptors/moments/`

## Scope

This keyword index covers **all files** under `samples/python/tutorial_code/ShapeDescriptors/moments/` recursively, including all subdirectories.
...
**Area** - Found in 1 file:
  - [samples/python/tutorial_code/ShapeDescriptors/moments/moments_demo.py](moments_demo.py_docs.md) ([keywords](moments_demo.py_kw.md))
