# Documentation for `samples/python/tutorial_code/ShapeDescriptors/point_polygon_test/`
...
**Path**: `samples/python/tutorial_code/ShapeDescriptors/point_polygon_test/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[pointPolygonTest_demo.py](pointPolygonTest_demo.py_docs.md)**: PY file
...
- **Parent Folder**: [samples/python/tutorial_code/ShapeDescriptors/](../ShapeDescriptors/doc.md)
