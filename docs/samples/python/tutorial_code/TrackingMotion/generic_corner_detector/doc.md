# Documentation for `samples/python/tutorial_code/TrackingMotion/generic_corner_detector/`
...
**Path**: `samples/python/tutorial_code/TrackingMotion/generic_corner_detector/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[cornerDetector_Demo.py](cornerDetector_Demo.py_docs.md)**: PY file
