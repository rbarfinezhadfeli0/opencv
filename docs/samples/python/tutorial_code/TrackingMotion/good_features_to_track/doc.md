# Documentation for `samples/python/tutorial_code/TrackingMotion/good_features_to_track/`
...
**Path**: `samples/python/tutorial_code/TrackingMotion/good_features_to_track/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[goodFeaturesToTrack_Demo.py](goodFeaturesToTrack_Demo.py_docs.md)**: PY file
...
- **Parent Folder**: [samples/python/tutorial_code/TrackingMotion/](../TrackingMotion/doc.md)
