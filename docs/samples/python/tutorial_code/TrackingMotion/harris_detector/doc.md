# Documentation for `samples/python/tutorial_code/TrackingMotion/harris_detector/`
...
**Path**: `samples/python/tutorial_code/TrackingMotion/harris_detector/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[cornerHarris_Demo.py](cornerHarris_Demo.py_docs.md)**: PY file
