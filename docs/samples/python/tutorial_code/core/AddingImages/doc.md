# Documentation for `samples/python/tutorial_code/core/AddingImages/`
...
**Path**: `samples/python/tutorial_code/core/AddingImages/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[adding_images.py](adding_images.py_docs.md)**: PY file
