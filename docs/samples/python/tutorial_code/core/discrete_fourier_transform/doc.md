# Documentation for `samples/python/tutorial_code/core/discrete_fourier_transform/`
...
**Path**: `samples/python/tutorial_code/core/discrete_fourier_transform/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[discrete_fourier_transform.py](discrete_fourier_transform.py_docs.md)**: PY file
...
- **Parent Folder**: [samples/python/tutorial_code/core/](../core/doc.md)
