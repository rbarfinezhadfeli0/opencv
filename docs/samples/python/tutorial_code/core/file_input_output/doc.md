# Documentation for `samples/python/tutorial_code/core/file_input_output/`
...
**Path**: `samples/python/tutorial_code/core/file_input_output/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[file_input_output.py](file_input_output.py_docs.md)**: PY file
