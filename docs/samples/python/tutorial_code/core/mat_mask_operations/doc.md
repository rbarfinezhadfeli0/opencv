# Documentation for `samples/python/tutorial_code/core/mat_mask_operations/`
...
**Path**: `samples/python/tutorial_code/core/mat_mask_operations/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[mat_mask_operations.py](mat_mask_operations.py_docs.md)**: PY file
