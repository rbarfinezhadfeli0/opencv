# Documentation for `samples/python/tutorial_code/core/mat_operations/`
...
**Path**: `samples/python/tutorial_code/core/mat_operations/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[mat_operations.py](mat_operations.py_docs.md)**: PY file
