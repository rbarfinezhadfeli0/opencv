# Subtree Keyword Index for `samples/python/tutorial_code/dnn/dnn_conversion/common/`

## Scope

This keyword index covers **all files** under `samples/python/tutorial_code/dnn/dnn_conversion/common/` recursively, including all subdirectories.
...
**Accuracy** - Found in 1 file:
  - [samples/python/tutorial_code/dnn/dnn_conversion/common/test/voc_segm_test.py](test/voc_segm_test.py_docs.md) ([keywords](test/voc_segm_test.py_kw.md))
