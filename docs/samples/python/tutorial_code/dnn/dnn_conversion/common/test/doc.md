# Documentation for `samples/python/tutorial_code/dnn/dnn_conversion/common/test/`
...
**Path**: `samples/python/tutorial_code/dnn/dnn_conversion/common/test/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[voc_segm_test.py](voc_segm_test.py_docs.md)**: PY file
...
- **Parent Folder**: [samples/python/tutorial_code/dnn/dnn_conversion/common/](../common/doc.md)
