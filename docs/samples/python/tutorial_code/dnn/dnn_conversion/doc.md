# Documentation for `samples/python/tutorial_code/dnn/dnn_conversion/`
...
**Path**: `samples/python/tutorial_code/dnn/dnn_conversion/`
**Direct Files**: 0
**Subfolders**: 2
...
- **Parent Folder**: [samples/python/tutorial_code/dnn/](../dnn/doc.md)
