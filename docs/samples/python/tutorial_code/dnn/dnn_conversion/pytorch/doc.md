# Documentation for `samples/python/tutorial_code/dnn/dnn_conversion/pytorch/`
...
**Path**: `samples/python/tutorial_code/dnn/dnn_conversion/pytorch/`
**Direct Files**: 0
**Subfolders**: 1
...
- **Parent Folder**: [samples/python/tutorial_code/dnn/dnn_conversion/](../dnn_conversion/doc.md)
