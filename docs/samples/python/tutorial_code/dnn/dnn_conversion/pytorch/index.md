# Index of `samples/python/tutorial_code/dnn/dnn_conversion/pytorch/`

## Overview

This folder is part of the OpenCV repository structure and contains and other repository content.

**Location**: `samples/python/tutorial_code/dnn/dnn_conversion/pytorch`
...
- **[segmentation/](segmentation/index.md)**: Subfolder containing 1 files
