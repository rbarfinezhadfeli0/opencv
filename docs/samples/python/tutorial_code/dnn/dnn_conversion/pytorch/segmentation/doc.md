# Documentation for `samples/python/tutorial_code/dnn/dnn_conversion/pytorch/segmentation/`
...
**Path**: `samples/python/tutorial_code/dnn/dnn_conversion/pytorch/segmentation/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[py_to_py_fcn_resnet50.py](py_to_py_fcn_resnet50.py_docs.md)**: PY file
...
- **Parent Folder**: [samples/python/tutorial_code/dnn/dnn_conversion/pytorch/](../pytorch/doc.md)
