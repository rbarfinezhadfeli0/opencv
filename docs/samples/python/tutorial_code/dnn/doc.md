# Documentation for `samples/python/tutorial_code/dnn/`
...
**Path**: `samples/python/tutorial_code/dnn/`
**Direct Files**: 0
**Subfolders**: 1
...
- **dnn_conversion/** - See [dnn_conversion/doc.md](dnn_conversion/doc.md)
...
**Subfolders**:
- [dnn_conversion/](dnn_conversion/doc.md)
