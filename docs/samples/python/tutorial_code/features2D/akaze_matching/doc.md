# Documentation for `samples/python/tutorial_code/features2D/akaze_matching/`
...
**Path**: `samples/python/tutorial_code/features2D/akaze_matching/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[AKAZE_match.py](AKAZE_match.py_docs.md)**: PY file
