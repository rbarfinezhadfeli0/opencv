# Documentation for `samples/python/tutorial_code/features2D/feature_detection/`
...
**Path**: `samples/python/tutorial_code/features2D/feature_detection/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[SURF_detection_Demo.py](SURF_detection_Demo.py_docs.md)**: PY file
