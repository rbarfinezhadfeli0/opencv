# Documentation for `samples/python/tutorial_code/highgui/trackbar/`
...
**Path**: `samples/python/tutorial_code/highgui/trackbar/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[AddingImagesTrackbar.py](AddingImagesTrackbar.py_docs.md)**: PY file
...
- **Parent Folder**: [samples/python/tutorial_code/highgui/](../highgui/doc.md)
