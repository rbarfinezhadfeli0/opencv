# Documentation for `samples/python/tutorial_code/introduction/display_image/`
...
**Path**: `samples/python/tutorial_code/introduction/display_image/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[display_image.py](display_image.py_docs.md)**: PY file
