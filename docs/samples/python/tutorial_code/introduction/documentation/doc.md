# Documentation for `samples/python/tutorial_code/introduction/documentation/`
...
**Path**: `samples/python/tutorial_code/introduction/documentation/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[documentation.py](documentation.py_docs.md)**: PY file
...
- **Parent Folder**: [samples/python/tutorial_code/introduction/](../introduction/doc.md)
