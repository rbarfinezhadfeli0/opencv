# Documentation for `samples/python/tutorial_code/ml/introduction_to_pca/`
...
**Path**: `samples/python/tutorial_code/ml/introduction_to_pca/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[introduction_to_pca.py](introduction_to_pca.py_docs.md)**: PY file
