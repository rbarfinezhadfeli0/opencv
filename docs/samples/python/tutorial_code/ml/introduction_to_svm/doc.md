# Documentation for `samples/python/tutorial_code/ml/introduction_to_svm/`
...
**Path**: `samples/python/tutorial_code/ml/introduction_to_svm/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[introduction_to_svm.py](introduction_to_svm.py_docs.md)**: PY file
...
- **Parent Folder**: [samples/python/tutorial_code/ml/](../ml/doc.md)
