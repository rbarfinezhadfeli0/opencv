# Documentation for `samples/python/tutorial_code/ml/non_linear_svms/`
...
**Path**: `samples/python/tutorial_code/ml/non_linear_svms/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[non_linear_svms.py](non_linear_svms.py_docs.md)**: PY file
