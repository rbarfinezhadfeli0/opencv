# Documentation for `samples/python/tutorial_code/objectDetection/cascade_classifier/`
...
**Path**: `samples/python/tutorial_code/objectDetection/cascade_classifier/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[objectDetection.py](objectDetection.py_docs.md)**: PY file
...
- **Parent Folder**: [samples/python/tutorial_code/objectDetection/](../objectDetection/doc.md)
