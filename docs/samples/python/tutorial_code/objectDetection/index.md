# Index of `samples/python/tutorial_code/objectDetection/`

## Overview

This folder is part of the OpenCV repository structure and contains and other repository content.

**Location**: `samples/python/tutorial_code/objectDetection`
...
- **[cascade_classifier/](cascade_classifier/index.md)**: Subfolder containing 1 files
