# Documentation for `samples/python/tutorial_code/photo/hdr_imaging/`
...
**Path**: `samples/python/tutorial_code/photo/hdr_imaging/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[hdr_imaging.py](hdr_imaging.py_docs.md)**: PY file
...
- **Parent Folder**: [samples/python/tutorial_code/photo/](../photo/doc.md)
