# Documentation for `samples/python/tutorial_code/video/background_subtraction/`
...
**Path**: `samples/python/tutorial_code/video/background_subtraction/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[bg_sub.py](bg_sub.py_docs.md)**: PY file
