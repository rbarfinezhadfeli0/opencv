# Documentation for `samples/python/tutorial_code/video/meanshift/`
...
**Path**: `samples/python/tutorial_code/video/meanshift/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[meanshift.py](meanshift.py_docs.md)**: PY file
- **[camshift.py](camshift.py_docs.md)**: PY file
...
- **Parent Folder**: [samples/python/tutorial_code/video/](../video/doc.md)
