# Documentation for `samples/python/tutorial_code/videoio/`
...
**Path**: `samples/python/tutorial_code/videoio/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[video-input-psnr-ssim.py](video-input-psnr-ssim.py_docs.md)**: PY file
