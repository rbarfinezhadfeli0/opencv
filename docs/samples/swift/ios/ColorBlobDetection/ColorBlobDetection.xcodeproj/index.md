# Index of `samples/swift/ios/ColorBlobDetection/ColorBlobDetection.xcodeproj/`

## Overview

This folder is part of the OpenCV repository structure and contains and other repository content.

**Location**: `samples/swift/ios/ColorBlobDetection/ColorBlobDetection.xcodeproj`
...
|-----------|------|------|---------------|----------|
| [project.pbxproj](../../../../../../samples/swift/ios/ColorBlobDetection/ColorBlobDetection.xcodeproj/project.pbxproj) | PBXPROJ | 15.8KB | [docs](project.pbxproj_docs.md) | [keywords](project.pbxproj_kw.md) |
