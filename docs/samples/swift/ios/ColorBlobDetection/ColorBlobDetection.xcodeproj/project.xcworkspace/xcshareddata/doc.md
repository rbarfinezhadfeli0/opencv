# Documentation for `samples/swift/ios/ColorBlobDetection/ColorBlobDetection.xcodeproj/project.xcworkspace/xcshareddata/`
...
**Path**: `samples/swift/ios/ColorBlobDetection/ColorBlobDetection.xcodeproj/project.xcworkspace/xcshareddata/`
**Direct Files**: 1
**Subfolders**: 0
...
- **Parent Folder**: [samples/swift/ios/ColorBlobDetection/ColorBlobDetection.xcodeproj/project.xcworkspace/](../project.xcworkspace/doc.md)
