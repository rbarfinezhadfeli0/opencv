# Documentation for `samples/swift/ios/ColorBlobDetection/ColorBlobDetection/Base.lproj/`
...
**Path**: `samples/swift/ios/ColorBlobDetection/ColorBlobDetection/Base.lproj/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[Main.storyboard](Main.storyboard_docs.md)**: Main entry point
