# Documentation for `samples/swift/ios/ColorBlobDetection/ColorBlobDetectionDynamic.xcodeproj/project.xcworkspace/xcshareddata/`
...
**Path**: `samples/swift/ios/ColorBlobDetection/ColorBlobDetectionDynamic.xcodeproj/project.xcworkspace/xcshareddata/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[IDEWorkspaceChecks.plist](IDEWorkspaceChecks.plist_docs.md)**: PLIST file
...
- **Parent Folder**: [samples/swift/ios/ColorBlobDetection/ColorBlobDetectionDynamic.xcodeproj/project.xcworkspace/](../project.xcworkspace/doc.md)
