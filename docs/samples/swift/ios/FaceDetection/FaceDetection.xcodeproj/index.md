# Index of `samples/swift/ios/FaceDetection/FaceDetection.xcodeproj/`

## Overview

This folder is part of the OpenCV repository structure and contains and other repository content.

**Location**: `samples/swift/ios/FaceDetection/FaceDetection.xcodeproj`
...
|-----------|------|------|---------------|----------|
| [project.pbxproj](../../../../../../samples/swift/ios/FaceDetection/FaceDetection.xcodeproj/project.pbxproj) | PBXPROJ | 17.0KB | [docs](project.pbxproj_docs.md) | [keywords](project.pbxproj_kw.md) |
