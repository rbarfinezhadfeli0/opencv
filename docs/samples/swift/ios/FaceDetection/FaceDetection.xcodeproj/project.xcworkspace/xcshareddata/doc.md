# Documentation for `samples/swift/ios/FaceDetection/FaceDetection.xcodeproj/project.xcworkspace/xcshareddata/`
...
**Path**: `samples/swift/ios/FaceDetection/FaceDetection.xcodeproj/project.xcworkspace/xcshareddata/`
**Direct Files**: 1
**Subfolders**: 0
...
- **Parent Folder**: [samples/swift/ios/FaceDetection/FaceDetection.xcodeproj/project.xcworkspace/](../project.xcworkspace/doc.md)
