# Index of `samples/swift/ios/FaceDetection/FaceDetectionDynamic.xcodeproj/`

## Overview

This folder is part of the OpenCV repository structure and contains and other repository content.

**Location**: `samples/swift/ios/FaceDetection/FaceDetectionDynamic.xcodeproj`
...
|-----------|------|------|---------------|----------|
| [project.pbxproj](../../../../../../samples/swift/ios/FaceDetection/FaceDetectionDynamic.xcodeproj/project.pbxproj) | PBXPROJ | 17.7KB | [docs](project.pbxproj_docs.md) | [keywords](project.pbxproj_kw.md) |
