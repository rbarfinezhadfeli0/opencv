# Documentation for `samples/winrt/FaceDetection/FaceDetection/`
...
**Path**: `samples/winrt/FaceDetection/FaceDetection/`
**Direct Files**: 13
**Subfolders**: 1
...
- **Parent Folder**: [samples/winrt/FaceDetection/](../FaceDetection/doc.md)
