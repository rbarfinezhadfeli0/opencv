# Documentation for `samples/winrt/ImageManipulations/MediaExtensions/Common/`
...
**Path**: `samples/winrt/ImageManipulations/MediaExtensions/Common/`
**Direct Files**: 5
**Subfolders**: 0
...
- **[BufferLock.h](BufferLock.h_docs.md)**: H file
- **[AsyncCB.h](AsyncCB.h_docs.md)**: H file
- **[OpQueue.h](OpQueue.h_docs.md)**: H file
- **[CritSec.h](CritSec.h_docs.md)**: H file
- **[LinkList.h](LinkList.h_docs.md)**: H file
...
- **Parent Folder**: [samples/winrt/ImageManipulations/MediaExtensions/](../MediaExtensions/doc.md)
