# Documentation for `samples/winrt/ImageManipulations/MediaExtensions/OcvTransform/`
...
**Path**: `samples/winrt/ImageManipulations/MediaExtensions/OcvTransform/`
**Direct Files**: 7
**Subfolders**: 0
...
- **[dllmain.cpp](dllmain.cpp_docs.md)**: Main entry point
