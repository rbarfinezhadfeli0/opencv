# Index of `samples/winrt/ImageManipulations/MediaExtensions/`

## Overview

This folder is part of the OpenCV repository structure and contains and other repository content.

**Location**: `samples/winrt/ImageManipulations/MediaExtensions`
...
- **[Common/](Common/index.md)**: Subfolder containing 5 files
- **[OcvTransform/](OcvTransform/index.md)**: Subfolder containing 7 files
