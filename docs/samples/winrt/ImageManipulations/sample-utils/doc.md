# Documentation for `samples/winrt/ImageManipulations/sample-utils/`
...
**Path**: `samples/winrt/ImageManipulations/sample-utils/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[SampleTemplateStyles.xaml](SampleTemplateStyles.xaml_docs.md)**: XAML file
