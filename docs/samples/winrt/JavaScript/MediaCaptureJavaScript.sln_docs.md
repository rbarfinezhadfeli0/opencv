# Documentation for `samples/winrt/JavaScript/MediaCaptureJavaScript.sln`

## File Metadata

- **Full Path**: `samples/winrt/JavaScript/MediaCaptureJavaScript.sln`
- **File Name**: `MediaCaptureJavaScript.sln`
- **File Size**: 5,525 bytes
- **File Type**: .sln
- **Link to Source**: [samples/winrt/JavaScript/MediaCaptureJavaScript.sln](../../../samples/winrt/JavaScript/MediaCaptureJavaScript.sln)
