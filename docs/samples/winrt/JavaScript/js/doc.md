# Documentation for `samples/winrt/JavaScript/js/`
...
**Path**: `samples/winrt/JavaScript/js/`
**Direct Files**: 2
**Subfolders**: 0
...
- **[AdvancedCapture.js](AdvancedCapture.js_docs.md)**: JS file
- **[default.js](default.js_docs.md)**: JS file
