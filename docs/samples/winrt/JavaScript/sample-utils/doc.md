# Documentation for `samples/winrt/JavaScript/sample-utils/`
...
**Path**: `samples/winrt/JavaScript/sample-utils/`
**Direct Files**: 3
**Subfolders**: 0
...
- **[sample-utils.js](sample-utils.js_docs.md)**: JS file
- **[scenario-select.html](scenario-select.html_docs.md)**: HTML file
- **[sample-utils.css](sample-utils.css_docs.md)**: CSS file
