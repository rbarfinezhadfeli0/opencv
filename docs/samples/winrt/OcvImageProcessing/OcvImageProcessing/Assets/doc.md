# Documentation for `samples/winrt/OcvImageProcessing/OcvImageProcessing/Assets/`
...
**Path**: `samples/winrt/OcvImageProcessing/OcvImageProcessing/Assets/`
**Direct Files**: 5
**Subfolders**: 0
...
- **[SplashScreen.png](SplashScreen.png_docs.md)**: PNG file
- **[StoreLogo.png](StoreLogo.png_docs.md)**: PNG file
- **[Logo.png](Logo.png_docs.md)**: PNG file
- **[SmallLogo.png](SmallLogo.png_docs.md)**: PNG file
...
- **Parent Folder**: [samples/winrt/OcvImageProcessing/OcvImageProcessing/](../OcvImageProcessing/doc.md)
