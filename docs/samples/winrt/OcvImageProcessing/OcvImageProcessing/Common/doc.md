# Documentation for `samples/winrt/OcvImageProcessing/OcvImageProcessing/Common/`
...
**Path**: `samples/winrt/OcvImageProcessing/OcvImageProcessing/Common/`
**Direct Files**: 1
**Subfolders**: 0
...
- **[StandardStyles.xaml](StandardStyles.xaml_docs.md)**: XAML file
