# Documentation for `samples/winrt/`
...
- **ImageManipulations/** - See [ImageManipulations/doc.md](ImageManipulations/doc.md)
- **JavaScript/** - See [JavaScript/doc.md](JavaScript/doc.md)
