# Documentation for `samples/winrt_universal/PhoneTutorial/App.xaml.cpp`

## File Metadata

- **Full Path**: `samples/winrt_universal/PhoneTutorial/App.xaml.cpp`
- **File Name**: `App.xaml.cpp`
- **File Size**: 4,552 bytes
- **File Type**: .cpp
- **Link to Source**: [samples/winrt_universal/PhoneTutorial/App.xaml.cpp](../../../samples/winrt_universal/PhoneTutorial/App.xaml.cpp)
