# Documentation for `samples/winrt_universal/PhoneTutorial/App.xaml.h`

## File Metadata

- **Full Path**: `samples/winrt_universal/PhoneTutorial/App.xaml.h`
- **File Name**: `App.xaml.h`
- **File Size**: 818 bytes
- **File Type**: .h
- **Link to Source**: [samples/winrt_universal/PhoneTutorial/App.xaml.h](../../../samples/winrt_universal/PhoneTutorial/App.xaml.h)
