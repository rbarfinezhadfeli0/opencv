# Documentation for `samples/winrt_universal/PhoneTutorial/MainPage.xaml.h`

## File Metadata

- **Full Path**: `samples/winrt_universal/PhoneTutorial/MainPage.xaml.h`
- **File Name**: `MainPage.xaml.h`
- **File Size**: 745 bytes
- **File Type**: .h
- **Link to Source**: [samples/winrt_universal/PhoneTutorial/MainPage.xaml.h](../../../samples/winrt_universal/PhoneTutorial/MainPage.xaml.h)
