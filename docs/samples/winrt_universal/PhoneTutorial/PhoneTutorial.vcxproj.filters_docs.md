# Documentation for `samples/winrt_universal/PhoneTutorial/PhoneTutorial.vcxproj.filters`

## File Metadata

- **Full Path**: `samples/winrt_universal/PhoneTutorial/PhoneTutorial.vcxproj.filters`
- **File Name**: `PhoneTutorial.vcxproj.filters`
- **File Size**: 1,569 bytes
- **File Type**: .filters
- **Link to Source**: [samples/winrt_universal/PhoneTutorial/PhoneTutorial.vcxproj.filters](../../../samples/winrt_universal/PhoneTutorial/PhoneTutorial.vcxproj.filters)
