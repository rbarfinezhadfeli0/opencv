# Documentation for `samples/winrt_universal/PhoneTutorial/PhoneTutorial.vcxproj`

## File Metadata

- **Full Path**: `samples/winrt_universal/PhoneTutorial/PhoneTutorial.vcxproj`
- **File Name**: `PhoneTutorial.vcxproj`
- **File Size**: 8,711 bytes
- **File Type**: .vcxproj
- **Link to Source**: [samples/winrt_universal/PhoneTutorial/PhoneTutorial.vcxproj](../../../samples/winrt_universal/PhoneTutorial/PhoneTutorial.vcxproj)
