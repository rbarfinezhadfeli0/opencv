# Documentation for `samples/winrt_universal/PhoneTutorial/opencv.props`

## File Metadata

- **Full Path**: `samples/winrt_universal/PhoneTutorial/opencv.props`
- **File Name**: `opencv.props`
- **File Size**: 1,613 bytes
- **File Type**: .props
- **Link to Source**: [samples/winrt_universal/PhoneTutorial/opencv.props](../../../samples/winrt_universal/PhoneTutorial/opencv.props)
