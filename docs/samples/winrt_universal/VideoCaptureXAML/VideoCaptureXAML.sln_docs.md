# Documentation for `samples/winrt_universal/VideoCaptureXAML/VideoCaptureXAML.sln`

## File Metadata

- **Full Path**: `samples/winrt_universal/VideoCaptureXAML/VideoCaptureXAML.sln`
- **File Name**: `VideoCaptureXAML.sln`
- **File Size**: 5,887 bytes
- **File Type**: .sln
- **Link to Source**: [samples/winrt_universal/VideoCaptureXAML/VideoCaptureXAML.sln](../../../samples/winrt_universal/VideoCaptureXAML/VideoCaptureXAML.sln)

## Purpose and Role

This file is located in the `samples/winrt_universal/VideoCaptureXAML` directory and serves as part of the OpenCV library infrastructure.
