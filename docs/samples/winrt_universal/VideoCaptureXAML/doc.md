# Documentation for `samples/winrt_universal/VideoCaptureXAML/`
...
**Path**: `samples/winrt_universal/VideoCaptureXAML/`
**Direct Files**: 1
**Subfolders**: 1
...
- **[VideoCaptureXAML.sln](VideoCaptureXAML.sln_docs.md)**: SLN file
...
- **video_capture_xaml/** - See [video_capture_xaml/doc.md](video_capture_xaml/doc.md)
...
**Sibling Folders**:
- [PhoneTutorial/](../PhoneTutorial/doc.md)

**Subfolders**:
- [video_capture_xaml/](video_capture_xaml/doc.md)
