# Documentation for `samples/winrt_universal/VideoCaptureXAML/video_capture_xaml/opencv.props`

## File Metadata

- **Full Path**: `samples/winrt_universal/VideoCaptureXAML/video_capture_xaml/opencv.props`
- **File Name**: `opencv.props`
- **File Size**: 2,839 bytes
- **File Type**: .props
- **Link to Source**: [samples/winrt_universal/VideoCaptureXAML/video_capture_xaml/opencv.props](../../../../samples/winrt_universal/VideoCaptureXAML/video_capture_xaml/opencv.props)

## Purpose and Role

This file is located in the `samples/winrt_universal/VideoCaptureXAML/video_capture_xaml` directory and serves as part of the OpenCV library infrastructure.
