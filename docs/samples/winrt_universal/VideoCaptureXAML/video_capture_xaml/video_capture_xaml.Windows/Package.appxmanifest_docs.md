# Documentation for `samples/winrt_universal/VideoCaptureXAML/video_capture_xaml/video_capture_xaml.Windows/Package.appxmanifest`

## File Metadata

- **Full Path**: `samples/winrt_universal/VideoCaptureXAML/video_capture_xaml/video_capture_xaml.Windows/Package.appxmanifest`
- **File Name**: `Package.appxmanifest`
- **File Size**: 1,254 bytes
- **File Type**: .appxmanifest
- **Link to Source**: [samples/winrt_universal/VideoCaptureXAML/video_capture_xaml/video_capture_xaml.Windows/Package.appxmanifest](../../../../../samples/winrt_universal/VideoCaptureXAML/video_capture_xaml/video_capture_xaml.Windows/Package.appxmanifest)
