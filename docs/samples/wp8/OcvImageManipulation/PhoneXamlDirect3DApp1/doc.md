# Documentation for `samples/wp8/OcvImageManipulation/PhoneXamlDirect3DApp1/`
...
**Path**: `samples/wp8/OcvImageManipulation/PhoneXamlDirect3DApp1/`
**Direct Files**: 0
**Subfolders**: 2
...
- **Parent Folder**: [samples/wp8/OcvImageManipulation/](../OcvImageManipulation/doc.md)
