# Documentation for `samples/wp8/OcvImageManipulation/`
...
**Path**: `samples/wp8/OcvImageManipulation/`
**Direct Files**: 1
**Subfolders**: 1
...
- **[ImageManipulation.sln](ImageManipulation.sln_docs.md)**: SLN file
...
- **Parent Folder**: [samples/wp8/](../wp8/doc.md)
