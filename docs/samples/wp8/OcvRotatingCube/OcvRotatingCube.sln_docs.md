# Documentation for `samples/wp8/OcvRotatingCube/OcvRotatingCube.sln`

## File Metadata

- **Full Path**: `samples/wp8/OcvRotatingCube/OcvRotatingCube.sln`
- **File Name**: `OcvRotatingCube.sln`
- **File Size**: 5,028 bytes
- **File Type**: .sln
- **Link to Source**: [samples/wp8/OcvRotatingCube/OcvRotatingCube.sln](../../../samples/wp8/OcvRotatingCube/OcvRotatingCube.sln)

## Purpose and Role

This file is located in the `samples/wp8/OcvRotatingCube` directory and serves as part of the OpenCV library infrastructure.
