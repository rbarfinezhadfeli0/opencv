# Documentation for `samples/wp8/OcvRotatingCube/PhoneXamlDirect3DApp1/PhoneXamlDirect3DApp1/Assets/Tiles/`
...
**Path**: `samples/wp8/OcvRotatingCube/PhoneXamlDirect3DApp1/PhoneXamlDirect3DApp1/Assets/Tiles/`
**Direct Files**: 5
**Subfolders**: 0
...
- **[FlipCycleTileSmall.png](FlipCycleTileSmall.png_docs.md)**: PNG file
- **[FlipCycleTileLarge.png](FlipCycleTileLarge.png_docs.md)**: PNG file
- **[FlipCycleTileMedium.png](FlipCycleTileMedium.png_docs.md)**: PNG file
- **[IconicTileSmall.png](IconicTileSmall.png_docs.md)**: PNG file
- **[IconicTileMediumLarge.png](IconicTileMediumLarge.png_docs.md)**: PNG file
...
- **Parent Folder**: [samples/wp8/OcvRotatingCube/PhoneXamlDirect3DApp1/PhoneXamlDirect3DApp1/Assets/](../Assets/doc.md)
